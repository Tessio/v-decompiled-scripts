...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (flag != -1)
		{
			if (Global_114018[flag /*10*/].f_9 != -1)
			{
				...
				func_329(&(Global_114018[flag /*10*/].f_9));
			}
		}
	
		func_311(&flag, &num, true);
	}

	if (!func_308(&unk124, &flag, vector, 1f))
	{
		func_307();
	...
	while (true)
	{
		...
		func_228(flag);
		func_221(&iLocal_106, &(flag.f_9), vector);
		...
		if (func_218(&uLocal_94) && flag == 37)
			func_215(flag.f_28[1], &uLocal_94, flag);
	
		if (flag == 37)
		{
			func_211(&flag, vector, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_108);
		}
		else if (flag == 42)
		{
			func_206(&flag, vector, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (flag == 43)
		{
			func_204(&num, &flag.f_35[0], &flag.f_28[1]);
			func_206(&flag, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
	
		flag2 = false;
	
		if (flag == 41)
			if (func_202(&flag, &unk63) || func_201(&flag))
				flag2 = true;
		else if (func_186(&flag, 0))
			flag2 = true;
		...
		if (flag2)
		{
			...
			if (func_184(flag))
				func_181(flag, &blLocal_107);
		
			if (!func_2(&flag))
				func_311(&flag, &num, true);
		
			if (func_1(&flag))
				func_311(&flag, &num, false);
		}
	}
...
void func_4(BOOL bParam0) // Position - 0x51B (1307)
{
	int num;
	BOOL flag;
...
void func_6(BOOL bParam0) // Position - 0x728 (1832)
{
	switch (bParam0)
	{
		case 2:
...
int func_28(var uParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x2A14 (10772)
{
...
BOOL func_29(ePedComponentType epctParam0) // Position - 0x2A54 (10836)
{
	int i;
...
void func_30(var uParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x2A82 (10882)
{
...
int func_31(ePedComponentType epctParam0) // Position - 0x2B5E (11102)
{
	int i;
...
eCharacter func_32(ePedComponentType epctParam0) // Position - 0x2BA0 (11168)
{
	int i;
...
int func_33(ePedComponentType epctParam0, eCharacter echParam1, int iParam2) // Position - 0x2C03 (11267)
{
	int i;
...
void func_37(ePedComponentType epctParam0, var uParam1) // Position - 0x2F3B (12091)
{
	int i;
...
Vector3 func_97(ePedComponentType epctParam0, int iParam1) // Position - 0x8AC4 (35524)
{
	switch (iParam1)
	{
		case 0:
...
void func_121(BOOL bParam0, var uParam1) // Position - 0x9854 (38996)
{
	switch (bParam0)
	{
		case 0:
...
void func_126(BOOL bParam0) // Position - 0xAFB2 (44978)
{
	if (bParam0 < 63)
	{
		func_127();
...
void func_128(ePedComponentType epctParam0) // Position - 0xB010 (45072)
{
	int num;
	int num2;
	int num3;
...
int func_130(ePedComponentType epctParam0) // Position - 0xB0EC (45292)
{
	int i;
...
int func_136(ePedComponentType epctParam0) // Position - 0xB24C (45644)
{
	int i;
...
eCharacter func_148(int iParam0, BOOL bParam1) // Position - 0xB75B (46939)
{
	eCharacter character;
	int num;
...
BOOL func_171(BOOL bParam0) // Position - 0xBD93 (48531)
{
	int num;
...
void func_172(BOOL bParam0) // Position - 0xBDD8 (48600)
{
...
BOOL func_178() // Position - 0xC1E6 (49638)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

BOOL func_179(const char* sParam0, int iParam1) // Position - 0xC1F7 (49655)
{
	int num;
	const char* str;
	Hash hashKey;
...
void func_181(BOOL bParam0, var uParam1) // Position - 0xC264 (49764)
{
	switch (bParam0)
	{
		case false:
...
BOOL func_184(BOOL bParam0) // Position - 0xC716 (50966)
{
	switch (bParam0)
	{
		case false:
...
void func_215(Ped pedParam0, var uParam1, BOOL bParam2) // Position - 0xE233 (57907)
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_216(bParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
			...
			case 5:
				if (!func_216(bParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
void func_228(BOOL bParam0) // Position - 0xE910 (59664)
{
	if (bParam0 == -1)
		bParam0 = func_178();
...
BOOL func_256(BOOL bParam0) // Position - 0xFD8B (64907)
{
	if (bParam0 == -1)
		bParam0 = func_178();
...
BOOL func_257(BOOL bParam0) // Position - 0xFE20 (65056)
{
...
BOOL func_260(BOOL bParam0) // Position - 0xFE9F (65183)
{
	if (func_261() && Global_102454.f_11 == 6 && bParam0 == func_179(&(Global_102454.f_3), 0))
		return true;
...
BOOL func_262(BOOL bParam0) // Position - 0xFF11 (65297)
{
	if (func_119(false))
...
int func_270(ePedComponentType epctParam0, eCharacter echParam1) // Position - 0x1047B (66683)
{
	int num;
...
BOOL func_298(BOOL bParam0) // Position - 0x15E79 (89721)
{
	var unk;
	eCharacter character;
...
BOOL func_299(BOOL bParam0) // Position - 0x15ECA (89802)
{
	const char* string2;
...
BOOL func_300(BOOL bParam0) // Position - 0x15F83 (89987)
{
	var unk;
...
BOOL func_303(BOOL bParam0) // Position - 0x161AB (90539)
{
...
BOOL func_304(BOOL bParam0) // Position - 0x161D6 (90582)
{
	if (bParam0 == 63 || bParam0 == -1)
		return false;
...
BOOL func_305(BOOL bParam0) // Position - 0x16201 (90625)
{
	if (bParam0 == 63 || bParam0 == -1)
		return false;
...
BOOL func_306(BOOL bParam0) // Position - 0x1622C (90668)
{
	if (func_257(bParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
