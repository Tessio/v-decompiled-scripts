...
void func_1(var uParam0) // Position - 0xB6 (182)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if (func_56(uParam0) || func_52(uParam0) || func_51(uParam0) || !func_50(uParam0) || func_48(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || IS_BIT_SET(Global_1951218.f_4, 2) || func_47(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						if (MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)
							if (func_42(uParam0->f_9) && !Global_262145.f_26732)
...
void func_37(int iParam0) // Position - 0x1793 (6035)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_2359296[func_38() /*5574*/].f_681.f_4248[i /*3*/] == iParam0)
		{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_84(Global_2658296[plParam0 /*468*/].f_325.f_8) == 15;

	return false;
}

int func_84(BOOL bParam0) // Position - 0x21CD (8653)
{
	switch (bParam0)
	{
		case false:
...
void func_85() // Position - 0x2736 (10038)
{
	func_87(&uLocal_147);
	func_86();
	return;
...
void func_86() // Position - 0x2748 (10056)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_87(var uParam0) // Position - 0x2754 (10068)
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x27B3 (10163)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_101(PLAYER::PLAYER_ID(), 0) && !func_100() && !func_99(PLAYER::PLAYER_ID()))
...
BOOL func_89(BOOL bParam0) // Position - 0x2C68 (11368)
{
...
BOOL func_90() // Position - 0x2C94 (11412)
{
	if (func_91())
		return true;
...
BOOL func_91() // Position - 0x2CAF (11439)
{
...
BOOL func_92(int iParam0) // Position - 0x2CDA (11482)
{
	return iParam0 == 17;
}

void func_93() // Position - 0x2CE7 (11495)
{
	var unk;
...
void func_94() // Position - 0x2D34 (11572)
{
...
BOOL func_95(Ped pedParam0) // Position - 0x2D72 (11634)
{
	int scriptTaskStatus;
...
void func_96(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2DA3 (11683)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2E73 (11891)
{
	Hash statName;
...
void func_98() // Position - 0x2E8F (11919)
{
	eViewModeContext i;
...
BOOL func_99(Player plParam0) // Position - 0x2EE7 (12007)
{
...
BOOL func_100() // Position - 0x2F26 (12070)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_101(Player plParam0, int iParam1) // Position - 0x2F34 (12084)
{
	BOOL flag;
...
int func_102(int iParam0, BOOL bParam1) // Position - 0x2F8D (12173)
{
	int num;
	int num2;
...
int func_103() // Position - 0x2FCE (12238)
{
	return Global_1574928;
}

BOOL func_104(Player plParam0) // Position - 0x2FDA (12250)
{
	Player player;
...
BOOL func_105() // Position - 0x2FFC (12284)
{
...
void func_106() // Position - 0x302D (12333)
{
...
void func_107() // Position - 0x305E (12382)
{
	func_108(0, &uLocal_147, 0, 3);
	func_108(1, &uLocal_147, 1, 3);
	func_108(2, &uLocal_147, 2, 3);
	func_108(3, &uLocal_147, 3, 1);
	func_108(4, &uLocal_147, 4, 1);
	func_108(5, &uLocal_147, 5, 1);
	func_108(6, &uLocal_147, 6, 1);
	func_108(7, &uLocal_147, 7, 1);
	func_108(8, &uLocal_147, 8, 1);
	func_108(9, &uLocal_147, 9, 1);
	func_108(10, &uLocal_147, 10, 1);
	func_108(11, &uLocal_147, 11, 1);
	func_108(12, &uLocal_147, 12, 1);
	func_108(13, &uLocal_147, 13, 1);
	func_108(14, &uLocal_147, 14, 1);
	func_108(15, &uLocal_147, 15, 1);
	func_108(16, &uLocal_147, 16, 1);
	func_108(17, &uLocal_147, 17, 1);
	func_108(18, &uLocal_147, 18, 1);
	func_108(19, &uLocal_147, 19, 1);
	return;
}

void func_108(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3132 (12594)
{
	var unk;
	float num;
...
Vector3 func_109() // Position - 0x31C3 (12739)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_110(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x31D6 (12758)
{
	float num;
	float num2;
	float num3;
...
float func_111(int iParam0, float fParam1) // Position - 0x321A (12826)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_112() // Position - 0x3253 (12883)
{
	return -0.5f, -0.5f, 0f;
}

void func_113(int iParam0, var uParam1, var uParam2) // Position - 0x3266 (12902)
{
	if (func_4())
	{
		switch (iParam0)
...
void func_114() // Position - 0x3826 (14374)
{
	return;
}

int func_115(int iParam0, int iParam1, BOOL bParam2) // Position - 0x382E (14382)
{
	int i;
...
Player func_116() // Position - 0x3944 (14660)
{
	Player player;
