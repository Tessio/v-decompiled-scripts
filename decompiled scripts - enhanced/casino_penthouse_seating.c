...
void func_1(var uParam0) // Position - 0xB6 (182)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if (func_56(uParam0) || func_52(uParam0) || func_51(uParam0) || !func_50(uParam0) || func_48(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || IS_BIT_SET(Global_1950714.f_4, 2) || func_47(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						if (MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)
							if (func_42(uParam0->f_9) && !Global_262145.f_26731)
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_84(Global_2658294[plParam0 /*468*/].f_325.f_8) == 15;
...
{
	func_108(0, &uLocal_140, 0, 3);
	func_108(1, &uLocal_140, 1, 3);
	func_108(2, &uLocal_140, 2, 3);
	func_108(3, &uLocal_140, 3, 1);
	func_108(4, &uLocal_140, 4, 1);
	func_108(5, &uLocal_140, 5, 1);
	func_108(6, &uLocal_140, 6, 1);
	func_108(7, &uLocal_140, 7, 1);
	func_108(8, &uLocal_140, 8, 1);
	func_108(9, &uLocal_140, 9, 1);
	func_108(10, &uLocal_140, 10, 1);
	func_108(11, &uLocal_140, 11, 1);
	func_108(12, &uLocal_140, 12, 1);
	func_108(13, &uLocal_140, 13, 1);
	func_108(14, &uLocal_140, 14, 1);
	func_108(15, &uLocal_140, 15, 1);
	func_108(16, &uLocal_140, 16, 1);
	func_108(17, &uLocal_140, 17, 1);
	func_108(18, &uLocal_140, 18, 1);
	func_108(19, &uLocal_140, 19, 1);
	return;
}
