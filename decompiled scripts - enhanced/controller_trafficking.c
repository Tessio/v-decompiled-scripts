...
void func_43(float fParam0, int iParam1) // Position - 0x1D63 (7523)
{
	func_44(fParam0, iParam1);
	return;
}
...
void func_72(ePedComponentType epctParam0) // Position - 0x2A34 (10804)
{
	int num;
	int num2;
	int num3;
...
int func_74(ePedComponentType epctParam0) // Position - 0x2B10 (11024)
{
	int i;
...
int func_80(ePedComponentType epctParam0) // Position - 0x2C70 (11376)
{
	int i;
...
BOOL func_163(Vehicle veParam0, int iParam1) // Position - 0xAF43 (44867)
{
	BOOL num;
	int num2;
	...
	*veParam0 = { 0f, 0f, 0f };
	...
	switch (iParam1)
	{
		case 0:
			*veParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			veParam0->f_4 = func_11(CHAR_MICHAEL, 1);
			veParam0->f_12 = 0;
		...
		case 2:
			*veParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			veParam0->f_4 = func_11(CHAR_FRANKLIN, 1);
			veParam0->f_12 = 1;
			MISC::SET_BIT(&(veParam0->f_9), 20);
			MISC::SET_BIT(&(veParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*veParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			veParam0->f_4 = func_11(CHAR_FRANKLIN, 2);
			veParam0->f_12 = 1;
		...
		case 6:
			*veParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			veParam0->f_4 = func_11(CHAR_TREVOR, 1);
			veParam0->f_12 = 2;
			MISC::SET_BIT(&(veParam0->f_9), 20);
			MISC::SET_BIT(&(veParam0->f_9), 7);
			num = 1;
	...
	if (IS_BIT_SET(veParam0->f_9, 10))
	{
		...
		if (!func_110(Global_114931.f_32757.f_1864[veParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_110(Global_114931.f_2370.f_539.f_3588[1 /*10*/][veParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_110(Global_114931.f_2370.f_539.f_3588[0 /*10*/][veParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_181(float fParam0, int iParam1) // Position - 0xCDD6 (52694)
{
	return fParam0 && iParam1 != false;
}
