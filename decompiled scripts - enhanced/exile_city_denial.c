...
void func_23() // Position - 0xF98 (3992)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(character) && !func_9(14) || Global_113879)
			{
...
void func_29(int iParam0) // Position - 0x1479 (5241)
{
	...
	for (i = CHAR_MICHAEL; i < Global_114931.f_7695.f_198; i = i + 1)
	{
		if (Global_114931.f_7695.f_137[i /*15*/] == iParam0)
		{
			func_30(Global_114931.f_7695.f_137[i /*15*/].f_6);
...
int func_30(eCharacter echParam0) // Position - 0x1535 (5429)
{
	...
	{
		if (func_36(echParam0, Global_21627) == 1)
		{
			func_35(echParam0, Global_21627, 0);
		
			if (func_34(echParam0, Global_21627) == 0)
			{
