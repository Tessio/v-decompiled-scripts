...
void main() // Position - 0x0 (0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(eScriptParam_0))
	{
		...
		epctLocal_314 = Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36;
		func_73(&Global_1569868, epctLocal_314);
...
void func_2() // Position - 0xCE5 (3301)
{
	...
	if (type > PV_COMP_INVALID && type != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 33; i = i + 1)
		{
			if (Global_1845274[PLAYER::PLAYER_ID() /*877*/].f_260.f_36 == Global_1845274[type /*877*/].f_260[i])
			{
				if (func_9(i) != -1)
				{
