...
void main() // Position - 0x0 (0)
{
	...
	iLocal_54 = 0;
	func_33(&uLocal_55);
	func_32(&uLocal_55, 1701.7803f, 3225.1482f, 40.0202f);
	func_32(&uLocal_55, 1678.909f, 3287.6023f, 39.9648f);
	func_32(&uLocal_55, 1710.4376f, 3326.4993f, 40.1797f);
	func_32(&uLocal_55, 1738.8787f, 3335.25f, 40.1493f);
	func_32(&uLocal_55, 1768.3873f, 3312.1008f, 40.2875f);
	func_32(&uLocal_55, 1819.2413f, 3225.4495f, 42.9019f);
	func_31(&uLocal_55);
				...
				if (func_23())
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (func_22(entityCoords, unk3, 75f))
							if (func_21(&uLocal_55, entityCoords))
...
{
	func_6(-815326385);
	func_3("SHI_T_SANDY_2" /*Los aviones que compres en sitios web o que aterrices dentro se almacenarán en~HUD_COLOUR_TREVOR~~BLIP_HANGAR~~s~~n~Los vehículos demasiado grandes para un garage también se almacenarán aquí.*/, 0, 0, -1, 10000, 7, 0, 0, 0);
	BUILTIN::WAIT(0);
	func_3("SHI_T_SANDY_3" /*Los helicópteros que compres en sitios web o que aterrices en el helipuerto se almacenarán en ~HUD_COLOUR_TREVOR~~BLIP_HELIPAD~*/, 0, 0, -1, 10000, 7, 0, 0, 0);
	iLocal_54 = 2;
	return;
}
...
void func_7(int iParam0) // Position - 0x69D (1693)
{
	...
	if (iParam0 < 0 || iParam0 >= Global_114990.f_7697.f_866)
		return;

	if (Global_114990.f_7697.f_866 > 1)
	{
		for (i = iParam0; i <= Global_114990.f_7697.f_866 - 2; i = i + 1)
		{
...
void func_8(int iParam0) // Position - 0x756 (1878)
{
	...
	if (iParam0 < 0 || iParam0 >= Global_114990.f_7697.f_764)
		return;

	if (Global_114990.f_7697.f_764 > 1)
	{
		for (i = iParam0; i <= Global_114990.f_7697.f_764 - 2; i = i + 1)
		{
...
void func_12(int iParam0) // Position - 0x995 (2453)
{
	...
	for (i = 0; i < Global_114990.f_7697.f_198; i = i + 1)
	{
		if (Global_114990.f_7697.f_137[i /*15*/] == iParam0)
		{
			func_13(Global_114990.f_7697.f_137[i /*15*/].f_6);
...
int func_13(int iParam0) // Position - 0xA51 (2641)
{
	...
	{
		if (func_19(iParam0, Global_21666) == 1)
		{
			func_18(iParam0, Global_21666, 0);
		
			if (func_17(iParam0, Global_21666) == 0)
			{
...
void func_15(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xADC (2780)
{
	...
	Global_2349[iParam0 /*29*/].f_24[echParam1] = iParam2;

	if (iParam0 < 162)
		Global_114990.f_28060[iParam0 /*29*/].f_24[echParam1] = iParam2;
...
void func_16(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xB21 (2849)
{
	...
	Global_2349[iParam0 /*29*/].f_12[echParam1] = iParam2;

	if (iParam0 < 162)
		Global_114990.f_28060[iParam0 /*29*/].f_12[echParam1] = iParam2;
...
{
	Global_2349[iParam0 /*29*/].f_19[echParam1] = iParam2;

	if (iParam0 < 162)
		Global_114990.f_28060[iParam0 /*29*/].f_19[echParam1] = iParam2;
...
void func_20(eCharacter echParam0) // Position - 0xBEB (3051)
{
	...
	if (echParam0 < 0 || echParam0 >= Global_114990.f_7697.f_136)
		return;

	num = Global_114990.f_7697[echParam0 /*15*/].f_2;

	if (Global_114990.f_7697.f_136 > 1)
	{
	...
	if (Global_114990.f_7697.f_136 > 0)
	{
...
void func_26() // Position - 0xE52 (3666)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(character) && !func_27(14) || Global_113936)
			{
