...
int func_164(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7CB5 (31925)
{
	...
	{
		if (!func_180(Global_100893[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_181(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC113 (49427)
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
void func_193(var uParam0, int iParam1) // Position - 0xCD6B (52587)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_181(Global_114931.f_18540[i], &unk, &num))
			{
...
BOOL func_232(eCharacter echParam0) // Position - 0xE8DD (59613)
{
	int i;
...
void func_235(var uParam0, int iParam1) // Position - 0xEA3E (59966)
{
...
void func_244(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF067 (61543)
{
	uParam0->f_1 = iParam1;
...
int func_245(int iParam0, int iParam1) // Position - 0xF0D3 (61651)
{
	if (iParam0 > iParam1)
		return iParam0;
