...
void main() // Position - 0x0 (0)
{
	...
	func_246(3);
	func_235(&(uLocal_63.f_1), func_245(Global_98515[1 /*19*/], Global_98515[2 /*19*/]));
	func_234(&uLocal_63, 0);
	...
	while (!func_233(4))
	{
		if (!Global_80633)
		{
			if (!func_232(86) && !func_231(14))
				func_220(&uLocal_63, 32f, 35f);
			else if (IS_BIT_SET(uLocal_63.f_449, 0))
				func_218(&uLocal_63);
		
			if (IS_BIT_SET(uLocal_63.f_449, 0))
			{
				if (func_217() == 86)
				{
					while (!func_218(&uLocal_63))
					{
						BUILTIN::WAIT(0);
					}
				}
			...
			if (_CAN_ENTER_FREEROAM_STATE(0) || IS_BIT_SET(uLocal_63.f_449, 2))
			{
				func_67(&uLocal_63);
				func_4(&uLocal_63);
				func_3(&uLocal_63);
...
void func_13(const char* sParam0, BOOL bParam1) // Position - 0xA07 (2567)
{
	int i;
	int j;
...
void func_101() // Position - 0x3E5A (15962)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_102(character) && !func_231(14) || Global_113936)
			{
...
void func_109(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x40BB (16571)
{
...
void func_115(int iParam0, BOOL bParam1) // Position - 0x5934 (22836)
{
...
void func_154() // Position - 0x7186 (29062)
{
	...
	if (func_233(18))
	{
		if (func_233(17))
		{
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(pedLocal_746, false))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_746, "Lester", 0, joaat("CS_LesterCrest"), 0);
				else
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_746, "Lester", 2, joaat("CS_LesterCrest"), 0);
			
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_749))
					if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(pedLocal_749))
						ENTITY::DETACH_ENTITY(pedLocal_749, true, true);
			
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Michael", 0, joaat("Player_Zero"), 0);
			
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_749))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_749, "WalkingStick_Lester", 1, joaat("prop_cs_walking_stick"), 0);
				else
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_749, "WalkingStick_Lester", 2, joaat("prop_cs_walking_stick"), 0);
		...
		else if (CUTSCENE::IS_CUTSCENE_PLAYING())
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_749))
					ENTITY::SET_ENTITY_VISIBLE(pedLocal_749, true, false);
			
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_747))
					ENTITY::SET_ENTITY_VISIBLE(pedLocal_747, true, false);
			
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_746))
					ENTITY::SET_ENTITY_VISIBLE(pedLocal_746, true, false);
			
				MISC::CLEAR_BIT(&iLocal_58, 7);
			}
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Lester", 0))
			{
				if (!PED::IS_PED_INJURED(pedLocal_746))
				{
					args = pedLocal_746;
		...
		else if (iLocal_60 == -1 && !func_119(false))
		{
			iLocal_60 = MISC::GET_GAME_TIMER() + 1500;
		}
		else if (MISC::GET_GAME_TIMER() > iLocal_60 || func_119(false))
		{
			if (func_119(false))
			{
			...
			func_193(&(Global_114990.f_2370.f_539), 86);
			func_163(&(Global_114990.f_2370.f_539), 86);
			func_162(&iLocal_62);
			MISC::CLEAR_BIT(&iLocal_58, 1);
			PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_750, false);
		
			if (iLocal_755 != -1)
				if (PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_755))
					PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_755);
		
			PED::CLEAR_PED_NON_CREATION_AREA();
			PATHFIND::SET_PED_PATHS_IN_AREA(uLocal_63.f_1.f_394 - uLocal_63.f_1.f_397, uLocal_63.f_1.f_394 + uLocal_63.f_1.f_397, true, 0);
	...
	if (IS_BIT_SET(iLocal_58, 18))
	{
		...
		if (MISC::GET_GAME_TIMER() > iLocal_756 + 1000)
...
void func_155(int iParam0, BOOL bParam1) // Position - 0x7581 (30081)
{
	...
	if (!bParam1)
	{
		...
		func_156("DI_FEED_HST" /*Miembros de equipo*/);
	}
...
int func_164(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7CB5 (31925)
{
	eCharacter character;
	var unk;
	var unk99;
	...
	{
		if (!func_180(Global_100950[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_165(int iParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7DD2 (32210)
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
int func_167(int iParam0, var uParam1, int iParam2) // Position - 0xB6A9 (46761)
{
	...
	if (!func_168(Global_101915[iParam0 /*98*/], false, -1))
	{
		func_166(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
BOOL func_168(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0xB8E1 (47329)
{
	int i;
	Hash outData;
...
BOOL func_169(ePedComponentType epctParam0) // Position - 0xBA66 (47718)
{
	int num;
	var unk;
	var name;
...
BOOL func_171(ePedComponentType epctParam0, int iParam1) // Position - 0xBB49 (47945)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_172() // Position - 0xBCFE (48382)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_173() // Position - 0xBD14 (48404)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_174() // Position - 0xBD2A (48426)
{
	return false;
}

BOOL func_175() // Position - 0xBD33 (48435)
{
	return true;
}

BOOL func_176() // Position - 0xBD3C (48444)
{
	return true;
}

BOOL func_177() // Position - 0xBD45 (48453)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xBD5E (48478)
{
	int profileSetting;
...
BOOL func_179(int iParam0) // Position - 0xBE16 (48662)
{
...
BOOL func_180(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC098 (49304)
{
	if (bParam6)
...
BOOL func_181(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC0DF (49375)
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
var func_182() // Position - 0xCA4E (51790)
{
	var unk;
...
void func_183(var uParam0, int iParam1) // Position - 0xCA94 (51860)
{
	if (iParam1 <= 0)
		return;
...
void func_184(var uParam0, int iParam1) // Position - 0xCB1A (51994)
{
...
void func_185(var uParam0, int iParam1) // Position - 0xCB4D (52045)
{
	int num;
	int num2;
...
int func_186(int iParam0, int iParam1) // Position - 0xCB9E (52126)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_187(int iParam0) // Position - 0xCC40 (52288)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_188(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCC62 (52322)
{
	if (bParam0)
		return uParam1;
...
int func_189(int iParam0) // Position - 0xCC79 (52345)
{
	return iParam0 & 15;
}

void func_190(var uParam0, int iParam1) // Position - 0xCC86 (52358)
{
...
void func_191(var uParam0, int iParam1) // Position - 0xCCC0 (52416)
{
...
void func_192(var uParam0, int iParam1) // Position - 0xCCFB (52475)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_193(var uParam0, int iParam1) // Position - 0xCD37 (52535)
{
	int i;
	eCharacter character;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_181(Global_114990.f_18542[i], &unk, &num))
			{
...
void func_194(var uParam0) // Position - 0xCEFD (52989)
{
	*uParam0 = -15;
	return;
}

int func_195() // Position - 0xCF0B (53003)
{
	if (func_119(false))
		return 0;
...
void func_196(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCF56 (53078)
{
	if (bParam0)
	{
...
BOOL func_197() // Position - 0xD0A5 (53413)
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_36.f_18, 14);
}

BOOL func_198(Player plParam0, int iParam1) // Position - 0xD0BF (53439)
{
	BOOL flag;
...
int func_199(int iParam0, BOOL bParam1) // Position - 0xD118 (53528)
{
	int num;
	int num2;
...
int func_200() // Position - 0xD159 (53593)
{
	return Global_1574928;
}

BOOL func_201(Player plParam0) // Position - 0xD165 (53605)
{
	Player player;
...
BOOL func_202(Player plParam0) // Position - 0xD187 (53639)
{
...
BOOL func_203() // Position - 0xD1C6 (53702)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_204(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD1D4 (53716)
{
	int num;
...
void func_205(int iParam0) // Position - 0xD207 (53767)
{
	if (iParam0 == 1)
...
void func_206() // Position - 0xD22A (53802)
{
	...
	if (func_233(16))
	{
		if (!func_119(false))
		{
			if (!IS_BIT_SET(iLocal_58, 10))
			{
				...
				func_214();
				func_116(0, 0, true);
				iLocal_750 = PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_63.f_1.f_394 - uLocal_63.f_1.f_397, uLocal_63.f_1.f_394 + uLocal_63.f_1.f_397, false, true, true, true, 1);
				iLocal_755 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uLocal_63.f_1.f_394, uLocal_63.f_1.f_397 * { 1.5f, 1.5f, 1.5f }, 0f, false, 7);
				PED::SET_PED_NON_CREATION_AREA(uLocal_63.f_1.f_394 - uLocal_63.f_1.f_397, uLocal_63.f_1.f_394 + uLocal_63.f_1.f_397);
				PATHFIND::SET_PED_PATHS_IN_AREA(uLocal_63.f_1.f_394 - uLocal_63.f_1.f_397, uLocal_63.f_1.f_394 + uLocal_63.f_1.f_397, false, 0);
			...
			if (func_158(86))
			{
				if (!IS_BIT_SET(iLocal_58, 1))
				{
					...
					{
						if (func_211(&iLocal_62, 0, 0, false, 0) == 1)
						{
			...
			if (IS_BIT_SET(iLocal_58, 2))
			{
				...
				{
					case 0:
						if (CAM::DOES_CAM_EXIST(caLocal_751))
							CAM::DESTROY_CAM(caLocal_751, false);
					
						if (CAM::DOES_CAM_EXIST(caLocal_752))
							CAM::DESTROY_CAM(caLocal_752, false);
					
						caLocal_751 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 724.4682f, -992.0684f, 24.251366f, 5.259225f, 0.000715f, 25.889177f, 44.13121f, false, 2);
						caLocal_752 = CAM::CREATE_CAMERA_WITH_PARAMS(joaat("DEFAULT_SCRIPTED_CAMERA"), 724.37274f, -991.3205f, 24.433039f, 31.499252f, 0.000715f, -4.206256f, 44.13121f, false, 2);
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98983.f_9[0]))
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_98983.f_9[0], false))
							{
								pedLocal_746 = Global_98983.f_9[0];
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_746, false, true);
							}
						}
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98983[0]))
							if (!ENTITY::IS_ENTITY_DEAD(Global_98983[0], false))
								veLocal_748 = Global_98983[0];
					...
					case 1:
						...
						if (ENTITY::DOES_ENTITY_EXIST(veLocal_748))
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_748, false))
								CAM::POINT_CAM_AT_ENTITY(caLocal_751, veLocal_748, 0f, 0f, 0f, true);
					
						CAM::SET_CAM_ACTIVE_WITH_INTERP(caLocal_752, caLocal_751, 5000, 1, 1);
						CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
					...
					case 2:
						if (MISC::GET_GAME_TIMER() - iLocal_60 > 1200)
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
							{
								if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
								{
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_748, false))
									{
										if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_748, false))
										{
											TASK::OPEN_SEQUENCE_TASK(&iLocal_753);
											TASK::TASK_LEAVE_VEHICLE(0, veLocal_748, 0);
											TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 718.1777f, -976.126f, 23.9148f, 1f, 20000, 1048576000, 0, 1193033728);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_753);
											TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
											TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_753);
										}
									}
								}
							}
					...
					case 3:
						if (MISC::GET_GAME_TIMER() - iLocal_60 > 2400)
						{
							if (!ENTITY::IS_ENTITY_DEAD(pedLocal_746, false))
							{
								if (ENTITY::DOES_ENTITY_EXIST(veLocal_748))
								{
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_748, false))
									{
										if (PED::IS_PED_IN_VEHICLE(pedLocal_746, veLocal_748, false))
										{
											TASK::OPEN_SEQUENCE_TASK(&iLocal_754);
											TASK::TASK_LEAVE_VEHICLE(0, veLocal_748, 0);
											TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 718.1777f, -976.126f, 23.9148f, 1f, 20000, 1048576000, 0, 1193033728);
											TASK::CLOSE_SEQUENCE_TASK(iLocal_754);
											TASK::CLEAR_PED_TASKS(pedLocal_746);
											TASK::TASK_PERFORM_SEQUENCE(pedLocal_746, iLocal_754);
										}
									}
								}
							}
					...
					case 4:
						if (MISC::GET_GAME_TIMER() - iLocal_60 > 5000)
							MISC::CLEAR_BIT(&iLocal_58, 2);
						break;
				}
			}
		
			if (IS_BIT_SET(iLocal_58, 1) && !IS_BIT_SET(iLocal_58, 2))
			{
				if (CUTSCENE::HAS_THIS_CUTSCENE_LOADED("JH_1_MCS_4_P1_ALT1"))
				{
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						pedLocal_747 = PLAYER::PLAYER_PED_ID();
					
						if (!ENTITY::IS_ENTITY_DEAD(pedLocal_747, false))
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_747, "Michael", 0, joaat("Player_Zero"), 0);
					
						if (!ENTITY::IS_ENTITY_DEAD(pedLocal_746, false))
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_746, "Lester", 2, joaat("IG_LesterCrest"), 0);
					
						MISC::SET_BIT(&iLocal_58, 9);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_749, "WalkingStick_Lester", 2, joaat("prop_cs_walking_stick"), 0);
						MISC::SET_BIT(&iLocal_58, 8);
						_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_63.f_484), 0, 0, "MICHAEL", 1, 1);
						_CONVERSATION_INITIALIZE_ACTOR(&(uLocal_63.f_484), 3, 0, "LESTER", 1, 1);
						func_72(true);
						iLocal_60 = MISC::GET_GAME_TIMER();
					...
					else
					{
						...
						{
							if (CAM::DOES_CAM_EXIST(caLocal_751))
								CAM::SET_CAM_ACTIVE(caLocal_751, false);
						
							if (CAM::DOES_CAM_EXIST(caLocal_752))
								CAM::SET_CAM_ACTIVE(caLocal_752, false);
							...
							if (ENTITY::DOES_ENTITY_EXIST(pedLocal_746))
								PED::DELETE_PED(&pedLocal_746);
						
							MISC::SET_BIT(&iLocal_58, 5);
						}
					
						if (!IS_BIT_SET(iLocal_58, 6))
							if (iLocal_61 > 0)
								MISC::SET_BIT(&iLocal_58, 6);
					
						if (!IS_BIT_SET(iLocal_58, 12))
						{
							if (MISC::GET_GAME_TIMER() - iLocal_60 > 14058)
							{
								func_116(0, 1, true);
								MISC::SET_BIT(&iLocal_58, 12);
							}
						}
						else if (!IS_BIT_SET(iLocal_58, 13))
						{
							if (MISC::GET_GAME_TIMER() - iLocal_60 > 22887)
							{
								func_116(0, 2, true);
								MISC::SET_BIT(&iLocal_58, 13);
							}
						}
						else if (!IS_BIT_SET(iLocal_58, 14))
						{
							if (MISC::GET_GAME_TIMER() - iLocal_60 > 27988)
							{
								func_116(0, 3, true);
								func_208(&uLocal_63);
								MISC::SET_BIT(&iLocal_58, 14);
						...
						else if (!IS_BIT_SET(iLocal_58, 15))
						{
							if (MISC::GET_GAME_TIMER() - iLocal_60 > 42084)
							{
								func_116(0, 4, true);
								MISC::SET_BIT(&iLocal_58, 15);
							}
						...
						if (IS_BIT_SET(iLocal_58, 8))
						{
							...
							{
								pedLocal_749 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("WalkingStick_Lester", joaat("prop_cs_walking_stick")));
						...
						if (IS_BIT_SET(iLocal_58, 9))
						{
							...
							{
								pedLocal_746 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", joaat("IG_LesterCrest")));
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(pedLocal_747, false))
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_747, true);
								PED::SET_PED_CONFIG_FLAG(pedLocal_747, 208, true);
								PED::SET_PED_CONFIG_FLAG(pedLocal_747, 118, false);
								PED::SET_PED_CONFIG_FLAG(pedLocal_747, 213, false);
								TASK::TASK_GO_STRAIGHT_TO_COORD(pedLocal_747, 708.8129f, -966.3621f, 29.3956f, 1f, 20000, 1193033728, 1056964608);
							}
						}
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Lester", 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(pedLocal_746, false))
								if (ENTITY::DOES_ENTITY_EXIST(pedLocal_749))
									ENTITY::ATTACH_ENTITY_TO_ENTITY(pedLocal_749, pedLocal_746, PED::GET_PED_BONE_INDEX(pedLocal_746, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
						
							if (!ENTITY::IS_ENTITY_DEAD(pedLocal_746, false))
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_746, true);
								PED::SET_PED_CONFIG_FLAG(pedLocal_746, 208, true);
								PED::SET_PED_CONFIG_FLAG(pedLocal_746, 118, false);
								PED::SET_PED_CONFIG_FLAG(pedLocal_746, 213, false);
								TASK::TASK_GO_STRAIGHT_TO_COORD(pedLocal_746, 708.3643f, -963.9194f, 29.4181f, 1f, 20000, 1193033728, 1056964608);
							}
						}
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(pedLocal_747, false))
									ENTITY::SET_ENTITY_VISIBLE(pedLocal_747, false, false);
							
								if (!ENTITY::IS_ENTITY_DEAD(pedLocal_746, false))
									ENTITY::SET_ENTITY_VISIBLE(pedLocal_746, false, false);
							
								if (ENTITY::DOES_ENTITY_EXIST(pedLocal_749))
									ENTITY::SET_ENTITY_VISIBLE(pedLocal_749, false, false);
	...
	else
	{
		...
		if (IS_BIT_SET(iLocal_58, 10))
			MISC::CLEAR_BIT(&iLocal_58, 10);
	}

	return;
}

void func_207() // Position - 0xDB49 (56137)
{
	func_85(1, 0, true);
	func_85(2, 0, true);
	func_215(&uLocal_63);
...
void func_208(var uParam0) // Position - 0xDB6B (56171)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
...
void func_209(var uParam0) // Position - 0xDBB1 (56241)
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDBED (56301)
{
...
int func_211(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xDC88 (56456)
{
	int i;
...
void func_212(var uParam0, int iParam1) // Position - 0xDDBF (56767)
{
	int i;
...
BOOL func_213(int iParam0) // Position - 0xDE0E (56846)
{
	if (Global_44938 == 15)
		return false;
...
void func_214() // Position - 0xDE30 (56880)
{
	Global_102550 = true;
	return;
}

void func_215(var uParam0) // Position - 0xDE3D (56893)
{
...
BOOL func_216(int iParam0) // Position - 0xDE8C (56972)
{
	switch (iParam0)
	{
		case 0:
...
int func_217() // Position - 0xDEF9 (57081)
{
	return Global_80625;
}

BOOL func_218(var uParam0) // Position - 0xDF05 (57093)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_208(uParam0);
...
void func_219(var uParam0) // Position - 0xDF2E (57134)
{
...
void func_220(var uParam0, float fParam1, float fParam2) // Position - 0xDF98 (57240)
{
	float num;
...
void func_221(var uParam0) // Position - 0xE069 (57449)
{
...
void func_222(var uParam0) // Position - 0xE0E7 (57575)
{
	int i;
...
void func_223(var uParam0) // Position - 0xE141 (57665)
{
	int i;
	Hash modelHash;
	float pitch;
...
Vector3 func_224(var uParam0, var uParam1) // Position - 0xE277 (57975)
{
	float num;
	float num2;
	float num3;
...
void func_225(var uParam0) // Position - 0xE2F5 (58101)
{
	int i;
	int num;
	int num2;
...
void func_226(var uParam0) // Position - 0xE3D2 (58322)
{
	int num;
	int value;
	int i;
...
BOOL func_227(var uParam0) // Position - 0xE512 (58642)
{
...
void func_228(var uParam0) // Position - 0xE5AD (58797)
{
	float num;
	float num2;
...
void func_229(var uParam0) // Position - 0xE636 (58934)
{
	int i;
	int num;
	BOOL value;
...
void func_230(var uParam0) // Position - 0xE877 (59511)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
BOOL func_231(int iParam0) // Position - 0xE89B (59547)
{
	return Global_44938 == iParam0;
}

BOOL func_232(eCharacter echParam0) // Position - 0xE8A9 (59561)
{
	int i;
...
BOOL func_233(int iParam0) // Position - 0xE911 (59665)
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_234(var uParam0, int iParam1) // Position - 0xE93E (59710)
{
	var unk;
	var unk4;
...
void func_235(var uParam0, int iParam1) // Position - 0xEA0A (59914)
{
	...
	func_238(uParam0, 2, 2, "H_TD_SEC" /*Evaluar seguridad*/);
	func_238(uParam0, 2, 2, "H_TD_PHOTO" /*Fotografiar interior*/);
	func_238(uParam0, 2, 5, "H_TD_PLAN" /*Decidir táctica*/);
	func_238(uParam0, 2, 6, "H_TD_CREW" /*Elegir equipo*/);
	func_238(uParam0, 7, 11, "H_TD_CARB" /*Carabinas*/);
	func_238(uParam0, 8, 9, "H_TD_BUGS" /*Equipo de exterminador*/);
	func_238(uParam0, 8, 10, "H_TD_GAS" /*Botes de gas BZ*/);
...
void func_236(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xECB0 (60592)
{
	var unk;
...
void func_237(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED29 (60713)
{
	if (uParam0->f_33 < 20)
	{
...
void func_238(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xED6D (60781)
{
	var unk;
...
void func_239(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xEDBD (60861)
{
	if (uParam0->f_117 < 22)
	{
...
void func_240(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0xEE0D (60941)
{
	var unk;
	var unk3;
...
void func_241(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0xEEA7 (61095)
{
	var unk;
	var unk5;
	var unk9;
...
void func_242(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0xEF4B (61259)
{
	uParam0->f_9 = fParam1;
...
void func_244(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF033 (61491)
{
	uParam0->f_1 = iParam1;
...
int func_245(int iParam0, int iParam1) // Position - 0xF09F (61599)
{
	if (iParam0 > iParam1)
		return iParam0;
...
int func_246(int iParam0) // Position - 0xF0B5 (61621)
{
	int num;
	int offset;
...
void func_247() // Position - 0xF10C (61708)
{
