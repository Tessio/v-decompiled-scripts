...
int func_163(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7C82 (31874)
{
	...
	{
		if (!func_179(Global_100356[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_180(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC155 (49493)
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
void func_192(var uParam0, int iParam1) // Position - 0xCDAD (52653)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_180(Global_114370.f_18537[i], &unk, &num))
			{
...
BOOL func_231(eCharacter echParam0) // Position - 0xE91F (59679)
{
	int i;
...
void func_234(var uParam0, int iParam1) // Position - 0xEA80 (60032)
{
...
void func_243(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF0A9 (61609)
{
	uParam0->f_1 = iParam1;
...
int func_244(int iParam0, int iParam1) // Position - 0xF115 (61717)
{
	if (iParam0 > iParam1)
		return iParam0;
