...
void func_33(BOOL bParam0) // Position - 0x10A6 (4262)
{
...
eCharacter func_95(int iParam0, BOOL bParam1) // Position - 0x26D7 (9943)
{
...
void func_102() // Position - 0x2809 (10249)
{
	...
	func_103(4, &uLocal_160, 4, 1);
	func_103(5, &uLocal_160, 5, 1);
	func_103(6, &uLocal_160, 6, 1);
	func_103(7, &uLocal_160, 7, 1);
	func_103(8, &uLocal_160, 8, 1);
	func_103(9, &uLocal_160, 9, 1);
	return;
}
