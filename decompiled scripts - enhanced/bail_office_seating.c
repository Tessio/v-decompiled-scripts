...
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("bail_office_seating", Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_11, true, 0))
		return false;
...
void func_105() // Position - 0x287C (10364)
{
	...
	func_106(4, &uLocal_160, 4, 1);
	func_106(5, &uLocal_160, 5, 1);
	func_106(6, &uLocal_160, 6, 1);
	func_106(7, &uLocal_160, 7, 1);
	func_106(8, &uLocal_160, 8, 1);
	func_106(9, &uLocal_160, 9, 1);
	return;
}
