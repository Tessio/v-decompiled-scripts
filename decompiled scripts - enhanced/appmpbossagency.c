...
void main() // Position - 0x0 (0)
{
	...
	fLocal_82 = 0f;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_122, "CELL_206" /*VOLVER*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_126, "CELL_214" /*OPCIONES*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_130, "CELL_243" /*ACEPTAR ACTIVIDAD*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_134, "CELL_244" /*CANCELAR ACTIVIDAD*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_138, "CELL_265" /*INVITACIÓN*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_142, "CELL_300" /*CHAR_DEFAULT*/, 16);
	MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
	func_102(&uLocal_149);
	iLocal_146 = 0;
	func_100();
	func_99(Global_21647, "SET_THEME", BUILTIN::TO_FLOAT(5), -1082130432, -1082130432, -1082130432, -1082130432);
	func_89(false);
...
void func_5() // Position - 0x1FA (506)
{
	...
	Global_1882206.f_6 = 1;

	if (bLocal_148)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, Global_21635))
			bLocal_148 = false;
	...
	HUD::SET_WARNING_MESSAGE_WITH_HEADER("HUD_INPUT23" /*Confirmar*/, "BA_APP_PASS_W" /*¿Seguro que quieres convertirte en guardia? El modo pasivo estará desactivado mientras juegues como guardia.*/, 36, 0, false, -1, 0, 0, true, 0);
	return;
}
...
void func_6(int iParam0) // Position - 0x261 (609)
{
	...
	player = Global_1882206.f_7[iParam0 /*8*/].f_2;

	if (Global_1882206.f_7[iParam0 /*8*/].f_1 == 1 && plLocal_147 == player)
	{
		func_27(player, Global_1882206.f_7[iParam0 /*8*/].f_6);
		func_13(iParam0);
	}
...
void func_13(int iParam0) // Position - 0x44F (1103)
{
	...
	if (iParam0 != -1)
	{
		if (Global_1882206.f_7[iParam0 /*8*/].f_1 == 1)
		{
			if (IS_BIT_SET(Global_1882206.f_7[iParam0 /*8*/].f_5, 0))
			{
				func_26();
			
				if (Global_1882206.f_7[iParam0 /*8*/].f_7 == 0)
				{
					func_26();
				}
				else
				{
					Global_1882206.f_4 = Global_1882206.f_4 - 1;
				
					if (Global_1882206.f_4 < 0)
						Global_1882206.f_4 = 0;
				
					func_18();
				}
			}
		
			MISC::CLEAR_BIT(&(Global_1893070[PLAYER::PLAYER_ID() /*615*/].f_10.f_23), Global_1882206.f_7[iParam0 /*8*/].f_2);
			HUD::THEFEED_REMOVE_ITEM(Global_1882206.f_7[iParam0 /*8*/].f_4);
			func_17();
			func_15(0);
		}
		...
		{
			Global_1882206.f_7[i /*8*/] = { Global_1882206.f_7[i + 1 /*8*/] };
		}
	
		Global_1882206.f_7[9 /*8*/].f_1 = 0;
		Global_1882206.f_7[9 /*8*/].f_2 = _INVALID_PLAYER_INDEX();
	}
...
{
	if (!func_16(iParam0))
		MISC::SET_BIT(&(Global_1882206.f_3), iParam0);
...
{
	return IS_BIT_SET(Global_1882206.f_3, iParam0);
}

void func_17() // Position - 0x579 (1401)
{
	Global_1882206 = Global_1882206 - 1;
	return;
}
...
void func_19() // Position - 0x5AD (1453)
{
	if (!Global_21900 && !IS_BIT_SET(Global_9504, 9))
	{
		...
		{
			func_99(Global_21647, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_20(1);
			func_99(Global_21647, "DISPLAY_VIEW", 1f, BUILTIN::TO_FLOAT(Global_21646), -1082130432, -1082130432, -1082130432);
		}
	}
				...
				if (iParam0 == Global_9509[num /*15*/].f_11)
				{
					if (i == Global_9509[num /*15*/].f_4)
					{
						if (Global_10103[i] == 0)
						{
							...
							if (Global_2697084)
								if (num == 14)
									func_21(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9509[num /*15*/].f_10), BUILTIN::TO_FLOAT(Global_24103), -1f, &Global_9509[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_9509[num /*15*/].f_4)
					{
						if (Global_10103[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_21(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9509[num /*15*/].f_10), BUILTIN::TO_FLOAT(Global_24109), -1f, &Global_9509[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_80362)
								{
									...
									func_21(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9509[num /*15*/].f_10), BUILTIN::TO_FLOAT(value2), -1f, &Global_9509[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21666)
									...
									func_21(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9509[num /*15*/].f_10), BUILTIN::TO_FLOAT(value3), -1f, &Global_9509[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_9509[num /*15*/].f_10 == 57 && num == 25)
							{
								...
								func_21(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9509[num /*15*/].f_10), BUILTIN::TO_FLOAT(value6), -1f, &Global_9509[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_21(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9509[num /*15*/].f_10), BUILTIN::TO_FLOAT(0), -1f, &Global_9509[num /*15*/], 0, 0, 0, 0);
							}
...
{
	Global_1882206.f_1 = Global_1882206.f_1 - 1;

	if (Global_1882206.f_1 < 0)
		Global_1882206.f_1 = 0;
...
{
	if (Global_1893070[PLAYER::PLAYER_ID() /*615*/].f_10.f_27 == _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
		{
			Global_1893070[PLAYER::PLAYER_ID() /*615*/].f_10.f_27 = plParam0;
			Global_2733326.f_3989.f_229 = uParam1;
...
int func_31(int iParam0, int iParam1) // Position - 0xD84 (3460)
{
	...
	{
		if (Global_1882206.f_7[i /*8*/].f_7 == iParam1)
		{
			iParam0 = iParam0 - 1;
...
void func_33() // Position - 0xDD0 (3536)
{
	...
	player = Global_1882206.f_7[num /*8*/].f_2;

	if (!_NETWORK_IS_PLAYER_VALID(player, false, true) || plLocal_147 != player)
	{
		func_89(true);
		return;
	}
	...
	if (func_41(&uLocal_149))
	{
		func_89(true);
		return;
	}

	if (func_40(&uLocal_149))
	{
		func_13(num);
		func_89(true);
		return;
	...
	if (func_36(&uLocal_149))
	{
		...
		else if (Global_1882206.f_7[num /*8*/] == 0)
		{
			func_6(num);
		}
		else if (Global_1882206.f_7[num /*8*/] == 1)
		{
			func_34(num);
		}
		else
...
{
	MISC::SET_BIT(&Global_1836256, 15);
	func_13(iParam0);
	Global_1882206.f_6 = 0;
	func_7(0);
	return;
...
BOOL func_41(var uParam0) // Position - 0xFCE (4046)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21636))
		return false;
...
void func_43(var uParam0) // Position - 0x1034 (4148)
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21642) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_SCROLL_BACKWARD))
	{
		func_46();
		uParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21643) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_SCROLL_FORWARD))
	{
		func_44();
		uParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
...
{
	func_99(Global_21647, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
{
	func_99(Global_21647, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21655, true);
	func_47();
	return;
}
...
void func_49() // Position - 0x11C1 (4545)
{
	...
	if (func_36(&uLocal_149))
	{
		...
		iLocal_146 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(methodReturn);
		num = func_31(iLocal_146, 0);
	
		switch (Global_1882206.f_7[num /*8*/].f_1)
		{
			case 0:
				return;
	...
	if (func_40(&uLocal_149))
	{
		...
		iLocal_146 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(methodReturn2);
		num2 = func_31(iLocal_146, 0);
	
		switch (Global_1882206.f_7[num2 /*8*/].f_1)
		{
			case 0:
				return;
...
{
	if (func_16(iParam0))
		MISC::CLEAR_BIT(&(Global_1882206.f_3), iParam0);
...
void func_51() // Position - 0x12EA (4842)
{
	...
	func_99(Global_21647, "SET_DATA_SLOT_EMPTY", BUILTIN::TO_FLOAT(26), -1082130432, -1082130432, -1082130432, -1082130432);
	flag = false;
	num2 = func_31(iLocal_146, 0);
	plLocal_147 = Global_1882206.f_7[num2 /*8*/].f_2;
	player = Global_1882206.f_7[num2 /*8*/].f_2;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21647, "SET_DATA_SLOT");
	...
	if (Global_1882206.f_7[num2 /*8*/] == 0)
	{
		if (Global_262145.f_15460)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (num3 < 3)
				{
					if (Global_1893070[player /*615*/].f_10.f_12[i] != _INVALID_PLAYER_INDEX())
					{
						if (_NETWORK_IS_PLAYER_VALID(Global_1893070[player /*615*/].f_10.f_12[i], false, true))
						{
							unk16[num3] = Global_1893070[player /*615*/].f_10.f_12[i];
							num3 = num3 + 1;
						}
					}
				}
			...
			if (num3 == 0)
			{
				if (flag2)
					...
					func_22("BA_APP_BODY_TA" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en guardia.~s~*/);
			}
			else
			{
				TEXT_LABEL_ASSIGN_STRING(&componentType, "BA_APP_BODY_T4" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en guardia.~n~~n~Otros guardias:~n~~a~~s~*/, 16);
				...
				if (num3 == 2)
					if (flag2)
						...
						TEXT_LABEL_ASSIGN_STRING(&componentType, "BA_APP_BODY_T5" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en guardia.~n~~n~Otros guardias:~n~~a~~n~~a~~s~*/, 16);
				else if (num3 > 2)
					if (flag2)
						...
						TEXT_LABEL_ASSIGN_STRING(&componentType, "BA_APP_BODY_T6" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en guardia.~n~~n~Otros guardias:~n~~a~~n~~a~~n~~a~~s~*/, 16);
		...
		{
			if (Global_1882206.f_88[num2 /*5*/].f_1)
				if (Global_1882206.f_88[num2 /*5*/].f_2)
					TEXT_LABEL_ASSIGN_STRING(&componentType2, "BA_APP_BODY_T9" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en socio.~n~~n~- Salario: $~1~ ~n~- Socios: ~1~ ~n~- Tiene un yate ~n~- Tiene una oficina ~n~- Almacenes: ~1~ ~n~- Vehículos: ~1~*/, 16);
				else
					TEXT_LABEL_ASSIGN_STRING(&componentType2, "BA_APP_BODY_T8" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en guardia.~n~~n~- Salario: $~1~ ~n~- Guardias: ~1~ ~n~- Tiene un yate ~n~- No tiene oficina ~n~- Almacenes: ~1~ ~n~- Vehículos: ~1~*/, 16);
			else if (Global_1882206.f_88[num2 /*5*/].f_2)
				TEXT_LABEL_ASSIGN_STRING(&componentType2, "BA_APP_BODY_T7" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en socio.~n~~n~- Salario: $~1~ ~n~- Socios: ~1~ ~n~- No tiene un yate~n~- Tiene una oficina ~n~- Almacenes: ~1~ ~n~- Vehículos: ~1~*/, 16);
			else
				TEXT_LABEL_ASSIGN_STRING(&componentType2, "BA_APP_BODY_T10" /*~HUD_COLOUR_WHITE~Quiere que te conviertas en guardia.~n~~n~- Salario $~1~ ~n~- Guardias: ~1~ ~n~- No tiene yate~n~- No tiene oficina ~n~- Almacenes: ~1~ ~n~- Vehículos: ~1~*/, 16);
		
			GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&componentType2);
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1882206.f_88[num2 /*5*/]);
			HUD::ADD_TEXT_COMPONENT_INTEGER(func_78(player));
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1882206.f_88[num2 /*5*/].f_3);
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1882206.f_88[num2 /*5*/].f_4);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		}
	}
	else if (Global_1882206.f_7[num2 /*8*/] == 1)
	{
		GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("BA_APP_BODY_DM2" /*~HUD_COLOUR_WHITE~El VIP de la organización ~a~ te desafió a una partida a muerte VIP.~s~*/);
		HUD::SET_COLOUR_OF_NEXT_TEXT_COMPONENT(func_80(Global_1882206.f_7[num2 /*8*/].f_2));
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_63(Global_1882206.f_7[num2 /*8*/].f_2));
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	}

	if (flag)
	{
		num = func_57(Global_1882206.f_7[num2 /*8*/].f_2);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_99(Global_21647, "DISPLAY_VIEW", BUILTIN::TO_FLOAT(26), -1082130432, -1082130432, -1082130432, -1082130432);
	func_55(&uLocal_138);
	func_52(13, &uLocal_130, 12, &uLocal_134, 4, &uLocal_122, &uLocal_149);
	iLocal_121 = 1;
	return;
}
...
void func_53(int iParam0, int iParam1, const char* sParam2, int iParam3, int* piParam4, int iParam5) // Position - 0x1669 (5737)
{
	if (iParam1 == 1)
	{
		func_21(Global_21647, "SET_SOFT_KEYS", BUILTIN::TO_FLOAT(iParam0), 0f, BUILTIN::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_21654)
	{
		func_21(Global_21647, "SET_SOFT_KEYS", BUILTIN::TO_FLOAT(iParam0), 1f, BUILTIN::TO_FLOAT(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		MISC::SET_BIT(piParam4, iParam3);
		func_54(iParam5, true);
		return;
	}

	func_21(Global_21647, "SET_SOFT_KEYS", BUILTIN::TO_FLOAT(iParam0), 1f, BUILTIN::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	MISC::SET_BIT(piParam4, iParam3);
	func_54(iParam5, true);
	return;
}
...
{
	func_56(Global_21647, "SET_HEADER", sParam0, 0, 0, 0, 0);
	return;
}
...
const char* func_63(Player plParam0) // Position - 0x19E3 (6627)
{
	...
	{
		str = func_72(&(Global_1893070[plParam0 /*615*/].f_10.f_106));
		return str;
	}
	...
	if (player != _INVALID_PLAYER_INDEX())
	{
		str = func_72(&(Global_1893070[player /*615*/].f_10.f_106));
...
BOOL func_76(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x1D46 (7494)
{
	...
	if (func_30(player) && Global_1893070[player /*615*/].f_10.f_433 == iParam2)
		return 1;
...
{
	if (func_30(plParam0))
		if (func_30(Global_1893070[plParam0 /*615*/].f_10))
...
int func_83(Player plParam0) // Position - 0x1F38 (7992)
{
	if (func_30(plParam0))
		if (func_84(plParam0, true))
			return Global_2649164.f_818.f_11[func_65(plParam0)];
...
BOOL func_84(Player plParam0, BOOL bParam1) // Position - 0x1F68 (8040)
{
	...
	return func_30(Global_1893070[plParam0 /*615*/].f_10);
}
...
void func_89(BOOL bParam0) // Position - 0x2038 (8248)
{
	...
	plLocal_147 = _INVALID_PLAYER_INDEX();
	...
	func_90();
	func_99(Global_21647, "DISPLAY_VIEW", BUILTIN::TO_FLOAT(25), BUILTIN::TO_FLOAT(value), -1082130432, -1082130432, -1082130432);
	...
	if (flag)
		func_52(13, &uLocal_126, 12, &uLocal_134, 4, &uLocal_122, &uLocal_149);
	else
		func_52(1, "", 1, "", 4, &uLocal_122, &uLocal_149);
...
void func_90() // Position - 0x2122 (8482)
{
	...
	func_99(Global_21647, "SET_DATA_SLOT_EMPTY", BUILTIN::TO_FLOAT(25), -1082130432, -1082130432, -1082130432, -1082130432);

	for (i = 0; i < func_32(); i = i + 1)
	{
		if (Global_1882206.f_7[i /*8*/].f_1 == 1 && Global_1882206.f_7[i /*8*/].f_7 == 0)
		{
			switch (Global_1882206.f_7[i /*8*/])
			{
				case 0:
					if (func_94(i, num))
						num = num + 1;
...
void func_91() // Position - 0x21D7 (8663)
{
	...
	if (func_85(PLAYER::PLAYER_ID()))
		...
		func_22("BA_APP_NONE" /*No hay invitaciones de VIP*/);
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x2235 (8757)
{
	...
	if (Global_1882206.f_7[iParam0 /*8*/].f_2 == _INVALID_PLAYER_INDEX() || !_NETWORK_IS_PLAYER_VALID(Global_1882206.f_7[iParam0 /*8*/].f_2, false, true))
		return false;

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21647, "SET_DATA_SLOT");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(25);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	unk = { func_86(Global_1882206.f_7[iParam0 /*8*/].f_2) };
	func_93(&unk);
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("BA_APP_BODY_DM1" /*Te desafió a una partida a muerte VIP.*/);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
	value = HUD_COLOUR_WHITE;
	num = func_83(Global_1882206.f_7[iParam0 /*8*/].f_2);
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x22F2 (8946)
{
	...
	unk = { func_86(Global_1882206.f_7[iParam0 /*8*/].f_2) };
	func_93(&unk);
	flag = func_79(Global_1882206.f_7[iParam0 /*8*/].f_2);
	value = func_78(Global_1882206.f_7[iParam0 /*8*/].f_2);
	...
	if (value == 0)
	{
		if (flag)
			...
			func_22("BA_APP_BODY_T" /*Quiere que te conviertas en guardia*/);
	}
	else if (value == 1)
	{
		if (flag)
			...
			GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("BA_APP_BODY_T3" /*Quiere que te conviertas en guardia.~n~~1~ más en esta organización.*/);
	...
	else
	{
		if (flag)
			...
			GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("BA_APP_BODY_T2" /*Quiere que te conviertas en guardia.~n~~1~ más en esta organización.*/);
...
int func_98() // Position - 0x25BA (9658)
{
	...
	for (i = 0; i < func_32(); i = i + 1)
	{
		if (Global_1882206.f_7[i /*8*/].f_7 == 1)
			num = num + 1;
	}
