...
int func_51(ePedComponentType epctParam0) // Position - 0x19F3 (6643)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		return Global_1845274[epctParam0 /*877*/].f_872;
...
BOOL func_94(Player plParam0, int iParam1) // Position - 0x269D (9885)
{
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_95(-1, false) == CHAR_MIKE_FRANK_CONF;
	else
...
eCharacter func_95(int iParam0, BOOL bParam1) // Position - 0x26F6 (9974)
{
...
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("SB_HELI_TOURS_seating", Global_2658019[PLAYER::PLAYER_ID() /*467*/].f_324.f_11, true, 0))
		return false;
...
void func_106(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2904 (10500)
{
	...
	{
		case 0:
			*uParam1 = { func_107(-1157.9813f, -1540.5574f, -50f, -90f, 0, 0) };
			*uParam2 = -90f;
			break;
	
		case 1:
			*uParam1 = { func_107(-1157.9813f, -1540.5574f, -50f, -90f, 0, 1) };
			*uParam2 = -90f;
			break;
	
		case 2:
			*uParam1 = { func_107(-1157.9813f, -1540.5574f, -50f, -90f, 0, 2) };
			*uParam2 = -90f;
			break;
	}
...
void func_109() // Position - 0x2A26 (10790)
{
	return;
}

int func_110(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2A2E (10798)
{
	int i;
...
BOOL func_111(BOOL bParam0) // Position - 0x2B44 (11076)
{
	bParam0;
