...
BOOL func_15(int iParam0) // Position - 0x5B9 (1465)
{
	...
	if (!MISC::ARE_STRINGS_EQUAL(&Global_113637[iParam0 /*28*/], "") && !MISC::IS_STRING_NULL(&Global_113637[iParam0 /*28*/]))
		if (IS_BIT_SET(Global_113637[iParam0 /*28*/].f_27, 1))
			if (IS_BIT_SET(Global_113637[iParam0 /*28*/].f_27, 2))
				return func_19(num, &Global_113637[iParam0 /*28*/], &(Global_113637[iParam0 /*28*/].f_4), Global_113637[iParam0 /*28*/].f_20);
			else
				return func_18(num, &Global_113637[iParam0 /*28*/], &(Global_113637[iParam0 /*28*/].f_4));
		else if (IS_BIT_SET(Global_113637[iParam0 /*28*/].f_27, 2))
			return func_17(num, &Global_113637[iParam0 /*28*/], Global_113637[iParam0 /*28*/].f_20);
		else
			return func_16(num, &Global_113637[iParam0 /*28*/]);
...
int func_26(int iParam0) // Position - 0xB70 (2928)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_114990.f_10058.f_108, func_30(func_31(iParam0), i)))
				outValue = outValue + 1;
		}
	}
	else if (iParam0 == 6)
...
{
	if (Global_80630 != bParam0)
		Global_80630 = bParam0;
...
void func_62() // Position - 0x196F (6511)
{
	...
	Global_114990.f_10058.f_122.f_2 = 1;
...
void func_73() // Position - 0x2C6F (11375)
{
	...
	Global_114990.f_10058.f_122.f_2 = 0;
