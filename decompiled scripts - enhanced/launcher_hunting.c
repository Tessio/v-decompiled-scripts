...
ePedComponentType func_83() // Position - 0x765E (30302)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x76A2 (30370)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x855C (34140)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
void func_198(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD0CB (53451)
{
...
BOOL func_209(Any* panParam0, BOOL bParam1) // Position - 0xD52D (54573)
{
	...
	if (func_246(*panParam0) || func_244(*panParam0) || Global_80014 == true)
		return true;
...
int func_254(Ped pedParam0, eCharacter echParam1) // Position - 0xF38E (62350)
{
	int num;
