...
BOOL func_91(ePedComponentType epctParam0, int iParam1) // Position - 0x455B (17755)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
void func_119(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x67C9 (26569)
{
	if (func_116(&Global_79152.f_555[0 /*21*/], iParam0))
	{
...
eCharacter func_125(Vehicle veParam0) // Position - 0x6ABD (27325)
{
	int i;
...
int func_134(Vector3 vParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0x72C2 (29378)
{
	int i;
...
void func_151(int iParam0, BOOL bParam1) // Position - 0x7989 (31113)
{
