...
ePedComponentType func_83() // Position - 0x76BC (30396)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x7700 (30464)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x85BB (34235)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
void func_212(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC7E (56446)
{
...
BOOL func_226(Any* panParam0, BOOL bParam1) // Position - 0xE1C6 (57798)
{
	...
	if (func_263(*panParam0) || func_261(*panParam0) || Global_80014 == true)
		return true;
...
int func_285(Ped pedParam0, eCharacter echParam1) // Position - 0x10967 (67943)
{
	int num;
