...
void main() // Position - 0x0 (0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		while (iLocal_57 == 0)
		{
			...
			{
				iLocal_57.f_1 = func_45(uScriptParam_0);
				iLocal_57.f_2 = func_44();
				iLocal_57 = 1;
			}
			else
			{
	...
	while (true)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1576972 == 0 || func_28())
			func_25();
...
void func_1() // Position - 0xE4 (228)
{
	...
	if (iLocal_56 == 1)
	{
		...
		if (num > -1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_60[num /*49*/]) && !ENTITY::IS_ENTITY_DEAD(uLocal_60[num /*49*/], false))
			{
				AUDIO::PLAY_STREAM_FROM_PED(uLocal_60[num /*49*/]);
				iLocal_56 = iLocal_56 + 1;
			}
		}
	}
	...
	if (iLocal_56 == 2)
	{
		...
		{
			num2 = BUILTIN::TO_FLOAT(iLocal_57.f_1) / 5f;
...
int func_2() // Position - 0x16F (367)
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (uLocal_60[i /*49*/].f_48 <= iLocal_57.f_1)
		{
			num2 = BUILTIN::VDIST(uLocal_60[i /*49*/].f_40, 945f, 15f, 117f);
...
void func_3() // Position - 0x1D4 (468)
{
	int i;

	for (i = 0; i < 50; i = i + 1)
	{
		if (func_22(&uLocal_60[i /*49*/]))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_60[i /*49*/]))
				func_12(&uLocal_60[i /*49*/], i);
			else if (ENTITY::IS_ENTITY_DEAD(uLocal_60[i /*49*/], false))
				func_11(&uLocal_60[i /*49*/]);
		
			func_4(&uLocal_60[i /*49*/]);
		}
	}
...
void func_4(var uParam0) // Position - 0x23E (574)
{
...
void func_5(var uParam0) // Position - 0x264 (612)
{
	char* animDict;
	char* animName;
...
BOOL func_6(var uParam0) // Position - 0x431 (1073)
{
	switch (uParam0->f_44)
	{
		case 2:
...
BOOL func_7(var uParam0) // Position - 0x44D (1101)
{
	switch (uParam0->f_44)
	{
		case 0:
...
char* func_8(var uParam0) // Position - 0x51D (1309)
{
	if (func_9(uParam0))
	{
		switch (uParam0->f_44)
...
BOOL func_9(var uParam0) // Position - 0x706 (1798)
{
	switch (uParam0->f_2)
	{
		case 0:
...
char* func_10(var uParam0) // Position - 0x830 (2096)
{
	switch (uParam0->f_44)
	{
		case 0:
...
void func_11(Ped* ppedParam0) // Position - 0xB78 (2936)
{
...
void func_12(var uParam0, int iParam1) // Position - 0xBA3 (2979)
{
	ePedComponentType i;
		...
		if (uParam0->f_46 && func_20(uParam0))
		{
			...
			*uParam0 = PED::CREATE_PED(PED_TYPE_MISSION, func_19(uParam0), uParam0->f_40, uParam0->f_43, false, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
				...
				if (iParam1 + 1 < 50)
					if (func_19(&uLocal_60[iParam1 + 1 /*49*/]) != func_19(uParam0))
...
char* func_13(var uParam0) // Position - 0xD3E (3390)
{
	switch (uParam0->f_44)
	{
		case 3:
...
Vector3 func_14(var uParam0) // Position - 0xEF3 (3827)
{
	switch (uParam0->f_44)
	{
		case 1:
...
int func_15(var uParam0) // Position - 0xF3F (3903)
{
	switch (uParam0->f_44)
	{
		case 1:
...
Hash func_16(var uParam0) // Position - 0xFC3 (4035)
{
	switch (uParam0->f_44)
	{
		case 1:
...
BOOL func_17(var uParam0) // Position - 0x1035 (4149)
{
	switch (uParam0->f_44)
	{
		case 1:
...
void func_18(var uParam0) // Position - 0x109F (4255)
{
...
Hash func_19(var uParam0) // Position - 0x1125 (4389)
{
	switch (uParam0->f_2)
	{
		case 0:
...
int func_20(var uParam0) // Position - 0x12C2 (4802)
{
	if (func_22(uParam0))
	{
...
void func_21(var uParam0) // Position - 0x133A (4922)
{
	if (func_22(uParam0))
	{
...
BOOL func_22(var uParam0) // Position - 0x138A (5002)
{
...
var func_23() // Position - 0x13B3 (5043)
{
	var unk;
...
BOOL func_24(float fParam0, var uParam1, var uParam2) // Position - 0x13C3 (5059)
{
...
void func_25() // Position - 0x13ED (5101)
{
	if (AUDIO::IS_STREAM_PLAYING())
		AUDIO::STOP_STREAM();
...
void func_26() // Position - 0x1408 (5128)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_27() // Position - 0x1414 (5140)
{
	int i;
...
BOOL func_28() // Position - 0x1439 (5177)
{
	return !Global_1576968 && NETWORK::NETWORK_IS_ACTIVITY_SESSION();
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x144F (5199)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x14D3 (5331)
{
	switch (func_32())
	{
		case 0:
...
Hash func_31() // Position - 0x1506 (5382)
{
...
BOOL func_33() // Position - 0x1535 (5429)
{
	return Global_2685155.f_726;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x1544 (5444)
{
...
BOOL func_35() // Position - 0x155B (5467)
{
	return Global_2697089;
}

BOOL func_36() // Position - 0x1567 (5479)
{
...
void func_38(BOOL bParam0) // Position - 0x1583 (5507)
{
	func_27();
...
void func_39() // Position - 0x1598 (5528)
{
	int i;

	for (i = 0; i < 50; i = i + 1)
	{
		func_40(&uLocal_60[i /*49*/], i);
	}

	return;
}

void func_40(var uParam0, int iParam1) // Position - 0x15BF (5567)
{
	switch (func_43())
	{
		case 0:
...
void func_41(var uParam0, int iParam1) // Position - 0x15F2 (5618)
{
	switch (iParam1)
	{
		case 0:
...
void func_42(var uParam0, int iParam1) // Position - 0x4D90 (19856)
{
	switch (iParam1)
	{
		case 0:
...
int func_43() // Position - 0x83FE (33790)
{
	var unk;
...
int func_44() // Position - 0x840E (33806)
{
	if (Global_1576968)
		return 1;
...
{
	if (uParam0 >= Global_262145.f_26715)
		return 5;
	else if (uParam0 >= Global_262145.f_26714)
		return 4;
...
void func_46() // Position - 0x8474 (33908)
{
	while (!NETWORK::NETWORK_TRY_TO_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, Global_1576987))
	{
		BUILTIN::WAIT(0);
	}

	Global_1576987 = Global_1576987 + 1;
	func_47(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_57, 3, 0);
	return;
}

int func_47(int iParam0, int iParam1, BOOL bParam2) // Position - 0x84AD (33965)
{
	int i;
