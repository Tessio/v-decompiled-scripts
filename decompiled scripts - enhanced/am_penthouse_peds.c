...
{
	return !Global_1576962 && NETWORK::NETWORK_IS_ACTIVITY_SESSION();
}
...
{
	while (!NETWORK::NETWORK_TRY_TO_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, Global_1576981))
	{
		BUILTIN::WAIT(0);
	}

	Global_1576981 = Global_1576981 + 1;
	func_47(0, -1, false);
