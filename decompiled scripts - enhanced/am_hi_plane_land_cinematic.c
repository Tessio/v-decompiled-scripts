...
BOOL func_145(int iParam0) // Position - 0xC383 (50051)
{
	int num;
...
BOOL func_146(int iParam0) // Position - 0xC3A8 (50088)
{
	int num;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0xC3C6 (50118)
{
