...
void func_22(int iParam0, BOOL bParam1) // Position - 0xBAF (2991)
{
	...
	{
		func_192(&(Global_114018[flag /*10*/].f_9));
	}
	...
	func_178(flag, 1, false, false);
	func_177(0, 0);
	TEXT_LABEL_COPY(&unk, { func_175(flag) }, 4);
...
BOOL func_78(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x56F6 (22262)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_70(hParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_70(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_70(hParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_70(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_70(hParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_70(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_70(hParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_70(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_79(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x5973 (22899)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_80(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x5D98 (23960)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<2> func_175(BOOL bParam0) // Position - 0x2071B (132891)
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_176(bParam0) };
...
void func_178(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20BE8 (134120)
{
	...
	if (iParam1 == 1)
		func_179(bParam0, bParam2, bParam3);
...
void func_180(const char* sParam0, Any anParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x20CC4 (134340)
{
...
void func_190(Vehicle veParam0, int iParam1) // Position - 0x22360 (140128)
{
...
BOOL func_221() // Position - 0x27784 (161668)
{
...
struct<2> func_359(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2FBDF (195551)
{
	var unk;
	BOOL flag;
	...
	{
		case 1:
			unk = { func_367(bParam0) };
			break;
	
		case 7:
			unk = { func_175(bParam0) };
			break;
		...
		case 3:
			...
			switch (flag)
			{
				...
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_360(flag), 8);
					break;
			}
			break;
...
char* func_360(BOOL bParam0) // Position - 0x2FCB5 (195765)
{
	switch (bParam0)
	{
		case false:
...
struct<2> func_367(BOOL bParam0) // Position - 0x2FF5F (196447)
{
	var unk;
...
BOOL func_430() // Position - 0x31EC2 (204482)
{
	int num;
	int num2;
