		...
		if (!func_106(false) && !func_105(14))
		{
			if (iLocal_45 == 0)
			{
				if (func_115())
				{
					...
					bLocal_459 = IS_BIT_SET(Global_9076, 28);
...
{
	Global_114370.f_10053.f_135[1] = -1;
	return;
}
...
{
	Global_79551[1 /*14*/] = { func_10(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_9(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 0, 1);
		else
			func_9(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 2, Global_79551[1 /*14*/].f_1, 1, 0);
...
void func_12(int iParam0) // Position - 0x175C (5980)
{
	...
	func_13(&Global_79551[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_16(func_20(iParam1, iParam0->f_2), Global_79548);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_16(func_15(iParam1, iParam0->f_2), Global_79548);
...
BOOL func_22(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x39A6 (14758)
{
...
int func_23(int iParam0) // Position - 0x667E (26238)
{
	switch (iParam0)
	{
		case -1:
...
void func_24(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x6752 (26450)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_13(&Global_79551[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_13(&Global_79551[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_13(&Global_79551[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79749)
		{
			...
			func_13(&Global_79551[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_25(iParam0));
...
int func_25(int iParam0) // Position - 0x69D7 (27095)
{
	switch (iParam0)
	{
		case 0:
...
void func_26(int iParam0) // Position - 0x6A87 (27271)
{
	BOOL flag;
	int num;
	var unk;
...
void func_27(int iParam0) // Position - 0x6BCA (27594)
{
	BOOL flag;
	int num;
	var unk;
...
void func_28(int iParam0) // Position - 0x70D6 (28886)
{
	BOOL flag;
	int num;
	var unk;
...
void func_29(int iParam0) // Position - 0x7149 (29001)
{
	BOOL flag;
	int num;
	var unk;
...
void func_30(int iParam0) // Position - 0x71BB (29115)
{
	BOOL flag;
	int num;
	var unk;
...
void func_31(int iParam0) // Position - 0x72A2 (29346)
{
	BOOL flag;
	int num;
	var unk;
...
void func_32(int iParam0) // Position - 0x75C3 (30147)
{
	BOOL flag;
	int num;
	var unk;
...
void func_33(int iParam0) // Position - 0x77C2 (30658)
{
	BOOL flag;
	int num;
	var unk;
...
void func_34(int iParam0) // Position - 0x79D2 (31186)
{
	BOOL flag;
	int num;
	var unk;
...
void func_35(int iParam0) // Position - 0x7AD4 (31444)
{
	BOOL flag;
	int num;
	var unk;
...
void func_36(int iParam0) // Position - 0x845C (33884)
{
	BOOL flag;
	int num;
	var unk;
...
void func_37(int iParam0) // Position - 0x8F99 (36761)
{
	if (iParam0 < 136)
		func_39(iParam0);
	else
...
void func_38(int iParam0) // Position - 0x8FCE (36814)
{
	BOOL flag;
	int num;
	var unk;
...
void func_39(int iParam0) // Position - 0x9BD2 (39890)
{
	BOOL flag;
	int num;
	var unk;
...
void func_40(int iParam0) // Position - 0xAAC4 (43716)
{
	BOOL flag;
	int num;
	var unk;
...
void func_41(int iParam0) // Position - 0xABF1 (44017)
{
	BOOL flag;
	int num;
	var unk;
...
void func_42(int iParam0, int iParam1) // Position - 0xACE1 (44257)
{
	switch (iParam0)
	{
		case 0:
...
void func_43(int iParam0) // Position - 0xADD1 (44497)
{
	BOOL flag;
	int num;
	var unk;
...
void func_44(int iParam0) // Position - 0xC27B (49787)
{
	BOOL flag;
	int num;
	var unk;
...
void func_45(int iParam0) // Position - 0xC3B8 (50104)
{
	BOOL flag;
	int num;
	var unk;
...
void func_46(int iParam0) // Position - 0xC8C1 (51393)
{
	BOOL flag;
	int num;
	var unk;
...
void func_47(int iParam0) // Position - 0xCF25 (53029)
{
	BOOL flag;
	int num;
	var unk;
...
void func_48(int iParam0) // Position - 0xCF97 (53143)
{
	BOOL flag;
	int num;
	var unk;
...
void func_49(int iParam0) // Position - 0xD067 (53351)
{
	BOOL flag;
	int num;
	var unk;
...
void func_50(int iParam0) // Position - 0xD52D (54573)
{
	BOOL flag;
	int num;
	var unk;
...
void func_51(int iParam0) // Position - 0xD6B8 (54968)
{
	BOOL flag;
	int num;
	var unk;
...
void func_52(int iParam0) // Position - 0xDE98 (56984)
{
	BOOL flag;
	int num;
	var unk;
...
void func_53(int iParam0) // Position - 0xDF9A (57242)
{
	BOOL flag;
	int num;
	var unk;
...
void func_54(int iParam0) // Position - 0xEEB5 (61109)
{
	BOOL flag;
	int num;
	var unk;
...
void func_55(int iParam0) // Position - 0xFB52 (64338)
{
	if (iParam0 < 107)
		func_58(iParam0);
	else if (iParam0 < 227)
...
void func_56(int iParam0) // Position - 0xFB98 (64408)
{
	BOOL flag;
	int num;
	var unk;
...
void func_57(int iParam0) // Position - 0x1063D (67133)
{
	BOOL flag;
	int num;
	var unk;
...
void func_58(int iParam0) // Position - 0x1142A (70698)
{
	BOOL flag;
	int num;
	var unk;
...
void func_59(int iParam0) // Position - 0x1205F (73823)
{
	BOOL flag;
	int num;
	var unk;
...
void func_60(int iParam0) // Position - 0x122D6 (74454)
{
	BOOL flag;
	int num;
	var unk;
...
void func_61(int iParam0, int iParam1) // Position - 0x12408 (74760)
{
	switch (iParam0)
	{
		case 0:
...
void func_62(int iParam0) // Position - 0x124F8 (75000)
{
	BOOL flag;
	int num;
	var unk;
...
void func_63(int iParam0) // Position - 0x1322A (78378)
{
	BOOL flag;
	int num;
	var unk;
...
void func_64(int iParam0) // Position - 0x1338E (78734)
{
	BOOL flag;
	int num;
	var unk;
...
void func_65(int iParam0) // Position - 0x138F9 (80121)
{
	BOOL flag;
	int num;
	var unk;
...
void func_66(int iParam0) // Position - 0x13E1F (81439)
{
	BOOL flag;
	int num;
	var unk;
...
void func_67(int iParam0) // Position - 0x13E91 (81553)
{
	BOOL flag;
	int num;
	var unk;
...
void func_68(int iParam0) // Position - 0x13F61 (81761)
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x178D5 (96469)
{
	...
	switch (iParam0)
	{
		case joaat("Player_Zero"):
			if (!bParam3 || IS_BIT_SET(Global_114370.f_7233[1], 0))
				MISC::SET_BIT(&Global_114370.f_2367.f_539.f_3816[0 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	
		case joaat("Player_Two"):
			if (!bParam3 || IS_BIT_SET(Global_114370.f_7233[3], 0))
				MISC::SET_BIT(&Global_114370.f_2367.f_539.f_3816[1 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
		
			if (!bParam3 || IS_BIT_SET(Global_114370.f_7233[4], 0))
				MISC::SET_BIT(&Global_114370.f_2367.f_539.f_3816[2 /*166*/][iParam1 /*11*/][iParam2 / 32], iParam2 % 32);
			break;
	}
...
int func_81(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x179B5 (96693)
{
	...
	if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_79551[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 1, Global_79551[1 /*14*/].f_1, 1, 0);
		...
		{
			func_9(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 1, Global_79551[1 /*14*/].f_1, 0, 1);
		}
...
int func_84(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x187F1 (100337)
{
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_25(iParam2));
...
int func_93(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1AEAE (110254)
{
	...
	{
		if (bParam3)
			func_9(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 0, Global_79551[1 /*14*/].f_1, 1, 0);
		else
			func_9(iParam1, Global_79551[1 /*14*/].f_5, Global_79551[1 /*14*/].f_2, 0, Global_79551[1 /*14*/].f_1, 0, 1);
...
BOOL func_95(int iParam0) // Position - 0x1AF73 (110451)
{
	...
	return IS_BIT_SET(Global_114370.f_10053.f_135[num], num2);
}
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x1AFAD (110509)
{
	...
	if (bParam1)
		MISC::SET_BIT(&Global_114370.f_10053.f_135[num], offset);
	else
		MISC::CLEAR_BIT(&Global_114370.f_10053.f_135[num], offset);
...
BOOL func_107() // Position - 0x1B335 (111413)
{
	...
	if (Global_114370.f_10053.f_135[1] == -1)
		return true;
	...
	if (num > 0)
	{
		...
		{
			if (Global_114370.f_10053.f_135[i] != -1)
				return false;
		}
	}

	if (num2 == 31)
		return Global_114370.f_10053.f_135[num] == -1;

	return Global_114370.f_10053.f_135[num] == BUILTIN::ROUND(BUILTIN::POW(2f, BUILTIN::TO_FLOAT(num2 + 1))) - 1;
}
