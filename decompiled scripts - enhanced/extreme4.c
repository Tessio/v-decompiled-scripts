...
void func_10(int iParam0, BOOL bParam1) // Position - 0x5DB (1499)
{
	...
	{
		func_182(&(Global_114018[flag /*10*/].f_9));
	}
	...
	func_168(flag, 1, false, false);
	func_167(0, 0);
	TEXT_LABEL_COPY(&unk, { func_165(flag) }, 4);
...
BOOL func_68(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x519B (20891)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_60(hParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_60(hParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_60(hParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_60(hParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_60(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_69(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x5418 (21528)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_70(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x583D (22589)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<2> func_165(BOOL bParam0) // Position - 0x2044C (132172)
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_166(bParam0) };
...
void func_168(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20919 (133401)
{
	...
	if (iParam1 == 1)
		func_169(bParam0, bParam2, bParam3);
...
void func_170(const char* sParam0, Any anParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x209F5 (133621)
{
...
void func_180(Vehicle veParam0, int iParam1) // Position - 0x22091 (139409)
{
...
BOOL func_212() // Position - 0x274F2 (161010)
{
...
struct<2> func_308(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2B4CA (177354)
{
	var unk;
	BOOL flag;
...
char* func_309(BOOL bParam0) // Position - 0x2B5A0 (177568)
{
	switch (bParam0)
	{
		case false:
...
struct<2> func_316(BOOL bParam0) // Position - 0x2B82F (178223)
{
	var unk;
...
BOOL func_362() // Position - 0x2CB76 (183158)
{
	int num;
	int num2;
