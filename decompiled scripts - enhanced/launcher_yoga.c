...
void func_5(char* sParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xABA (2746)
{
...
void func_26(ePedComponentType epctParam0) // Position - 0xF22 (3874)
{
	int num;
	int num2;
	int num3;
...
int func_28(ePedComponentType epctParam0) // Position - 0xFFE (4094)
{
	int i;
...
int func_34(ePedComponentType epctParam0) // Position - 0x115E (4446)
{
	int i;
...
void func_89(float fParam0, int iParam1) // Position - 0x2863 (10339)
{
	func_90(fParam0, iParam1);
	return;
}
