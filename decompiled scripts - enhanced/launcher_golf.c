					...
					else
					{
						...
						if (flag3)
						{
							...
							if (iLocal_135 > iLocal_136)
							{
								if (clockHours < iLocal_135 && clockHours >= iLocal_136)
								{
									...
									if (fLocal_110 < (fLocal_134 * fLocal_134) + 4f)
									{
										...
										{
											func_55("MG_NA_TIME" /*La actividad no está disponible en este momento. Vuelve de ~1~:00 a ~1~:00 para participar en ella.*/, iLocal_135, iLocal_136);
							...
							if (flag3 && _GET_PLAYER_CASH(_GET_CURRENT_PLAYER_CHARACTER()) < iLocal_137)
							{
								...
								{
									func_47("MG_YOU_IS_BROKE" /*No puedes pagar esta actividad. Necesitas $~1~ para iniciarla.*/, iLocal_137, -1);
...
void func_39() // Position - 0x158F (5519)
{
	...
	if (iLocal_137 > 0)
	{
		...
		{
			iLocal_137 = 0;
			sLocal_118 = "PLAY_GOLF" /*Presiona ~INPUT_CONTEXT~ para jugar golf.*/;
		}
	}
...
{
	TEXT_LABEL_ASSIGN_STRING(&uLocal_70, "golf" /*Club de golf GW*/, 64);
	iLocal_116 = 2;
	fLocal_134 = 7f;
	...
	else
	{
		...
		sLocal_118 = "PAY_PLAY_GOLF" /*Presiona ~INPUT_CONTEXT~ para jugar golf. Precio de entrada: $~1~.*/;
	}
