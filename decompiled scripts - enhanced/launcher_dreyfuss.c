...
void func_202(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD4CB (54475)
{
...
BOOL func_212(Any* panParam0, BOOL bParam1) // Position - 0xD8F3 (55539)
{
	...
	if (func_249(*panParam0) || func_247(*panParam0) || Global_80608 == true)
		return true;
...
int func_265(Ped pedParam0, eCharacter echParam1) // Position - 0x13A78 (80504)
{
	int num;
