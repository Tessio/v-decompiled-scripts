...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (flag != -1)
		{
			if (Global_114018[flag /*10*/].f_9 != -1)
			{
				...
				func_300(&(Global_114018[flag /*10*/].f_9));
			}
		}
	...
	if (!func_279(&unk63, &flag, vector, 1f))
	{
		func_278();
	...
	while (true)
	{
		...
		func_211(flag);
		func_204(&iLocal_96, &(flag.f_9), vector);
	
		if (flag == 8)
			func_200(&flag, vector, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
	
		if (func_194(&flag, 0) || func_182())
		{
			if (!func_2(&flag))
				func_282(&flag, true);
...
void func_4(BOOL bParam0) // Position - 0x3EE (1006)
{
	int num;
	BOOL flag;
...
void func_6(BOOL bParam0) // Position - 0x5FB (1531)
{
	switch (bParam0)
	{
		case 2:
...
int func_28(var uParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x28E7 (10471)
{
...
BOOL func_29(ePedComponentType epctParam0) // Position - 0x2927 (10535)
{
	int i;
...
void func_30(var uParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x2955 (10581)
{
...
int func_31(ePedComponentType epctParam0) // Position - 0x2A31 (10801)
{
	int i;
...
eCharacter func_32(ePedComponentType epctParam0) // Position - 0x2A73 (10867)
{
	int i;
...
int func_33(ePedComponentType epctParam0, eCharacter echParam1, int iParam2) // Position - 0x2AD6 (10966)
{
	int i;
...
void func_37(ePedComponentType epctParam0, var uParam1) // Position - 0x2E0E (11790)
{
	int i;
...
Vector3 func_97(ePedComponentType epctParam0, int iParam1) // Position - 0x8996 (35222)
{
	switch (iParam1)
	{
		case 0:
...
void func_121(BOOL bParam0, var uParam1) // Position - 0x9726 (38694)
{
	switch (bParam0)
	{
		case 0:
...
void func_126(BOOL bParam0) // Position - 0xAE84 (44676)
{
	if (bParam0 < 63)
	{
		func_127();
...
void func_128(ePedComponentType epctParam0) // Position - 0xAEE2 (44770)
{
	int num;
	int num2;
	int num3;
...
int func_130(ePedComponentType epctParam0) // Position - 0xAFBE (44990)
{
	int i;
...
int func_136(ePedComponentType epctParam0) // Position - 0xB11E (45342)
{
	int i;
...
eCharacter func_148(int iParam0, BOOL bParam1) // Position - 0xB62D (46637)
{
	eCharacter character;
	int num;
...
BOOL func_172(BOOL bParam0) // Position - 0xBC98 (48280)
{
	int num;
...
void func_173(BOOL bParam0) // Position - 0xBCDD (48349)
{
...
BOOL func_179() // Position - 0xC0AA (49322)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

BOOL func_180(const char* sParam0, int iParam1) // Position - 0xC0BB (49339)
{
	int num;
	const char* str;
	Hash hashKey;
...
void func_211(BOOL bParam0) // Position - 0xD8AD (55469)
{
	if (bParam0 == -1)
		bParam0 = func_179();
...
BOOL func_243(BOOL bParam0) // Position - 0xF0DD (61661)
{
	if (bParam0 == -1)
		bParam0 = func_179();
...
BOOL func_244(BOOL bParam0) // Position - 0xF172 (61810)
{
...
BOOL func_247(BOOL bParam0) // Position - 0xF1F1 (61937)
{
	if (func_248() && Global_102454.f_11 == 6 && bParam0 == func_180(&(Global_102454.f_3), 0))
		return true;
...
BOOL func_249(BOOL bParam0) // Position - 0xF263 (62051)
{
	if (func_119(false))
...
int func_265(ePedComponentType epctParam0, eCharacter echParam1) // Position - 0x13A57 (80471)
{
	int num;
...
BOOL func_269(BOOL bParam0) // Position - 0x13B34 (80692)
{
	var unk;
	eCharacter character;
...
BOOL func_270(BOOL bParam0) // Position - 0x13B85 (80773)
{
	const char* string2;
...
BOOL func_271(BOOL bParam0) // Position - 0x13C3E (80958)
{
	var unk;
...
BOOL func_274(BOOL bParam0) // Position - 0x13E66 (81510)
{
...
BOOL func_275(BOOL bParam0) // Position - 0x13E91 (81553)
{
	if (bParam0 == 63 || bParam0 == -1)
		return false;
...
BOOL func_276(BOOL bParam0) // Position - 0x13EBC (81596)
{
	if (bParam0 == 63 || bParam0 == -1)
		return false;
...
BOOL func_277(BOOL bParam0) // Position - 0x13EE7 (81639)
{
	if (func_244(bParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
