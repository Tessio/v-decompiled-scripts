...
void func_5(char* sParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB29 (2857)
{
...
void func_26(ePedComponentType epctParam0) // Position - 0xFD9 (4057)
{
	int num;
	int num2;
	int num3;
...
int func_28(ePedComponentType epctParam0) // Position - 0x10B5 (4277)
{
	int i;
...
int func_34(ePedComponentType epctParam0) // Position - 0x1215 (4629)
{
	int i;
...
void func_119(float fParam0, int iParam1) // Position - 0x74B2 (29874)
{
	func_120(fParam0, iParam1);
	return;
}
