...
ePedComponentType func_83() // Position - 0x7629 (30249)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x766D (30317)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8524 (34084)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
void func_211(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD946 (55622)
{
...
BOOL func_213(Any* panParam0, BOOL bParam1) // Position - 0xDA37 (55863)
{
	...
	if (func_250(*panParam0) || func_248(*panParam0) || Global_80014 == true)
		return true;
...
int func_261(Ped pedParam0, eCharacter echParam1) // Position - 0xFCD6 (64726)
{
	int num;
