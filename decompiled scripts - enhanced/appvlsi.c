		...
		if (Global_21666.f_1 != 9)
		{
			switch (Global_21666.f_1)
			{
				case 7:
					if (iLocal_38 == 1)
					{
						if (func_8(FRONTEND_CONTROL, Global_21635, 0))
						{
				...
				case 8:
					if (func_8(FRONTEND_CONTROL, Global_21634, 0))
					{
						func_4();
						Global_21644 = true;
...
void func_5() // Position - 0x1C6 (454)
{
	if (Global_21654)
	{
		func_6(Global_21647, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*LLAMAR*/, 0, 0, 0, 0);
		func_6(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
		func_6(Global_21647, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
		func_6(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, 0, 0, 0, 0, 0);
	}

	func_6(Global_21647, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
...
void func_9() // Position - 0x38F (911)
{
	if (Global_21654)
	{
		func_6(Global_21647, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201" /*LLAMAR*/, 0, 0, 0, 0);
		func_6(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
		func_6(Global_21647, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
		func_6(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, 0, 0, 0, 0, 0);
	}
...
void func_10() // Position - 0x421 (1057)
{
	if (iLocal_38 == 0)
	{
		...
		func_11(Global_21647, "SET_DATA_SLOT_EMPTY", 23f, -1082130432, -1082130432, -1082130432, -1082130432);
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		func_11(Global_21647, "DISPLAY_VIEW", 23f, BUILTIN::TO_FLOAT(1), -1082130432, -1082130432, -1082130432);
		iLocal_38 = 1;
	}
	else if (iLocal_38 == 1)
	{
