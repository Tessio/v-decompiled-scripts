							...
							if (iLocal_137 > iLocal_138)
							{
								if (clockHours < iLocal_137 && clockHours >= iLocal_138)
								{
									...
									if (fLocal_110 < (fLocal_134 * fLocal_134) + 4f)
									{
										...
										{
											func_47("MG_NA_TIME" /*La actividad no está disponible en este momento. Vuelve de ~1~:00 a ~1~:00 para participar en ella.*/, iLocal_137, iLocal_138);
...
void func_90() // Position - 0x2A2A (10794)
{
	...
	sLocal_118 = "PLAY_HUNT" /*Presiona ~INPUT_CONTEXT~ para empezar a cazar.*/;
	iLocal_137 = 5;
	iLocal_138 = 19;
	fLocal_134 = 2f;
	iLocal_122 = 69;
