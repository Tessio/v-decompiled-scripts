...
void main() // Position - 0x0 (0)
{
	...
	{
		if (IS_BIT_SET(Global_1690460, 1))
		{
			func_27();
		}
		else
...
int func_4(Hash hParam0) // Position - 0x39F (927)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (func_5(hParam0, &Global_2652584.f_2452[i /*16*/]))
			return i;
	}
...
int func_9(int iParam0) // Position - 0x4C0 (1216)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (!func_7(&Global_1912812[iParam0 /*322*/].f_102.f_21[i /*14*/]))
		{
			num = i;
			break;
		}
...
int func_10(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x50C (1292)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (!func_7(&Global_2652584.f_2452[i /*16*/]) && !OBJECT::DOES_PICKUP_OF_TYPE_EXIST_IN_AREA(hParam0, vParam1, 2f))
		{
			num = i;
			break;
		}
...
int func_17() // Position - 0x6D2 (1746)
{
	return Global_33832;
}
