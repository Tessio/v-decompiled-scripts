...
BOOL func_49(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x6E9E (28318)
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_34(epctParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_34(epctParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_34(epctParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_34(epctParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_34(epctParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_34(epctParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_34(epctParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_34(epctParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_50(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x711B (28955)
{
	if (epctParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_51(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x7540 (30016)
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
void func_56(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, Interior inParam4) // Position - 0x79DD (31197)
{
	Interior interior;
	int offset;
	int num;
	...
	{
		address = func_61(num, interior);
		MISC::SET_BIT(&address, offset);
		func_57(num, address, interior, true);
	}

	return;
}

void func_57(int iParam0, int iParam1, Interior inParam2, BOOL bParam3) // Position - 0x7A25 (31269)
{
	Hash statName;
...
Hash func_58(int iParam0, Interior inParam1) // Position - 0x7A53 (31315)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_59(inParam1));
}

Interior func_59(Interior inParam0) // Position - 0x7A68 (31336)
{
	Interior interior;
	Interior interior2;
...
Interior func_60() // Position - 0x7A9C (31388)
{
	return Global_1574927;
}

int func_61(int iParam0, Interior inParam1) // Position - 0x7AA8 (31400)
{
	Hash statHash;
	int outValue;
...
BOOL func_72(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, Interior inParam4) // Position - 0xD96D (55661)
{
	Interior interior;
	int num;
	int num2;
...
eCharacter func_141(Interior inParam0, BOOL bParam1) // Position - 0x1F3DD (127965)
{
	eCharacter character;
	Interior interior;
