	...
	while (true)
	{
		...
		if (Global_21627.f_1 != 9)
		{
			switch (Global_21627.f_1)
			{
				...
				case 8:
					if (func_5(FRONTEND_CONTROL, Global_21595, 0))
					{
						func_4();
						Global_21605 = true;
...
BOOL func_5(eControlType ectParam0, BOOL bParam1, int iParam2) // Position - 0x17D (381)
{
...
void func_11() // Position - 0x417 (1047)
{
	if (Global_21615)
	{
		func_12(Global_21608, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
		func_12(Global_21608, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
