...
{
	MISC::CLEAR_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 3);
	return;
}
...
{
	if (!SCRIPT::IS_THREAD_ACTIVE(Global_2647287.f_1582) || Global_2647287.f_1582 == SCRIPT::GET_ID_OF_THIS_THREAD() || bParam2)
	{
		if (bParam0)
		{
			Global_2647287.f_1582 = SCRIPT::GET_ID_OF_THIS_THREAD();
			Global_2647287.f_1583 = NETWORK::GET_NETWORK_TIME();
		}
		else
		{
			Global_2647287.f_1582 = -1;
		}
	
		Global_2647287.f_1585 = iParam1;
		Global_2647287.f_1587 = bParam0;
	}
	else
	{
		!bParam2;
...
{
	if (!SCRIPT::IS_THREAD_ACTIVE(Global_2647287.f_1598) || Global_2647287.f_1598 == SCRIPT::GET_ID_OF_THIS_THREAD() || bParam1)
	{
		if (bParam0)
		{
			Global_2647287.f_1598 = SCRIPT::GET_ID_OF_THIS_THREAD();
			MISC::SET_BIT(&(Global_2658296[PLAYER::PLAYER_ID() /*468*/].f_76.f_2), 23);
		}
		else
		{
			Global_2647287.f_1598 = -1;
			MISC::CLEAR_BIT(&(Global_2658296[PLAYER::PLAYER_ID() /*468*/].f_76.f_2), 23);
		}
	}
	else
	{
...
{
	MISC::CLEAR_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 1);
	return;
}
...
void func_17(int* piParam0) // Position - 0x33F (831)
{
	...
	func_3();
	MISC::CLEAR_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 4);
	return;
}
...
{
	return !IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868, 4) && !func_31(true);
}

BOOL func_31(BOOL bParam0) // Position - 0x710 (1808)
{
	if (*Global_4718592.f_128458 == 6 || *Global_4718592.f_128458 == 7)
	{
...
{
	if (bParam0)
		MISC::SET_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 6);
	else
		MISC::CLEAR_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 6);
...
BOOL func_46() // Position - 0xB74 (2932)
{
	...
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868, 5);
}
...
{
	MISC::SET_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 1);
	return;
}
...
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868, 3);
}
...
void func_58(int* piParam0) // Position - 0xD5A (3418)
{
	...
	MISC::CLEAR_BIT(&(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868), 2);
	return;
}
...
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868, 2);
}
...
BOOL func_62(Player plParam0) // Position - 0xE60 (3680)
{
	if (plParam0 > -1)
	{
		if (Global_2658296[plParam0 /*468*/].f_250 > -1)
			if (func_63(Global_2658296[plParam0 /*468*/].f_250) == 4)
				return true;
...
{
	return plParam0 != -1 && IS_BIT_SET(Global_1845347[plParam0 /*884*/].f_868, 1);
}
...
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868, 1);
}
...
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_868, 6);
}
