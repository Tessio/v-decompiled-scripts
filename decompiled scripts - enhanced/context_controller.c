...
void main() // Position - 0x0 (0)
{
	...
	Global_45854 = false;
	func_41();
	TEXT_LABEL_ASSIGN_STRING(&Global_45855, "CC_SUBSTR" /*~INPUT_CONTEXT~*/, 16);
	num3 = -1;
	num4 = -1;
	flag = false;
	flag2 = false;
	...
	while (true)
	{
		...
		if (Global_45860)
			if (Global_45862 > -1)
				if (!Global_45660[Global_45862 /*32*/].f_6)
					if (!_CONTEXT_IS_HELP_TEXT_BEING_DISPLAYED(Global_45862, 1))
						Global_45862 = -1;
		...
		if (num3 > -1)
		{
			if (!Global_45860)
			{
				if (Global_45862 != num3)
				{
					if (func_18(Global_45862))
					{
						func_25();
					
						if (!Global_45660[num3 /*32*/].f_5 && Global_45660[num3 /*32*/])
						{
							if (!func_19())
							{
								if (!Global_45660[num3 /*32*/].f_7)
								{
									if (!Global_45660[num3 /*32*/].f_6)
									{
										if (!Global_45660[num3 /*32*/].f_12)
											func_17(Global_45660[num3 /*32*/].f_8, Global_45660[num3 /*32*/].f_3);
										else
											func_16(Global_45660[num3 /*32*/].f_8, Global_45660[num3 /*32*/].f_13, Global_45660[num3 /*32*/].f_3, Global_45660[num3 /*32*/].f_30);
		...
		switch (num)
		{
			case 0:
				...
				if (!func_19())
				{
					if (num3 > -1 && flag3)
					{
						...
						{
							Global_45660[num3 /*32*/].f_4 = 1;
							Global_45660[num3 /*32*/].f_29 = 0;
							num5 = Global_45660[num3 /*32*/].f_1;
							num = 1;
							Global_45853 = false;
						}
					}
			...
			case 1:
				...
				else
				{
					...
					if (!(num5 == Global_45660[num3 /*32*/].f_1))
						num = 0;
				
					if (Global_45660[num3 /*32*/].f_7 || Global_45660[num3 /*32*/] == false)
						num = 0;
				}
				break;
			...
			case 2:
				...
				{
					if (!(Global_45660[num3 /*32*/].f_4 || Global_45660[num3 /*32*/].f_7))
					{
						Global_45854 = false;
						num3 = -1;
					}
...
void func_1() // Position - 0x45A (1114)
{
	...
	if (bLocal_107)
	{
		...
		HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(&uLocal_109);
	
		if (bLocal_108)
		{
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&uLocal_113);
		}
		else
		{
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_45855);
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&uLocal_113);
		}
...
int func_6(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x564 (1380)
{
	...
	if (func_8(type) && Global_1892798[type /*615*/].f_10.f_433 == iParam2)
		return 1;

	return 0;
}

BOOL func_7(ePedComponentType epctParam0, int iParam1) // Position - 0x5C0 (1472)
{
	if (func_8(epctParam0))
		if (func_8(Global_1892798[epctParam0 /*615*/].f_10))
...
BOOL func_8(ePedComponentType epctParam0) // Position - 0x60F (1551)
{
	Player player;
...
void func_10(var uParam0) // Position - 0x65E (1630)
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_45660[i /*32*/] && Global_45660[i /*32*/].f_4)
		{
			if (Global_45660[i /*32*/].f_31 != 0)
			{
				if (!SCRIPT::IS_THREAD_ACTIVE(Global_45660[i /*32*/].f_31))
				{
					if (*uParam0 > -1)
						func_11();
				
					Global_45660[i /*32*/] = false;
					Global_45660[i /*32*/].f_31 = 0;
					Global_45660[i /*32*/] = false;
					Global_45660[i /*32*/].f_4 = 0;
					Global_45660[i /*32*/].f_5 = 0;
					Global_45660[i /*32*/].f_2 = 0;
					Global_45660[i /*32*/].f_7 = 0;
					Global_45660[i /*32*/].f_6 = 0;
					Global_45660[i /*32*/].f_3 = 0;
					*uParam0 = -1;
				}
			}
		}
...
int func_14() // Position - 0x7E5 (2021)
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (Global_45660[i /*32*/] == true)
			if (Global_45660[i /*32*/].f_4 == false)
				num = num + 1;
	}
...
int func_15() // Position - 0x82F (2095)
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		...
		{
			if (Global_45660[i /*32*/].f_2 > num)
			{
				num2 = i;
				num = Global_45660[i /*32*/].f_2;
			}
		}
	}
...
BOOL func_18(int iParam0) // Position - 0x8BD (2237)
{
	...
	if (iParam0 > 0)
		if (_CONTEXT_IS_HELP_TEXT_BEING_DISPLAYED(iParam0, 1) || bLocal_106)
			return true;
...
void func_35() // Position - 0xE8D (3725)
{
	...
	{
		unk = 1;
		unk[0 /*13*/] = Global_1835513[0];
		unk[0 /*13*/].f_1 = Global_1835513[1];
		unk[0 /*13*/].f_2 = Global_1835513[2];
		unk[0 /*13*/].f_3 = Global_1835513[3];
		unk[0 /*13*/].f_4 = Global_1835513[4];
		unk[0 /*13*/].f_5 = Global_1835513[5];
		unk[0 /*13*/].f_6 = Global_1835513[6];
		unk[0 /*13*/].f_7 = Global_1835513[7];
		unk[0 /*13*/].f_8 = Global_1835513[8];
		unk[0 /*13*/].f_9 = Global_1835513[9];
		unk[0 /*13*/].f_10 = Global_1835513[10];
		unk[0 /*13*/].f_11 = Global_1835513[11];
		unk[0 /*13*/].f_12 = Global_1835513[12];
			...
			if (bLocal_130)
			{
				...
				else
				{
					if (NETWORK::NETWORK_GAMERTAG_FROM_HANDLE_SUCCEEDED())
						TEXT_LABEL_ASSIGN_STRING(&Global_2359296[func_39() /*5574*/].f_5397.f_18[Global_1835512 /*6*/], NETWORK::NETWORK_GET_GAMERTAG_FROM_HANDLE(&unk[0 /*13*/]), 24);
		...
		else if (MISC::IS_PS3_VERSION() || func_37())
		{
			if (IS_GAMER_HANDLE_VALID(unk[0 /*13*/]))
			{
				...
				{
					case 0:
						iLocal_132 = NETWORK::NETWORK_DISPLAYNAMES_FROM_HANDLES_START(&unk, 1);
					...
					case 1:
						displaynamesFromHandles = NETWORK::NETWORK_GET_DISPLAYNAMES_FROM_HANDLES(iLocal_132, &unk15, 1);
						...
						switch (displaynamesFromHandles)
						{
							...
							case 0:
								TEXT_LABEL_COPY(&Global_2359296[func_39() /*5574*/].f_5397.f_18[Global_1835512 /*6*/], { unk15[0 /*16*/] }, 6);
								func_38();
								break;
		...
		{
			if (IS_GAMER_HANDLE_VALID(unk[0 /*13*/]))
				TEXT_LABEL_ASSIGN_STRING(&Global_2359296[func_39() /*5574*/].f_5397.f_18[Global_1835512 /*6*/], NETWORK::NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(&unk[0 /*13*/]), 24);
