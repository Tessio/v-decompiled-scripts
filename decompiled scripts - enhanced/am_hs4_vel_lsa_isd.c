...
void func_6(ePedComponentType epctParam0) // Position - 0x342 (834)
{
	...
	{
		if (!func_14(&Global_2739365[epctParam0 /*2*/], 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(epctParam0))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&Global_2739365[epctParam0 /*2*/], true, false);
				}
...
BOOL func_29(ePedComponentType epctParam0) // Position - 0xD66 (3430)
{
...
void func_54(BOOL bParam0) // Position - 0x134D (4941)
{
...
BOOL func_108(Vehicle veParam0, Any* panParam1) // Position - 0x945B (37979)
{
	...
	{
		type = Global_2359296[func_115() /*5574*/].f_681.f_2;
...
int func_111(ePedComponentType epctParam0) // Position - 0x994D (39245)
{
	if (func_114(epctParam0) == 233)
		return func_112(epctParam0);

	return -1;
}

int func_112(ePedComponentType epctParam0) // Position - 0x996A (39274)
{
	if (func_113(epctParam0, false))
		return Global_1892798[epctParam0 /*615*/].f_10.f_183;

	return -1;
}

BOOL func_113(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x998D (39309)
{
	if (func_11(epctParam0))
...
int func_114(ePedComponentType epctParam0) // Position - 0x99D1 (39377)
{
	if (func_11(epctParam0))
		if (func_113(epctParam0, false))
...
BOOL func_117(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x9A1C (39452)
{
	return func_118(epctParam0, bParam1, 1);
}

BOOL func_118(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x9A2D (39469)
{
	ePedComponentType type;
	...
	if (!bParam1)
		if (func_119(epctParam0, iParam2))
			return 0;
...
BOOL func_119(ePedComponentType epctParam0, int iParam1) // Position - 0x9A89 (39561)
{
	if (func_11(epctParam0))
...
BOOL func_125(ePedComponentType epctParam0) // Position - 0x9B94 (39828)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (func_126(epctParam0) && Global_2658294[epctParam0 /*468*/].f_325.f_11 == epctParam0)
			return true;

	return false;
}

BOOL func_126(ePedComponentType epctParam0) // Position - 0x9BC9 (39881)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
				return func_127(Global_2658294[epctParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_127(ePedComponentType epctParam0) // Position - 0x9C10 (39952)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_149(Entity eParam0, int iParam1) // Position - 0xC3F8 (50168)
{
	int num;
	int num2;
	int num3;
...
BOOL func_172(var uParam0) // Position - 0xD126 (53542)
{
	...
	else
	{
		...
		func_173(uParam0->f_23, &Global_1879768[type /*55*/], false, -1);
	}
...
BOOL func_192(Ped pedParam0, int iParam1) // Position - 0x14046 (81990)
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				type = func_197(pedParam0, 11, PV_COMP_INVALID);
			
				if (type >= 237)
				{
					componentHash = func_193(joaat("MP_M_Freemode_01"), type, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				type2 = func_197(pedParam0, 11, PV_COMP_INVALID);
			
				if (type2 >= 256)
				{
					componentHash2 = func_193(joaat("MP_F_Freemode_01"), type2, 11, 4);
...
BOOL func_193(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x14306 (82694)
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = epctParam1 - func_196(hParam0);
	...
	else
	{
		...
		componentId2 = epctParam1 - func_194(hParam0, func_195(iParam2));
...
ePedComponentType func_197(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x148D8 (84184)
{
	ePedComponentType i;
	ePedComponentType j;
...
ePedComponentType func_198(Ped pedParam0, int iParam1) // Position - 0x14979 (84345)
{
...
ePedComponentType func_200(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14A30 (84528)
{
	int pedPropIndex;
...
BOOL func_206(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x14E51 (85585)
{
	Hash entityModel;
	ePedComponentType type;
	ePedComponentType type2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80088[1 /*14*/] = { func_222(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		unk = { func_218(entityModel, epctParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num] != -99)
			{
				if (!func_206(pedParam0, num, unk[num]))
				{
					...
					if (num == 13)
					{
						unk18 = { func_215(entityModel, unk[num]) };
							...
							if (!func_206(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_80088[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_210(entityModel, epctParam2, 14, j, &unk, &Global_80088[2 /*14*/]))
											{
												Global_2883588 = type2;
												Global_2883589 = hash;
												return false;
					...
					{
						type = func_198(pedParam0, num);
						Global_80088[2 /*14*/] = { func_222(entityModel, num, type, -1) };
					
						if (!func_210(entityModel, epctParam2, num, type, &unk, &Global_80088[2 /*14*/]))
						{
							Global_2883588 = type2;
							Global_2883589 = hash;
							return false;
	...
	{
		unk28 = { func_215(entityModel, epctParam2) };
		...
		if (iParam1 == 4)
		{
			...
			if (Global_80087 == 1)
				if (func_209(entityModel, 11, func_198(pedParam0, 11), -1))
					if (func_208(entityModel, 4, epctParam2, &type3))
						return func_206(pedParam0, 4, type3);
				else if (func_207(entityModel, 4, epctParam2, &type3))
					return func_206(pedParam0, 4, type3);
...
BOOL func_207(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x152AC (86700)
{
	BOOL componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (epctParam2 >= 256)
					{
						componentHash = func_193(hParam0, epctParam2, iParam1, 4);
...
BOOL func_208(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x15355 (86869)
{
	BOOL componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_209(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x153FD (87037)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_193(hParam0, epctParam2, 11, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("DRESS"), 0);
					}
					break;
			}
			break;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x15450 (87120)
{
	var unk;
	int i;
	...
	if (func_214(hParam0, iParam2, epctParam3))
		return true;

	if (hParam0 == joaat("Player_Zero"))
	{
		if (func_213(hParam0, iParam2, epctParam3, -1))
		{
		...
		else if (func_211(hParam0, iParam2, epctParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_211(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x15A54 (88660)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_193(hParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_193(hParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_193(hParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_193(hParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_212(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x15CD1 (89297)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_213(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x160F6 (90358)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_214(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x163E9 (91113)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 26:
					func_221(&unk, -99, -99, PV_COMP_UPPR, PV_COMP_UPPR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 29:
					func_221(&unk, -99, -99, PV_COMP_HAIR, PV_COMP_HAIR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 30:
					func_221(&unk, -99, -99, 161, PV_COMP_UPPR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 31:
					func_221(&unk, -99, -99, PV_COMP_UPPR, PV_COMP_UPPR, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				...
				case 33:
					func_221(&unk, -99, -99, 86, PV_COMP_LOWR, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 36:
					func_221(&unk, -99, -99, PV_COMP_LOWR, PV_COMP_LOWR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 37:
					func_221(&unk, -99, -99, PV_COMP_HAND, PV_COMP_HAND, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 38:
					func_221(&unk, -99, -99, PV_COMP_FEET, PV_COMP_FEET, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_221(&unk, -99, -99, PV_COMP_TEEF, PV_COMP_TEEF, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_221(&unk, -99, -99, PV_COMP_ACCS, PV_COMP_ACCS, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_221(&unk, -99, -99, PV_COMP_TASK, PV_COMP_TASK, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_221(&unk, -99, -99, PV_COMP_DECL, PV_COMP_DECL, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_221(&unk, -99, -99, PV_COMP_JBIB, PV_COMP_JBIB, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 44:
					func_221(&unk, -99, -99, PV_COMP_MAX, PV_COMP_MAX, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 1:
					func_221(&unk, -99, -99, 22, PV_COMP_DECL, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
				...
				case 3:
					func_221(&unk, -99, -99, 23, PV_COMP_JBIB, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
			
				case 4:
					func_221(&unk, -99, -99, 23, PV_COMP_JBIB, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				...
				case 8:
					func_221(&unk, -99, -99, 17, PV_COMP_HAND, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
			
				case 9:
					func_221(&unk, -99, -99, 16, PV_COMP_LOWR, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 11:
					func_221(&unk, -99, -99, 259, PV_COMP_DECL, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 12:
					func_221(&unk, -99, -99, 18, PV_COMP_FEET, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_221(&unk, -99, -99, 19, PV_COMP_TEEF, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_221(&unk, -99, -99, 20, PV_COMP_ACCS, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 15:
					func_221(&unk, -99, -99, 21, PV_COMP_TASK, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_221(&unk, -99, -99, 17, PV_COMP_HAND, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
			
				case 2:
					func_221(&unk, -99, -99, 43, PV_COMP_ACCS, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				...
				case 12:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 16:
					func_221(&unk, -99, -99, 44, PV_COMP_TASK, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_221(&unk, -99, -99, 45, PV_COMP_DECL, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_221(&unk, -99, -99, 46, PV_COMP_JBIB, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 19:
					func_221(&unk, -99, -99, 47, PV_COMP_MAX, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 21:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_221(&unk, -99, -99, 98, PV_COMP_HEAD, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_221(&unk, -99, -99, 27, PV_COMP_HEAD, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 41:
					func_221(&unk, -99, -99, PV_COMP_HAIR, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_221(&unk, -99, -99, 55, PV_COMP_HEAD, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 46:
					func_221(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_221(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
			
				case 1:
					func_221(&unk, -99, -99, PV_COMP_BERD, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
			
				case 2:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
			
				case 3:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
			
				case 4:
					func_221(&unk, -99, -99, PV_COMP_BERD, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
			
				case 5:
					func_221(&unk, -99, -99, PV_COMP_BERD, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
			
				case 6:
					func_221(&unk, -99, -99, PV_COMP_BERD, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
			
				case 7:
					func_221(&unk, -99, -99, PV_COMP_BERD, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
			
				case 8:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
			
				case 9:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
			
				case 10:
					func_221(&unk, -99, -99, PV_COMP_BERD, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
			
				case 11:
					func_221(&unk, -99, -99, PV_COMP_BERD, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
			
				case 12:
					func_221(&unk, -99, -99, PV_COMP_BERD, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
			
				case 13:
					func_221(&unk, -99, -99, PV_COMP_BERD, PV_COMP_LOWR, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
			
				case 14:
					func_221(&unk, -99, -99, PV_COMP_BERD, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
			
				case 15:
					func_221(&unk, -99, -99, PV_COMP_BERD, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
			
				case 16:
					func_221(&unk, -99, -99, PV_COMP_BERD, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
			
				case 17:
					func_221(&unk, -99, -99, PV_COMP_BERD, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
			
				case 18:
					func_221(&unk, -99, -99, PV_COMP_HAND, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
			
				case 19:
					func_221(&unk, -99, -99, PV_COMP_HAND, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
			
				case 20:
					func_221(&unk, -99, -99, PV_COMP_BERD, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
			
				case 21:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
			
				case 22:
					func_221(&unk, -99, -99, PV_COMP_FEET, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
			
				case 23:
					func_221(&unk, -99, -99, PV_COMP_BERD, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
			
				case 24:
					func_221(&unk, -99, -99, PV_COMP_BERD, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
			
				case 25:
					func_221(&unk, -99, -99, PV_COMP_HAIR, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_221(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
			
				case 1:
					func_221(&unk, -99, -99, PV_COMP_HAND, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
			
				case 2:
					func_221(&unk, -99, -99, PV_COMP_LOWR, PV_COMP_BERD, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
			
				case 3:
					func_221(&unk, -99, -99, PV_COMP_BERD, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
			
				case 4:
					func_221(&unk, -99, -99, PV_COMP_HAIR, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
			
				case 5:
					func_221(&unk, -99, -99, PV_COMP_TASK, PV_COMP_TEEF, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
			
				case 6:
					func_221(&unk, -99, -99, PV_COMP_BERD, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
			
				case 7:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
			
				case 8:
					func_221(&unk, -99, -99, PV_COMP_BERD, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
			
				case 9:
					func_221(&unk, -99, -99, PV_COMP_HAND, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
			
				case 10:
					func_221(&unk, -99, -99, PV_COMP_TASK, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
			
				case 11:
					func_221(&unk, -99, -99, PV_COMP_HAND, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
			
				case 12:
					func_221(&unk, -99, -99, PV_COMP_FEET, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
			
				case 13:
					func_221(&unk, -99, -99, PV_COMP_HAND, PV_COMP_HEAD, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
			
				case 14:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
			
				case 15:
					func_221(&unk, -99, -99, PV_COMP_TASK, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
			
				case 16:
					func_221(&unk, -99, -99, PV_COMP_HAIR, PV_COMP_ACCS, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
			
				case 17:
					func_221(&unk, -99, -99, PV_COMP_HAND, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
			
				case 18:
					func_221(&unk, -99, -99, PV_COMP_FEET, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
			
				case 19:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
			
				case 20:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
			
				case 21:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
			
				case 22:
					func_221(&unk, -99, -99, PV_COMP_UPPR, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
			
				case 23:
					func_221(&unk, -99, -99, PV_COMP_HEAD, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
			
				case 24:
					func_221(&unk, -99, -99, PV_COMP_HAND, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
			
				case 25:
					func_221(&unk, -99, -99, PV_COMP_TEEF, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
			
				case 26:
					func_221(&unk, -99, -99, PV_COMP_LOWR, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
...
void func_221(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x19008 (102408)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_222(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x19079 (102521)
{
	func_268();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_252(iParam1, epctParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_223(iParam1, epctParam2, hParam3);
...
BOOL func_230(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B1C1 (111041)
{
	int num;
	int num2;
	int num3;
...
BOOL func_231(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B1FF (111103)
{
...
Hash func_270(int iParam0) // Position - 0x34D2B (216363)
{
	if (func_271(true))
...
int func_274(BOOL bParam0) // Position - 0x34DB9 (216505)
{
	int i;
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						type2 = func_197(pedParam0, 8, PV_COMP_INVALID);
					
						if (type2 >= 241)
						{
							componentHash2 = func_193(joaat("MP_M_Freemode_01"), type2, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num2 = func_278(joaat("MP_F_Freemode_01"), 11, func_197(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						type3 = func_197(pedParam0, 11, PV_COMP_INVALID);
					
						if (type3 >= 256)
						{
							componentHash3 = func_193(joaat("MP_F_Freemode_01"), type3, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num3 = func_278(joaat("MP_F_Freemode_01"), 11, func_197(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						type4 = func_197(pedParam0, 8, PV_COMP_INVALID);
					
						if (type4 >= 136)
						{
							componentHash4 = func_193(joaat("MP_F_Freemode_01"), type4, 8, 4);
...
int func_278(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x35691 (218769)
{
	BOOL componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_193(hParam0, epctParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_193(hParam0, epctParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_193(hParam0, epctParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_193(hParam0, epctParam2, 8, 4);
