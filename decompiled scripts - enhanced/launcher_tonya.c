...
ePedComponentType func_83() // Position - 0x7651 (30289)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x7695 (30357)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x854C (34124)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
void func_215(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE4E7 (58599)
{
...
BOOL func_227(Any* panParam0, BOOL bParam1) // Position - 0xE997 (59799)
{
	...
	if (func_264(*panParam0) || func_262(*panParam0) || Global_80014 == true)
		return true;
...
BOOL func_267(eCharacter echParam0) // Position - 0x1065B (67163)
{
	int i;
