...
void main() // Position - 0x0 (0)
{
	...
	func_164(iLocal_85);
	func_163();
	func_161(&Global_4525223);
	func_160(&Global_4525223, 1);
	func_158(&uLocal_86);

	while (true)
	{
		if (Global_34083 != iLocal_84)
		{
			if (iLocal_84 == 0 && Global_34083 != 0)
				if (MISC::IS_PS3_VERSION() || func_157())
					_DISPLAY_HELP_TEXT("CHEAT_TROPHIE" /*Se activaron los trucos. No se concederán trofeos mientras dure esta sesión.*/, -1);
				else
					_DISPLAY_HELP_TEXT("CHEAT_ACHIEVE" /*Se activaron los trucos. No se concederán logros mientras dure esta sesión.*/, -1);
		
			iLocal_84 != 0 && Global_34083 == 0;
		}
	
		iLocal_84 = Global_34083;
		...
		if (!func_155(14))
		{
			...
			if (Global_33842)
			{
				if (!PLAYER::HAS_ACHIEVEMENT_BEEN_PASSED(12))
				{
					...
					{
						func_128(12, value);
						STATS::STAT_SET_INT(joaat("NUM_GOLD_MEDALS_OBTAINED") /* TUNEABLE: NUM_GOLD_MEDALS_OBTAINED */, value, true);
					}
			...
			if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					{
						func_111(false);
						iLocal_75 = MISC::GET_GAME_TIMER() + iLocal_80;
					}
				
					if (MISC::GET_GAME_TIMER() > iLocal_76)
					{
						if (!PLAYER::HAS_ACHIEVEMENT_BEEN_PASSED(14) || iLocal_83 == 1)
							if (func_110(53))
								func_109();
					
						iLocal_76 = MISC::GET_GAME_TIMER() + iLocal_81;
					}
				}
			}
		
			func_101(&Global_4525223);
			func_1();
		}
		else
		{
...
void func_1() // Position - 0x20D (525)
{
	BOOL flag;
	int num;

	if (!func_100(&Global_4525223))
		return;
...
void func_2() // Position - 0x29D (669)
{
	int num;
	...
	if (!PLAYER::HAS_ACHIEVEMENT_BEEN_PASSED(38))
		if (_MPPLY_STAT_GET_INT(joaat("MPPLY_TOTAL_CUSTOM_RACES_WON") /* TUNEABLE: MPPLY_TOTAL_CUSTOM_RACES_WON */) >= 5)
			func_122(38, 1);
	...
	if (!PLAYER::HAS_ACHIEVEMENT_BEEN_PASSED(41))
		if (IS_BIT_SET(Global_2733326.f_1415.f_18, 1))
			func_122(41, 1);
...
int func_3(BOOL bParam0) // Position - 0x442 (1090)
{
	if (!func_97())
		return 0;
...
BOOL func_4(int iParam0, int iParam1) // Position - 0x4BD (1213)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_5(int iParam0, int iParam1) // Position - 0x4E1 (1249)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_6(iParam1));
}

int func_6(int iParam0) // Position - 0x4F6 (1270)
{
	int num;
	int num2;
...
int func_7() // Position - 0x52A (1322)
{
	return Global_1574928;
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x536 (1334)
{
	if (iParam1 == -1)
		iParam1 = func_7();
...
int func_9(BOOL bParam0) // Position - 0x552 (1362)
{
	int i;
	int num;
	int num2;
...
BOOL func_10(int iParam0, int iParam1, BOOL bParam2) // Position - 0x5C3 (1475)
{
	BOOL flag;
...
int func_11(int iParam0, int iParam1) // Position - 0x648 (1608)
{
	Hash statHash;
	int outValue;
...
Hash func_12(int iParam0, int iParam1) // Position - 0x677 (1655)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_6(iParam1));
}

int func_13(int iParam0, int iParam1) // Position - 0x68C (1676)
{
	Hash statHash;
	int outValue;
...
Hash func_14(int iParam0, int iParam1) // Position - 0x6B0 (1712)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_6(iParam1));
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x6C6 (1734)
{
	Hash statHash;
	int outValue;
...
int func_16(BOOL bParam0) // Position - 0x6E4 (1764)
{
	int num;
...
BOOL func_17(int iParam0, int iParam1) // Position - 0x742 (1858)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_18(int iParam0, int iParam1) // Position - 0x766 (1894)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_6(iParam1));
}

int func_19(int iParam0, int iParam1) // Position - 0x77C (1916)
{
	int i;
	int value;
	int value2;
...
int func_20(int iParam0) // Position - 0x837 (2103)
{
	int num;
	int num2;
...
int func_21(int iParam0) // Position - 0xD7B (3451)
{
	return func_11(640, iParam0);
}

void func_22(Ped pedParam0) // Position - 0xD8C (3468)
{
	int i;
	int num;
...
BOOL func_23(Ped pedParam0, Hash hParam1) // Position - 0xE1B (3611)
{
	var unk;
	int dlcWeaponIndex;
	int num;
...
BOOL func_24(Hash hParam0) // Position - 0x1114 (4372)
{
...
Hash func_25(Hash hParam0, int iParam1) // Position - 0x1324 (4900)
{
	Hash hash;
	int num;
...
BOOL func_26(Ped pedParam0, Hash hParam1, Hash hParam2) // Position - 0x1361 (4961)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x1380 (4992)
{
...
BOOL func_28(var uParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x13A1 (5025)
{
	int num;
	int num2;
	int num3;
...
int func_29(Hash hParam0, int iParam1) // Position - 0x6C8D (27789)
{
	int price;
	float num;
	int dlcWeaponIndex;
...
float func_30(Hash hParam0, var uParam1, float fParam2) // Position - 0xA8A5 (43173)
{
	float num;
	float num2;
	int num3;
...
int func_31(Hash hParam0) // Position - 0xA983 (43395)
{
...
int func_32(int iParam0, eCharacter echParam1) // Position - 0xABDF (43999)
{
	int num;
	int num2;
	int num3;
...
int func_33(int iParam0, eCharacter echParam1) // Position - 0xACE3 (44259)
{
	return Global_114990.f_19156[echParam1 /*271*/].f_3[iParam0 /*12*/].f_3;
}

BOOL func_34(eCharacter echParam0) // Position - 0xACFF (44287)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xAD0B (44299)
{
	func_36();
	return Global_114990.f_2370.f_539.f_4321;
}

void func_36() // Position - 0xAD24 (44324)
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_34(character) && !func_155(14) || Global_113936)
			{
				if (Global_114990.f_2370.f_539.f_4321 != character && func_34(Global_114990.f_2370.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xAE21 (44577)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xAE5E (44638)
{
...
Hash func_39(eCharacter echParam0) // Position - 0xAE83 (44675)
{
	return Global_2349[echParam0 /*29*/];
}

var func_40() // Position - 0xAE92 (44690)
{
	return Global_102563.f_2131;
}

void func_41(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, BOOL bParam12, int iParam13) // Position - 0xAEA1 (44705)
{
...
BOOL func_42() // Position - 0xB611 (46609)
{
	return func_43();
}

BOOL func_43() // Position - 0xB61D (46621)
{
	return Global_1583778[189 /*143*/].f_66 == joaat("thruster");
}

Hash func_44() // Position - 0xB635 (46645)
{
	return 1384502824;
}

Hash func_45() // Position - 0xB642 (46658)
{
	return -1576586413;
}

Hash func_46() // Position - 0xB64F (46671)
{
	return joaat("kosatka");
}

int func_47(Hash hParam0) // Position - 0xB65C (46684)
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
int func_48(Hash hParam0) // Position - 0xB6BB (46779)
{
	return func_49(hParam0);
}

int func_49(Hash hParam0) // Position - 0xB6C9 (46793)
{
	switch (hParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
char* func_50(int iParam0, Hash hParam1) // Position - 0xBD19 (48409)
{
	int dlcWeaponIndex;
	int i;
	var unk;
...
char* func_51(var uParam0) // Position - 0xC84D (51277)
{
	return uParam0;
}

BOOL func_52() // Position - 0xC857 (51287)
{
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xC874 (51316)
{
...
BOOL func_54(int iParam0) // Position - 0xC88B (51339)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		switch (iParam0)
...
BOOL func_55(int iParam0) // Position - 0xC8ED (51437)
{
	switch (iParam0)
	{
		case joaat("COMPONENT_PISTOL_MK2_CAMO_IND_01"):
...
BOOL func_56() // Position - 0xC94C (51532)
{
...
BOOL func_57() // Position - 0xC97E (51582)
{
	return true;
}

int func_58() // Position - 0xC987 (51591)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_59() // Position - 0xCA3D (51773)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xCB76 (52086)
{
	int profileSetting;
...
BOOL func_61(int iParam0) // Position - 0xCC2E (52270)
{
	switch (iParam0)
	{
...
int func_62(Hash hParam0, var uParam1) // Position - 0xCCCF (52431)
{
	int num;
	int num2;
	var unk;
...
int func_63(int iParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0xD04B (53323)
{
	*uParam2 = 1;
	*uParam3 = 0;
	...
	{
		case joaat("WEAPON_BAT"):
			if (!*Global_262145.f_33900 && func_75(iLocal_73, false) || func_65(iParam0, hParam1, -1))
			{
				*uParam2 = 1;
				*uParam3 = 0;
				return 1;
...
BOOL func_64() // Position - 0xD5F3 (54771)
{
...
BOOL func_65(int iParam0, Hash hParam1, int iParam2) // Position - 0xD6EC (55020)
{
	int num;
	int num2;
...
int func_66(int iParam0) // Position - 0xD71E (55070)
{
	return iParam0 % 32;
}

int func_67(int iParam0, Hash hParam1) // Position - 0xD72B (55083)
{
	return func_68(iParam0, hParam1);
}

int func_68(int iParam0, int iParam1) // Position - 0xD73B (55099)
{
	switch (iParam1)
	{
		case joaat("WEAPON_PISTOL"):
...
int func_69(int iParam0, Hash hParam1, int iParam2) // Position - 0xFD5A (64858)
{
	int num;
...
int func_70(int iParam0, Hash hParam1) // Position - 0xFD74 (64884)
{
	int num;
	int num2;
...
int func_71() // Position - 0xFEF4 (65268)
{
	return Global_33833;
}

int func_72() // Position - 0xFEFF (65279)
{
	return Global_33832;
}

int func_73(int iParam0) // Position - 0xFF0A (65290)
{
	return iParam0 / 32;
}

BOOL func_74() // Position - 0xFF17 (65303)
{
	return Global_1575076;
}

BOOL func_75(int iParam0, BOOL bParam1) // Position - 0xFF23 (65315)
{
	if (iParam0 == 58)
	{
		if (bParam1)
			return Global_102563.f_349[58] < 5f;
...
BOOL func_76(int iParam0, int iParam1, int iParam2) // Position - 0xFF4C (65356)
{
	int num;
	int num2;
...
int func_77(int iParam0, int iParam1, int iParam2) // Position - 0xFF7E (65406)
{
	int num;
...
int func_78(int iParam0, int iParam1) // Position - 0xFF98 (65432)
{
	int num;
	int num2;
...
BOOL func_79(int iParam0) // Position - 0x1013A (65850)
{
	switch (iParam0)
	{
		case 46:
...
BOOL func_80(Hash hParam0) // Position - 0x10190 (65936)
{
	switch (hParam0)
	{
		case -1916886713:
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x101AD (65965)
{
	*uParam0 = iParam1;
	uParam0->f_4 = iParam2;
	uParam0->f_6 = iParam3;
...
int func_82(Hash hParam0, Any* panParam1) // Position - 0x101CC (65996)
{
	int i;
	int numDlcWeapons;
...
void func_83(Ped pedParam0, var uParam1) // Position - 0x10207 (66055)
{
	int i;
	int j;
	Hash k;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		{
			if (EXTRAMETADATA::GET_DLC_WEAPON_DATA_SP(l, &outData) && !func_84(outData.f_1) && num < 51)
			{
...
BOOL func_84(int iParam0) // Position - 0x1048F (66703)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
Hash func_85(Hash hParam0, int iParam1) // Position - 0x10687 (67207)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
Hash func_86(int iParam0) // Position - 0x11408 (70664)
{
	int num;
...
float func_87(int* piParam0) // Position - 0x1167C (71292)
{
	if (func_90(piParam0))
		if (func_89(piParam0))
			return piParam0->f_2;
...
float func_88(BOOL bParam0) // Position - 0x116B8 (71352)
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_89(int* piParam0) // Position - 0x11710 (71440)
{
	return IS_BIT_SET(*piParam0, 2);
}

BOOL func_90(int* piParam0) // Position - 0x1171D (71453)
{
	return IS_BIT_SET(*piParam0, 1);
}

BOOL func_91() // Position - 0x1172A (71466)
{
	if (Global_1574613)
		return true;
...
BOOL func_92() // Position - 0x1175A (71514)
{
	return Global_1575085;
}

BOOL func_93() // Position - 0x11766 (71526)
{
	return Global_1575087;
}

void func_94() // Position - 0x11772 (71538)
{
	int i;
...
BOOL func_95(int iParam0, int iParam1) // Position - 0x11806 (71686)
{
	int profileSetting;
	int profileSetting2;
...
int func_96(int iParam0) // Position - 0x1182F (71727)
{
	int num;
...
BOOL func_97() // Position - 0x11892 (71826)
{
...
var func_98(int iParam0) // Position - 0x118B0 (71856)
{
	return Global_1574538[iParam0];
}

var func_99() // Position - 0x118C0 (71872)
{
	return func_98(func_7() + 1);
}

BOOL func_100(var uParam0) // Position - 0x118D2 (71890)
{
	return uParam0->f_79 == 1;
}

void func_101(var uParam0) // Position - 0x118E0 (71904)
{
	float num;
...
void func_102(var uParam0) // Position - 0x11968 (72040)
{
	int i;
...
void func_103(var uParam0) // Position - 0x11999 (72089)
{
	int num;
...
BOOL func_104(int iParam0) // Position - 0x119D0 (72144)
{
...
BOOL func_105(int iParam0) // Position - 0x11A1A (72218)
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_106(var uParam0, int iParam1) // Position - 0x11A6A (72298)
{
	return uParam0->[iParam1] == 78;
}

void func_107(var uParam0, int iParam1) // Position - 0x11A7B (72315)
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_108(var uParam0) // Position - 0x11A98 (72344)
{
	return uParam0->f_80;
}

int func_109() // Position - 0x11AA4 (72356)
{
	float minimapFowDiscoveryRatio;

	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || Global_80362)
		return 0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			...
			if (minimapFowDiscoveryRatio > 0.01f && MISC::IS_PC_VERSION())
				func_128(14, BUILTIN::FLOOR(minimapFowDiscoveryRatio * 100f));
...
BOOL func_110(int iParam0) // Position - 0x11B1C (72476)
{
...
void func_111(BOOL bParam0) // Position - 0x11B48 (72520)
{
	if (Global_80362)
	{
		if (bParam0)
...
int func_112() // Position - 0x11B9C (72604)
{
	int num;
	int num2;
	...
	num = 0;
	num2 = 0;
	num = num + (STATS::STAT_GET_NUMBER_OF_DAYS(joaat("FIRST_PERSON_CAM_TIME") /* TUNEABLE: FIRST_PERSON_CAM_TIME, FIRST_PERSON_CAM_TIME */) * 24);
	num = num + STATS::STAT_GET_NUMBER_OF_HOURS(joaat("FIRST_PERSON_CAM_TIME") /* TUNEABLE: FIRST_PERSON_CAM_TIME, FIRST_PERSON_CAM_TIME */);
	num2 = num2 + (STATS::STAT_GET_NUMBER_OF_DAYS(joaat("MP_FIRST_PERSON_CAM_TIME") /* TUNEABLE: MP_FIRST_PERSON_CAM_TIME, MP_FIRST_PERSON_CAM_TIME */) * 24);
	num2 = num2 + STATS::STAT_GET_NUMBER_OF_HOURS(joaat("MP_FIRST_PERSON_CAM_TIME") /* TUNEABLE: MP_FIRST_PERSON_CAM_TIME, MP_FIRST_PERSON_CAM_TIME */);
...
int func_113() // Position - 0x11C0A (72714)
{
	...
	{
		if (Global_34098 < numSuccessfulStuntJumps)
		{
			if (Global_34098 >= 0)
				func_128(22, numSuccessfulStuntJumps);
		
			Global_34098 = numSuccessfulStuntJumps;
		}
	}
...
int func_114(BOOL bParam0) // Position - 0x11C61 (72801)
{
	var unk;
	int value;
	int i;
	...
	STATS::STAT_GET_INT(joaat("NUM_DISCIPLINE_GOLD_EARNED") /* TUNEABLE: NUM_DISCIPLINE_GOLD_EARNED */, &outValue, -1);

	if (value > outValue && value > 0)
	{
		STATS::STAT_SET_INT(joaat("NUM_DISCIPLINE_GOLD_EARNED") /* TUNEABLE: NUM_DISCIPLINE_GOLD_EARNED */, value, true);
		func_128(17, value);
	}
...
int func_115() // Position - 0x11D83 (73091)
{
	int i;
	...
	for (i = 0; i < 12; i = i + 1)
	{
		if (Global_114990.f_1995[0 /*121*/][i /*10*/].f_8 == 3)
			return 1;
		else if (Global_114990.f_1995[1 /*121*/][i /*10*/].f_8 == 3)
			return 1;
		else if (Global_114990.f_1995[2 /*121*/][i /*10*/].f_8 == 3)
			return 1;
	}
...
int func_116() // Position - 0x11DF0 (73200)
{
	int i;
	...
	for (i = 0; i < 22; i = i + 1)
	{
		if (Global_114990.f_19156[0 /*271*/].f_3[i /*12*/].f_3 == 3)
			return 1;
		else if (Global_114990.f_19156[1 /*271*/].f_3[i /*12*/].f_3 == 3)
			return 1;
		else if (Global_114990.f_19156[2 /*271*/].f_3[i /*12*/].f_3 == 3)
			return 1;
	}
...
int func_117() // Position - 0x11E66 (73318)
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (IS_BIT_SET(Global_114990.f_24985.f_1, i))
			return 1;
	}
...
int func_118() // Position - 0x11E97 (73367)
{
	int i;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (IS_BIT_SET(Global_114990.f_24988.f_2, i))
			return 1;
	}
...
int func_119() // Position - 0x11EC8 (73416)
{
	int i;
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (Global_114990.f_19025.f_19[i] == 1)
			return 1;
	}
...
int func_120() // Position - 0x11EFB (73467)
{
	int i;
...
int func_121(BOOL bParam0) // Position - 0x11F2C (73516)
{
	var outValue;
	int value;
	int outValue2;
...
int func_122(int iParam0, int iParam1) // Position - 0x11FE3 (73699)
{
	if (iParam0 >= 78)
		return 0;
...
int func_123(int iParam0, int iParam1) // Position - 0x11FFE (73726)
{
	if (func_155(14) && !func_105(iParam0))
		return 0;
	...
	if (func_100(&Global_4525223))
	{
		if (func_126(&Global_4525223, iParam0))
			return 0;
	
		if (func_124(&Global_4525223, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_124(var uParam0, int iParam1) // Position - 0x1209B (73883)
{
	int i;
	var unk;
...
int func_125(var uParam0, int iParam1) // Position - 0x1214C (74060)
{
	int i;
...
BOOL func_126(var uParam0, int iParam1) // Position - 0x121C7 (74183)
{
	return func_127(uParam0, iParam1) != -1;
}

int func_127(var uParam0, int iParam1) // Position - 0x121D9 (74201)
{
	int i;
...
BOOL func_128(int iParam0, int iParam1) // Position - 0x12206 (74246)
{
...
int func_129(BOOL bParam0) // Position - 0x12257 (74327)
{
	int num;
...
int func_130(BOOL bParam0) // Position - 0x12275 (74357)
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < Global_114990.f_18583; i = i + 1)
	{
		if (Global_114990.f_18583[i /*6*/].f_3 != -1 && func_140(i, 7))
		{
			num3 = 0;
			num4 = 0;
			...
			{
				bParam0;
				num2 = Global_114990.f_2359[i - 52 /*2*/];
				num5 = 0f;
			}
...
int func_131(float fParam0) // Position - 0x12369 (74601)
{
	if (fParam0 == 0f)
		return 0;
...
float func_132(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1239E (74654)
{
	float num;
	float value;
...
int func_133(int iParam0) // Position - 0x123FD (74749)
{
	if (func_134(iParam0, func_135(Global_65305[iParam0 /*13*/].f_4)))
		return 1;

	return 0;
}

BOOL func_134(int iParam0, int iParam1) // Position - 0x12420 (74784)
{
	if (iParam1 < 0)
		return false;
...
int func_135(Hash hParam0) // Position - 0x124EA (74986)
{
	int outValue;
...
int func_136(int iParam0, int iParam1, int iParam2) // Position - 0x12513 (75027)
{
	switch (iParam1)
	{
		case 1:
...
int func_137(int iParam0, int iParam1) // Position - 0x12556 (75094)
{
	switch (iParam0)
	{
		case 2:
...
int func_138(int iParam0, int iParam1) // Position - 0x12C3A (76858)
{
	switch (iParam1)
	{
		case 1:
...
int func_139(int iParam0) // Position - 0x12C75 (76917)
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x12E26 (77350)
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_141(int iParam0) // Position - 0x12E64 (77412)
{
	switch (iParam0)
	{
		case 0:
...
int func_142(BOOL bParam0) // Position - 0x131AA (78250)
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < Global_114990.f_9094.f_330; i = i + 1)
	{
		if (Global_114990.f_9094.f_330[i /*6*/].f_3 != -1 && func_140(i, 1))
		{
			num3 = 0;
			num4 = 0;
			num7 = -1;
...
int func_143(int iParam0) // Position - 0x132C4 (78532)
{
	int num;

	num = func_135(Global_65305[iParam0 /*13*/].f_4);
...
void func_144() // Position - 0x132E9 (78569)
{
...
BOOL func_145(Ped pedParam0) // Position - 0x13372 (78706)
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_146() // Position - 0x13390 (78736)
{
	switch (iLocal_74)
	{
		case 0:
...
void func_147(int* piParam0) // Position - 0x134A0 (79008)
{
	if (func_90(piParam0))
	{
		if (!func_89(piParam0))
...
float func_148(var uParam0) // Position - 0x134D7 (79063)
{
	if (func_90(uParam0))
		if (func_89(uParam0))
			return uParam0->f_2;
...
void func_149(var uParam0) // Position - 0x13510 (79120)
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_150() // Position - 0x13526 (79142)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_151() // Position - 0x13542 (79170)
{
	int num;
	Ped ped;
	...
	if (func_152(ped, 0) || IS_BIT_SET(Global_98337, 2))
		num = num + 1;

	ped = func_153(CHAR_FRANKLIN);

	if (func_152(ped, 0) || IS_BIT_SET(Global_98337, 1))
		num = num + 1;

	ped = func_153(CHAR_MICHAEL);

	if (func_152(ped, 0) || IS_BIT_SET(Global_98337, 0))
		num = num + 1;

	return num;
}

BOOL func_152(Ped pedParam0, int iParam1) // Position - 0x135B8 (79288)
{
	return false;
}

Ped func_153(eCharacter echParam0) // Position - 0x13611 (79377)
{
	...
	return Global_99964[func_154(echParam0)];
}

int func_154(eCharacter echParam0) // Position - 0x13642 (79426)
{
...
BOOL func_155(int iParam0) // Position - 0x1367D (79485)
{
	return Global_44938 == iParam0;
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1368B (79499)
{
...
BOOL func_157() // Position - 0x136A2 (79522)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_158(int* piParam0) // Position - 0x136B8 (79544)
{
	func_159(piParam0, 0f);
	return;
}

void func_159(int* piParam0, float fParam1) // Position - 0x136C7 (79559)
{
...
void func_160(var uParam0, int iParam1) // Position - 0x136F2 (79602)
{
...
void func_161(var uParam0) // Position - 0x1370E (79630)
{
	int i;
...
void func_162(var uParam0, int iParam1) // Position - 0x13742 (79682)
{
	uParam0->[iParam1] = 78;
	return;
}

void func_163() // Position - 0x13752 (79698)
{
	int i;
	int num;
...
void func_164(int iParam0) // Position - 0x1377C (79740)
{
	iParam0 > 0;
	return;
}
