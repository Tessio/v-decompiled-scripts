...
ePedComponentType func_83() // Position - 0x7668 (30312)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x76AC (30380)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8564 (34148)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
void func_204(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD853 (55379)
{
...
BOOL func_219(Any* panParam0, BOOL bParam1) // Position - 0xDDDC (56796)
{
	...
	if (func_256(*panParam0) || func_254(*panParam0) || Global_80014 == true)
		return true;
...
int func_262(Ped pedParam0, eCharacter echParam1) // Position - 0xFCF0 (64752)
{
	int num;
