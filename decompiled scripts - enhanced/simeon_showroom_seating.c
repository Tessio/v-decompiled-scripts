...
void func_64(ePedComponentType epctParam0) // Position - 0x21D2 (8658)
{
	int i;
...
int func_77(ePedComponentType epctParam0) // Position - 0x2619 (9753)
{
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x2643 (9795)
{
...
BOOL func_100(ePedComponentType epctParam0) // Position - 0x2A19 (10777)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
		if (func_102(epctParam0) && !func_101(epctParam0))
			return true;

	return false;
}

BOOL func_101(ePedComponentType epctParam0) // Position - 0x2A52 (10834)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_102(ePedComponentType epctParam0) // Position - 0x2A83 (10883)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
{
	func_106(0, &uLocal_140, 0, 3);
	func_106(1, &uLocal_140, 1, 3);
	func_106(2, &uLocal_140, 2, 3);
	func_106(3, &uLocal_140, 3, 2);
