...
void main() // Position - 0x0 (0)
{
	...
	iLocal_62 = 49;
	iLocal_63 = 64;
	uLocal_82 = { -1124.3922f, -514.70013f, 33.21493f };
	fLocal_85 = 200f;
	uLocal_86 = { 2490f, 3777f, 2402.879f };
	uLocal_89 = { -2052f, 3237f, 1450.078f };
	iLocal_92 = -1;
	iLocal_94 = -1;
	bLocal_103 = true;
	fLocal_104 = 10f;
	...
	iLocal_96[0 /*3*/] = { uLocal_86 };
	iLocal_96[1 /*3*/] = { uLocal_89 };
	...
	while (true)
	{
		...
		if (bLocal_103)
		{
			if (!func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[0 /*3*/], 290f + 50f, true))
				if (!func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[1 /*3*/], 290f + 50f, true))
					func_12();
		
			if (iLocal_95 != 0)
			{
				if (!func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[0 /*3*/], fLocal_108 + 50f, true))
				{
					if (!func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[1 /*3*/], fLocal_108 + 50f, true))
					{
		...
		switch (iLocal_95)
		{
			case 0:
				...
				{
					if (func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[i /*3*/], fLocal_108, true))
					{
						iLocal_94 = i;
						iLocal_95 = 1;
			...
			case 1:
				...
				for (i = 0; i < iLocal_96; i = i + 1)
				{
					if (func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[i /*3*/], fLocal_105, true))
					{
						iLocal_94 = i;
						iLocal_95 = 2;
					}
			...
			case 3:
				if (func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[iLocal_94 /*3*/], fLocal_105, true))
				{
					...
					if (iLocal_93 >= iLocal_109)
					{
						...
						if (iLocal_94 == 0)
							AUDIO::PLAY_SOUND_FROM_COORD(iLocal_110, "SPECIAL_EVIL_UFO_DEATH_RAY", iLocal_96[iLocal_94 /*3*/], 0, false, 0, false);
						else
							AUDIO::PLAY_SOUND_FROM_COORD(iLocal_110, "SPECIAL_EVIL_UFO_DEATH_RAY_3", iLocal_96[iLocal_94 /*3*/], 0, false, 0, false);
			...
			case 4:
				...
				if (!func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[iLocal_94 /*3*/], fLocal_108, true))
				{
					func_1();
					iLocal_94 = -1;
					iLocal_95 = 0;
...
void func_5() // Position - 0x44B (1099)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_2(vehiclePedIsIn))
		{
			...
			ENTITY::APPLY_FORCE_TO_ENTITY(vehiclePedIsIn, 2, 0f, 0f, -fLocal_104, 0f, 1f, 0f, 0, false, true, true, false, true);
		}
	}
...
void func_8() // Position - 0x525 (1317)
{
	...
	if (!func_10(PLAYER::PLAYER_PED_ID(), iLocal_96[iLocal_94 /*3*/], fLocal_106, true))
		return;

	vector = { func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - iLocal_96[iLocal_94 /*3*/]) * { fLocal_107, fLocal_107, fLocal_107 } };
