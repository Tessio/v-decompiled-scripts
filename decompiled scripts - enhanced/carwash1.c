...
int func_225(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xD2F3 (54003)
{
	int i;
	int j;
	int k;
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xDC6A (56426)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_230(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xDD48 (56648)
{
	Global_80088[1 /*14*/] = { func_273(hParam0, iParam1, bParam2, -1) };
	return IS_BIT_SET(Global_80088[1 /*14*/].f_6, 2);
}

BOOL func_231(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0xDD70 (56688)
{
	var unk;
	int i;
...
BOOL func_232(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xE374 (58228)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_234(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE4B8 (58552)
{
	BOOL i;
	BOOL j;
...
int func_236(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0xE609 (58889)
{
	int num;
...
BOOL func_237(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4, int iParam5) // Position - 0xE910 (59664)
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_238(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, var uParam4) // Position - 0xF4C3 (62659)
{
	int num;
...
BOOL func_239(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xF7A7 (63399)
{
	int num;
...
BOOL func_240(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFA6E (64110)
{
	BOOL i;
	BOOL flag;
...
BOOL func_241(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFAA5 (64165)
{
	BOOL flag;
...
BOOL func_242(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0xFACE (64206)
{
	*uParam2 = -99;
...
int func_243(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0xFD98 (64920)
{
	int num;
...
BOOL func_244(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10024 (65572)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_246(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x10215 (66069)
{
	switch (hParam0)
	{
...
Hash func_247(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x102E3 (66275)
{
	var outProp;
	int componentId;
	int num;
...
BOOL func_250(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x10805 (67589)
{
	Hash entityModel;
...
struct<10> func_255(Hash hParam0, BOOL bParam1) // Position - 0x10BDF (68575)
{
	int i;
	var unk;
...
struct<17> func_258(Hash hParam0, BOOL bParam1) // Position - 0x11680 (71296)
{
	int i;
	var unk;
...
BOOL func_262(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x137D3 (79827)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_263(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x13A50 (80464)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_264(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x13E75 (81525)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_265(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14169 (82281)
{
	int pedPropIndex;
...
BOOL func_266(Ped pedParam0, int iParam1) // Position - 0x141B0 (82352)
{
...
struct<14> func_273(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x17EE1 (98017)
{
	func_336();
		...
		case 4:
			...
			if (!bParam2 && !uParam1->f_9 && !func_385(24))
				if (iParam6 == 1 && func_351(PLAYER::PLAYER_ID()))
					func_371(uParam1, "CWASH_RIDEHLP2" /*Pulsa ~INPUT_CONTEXT~ para usar tu lavadero de coches gratis.*/);
				else
