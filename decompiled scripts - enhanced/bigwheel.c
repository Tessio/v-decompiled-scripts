...
int func_71(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x6F24 (28452)
{
	...
	if (iParam5 == 0)
	{
		Global_80088[1 /*14*/] = { func_124(entityModel, iParam1, epctParam2, -1) };
...
{
	Global_80088[1 /*14*/] = { func_124(hParam0, iParam1, epctParam2, -1) };
...
BOOL func_108(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0xD405 (54277)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_93(hParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_93(hParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_93(hParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_93(hParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_109(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0xD682 (54914)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_110(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0xDAA7 (55975)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_188(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_80088[2 /*14*/].f_12 == j)
										if (func_188(pedParam0, 14, k))
											if (!func_77(entityModel, epctParam2, 14, k, &unk, &Global_80088[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80088[2 /*14*/] = { func_124(entityModel, i, type, -1) };
					
						if (!func_77(entityModel, epctParam2, i, type, &unk, &Global_80088[2 /*14*/]))
							return false;
					}
				}
			}
...
void func_222(BOOL bParam0, int iParam1) // Position - 0x26CF0 (158960)
{
	BOOL flag;

	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		flag = func_259(PLAYER::PLAYER_ID());
	
		if (flag > false)
			if (flag >= bParam0)
				func_257(-bParam0, 1, 1, 0);
			else
				func_257(-flag, 1, 1, 0);
	}
	else
	{
		func_223(_GET_CURRENT_PLAYER_CHARACTER(), iParam1, bParam0);
	}

	return;
}

int func_223(eCharacter echParam0, int iParam1, BOOL bParam2) // Position - 0x26D3D (159037)
{
	...
	return func_224(func_256(echParam0), 0, iParam1, bParam2, false);
}

int func_224(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x26D71 (159089)
{
	float num;
	int num2;
	int num3;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_254(99, 1);
					func_253(joaat("SP0_MONEY_TOTAL_SPENT") /* TUNEABLE: SP0_MONEY_TOTAL_SPENT */, bParam3);
					break;
			
				case 1:
					func_253(joaat("SP1_MONEY_TOTAL_SPENT") /* TUNEABLE: SP1_MONEY_TOTAL_SPENT */, bParam3);
					break;
			
				case 2:
					func_253(joaat("SP2_MONEY_TOTAL_SPENT") /* TUNEABLE: SP2_MONEY_TOTAL_SPENT */, bParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_253(joaat("SP0_MONEY_SPENT_ON_TATTOOS") /* TUNEABLE: SP0_MONEY_SPENT_ON_TATTOOS */, bParam3);
							break;
					
						case 1:
							func_253(joaat("SP1_MONEY_SPENT_ON_TATTOOS") /* TUNEABLE: SP1_MONEY_SPENT_ON_TATTOOS */, bParam3);
							break;
					
						case 2:
							func_253(joaat("SP2_MONEY_SPENT_ON_TATTOOS") /* TUNEABLE: SP2_MONEY_SPENT_ON_TATTOOS */, bParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_253(joaat("SP0_MONEY_SPENT_ON_TAXIS") /* TUNEABLE: SP0_MONEY_SPENT_ON_TAXIS */, bParam3);
							break;
					
						case 1:
							func_253(joaat("SP1_MONEY_SPENT_ON_TAXIS") /* TUNEABLE: SP1_MONEY_SPENT_ON_TAXIS */, bParam3);
							break;
					
						case 2:
							func_253(joaat("SP2_MONEY_SPENT_ON_TAXIS") /* TUNEABLE: SP2_MONEY_SPENT_ON_TAXIS */, bParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_253(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS") /* TUNEABLE: SP0_MONEY_SPENT_IN_STRIP_CLUBS */, bParam3);
							break;
					
						case 1:
							func_253(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS") /* TUNEABLE: SP1_MONEY_SPENT_IN_STRIP_CLUBS */, bParam3);
							break;
					
						case 2:
							func_253(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS") /* TUNEABLE: SP2_MONEY_SPENT_IN_STRIP_CLUBS */, bParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_253(joaat("SP0_MONEY_SPENT_PROPERTY") /* TUNEABLE: SP0_MONEY_SPENT_PROPERTY */, bParam3);
							break;
					
						case 1:
							func_253(joaat("SP1_MONEY_SPENT_PROPERTY") /* TUNEABLE: SP1_MONEY_SPENT_PROPERTY */, bParam3);
							break;
					
						case 2:
							func_253(joaat("SP2_MONEY_SPENT_PROPERTY") /* TUNEABLE: SP2_MONEY_SPENT_PROPERTY */, bParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_253(joaat("SP0_MONEY_SPENT_IN_CLOTHES") /* TUNEABLE: SP0_MONEY_SPENT_IN_CLOTHES */, bParam3);
									break;
							
								case 1:
									func_253(joaat("SP1_MONEY_SPENT_IN_CLOTHES") /* TUNEABLE: SP1_MONEY_SPENT_IN_CLOTHES */, bParam3);
									break;
							
								case 2:
									func_253(joaat("SP2_MONEY_SPENT_IN_CLOTHES") /* TUNEABLE: SP2_MONEY_SPENT_IN_CLOTHES */, bParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_253(joaat("SP0_MONEY_SPENT_ON_HAIRDOS") /* TUNEABLE: SP0_MONEY_SPENT_ON_HAIRDOS */, bParam3);
									break;
							
								case 1:
									func_253(joaat("SP1_MONEY_SPENT_ON_HAIRDOS") /* TUNEABLE: SP1_MONEY_SPENT_ON_HAIRDOS */, bParam3);
									break;
							
								case 2:
									func_253(joaat("SP2_MONEY_SPENT_ON_HAIRDOS") /* TUNEABLE: SP2_MONEY_SPENT_ON_HAIRDOS */, bParam3);
									break;
							}
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_253(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS") /* TUNEABLE: SP0_MONEY_SPENT_IN_BUYING_GUNS */, bParam3);
									break;
							
								case 1:
									func_253(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS") /* TUNEABLE: SP1_MONEY_SPENT_IN_BUYING_GUNS */, bParam3);
									break;
							
								case 2:
									func_253(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS") /* TUNEABLE: SP2_MONEY_SPENT_IN_BUYING_GUNS */, bParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_253(joaat("SP0_MONEY_SPENT_CAR_MODS") /* TUNEABLE: SP0_MONEY_SPENT_CAR_MODS */, bParam3);
									break;
							
								case 1:
									func_253(joaat("SP1_MONEY_SPENT_CAR_MODS") /* TUNEABLE: SP1_MONEY_SPENT_CAR_MODS */, bParam3);
									break;
							
								case 2:
									func_253(joaat("SP2_MONEY_SPENT_CAR_MODS") /* TUNEABLE: SP2_MONEY_SPENT_CAR_MODS */, bParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_253(joaat("SP0_TOTAL_CASH_EARNED") /* TUNEABLE: SP0_TOTAL_CASH_EARNED */, bParam3);
					break;
			
				case 1:
					func_253(joaat("SP1_TOTAL_CASH_EARNED") /* TUNEABLE: SP1_TOTAL_CASH_EARNED */, bParam3);
					break;
			
				case 2:
					func_253(joaat("SP2_TOTAL_CASH_EARNED") /* TUNEABLE: SP2_TOTAL_CASH_EARNED */, bParam3);
					break;
			}
			break;
...
void func_236(BOOL bParam0) // Position - 0x27B65 (162661)
{
	func_254(93, bParam0);
	func_254(29, bParam0);
	func_254(30, bParam0);
...
void func_253(Hash hParam0, BOOL bParam1) // Position - 0x28163 (164195)
{
	int outValue;
...
void func_254(int iParam0, BOOL bParam1) // Position - 0x28186 (164230)
{
	int outValue;
...
BOOL func_259(Player plParam0) // Position - 0x282FD (164605)
{
	BOOL flag;

	flag = func_260(plParam0);
	return flag;
}

BOOL func_260(Player plParam0) // Position - 0x2830F (164623)
{
	if (plParam0 > -1)
		if (plParam0 == PLAYER::PLAYER_ID())
