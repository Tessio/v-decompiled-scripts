...
BOOL func_29(ePedComponentType epctParam0) // Position - 0xD73 (3443)
{
...
BOOL func_110(Vehicle veParam0, Any* panParam1) // Position - 0x94FC (38140)
{
	...
	{
		type = Global_2359296[func_117() /*5574*/].f_681.f_2;
...
int func_113(ePedComponentType epctParam0) // Position - 0x99EE (39406)
{
	if (func_116(epctParam0) == 233)
		return func_114(epctParam0);

	return -1;
}

int func_114(ePedComponentType epctParam0) // Position - 0x9A0B (39435)
{
...
BOOL func_115(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x9A2E (39470)
{
	if (func_11(epctParam0))
...
int func_116(ePedComponentType epctParam0) // Position - 0x9A72 (39538)
{
	if (func_11(epctParam0))
		if (func_115(epctParam0, false))
...
BOOL func_119(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x9ABD (39613)
{
	return func_120(epctParam0, bParam1, 1);
}

BOOL func_120(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x9ACE (39630)
{
	ePedComponentType type;
...
BOOL func_121(ePedComponentType epctParam0, int iParam1) // Position - 0x9B2A (39722)
{
	if (func_11(epctParam0))
...
BOOL func_127(ePedComponentType epctParam0) // Position - 0x9C35 (39989)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (func_128(epctParam0) && Global_2658294[epctParam0 /*468*/].f_325.f_11 == epctParam0)
			return true;

	return false;
}

BOOL func_128(ePedComponentType epctParam0) // Position - 0x9C6A (40042)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
				return func_129(Global_2658294[epctParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_129(ePedComponentType epctParam0) // Position - 0x9CB1 (40113)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_147(ePedComponentType epctParam0) // Position - 0xC42A (50218)
{
	ePedComponentType type;
...
BOOL func_148(ePedComponentType epctParam0) // Position - 0xC44F (50255)
{
	ePedComponentType type;
	...
	if (type != PV_COMP_INVALID)
		return func_149(epctParam0, 9);

	return false;
}

BOOL func_149(ePedComponentType epctParam0, int iParam1) // Position - 0xC46D (50285)
{
...
BOOL func_151(Entity eParam0, int iParam1) // Position - 0xC499 (50329)
{
	int num;
	int num2;
	int num3;
...
BOOL func_173(var uParam0) // Position - 0xD1A6 (53670)
{
	...
	else
	{
		...
		func_174(uParam0->f_23, &Global_1879768[type /*55*/], false, -1);
	}
...
BOOL func_194(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x14306 (82694)
{
	var outProp;
	int componentId;
	int num;
...
ePedComponentType func_198(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x148D8 (84184)
{
	ePedComponentType i;
	ePedComponentType j;
...
ePedComponentType func_199(Ped pedParam0, int iParam1) // Position - 0x14979 (84345)
{
...
ePedComponentType func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14A30 (84528)
{
	int pedPropIndex;
...
BOOL func_207(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x14E51 (85585)
{
	Hash entityModel;
	ePedComponentType type;
	ePedComponentType type2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80088[1 /*14*/] = { func_223(entityModel, iParam1, epctParam2, -1) };
			...
			if (unk[num] != -99)
			{
				if (!func_207(pedParam0, num, unk[num]))
				{
							...
							if (!func_207(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_80088[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_211(entityModel, epctParam2, 14, j, &unk, &Global_80088[2 /*14*/]))
											{
												Global_2883588 = type2;
												Global_2883589 = hash;
												return false;
					...
					else
					{
						...
						Global_80088[2 /*14*/] = { func_223(entityModel, num, type, -1) };
					
						if (!func_211(entityModel, epctParam2, num, type, &unk, &Global_80088[2 /*14*/]))
						{
							Global_2883588 = type2;
							Global_2883589 = hash;
							return false;
...
BOOL func_208(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x152AC (86700)
{
	BOOL componentHash;
...
BOOL func_209(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x15355 (86869)
{
	BOOL componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x153FD (87037)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_194(hParam0, epctParam2, 11, 4);
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x15450 (87120)
{
	var unk;
	int i;
...
BOOL func_212(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x15A54 (88660)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_194(hParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_194(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_194(hParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_194(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_194(hParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_194(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (bParam3 == -1)
							bParam3 = func_194(hParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(bParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_194(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_213(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x15CD1 (89297)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_214(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x160F6 (90358)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_215(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x163E9 (91113)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_222(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x19008 (102408)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_223(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x19079 (102521)
{
	func_269();
...
BOOL func_231(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B1C1 (111041)
{
	int num;
	int num2;
	int num3;
...
BOOL func_232(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B1FF (111103)
{
...
Hash func_271(ePedComponentType epctParam0) // Position - 0x34D2B (216363)
{
	if (func_272(true))
...
int func_275(BOOL bParam0) // Position - 0x34DB9 (216505)
{
	int i;
