...
void func_2() // Position - 0xD6 (214)
{
	...
	textureDict = { func_4(uLocal_72.f_20) };
	GRAPHICS::SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(&textureDict);
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&(uLocal_72.f_725));
	AUDIO::RELEASE_NAMED_SCRIPT_AUDIO_BANK("DLC_24-2/DLC_24-2_Circuit_Hack");
	func_3();
	AUDIO::STOP_SOUND(uLocal_72.f_21);
	AUDIO::RELEASE_SOUND_ID(uLocal_72.f_21);
	uLocal_72.f_21 = -1;

	if (!AUDIO::HAS_SOUND_FINISHED(uLocal_72.f_22))
		AUDIO::STOP_SOUND(uLocal_72.f_22);

	AUDIO::RELEASE_SOUND_ID(uLocal_72.f_22);
	uLocal_72.f_22 = -1;
...
void func_10() // Position - 0x2C8 (712)
{
	...
	if (!func_15(uLocal_72.f_16))
		func_14(&(uLocal_72.f_16));

	if (!AUDIO::HAS_SOUND_FINISHED(uLocal_72.f_22))
		AUDIO::STOP_SOUND(uLocal_72.f_22);

	if (!IS_BIT_SET(Global_1925700, 6))
	{
		AUDIO::PLAY_SOUND_FRONTEND(-1, "Fail", "DLC_24-2_Hack_Circuit_Board", true);
		MISC::SET_BIT(&Global_1925700, 6);
	}

	if (func_12(uLocal_72.f_16, 5000))
		func_11(4);
...
void func_18() // Position - 0x410 (1040)
{
	...
	if (!func_15(uLocal_72.f_15))
		func_14(&(uLocal_72.f_15));

	num = func_13(uLocal_72.f_15);
	num = func_30(uLocal_72.f_20) - num;
	...
	if (func_15(uLocal_72.f_17) && !func_12(uLocal_72.f_17, 1250) || !func_15(uLocal_72.f_17) && func_15(uLocal_72.f_16) && !func_12(uLocal_72.f_16, 1250) || !func_15(uLocal_72.f_16))
		func_19(num);

	if (IS_BIT_SET(Global_1925700, 1) || uLocal_72.f_9 != 1)
		return;

	if (func_12(uLocal_72.f_15, func_30(uLocal_72.f_20)))
		MISC::SET_BIT(&Global_1925700, 1);
...
void func_19(int iParam0) // Position - 0x4EC (1260)
{
	...
	if (uLocal_72.f_9 == 1)
		if (!AUDIO::HAS_SOUND_FINISHED(uLocal_72.f_22))
			AUDIO::SET_VARIABLE_ON_SOUND(uLocal_72.f_22, "TimeRemaining", BUILTIN::TO_FLOAT(iParam0) / 1000f);
...
struct<11> func_27(int iParam0) // Position - 0x6F4 (1780)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			num.f_2 = 0.85f;
			num.f_3 = 255;
			num.f_4 = BUILTIN::ROUND(func_28(100f, 255f, uLocal_72.f_23));
			num.f_5 = BUILTIN::ROUND(func_28(100f, 255f, uLocal_72.f_23));
			num.f_6 = 255;
			num.f_7 = 0;
			num.f_10 = 10;
			num = 4;
...
void func_31() // Position - 0x87E (2174)
{
	...
	num = 0.5f - (func_77() * (float)uLocal_72.f_11 - 1);
	num2 = (0.5f - ((func_76() / 2f) * (float)uLocal_72.f_10 - 1)) + func_75();
	num3 = num - (func_77() * 1.1f);
	num4 = 0.25f;
	num5 = 0.5f + (func_77() * (float)uLocal_72.f_11 - 1) + (func_77() * 1.1f);
	num6 = 0.25f;
	num7 = 0.5f - 0.62f;
	num8 = 0.235f;
	num9 = 0.5f + 0.62f;
	...
	for (i = 0; i <= uLocal_72.f_11 - 1; i = i + 1)
	{
		red = 255;
		green = 255;
		blue = 255;
		alpha = 255;
		func_66(uLocal_72.f_20, i) == uLocal_72[i];
		func_62(num, num2, i, uLocal_72[i], red, green, blue, alpha);
	
		if (i == uLocal_72.f_12 && uLocal_72.f_9 == 1)
			func_56(num, num2, i, uLocal_72[i]);
	}

	num11 = func_55(uLocal_72.f_20);
	num12 = func_54(uLocal_72.f_20);
	num13 = func_53(uLocal_72.f_20);
	num14 = func_52(uLocal_72.f_20);
	...
	if (uLocal_72.f_9 == 2)
	{
		...
		if (func_15(uLocal_72.f_17) && func_12(uLocal_72.f_17, 1250) || func_15(uLocal_72.f_16) && func_12(uLocal_72.f_16, 1250))
		{
			red = 255;
			green = 255;
			blue = 255;
			alpha = 255;
			GRAPHICS::DRAW_SPRITE(func_5(), func_36(), 0.5f, 0.5f, 1f * fLocal_65, 1f, 0f, red, green, blue, alpha, false, 0);
		}
	}
	else if (uLocal_72.f_9 == 3)
	{
		func_37(num7, num8, uLocal_72.f_24 ? 1 : 0);
		func_37(num9, num10, uLocal_72.f_24 ? 1 : 0);
		...
		if (func_15(uLocal_72.f_17) && func_12(uLocal_72.f_17, 1250) || func_15(uLocal_72.f_16) && func_12(uLocal_72.f_16, 1250))
		{
			...
			blue = 255;
			alpha = 255;
			GRAPHICS::DRAW_SPRITE(func_34(), func_33(), 0.5f, 0.5f, 1f * fLocal_65, 1f, 0f, red, green, blue, alpha, false, 0);
		}
	}
	else
	{
		...
		if (func_32(uLocal_72.f_20))
			func_37(num9, num10, uLocal_72.f_24 ? 2 : 0);
		else
...
BOOL func_32(var uParam0) // Position - 0xB73 (2931)
{
	...
	for (i = 0; i <= uLocal_72.f_11 - 1; i = i + 1)
	{
		if (uLocal_72[i] != func_66(uParam0, i))
			return false;
	}
...
void func_37(float fParam0, float fParam1, int iParam2) // Position - 0xBE3 (3043)
{
	...
	GRAPHICS::DRAW_SPRITE(func_38(), &textureName, func_29(fParam0), fParam1, (0.042968754f * 1.788f) / fLocal_64, 0.07638889f, 0f, 255, 255, 255, 255, false, 0);
	return;
}
...
{
	GRAPHICS::DRAW_SPRITE(func_44(), func_43(), func_29(fParam0), fParam1, (0.046875f * 1.788f) / fLocal_64, 0.054166667f, 0f, 255, 255, 255, 255, false, 0);
	return;
}
...
{
	GRAPHICS::DRAW_SPRITE(func_47(), func_46(), func_29(fParam0), fParam1, (0.046875f * 1.788f) / fLocal_64, 0.054166667f, 0f, 255, 255, 255, 255, false, 0);
	return;
}
...
{
	GRAPHICS::DRAW_SPRITE(func_47(), func_49(), func_29(fParam0), fParam1, (0.046875f * 1.788f) / fLocal_64, 0.054166667f, 0f, 255, 255, 255, 255, false, 0);
	return;
}
...
{
	GRAPHICS::DRAW_SPRITE(func_47(), func_51(), func_29(fParam0), fParam1, (0.046875f * 1.788f) / fLocal_64, 0.054166667f, 0f, 255, 255, 255, 255, false, 0);
	return;
}
...
void func_56(float fParam0, float fParam1, int iParam2, int iParam3) // Position - 0xF77 (3959)
{
	...
	num.f_1 = 255;
	num.f_2 = 255;
	num.f_3 = BUILTIN::ROUND(func_28(100f, 255f, uLocal_72.f_23));
	num2 = -0.001f;
	num3 = -0.002f;
...
void func_58(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1039 (4153)
{
	...
	value = BUILTIN::ROUND(*uParam1 * (float)iLocal_71);
	*uParam1 = BUILTIN::TO_FLOAT(value) * (1f / (float)iLocal_71);
	value = BUILTIN::ROUND((*uParam3 * (float)iLocal_71) / 4f) * 4;
	*uParam3 = BUILTIN::TO_FLOAT(value) * (1f / (float)iLocal_71);
...
void func_62(float fParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x10B6 (4278)
{
	...
	unk = { func_4(uLocal_72.f_20) };
	unk17 = { func_65(iParam2, uLocal_72.f_20) };
	num.f_3 = 255;
	num = iParam4;
	num.f_1 = iParam5;
	num.f_2 = iParam6;
...
void func_78() // Position - 0x15CF (5583)
{
	if (uLocal_72.f_24)
	{
		uLocal_72.f_23 = uLocal_72.f_23 + (3f * BUILTIN::TIMESTEP());
	
		if (uLocal_72.f_23 >= 1f)
		{
			uLocal_72.f_24 = 0;
			uLocal_72.f_23 = 1f;
		}
...
void func_82() // Position - 0x1699 (5785)
{
	...
	if (!IS_BIT_SET(Global_1925700, 3))
	{
		AUDIO::PLAY_SOUND_FRONTEND(-1, "Success", "DLC_24-2_Hack_Circuit_Board", true);
		MISC::SET_BIT(&Global_1925700, 3);
	}

	if (!func_15(uLocal_72.f_17))
		func_14(&(uLocal_72.f_17));

	if (func_12(uLocal_72.f_17, 5000))
		func_11(4);
...
{
	if (func_15(uLocal_72.f_17) && func_12(uLocal_72.f_17, 1250))
	{
		HUD::SET_TEXT_SCALE(1.6f, 1.6f);
		HUD::SET_TEXT_COLOUR(13, 118, 94, 255);
		HUD::SET_TEXT_DROPSHADOW(5, 0, 0, 0, 175);
		HUD::SET_TEXT_JUSTIFICATION(0);
		func_17(0.5f, 0.41f, "CBH_MV_PS" /*HACKEADO*/, 0);
	}
...
BOOL func_85() // Position - 0x17BE (6078)
{
	...
	if (IS_BIT_SET(Global_1925700, 0))
		return true;

	return false;
}

BOOL func_86() // Position - 0x17F1 (6129)
{
	if (IS_BIT_SET(Global_1925700, 1) || IS_BIT_SET(Global_1925700, 4))
		return true;

	return false;
}

BOOL func_87() // Position - 0x1813 (6163)
{
	if (IS_BIT_SET(Global_1925700, 5) && IS_BIT_SET(Global_1925700, 2))
		return true;

	return false;
}

void func_88() // Position - 0x1834 (6196)
{
	if (func_32(uLocal_72.f_20))
		MISC::SET_BIT(&Global_1925700, 2);
	else
		MISC::CLEAR_BIT(&Global_1925700, 2);

	return;
}

void func_89() // Position - 0x185C (6236)
{
	if (func_91(uLocal_72.f_14))
	{
		if (uLocal_72.f_12 > -1 && uLocal_72.f_12 < uLocal_72.f_11)
		{
			if (uLocal_72.f_14 < 0)
			...
			uLocal_72[uLocal_72.f_12] = uLocal_72[uLocal_72.f_12] + uLocal_72.f_14;
		}
	}

	if (func_90(uLocal_72.f_13))
	{
		AUDIO::PLAY_SOUND_FRONTEND(-1, "Nav", "DLC_24-2_Hack_Circuit_Board", true);
		uLocal_72.f_12 = uLocal_72.f_12 + uLocal_72.f_13;
	}
...
BOOL func_90(int iParam0) // Position - 0x18EF (6383)
{
	if (iParam0 == 0)
		return false;

	if (uLocal_72.f_12 + iParam0 >= uLocal_72.f_11 || uLocal_72.f_12 + iParam0 < 0)
		return false;

	return true;
}

BOOL func_91(int iParam0) // Position - 0x1924 (6436)
{
	if (iParam0 == 0)
		return false;

	if (uLocal_72[uLocal_72.f_12] + iParam0 >= uLocal_72.f_10 || uLocal_72[uLocal_72.f_12] + iParam0 < 0)
		return false;

	return true;
}

void func_92() // Position - 0x1961 (6497)
{
	var unk;
	...
	if (PAD::IS_DISABLED_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_LEFT))
		uLocal_72.f_13 = uLocal_72.f_13 - 1;
	...
	else
	{
		...
		MISC::CLEAR_BIT(&Global_1925700, 5);
	}

	if (func_105(false, false))
		MISC::SET_BIT(&Global_1925700, 4);

	if (PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL) && uLocal_72.f_25.f_693 != 0)
	{
		func_9(&(uLocal_72.f_25));
		return;
	}

	if (uLocal_72.f_25.f_693 == 0)
	{
		func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_ACCEPT, true), "CBH_CONFI" /*Confirmar*/, &(uLocal_72.f_25), 0);
	
		if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
			func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_CURSOR_CANCEL, true), "CBH_QUIT" /*Salir*/, &(uLocal_72.f_25), 0);
		else
			func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_CANCEL, true), "CBH_QUIT" /*Salir*/, &(uLocal_72.f_25), 0);
	
		func_103(0, 4, "CBH_MV_UD" /*Mover*/, &(uLocal_72.f_25));
		func_103(0, 5, "CBH_MV_LR" /*Seleccionar*/, &(uLocal_72.f_25));
	}
	...
	if (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_72.f_725) || !IS_BIT_SET(uLocal_72.f_19, 0) || GRAPHICS::IS_SCALEFORM_MOVIE_DELETING(uLocal_72.f_725))
	{
		uLocal_72.f_725 = GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("GENERIC_INSTRUCTIONAL_BUTTONS");
		MISC::SET_BIT(&(uLocal_72.f_19), 0);
	}
	else
	{
		func_101(1);
		func_93(&(uLocal_72.f_725), &unk, &(uLocal_72.f_25), func_100(&(uLocal_72.f_25)));
	}

	return;
}

void func_93(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1B53 (6995)
{
	int i;
...
void func_94() // Position - 0x1EEE (7918)
{
...
void func_95(int iParam0, var uParam1) // Position - 0x1F0C (7948)
{
...
void func_96(const char* sParam0) // Position - 0x1F3A (7994)
{
...
void func_97(const char* sParam0) // Position - 0x1F4C (8012)
{
...
struct<9> func_102() // Position - 0x1FA3 (8099)
{
	float num;
...
void func_103(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x1FE7 (8167)
{
	int offset;
...
void func_104(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0x204B (8267)
{
	int num;
...
BOOL func_105(BOOL bParam0, BOOL bParam1) // Position - 0x209B (8347)
{
	if (HUD::IS_PAUSE_MENU_ACTIVE())
		return false;
	...
	{
		if (bParam1)
			PAD::DISABLE_CONTROL_ACTION(FRONTEND_CONTROL, INPUT_FRONTEND_PAUSE, false);
	
		if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_CURSOR_CANCEL) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_CURSOR_CANCEL))
			return true;
	...
	if (bParam0)
	{
		if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT))
			return true;
	
		return false;
	}

	if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_FRONTEND_CANCEL) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_FRONTEND_CANCEL))
		return true;

	return false;
}

void func_106() // Position - 0x2122 (8482)
{
	int i;
	var textureDict;

	MISC::CLEAR_BIT(&Global_1925700, 0);
	MISC::CLEAR_BIT(&Global_1925700, 1);
	MISC::CLEAR_BIT(&Global_1925700, 2);
	MISC::CLEAR_BIT(&Global_1925700, 3);
	MISC::CLEAR_BIT(&Global_1925700, 4);
	MISC::CLEAR_BIT(&Global_1925700, 6);
	MISC::SET_RANDOM_SEED(NETWORK::GET_NETWORK_TIME());
	uLocal_72.f_20 = MISC::GET_RANDOM_INT_IN_RANGE(0, 10);
	i = 0;

	for (i = 0; i <= uLocal_72.f_11 - 1; i = i + 1)
	{
		uLocal_72[i] = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
	
		if (func_66(uLocal_72.f_20, i) == uLocal_72[i])
			i = -1;
	}
	...
	_DISPLAY_HELP_TEXT("CBH_MV_HELP" /*Ajusta los bloques del circuito para formar una línea continua entre el principio y el final. Usa ~INPUTGROUP_CELLPHONE_NAVIGATE~ para seleccionar y mover los bloques. Presiona ~INPUT_FRONTEND_ACCEPT~ para probar el circuito.*/, 10000);
	AUDIO::START_AUDIO_SCENE("DLC_24-2_Hacking_Circuit_Scene");
	uLocal_72.f_21 = AUDIO::GET_SOUND_ID();
	AUDIO::PLAY_SOUND_FRONTEND(uLocal_72.f_21, "Background_Loop", "DLC_24-2_Hack_Circuit_Board", true);
	uLocal_72.f_22 = AUDIO::GET_SOUND_ID();
	AUDIO::PLAY_SOUND_FRONTEND(uLocal_72.f_22, "Timer", "DLC_24-2_Hack_Circuit_Board", true);
	func_11(1);
	return;
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x228A (8842)
{
...
char* func_108() // Position - 0x22A1 (8865)
{
	return "CommonMenu";
}

void func_109() // Position - 0x22AD (8877)
{
	func_120(0);
...
void func_110() // Position - 0x2328 (9000)
{
	if (!Global_2673276.f_1023.f_10)
...
void func_111() // Position - 0x2347 (9031)
{
...
void func_112() // Position - 0x235D (9053)
{
...
void func_113() // Position - 0x2380 (9088)
{
	Global_24447.f_134 = 1;
	return;
}

BOOL func_114() // Position - 0x238E (9102)
{
	if (func_115() == 0)
		return true;
...
int func_115() // Position - 0x23A3 (9123)
{
	return Global_1574635.f_18;
}

void func_116() // Position - 0x23B1 (9137)
{
	Global_2733326.f_3726 = 0;
	return;
}

void func_117() // Position - 0x23C1 (9153)
{
	Global_24447.f_6 = 1;
	return;
}

void func_118() // Position - 0x23CF (9167)
{
	Global_1574757 = true;
...
void func_119(int iParam0, int iParam1) // Position - 0x23F8 (9208)
{
...
void func_120(int iParam0) // Position - 0x242E (9262)
{
	if (func_126())
		return;
...
void func_121(int iParam0) // Position - 0x2461 (9313)
{
	if (func_126())
		return;
...
BOOL func_122() // Position - 0x24EB (9451)
{
...
void func_123(BOOL bParam0, BOOL bParam1) // Position - 0x2512 (9490)
{
	if (bParam0)
	{
		if (func_125(0))
...
BOOL func_124() // Position - 0x2586 (9606)
{
	return IS_BIT_SET(Global_1965230, 5);
}

BOOL func_125(int iParam0) // Position - 0x2594 (9620)
{
	if (iParam0 == 1)
...
BOOL func_126() // Position - 0x25EB (9707)
{
	return IS_BIT_SET(Global_1965230, 19);
}

void func_127() // Position - 0x25FA (9722)
{
	BUILTIN::WAIT(0);
	return;
}
