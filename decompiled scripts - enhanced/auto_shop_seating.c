	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_104(Global_2658296[plParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_104(int iParam0) // Position - 0x2AA0 (10912)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_105() // Position - 0x3009 (12297)
{
	...
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("auto_shop_seating", Global_2658296[PLAYER::PLAYER_ID() /*468*/].f_325.f_11, true, 0))
			return false;
...
{
	func_107(0, &uLocal_147, 0, 1);
	func_107(1, &uLocal_147, 1, 1);
	func_107(2, &uLocal_147, 2, 1);
	func_107(3, &uLocal_147, 3, 1);
	func_107(4, &uLocal_147, 4, 1);
	return;
}
