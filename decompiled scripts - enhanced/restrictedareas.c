...
void main() // Position - 0x0 (0)
{
	...
	func_43();
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_104, 8, 0, "TANNOY", 0, 1);
				...
				case 0:
					...
					else
					{
						if (bLocal_75)
						{
							...
							for (iLocal_85 = 0; iLocal_85 < 8; iLocal_85 = iLocal_85 + 1)
							{
								if (uLocal_76[iLocal_85])
								{
									if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_85 + 1, 0, false))
									{
						...
						{
							iLocal_54 = iLocal_87 + 1;
						
							if (func_36(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								if (!uLocal_55[iLocal_87])
									uLocal_55[iLocal_87] = 1;
							
								if (func_35(iLocal_54))
								{
									if (!uLocal_64[iLocal_87])
										uLocal_64[iLocal_87] = 1;
								
									uLocal_89 = { func_34(iLocal_54) };
								
									if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&uLocal_89)) == 0)
										if (!Global_34048[iLocal_54])
											func_33(iLocal_54, Global_34048[iLocal_54]);
								}
								else if (!Global_34048[iLocal_54])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!bLocal_73)
											if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_54, 0, false))
												if (MISC::GET_GAME_TIMER() - uLocal_95[iLocal_87] > 8000)
													func_25();
													...
													if (!bLocal_74)
														if (_CONVERSATION_ADD_LINE(&uLocal_104, "FH1AUD", "FH1_TANNOY", 8, 0, 0, 0))
															bLocal_74 = true;
											else
												uLocal_95[iLocal_87] = MISC::GET_GAME_TIMER();
									}
									else
									{
										bLocal_73 = false;
										...
										if (!bLocal_73)
											if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_54, 0, false))
												if (!(iLocal_54 == 4) || MISC::GET_GAME_TIMER() - uLocal_95[iLocal_87] > 8000)
													func_25();
											else
												uLocal_95[iLocal_87] = MISC::GET_GAME_TIMER();
									}
							...
							else if (uLocal_55[iLocal_87])
							{
								if (func_35(iLocal_54))
								{
									...
									if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&uLocal_89)) == 0)
									{
										func_33(iLocal_54, false);
										uLocal_55[iLocal_87] = 0;
									}
								}
								else if (Global_34048[iLocal_54])
								{
									Global_34048[iLocal_54] = false;
									uLocal_55[iLocal_87] = 0;
									uLocal_64[iLocal_87] = 0;
									bLocal_74 = false;
								}
							}
...
void func_15() // Position - 0xA98 (2712)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_16(character) && !func_20(14) || Global_113936)
			{
				if (Global_114990.f_2370.f_539.f_4321 != character && func_16(Global_114990.f_2370.f_539.f_4321))
...
void func_25() // Position - 0xD5C (3420)
{
	switch (iLocal_87)
	{
		case 0:
			iLocal_88 = 2;
			PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < iLocal_88;
			break;
	...
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < iLocal_88)
	{
		PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), iLocal_88, false);
		PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), false);
	}

	uLocal_76[iLocal_87] = 1;
	bLocal_75 = true;
	return;
}
