...
void main() // Position - 0x0 (0)
{
	...
	func_287(&uLocal_410, 3);
	func_286();

	if (iLocal_107 == 1 && func_285(55) && !func_284(55))
		SCRIPT::TERMINATE_THIS_THREAD();

	if (func_243(uLocal_139, 25, iLocal_107, false, false))
		func_240(-1);
	else
		SCRIPT::TERMINATE_THIS_THREAD();
	...
	while (true)
	{
		...
		func_236(blLocal_82, &uLocal_409);
						...
						switch (iLocal_65)
						{
							...
							case 2:
									...
									if (func_166())
									{
										if (iLocal_160 == 4)
										{
											...
											if (!HUD::DOES_BLIP_EXIST(blLocal_84))
												blLocal_84 = func_164(pkLocal_208);
								...
								if (bLocal_166)
								{
									...
									{
										func_157(blLocal_83, &uLocal_159);
									}
							...
							case 5:
								...
								if (!bLocal_169)
								{
									func_146(pedLocal_79, &uLocal_210);
...
BOOL func_14(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x122C (4652)
{
	...
	if (func_22() || func_21(*Global_4718592.f_203791) || func_20())
	{
	...
	if (!PED::IS_PED_INJURED(pedLocal_79))
	{
		if (!bLocal_169)
		{
			if (bLocal_170)
			{
						...
						if (func_131(true, false, true))
						{
							if (!func_130())
							{
								if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
									{
										while (!func_118(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fLocal_94, 1, 1056964608, false, true, false) || func_175())
										{
				...
				{
					func_114(ENTITY::GET_ENTITY_COORDS(pedLocal_79, true), &uLocal_93, &fLocal_94);
				}
			}
			...
			switch (iLocal_168)
			{
				case 0:
					...
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						if (!PED::IS_PED_INJURED(pedLocal_79))
						{
							func_111(pedLocal_79, &uLocal_142, &fLocal_145, sLocal_378, sLocal_380);
							...
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(playersLastVehicle, uLocal_142, maximum.f_1 + 1.5f, maximum.f_1 + 1.5f, 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(playersLastVehicle, PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_378, sLocal_380, uLocal_142, fLocal_145, 0, 2), maximum.f_1 + 1f, maximum.f_1 + 1f, 3f, false, true, 0))
								{
									...
									else
									{
										...
										uLocal_97 = { func_109(uLocal_142, PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_378, sLocal_380, uLocal_142, fLocal_145, 0, 2)) };
									}
				...
				case 1:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_148) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_148) > 0.9f || func_107(1000))
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
...
void func_69(int iParam0) // Position - 0x4096 (16534)
{
	...
	else if (IS_BIT_SET(Global_114990.f_20573.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_71() /*5574*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114990.f_20573.f_471), iParam0);
...
int func_89(int iParam0, int iParam1) // Position - 0x4994 (18836)
{
	...
	if (func_99(&Global_4525223))
	{
		if (func_97(&Global_4525223, iParam0))
			return 0;
...
void func_93(var uParam0) // Position - 0x4B6E (19310)
{
	...
	func_95(uParam0, Global_4525222 - 0.5f);
	return;
}
...
void func_136() // Position - 0x5F92 (24466)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_137(character) && !func_54(14) || Global_113936)
			{
				if (Global_114990.f_2370.f_539.f_4321 != character && func_137(Global_114990.f_2370.f_539.f_4321))
...
void func_150() // Position - 0x6670 (26224)
{
	...
	if (!HUD::DOES_BLIP_EXIST(blLocal_82))
		if (!ENTITY::IS_ENTITY_DEAD(pedLocal_79, false))
			blLocal_82 = func_151(pedLocal_79, false, 0);
	...
	if (!func_175())
	{
		if (BUILTIN::TIMERA() > 10000)
		{
			if (!PED::IS_PED_INJURED(pedLocal_79))
			{
				...
				{
					func_171(pedLocal_79, "GENERIC_CURSE_MED", 24);
					BUILTIN::SETTIMERA(0);
				}
			}
		}
		...
		if (iLocal_107 != 2)
		{
			if (!PED::IS_PED_INJURED(pedLocal_79) && !PED::IS_PED_INJURED(pedLocal_80))
			{
				...
				if (func_190())
				{
					...
					{
						if (!ENTITY::IS_ENTITY_DEAD(pedLocal_80, false))
							blLocal_85 = func_151(pedLocal_80, true, 0);
...
void func_180() // Position - 0x7E40 (32320)
{
	...
	if (!HUD::DOES_BLIP_EXIST(blLocal_83))
		if (!ENTITY::IS_ENTITY_DEAD(pedLocal_80, false))
			blLocal_83 = func_151(pedLocal_80, true, 0);
...
int func_182(BOOL bParam0) // Position - 0x7F50 (32592)
{
	if (func_184())
	{
		...
		if (func_183(Global_114979))
			func_148(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Evento aleatorio*/);
	
		if (bParam0 && func_183(Global_114979))
...
{
	switch (func_185(&Global_33892, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
{
	return func_188(iParam0, Global_44938);
}
...
void func_193(int iParam0, var uParam1) // Position - 0x856D (34157)
{
	switch (iParam0)
	{
		...
		case 5:
			func_194(uParam1, "Barry3A", func_196(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Las zonas donde puedes encontrar un vehículo con un botín oculto aparecen indicadas en el mapa. Recoge estos vehículos para Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_195(iParam0), 0, 1);
			break;
		...
		case 8:
			func_194(uParam1, "Dreyfuss1", func_196(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*Se reveló la identidad y el paradero del asesino.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_195(iParam0), 0, 0);
			break;
		...
		case 38:
			func_194(uParam1, "Nigel1A", func_196(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Se marcaron en el mapa las zonas en las que puedes encontrar objetos de famosos. Róbalos para Nigel y para la señora Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_195(iParam0), 1, 1);
			break;
		...
		case 49:
			func_194(uParam1, "Paparazzo3A", func_196(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Las zonas en las que puedes encontrar oportunidades para sacar fotos a famosos se marcaron en el mapa. Localiza y fotografía a estos famosos para Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_195(iParam0), 0, 1);
			break;
		...
		case 58:
			func_194(uParam1, "Tonya1", func_196(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Puedes encontrar extraños y locos por todo San Andreas en ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_195(iParam0), 0, 1);
			break;
...
{
	if (Global_114979 == func_205() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114980)
		return true;
...
void func_213() // Position - 0xA300 (41728)
{
	...
	if (bLocal_207 && !bLocal_154)
	{
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_80) && ENTITY::DOES_ENTITY_EXIST(pedLocal_80))
		{
			if (!PED::IS_PED_INJURED(pedLocal_79) && !PED::IS_PED_INJURED(pedLocal_80))
			{
				if (iLocal_205 - iLocal_204 > 12000 && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_80, 3f, 3f, 35f, false, true, 0) && ENTITY::IS_ENTITY_ON_SCREEN(pedLocal_80) && !func_175())
				{
			...
			if (func_204())
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_79, SCRIPT_TASK_PERFORM_SEQUENCE) == 7 || TASK::GET_SCRIPT_TASK_STATUS(pedLocal_79, SCRIPT_TASK_COWER) == 7)
				{
					...
					if (iLocal_209 > 0)
					{
						...
						BUILTIN::WAIT(0);
						func_220(_GET_CURRENT_PLAYER_CHARACTER(), 1, iLocal_209 / 10, false, true);
					}
...
{
	func_233();
	func_232(&uLocal_410, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE");
	func_232(&uLocal_410, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@EXIT");
	func_232(&uLocal_410, sLocal_394);
	func_232(&uLocal_410, sLocal_378);
	func_230(&uLocal_410, hLocal_100);
	func_230(&uLocal_410, hLocal_101);
	func_230(&uLocal_410, hLocal_102);
	func_232(&uLocal_410, sLocal_377);
	func_232(&uLocal_410, sLocal_376);
	func_232(&uLocal_410, sLocal_395);
	func_232(&uLocal_410, "RANDOM@BICYCLE_THIEF@IDLE_A");

	if (func_226(&uLocal_410))
	{
		func_223();
		return true;
	}
...
BOOL func_243(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xC0B5 (49333)
{
	...
	if (!flag)
	{
		...
		if (!func_278(Global_114990.f_25004.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_276() || Global_114037 || Global_33835 || func_275() || func_56(8, -1) || func_274() || func_273() || func_272() || func_271() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_276() || Global_33835 || func_275() || func_56(8, -1) || func_272() || func_274() || func_273() || func_271() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_276() || Global_114037 || Global_33835 || func_275() || func_56(8, -1) || func_272() || func_274() || func_273() || func_271() || Global_114990.f_7697.f_919[character] == 5 || Global_45485 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_276() || Global_114037 || Global_33835 || func_275() || func_56(8, -1) || func_274() || func_273() || func_271() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_276() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_56(8, -1) || func_271() || func_270() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_276() || Global_33835 || func_275() || func_56(8, -1) || func_273() || func_272() || func_271() || Global_114990.f_7697.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_276() || func_273() || Global_114037 || Global_33835 || func_275() || Global_46164 || func_56(8, -1) || func_272() || func_270() || func_271() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_276() || Global_114037 || Global_33835 || func_275() || func_56(8, -1) || func_272() || func_270() || func_274() || func_273() || func_271())
							return false;
						break;
				}
			}
...
void func_294(int iParam0) // Position - 0xDAD8 (56024)
{
	...
	if (func_204())
	{
		...
		func_298(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_297(Global_114979, true), 64);
	
		if (func_296(Global_114979) > 0)
		{
...
void func_306(int iParam0, int iParam1) // Position - 0xE35B (58203)
{
	...
	if (iParam1 <= func_296(iParam0))
	{
		...
		if (!func_315(51))
		{
			func_312("RE_REWARD" /*Algunos eventos aleatorios recompensarán al jugador con mejoras de estadísticas o con dinero.*/, 1, 0, 4000, 10000, func_198(), 0, 138, 0);
			func_311(51);
		}
		...
		if (func_310(iParam0, iParam1) != 322)
			func_307(func_310(iParam0, iParam1), uLocal_60, uLocal_60.f_1);
...
void func_308() // Position - 0xE545 (58693)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114990.f_10203.f_3853))
		func_101(13, BUILTIN::FLOOR(Global_114990.f_10203.f_3853));
