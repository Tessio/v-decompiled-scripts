...
void func_7(char* sParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAD1 (2769)
{
...
void func_27(ePedComponentType epctParam0) // Position - 0xF1A (3866)
{
	int num;
	int num2;
	int num3;
...
int func_29(ePedComponentType epctParam0) // Position - 0xFF6 (4086)
{
	int i;
...
int func_35(ePedComponentType epctParam0) // Position - 0x1156 (4438)
{
	int i;
...
void func_190(float fParam0, int iParam1) // Position - 0x1D714 (120596)
{
	func_191(fParam0, iParam1);
	return;
}
