...
void func_113() // Position - 0x3736 (14134)
{
	...
	if (!func_114(Global_45897[iLocal_63 /*5*/].f_2))
		return;
...
void func_128() // Position - 0x3DB2 (15794)
{
	...
	if (Global_45897[iLocal_63 /*5*/].f_3 >= 10 || Global_45897[iLocal_63 /*5*/].f_4 >= 15 || IS_BIT_SET(Global_46114, 9))
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && uLocal_41.f_1 == PLAYER::PLAYER_PED_ID() && func_145(PLAYER::PLAYER_ID()) && Global_262145.f_24026)
		{
			if (Global_45897[iLocal_63 /*5*/].f_3 >= 10)
				Global_45897[iLocal_63 /*5*/].f_3 = 9;
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && uLocal_41.f_1 == PLAYER::PLAYER_PED_ID() && func_144())
		{
			if (Global_45897[iLocal_63 /*5*/].f_3 >= 10)
				Global_45897[iLocal_63 /*5*/].f_3 = 9;
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && uLocal_41.f_1 == PLAYER::PLAYER_PED_ID() && func_140(PLAYER::PLAYER_ID()) && Global_262145.f_26696)
		{
			if (Global_45897[iLocal_63 /*5*/].f_3 >= 10)
				Global_45897[iLocal_63 /*5*/].f_3 = 9;
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && uLocal_41.f_1 == PLAYER::PLAYER_PED_ID() && func_137(PLAYER::PLAYER_ID()) && Global_262145.f_26727)
		{
			if (Global_45897[iLocal_63 /*5*/].f_3 >= 10)
				Global_45897[iLocal_63 /*5*/].f_3 = 9;
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && uLocal_41.f_1 == PLAYER::PLAYER_PED_ID() && func_133(PLAYER::PLAYER_ID()) == 15)
		{
			if (Global_45897[iLocal_63 /*5*/].f_3 >= 10)
				Global_45897[iLocal_63 /*5*/].f_3 = 9;
...
{
	if (func_132(Global_1845299[plParam0 /*883*/].f_260.f_39))
		return true;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_138(Global_2658294[plParam0 /*468*/].f_325.f_8) == 15;
...
BOOL func_140(Player plParam0) // Position - 0x4A1C (18972)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_138(Global_2658294[plParam0 /*468*/].f_325.f_8) == 14;
...
BOOL func_145(Player plParam0) // Position - 0x4AD1 (19153)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_138(Global_2658294[plParam0 /*468*/].f_325.f_8) == 11;
...
void func_149() // Position - 0x4C56 (19542)
{
	...
	if (iLocal_54.f_1 == -1)
	{
		fLocal_52 = func_150(vehicle, 0.13f, 0.06f);
	}
	else
	{
		...
		if (num < 5000)
			...
			fLocal_52 = func_150(vehicle, 0.05f, 0.02f);
		else if (num < 30000)
			fLocal_52 = func_150(vehicle, 0.07f, 0.03f);
		else if (num < 45000)
			fLocal_52 = func_150(vehicle, 0.09f, 0.04f);
		else if (num < 600000)
			fLocal_52 = func_150(vehicle, 0.1f, 0.05f);
		else
			fLocal_52 = func_150(vehicle, 0.13f, 0.06f);
	}
...
void func_168() // Position - 0x5604 (22020)
{
	...
	else
	{
		...
		if (!func_121(uLocal_41.f_1))
			func_114(Global_45897[iLocal_63 /*5*/].f_2);
	}
	...
	if (!func_35(0) && !func_35(3))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_41.f_1, false))
		{
			...
			if (Global_45897[iLocal_63 /*5*/].f_4 > 0)
			{
				...
				{
					case CHAR_MICHAEL:
						func_189(uLocal_41.f_1, "POST_STONED", 24);
						break;
