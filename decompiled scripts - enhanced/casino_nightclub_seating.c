	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_82(Global_2658296[plParam0 /*468*/].f_325.f_8) == 19;

	return false;
}

int func_82(BOOL bParam0) // Position - 0x2194 (8596)
{
	switch (bParam0)
	{
		case false:
...
void func_83() // Position - 0x26FD (9981)
{
	Global_1951201 = false;
	func_85(&uLocal_147);
	func_84();
...
void func_84() // Position - 0x2714 (10004)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_85(var uParam0) // Position - 0x2720 (10016)
{
	int localSceneFromNetworkId;
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_93(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_90(*Global_4718592.f_203791))
...
BOOL func_87(BOOL bParam0) // Position - 0x2C34 (11316)
{
...
BOOL func_88() // Position - 0x2C60 (11360)
{
	if (func_89())
		return true;
...
BOOL func_89() // Position - 0x2C7B (11387)
{
...
BOOL func_90(int iParam0) // Position - 0x2CA6 (11430)
{
	return iParam0 == 17;
}

void func_91() // Position - 0x2CB3 (11443)
{
	var unk;
...
void func_92() // Position - 0x2D00 (11520)
{
...
BOOL func_93(Ped pedParam0) // Position - 0x2D3E (11582)
{
	int scriptTaskStatus;
...
void func_94(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2D6F (11631)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2E3F (11839)
{
	Hash statName;
...
void func_96() // Position - 0x2E5B (11867)
{
	eViewModeContext i;
...
BOOL func_97(Player plParam0) // Position - 0x2EB3 (11955)
{
...
BOOL func_98() // Position - 0x2EF2 (12018)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_99(Player plParam0, int iParam1) // Position - 0x2F00 (12032)
{
	BOOL flag;
...
int func_100(int iParam0, BOOL bParam1) // Position - 0x2F59 (12121)
{
	int num;
	int num2;
...
int func_101() // Position - 0x2F9A (12186)
{
	return Global_1574928;
}

BOOL func_102(Player plParam0) // Position - 0x2FA6 (12198)
{
	Player player;
...
BOOL func_103() // Position - 0x2FC8 (12232)
{
...
void func_104() // Position - 0x2FF9 (12281)
{
...
void func_105() // Position - 0x3027 (12327)
{
	func_106(0, &uLocal_147, 0, 1);
	func_106(1, &uLocal_147, 1, 1);
	func_106(2, &uLocal_147, 2, 1);
	func_106(3, &uLocal_147, 3, 1);
	func_106(4, &uLocal_147, 4, 1);
	func_106(5, &uLocal_147, 5, 1);
	func_106(6, &uLocal_147, 6, 1);
	func_106(7, &uLocal_147, 7, 1);
	func_106(8, &uLocal_147, 8, 1);
	func_106(9, &uLocal_147, 9, 1);
	func_106(10, &uLocal_147, 10, 1);
	func_106(11, &uLocal_147, 11, 1);
	return;
}

void func_106(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x30A3 (12451)
{
	var unk;
	float num;
...
Vector3 func_107() // Position - 0x3134 (12596)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_108(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3147 (12615)
{
	float num;
	float num2;
	float num3;
...
float func_109(int iParam0, float fParam1) // Position - 0x318B (12683)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_110() // Position - 0x31C4 (12740)
{
	return -0.5f, -0.5f, 0f;
}

void func_111(int iParam0, var uParam1, var uParam2) // Position - 0x31D7 (12759)
{
	if (func_4())
	{
		switch (iParam0)
...
void func_112() // Position - 0x3527 (13607)
{
	return;
}

int func_113(int iParam0, int iParam1, BOOL bParam2) // Position - 0x352F (13615)
{
	int i;
