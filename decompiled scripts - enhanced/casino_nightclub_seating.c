...
BOOL func_78(ePedComponentType epctParam0) // Position - 0x20B2 (8370)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
		if (func_80(epctParam0) && !func_79(epctParam0))
			return true;

	return false;
}

BOOL func_79(ePedComponentType epctParam0) // Position - 0x20EB (8427)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_80(ePedComponentType epctParam0) // Position - 0x211C (8476)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
int func_82(ePedComponentType epctParam0) // Position - 0x2194 (8596)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_90(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_87(*Global_4718592.f_199277))
...
BOOL func_87(int iParam0) // Position - 0x2C33 (11315)
{
	return iParam0 == 17;
}

void func_88() // Position - 0x2C40 (11328)
{
	var unk;
...
void func_89() // Position - 0x2C8D (11405)
{
...
BOOL func_90(Ped pedParam0) // Position - 0x2CCB (11467)
{
	int scriptTaskStatus;
...
void func_91(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2CFC (11516)
{
	int num;
	eViewModeContext i;
...
void func_93() // Position - 0x2DE8 (11752)
{
	eViewModeContext i;
...
BOOL func_94(Player plParam0) // Position - 0x2E40 (11840)
{
...
BOOL func_95() // Position - 0x2E7F (11903)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_96(Player plParam0, int iParam1) // Position - 0x2E8D (11917)
{
	BOOL flag;
...
eCharacter func_97(int iParam0, BOOL bParam1) // Position - 0x2EE6 (12006)
{
...
int func_98() // Position - 0x2F27 (12071)
{
	return Global_1574927;
}

BOOL func_99(Player plParam0) // Position - 0x2F33 (12083)
{
	Player player;
...
BOOL func_100() // Position - 0x2F55 (12117)
{
...
void func_101() // Position - 0x2F86 (12166)
{
...
void func_102() // Position - 0x2FB4 (12212)
{
	func_103(0, &uLocal_140, 0, 1);
	func_103(1, &uLocal_140, 1, 1);
	func_103(2, &uLocal_140, 2, 1);
	func_103(3, &uLocal_140, 3, 1);
	func_103(4, &uLocal_140, 4, 1);
	func_103(5, &uLocal_140, 5, 1);
	func_103(6, &uLocal_140, 6, 1);
	func_103(7, &uLocal_140, 7, 1);
	func_103(8, &uLocal_140, 8, 1);
	func_103(9, &uLocal_140, 9, 1);
	func_103(10, &uLocal_140, 10, 1);
	func_103(11, &uLocal_140, 11, 1);
	return;
}

void func_103(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3030 (12336)
{
	var unk;
	float num;
...
Vector3 func_104() // Position - 0x30C1 (12481)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_105(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x30D4 (12500)
{
	float num;
	float num2;
	float num3;
...
float func_106(int iParam0, float fParam1) // Position - 0x3118 (12568)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_107() // Position - 0x3151 (12625)
{
	return -0.5f, -0.5f, 0f;
}

void func_108(int iParam0, var uParam1, var uParam2) // Position - 0x3164 (12644)
{
	if (func_4())
	{
		switch (iParam0)
...
void func_109() // Position - 0x34B4 (13492)
{
	return;
}

int func_110(int iParam0, int iParam1, BOOL bParam2) // Position - 0x34BC (13500)
{
	int i;
...
BOOL func_111(BOOL bParam0) // Position - 0x35D2 (13778)
{
	bParam0;
