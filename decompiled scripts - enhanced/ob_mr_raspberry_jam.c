...
void func_1() // Position - 0x171 (369)
{
	...
	switch (iLocal_291)
	{
		...
		case 5:
			...
			if (STATS::STAT_GET_INT(joaat("NUM_SH_MR_JAM_USED") /* TUNEABLE: NUM_SH_MR_JAM_USED */, &iLocal_299, -1))
				STATS::STAT_SET_INT(joaat("NUM_SH_MR_JAM_USED") /* TUNEABLE: NUM_SH_MR_JAM_USED */, iLocal_299 + 1, true);
...
eCharacter func_44(Interior inParam0, BOOL bParam1) // Position - 0x18FA (6394)
{
	eCharacter character;
	Interior interior;
...
Interior func_45() // Position - 0x193B (6459)
{
