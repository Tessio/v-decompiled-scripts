...
BOOL func_78(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41B9 (16825)
{
	...
	if (func_86() || func_85(*Global_4718592.f_203791) || func_84())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_113695.f_222[iParam0], false))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_113695.f_222[iParam0], true, true);
		return Global_113695.f_222[iParam0];
	}
...
{
	return Global_113695.f_20;
}

int func_113() // Position - 0x5876 (22646)
{
	return func_114(Global_113695.f_20, Global_113695.f_29);
}
...
void func_117(Vehicle veParam0, eCharacter echParam1) // Position - 0x5A25 (23077)
{
	...
	func_118(veParam0, &(Global_114990.f_32759.f_5510));
	return;
}
...
BOOL func_129() // Position - 0x68FD (26877)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_130() // Position - 0x6913 (26899)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_131() // Position - 0x6929 (26921)
{
	return false;
}

BOOL func_132() // Position - 0x6932 (26930)
{
	return true;
}

BOOL func_133() // Position - 0x693B (26939)
{
	return true;
}

BOOL func_134() // Position - 0x6944 (26948)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x695D (26973)
{
	int profileSetting;
...
BOOL func_136(Vehicle veParam0) // Position - 0x6A15 (27157)
{
	Hash entityModel;
...
BOOL func_137(Vehicle veParam0) // Position - 0x6A5C (27228)
{
	int i;
...
BOOL func_138(Vehicle veParam0) // Position - 0x6A97 (27287)
{
	int i;
...
BOOL func_139(Vehicle veParam0) // Position - 0x6B13 (27411)
{
	int i;
...
eCharacter func_140(Vehicle veParam0) // Position - 0x6BFB (27643)
{
	int i;
...
BOOL func_141(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x6C5E (27742)
{
	int i;
	var garageName;
	int num;
...
BOOL func_142(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x6CCC (27852)
{
...
void func_143(int iParam0) // Position - 0x6DA4 (28068)
{
