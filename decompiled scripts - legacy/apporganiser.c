...
void func_4(int iParam0, BOOL bParam1) // Position - 0x25C (604)
{
	...
	{
		num3 = num2;
		num2 = Global_99553[num /*25*/][value];
		...
		if (num == Global_99552 && value == Global_99551)
			flag = false;
	}
...
void func_8() // Position - 0x475 (1141)
{
	...
	if (num7 > 0)
	{
		...
		if (num7 > 7)
		{
			...
			for (i = 0; i < 7; i = i + 1)
			{
				for (j = 0; j < 24; j = j + 1)
				{
					if (!(Global_99553[num4 /*25*/][num5] == 0))
					{
						Global_99548 = Global_99548 + 1;
						Global_99550 = Global_99550 - 1;
					}
				
					Global_99553[num4 /*25*/][num5] = 0;
				}
			}
		}
		else if (num7 > 1)
	...
	else
	{
		if (num3 > clockHours)
		{
			Global_99731 = clockMonth;
			Global_99730 = clockDayOfMonth;
			Global_99729 = clockHours;
			Global_99552 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
			Global_99551 = CLOCK::GET_CLOCK_HOURS();
			return;
		}
