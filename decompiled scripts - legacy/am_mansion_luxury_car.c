...
BOOL func_27() // Position - 0x5FA (1530)
{
	...
	if (Global_1674227 && !func_340(2))
		func_285(2);

	if (func_282(PLAYER::PLAYER_ID()) && func_280(func_281(PLAYER::PLAYER_ID())) == 33 && Global_1950191 < 13)
		return false;
...
BOOL func_37(Player plParam0, int iParam1) // Position - 0xF58 (3928)
{
	BOOL flag;
...
int func_38(int iParam0, BOOL bParam1) // Position - 0xFB1 (4017)
{
	int num;
	int num2;
...
BOOL func_40(Player plParam0) // Position - 0xFFE (4094)
{
	Player player;
...
int func_48() // Position - 0x1527 (5415)
{
	return Global_33775;
}
...
BOOL func_61(Vehicle veParam0, Any* panParam1) // Position - 0x7E63 (32355)
{
	...
	{
		num = Global_2359296[func_68() /*5574*/].f_681.f_2;
...
int func_64(Player plParam0) // Position - 0x834D (33613)
{
	if (func_67(plParam0) == 233)
		return func_65(plParam0);

	return -1;
}

int func_65(Player plParam0) // Position - 0x836A (33642)
{
...
BOOL func_66(Player plParam0, BOOL bParam1) // Position - 0x838D (33677)
{
	if (func_40(plParam0))
...
int func_67(Player plParam0) // Position - 0x83D1 (33745)
{
	if (func_40(plParam0))
		if (func_66(plParam0, false))
...
BOOL func_70(Player plParam0, BOOL bParam1) // Position - 0x841C (33820)
{
	return func_71(plParam0, bParam1, 1);
}

int func_71(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x842D (33837)
{
	Player player;
...
BOOL func_72(Player plParam0, int iParam1) // Position - 0x8489 (33929)
{
	if (func_40(plParam0))
...
BOOL func_78(Player plParam0) // Position - 0x8594 (34196)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_79(plParam0) && Global_2658291[plParam0 /*468*/].f_325.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_79(Player plParam0) // Position - 0x85C9 (34249)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_280(Global_2658291[plParam0 /*468*/].f_325.f_8) == 22;
...
int func_83(int iParam0, int iParam1, int iParam2) // Position - 0x8991 (35217)
{
...
BOOL func_97(Player plParam0) // Position - 0xA7F2 (42994)
{
	Player player;
...
BOOL func_98(Player plParam0) // Position - 0xA817 (43031)
{
	Player player;
	...
	if (player != -1)
		return func_99(plParam0, 9);

	return false;
}

BOOL func_99(Player plParam0, int iParam1) // Position - 0xA835 (43061)
{
...
BOOL func_101(var uParam0, int iParam1) // Position - 0xA861 (43105)
{
	int num;
	int num2;
	int num3;
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xB3AC (45996)
{
	Vehicle vehiclePedIsIn;
...
void func_124(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, Vehicle veParam5) // Position - 0xB8D3 (47315)
{
	int i;
...
int func_125(Player plParam0, var uParam1, var uParam2, var uParam3, Hash hParam4) // Position - 0xB9A6 (47526)
{
	Player player;
	int i;
	Vector3 vector;
...
BOOL func_129(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, Hash hParam6, int iParam7, var uParam8, var uParam9, var uParam10) // Position - 0xBB15 (47893)
{
	BOOL flag;
	int i;
	float num;
	...
	{
		if (!(Global_2635562.f_677 == 0))
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635562.f_680) < func_271(false))
				return false;
			else
				Global_2635562.f_677 = 0;
	}
	else
	{
		...
		if (!(Global_2635562.f_677 == 0))
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635562.f_680) > func_271(true))
				Global_2635562.f_677 = 0;
	}
	...
	if (Global_2635562.f_677 == 0)
	{
		...
		if (!uParam10->f_27 || func_262(fParam0, true, 1133903872) && !uParam10->f_28 && !Global_2733002.f_590 && !Global_2733002.f_577 && !Global_2733002.f_585 && !Global_2733002.f_591 && !Global_2733002.f_613 && !Global_2733002.f_625 && !Global_2733002.f_592 && !Global_2733002.f_647 && !IS_BIT_SET(Global_2733002.f_594, 1))
	...
	switch (Global_2635562.f_677)
	{
		case 2:
			if (PATHFIND::ARE_NODES_LOADED_FOR_AREA(fParam0 - 100f, fParam0.f_1 - 100f, fParam0 + 100f, fParam0.f_1 + 100f))
			{
				...
				if (uParam10->f_3 && func_214(fParam0, num, num2, num3, 1f, false, false, false, 1123024896, false, -1, true, 0, false, 0, false, false) && !uParam10->f_7 && !func_212(fParam0, *uParam9, hParam6, PLAYER::PLAYER_ID(), 0))
				{
					Global_2635562.f_684 = { fParam0 };
				...
				func_153(Global_2635562.f_684, Global_2635562.f_687, hParam6, &(Global_2635562.f_674));
			...
			if (Global_2635562.f_672)
			{
				if (Global_2635562.f_674 == Global_2635562.f_675)
				{
					if (Global_2635562.f_673)
					{
						...
						{
							if (func_152(Global_2635562.f_684, Global_2635562.f_687, hParam6, true, 1036831949))
							{
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635562.f_701) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2635562.f_700))
					{
						if (NETWORK::NETWORK_ENTITY_AREA_HAVE_ALL_REPLIED(Global_2635562.f_700))
						{
							...
							{
								if (func_148(Global_2635562.f_684, Global_2635562.f_687, hParam6, PLAYER::PLAYER_ID(), 0) || func_131(Global_2635562.f_684, Global_2635562.f_687, hParam6, true, false, false, false, 1, false))
								{
									func_150(Global_2635562.f_684, 0);
									func_149(-1);
								}
...
BOOL func_131(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, BOOL bParam10) // Position - 0xC4EF (50415)
{
	Player i;
	Player player;
	float num;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (iParam9 == 1 && PLAYER::PLAYER_ID() != player || iParam9 == 0)
		{
			if (_NETWORK_IS_PLAYER_VALID(player, bParam5, bParam6))
			{
				...
				{
					if (!bParam8 || !PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(player)) && func_147(player))
					{
							...
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(player)))
							{
								...
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(player), false))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))
									{
										...
										if (func_141(uParam0, iParam3, hParam4, entityCoords, entityHeading, entityModel, 0))
											return true;
									}
									else
									{
								...
								if (func_132(_GET_PLAYER_COORDS(player), uParam0, iParam3, hParam4, num))
									return true;
							}
						}
					}
...
BOOL func_132(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6, Hash hParam7, int iParam8) // Position - 0xC662 (50786)
{
	Vector3 vector;
	Vector3 vector2;
	float width;

	if (BUILTIN::VDIST(vParam0, vParam3) < func_140(hParam7, 1008981770))
	{
		func_133(vParam3, iParam6, hParam7, &vector, &vector2, &width, iParam8);
...
void func_133(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, var uParam5, var uParam6, Any anParam7, int iParam8) // Position - 0xC6B5 (50869)
{
	Vector3 vector;
	var unk3;
	float num;
	...
	func_134(hParam4, &unk3, &num, 1086324736, 1080033280, 1077936128);
...
void func_134(Hash hParam0, Vector3* pvParam1, Vector3* pvParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC781 (51073)
{
	int num;
...
void func_136(int iParam0, var uParam1) // Position - 0xCA8C (51852)
{
	switch (iParam0)
	{
		case 1:
...
int func_137(Hash hParam0) // Position - 0xCB0D (51981)
{
	int i;
	int num;
...
Hash func_138(int iParam0) // Position - 0xCB3C (52028)
{
	Hash num;
...
float func_140(Hash hParam0, int iParam1) // Position - 0xCC25 (52261)
{
	var unk;
	var unk4;
	float num;
...
BOOL func_141(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, var uParam5, var uParam6, var uParam7, float fParam8, Hash hParam9, int iParam10) // Position - 0xCCA5 (52389)
{
	if (func_132(uParam0, uParam5, fParam8, hParam9, 1036831949))
		return true;

	func_133(uParam0, iParam3, hParam4, &Global_1982441, &(Global_1982441.f_3), &(Global_1982441.f_6), 1036831949);
	func_133(uParam5, fParam8, hParam9, &(Global_1982441.f_7), &(Global_1982441.f_10), &(Global_1982441.f_13), 1036831949);
...
BOOL func_142(Player plParam0) // Position - 0xCD43 (52547)
{
...
BOOL func_143(Player plParam0, Player plParam1) // Position - 0xCD8A (52618)
{
	Player player;

	player = func_144(plParam0);

	if (func_40(player))
		if (player == func_144(plParam1))
			return true;

	return false;
}

Player func_144(Player plParam0) // Position - 0xCDB3 (52659)
{
	if (func_40(plParam0))
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0xCDD6 (52694)
{
	var gamerHandle;
...
BOOL func_146(Player plParam0, Player plParam1) // Position - 0xCDED (52717)
{
...
BOOL func_147(Player plParam0) // Position - 0xCE5A (52826)
{
...
BOOL func_148(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0xCE86 (52870)
{
	Player i;
	Player player;
		...
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
				if (Global_2649159.f_261[i])
					if (func_132(Global_2649159.f_131[i /*3*/], uParam0, iParam3, hParam4, 1036831949))
						return true;
				else if (func_132(_GET_PLAYER_COORDS(player), uParam0, iParam3, hParam4, 1036831949))
					return true;
				...
				if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(player)))
					if (func_132(_GET_PLAYER_COORDS(player), uParam0, iParam3, hParam4, 1036831949))
						return true;
		}
	}
...
BOOL func_152(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0xD0A4 (53412)
{
	Vector3 vector;
	Vector3 vector2;
	var unk5;
	...
	else
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			...
			{
				func_133(uParam0, iParam3, hParam4, &vector, &vector2, &unk5, iParam6);
...
void func_153(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, var uParam5) // Position - 0xD175 (53621)
{
	Hash eventData;

	*uParam5 = func_154(&uParam0, &iParam3, &hParam4);
	eventData = 323285304;
	eventData.f_1 = PLAYER::PLAYER_ID();
	eventData.f_3 = { uParam0 };
...
BOOL func_158(var uParam0, var uParam1, var uParam2, float fParam3, Player plParam4, int iParam5, int iParam6) // Position - 0xDD36 (56630)
{
	if (func_160(uParam0, fParam3, plParam4, iParam5, false) || func_159(uParam0, plParam4, iParam6))
		return true;

	return false;
}

int func_159(var uParam0, var uParam1, var uParam2, Player plParam3, int iParam4) // Position - 0xDD67 (56679)
{
	Player i;
	int j;
	Player player;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (!(plParam3 == i) || iParam4 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (!(Global_2649159.f_461[i /*11*/][j /*5*/].f_4 == 0))
...
int func_160(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Player plParam4, int iParam5, BOOL bParam6) // Position - 0xDE29 (56873)
{
	Player i;
	Player player;
	BOOL flag;
...
BOOL func_166(Player plParam0) // Position - 0xE15E (57694)
{
			...
			if (NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), plParam0))
				if (!(PLAYER::GET_PLAYER_TEAM(plParam0) == PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID())))
					if (func_170(PLAYER::PLAYER_ID(), true, false))
						if (!func_167(PLAYER::GET_PLAYER_TEAM(plParam0), PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()), 0, -1))
							return true;
					else
						return true;
...
BOOL func_168(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE557 (58711)
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || func_37(player, 0) || IS_BIT_SET(Global_2658291[player /*468*/].f_203, 2) || func_169(player))
		{
		}
...
BOOL func_169(Player plParam0) // Position - 0xE683 (59011)
{
	return IS_BIT_SET(Global_1845250[plParam0 /*880*/].f_36.f_18, 14);
}

BOOL func_170(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE69B (59035)
{
	if (bParam1)
...
BOOL func_171(Player plParam0) // Position - 0xE6CD (59085)
{
	return func_172(plParam0);
}

BOOL func_172(Player plParam0) // Position - 0xE6DB (59099)
{
	return IS_BIT_SET(Global_1845250[plParam0 /*880*/].f_11.f_1, 0);
}

BOOL func_173(Player plParam0) // Position - 0xE6F2 (59122)
{
...
BOOL func_175(Vector3 vParam0, var uParam1, var uParam2, int iParam3, Hash hParam4) // Position - 0xE73F (59199)
{
	int flags;
	...
	if (ENTITY::DOES_ENTITY_EXIST(closestVehicle) && !ENTITY::IS_ENTITY_DEAD(closestVehicle, false))
	{
		...
		if (func_141(vParam0, iParam3, hParam4, entityCoords, entityHeading, entityModel, 0))
			return true;
	}
...
BOOL func_176(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6, int iParam7) // Position - 0xE84B (59467)
{
	if (func_148(uParam0, iParam3, hParam4, plParam5, iParam6) || func_212(uParam0, iParam3, hParam4, plParam5, iParam7))
		return true;
...
Vector3 func_182(Vector3 vParam0, var uParam1, var uParam2, float* pfParam3, int iParam4, BOOL bParam5, Vector3 vParam6, var uParam7, var uParam8, BOOL bParam9, BOOL bParam10, Hash hParam11, var uParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16) // Position - 0xED4E (60750)
{
	...
	if (flags & 1024 == 0 && !bParam10)
	{
		...
		if (bParam14)
		{
			...
			if (VEHICLE::IS_THIS_MODEL_A_HELI(hParam11) && func_184(vParam0))
				return 0f, 0f, 0f;
		}
		...
		else
		{
			...
			{
				if (flags & 8 != 0)
					num2 = func_183(hParam11, 3.5f);
				else
					num2 = func_183(hParam11, 1.5f);
...
float func_183(Hash hParam0, float fParam1) // Position - 0xF19D (61853)
{
	var unk;
	float num;
	float num2;

	func_134(hParam0, &unk, &num, 1086324736, 1080033280, 1077936128);
	num2 = num - unk;
...
BOOL func_212(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0x10878 (67704)
{
	Player i;
	int j;
	Player player;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (func_213(uParam0, hParam4, Global_2649159.f_461[i /*11*/][j /*5*/], Global_2649159.f_461[i /*11*/][j /*5*/].f_4))
					if (func_141(uParam0, iParam3, hParam4, Global_2649159.f_461[i /*11*/][j /*5*/], Global_2649159.f_461[i /*11*/][j /*5*/].f_3, Global_2649159.f_461[i /*11*/][j /*5*/].f_4, 0))
						if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
							return true;
						else
							return true;
...
BOOL func_213(Vector3 vParam0, var uParam1, var uParam2, Hash hParam3, Vector3 vParam4, var uParam5, var uParam6, Hash hParam7) // Position - 0x10952 (67922)
{
	float num;
	float num2;
	float num3;

	num = func_140(hParam3, 1008981770);
	num2 = func_140(hParam7, 1008981770);
...
BOOL func_214(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, float fParam10, BOOL bParam11, int iParam12, BOOL bParam13, int iParam14, BOOL bParam15, int iParam16, BOOL bParam17, BOOL bParam18) // Position - 0x10992 (67986)
{
	...
	if (iParam14 > 0f)
		if (func_221(fParam0, iParam14, true, true, bParam15, bParam17, bParam11, bParam15, false))
			return 0;
...
BOOL func_215(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x10AA4 (68260)
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		{
			if (!func_37(player, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), player))
			{
					...
					if (func_147(player) || !bParam10 && !Global_2658291[player /*468*/].f_274)
					{
						...
						if (!bParam7)
							if (bParam5 || bParam5 == false && PLAYER::GET_PLAYER_TEAM(player) != PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) || PLAYER::GET_PLAYER_TEAM(player) == -1)
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_216(player), vParam0, true) <= num + fParam3)
...
Vector3 func_216(Player plParam0) // Position - 0x10C5C (68700)
{
	Player player;

	player = plParam0;

	if (func_220() && Global_1845250[player /*880*/].f_862 && !func_219(Global_1845250[player /*880*/].f_863))
...
BOOL func_219(float fParam0, var uParam1, var uParam2) // Position - 0x10CF0 (68848)
{
...
BOOL func_220() // Position - 0x10D1A (68890)
{
	return Global_2685150.f_19;
}

BOOL func_221(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x10D28 (68904)
{
	Player i;
	Player player;
...
void func_222() // Position - 0x10E2C (69164)
{
	func_223(-692.3094f, -1442.4144f, 24f, 288f);
	func_223(-708.6566f, -1492.726f, 24f, 216f);
	func_223(-735.107f, -1411.3202f, 24f, 360f);
	func_223(-692.3094f, -1470.226f, 44f, 252f);
	func_223(-708.6566f, -1419.9144f, 44f, 324f);
	func_223(-761.5574f, -1492.726f, 24f, 144f);
	func_223(-777.9046f, -1442.4144f, 24f, 72f);
	func_223(-735.107f, -1501.3202f, 44f, 180f);
	func_223(-777.9046f, -1470.226f, 44f, 108f);
	func_223(-761.5574f, -1419.9144f, 44f, 36f);
	func_223(-735.107f, -1386.3202f, 54f, 360f);
	func_223(-693.962f, -1399.6888f, 34f, 324f);
	func_223(-668.533f, -1434.6888f, 54f, 288f);
	func_223(-668.533f, -1477.9515f, 34f, 252f);
	func_223(-693.962f, -1512.9515f, 54f, 216f);
	func_223(-735.107f, -1526.3202f, 34f, 180f);
	func_223(-776.252f, -1512.9515f, 54f, 144f);
	func_223(-801.681f, -1477.9515f, 34f, 108f);
	func_223(-801.681f, -1434.6888f, 54f, 72f);
	func_223(-776.252f, -1399.6888f, 34f, 36f);
	func_223(-735.107f, -1431.3202f, 69f, 360f);
	func_223(-711.3306f, -1448.5946f, 69f, 288f);
	func_223(-720.4124f, -1476.5458f, 69f, 216f);
	func_223(-749.8016f, -1476.5458f, 69f, 144f);
	func_223(-758.8834f, -1448.5946f, 49f, 72f);
	func_223(-696.4671f, -1369.5336f, 49f, 336f);
	func_223(-640.6275f, -1466.2504f, 49f, 264f);
	func_223(-715.3553f, -1549.244f, 49f, 195.48f);
	func_223(-817.3795f, -1503.8202f, 49f, 120f);
	func_223(-805.7059f, -1392.7528f, 49f, 48f);
	func_223(-735.0321f, -1346.4086f, 64f, 360f);
	func_223(-630.4158f, -1422.4169f, 64f, 288f);
	func_223(-670.3758f, -1545.4003f, 64f, 216f);
	func_223(-799.6883f, -1545.4003f, 64f, 144f);
	func_223(-839.6483f, -1422.4169f, 64f, 72f);
	return;
}

void func_223(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1117C (70012)
{
...
void func_224() // Position - 0x111E1 (70113)
{
	func_223(-746.1063f, -1469.455f, 4.5f, 316.7026f);
	func_223(-724.7337f, -1444.4575f, 4.5f, 141.0742f);
	func_223(-762.1299f, -1453.8724f, 4.5f, 273.6639f);
	func_223(-721.4189f, -1473.2883f, 4.5f, 97.6222f);
	func_223(-746.037f, -1433.3291f, 4.5f, 273.6639f);
	func_223(-700.7369f, -1447.7029f, 4.5f, 97.6222f);
	return;
}

void func_225(Hash hParam0) // Position - 0x11279 (70265)
{
	int randomIntInRange;
...
void func_226() // Position - 0x11603 (71171)
{
...
void func_227() // Position - 0x116CB (71371)
{
...
void func_228() // Position - 0x117C3 (71619)
{
...
void func_229(Hash hParam0) // Position - 0x118BB (71867)
{
	int num;
...
int func_230(Hash hParam0) // Position - 0x119C5 (72133)
{
	switch (hParam0)
	{
		case joaat("microlight"):
...
BOOL func_231(var uParam0, var uParam1, var uParam2) // Position - 0x11B4F (72527)
{
	var unk;

	if (Global_2733002.f_590 || IS_BIT_SET(Global_2733002.f_594, 1) && func_232(uParam0, &unk))
		return true;

	return false;
}

BOOL func_232(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x11B84 (72580)
{
	int i;
	int num;
	int num2;
	...
	*uParam3 = -1;
	...
	if (!(num2 == -1))
	{
		for (i = 83; i <= 87; i = i + 1)
		{
			...
			if (func_233(num))
			{
				if (func_241(Global_1950198.f_781[i /*3*/], 0) == num2)
				{
					*uParam3 = i + 1000;
					return true;
				}
...
BOOL func_233(int iParam0) // Position - 0x11BE8 (72680)
{
	int num;
	Player player;
	...
	player = Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10;

	if (player != _INVALID_PLAYER_INDEX())
		if (Global_1845250[player /*880*/].f_260.f_304 == num)
			return true;

	if (func_239() == iParam0)
		return true;

	if (func_238(PLAYER::PLAYER_ID(), false) || func_282(PLAYER::PLAYER_ID()) && func_280(func_281(PLAYER::PLAYER_ID())) == 12)
		return true;

	if (func_237(PLAYER::PLAYER_ID()) || func_282(PLAYER::PLAYER_ID()) && func_280(func_281(PLAYER::PLAYER_ID())) == 8)
		return true;

	if (func_236(PLAYER::PLAYER_ID()) || func_282(PLAYER::PLAYER_ID()) && func_280(func_281(PLAYER::PLAYER_ID())) == 5)
		return true;

	if (func_235(PLAYER::PLAYER_ID()) || func_282(PLAYER::PLAYER_ID()) && func_280(func_281(PLAYER::PLAYER_ID())) == 10)
		return true;

	if (func_234(PLAYER::PLAYER_ID()) || func_282(PLAYER::PLAYER_ID()) && func_280(func_281(PLAYER::PLAYER_ID())) == 6)
		return true;

	return false;
}

BOOL func_234(Player plParam0) // Position - 0x11D44 (73028)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_280(Global_2658291[plParam0 /*468*/].f_325.f_8) == 6;

	return false;
}

BOOL func_235(Player plParam0) // Position - 0x11D8A (73098)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_280(Global_2658291[plParam0 /*468*/].f_325.f_8) == 10;

	return false;
}

BOOL func_236(Player plParam0) // Position - 0x11DD1 (73169)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658291[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_280(Global_2658291[plParam0 /*468*/].f_325.f_8) == 5;

	return false;
}

BOOL func_237(Player plParam0) // Position - 0x11E30 (73264)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658291[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_280(Global_2658291[plParam0 /*468*/].f_325.f_8) == 8;

	return false;
}

BOOL func_238(Player plParam0, BOOL bParam1) // Position - 0x11E90 (73360)
{
	Vehicle vehiclePedIsIn;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658291[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_280(Global_2658291[plParam0 /*468*/].f_325.f_8) == 12;

	return false;
}

int func_239() // Position - 0x11F1E (73502)
{
	return Global_2658291[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

int func_240(int iParam0) // Position - 0x11F36 (73526)
{
	switch (iParam0)
	{
		case 83:
...
int func_241(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x11F87 (73607)
{
	int i;
...
void func_242(var uParam0, var uParam1, var uParam2, Hash hParam3) // Position - 0x11FDB (73691)
{
	int i;
	int num;
	int num2;
	...
	if (!func_261())
	{
		...
		if (num > -1)
		{
			...
			switch (num)
			{
				...
				case 30:
					if (func_257(hParam3))
						func_258(Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_260.f_39);
					break;
				...
				case 32:
					func_223(54.0916f, -1417.7871f, 28.68f, -134.36f);
					func_223(56.6694f, -1414.9559f, 28.6847f, -134.96f);
					break;
			}
		}
		else
		{
			...
			if (func_253(uParam0, &num2, &unk4) || func_232(uParam0, &num2[0]) && VEHICLE::IS_THIS_MODEL_A_PLANE(hParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(hParam3))
			{
				func_272();
...
void func_243(int iParam0, Hash hParam1) // Position - 0x12E0C (77324)
{
	switch (iParam0)
	{
		case 23:
...
void func_244(float fParam0, float fParam1, float fParam2, float fParam3, Hash hParam4, BOOL bParam5) // Position - 0x17259 (94809)
{
	var unk;
	var unk4;
	float num;
	...
	if (!(hParam4 == 0))
	{
		func_134(hParam4, &unk, &unk4, 1086324736, 1080033280, 1077936128);
		...
		func_223(offsetFromCoordAndHeadingInWorldCoords, fParam3);
	}
	else
	{
...
void func_245(int iParam0) // Position - 0x172D3 (94931)
{
	switch (iParam0)
	{
		case 83:
...
BOOL func_246(Hash hParam0) // Position - 0x188A7 (100519)
{
	switch (hParam0)
	{
		case joaat("microlight"):
...
void func_247(int iParam0) // Position - 0x18963 (100707)
{
	switch (iParam0)
	{
		case 83:
...
BOOL func_248(Hash hParam0) // Position - 0x18F39 (102201)
{
	switch (hParam0)
	{
		case joaat("hydra"):
...
int func_249(Ped pedParam0) // Position - 0x18FEF (102383)
{
...
BOOL func_250(Ped pedParam0) // Position - 0x19005 (102405)
{
...
int func_251(Ped pedParam0) // Position - 0x19043 (102467)
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0;
...
BOOL func_252(int iParam0, int iParam1) // Position - 0x19081 (102529)
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
BOOL func_253(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1915E (102750)
{
	int i;
	int j;
	int num;
...
BOOL func_254(int iParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x19345 (103237)
{
	float num;

	if (iParam0 == -1 || func_280(iParam0) != 28)
		return 0;
...
BOOL func_255(int iParam0) // Position - 0x19481 (103553)
{
	int num;
	Player player;
	...
	if (player != _INVALID_PLAYER_INDEX())
		if (Global_1845250[player /*880*/].f_260.f_311 == num)
			return true;
...
int func_256(int iParam0) // Position - 0x194E9 (103657)
{
	switch (iParam0)
	{
		case 89:
...
BOOL func_257(Hash hParam0) // Position - 0x19570 (103792)
{
...
void func_258(int iParam0) // Position - 0x1959E (103838)
{
	switch (iParam0)
	{
		case 78:
...
BOOL func_259() // Position - 0x1A799 (108441)
{
	return Global_2685150.f_17;
}

int func_260(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1A7A7 (108455)
{
	int i;
...
BOOL func_261() // Position - 0x1A849 (108617)
{
...
BOOL func_262(float fParam0, var uParam1, var uParam2, BOOL bParam3, int iParam4) // Position - 0x1A871 (108657)
{
	int i;
	int num;
	float num2;
...
void func_263() // Position - 0x1A8F3 (108787)
{
	int i;
...
BOOL func_264(var uParam0, BOOL bParam1) // Position - 0x1A91E (108830)
{
	int i;
	var unk;
...
BOOL func_265(var uParam0, var uParam1, var uParam2) // Position - 0x1A9BB (108987)
{
	int num;
	var unk;
	...
	if (!Global_2635562.f_516 && !Global_2635562.f_517)
	{
		if (!Global_2635562.f_45.f_318)
		{
			...
			else
			{
				...
				if (num > -1)
				{
					unk = { func_266(&Global_2635562.f_45[num /*12*/]) };
...
Vector3 func_266(var uParam0) // Position - 0x1AA7B (109179)
{
	switch (uParam0->f_10)
	{
		case 0:
...
int func_267(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x1AAC4 (109252)
{
	int i;
...
BOOL func_268(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x1AB0C (109324)
{
	int i;
...
BOOL func_269(Player plParam0, BOOL bParam1) // Position - 0x1AB53 (109395)
{
	if (func_48() != 0)
		return func_270(plParam0) != 0;

	return func_170(plParam0, bParam1, false);
}

int func_270(Player plParam0) // Position - 0x1AB7A (109434)
{
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
...
int func_271(BOOL bParam0) // Position - 0x1AB9C (109468)
{
	if (CAM::IS_SCREEN_FADED_OUT())
		return 10000;
...
void func_272() // Position - 0x1ABBF (109503)
{
	int i;
	var unk;
...
void func_273() // Position - 0x1ABF3 (109555)
{
	int i;
...
BOOL func_274() // Position - 0x1AC9F (109727)
{
...
BOOL func_275() // Position - 0x1ACDB (109787)
{
	if (!(Global_2635562.f_607 == 0) && NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635562.f_612) < func_271(false))
		return true;

	return false;
}

BOOL func_276() // Position - 0x1AD0F (109839)
{
	...
	if (!func_277(PLAYER::PLAYER_ID()) && !func_218(false))
		return false;

	return true;
}

BOOL func_277(Player plParam0) // Position - 0x1AD66 (109926)
{
	if (!func_40(plParam0))
		return false;
...
float func_278() // Position - 0x1AD85 (109957)
{
	return 10f;
}

Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x1AD92 (109970)
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

int func_280(int iParam0) // Position - 0x1ADA5 (109989)
{
	switch (iParam0)
	{
		case 0:
...
int func_281(Player plParam0) // Position - 0x1B2F5 (111349)
{
...
BOOL func_282(Player plParam0) // Position - 0x1B326 (111398)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		if (func_284(plParam0) && !func_283(plParam0))
			return true;

	return false;
}

BOOL func_283(Player plParam0) // Position - 0x1B35F (111455)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		return IS_BIT_SET(Global_2658291[plParam0 /*468*/].f_325, 4);

	return false;
}

BOOL func_284(Player plParam0) // Position - 0x1B390 (111504)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
void func_285(int iParam0) // Position - 0x1B3C1 (111553)
{
	int num;
	int offset;
...
void func_286(int iParam0) // Position - 0x1B3E3 (111587)
{
	int num;
	int offset;
...
void func_287(Player plParam0) // Position - 0x1B412 (111634)
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
void func_288() // Position - 0x1B42B (111659)
{
	if (func_24() > 0)
	{
		func_320();
	...
	if (func_290(NETWORK::PARTICIPANT_ID()) != 3 && func_24() == 3)
		func_289(3);
...
void func_289(int iParam0) // Position - 0x1B49D (111773)
{
	uLocal_104[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
	return;
}

int func_290(Player plParam0) // Position - 0x1B4B1 (111793)
{
	return uLocal_104[plParam0 /*4*/].f_1;
}

void func_291() // Position - 0x1B4C1 (111809)
{
	if (!func_301())
		return;
...
void func_292() // Position - 0x1B4FD (111869)
{
	func_293(28);
	return;
}

void func_293(int iParam0) // Position - 0x1B50B (111883)
{
	MISC::CLEAR_BIT(&(Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_6), iParam0);
	return;
}

void func_294() // Position - 0x1B528 (111912)
{
	func_295(28);
	return;
}

void func_295(int iParam0) // Position - 0x1B536 (111926)
{
	MISC::SET_BIT(&(Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_6), iParam0);
	return;
}

BOOL func_296(Player plParam0) // Position - 0x1B553 (111955)
{
	return func_6(plParam0, 28);
}

BOOL func_297() // Position - 0x1B563 (111971)
{
	if (func_5(PLAYER::PLAYER_ID()))
		return false;
...
BOOL func_298(Player plParam0, int iParam1) // Position - 0x1B5BD (112061)
{
	int num;
	int num2;
...
void func_299(int iParam0) // Position - 0x1B5E2 (112098)
{
	Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_502 = iParam0;
	return;
}

int func_300() // Position - 0x1B5FC (112124)
{
	return Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_502;
}

BOOL func_301() // Position - 0x1B614 (112148)
{
	if (!func_302())
		return false;
...
BOOL func_302() // Position - 0x1B629 (112169)
{
	return func_303(PLAYER::PLAYER_ID());
}

BOOL func_303(Player plParam0) // Position - 0x1B639 (112185)
{
	return func_6(plParam0, 27);
}

void func_304() // Position - 0x1B649 (112201)
{
	if (!func_312())
		return;
...
BOOL func_305() // Position - 0x1B6C0 (112320)
{
	if (func_302())
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && func_7() && !func_311(PLAYER::PLAYER_PED_ID(), func_17(), 1000f, true))
			return true;
		...
		if (func_284(PLAYER::PLAYER_ID()))
		{
			...
			else if (func_283(PLAYER::PLAYER_ID()) && Global_1950191 < 2)
			{
			}
			else
			{
...
BOOL func_306(Player plParam0) // Position - 0x1B765 (112485)
{
...
BOOL func_307(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B79E (112542)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x1B802 (112642)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_309(int iParam0) // Position - 0x1B823 (112675)
{
	int num;
	int offset;
...
void func_310(int iParam0) // Position - 0x1B84D (112717)
{
	int num;
	int offset;
...
BOOL func_311(Ped pedParam0, Vehicle veParam1, float fParam2, BOOL bParam3) // Position - 0x1B877 (112759)
{
...
BOOL func_312() // Position - 0x1B899 (112793)
{
	if (func_7())
		return true;
...
void func_313() // Position - 0x1B8AD (112813)
{
	int num;
...
void func_314(int iParam0) // Position - 0x1B938 (112952)
{
	iLocal_148 = iParam0;
	return;
}

int func_315() // Position - 0x1B944 (112964)
{
	return iLocal_148;
}

BOOL func_316() // Position - 0x1B94E (112974)
{
	return func_317(PLAYER::PLAYER_ID());
}

BOOL func_317(Player plParam0) // Position - 0x1B95E (112990)
{
	if (func_40(plParam0))
		if (func_40(Global_1892653[plParam0 /*615*/].f_10))
...
BOOL func_318(BOOL bParam0) // Position - 0x1B993 (113043)
{
	return func_319(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_319(Player plParam0, BOOL bParam1) // Position - 0x1B9A5 (113061)
{
	if (!func_40(plParam0))
		return false;
...
void func_320() // Position - 0x1B9DD (113117)
{
	int num;
	...
	switch (func_20())
	{
		...
		case 2:
			if (!func_11(3) && !func_298(NETWORK::PARTICIPANT_ID(), 2) && func_7() && !NETWORK::NETWORK_IS_ENTITY_FADING(func_17()) && func_323(func_10()) && func_322(func_17()) == 0)
			{
		...
		case 4:
			if (!func_11(5) && !func_298(NETWORK::PARTICIPANT_ID(), 4) && func_7() && func_323(func_10()))
			{
				num = func_10();
				func_321(&num);
				func_310(4);
...
void func_321(var uParam0) // Position - 0x1BB06 (113414)
{
	Entity entity;
...
int func_322(Vehicle veParam0) // Position - 0x1BB3F (113471)
{
	int i;
	int num;
	int num2;
...
BOOL func_323(int iParam0) // Position - 0x1BB86 (113542)
{
...
BOOL func_324(int iParam0) // Position - 0x1BBBB (113595)
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
...
void func_325() // Position - 0x1BBDD (113629)
{
	if (func_331())
	{
		if (!HUD::DOES_BLIP_EXIST(blLocal_153))
		{
			...
			HUD::SET_BLIP_SPRITE(blLocal_153, func_330());
			func_327(&blLocal_153, func_329());
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blLocal_153, func_326());
		}
	}
...
char* func_326() // Position - 0x1BC30 (113712)
{
	return "MANSION_VD";
}

void func_327(var uParam0, int iParam1) // Position - 0x1BC3B (113723)
{
	int num;
...
int func_328(eHudColour ehcParam0) // Position - 0x1BC61 (113761)
{
	int r;
	int g;
	int b;
...
int func_329() // Position - 0x1BEC9 (114377)
{
	return 12;
}

eBlipSprite func_330() // Position - 0x1BED3 (114387)
{
...
BOOL func_331() // Position - 0x1BEEE (114414)
{
	if (!NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(func_10()))
		return false;
...
void func_332(int iParam0) // Position - 0x1BF33 (114483)
{
	uLocal_104[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
	return;
}

BOOL func_333() // Position - 0x1BF45 (114501)
{
	func_334();
	return true;
}

void func_334() // Position - 0x1BF52 (114514)
{
	func_295(26);
	return;
}

int func_335() // Position - 0x1BF60 (114528)
{
	return iLocal_96;
}

int func_336(Player plParam0) // Position - 0x1BF6A (114538)
{
	return uLocal_104[plParam0 /*4*/];
}

void func_337() // Position - 0x1BF78 (114552)
{
	int i;
	Player playerIndex;
	BOOL flag;
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(i))
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
			{
				...
				{
					if (!flag)
						if (func_298(uLocal_137[i], 1))
							flag = true;
				
					if (!func_11(1))
						if (func_298(uLocal_137[i], 0))
							func_286(1);
				
					if (!func_11(3))
						if (func_298(uLocal_137[i], 2))
							func_286(3);
				
					if (!func_11(4))
						if (func_298(uLocal_137[i], 3))
							func_286(4);
				
					if (!func_11(5))
						if (func_298(uLocal_137[i], 4))
							func_286(5);
				}
			}
		}
...
void func_338(int iParam0) // Position - 0x1C096 (114838)
{
	int num;
	int offset;
...
Player _INVALID_PLAYER_INDEX_0() // Position - 0x1C0C5 (114885)
{
	return -1;
}

BOOL func_340(int iParam0) // Position - 0x1C0CE (114894)
{
	int num;
	int num2;
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x1C0ED (114925)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1C171 (115057)
{
	switch (func_48())
	{
		case 0:
...
Hash func_343() // Position - 0x1C1A4 (115108)
{
...
BOOL func_344() // Position - 0x1C1C8 (115144)
{
	return Global_2685150.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x1C1D7 (115159)
{
...
BOOL func_346() // Position - 0x1C1EE (115182)
{
	return Global_2696964;
}

BOOL func_347() // Position - 0x1C1FA (115194)
{
	return Global_2685150.f_695;
}

void func_348() // Position - 0x1C209 (115209)
{
	BUILTIN::WAIT(0);
	return;
}

void func_349() // Position - 0x1C216 (115222)
{
...
void func_350() // Position - 0x1C28D (115341)
{
	int netId;
	Vehicle vehicle;
...
void func_351(var uParam0) // Position - 0x1C2E2 (115426)
{
	Entity entity;
...
void func_352() // Position - 0x1C306 (115462)
{
	func_293(29);
	return;
}

void func_353() // Position - 0x1C314 (115476)
{
	func_293(26);
	return;
}

void func_354() // Position - 0x1C322 (115490)
{
	func_293(27);
...
BOOL func_355(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1C341 (115521)
{
	func_358(8, uParam0);
...
int func_356(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1C378 (115576)
{
	int i;
...
void func_357() // Position - 0x1C48E (115854)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_358(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x1C49A (115866)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_357();
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1C4B9 (115897)
{
	Player player;
