...
BOOL func_7(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x3C4 (964)
{
	...
	else
	{
		...
		num2 = 0;
		func_13(&num2);
		num3 = func_12(unk10, Global_114904.f_7695.f_765[num2 /*10*/]);
	
		if (num3 == 2)
		{
			func_10(Global_114904.f_7695.f_765[num2 /*10*/]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_8(Global_114904.f_7695.f_765[num2 /*10*/]))
				{
					Global_114904.f_7695.f_765[num2 /*10*/] = { unk10 };
					func_9(&unk10);
					return true;
...
void func_13(var uParam0) // Position - 0x698 (1688)
{
	...
	*uParam0 = 0;
	...
	{
		if (func_12(Global_114904.f_7695.f_765[i /*10*/], Global_114904.f_7695.f_765[*uParam0 /*10*/]) == 0)
			*uParam0 = i;
	}
...
void func_17(int iParam0, BOOL bParam1) // Position - 0x7DA (2010)
{
	...
	{
		func_187(&(Global_113991[num /*10*/].f_9));
	}
...
void func_20() // Position - 0xA3F (2623)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114904.f_10201.f_3853))
		func_6(13, BUILTIN::FLOOR(Global_114904.f_10201.f_3853));
...
BOOL func_44(Ped pedParam0, ePedComponentType epctParam1, Hash hParam2) // Position - 0x19D4 (6612)
{
	Hash entityModel;
	ePedComponentType i;
	var unk;
	...
	Global_80063[1 /*14*/] = { func_97(entityModel, epctParam1, hParam2, -1) };
	...
	else
	{
		...
		Global_80063[1 /*14*/] = { func_97(entityModel, epctParam1, unk28[epctParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_89(epctParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_89(epctParam1), Global_80063[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_89(epctParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, 0);
	}
...
BOOL func_45(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1B91 (7057)
{
	...
	{
		if (!func_162(pedParam0, Global_114904.f_2370.f_539[num /*65*/].f_64, Global_114904.f_2370.f_539[num /*65*/].f_63))
		{
...
int func_47(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1C6D (7277)
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_80063[1 /*14*/] = { func_97(entityModel, iParam1, hParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_80063[1 /*14*/] = { func_97(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_80063[1 /*14*/] = { func_97(entityModel, 14, unk18[j], -1) };
							func_63(pedParam0, Global_80063[1 /*14*/].f_12, Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4);
							func_79(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_89(i), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_89(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_89(i), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, iParam4);
			...
			{
				Global_80063[1 /*14*/] = { func_97(entityModel, i, func_53(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_80063[1 /*14*/] = { func_97(entityModel, 14, unk59[j], -1) };
			func_63(pedParam0, Global_80063[1 /*14*/].f_12, Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4);
			func_79(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_89(iParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_89(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_89(iParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, iParam4);
...
BOOL func_49(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2508 (9480)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_50(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x25E6 (9702)
{
	Global_80063[1 /*14*/] = { func_97(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_80063[1 /*14*/].f_6, 2);
}

BOOL func_51(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x260E (9742)
{
	var unk;
	int i;
...
BOOL func_52(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2C12 (11282)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_53(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2CAB (11435)
{
	Hash i;
	Hash j;
...
int func_54(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x2D4C (11596)
{
	int num;
...
Hash func_55(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x3053 (12371)
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_56(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x3C06 (15366)
{
	int num;
...
Hash func_57(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x3EEA (16106)
{
	int num;
...
Hash func_58(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x41B2 (16818)
{
	Hash i;
	Hash hash;
...
BOOL func_59(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x41E9 (16873)
{
	Hash hash;
...
BOOL func_60(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x4212 (16914)
{
	*uParam2 = -99;
...
int func_61(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x44DC (17628)
{
	int num;
...
Hash func_62(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x4766 (18278)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_63(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x48BD (18621)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_64(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, hash, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_64(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x4957 (18775)
{
	switch (hParam0)
	{
...
Hash func_65(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4A25 (18981)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_68(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x4F47 (20295)
{
	Hash entityModel;
...
BOOL func_73(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x5321 (21281)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (hParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, hParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (hParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, hParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (hParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, hParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (hParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, hParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_74(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x559E (21918)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_75(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x59C3 (22979)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_76(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5CB6 (23734)
{
	int pedPropIndex;
...
Hash func_77(Ped pedParam0, int iParam1) // Position - 0x5CFD (23805)
{
...
void func_79(int iParam0) // Position - 0x5DB4 (23988)
{
	if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_80063[1 /*14*/].f_6, 6))
		func_86(iParam0, Global_80063[1 /*14*/].f_5, Global_80063[1 /*14*/].f_2, 2, Global_80063[1 /*14*/].f_1, 1, 0);
...
BOOL func_88(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9C58 (40024)
{
	...
	{
		if (!func_162(pedParam0, Global_114904.f_2370.f_539[num /*65*/].f_61, Global_114904.f_2370.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
struct<10> func_90(Hash hParam0, Hash hParam1) // Position - 0x9DB3 (40371)
{
	int i;
	var unk;
...
struct<17> func_93(Hash hParam0, Hash hParam1) // Position - 0xA854 (43092)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (hParam1)
			{
				...
				case 5:
					func_96(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (hParam1)
			{
				...
				case 2:
					func_96(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (hParam1)
			{
				...
				case 4:
					func_96(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
struct<14> func_97(Hash hParam0, ePedComponentType epctParam1, Hash hParam2, int iParam3) // Position - 0xC9A9 (51625)
{
	func_161();
...
void func_99(int iParam0) // Position - 0xCAEB (51947)
{
	...
	func_100(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_84(func_103(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_84(func_102(iParam1, iParam0->f_2), Global_80060);
...
void func_107(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xEDDB (60891)
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_100(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_100(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_100(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_100(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_162(Ped pedParam0, ePedComponentType epctParam1, Hash hParam2) // Position - 0x20059 (131161)
{
	Hash entityModel;
	Hash hash;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_162(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_162(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_80063[2 /*14*/] = { func_97(entityModel, 14, k, -1) };
								
									if (Global_80063[2 /*14*/].f_12 == j)
										if (func_162(pedParam0, 14, k))
											if (!func_51(entityModel, hParam2, 14, k, &unk, &Global_80063[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_97(entityModel, i, hash, -1) };
					
						if (!func_51(entityModel, hParam2, i, hash, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_89(epctParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_89(epctParam1)))
	{
		return true;
	}
...
void func_169() // Position - 0x203C6 (132038)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_166(character) && !func_105(14) || Global_113852)
			{
...
void func_174(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20A2D (133677)
{
	...
	if (iParam0 != -1)
	{
		...
		func_175(&unk33, unk.f_3, Global_102466, bParam1, bParam2);
	}
...
void func_180() // Position - 0x2204E (139342)
{
	...
	{
		func_169();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_181(Global_114904.f_2370.f_539.f_4321));
	}
	else
	{
...
void func_190(int iParam0) // Position - 0x22695 (140949)
{
	...
	Global_114904.f_18581[iParam0 /*6*/].f_3 = func_191();
...
void func_300(Ped pedParam0, BOOL bParam1) // Position - 0x29E85 (171653)
{
	...
	if (func_166(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_301(pedParam0, &Global_114904.f_2370.f_539.f_298[character /*477*/]);
	...
	if (Global_80535 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_309(Global_80536, Global_80538, iParam10) };
				y == -0.014f;
...
{
	if (!func_320(0) || Global_80551 || Global_80539 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
{
	return func_322(iParam0, Global_44869);
}
...
void func_341(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C409 (181257)
{
	...
	if (func_166(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		func_342(pedParam0, &Global_114904.f_2370.f_539.f_298[character /*477*/], bParam1);
	
		for (i = 0; i <= 8 - 1; i = i + 1)
		{
			HUD::HUD_SET_WEAPON_WHEEL_TOP_SLOT(Global_114904.f_2370.f_539.f_1730[i /*4*/][character]);
		
			if (bParam2)
				if (i == Global_114904.f_2370.f_539.f_1763 || Global_114904.f_2370.f_539.f_1763 == -1 && i == 4)
					if (Global_114904.f_2370.f_539.f_1730[i /*4*/][character] != 0 && Global_114904.f_2370.f_539.f_1730[i /*4*/][character] != joaat("WEAPON_MOLOTOV"))
						if (WEAPON::HAS_PED_GOT_WEAPON(pedParam0, Global_114904.f_2370.f_539.f_1730[i /*4*/][character], false))
							WEAPON::SET_CURRENT_PED_WEAPON(pedParam0, Global_114904.f_2370.f_539.f_1730[i /*4*/][character], true);
		}
...
{
	if (bParam0)
		if (IS_BIT_SET(Global_114904.f_668.f_1324, 2))
			return true;
...
int func_360() // Position - 0x2D7AF (186287)
{
	...
	num = func_361(&(Global_102429.f_3), false);
	num2 = 0;
...
BOOL func_364() // Position - 0x2D883 (186499)
{
	...
	if (Global_102429.f_11 == 5)
		if (func_359(&(Global_102429.f_3)) > -1)
			return true;
