...
void func_77(var uParam0) // Position - 0x1AA4 (6820)
{
	...
	func_81(uParam0);
	func_78(true, true, false, true, false);
...
void func_78(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1B4C (6988)
{
	func_80();
...
void func_79() // Position - 0x1BCD (7117)
{
	func_37(0);
	func_38(4, 1, -1);
	func_38(6, true, -1);
...
void func_80() // Position - 0x1C24 (7204)
{
	Global_1574756 = true;
...
void func_81(var uParam0) // Position - 0x1C4D (7245)
{
	var unk;
...
void func_82(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D48 (7496)
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2218 (8728)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_84(Hash hParam0) // Position - 0x2228 (8744)
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_85(Hash hParam0) // Position - 0x2256 (8790)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_86(Hash hParam0) // Position - 0x228B (8843)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
BOOL func_87(Hash hParam0) // Position - 0x231A (8986)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_88(Vehicle veParam0) // Position - 0x2421 (9249)
{
	Hash entityModel;
...
void func_89(var uParam0, var uParam1, var uParam2) // Position - 0x24AC (9388)
{
	Hash eventData;
...
int func_90(BOOL bParam0, BOOL bParam1) // Position - 0x24ED (9453)
{
	int address;
	int i;
	ePedComponentType type;
...
BOOL func_91(int iParam0) // Position - 0x2552 (9554)
{
	int i;
...
BOOL func_92(int iParam0) // Position - 0x258D (9613)
{
	return func_93(iParam0, 6, true);
}

BOOL func_93(int iParam0, int iParam1, BOOL bParam2) // Position - 0x259D (9629)
{
	if (iParam0 == -1)
		return false;
...
int func_94(int iParam0, int iParam1) // Position - 0x25FD (9725)
{
	Hash statHash;
	int outValue;
...
Hash func_95(int iParam0, int iParam1) // Position - 0x262C (9772)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_96(iParam1));
}

int func_96(int iParam0) // Position - 0x2641 (9793)
{
	int num;
	int num2;
...
int func_97(int iParam0) // Position - 0x2675 (9845)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_98() // Position - 0x2A59 (10841)
{
	return Global_33775;
}

int func_99(int iParam0) // Position - 0x2A64 (10852)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_100() // Position - 0x2DCE (11726)
{
	return Global_102481.f_418 > 0;
}

int func_101(Vehicle veParam0, Any* panParam1) // Position - 0x2DDF (11743)
{
...
BOOL func_102(Vehicle veParam0) // Position - 0x2E5C (11868)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_103(Vehicle veParam0) // Position - 0x2EE9 (12009)
{
	int _int;
...
BOOL func_104(var uParam0, Player plParam1) // Position - 0x2F45 (12101)
{
	func_108();
	...
	func_106(*uParam0, &Global_1950086, &(Global_1950086.f_1), &(Global_1950086.f_4), &(Global_1950086.f_7), &(Global_1950086.f_10));
	...
	{
		if (func_105(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1950086.f_23 == 0 && func_105(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13) || Global_1950086.f_23 != 0 && Global_1950086.f_24 == 0 && func_105(uParam0, plParam1, Global_1950086, Global_1950086.f_14, Global_1950086.f_17, Global_1950086.f_20, Global_1950086.f_10, 1, Global_1950086.f_13) || Global_1950086.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1576399 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_105(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x31F0 (12784)
{
...
int func_106(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3219 (12825)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_107(Global_1950112, 0f, 0f, 0f, false) && !func_107(Global_1950115, 0f, 0f, 0f, false) && !func_107(Global_1950118, 0f, 0f, 0f, false) && !(Global_1950121 == 0f))
	{
...
BOOL func_107(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x925E (37470)
{
	if (bParam6)
...
void func_108() // Position - 0x92A5 (37541)
{
	Global_1950086 = 0;
...
BOOL func_109(Vehicle veParam0) // Position - 0x931E (37662)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_110(Vehicle veParam0) // Position - 0x9356 (37718)
{
	int _int;
...
BOOL func_111(Vehicle veParam0, Any* panParam1) // Position - 0x939E (37790)
{
...
BOOL func_112(Vehicle veParam0) // Position - 0x94FB (38139)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_113(Vehicle veParam0) // Position - 0x9858 (39000)
{
...
int func_114(ePedComponentType epctParam0) // Position - 0x9884 (39044)
{
...
int func_115(ePedComponentType epctParam0) // Position - 0x98A1 (39073)
{
...
BOOL func_116(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x98C4 (39108)
{
	if (func_11(epctParam0))
...
int func_117(ePedComponentType epctParam0) // Position - 0x9908 (39176)
{
	if (func_11(epctParam0))
		if (func_116(epctParam0, false))
...
int func_118() // Position - 0x9934 (39220)
{
	int num;
...
BOOL func_119(BOOL bParam0) // Position - 0x9941 (39233)
{
	return func_120(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_120(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x9953 (39251)
{
	return func_121(epctParam0, bParam1, 1);
}

BOOL func_121(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x9964 (39268)
{
	ePedComponentType type;
...
BOOL func_122(ePedComponentType epctParam0, int iParam1) // Position - 0x99C0 (39360)
{
	if (func_11(epctParam0))
...
BOOL func_123(int iParam0, BOOL bParam1) // Position - 0x9A0F (39439)
{
	int num;
	int num2;
...
int func_124(int iParam0) // Position - 0x9A6D (39533)
{
	return iParam0 % 32;
}

int func_125(int iParam0) // Position - 0x9A7A (39546)
{
	int num;
...
int func_126(int iParam0) // Position - 0x9A91 (39569)
{
	int num;
	int num2;
...
int func_127(int iParam0) // Position - 0x9ABE (39614)
{
	return iParam0 / 32;
}

BOOL func_128(ePedComponentType epctParam0) // Position - 0x9ACB (39627)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (func_129(epctParam0) && Global_2658291[epctParam0 /*468*/].f_325.f_11 == epctParam0)
			return true;

	return false;
}

BOOL func_129(ePedComponentType epctParam0) // Position - 0x9B00 (39680)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658291[epctParam0 /*468*/].f_325.f_8 != -1)
				return func_130(Global_2658291[epctParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_130(int iParam0) // Position - 0x9B47 (39751)
{
	switch (iParam0)
	{
		case 0:
...
void func_131(Vehicle veParam0, int iParam1) // Position - 0xA097 (41111)
{
	int num;
	int num2;
...
BOOL func_132(int iParam0, var uParam1) // Position - 0xA0B8 (41144)
{
	*uParam1 = -1;
...
int func_133(int iParam0) // Position - 0xA37A (41850)
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA418 (42008)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_135() && Global_1576247)
...
BOOL func_135() // Position - 0xA5FA (42490)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA642 (42562)
{
	var gamerHandle;
...
BOOL func_137(Vehicle veParam0) // Position - 0xA657 (42583)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_138(int iParam0, var uParam1) // Position - 0xA678 (42616)
{
	*uParam1 = -1f;
...
void func_139(Vehicle veParam0, var uParam1) // Position - 0xA979 (43385)
{
...
void func_140(Vehicle veParam0) // Position - 0xA9F2 (43506)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_141(Vehicle veParam0) // Position - 0xAA24 (43556)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_142(Hash hParam0) // Position - 0xAA58 (43608)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_143(Hash hParam0) // Position - 0xAA7B (43643)
{
...
void func_144(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBA40 (47680)
{
	int num;
	int num2;
	int i;
...
BOOL func_145(Vehicle veParam0, float fParam1) // Position - 0xC160 (49504)
{
	float entityCoords;
	var groundZ;
...
Hash func_146(BOOL bParam0) // Position - 0xC1D1 (49617)
{
	if (bParam0)
...
BOOL func_147() // Position - 0xC1EB (49643)
{
	...
	if (func_151(7))
		if (func_149(Global_2673271.f_4.f_16) || func_148(Global_2673271.f_4.f_16))
			return false;

	return true;
}

BOOL func_148(ePedComponentType epctParam0) // Position - 0xC27A (49786)
{
	ePedComponentType type;
...
BOOL func_149(ePedComponentType epctParam0) // Position - 0xC29F (49823)
{
	ePedComponentType type;
...
BOOL func_150(ePedComponentType epctParam0, int iParam1) // Position - 0xC2BD (49853)
{
	return IS_BIT_SET(Global_1892653[epctParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_151(int iParam0) // Position - 0xC2D5 (49877)
{
	return func_152(&(Global_2673271.f_194), iParam0);
}

BOOL func_152(ePedComponentType epctParam0, int iParam1) // Position - 0xC2E9 (49897)
{
	int num;
	int num2;
	int num3;
...
int func_153(var uParam0, var uParam1, var uParam2) // Position - 0xC30C (49932)
{
	int i;
	int modType;
...
BOOL func_154(Vehicle veParam0) // Position - 0xC4E5 (50405)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_155(var uParam0) // Position - 0xC5BF (50623)
{
...
int func_156(Vehicle veParam0, int iParam1) // Position - 0xC616 (50710)
{
	int value;
	int value2;
	float num;
...
int func_157(Vehicle veParam0, int iParam1) // Position - 0xC6FF (50943)
{
	int i;
...
BOOL func_158(Hash hParam0) // Position - 0xC761 (51041)
{
...
BOOL func_159(Hash hParam0, int iParam1) // Position - 0xC78C (51084)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_160(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xCB72 (52082)
{
...
BOOL func_161() // Position - 0xCB96 (52118)
{
	return false;
}

void func_162(Vehicle veParam0, int iParam1) // Position - 0xCB9F (52127)
{
	int vehicleMod;
...
BOOL func_163(int iParam0) // Position - 0xCC17 (52247)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_164() // Position - 0xCC37 (52279)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_165(Vehicle veParam0) // Position - 0xCC48 (52296)
{
	int _int;
...
int func_166(var uParam0) // Position - 0xCC8D (52365)
{
...
BOOL func_167(int iParam0) // Position - 0xCCAD (52397)
{
	switch (iParam0)
	{
		case 161:
...
int func_168(int iParam0) // Position - 0xCD00 (52480)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_169(Vehicle veParam0) // Position - 0xCDB0 (52656)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xCE37 (52791)
{
...
void func_171(var uParam0) // Position - 0xCE84 (52868)
{
...
void func_172(var uParam0) // Position - 0xCED2 (52946)
{
...
Vector3 func_173(float fParam0, var uParam1, var uParam2) // Position - 0xCF8C (53132)
{
	return -BUILTIN::SIN(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::COS(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::SIN(fParam0);
}

BOOL func_174(var uParam0) // Position - 0xCFB9 (53177)
{
	ePedComponentType type;
	...
	else
	{
		...
		func_175(uParam0->f_23, &Global_1879623[type /*55*/], false, -1);
	}
...
void func_175(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xD091 (53393)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_176(Ped pedParam0, int iParam1, int iParam2) // Position - 0xD1FA (53754)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_177(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE4D1 (58577)
{
	Hash entityModel;
	int num;
...
BOOL func_178(int iParam0, int iParam1) // Position - 0xECF7 (60663)
{
	int num;
	int num2;
...
int func_179(int iParam0, int iParam1) // Position - 0xED36 (60726)
{
	int num;
	int num2;
...
int func_180() // Position - 0xED7C (60796)
{
	return Global_33776;
}

int func_181(int iParam0) // Position - 0xED87 (60807)
{
	int num;
	int num2;
	...
	if (func_98() == false || func_180() == 0 || func_98() == 999 && func_180() == 999)
	{
		switch (num2)
		{
			case 0:
...
char* func_182(int iParam0) // Position - 0xF128 (61736)
{
	switch (iParam0)
	{
		case 0:
...
int func_183(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF765 (63333)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_184(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x10A9E (68254)
{
	Hash entityModel;
	int num;
...
void func_185(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13A0A (80394)
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_186() // Position - 0x13A9C (80540)
{
...
int func_187() // Position - 0x13AC3 (80579)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_188() // Position - 0x13B79 (80761)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_190() // Position - 0x13D6A (81258)
{
	return 1;
}

int func_191() // Position - 0x13D73 (81267)
{
	return 1;
}

void func_192(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x13D7C (81276)
{
	var unk;
...
BOOL func_193(Ped pedParam0, int iParam1) // Position - 0x14033 (81971)
{
...
Hash func_194(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x142F3 (82675)
{
	var outProp;
	int componentId;
	int num;
...
int func_195(Hash hParam0, int iParam1) // Position - 0x1440D (82957)
{
	switch (hParam0)
	{
...
ePedComponentType func_196(int iParam0) // Position - 0x147B4 (83892)
{
	switch (iParam0)
	{
		case 0:
...
int func_197(Hash hParam0) // Position - 0x14864 (84068)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_198(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x148C5 (84165)
{
	ePedComponentType i;
	ePedComponentType j;
...
ePedComponentType func_199(Ped pedParam0, int iParam1) // Position - 0x14966 (84326)
{
...
int func_200(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x149C6 (84422)
{
	ePedComponentType componentId;
...
ePedComponentType func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14A1D (84509)
{
	int pedPropIndex;
...
int func_202(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x14A64 (84580)
{
	Hash entityModel;
...
int func_203(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14B60 (84832)
{
	Hash entityModel;
...
int func_204(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14C9E (85150)
{
	var outfit;
	int i;
	int num;
...
int func_205(Hash hParam0) // Position - 0x14D59 (85337)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_206(ePedComponentType epctParam0) // Position - 0x14DB8 (85432)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_207(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x14E3E (85566)
{
	Hash entityModel;
	ePedComponentType type;
	ePedComponentType type2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_223(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num] != -99)
			{
				if (!func_207(pedParam0, num, unk[num]))
				{
					...
					if (num == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_207(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_80063[2 /*14*/] = { func_223(entityModel, 14, j, -1) };
								
									if (Global_80063[2 /*14*/].f_12 == i)
									{
										if (func_207(pedParam0, 14, j))
										{
											if (!func_211(entityModel, epctParam2, 14, j, &unk, &Global_80063[2 /*14*/]))
											{
												Global_2883588 = type2;
												Global_2883589 = hash;
												return false;
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_223(entityModel, num, type, -1) };
					
						if (!func_211(entityModel, epctParam2, num, type, &unk, &Global_80063[2 /*14*/]))
						{
							Global_2883588 = type2;
							Global_2883589 = hash;
							return false;
		...
		{
			if (func_94(1759, Global_80060) != unk[10])
			{
				Global_2883588 = type2;
				Global_2883589 = hash;
				return false;
	...
	{
		if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_196(iParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_196(iParam1)))
			return true;
...
BOOL func_208(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x15299 (86681)
{
	Hash componentHash;
...
BOOL func_209(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x15342 (86850)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_210(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x153EA (87018)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x1543D (87101)
{
	var unk;
	int i;
...
BOOL func_212(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x15A41 (88641)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x15CBE (89278)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_214(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x160E3 (90339)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_215(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x163D6 (91094)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_216(Hash hParam0, int iParam1) // Position - 0x1646F (91247)
{
	int i;
	var unk;
...
void func_217(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16D9E (93598)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_218(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x16EC8 (93896)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_219(Hash hParam0, int iParam1) // Position - 0x16F10 (93968)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_222(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
				...
				case 26:
					func_222(&unk, -99, -99, PV_COMP_UPPR, PV_COMP_UPPR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 29:
					func_222(&unk, -99, -99, PV_COMP_HAIR, PV_COMP_HAIR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 30:
					func_222(&unk, -99, -99, 161, PV_COMP_UPPR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 31:
					func_222(&unk, -99, -99, PV_COMP_UPPR, PV_COMP_UPPR, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
				...
				case 33:
					func_222(&unk, -99, -99, 86, PV_COMP_LOWR, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 36:
					func_222(&unk, -99, -99, PV_COMP_LOWR, PV_COMP_LOWR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 37:
					func_222(&unk, -99, -99, PV_COMP_HAND, PV_COMP_HAND, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 38:
					func_222(&unk, -99, -99, PV_COMP_FEET, PV_COMP_FEET, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_222(&unk, -99, -99, PV_COMP_TEEF, PV_COMP_TEEF, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_222(&unk, -99, -99, PV_COMP_ACCS, PV_COMP_ACCS, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_222(&unk, -99, -99, PV_COMP_TASK, PV_COMP_TASK, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_222(&unk, -99, -99, PV_COMP_DECL, PV_COMP_DECL, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_222(&unk, -99, -99, PV_COMP_JBIB, PV_COMP_JBIB, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 44:
					func_222(&unk, -99, -99, PV_COMP_MAX, PV_COMP_MAX, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 1:
					func_222(&unk, -99, -99, 22, PV_COMP_DECL, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 2:
					func_222(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
			
				case 3:
					func_222(&unk, -99, -99, 23, PV_COMP_JBIB, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
			
				case 4:
					func_222(&unk, -99, -99, 23, PV_COMP_JBIB, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
				...
				case 8:
					func_222(&unk, -99, -99, 17, PV_COMP_HAND, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
			
				case 9:
					func_222(&unk, -99, -99, 16, PV_COMP_LOWR, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 11:
					func_222(&unk, -99, -99, 259, PV_COMP_DECL, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 12:
					func_222(&unk, -99, -99, 18, PV_COMP_FEET, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_222(&unk, -99, -99, 19, PV_COMP_TEEF, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_222(&unk, -99, -99, 20, PV_COMP_ACCS, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 15:
					func_222(&unk, -99, -99, 21, PV_COMP_TASK, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_222(&unk, -99, -99, 17, PV_COMP_HAND, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
			
				case 2:
					func_222(&unk, -99, -99, 43, PV_COMP_ACCS, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
				...
				case 4:
					func_222(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 12:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 16:
					func_222(&unk, -99, -99, 44, PV_COMP_TASK, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_222(&unk, -99, -99, 45, PV_COMP_DECL, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_222(&unk, -99, -99, 46, PV_COMP_JBIB, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 19:
					func_222(&unk, -99, -99, 47, PV_COMP_MAX, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 21:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_222(&unk, -99, -99, 98, PV_COMP_HEAD, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_222(&unk, -99, -99, 27, PV_COMP_HEAD, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 41:
					func_222(&unk, -99, -99, PV_COMP_HAIR, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_222(&unk, -99, -99, 55, PV_COMP_HEAD, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 46:
					func_222(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_222(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
			
				case 1:
					func_222(&unk, -99, -99, PV_COMP_BERD, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
			
				case 2:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
			
				case 3:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
			
				case 4:
					func_222(&unk, -99, -99, PV_COMP_BERD, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
			
				case 5:
					func_222(&unk, -99, -99, PV_COMP_BERD, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
			
				case 6:
					func_222(&unk, -99, -99, PV_COMP_BERD, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
			
				case 7:
					func_222(&unk, -99, -99, PV_COMP_BERD, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
			
				case 8:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
			
				case 9:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
			
				case 10:
					func_222(&unk, -99, -99, PV_COMP_BERD, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
			
				case 11:
					func_222(&unk, -99, -99, PV_COMP_BERD, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
			
				case 12:
					func_222(&unk, -99, -99, PV_COMP_BERD, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
			
				case 13:
					func_222(&unk, -99, -99, PV_COMP_BERD, PV_COMP_LOWR, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
			
				case 14:
					func_222(&unk, -99, -99, PV_COMP_BERD, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
			
				case 15:
					func_222(&unk, -99, -99, PV_COMP_BERD, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
			
				case 16:
					func_222(&unk, -99, -99, PV_COMP_BERD, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
			
				case 17:
					func_222(&unk, -99, -99, PV_COMP_BERD, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
			
				case 18:
					func_222(&unk, -99, -99, PV_COMP_HAND, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
			
				case 19:
					func_222(&unk, -99, -99, PV_COMP_HAND, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
			
				case 20:
					func_222(&unk, -99, -99, PV_COMP_BERD, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
			
				case 21:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
			
				case 22:
					func_222(&unk, -99, -99, PV_COMP_FEET, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
			
				case 23:
					func_222(&unk, -99, -99, PV_COMP_BERD, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
			
				case 24:
					func_222(&unk, -99, -99, PV_COMP_BERD, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
			
				case 25:
					func_222(&unk, -99, -99, PV_COMP_HAIR, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_222(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
			
				case 1:
					func_222(&unk, -99, -99, PV_COMP_HAND, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
			
				case 2:
					func_222(&unk, -99, -99, PV_COMP_LOWR, PV_COMP_BERD, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
			
				case 3:
					func_222(&unk, -99, -99, PV_COMP_BERD, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
			
				case 4:
					func_222(&unk, -99, -99, PV_COMP_HAIR, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
			
				case 5:
					func_222(&unk, -99, -99, PV_COMP_TASK, PV_COMP_TEEF, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
			
				case 6:
					func_222(&unk, -99, -99, PV_COMP_BERD, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
			
				case 7:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
			
				case 8:
					func_222(&unk, -99, -99, PV_COMP_BERD, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
			
				case 9:
					func_222(&unk, -99, -99, PV_COMP_HAND, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
			
				case 10:
					func_222(&unk, -99, -99, PV_COMP_TASK, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
			
				case 11:
					func_222(&unk, -99, -99, PV_COMP_HAND, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
			
				case 12:
					func_222(&unk, -99, -99, PV_COMP_FEET, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
			
				case 13:
					func_222(&unk, -99, -99, PV_COMP_HAND, PV_COMP_HEAD, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
			
				case 14:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
			
				case 15:
					func_222(&unk, -99, -99, PV_COMP_TASK, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
			
				case 16:
					func_222(&unk, -99, -99, PV_COMP_HAIR, PV_COMP_ACCS, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
			
				case 17:
					func_222(&unk, -99, -99, PV_COMP_HAND, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
			
				case 18:
					func_222(&unk, -99, -99, PV_COMP_FEET, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
			
				case 19:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
			
				case 20:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
			
				case 21:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
			
				case 22:
					func_222(&unk, -99, -99, PV_COMP_UPPR, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
			
				case 23:
					func_222(&unk, -99, -99, PV_COMP_HEAD, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
			
				case 24:
					func_222(&unk, -99, -99, PV_COMP_HAND, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
			
				case 25:
					func_222(&unk, -99, -99, PV_COMP_TEEF, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
			
				case 26:
					func_222(&unk, -99, -99, PV_COMP_LOWR, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
...
void func_220(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x18D59 (101721)
{
	int num;
	Hash outfit;
...
int func_221(int iParam0) // Position - 0x18F43 (102211)
{
	switch (iParam0)
	{
		case 0:
...
void func_222(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18FF3 (102387)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_223(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x19064 (102500)
{
	func_269();
...
void func_224(int iParam0, int iParam1, Hash hParam2) // Position - 0x190A5 (102565)
{
	switch (iParam0)
	{
		case 2:
...
void func_225(int iParam0) // Position - 0x191B1 (102833)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_226(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_226(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1936C (103276)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_94(func_229(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_94(func_228(iParam1, iParam0->f_2), Global_80060);
...
BOOL func_227(int iParam0, int iParam1, var uParam2) // Position - 0x1970E (104206)
{
	*uParam2 = 979;
...
int func_228(int iParam0, int iParam1) // Position - 0x19B13 (105235)
{
	switch (iParam1)
	{
		case 0:
...
int func_229(int iParam0, int iParam1) // Position - 0x19F0E (106254)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_230(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1A309 (107273)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_231(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B1AC (111020)
{
	int num;
	int num2;
	int num3;
...
BOOL func_232(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B1EA (111082)
{
...
void func_236(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1E1CB (123339)
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_226(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_226(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_226(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_226(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_239(int iParam0, Hash hParam1) // Position - 0x1E834 (124980)
{
	...
	{
		func_226(&Global_80063[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}
...
int func_249(int iParam0, int iParam1) // Position - 0x2661C (157212)
{
	...
	num = func_94(func_250(iParam0), iParam1);
	return num;
}
...
BOOL func_270(Ped pedParam0) // Position - 0x34CAF (216239)
{
	...
	{
		type = Global_1845250[PLAYER::PLAYER_ID() /*880*/].f_97.f_28;
	
		if (type != PV_COMP_INVALID && type < PV_COMP_LOWR)
			if (func_271(type) != -1 && func_271(type) != 0)
				return 1;
	}
...
int func_271(ePedComponentType epctParam0) // Position - 0x34D2B (216363)
{
	if (func_272(true))
	...
	return Global_2686090.f_6496[epctParam0];
}

BOOL func_272(BOOL bParam0) // Position - 0x34D62 (216418)
{
	if (func_276(bParam0) || func_274() || func_273(*Global_4718592.f_192777))
		return true;
...
{
	return func_275(*Global_4718592.f_132500);
}
...
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_185514, 12) && func_277();
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_120(PLAYER::PLAYER_ID(), true) && Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_77.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_279(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x35691 (218769)
{
	Hash componentHash;
...
ePedComponentType func_282() // Position - 0x35F36 (220982)
{
	ePedComponentType type;
...
BOOL func_286(ePedComponentType epctParam0) // Position - 0x35FB3 (221107)
{
	if (func_11(epctParam0))
		if (func_11(Global_1892653[epctParam0 /*615*/].f_10))
...
void func_304() // Position - 0x362BE (221886)
{
	...
	func_307(&uLocal_122, joaat("nimbus"), "Plane_1");
	func_58(&uLocal_122, 1);
	func_305(&uLocal_122, -1249.1444f, -3200.4622f, 13.5621f, 1.8349f, -0.2505f, 59.0838f, "hs4_lsa_take_nimb2", 0, 0, 1, 0);
	return;
}
