	...
	while (!IS_BIT_SET(iLocal_214, 1))
	{
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!ENTITY::IS_ENTITY_DEAD(pedLocal_44, false))
			{
				...
				if (Global_80009 == CHAR_MP_GERALD)
				{
					if (!Global_114339 == true && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.914824f, 718.05927f, -979.45496f, 27.119097f, 5.75f, false, true, 0))
					{
						func_3(7, true);
						Global_114335 = 0;
						Global_114339 = true;
...
void func_3(int iParam0, BOOL bParam1) // Position - 0x4B4 (1204)
{
	...
	{
		if (bParam1)
			MISC::SET_BIT(&(Global_114344.f_24999), offset);
		else
			MISC::CLEAR_BIT(&(Global_114344.f_24999), offset);
	}
	else
	{
		offset = offset - 31;
		...
		if (bParam1)
			MISC::SET_BIT(&(Global_114344.f_24999.f_1), offset);
		else
			MISC::CLEAR_BIT(&(Global_114344.f_24999.f_1), offset);
	}
...
void func_23() // Position - 0xCAD (3245)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_24(character) && !func_16(14) || Global_113292)
			{
