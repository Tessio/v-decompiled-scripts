...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (!func_303(PLAYER::PLAYER_PED_ID()) || Global_33779 == 1)
		{
			func_308(1, 1, 1, true);
			Global_33781 = 0;
...
int func_117(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x49C5 (18885)
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_80063[1 /*14*/] = { func_165(entityModel, iParam1, hParam2, -1) };
...
BOOL func_121(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x533C (21308)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_122(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x541A (21530)
{
	Global_80063[1 /*14*/] = { func_165(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_80063[1 /*14*/].f_6, 2);
}

BOOL func_123(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x5442 (21570)
{
	var unk;
	int i;
...
BOOL func_124(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5A46 (23110)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_126(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x5B8A (23434)
{
	Hash i;
	Hash j;
...
int func_128(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x5CDB (23771)
{
	int num;
...
Hash func_129(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x5FE2 (24546)
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_130(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x6B95 (27541)
{
	int num;
...
Hash func_131(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x6E79 (28281)
{
	int num;
...
Hash func_132(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7140 (28992)
{
	Hash i;
	Hash hash;
...
BOOL func_133(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x7177 (29047)
{
	Hash hash;
...
BOOL func_134(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x71A0 (29088)
{
	*uParam2 = -99;
...
int func_135(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x746A (29802)
{
	int num;
...
Hash func_136(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x76F4 (30452)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_137(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x784B (30795)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_138(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, hash, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_138(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x78E5 (30949)
{
	switch (hParam0)
	{
...
Hash func_139(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x79B3 (31155)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_142(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x7ED5 (32469)
{
	Hash entityModel;
...
struct<10> func_147(Hash hParam0, Hash hParam1) // Position - 0x82AF (33455)
{
	int i;
	var unk;
...
struct<17> func_150(Hash hParam0, Hash hParam1) // Position - 0x8D50 (36176)
{
	int i;
	var unk;
...
BOOL func_154(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xAEA3 (44707)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (hParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_139(hParam0, hParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (hParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_139(hParam0, hParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (hParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_139(hParam0, hParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (hParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_139(hParam0, hParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_155(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xB120 (45344)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_156(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xB545 (46405)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_157(Ped pedParam0, ePedComponentType epctParam1) // Position - 0xB838 (47160)
{
	int pedPropIndex;
...
Hash func_158(Ped pedParam0, int iParam1) // Position - 0xB87F (47231)
{
...
void func_161(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xB9E2 (47586)
{
	int num;
	int offset;
	int num2;
...
BOOL func_162(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xBA2A (47658)
{
...
struct<14> func_165(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0xF5B3 (62899)
{
	func_228();
...
BOOL func_172(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1190B (71947)
{
	int num;
	int num2;
	int num3;
...
BOOL func_229(Ped pedParam0, ePedComponentType epctParam1, Hash hParam2) // Position - 0x22EB9 (143033)
{
	Hash entityModel;
	Hash hash;
	int i;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_165(entityModel, epctParam1, hParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_229(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_80063[2 /*14*/].f_12 == j)
										if (func_229(pedParam0, 14, k))
											if (!func_123(entityModel, hParam2, 14, k, &unk, &Global_80063[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_165(entityModel, i, hash, -1) };
					
						if (!func_123(entityModel, hParam2, i, hash, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_127(epctParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_127(epctParam1)))
	{
		return true;
	}
...
int func_234(int iParam0, BOOL bParam1) // Position - 0x23313 (144147)
{
	int num;
	int num2;
