...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		if (Global_114904.f_20417.f_145 > 0 || Global_113541)
		{
			if (!Global_113541)
			{
				if (Global_44869 != 6 && Global_44869 != 15 && !Global_98411)
					func_23();
				...
				if (!Global_113540)
				{
					...
					{
						if (func_20(&Global_114904.f_20417[iLocal_35 /*16*/]))
						{
							if (func_18(_GET_CURRENT_PLAYER_CHARACTER_0()))
							{
								if (IS_BIT_SET(Global_114904.f_20417[iLocal_35 /*16*/].f_11, _GET_CURRENT_PLAYER_CHARACTER()))
								{
									if (Global_114904.f_20417[iLocal_35 /*16*/].f_12 == Global_114904.f_20417.f_146[_GET_CURRENT_PLAYER_CHARACTER()])
									{
										if (MISC::GET_GAME_TIMER() > Global_113543)
										{
											if (MISC::GET_GAME_TIMER() > Global_114904.f_20417[iLocal_35 /*16*/].f_8)
											{
												if (MISC::ARE_STRINGS_EQUAL(&(Global_114904.f_20417[iLocal_35 /*16*/].f_4), ""))
												{
													HUD::ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS(true);
													func_11(&Global_114904.f_20417[iLocal_35 /*16*/]);
												}
												else
												{
													HUD::ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS(true);
													func_10(&Global_114904.f_20417[iLocal_35 /*16*/], &(Global_114904.f_20417[iLocal_35 /*16*/].f_4));
												}
											
												if (Global_114904.f_20417[iLocal_35 /*16*/].f_13 != 0)
													func_9(Global_114904.f_20417[iLocal_35 /*16*/].f_13, 0);
											
												uLocal_18 = { Global_114904.f_20417[iLocal_35 /*16*/] };
												uLocal_18.f_4 = { Global_114904.f_20417[iLocal_35 /*16*/].f_4 };
												uLocal_18.f_8 = Global_114904.f_20417[iLocal_35 /*16*/].f_8;
												uLocal_18.f_10 = Global_114904.f_20417[iLocal_35 /*16*/].f_10;
												uLocal_18.f_9 = Global_114904.f_20417[iLocal_35 /*16*/].f_9;
												uLocal_18.f_11 = Global_114904.f_20417[iLocal_35 /*16*/].f_11;
												uLocal_18.f_12 = Global_114904.f_20417[iLocal_35 /*16*/].f_12;
												uLocal_18.f_13 = Global_114904.f_20417[iLocal_35 /*16*/].f_13;
												uLocal_18.f_14 = Global_114904.f_20417[iLocal_35 /*16*/].f_14;
												uLocal_18.f_15 = Global_114904.f_20417[iLocal_35 /*16*/].f_15;
												uLocal_18.f_16 = 0;
												Global_113544 = { Global_114904.f_20417[iLocal_35 /*16*/] };
												Global_113542 = MISC::GET_GAME_TIMER();
											
												for (i = iLocal_35; i <= Global_114904.f_20417.f_145 - 2; i = i + 1)
												{
													func_8(i, i + 1);
												}
											
												func_7(Global_114904.f_20417.f_145 - 1);
			...
			else if (!func_4())
			{
				...
				if (MISC::GET_GAME_TIMER() - Global_113542 > 4000 || uLocal_18.f_16)
				{
					if (uLocal_18.f_14 != 0)
			...
			if (!MISC::ARE_STRINGS_EQUAL(&Global_114904.f_20417[iLocal_35 /*16*/], &uLocal_18) && !MISC::ARE_STRINGS_EQUAL(&Global_114904.f_20417[iLocal_35 /*16*/], ""))
			{
				if (Global_114904.f_20417[iLocal_35 /*16*/].f_10 != -1)
				{
					if (MISC::GET_GAME_TIMER() > Global_114904.f_20417[iLocal_35 /*16*/].f_10)
					{
						for (j = iLocal_35; j <= Global_114904.f_20417.f_145 - 2; j = j + 1)
						{
							func_8(j, j + 1);
						}
			...
			if (iLocal_35 >= Global_114904.f_20417.f_145)
				iLocal_35 = 0;
		}
		else if (Global_44869 != 6 && Global_44869 != 15 && !Global_98411)
		{
			func_23();
		}
...
BOOL func_4() // Position - 0x670 (1648)
{
	...
	if (uLocal_18.f_9 != -1 && MISC::GET_GAME_TIMER() - Global_113542 > uLocal_18.f_9)
		return false;
...
void func_13() // Position - 0xA60 (2656)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_18(character) && !func_14(14) || Global_113852)
			{
