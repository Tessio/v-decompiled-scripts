	...
	while (true)
	{
		if (Global_114963.f_20419.f_145 > 0 || Global_113598)
		{
				...
				if (!Global_113597)
				{
					if (Global_114963.f_20419.f_145 > 0)
					{
						if (func_20(&Global_114963.f_20419[iLocal_54 /*16*/]))
						{
							...
							{
								if (IS_BIT_SET(Global_114963.f_20419[iLocal_54 /*16*/].f_11, _GET_CURRENT_PLAYER_CHARACTER()))
								{
									if (Global_114963.f_20419[iLocal_54 /*16*/].f_12 == Global_114963.f_20419.f_146[_GET_CURRENT_PLAYER_CHARACTER()])
									{
										if (MISC::GET_GAME_TIMER() > Global_113600)
										{
											if (MISC::GET_GAME_TIMER() > Global_114963.f_20419[iLocal_54 /*16*/].f_8)
											{
												...
												uLocal_37 = { Global_114963.f_20419[iLocal_54 /*16*/] };
												uLocal_37.f_4 = { Global_114963.f_20419[iLocal_54 /*16*/].f_4 };
												uLocal_37.f_8 = Global_114963.f_20419[iLocal_54 /*16*/].f_8;
												uLocal_37.f_10 = Global_114963.f_20419[iLocal_54 /*16*/].f_10;
												uLocal_37.f_9 = Global_114963.f_20419[iLocal_54 /*16*/].f_9;
												uLocal_37.f_11 = Global_114963.f_20419[iLocal_54 /*16*/].f_11;
												uLocal_37.f_12 = Global_114963.f_20419[iLocal_54 /*16*/].f_12;
												uLocal_37.f_13 = Global_114963.f_20419[iLocal_54 /*16*/].f_13;
												uLocal_37.f_14 = Global_114963.f_20419[iLocal_54 /*16*/].f_14;
												uLocal_37.f_15 = Global_114963.f_20419[iLocal_54 /*16*/].f_15;
												uLocal_37.f_16 = 0;
												Global_113601 = { Global_114963.f_20419[iLocal_54 /*16*/] };
												Global_113599 = MISC::GET_GAME_TIMER();
											
												for (i = iLocal_54; i <= Global_114963.f_20419.f_145 - 2; i = i + 1)
												{
													func_8(i, i + 1);
												}
			...
			else if (!func_4())
			{
				...
				if (MISC::GET_GAME_TIMER() - Global_113599 > 4000 || uLocal_37.f_16)
				{
					if (uLocal_37.f_14 != 0)
			...
			if (!MISC::ARE_STRINGS_EQUAL(&Global_114963.f_20419[iLocal_54 /*16*/], &uLocal_37) && !MISC::ARE_STRINGS_EQUAL(&Global_114963.f_20419[iLocal_54 /*16*/], ""))
			{
				if (Global_114963.f_20419[iLocal_54 /*16*/].f_10 != -1)
				{
					if (MISC::GET_GAME_TIMER() > Global_114963.f_20419[iLocal_54 /*16*/].f_10)
					{
						for (j = iLocal_54; j <= Global_114963.f_20419.f_145 - 2; j = j + 1)
						{
							func_8(j, j + 1);
						}
...
BOOL func_4() // Position - 0x670 (1648)
{
	...
	if (uLocal_37.f_9 != -1 && MISC::GET_GAME_TIMER() - Global_113599 > uLocal_37.f_9)
		return false;
...
void func_13() // Position - 0xA60 (2656)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_18(character) && !func_14(14) || Global_113909)
			{
