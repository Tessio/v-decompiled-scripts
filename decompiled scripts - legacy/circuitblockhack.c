...
void func_10() // Position - 0x2C8 (712)
{
	...
	if (!IS_BIT_SET(Global_1925224, 6))
	{
...
void func_18() // Position - 0x410 (1040)
{
	...
	if (IS_BIT_SET(Global_1925224, 1) || uLocal_72.f_9 != 1)
		return;
...
void func_82() // Position - 0x1699 (5785)
{
	...
	if (!IS_BIT_SET(Global_1925224, 3))
	{
...
BOOL func_85() // Position - 0x17BE (6078)
{
	...
	if (IS_BIT_SET(Global_1925224, 0))
		return true;
...
{
	if (IS_BIT_SET(Global_1925224, 1) || IS_BIT_SET(Global_1925224, 4))
		return true;
...
{
	if (IS_BIT_SET(Global_1925224, 5) && IS_BIT_SET(Global_1925224, 2))
		return true;
...
void func_92() // Position - 0x1961 (6497)
{
	...
	{
		if (!IS_BIT_SET(Global_1925224, 5))
