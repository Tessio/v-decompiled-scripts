...
void func_18() // Position - 0x410 (1040)
{
	...
	if (IS_BIT_SET(Global_1924844, 1) || uLocal_53.f_9 != 1)
		return;

	if (func_12(uLocal_53.f_15, func_30(uLocal_53.f_20)))
		MISC::SET_BIT(&Global_1924844, 1);
...
BOOL func_85() // Position - 0x17BE (6078)
{
	...
	if (IS_BIT_SET(Global_1924844, 0))
		return true;
...
{
	if (IS_BIT_SET(Global_1924844, 1) || IS_BIT_SET(Global_1924844, 4))
		return true;
...
{
	if (IS_BIT_SET(Global_1924844, 5) && IS_BIT_SET(Global_1924844, 2))
		return true;
...
{
	if (func_32(uLocal_53.f_20))
		MISC::SET_BIT(&Global_1924844, 2);
	else
		MISC::CLEAR_BIT(&Global_1924844, 2);
...
void func_92() // Position - 0x1961 (6497)
{
	...
	else
	{
		...
		MISC::CLEAR_BIT(&Global_1924844, 5);
	}

	if (func_105(false, false))
		MISC::SET_BIT(&Global_1924844, 4);
...
void func_106() // Position - 0x2122 (8482)
{
	...
	MISC::CLEAR_BIT(&Global_1924844, 0);
	MISC::CLEAR_BIT(&Global_1924844, 1);
	MISC::CLEAR_BIT(&Global_1924844, 2);
	MISC::CLEAR_BIT(&Global_1924844, 3);
	MISC::CLEAR_BIT(&Global_1924844, 4);
	MISC::CLEAR_BIT(&Global_1924844, 6);
