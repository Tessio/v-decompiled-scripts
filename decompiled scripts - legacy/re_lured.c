...
int func_69(int iParam0) // Position - 0x31DA (12762)
{
	int num;
	int num2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x33FD (13309)
{
	if (iParam1 == -1)
		iParam1 = func_14();
...
void func_136(int iParam0) // Position - 0x687F (26751)
{
	if (iParam0 == -1)
		iParam0 = func_31();
...
void func_138(int iParam0) // Position - 0x68F2 (26866)
{
	Global_114893 = iParam0;
	return;
}

BOOL func_139(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6900 (26880)
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (!func_175(Global_114904.f_25002.f_43[iParam3]))
			return false;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x74E1 (29921)
{
...
BOOL func_172() // Position - 0x7CB5 (31925)
{
...
BOOL func_176(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x7D17 (32023)
{
	BOOL num;
	eCharacter character;
...
BOOL func_178(int iParam0) // Position - 0x7E1F (32287)
{
	int num;
	BOOL flag;
...
char* func_184(int iParam0, BOOL bParam1) // Position - 0x8125 (33061)
{
	switch (iParam0)
	{
		case 0:
