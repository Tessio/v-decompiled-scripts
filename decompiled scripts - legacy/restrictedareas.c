							...
							if (func_36(iLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								...
								if (func_35(iLocal_54))
								{
									...
									if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&uLocal_89)) == 0)
										if (!Global_34031[iLocal_54])
											func_33(iLocal_54, Global_34031[iLocal_54]);
								}
								else if (!Global_34031[iLocal_54])
								{
...
void func_15() // Position - 0xA98 (2712)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_16(character) && !func_20(14) || Global_113909)
			{
				if (Global_114963.f_2370.f_539.f_4321 != character && func_16(Global_114963.f_2370.f_539.f_4321))
