...
BOOL func_146(Player plParam0) // Position - 0xC1D5 (49621)
{
	Player player;
	...
	if (player != -1)
		return Global_1882572[player /*315*/].f_82.f_75 != PV_COMP_HEAD;

	return false;
}

BOOL func_147(Player plParam0) // Position - 0xC1FA (49658)
{
	Player player;
...
BOOL func_148(Player plParam0, int iParam1) // Position - 0xC218 (49688)
{
...
BOOL func_150(ePedComponentType epctParam0, int iParam1) // Position - 0xC244 (49732)
{
	int num;
	int num2;
	int num3;
...
Hash func_193(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x142F3 (82675)
{
	var outProp;
	int componentId;
	int num;
...
ePedComponentType func_197(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x148C5 (84165)
{
	ePedComponentType i;
	ePedComponentType j;
...
ePedComponentType func_198(Ped pedParam0, int iParam1) // Position - 0x14966 (84326)
{
...
ePedComponentType func_200(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14A1D (84509)
{
	int pedPropIndex;
...
BOOL func_206(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x14E3E (85566)
{
	Hash entityModel;
	ePedComponentType type;
	ePedComponentType type2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_222(entityModel, iParam1, epctParam2, -1) };
			...
			if (unk[num] != -99)
			{
				if (!func_206(pedParam0, num, unk[num]))
				{
							...
							if (!func_206(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_80063[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_210(entityModel, epctParam2, 14, j, &unk, &Global_80063[2 /*14*/]))
											{
												Global_2883588 = type2;
												Global_2883589 = hash;
												return false;
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_222(entityModel, num, type, -1) };
					
						if (!func_210(entityModel, epctParam2, num, type, &unk, &Global_80063[2 /*14*/]))
						{
							Global_2883588 = type2;
							Global_2883589 = hash;
							return false;
...
BOOL func_207(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x15299 (86681)
{
	Hash componentHash;
...
BOOL func_208(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x15342 (86850)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_209(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x153EA (87018)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_193(hParam0, epctParam2, 11, 4);
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x1543D (87101)
{
	var unk;
	int i;
...
BOOL func_211(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x15A41 (88641)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_193(hParam0, epctParam2, 14, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_193(hParam0, epctParam2, 1, 3);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_193(hParam0, epctParam2, 14, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_193(hParam0, epctParam2, 1, 4);
					
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_193(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_212(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x15CBE (89278)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_213(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x160E3 (90339)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_214(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x163D6 (91094)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_221(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18FF3 (102387)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_222(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x19064 (102500)
{
	func_268();
...
void func_303(var uParam0) // Position - 0x362BE (221886)
{
	...
	func_306(&uLocal_122, joaat("velum2"), "Smuggler_Plane");
	func_304(&uLocal_122, 3178.6318f, -4960.667f, 99.0647f, -3.4084f, -0.004f, -78.1044f, "HS4_VEL_LSA_ISD", 1, 1, 5, 0);
	return;
}
