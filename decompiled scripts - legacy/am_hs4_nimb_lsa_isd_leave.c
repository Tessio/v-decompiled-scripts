...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x22E8 (8936)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_86(Hash hParam0) // Position - 0x22F8 (8952)
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_87(Hash hParam0) // Position - 0x2326 (8998)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_88(Hash hParam0) // Position - 0x235B (9051)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
BOOL func_89(Hash hParam0) // Position - 0x23EA (9194)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_90(Vehicle veParam0) // Position - 0x24F1 (9457)
{
	Hash entityModel;
...
void func_91(var uParam0, var uParam1, var uParam2) // Position - 0x257C (9596)
{
	Hash eventData;
...
int func_92(BOOL bParam0, BOOL bParam1) // Position - 0x25BD (9661)
{
	int address;
	int i;
	ePedComponentType type;
...
BOOL func_93(int iParam0) // Position - 0x2622 (9762)
{
	int i;
...
BOOL func_94(int iParam0) // Position - 0x265D (9821)
{
	return func_95(iParam0, 6, true);
}

BOOL func_95(int iParam0, int iParam1, BOOL bParam2) // Position - 0x266D (9837)
{
	if (iParam0 == -1)
		return false;
...
int func_96(int iParam0, int iParam1) // Position - 0x26CD (9933)
{
	Hash statHash;
	int outValue;
...
Hash func_97(int iParam0, int iParam1) // Position - 0x26FC (9980)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_98(iParam1));
}

int func_98(int iParam0) // Position - 0x2711 (10001)
{
	int num;
	int num2;
...
int func_99(int iParam0) // Position - 0x2745 (10053)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_100() // Position - 0x2B29 (11049)
{
	return Global_33775;
}

int func_101(int iParam0) // Position - 0x2B34 (11060)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x2E9E (11934)
{
	return Global_102481.f_418 > 0;
}

int func_103(Vehicle veParam0, Any* panParam1) // Position - 0x2EAF (11951)
{
...
BOOL func_104(Vehicle veParam0) // Position - 0x2F2C (12076)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_105(Vehicle veParam0) // Position - 0x2FB9 (12217)
{
	int _int;
...
BOOL func_106(var uParam0, Player plParam1) // Position - 0x3015 (12309)
{
	func_110();
	...
	func_108(*uParam0, &Global_1950086, &(Global_1950086.f_1), &(Global_1950086.f_4), &(Global_1950086.f_7), &(Global_1950086.f_10));
	...
	{
		if (func_107(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1950086.f_23 == 0 && func_107(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13) || Global_1950086.f_23 != 0 && Global_1950086.f_24 == 0 && func_107(uParam0, plParam1, Global_1950086, Global_1950086.f_14, Global_1950086.f_17, Global_1950086.f_20, Global_1950086.f_10, 1, Global_1950086.f_13) || Global_1950086.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1576399 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_107(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x32C0 (12992)
{
...
int func_108(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x32E9 (13033)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_109(Global_1950112, 0f, 0f, 0f, false) && !func_109(Global_1950115, 0f, 0f, 0f, false) && !func_109(Global_1950118, 0f, 0f, 0f, false) && !(Global_1950121 == 0f))
	{
...
BOOL func_109(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9333 (37683)
{
	if (bParam6)
...
void func_110() // Position - 0x937A (37754)
{
	Global_1950086 = 0;
...
BOOL func_111(Vehicle veParam0) // Position - 0x93F3 (37875)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_112(Vehicle veParam0) // Position - 0x942B (37931)
{
	int _int;
...
BOOL func_113(Vehicle veParam0, Any* panParam1) // Position - 0x9473 (38003)
{
...
BOOL func_114(Vehicle veParam0) // Position - 0x95D0 (38352)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_115(Vehicle veParam0) // Position - 0x992D (39213)
{
...
int func_116(ePedComponentType epctParam0) // Position - 0x9959 (39257)
{
...
int func_117(ePedComponentType epctParam0) // Position - 0x9976 (39286)
{
...
BOOL func_118(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x9999 (39321)
{
	if (func_11(epctParam0))
...
int func_119(ePedComponentType epctParam0) // Position - 0x99DD (39389)
{
	if (func_11(epctParam0))
		if (func_118(epctParam0, false))
...
int func_120() // Position - 0x9A09 (39433)
{
	int num;
...
BOOL func_121(BOOL bParam0) // Position - 0x9A16 (39446)
{
	return func_122(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_122(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x9A28 (39464)
{
	return func_123(epctParam0, bParam1, 1);
}

BOOL func_123(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x9A39 (39481)
{
	ePedComponentType type;
...
BOOL func_124(ePedComponentType epctParam0, int iParam1) // Position - 0x9A95 (39573)
{
	if (func_11(epctParam0))
...
BOOL func_125(int iParam0, BOOL bParam1) // Position - 0x9AE4 (39652)
{
	int num;
	int num2;
...
int func_126(int iParam0) // Position - 0x9B42 (39746)
{
	return iParam0 % 32;
}

int func_127(int iParam0) // Position - 0x9B4F (39759)
{
	int num;
...
int func_128(int iParam0) // Position - 0x9B66 (39782)
{
	int num;
	int num2;
...
int func_129(int iParam0) // Position - 0x9B93 (39827)
{
	return iParam0 / 32;
}

BOOL func_130(ePedComponentType epctParam0) // Position - 0x9BA0 (39840)
{
...
BOOL func_131(ePedComponentType epctParam0) // Position - 0x9BD5 (39893)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658291[epctParam0 /*468*/].f_325.f_8 != -1)
				return func_132(Global_2658291[epctParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_132(int iParam0) // Position - 0x9C1C (39964)
{
	switch (iParam0)
	{
		case 0:
...
void func_133(Vehicle veParam0, int iParam1) // Position - 0xA16C (41324)
{
	int num;
	int num2;
...
BOOL func_134(int iParam0, var uParam1) // Position - 0xA18D (41357)
{
	*uParam1 = -1;
...
int func_135(int iParam0) // Position - 0xA44F (42063)
{
	switch (iParam0)
	{
		case 0:
...
int func_136(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA4ED (42221)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_137() && Global_1576247)
...
BOOL func_137() // Position - 0xA6CF (42703)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA717 (42775)
{
	var gamerHandle;
...
BOOL func_139(Vehicle veParam0) // Position - 0xA72C (42796)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_140(int iParam0, var uParam1) // Position - 0xA74D (42829)
{
	*uParam1 = -1f;
...
void func_141(Vehicle veParam0, var uParam1) // Position - 0xAA4E (43598)
{
...
void func_142(Vehicle veParam0) // Position - 0xAAC7 (43719)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_143(Vehicle veParam0) // Position - 0xAAF9 (43769)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_144(Hash hParam0) // Position - 0xAB2D (43821)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_145(Hash hParam0) // Position - 0xAB50 (43856)
{
...
void func_146(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBB15 (47893)
{
	int num;
	int num2;
	int i;
...
BOOL func_147(Vehicle veParam0, float fParam1) // Position - 0xC235 (49717)
{
	float entityCoords;
	var groundZ;
...
Hash func_148(BOOL bParam0) // Position - 0xC2A6 (49830)
{
	if (bParam0)
...
BOOL func_149() // Position - 0xC2C0 (49856)
{
	...
	if (func_153(7))
		if (func_151(Global_2673271.f_4.f_16) || func_150(Global_2673271.f_4.f_16))
			return false;

	return true;
}

BOOL func_150(float fParam0) // Position - 0xC34F (49999)
{
	float num;
...
BOOL func_151(float fParam0) // Position - 0xC374 (50036)
{
	float num;
	...
	if (num != -1)
		return func_152(fParam0, 9);

	return false;
}

BOOL func_152(float fParam0, int iParam1) // Position - 0xC392 (50066)
{
	return IS_BIT_SET(Global_1892653[fParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_153(int iParam0) // Position - 0xC3AA (50090)
{
	return func_154(&(Global_2673271.f_194), iParam0);
}

BOOL func_154(int iParam0, int iParam1) // Position - 0xC3BE (50110)
{
	int num;
	int num2;
	int num3;
...
int func_155(var uParam0, var uParam1, var uParam2) // Position - 0xC3E1 (50145)
{
	int i;
	int modType;
...
BOOL func_156(Vehicle veParam0) // Position - 0xC5BA (50618)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_157(var uParam0) // Position - 0xC694 (50836)
{
...
int func_158(Vehicle veParam0, int iParam1) // Position - 0xC6EB (50923)
{
	int value;
	int value2;
	float num;
...
int func_159(Vehicle veParam0, int iParam1) // Position - 0xC7D4 (51156)
{
	int i;
...
BOOL func_160(Hash hParam0) // Position - 0xC836 (51254)
{
...
BOOL func_161(Hash hParam0, int iParam1) // Position - 0xC861 (51297)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_162(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xCC47 (52295)
{
...
BOOL func_163() // Position - 0xCC6B (52331)
{
	return false;
}

void func_164(Vehicle veParam0, int iParam1) // Position - 0xCC74 (52340)
{
	int vehicleMod;
...
BOOL func_165(int iParam0) // Position - 0xCCEC (52460)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_166() // Position - 0xCD0C (52492)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_167(Vehicle veParam0) // Position - 0xCD1D (52509)
{
	int _int;
...
int func_168(var uParam0) // Position - 0xCD62 (52578)
{
...
BOOL func_169(int iParam0) // Position - 0xCD82 (52610)
{
	switch (iParam0)
	{
		case 161:
...
int func_170(int iParam0) // Position - 0xCDD5 (52693)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_171(Vehicle veParam0) // Position - 0xCE85 (52869)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xCF0C (53004)
{
...
void func_173(var uParam0) // Position - 0xCF59 (53081)
{
...
void func_174(var uParam0) // Position - 0xCFA7 (53159)
{
...
Vector3 func_175(float fParam0, var uParam1, var uParam2) // Position - 0xD061 (53345)
{
	return -BUILTIN::SIN(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::COS(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::SIN(fParam0);
}

BOOL func_176(var uParam0) // Position - 0xD08E (53390)
{
	ePedComponentType type;
	...
	else
	{
		...
		func_177(uParam0->f_23, &Global_1879623[type /*55*/], false, -1);
	}
...
void func_177(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xD166 (53606)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_178(Ped pedParam0, int iParam1, int iParam2) // Position - 0xD2CF (53967)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_179(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE5A6 (58790)
{
	Hash entityModel;
	int num;
...
BOOL func_180(int iParam0, int iParam1) // Position - 0xEDCC (60876)
{
	int num;
	int num2;
...
int func_181(int iParam0, int iParam1) // Position - 0xEE0B (60939)
{
	int num;
	int num2;
...
int func_182() // Position - 0xEE51 (61009)
{
	return Global_33776;
}

int func_183(int iParam0) // Position - 0xEE5C (61020)
{
	int num;
	int num2;
	...
	if (func_100() == false || func_182() == 0 || func_100() == 999 && func_182() == 999)
	{
		switch (num2)
		{
			case 0:
...
char* func_184(int iParam0) // Position - 0xF1FD (61949)
{
	switch (iParam0)
	{
		case 0:
...
int func_185(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF83E (63550)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
int func_189() // Position - 0x13AC3 (80579)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_190() // Position - 0x13B79 (80761)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_192() // Position - 0x13D6A (81258)
{
	return 1;
}

int func_193() // Position - 0x13D73 (81267)
{
	return 1;
}

void func_194(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x13D7C (81276)
{
	var unk;
...
BOOL func_195(Ped pedParam0, int iParam1) // Position - 0x14033 (81971)
{
...
Hash func_196(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x142F3 (82675)
{
	var outProp;
	int componentId;
	int num;
...
int func_197(Hash hParam0, int iParam1) // Position - 0x1440D (82957)
{
	switch (hParam0)
	{
...
ePedComponentType func_198(int iParam0) // Position - 0x147B4 (83892)
{
	switch (iParam0)
	{
		case 0:
...
int func_199(Hash hParam0) // Position - 0x14864 (84068)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_200(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x148C5 (84165)
{
	int i;
	int j;
...
int func_201(Ped pedParam0, int iParam1) // Position - 0x14966 (84326)
{
...
int func_202(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x149C6 (84422)
{
	ePedComponentType componentId;
...
int func_203(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14A1D (84509)
{
	int pedPropIndex;
...
int func_204(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x14A64 (84580)
{
	Hash entityModel;
...
int func_205(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14B60 (84832)
{
	Hash entityModel;
...
int func_206(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14C9E (85150)
{
	var outfit;
	int i;
	int num;
...
int func_207(Hash hParam0) // Position - 0x14D59 (85337)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_208(ePedComponentType epctParam0) // Position - 0x14DB8 (85432)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_209(Ped pedParam0, int iParam1, int iParam2) // Position - 0x14E3E (85566)
{
	Hash entityModel;
	int num;
	ePedComponentType type;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_225(entityModel, iParam1, iParam2, -1) };
	type = Global_2883588;
	hash = Global_2883589;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_209(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_209(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_80063[2 /*14*/] = { func_225(entityModel, 14, j, -1) };
								
									if (Global_80063[2 /*14*/].f_12 == i)
									{
										if (func_209(pedParam0, 14, j))
										{
											if (!func_213(entityModel, iParam2, 14, j, &unk, &Global_80063[2 /*14*/]))
											{
												Global_2883588 = type;
												Global_2883589 = hash;
												return false;
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_225(entityModel, num2, num, -1) };
					
						if (!func_213(entityModel, iParam2, num2, num, &unk, &Global_80063[2 /*14*/]))
						{
							Global_2883588 = type;
							Global_2883589 = hash;
							return false;
		...
		{
			if (func_96(1759, Global_80060) != unk[10])
			{
				Global_2883588 = type;
				Global_2883589 = hash;
				return false;
	...
	{
		if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_198(iParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_198(iParam1)))
			return true;
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x15299 (86681)
{
	Hash componentHash;
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x15342 (86850)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_212(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x153EA (87018)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_213(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1543D (87101)
{
	var unk;
	int i;
...
BOOL func_214(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15A41 (88641)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_215(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15CBE (89278)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_216(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x160E3 (90339)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_217(Hash hParam0, int iParam1, int iParam2) // Position - 0x163D6 (91094)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_218(Hash hParam0, int iParam1) // Position - 0x1646F (91247)
{
	int i;
	var unk;
...
void func_219(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16D9E (93598)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_220(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x16EC8 (93896)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_221(Hash hParam0, int iParam1) // Position - 0x16F10 (93968)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_224(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_224(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_224(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_222(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x18D59 (101721)
{
	int num;
	Hash outfit;
...
int func_223(int iParam0) // Position - 0x18F43 (102211)
{
	switch (iParam0)
	{
		case 0:
...
void func_224(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18FF3 (102387)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_225(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x19064 (102500)
{
	func_271();
...
void func_226(int iParam0, int iParam1, Hash hParam2) // Position - 0x190A5 (102565)
{
	switch (iParam0)
	{
		case 2:
...
void func_227(int iParam0) // Position - 0x191B1 (102833)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_228(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_228(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1936C (103276)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_96(func_231(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_96(func_230(iParam1, iParam0->f_2), Global_80060);
...
BOOL func_229(int iParam0, int iParam1, var uParam2) // Position - 0x1970E (104206)
{
	*uParam2 = 979;
...
int func_230(int iParam0, int iParam1) // Position - 0x19B13 (105235)
{
	switch (iParam1)
	{
		case 0:
...
int func_231(int iParam0, int iParam1) // Position - 0x19F0E (106254)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_232(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1A309 (107273)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_233(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B1AC (111020)
{
	int num;
	int num2;
	int num3;
...
BOOL func_234(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B1EA (111082)
{
...
void func_238(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1E1CB (123339)
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_228(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_228(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_228(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_228(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_241(int iParam0, Hash hParam1) // Position - 0x1E834 (124980)
{
	...
	{
		func_228(&Global_80063[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}
...
int func_251(int iParam0, int iParam1) // Position - 0x2661C (157212)
{
	...
	num = func_96(func_252(iParam0), iParam1);
	return num;
}
...
{
	if (func_278(bParam0) || func_276() || func_275(*Global_4718592.f_192777))
		return true;
...
{
	return func_277(*Global_4718592.f_132500);
}
...
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_185514, 12) && func_279();
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_122(PLAYER::PLAYER_ID(), true) && Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_77.f_21 != 0)
						{
							return 1;
						}
					}
...
void func_306() // Position - 0x362BE (221886)
{
	...
	func_314(&uLocal_122, joaat("nimbus"), "Plane_1");
	func_58(&uLocal_122, 1);
	func_312(&uLocal_122, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_NIMB_LSA_ISD", 0, 1, 1023, 0);
