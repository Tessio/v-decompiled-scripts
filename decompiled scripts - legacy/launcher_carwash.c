		...
		case 4:
			...
			if (!uParam1->f_9)
				if (MISC::GET_HASH_KEY(uParam0->[uParam1->f_12 /*24*/].f_5) == MISC::GET_HASH_KEY("Carwash1") && func_5(PLAYER::PLAYER_ID()))
					func_26(uParam1, "CWASH_RIDEHLP2" /*Presiona ~INPUT_CONTEXT~ para usar tu autolavado gratis.*/);
				else
...
void func_37() // Position - 0x120F (4623)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(character) && !func_10(14) || Global_113909)
			{
...
BOOL func_50(int iParam0) // Position - 0x152A (5418)
{
	...
	if (HUD::IS_PAUSE_MENU_ACTIVE() || PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED() || func_48() || Global_65057 || func_49(false) || func_55(0) || func_51(PLAYER::PLAYER_ID()))
		return false;

	return true;
}

BOOL func_51(Player plParam0) // Position - 0x1590 (5520)
{
	if (func_54(plParam0))
		return true;
...
BOOL func_52(Player plParam0) // Position - 0x15B3 (5555)
{
	Player player;
...
BOOL func_53(Player plParam0, int iParam1) // Position - 0x15D1 (5585)
{
	return IS_BIT_SET(Global_1892925[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_54(Player plParam0) // Position - 0x15E9 (5609)
{
	Player player;
...
BOOL func_55(int iParam0) // Position - 0x160C (5644)
{
	if (iParam0 == 1)
...
BOOL func_56() // Position - 0x1663 (5731)
{
	if (Global_44921 == 15)
		return false;
...
void func_57(var uParam0) // Position - 0x1678 (5752)
{
	if (uParam0->f_11 == 1)
...
void func_58(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x16AD (5805)
{
	int i;
	float num;
	float num2;
...
void func_59(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1762 (5986)
{
	func_60(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1788 (6024)
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_61(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1998 (6552)
{
...
void func_62(int iParam0) // Position - 0x19D1 (6609)
{
	int shapeTestResult;
	Entity entityHit;
	var endCoords;
...
void func_63(BOOL bParam0) // Position - 0x1AC2 (6850)
{
	bParam0;
	return;
}

int func_64(Vehicle veParam0) // Position - 0x1ACF (6863)
{
...
int func_65(Vehicle veParam0) // Position - 0x1B3A (6970)
{
	var minimum;
	float maximum;
...
BOOL func_66(Vehicle veParam0) // Position - 0x1CCB (7371)
{
	Hash entityModel;
...
BOOL func_67(Hash hParam0) // Position - 0x1F6F (8047)
{
...
BOOL func_68(Vehicle veParam0, BOOL bParam1) // Position - 0x21BC (8636)
{
	if (Global_80337)
...
float func_69(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x220D (8717)
{
...
void func_70() // Position - 0x2247 (8775)
{
	func_76(&iLocal_57[0 /*24*/], 1, "Carwash1", func_77(156), 15, "", 0, 4f);
	func_76(&iLocal_57[1 /*24*/], 1, "Carwash2", func_77(157), 15, "", 0, 4f);
	func_74(&iLocal_57[0 /*24*/], -1f, 0f, 0f, 360f);
	func_74(&iLocal_57[1 /*24*/], 0f, -1f, 0f, 360f);
...
void func_71(var uParam0, int iParam1) // Position - 0x22D5 (8917)
{
...
BOOL func_72() // Position - 0x2369 (9065)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_73() // Position - 0x237F (9087)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_74(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x2395 (9109)
{
...
float func_75(float fParam0, float fParam1, float fParam2) // Position - 0x23BE (9150)
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_76(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x23E5 (9189)
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_77(int iParam0) // Position - 0x245A (9306)
{
	int num;
...
BOOL func_78(Vehicle veParam0) // Position - 0x2472 (9330)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_79() // Position - 0x2490 (9360)
{
	func_80(&iLocal_57);
	func_28(&uLocal_106);
	SCRIPT::TERMINATE_THIS_THREAD();
...
void func_80(var uParam0) // Position - 0x24A8 (9384)
{
	int i;
...
void func_81(var uParam0) // Position - 0x24D1 (9425)
{
	*uParam0 = 0;
	return;
}
