		...
		if (func_3(FRONTEND_CONTROL, Global_21579, 0))
		{
			...
			else if (Global_114904.f_14148[iLocal_56 /*104*/].f_30 == 1)
			{
				...
				if (func_25(Global_8778, Global_21610) == 0)
					func_24(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8778 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_211" /*DIALING...*/, "CELL_195" /*Unknown*/, 0);
				else
					func_24(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(3), -1f, -1f, &(Global_2339[Global_8778 /*29*/].f_3), &(Global_2339[Global_8778 /*29*/].f_7), "CELL_211" /*DIALING...*/, &(Global_2339[Global_8778 /*29*/].f_3), 0);
...
void func_7() // Position - 0x6B3 (1715)
{
	...
	switch (Global_21610.f_1)
	{
		case 6:
			...
			if (Global_21598)
			{
				func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
				func_24(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_21843 == true)
					if (Global_21598)
						func_24(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_24(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_21598)
					func_24(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
		...
		case 10:
			...
			{
				func_24(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
		...
		case 9:
			if (Global_21609 == 1)
			{
				...
				{
					func_24(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_8778 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_24(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_2339[Global_8778 /*29*/].f_3), &(Global_2339[Global_8778 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2339[Global_8778 /*29*/].f_3), 0);
				}
			...
			else if (Global_22983 == 4 || Global_22983 == 3)
			{
				...
				else
				{
					...
					if (func_25(Global_8778, Global_21610) == 0)
					{
						...
						func_24(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8778 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_54(Global_21591, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_8() // Position - 0xC9C (3228)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_21591))
	{
		...
		{
			if (Global_21598)
				func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
			...
			if (Global_23030)
				...
				func_24(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_24(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
		...
		if (func_3(FRONTEND_CONTROL, Global_21579, 0) || Global_114904.f_14058[Global_21610 /*20*/].f_17 == 1 || Global_24043 == true)
		{
			...
			if (Global_114904.f_14148[iLocal_56 /*104*/].f_24 != 0)
			{
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&gxt))
				{
					...
					if (Global_21598)
						func_24(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 16f, -1f, -1f, "CELL_267" /*LINK*/, 0, 0, 0, 0);
					else
				...
				func_42(Global_21591, "SET_HEADER", "CELL_1" /*Texts*/, 0, 0, 0, 0);
				HUD::THEFEED_REMOVE_ITEM(Global_114904.f_14148[iLocal_56 /*104*/].f_16);
			
				if (Global_114904.f_14148[iLocal_56 /*104*/].f_29 > 0)
					if (Global_21598)
						func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_212" /*YES*/, 0, 0, 0, 0);
					else
						func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_114904.f_14148[iLocal_56 /*104*/].f_30 == 1)
					if (Global_21598)
						func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
					else
						func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, 0, 0, 0, 0, 0);
				else
					func_24(Global_21591, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
				...
				if (Global_114904.f_14148[iLocal_56 /*104*/].f_24 == 2)
				{
					if (Global_114904.f_14148[iLocal_56 /*104*/].f_31 == 1)
					{
						...
						if (Global_21598)
							func_24(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 11f, -1f, -1f, "CELL_264" /*BARTER*/, 0, 0, 0, 0);
						else
				...
				{
					func_24(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 12f, -1f, -1f, "CELL_216" /*DELETE*/, 0, 0, 0, 0);
					MISC::SET_BIT(&Global_9463, 17);
				}
				else
				{
...
void func_51() // Position - 0x2F7D (12157)
{
	if (Global_114904.f_14058[Global_21610 /*20*/].f_17 == 0)
	{
		...
		{
			if (iLocal_53 > 0)
				func_24(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_214" /*OPTIONS*/, 0, 0, 0, 0);
			else
