...
int func_52(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2042 (8258)
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_80063[1 /*14*/] = { func_102(entityModel, iParam1, hParam2, -1) };
...
BOOL func_54(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x28DD (10461)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_55(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x29BB (10683)
{
	Global_80063[1 /*14*/] = { func_102(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_80063[1 /*14*/].f_6, 2);
}

BOOL func_56(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x29E3 (10723)
{
	var unk;
	int i;
...
BOOL func_57(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2FE7 (12263)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_58(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x3080 (12416)
{
	Hash i;
	Hash j;
...
BOOL func_59(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x3121 (12577)
{
	int num;
...
Hash func_60(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x3428 (13352)
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_61(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x3FDB (16347)
{
	int num;
...
Hash func_62(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x42C0 (17088)
{
	int num;
...
Hash func_63(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4587 (17799)
{
	Hash i;
	Hash hash;
...
BOOL func_64(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x45BE (17854)
{
	Hash hash;
...
BOOL func_65(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x45E7 (17895)
{
	*uParam2 = -99;
...
BOOL func_66(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x48B1 (18609)
{
	int num;
...
Hash func_67(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x4B3B (19259)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_68(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4C92 (19602)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_69(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, hash, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_69(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x4D2C (19756)
{
	switch (hParam0)
	{
...
Hash func_70(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x4DFA (19962)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_73(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x531C (21276)
{
	Hash entityModel;
...
BOOL func_78(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x56F6 (22262)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_79(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x5973 (22899)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_80(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x5D98 (23960)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_81(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x608B (24715)
{
	int pedPropIndex;
...
Hash func_82(Ped pedParam0, int iParam1) // Position - 0x60D2 (24786)
{
...
Hash func_83(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6132 (24882)
{
	ePedComponentType componentId;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_167(pedParam0, i, unk[i]))
				{
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_102(entityModel, i, hash, -1) };
					
						if (!func_56(entityModel, epctParam2, i, hash, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
