...
{
	if (IS_BIT_SET(Global_2739138, plParam0) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_14(&Global_2739139[plParam0 /*2*/], 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(plParam0))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&Global_2739139[plParam0 /*2*/], true, false);
				}
		...
		else
		{
			...
			_STOPWATCH_DESTROY(&Global_2739139[plParam0 /*2*/]);
			MISC::CLEAR_BIT(&Global_2739138, plParam0);
		}
	}
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_21(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_18(*Global_4718592.f_192777))
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C30 (7216)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veParam0) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			func_139(veParam0, uParam1, bParam2, bParam3);
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2100 (8448)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Hash hParam0) // Position - 0x2110 (8464)
{
	switch (hParam0)
	{
		case -1321131184:
	...
	return func_81(hParam0) && !func_80(hParam0);
}

BOOL func_80(Hash hParam0) // Position - 0x213E (8510)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_81(Hash hParam0) // Position - 0x2173 (8563)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
BOOL func_82(Hash hParam0) // Position - 0x2202 (8706)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_83(Vehicle veParam0) // Position - 0x2309 (8969)
{
	Hash entityModel;
...
void func_84(var uParam0, var uParam1, var uParam2) // Position - 0x2394 (9108)
{
	Hash eventData;
	...
	SCRIPT::_SEND_TU_SCRIPT_EVENT_NEW(1, &eventData, 6, func_85(true, true), eventData);
	return;
}

int func_85(BOOL bParam0, BOOL bParam1) // Position - 0x23D5 (9173)
{
	int address;
	int i;
	Player player;
...
BOOL func_86(int iParam0) // Position - 0x243A (9274)
{
	int i;
...
BOOL func_87(int iParam0) // Position - 0x2475 (9333)
{
	return func_88(iParam0, 6, true);
}

BOOL func_88(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2485 (9349)
{
	if (iParam0 == -1)
		return false;
...
int func_89(int iParam0, int iParam1) // Position - 0x24E5 (9445)
{
	Hash statHash;
	int outValue;
...
Hash func_90(int iParam0, int iParam1) // Position - 0x2514 (9492)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_91(iParam1));
}

int func_91(int iParam0) // Position - 0x2529 (9513)
{
	int num;
	int num2;
...
int func_92(int iParam0) // Position - 0x255D (9565)
{
	switch (iParam0)
	{
		case 0:
...
int func_93() // Position - 0x2941 (10561)
{
	return Global_33775;
}

int func_94(int iParam0) // Position - 0x294C (10572)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_95() // Position - 0x2CB6 (11446)
{
	return Global_102481.f_418 > 0;
}

int func_96(Vehicle veParam0, Any* panParam1) // Position - 0x2CC7 (11463)
{
...
BOOL func_97(Vehicle veParam0) // Position - 0x2D44 (11588)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_98(Vehicle veParam0) // Position - 0x2DD1 (11729)
{
	int _int;
...
BOOL func_99(var uParam0, Player plParam1) // Position - 0x2E2D (11821)
{
	func_103();
	...
	func_101(*uParam0, &Global_1950086, &(Global_1950086.f_1), &(Global_1950086.f_4), &(Global_1950086.f_7), &(Global_1950086.f_10));
	...
	{
		if (func_100(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1950086.f_23 == 0 && func_100(uParam0, plParam1, Global_1950086, Global_1950086.f_1, Global_1950086.f_4, Global_1950086.f_7, Global_1950086.f_10, 0, Global_1950086.f_13) || Global_1950086.f_23 != 0 && Global_1950086.f_24 == 0 && func_100(uParam0, plParam1, Global_1950086, Global_1950086.f_14, Global_1950086.f_17, Global_1950086.f_20, Global_1950086.f_10, 1, Global_1950086.f_13) || Global_1950086.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1576399 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_100(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x30D8 (12504)
{
...
int func_101(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3101 (12545)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_102(Global_1950112, 0f, 0f, 0f, false) && !func_102(Global_1950115, 0f, 0f, 0f, false) && !func_102(Global_1950118, 0f, 0f, 0f, false) && !(Global_1950121 == 0f))
	{
...
BOOL func_102(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9145 (37189)
{
	if (bParam6)
...
void func_103() // Position - 0x918C (37260)
{
	Global_1950086 = 0;
...
BOOL func_104(Vehicle veParam0) // Position - 0x9205 (37381)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_105(Vehicle veParam0) // Position - 0x923D (37437)
{
	int _int;
...
BOOL func_106(Vehicle veParam0, Any* panParam1) // Position - 0x9285 (37509)
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
	...
	{
		num = Global_2359296[func_113() /*5574*/].f_681.f_2;
	
		if (num > -1 && num < 607)
			if (IS_BIT_SET(Global_1583765[num /*143*/].f_104, 8))
				flag = true;
	}
...
BOOL func_107(Vehicle veParam0) // Position - 0x93E2 (37858)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_108(Vehicle veParam0) // Position - 0x973F (38719)
{
...
int func_109(Player plParam0) // Position - 0x976B (38763)
{
...
int func_110(Player plParam0) // Position - 0x9788 (38792)
{
...
BOOL func_111(Player plParam0, BOOL bParam1) // Position - 0x97AB (38827)
{
	if (func_11(plParam0))
...
int func_112(Player plParam0) // Position - 0x97EF (38895)
{
	if (func_11(plParam0))
		if (func_111(plParam0, false))
...
int func_113() // Position - 0x981B (38939)
{
	int num;
...
BOOL func_114(BOOL bParam0) // Position - 0x9828 (38952)
{
	return func_115(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_115(Player plParam0, BOOL bParam1) // Position - 0x983A (38970)
{
	return func_116(plParam0, bParam1, 1);
}

BOOL func_116(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x984B (38987)
{
	Player player;
	...
	if (func_11(player) && Global_1892653[player /*615*/].f_10.f_433 == iParam2)
		return 1;

	return 0;
}

BOOL func_117(Player plParam0, int iParam1) // Position - 0x98A7 (39079)
{
	if (func_11(plParam0))
		if (func_11(Global_1892653[plParam0 /*615*/].f_10))
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x98F6 (39158)
{
	int num;
	int num2;
...
int func_119(int iParam0) // Position - 0x9954 (39252)
{
	return iParam0 % 32;
}

int func_120(int iParam0) // Position - 0x9961 (39265)
{
	int num;
...
int func_121(int iParam0) // Position - 0x9978 (39288)
{
	int num;
	int num2;
...
int func_122(int iParam0) // Position - 0x99A5 (39333)
{
	return iParam0 / 32;
}

BOOL func_123(Player plParam0) // Position - 0x99B2 (39346)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_124(plParam0) && Global_2658291[plParam0 /*468*/].f_325.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_124(Player plParam0) // Position - 0x99E7 (39399)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658291[plParam0 /*468*/].f_325.f_8 != -1)
				return func_125(Global_2658291[plParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

int func_125(int iParam0) // Position - 0x9A2E (39470)
{
	switch (iParam0)
	{
		case 0:
...
void func_126(Vehicle veParam0, int iParam1) // Position - 0x9F7E (40830)
{
	int num;
	int num2;
...
BOOL func_127(int iParam0, var uParam1) // Position - 0x9F9F (40863)
{
	*uParam1 = -1;
...
int func_128(int iParam0) // Position - 0xA261 (41569)
{
	switch (iParam0)
	{
		case 0:
...
int func_129(int iParam0, int iParam1, int iParam2) // Position - 0xA2FF (41727)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_130() && Global_1576247)
...
BOOL func_130() // Position - 0xA4E1 (42209)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA529 (42281)
{
	var gamerHandle;
...
BOOL func_132(Vehicle veParam0) // Position - 0xA53E (42302)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_133(int iParam0, var uParam1) // Position - 0xA55F (42335)
{
	*uParam1 = -1f;
...
void func_134(Vehicle veParam0, var uParam1) // Position - 0xA860 (43104)
{
...
void func_135(Vehicle veParam0) // Position - 0xA8D9 (43225)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA90B (43275)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA93F (43327)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA962 (43362)
{
...
void func_139(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB927 (47399)
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_157(veParam0, uParam1->f_69);
				else
					func_157(veParam0, uParam1->f_69);
		...
		if (func_142() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_141(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_140(veParam0, 5f))
...
BOOL func_140(Vehicle veParam0, float fParam1) // Position - 0xC049 (49225)
{
	float entityCoords;
	var groundZ;
...
Hash func_141(BOOL bParam0) // Position - 0xC0BA (49338)
{
	if (bParam0)
...
BOOL func_142() // Position - 0xC0D4 (49364)
{
	...
	if (func_146(7))
		if (func_144(Global_2673271.f_4.f_16) || func_143(Global_2673271.f_4.f_16))
			return false;

	return true;
}

BOOL func_143(Player plParam0) // Position - 0xC163 (49507)
{
	Player player;
...
BOOL func_144(Player plParam0) // Position - 0xC188 (49544)
{
	Player player;
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xC1A6 (49574)
{
	return IS_BIT_SET(Global_1892653[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_146(int iParam0) // Position - 0xC1BE (49598)
{
	return func_147(&(Global_2673271.f_194), iParam0);
}

BOOL func_147(var uParam0, int iParam1) // Position - 0xC1D2 (49618)
{
	int num;
	int num2;
	int num3;
...
int func_148(var uParam0, var uParam1, var uParam2) // Position - 0xC1F5 (49653)
{
	int i;
	int modType;
	...
	if (func_153(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_151(*uParam0, uParam1->[38] - 1))
...
BOOL func_149(Vehicle veParam0) // Position - 0xC3CE (50126)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_150(var uParam0) // Position - 0xC4A8 (50344)
{
...
int func_151(Vehicle veParam0, int iParam1) // Position - 0xC4FF (50431)
{
	int value;
	int value2;
	float num;
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xC5E8 (50664)
{
	int i;
...
BOOL func_153(Hash hParam0) // Position - 0xC64A (50762)
{
...
BOOL func_154(Hash hParam0, int iParam1) // Position - 0xC675 (50805)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_155(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xCA5B (51803)
{
...
BOOL func_156() // Position - 0xCA7F (51839)
{
	return false;
}

void func_157(Vehicle veParam0, int iParam1) // Position - 0xCA88 (51848)
{
	int vehicleMod;
...
BOOL func_158(int iParam0) // Position - 0xCB00 (51968)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_159() // Position - 0xCB20 (52000)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_160(Vehicle veParam0) // Position - 0xCB31 (52017)
{
	int _int;
...
int func_161(var uParam0) // Position - 0xCB76 (52086)
{
	if (!func_156() && func_162(uParam0))
		return 1;

	return 0;
}

BOOL func_162(int iParam0) // Position - 0xCB96 (52118)
{
	switch (iParam0)
	{
		case 161:
...
int func_163(int iParam0) // Position - 0xCBE9 (52201)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_164(Vehicle veParam0) // Position - 0xCC99 (52377)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xCD20 (52512)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xCD6D (52589)
{
...
void func_167(var uParam0) // Position - 0xCD8E (52622)
{
...
void func_168(var uParam0) // Position - 0xCDDC (52700)
{
...
Vector3 func_169(float fParam0, var uParam1, var uParam2) // Position - 0xCE96 (52886)
{
	return -BUILTIN::SIN(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::COS(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::SIN(fParam0);
}

BOOL func_170(var uParam0) // Position - 0xCEC3 (52931)
{
	Player player;
	...
	else
	{
		...
		func_171(uParam0->f_23, &Global_1879623[player /*55*/], false, -1);
	}
...
void func_171(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xCF9B (53147)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_172(Ped pedParam0, int iParam1, int iParam2) // Position - 0xD104 (53508)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_173(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE3DB (58331)
{
	Hash entityModel;
	int num;
...
BOOL func_174(int iParam0, int iParam1) // Position - 0xEC01 (60417)
{
	int num;
	int num2;
...
int func_175(int iParam0, int iParam1) // Position - 0xEC40 (60480)
{
	int num;
	int num2;
...
int func_176() // Position - 0xEC86 (60550)
{
	return Global_33776;
}

int func_177(int iParam0) // Position - 0xEC91 (60561)
{
	int num;
	int num2;
	...
	if (func_93() == 0 || func_176() == 0 || func_93() == 999 && func_176() == 999)
	{
		switch (num2)
		{
			case 0:
...
char* func_178(int iParam0) // Position - 0xF032 (61490)
{
	switch (iParam0)
	{
		case 0:
...
int func_179(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xF66F (63087)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_180(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x10A9E (68254)
{
	Hash entityModel;
	int num;
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(20000) * Global_262145.f_2825), 0);
					break;
			
				case 1:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1400) * Global_262145.f_2826), 2);
					break;
			
				case 2:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(9750) * Global_262145.f_2827), 3);
					break;
			
				case 3:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2150) * Global_262145.f_2828), 0);
					break;
			
				case 4:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2829), 0);
					break;
			
				case 54:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12400) * Global_262145.f_2830), 1);
					break;
			
				case 5:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3500) * Global_262145.f_2831), 0);
					break;
			
				case 6:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4950) * Global_262145.f_2832), 2);
					break;
			
				case 55:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1350) * Global_262145.f_2833), 1);
					break;
			
				case 7:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1450) * Global_262145.f_2834), 0);
					break;
			
				case 8:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2700) * Global_262145.f_2835), 7);
					break;
			
				case 9:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1200) * Global_262145.f_2836), 0);
					break;
			
				case 10:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1500) * Global_262145.f_2837), 0);
					break;
			
				case 11:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2650) * Global_262145.f_2838), 0);
					break;
			
				case 56:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1900) * Global_262145.f_2839), 1);
					break;
			
				case 12:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4950) * Global_262145.f_2840), 2);
					break;
			
				case 57:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2400) * Global_262145.f_2841), 1);
					break;
			
				case 58:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2842), 1);
					break;
			
				case 59:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7400) * Global_262145.f_2843), 1);
					break;
			
				case 60:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2844), 1);
					break;
			
				case 17:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2400) * Global_262145.f_2849), 2);
					break;
			
				case 18:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2850), 2);
					break;
			
				case 19:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3600) * Global_262145.f_2851), 2);
					break;
			
				case 20:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2852), 3);
					break;
			
				case 21:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12500) * Global_262145.f_2853), 3);
					break;
			
				case 22:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2854), 3);
					break;
			
				case 23:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2855), 3);
					break;
			
				case 24:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2856), 3);
					break;
			
				case 25:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3750) * Global_262145.f_2857), 2);
					break;
			
				case 26:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3750) * Global_262145.f_2858), 3);
					break;
			
				case 27:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4800) * Global_262145.f_2859), 3);
					break;
			
				case 28:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3500) * Global_262145.f_2860), 3);
					break;
			
				case 61:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12350) * Global_262145.f_2861), 1);
					break;
			
				case 62:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1900) * Global_262145.f_2862), 1);
					break;
			
				case 63:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4500) * Global_262145.f_2863), 1);
					break;
			
				case 64:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12250) * Global_262145.f_2864), 1);
					break;
			
				case 65:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12300) * Global_262145.f_2865), 1);
					break;
			
				case 29:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2500) * Global_262145.f_2866), 0);
					break;
			
				case 30:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2867), 0);
					break;
			
				case 31:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2868), 0);
					break;
			
				case 66:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2869), 1);
					break;
			
				case 32:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2870), 2);
					break;
			
				case 33:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7300) * Global_262145.f_2871), 3);
					break;
			
				case 34:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7250) * Global_262145.f_2872), 2);
					break;
			
				case 35:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(11900) * Global_262145.f_2873), 0);
					break;
			
				case 36:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2750) * Global_262145.f_2874), 0);
					break;
			
				case 37:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1750) * Global_262145.f_2875), 0);
					break;
			
				case 38:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7300) * Global_262145.f_2876), 3);
					break;
			
				case 39:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3250) * Global_262145.f_2877), 2);
					break;
			
				case 40:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1000) * Global_262145.f_2878), 0);
					break;
			
				case 67:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2879), 1);
					break;
			
				case 41:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2880), 2);
					break;
			
				case 68:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2881), 1);
					break;
			
				case 42:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5050) * Global_262145.f_2882), 0);
					break;
			
				case 43:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2450) * Global_262145.f_2883), 2);
					break;
			
				case 44:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4950) * Global_262145.f_2884), 0);
					break;
			
				case 45:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2885), 0);
					break;
			
				case 46:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12250) * Global_262145.f_2886), 0);
					break;
			
				case 47:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1150) * Global_262145.f_2887), 3);
					break;
			
				case 48:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2888), 3);
					break;
			
				case 49:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7600) * Global_262145.f_2889), 3);
					break;
			
				case 50:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2600) * Global_262145.f_2890), 2);
					break;
			
				case 51:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2500) * Global_262145.f_2891), 3);
					break;
			
				case 52:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7450) * Global_262145.f_2892), 3);
					break;
			
				case 53:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2893), 0);
					break;
			
				case 69:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2894), 1);
					break;
			
				case 70:
					func_188(sParam0, iParam1, pedParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2500) * Global_262145.f_2895), 2);
					break;
			}
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_188(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_188(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_188(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
					...
					case 13:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2845), 0);
						break;
				
					case 14:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_188(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2848), 0);
						break;
				
					case 71:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				
					case 72:
						func_188(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_188(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_188(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_188(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
					...
					case 14:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_188(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			break;
...
void func_181(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13A0A (80394)
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_182() // Position - 0x13A9C (80540)
{
...
int func_183() // Position - 0x13AC3 (80579)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_184() // Position - 0x13B79 (80761)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_186() // Position - 0x13D6A (81258)
{
	return 1;
}

int func_187() // Position - 0x13D73 (81267)
{
	return 1;
}

void func_188(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x13D7C (81276)
{
	var unk;
...
BOOL func_189(Ped pedParam0, int iParam1) // Position - 0x14033 (81971)
{
...
Hash func_190(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x142F3 (82675)
{
	var outProp;
	int componentId;
	int num;
	...
	else
	{
		...
		num2 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_192(iParam2));
...
int func_191(Hash hParam0, int iParam1) // Position - 0x1440D (82957)
{
	switch (hParam0)
	{
...
ePedComponentType func_192(int iParam0) // Position - 0x147B4 (83892)
{
	switch (iParam0)
	{
		case 0:
...
int func_193(Hash hParam0) // Position - 0x14864 (84068)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_194(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x148C5 (84165)
{
	int i;
	int j;
...
int func_195(Ped pedParam0, int iParam1) // Position - 0x14966 (84326)
{
...
int func_196(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x149C6 (84422)
{
	ePedComponentType componentId;
...
int func_197(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14A1D (84509)
{
	int pedPropIndex;
...
int func_198(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x14A64 (84580)
{
	Hash entityModel;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14B60 (84832)
{
	Hash entityModel;
...
int func_200(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14C9E (85150)
{
	var outfit;
	int i;
	int num;
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_192(iParam2));
...
int func_201(Hash hParam0) // Position - 0x14D59 (85337)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_202(ePedComponentType epctParam0) // Position - 0x14DB8 (85432)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_203(Ped pedParam0, int iParam1, int iParam2) // Position - 0x14E3E (85566)
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_219(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_203(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_203(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_80063[2 /*14*/] = { func_219(entityModel, 14, j, -1) };
								
									if (Global_80063[2 /*14*/].f_12 == i)
									{
										if (func_203(pedParam0, 14, j))
										{
											if (!func_207(entityModel, iParam2, 14, j, &unk, &Global_80063[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_219(entityModel, num2, num, -1) };
					
						if (!func_207(entityModel, iParam2, num2, num, &unk, &Global_80063[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_89(1759, Global_80060) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_192(iParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_192(iParam1)))
			return true;
...
BOOL func_204(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x15299 (86681)
{
	Hash componentHash;
...
BOOL func_205(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x15342 (86850)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x153EA (87018)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1543D (87101)
{
	var unk;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15A41 (88641)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15CBE (89278)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x160E3 (90339)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, int iParam2) // Position - 0x163D6 (91094)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_212(Hash hParam0, int iParam1) // Position - 0x1646F (91247)
{
	int i;
	var unk;
...
void func_213(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16D9E (93598)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_214(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x16EC8 (93896)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_215(Hash hParam0, int iParam1) // Position - 0x16F10 (93968)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_218(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_218(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_218(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_216(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x18D59 (101721)
{
	int num;
	Hash outfit;
...
int func_217(int iParam0) // Position - 0x18F43 (102211)
{
	switch (iParam0)
	{
		case 0:
...
void func_218(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x18FF3 (102387)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_219(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x19064 (102500)
{
	func_265();
...
void func_220(int iParam0, int iParam1, Hash hParam2) // Position - 0x190A5 (102565)
{
	switch (iParam0)
	{
		case 2:
...
void func_221(int iParam0) // Position - 0x191B1 (102833)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_222(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_222(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x1936C (103276)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_89(func_225(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_89(func_224(iParam1, iParam0->f_2), Global_80060);
...
BOOL func_223(int iParam0, int iParam1, var uParam2) // Position - 0x1970E (104206)
{
	*uParam2 = 979;
...
int func_224(int iParam0, int iParam1) // Position - 0x19B13 (105235)
{
	switch (iParam1)
	{
		case 0:
...
int func_225(int iParam0, int iParam1) // Position - 0x19F0E (106254)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_226(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1A309 (107273)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_227(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B1AC (111020)
{
	int num;
	int num2;
	int num3;
...
BOOL func_228(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B1EA (111082)
{
...
BOOL func_229(int iParam0) // Position - 0x1E0C9 (123081)
{
	return Global_44869 == iParam0;
}

int func_230(int iParam0) // Position - 0x1E0D7 (123095)
{
	switch (iParam0)
	{
		case -1:
...
void func_231(int iParam0, Hash hParam1) // Position - 0x1E1AB (123307)
{
	int num;
...
void func_232(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1E1CB (123339)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_222(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_222(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_222(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_222(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1E452 (123986)
{
	BOOL flag;
	int num;
	var unk;
...
void func_234(int iParam0, Hash hParam1) // Position - 0x1E555 (124245)
{
	BOOL flag;
	int num;
	var unk;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1E834 (124980)
{
	BOOL flag;
	int value;
	var unk;
	...
	{
		func_222(&Global_80063[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_236(int iParam0, Hash hParam1) // Position - 0x2160A (136714)
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x2170F (136975)
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x21EEB (138987)
{
	BOOL flag;
	int value;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x221D0 (139728)
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x237F7 (145399)
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x24E70 (151152)
{
	BOOL flag;
	int num;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x24FCB (151499)
{
	BOOL flag;
	int num;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x2524B (152139)
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_244(int iParam0, int iParam1) // Position - 0x265ED (157165)
{
	int num;
	int num2;

	if (func_246(iParam0) == 16715)
		return false;
...
int func_245(int iParam0, int iParam1) // Position - 0x2661C (157212)
{
	int num;

	num = func_89(func_246(iParam0), iParam1);
	return num;
}

int func_246(int iParam0) // Position - 0x26634 (157236)
{
	int num;
	int num2;
...
void func_247(int iParam0, Hash hParam1) // Position - 0x269AF (158127)
{
	BOOL flag;
	int value;
	var unk;
...
void func_248(int iParam0, Hash hParam1) // Position - 0x28118 (164120)
{
	BOOL flag;
	int value;
	var unk;
...
void func_249(int iParam0, int iParam1, Hash hParam2) // Position - 0x28FE9 (167913)
{
	switch (iParam0)
	{
		case 2:
...
void func_250(int iParam0) // Position - 0x290F5 (168181)
{
	BOOL flag;
	int num;
	var unk;
...
void func_251(int iParam0, Hash hParam1) // Position - 0x292BF (168639)
{
	int num;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x292DF (168671)
{
	BOOL flag;
	int num;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x293E2 (168930)
{
	BOOL flag;
	int num;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x29693 (169619)
{
	BOOL flag;
	int value;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2C454 (181332)
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x2C575 (181621)
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x2CE6D (183917)
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2D124 (184612)
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2E761 (190305)
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2FD94 (195988)
{
	BOOL flag;
	int num;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2FEEB (196331)
{
	BOOL flag;
	int num;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x302FE (197374)
{
	BOOL flag;
	int value;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x327EF (206831)
{
	BOOL flag;
	int value;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x33D7A (212346)
{
	BOOL flag;
	int value;
	var unk;
...
void func_265() // Position - 0x34C36 (216118)
{
...
BOOL func_266(Ped pedParam0) // Position - 0x34CAF (216239)
{
	int num;
...
int func_267(int iParam0) // Position - 0x34D2B (216363)
{
	if (func_268(true))
...
BOOL func_268(BOOL bParam0) // Position - 0x34D62 (216418)
{
	if (func_272(bParam0) || func_270() || func_269(*Global_4718592.f_192777))
		return true;

	return false;
}

BOOL func_269(int iParam0) // Position - 0x34D96 (216470)
{
	return iParam0 == 87;
}

BOOL func_270() // Position - 0x34DA3 (216483)
{
	return func_271(*Global_4718592.f_132500);
}

int func_271(int iParam0) // Position - 0x34DB9 (216505)
{
	int i;
...
BOOL func_272(BOOL bParam0) // Position - 0x34DF3 (216563)
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_185514, 12) && func_273();

	return IS_BIT_SET(*Global_4718592.f_185514, 12);
}

BOOL func_273() // Position - 0x34E29 (216617)
{
...
BOOL func_274(Ped pedParam0, BOOL bParam1) // Position - 0x34E57 (216663)
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_115(PLAYER::PLAYER_ID(), true) && Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_77.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_275(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35691 (218769)
{
	Hash componentHash;
...
int func_276(int iParam0, Hash hParam1) // Position - 0x35EB1 (220849)
{
...
int func_277(Ped pedParam0) // Position - 0x35ED3 (220883)
{
...
Player func_278() // Position - 0x35F36 (220982)
{
	Player player;
...
BOOL func_280(BOOL bParam0) // Position - 0x35F69 (221033)
{
	return func_281(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_281(Player plParam0, BOOL bParam1) // Position - 0x35F7B (221051)
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_282(Player plParam0) // Position - 0x35FB3 (221107)
{
	if (func_11(plParam0))
		if (func_11(Global_1892653[plParam0 /*615*/].f_10))
...
Ped func_283() // Position - 0x35FE8 (221160)
{
	Ped playerPed;
...
BOOL func_284(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3600A (221194)
{
...
int func_285(var uParam0) // Position - 0x36061 (221281)
{
	return *uParam0;
}

void func_286() // Position - 0x3606C (221292)
{
...
void func_287(int iParam0) // Position - 0x360B7 (221367)
{
	if (func_46())
		return;
...
void func_288(BOOL bParam0) // Position - 0x360EA (221418)
{
	if (bParam0)
		func_290();
...
void func_289(int iParam0, int iParam1) // Position - 0x3613B (221499)
{
...
void func_290() // Position - 0x36171 (221553)
{
	Global_2733002.f_3725 = 0;
	return;
}

BOOL func_291() // Position - 0x36181 (221569)
{
...
Hash func_294() // Position - 0x3624C (221772)
{
...
BOOL func_295() // Position - 0x36270 (221808)
{
...
BOOL func_297() // Position - 0x36296 (221846)
{
	return Global_2696964;
}

BOOL func_298() // Position - 0x362A2 (221858)
{
	return Global_2685150.f_695;
}

void func_299() // Position - 0x362B1 (221873)
{
	BUILTIN::WAIT(0);
	return;
}

void func_300(var uParam0) // Position - 0x362BE (221886)
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_303(&uLocal_122, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_122, 1);
	func_301(&uLocal_122, -2392.8381f, -2427.6187f, 43.1663f, -1.9378f, -0.4041f, -53.486f, "HS4_LSA_LAND_NIMB", 1, 1, uParam0->f_4, 0);
	return;
}

void func_301(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x36312 (221970)
{
	func_302(uParam0, sParam7, iParam8, iParam9, uParam10);
	uParam0->f_9 = { fParam1 };
...
void func_302(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x36342 (222018)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_303(var uParam0, int iParam1, char* sParam2) // Position - 0x3636F (222063)
{
