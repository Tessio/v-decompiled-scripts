...
void func_5() // Position - 0x21F (543)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && _STOPWATCH_IS_INITIALIZED(&Global_2750034))
	{
		if (!func_14(&Global_2750034, 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&Global_2750034, true, false);
				}
				else if (!func_8(PLAYER::PLAYER_ID(), 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_PARACHUTE) != 1 && TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_PARACHUTE) != 0 && PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID()) == -1 || Global_2750104)
					{
		...
		else
		{
			...
			_STOPWATCH_DESTROY(&Global_2750034);
		}
	}
	...
	if (Global_2750038 > 0)
	{
		for (i = 0; i < 32; i = i + 1)
		{
			if (IS_BIT_SET(Global_2750038, i))
			{
...
{
	if (IS_BIT_SET(Global_2750038, plParam0) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_14(&Global_2750039[plParam0 /*2*/], 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(plParam0))
		{
			if (!func_13())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_12(&Global_2750039[plParam0 /*2*/], true, false);
				}
		...
		else
		{
			...
			_STOPWATCH_DESTROY(&Global_2750039[plParam0 /*2*/]);
			MISC::CLEAR_BIT(&Global_2750038, plParam0);
		}
	}
...
{
	return IS_BIT_SET(Global_2684745, 7);
}
...
void func_50(int iParam0) // Position - 0x12A3 (4771)
{
	...
	TEXT_LABEL_ASSIGN_STRING(&Global_112993[iParam0 /*28*/], "", 16);
	TEXT_LABEL_ASSIGN_STRING(&(Global_112993[iParam0 /*28*/].f_4), "", 64);
...
void func_72(var uParam0) // Position - 0x198C (6540)
{
	...
	{
		func_14(&(uParam0->f_18), Global_262145.f_30230, false);
		return;
	}
...
void func_73(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A33 (6707)
{
	func_75();
	func_49(true);
	HUD::CLEAR_HELP(true);
...
void func_74() // Position - 0x1AA8 (6824)
{
	func_34(0);
	func_35(4, 1, -1);
	func_35(6, true, -1);
...
void func_75() // Position - 0x1AFF (6911)
{
	Global_1574756 = true;
...
void func_76(var uParam0) // Position - 0x1B28 (6952)
{
	var unk;
...
void func_77(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C23 (7203)
{
	Hash entityModel;
	float num;
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x215C (8540)
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Hash hParam0) // Position - 0x216C (8556)
{
	switch (hParam0)
	{
		case -1321131184:
...
BOOL func_80(Hash hParam0) // Position - 0x219A (8602)
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_81(Hash hParam0) // Position - 0x21CF (8655)
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_82(Vehicle veParam0) // Position - 0x22D6 (8918)
{
	Hash entityModel;
...
void func_83(var uParam0, var uParam1, var uParam2) // Position - 0x2361 (9057)
{
	Hash eventData;
	...
	SCRIPT::_SEND_TU_SCRIPT_EVENT_NEW(1, &eventData, 6, func_84(true, true), eventData);
	return;
}

int func_84(BOOL bParam0, BOOL bParam1) // Position - 0x23A2 (9122)
{
	int address;
	int i;
	Player player;
...
BOOL func_85(int iParam0) // Position - 0x2407 (9223)
{
	int i;
...
BOOL func_86(int iParam0) // Position - 0x2442 (9282)
{
	return func_87(iParam0, 6, true);
}

BOOL func_87(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2452 (9298)
{
	if (iParam0 == -1)
		return false;
...
int func_88(int iParam0, int iParam1) // Position - 0x24B2 (9394)
{
	Hash statHash;
	int outValue;
...
Hash func_89(int iParam0, int iParam1) // Position - 0x24E1 (9441)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_90(iParam1));
}

int func_90(int iParam0) // Position - 0x24F6 (9462)
{
	int num;
	int num2;
...
int func_91(int iParam0) // Position - 0x252A (9514)
{
	switch (iParam0)
	{
		case 0:
...
int func_92() // Position - 0x28E1 (10465)
{
	return Global_33281;
}

int func_93(int iParam0) // Position - 0x28EC (10476)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_94() // Position - 0x2C2F (11311)
{
	return Global_101945.f_400 > 0;
}

int func_95(Vehicle veParam0, Any* panParam1) // Position - 0x2C40 (11328)
{
...
BOOL func_96(Vehicle veParam0) // Position - 0x2CBD (11453)
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_97(Vehicle veParam0) // Position - 0x2D4A (11594)
{
	int _int;
...
BOOL func_98(var uParam0, Player plParam1) // Position - 0x2DA6 (11686)
{
	func_102();
	...
	func_100(*uParam0, &Global_1945812, &(Global_1945812.f_1), &(Global_1945812.f_4), &(Global_1945812.f_7), &(Global_1945812.f_10));
	...
	{
		if (func_99(uParam0, plParam1, Global_1945812, Global_1945812.f_1, Global_1945812.f_4, Global_1945812.f_7, Global_1945812.f_10, 0, Global_1945812.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1945812.f_23 == 0 && func_99(uParam0, plParam1, Global_1945812, Global_1945812.f_1, Global_1945812.f_4, Global_1945812.f_7, Global_1945812.f_10, 0, Global_1945812.f_13) || Global_1945812.f_23 != 0 && Global_1945812.f_24 == 0 && func_99(uParam0, plParam1, Global_1945812, Global_1945812.f_14, Global_1945812.f_17, Global_1945812.f_20, Global_1945812.f_10, 1, Global_1945812.f_13) || Global_1945812.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577970 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_99(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3051 (12369)
{
...
int func_100(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x307A (12410)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
	...
	*iParam1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veParam0, "chassis_dummy");
	...
	if (!func_101(Global_1945838, 0f, 0f, 0f, false) && !func_101(Global_1945841, 0f, 0f, 0f, false) && !func_101(Global_1945844, 0f, 0f, 0f, false) && !(Global_1945847 == 0f))
	{
...
BOOL func_101(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8F23 (36643)
{
	if (bParam6)
...
void func_102() // Position - 0x8F6A (36714)
{
	Global_1945812 = 0;
...
BOOL func_103(Vehicle veParam0) // Position - 0x8FE3 (36835)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_104(Vehicle veParam0) // Position - 0x901B (36891)
{
	int _int;
...
BOOL func_105(Vehicle veParam0, Any* panParam1) // Position - 0x9063 (36963)
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_106(Vehicle veParam0) // Position - 0x91C0 (37312)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_107(Vehicle veParam0) // Position - 0x950B (38155)
{
...
int func_108(Player plParam0) // Position - 0x9537 (38199)
{
...
int func_109(Player plParam0) // Position - 0x9554 (38228)
{
...
BOOL func_110(Player plParam0, BOOL bParam1) // Position - 0x9577 (38263)
{
	if (func_11(plParam0))
...
int func_111(Player plParam0) // Position - 0x95BB (38331)
{
	if (func_11(plParam0))
		if (func_110(plParam0, false))
...
int func_112() // Position - 0x95E7 (38375)
{
	int num;
...
BOOL func_113(BOOL bParam0) // Position - 0x95F4 (38388)
{
	return func_114(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_114(Player plParam0, BOOL bParam1) // Position - 0x9606 (38406)
{
	return func_115(plParam0, bParam1, 1);
}

BOOL func_115(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x9617 (38423)
{
	Player player;
	...
	if (func_11(player) && Global_1888737[player /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_116(Player plParam0, int iParam1) // Position - 0x9673 (38515)
{
	if (func_11(plParam0))
		if (func_11(Global_1888737[plParam0 /*611*/].f_10))
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x96C2 (38594)
{
	int num;
	int num2;
...
int func_118(int iParam0) // Position - 0x9720 (38688)
{
	return iParam0 % 32;
}

int func_119(int iParam0) // Position - 0x972D (38701)
{
	int num;
...
int func_120(int iParam0) // Position - 0x9744 (38724)
{
	int num;
	int num2;
...
int func_121(int iParam0) // Position - 0x9771 (38769)
{
	return iParam0 / 32;
}

BOOL func_122(Player plParam0) // Position - 0x977E (38782)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_123(plParam0) && Global_2658016[plParam0 /*467*/].f_324.f_11 == plParam0)
			return true;

	return false;
}

BOOL func_123(Player plParam0) // Position - 0x97B3 (38835)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658016[plParam0 /*467*/].f_324.f_8 != -1)
				return func_124(Global_2658016[plParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_124(int iParam0) // Position - 0x97FA (38906)
{
	switch (iParam0)
	{
		case 0:
...
void func_125(Vehicle veParam0, int iParam1) // Position - 0x9D30 (40240)
{
	int num;
	int num2;
...
BOOL func_126(int iParam0, var uParam1) // Position - 0x9D51 (40273)
{
	*uParam1 = -1;
...
int func_127(int iParam0) // Position - 0xA013 (40979)
{
	switch (iParam0)
	{
		case 0:
...
int func_128(int iParam0, int iParam1, int iParam2) // Position - 0xA0B1 (41137)
{
...
BOOL func_129() // Position - 0xA293 (41619)
{
	var gamerHandle;
...
struct<13> GET_LOCAL_GAMER_HANDLE() // Position - 0xA2DB (41691)
{
	var gamerHandle;
...
BOOL func_131(Vehicle veParam0) // Position - 0xA2F0 (41712)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
BOOL func_132(int iParam0, var uParam1) // Position - 0xA311 (41745)
{
	*uParam1 = -1f;
...
void func_133(Vehicle veParam0) // Position - 0xA612 (42514)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_134(Vehicle veParam0) // Position - 0xA644 (42564)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_135(Hash hParam0) // Position - 0xA678 (42616)
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_136(Hash hParam0) // Position - 0xA69B (42651)
{
...
BOOL func_137(Hash hParam0) // Position - 0xB142 (45378)
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_138(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB1D1 (45521)
{
	int num;
	int num2;
	int i;
...
BOOL func_139(Vehicle veParam0, float fParam1) // Position - 0xB8F0 (47344)
{
	float entityCoords;
	var groundZ;
...
Hash func_140(BOOL bParam0) // Position - 0xB961 (47457)
{
	if (bParam0)
...
BOOL func_141() // Position - 0xB97B (47483)
{
...
BOOL func_142(Player plParam0) // Position - 0xBA0A (47626)
{
	Player player;
...
BOOL func_143(Player plParam0) // Position - 0xBA2E (47662)
{
	Player player;
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0xBA4C (47692)
{
	return IS_BIT_SET(Global_1888737[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_145(int iParam0) // Position - 0xBA64 (47716)
{
	return func_146(&(Global_2672964.f_194), iParam0);
}

BOOL func_146(var uParam0, int iParam1) // Position - 0xBA78 (47736)
{
	int num;
	int num2;
	int num3;
...
int func_147(var uParam0, var uParam1, var uParam2) // Position - 0xBA9B (47771)
{
	int i;
	int modType;
...
BOOL func_148(Vehicle veParam0) // Position - 0xBC74 (48244)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_149(var uParam0) // Position - 0xBD4E (48462)
{
...
int func_150(Vehicle veParam0, int iParam1) // Position - 0xBDA5 (48549)
{
	int value;
	int value2;
	float num;
...
int func_151(Vehicle veParam0, int iParam1) // Position - 0xBE8E (48782)
{
	int i;
...
BOOL func_152(Hash hParam0) // Position - 0xBEF0 (48880)
{
...
BOOL func_153(Hash hParam0, int iParam1) // Position - 0xBF1B (48923)
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_154(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xC3DF (50143)
{
...
BOOL func_155() // Position - 0xC403 (50179)
{
	return false;
}

void func_156(Vehicle veParam0, int iParam1) // Position - 0xC40C (50188)
{
	int vehicleMod;
...
BOOL func_157(int iParam0) // Position - 0xC484 (50308)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_158() // Position - 0xC4A4 (50340)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_159(Vehicle veParam0) // Position - 0xC4B5 (50357)
{
	int _int;
...
int func_160(var uParam0) // Position - 0xC4FA (50426)
{
...
BOOL func_161(int iParam0) // Position - 0xC51A (50458)
{
	switch (iParam0)
	{
		case 161:
...
int func_162(int iParam0) // Position - 0xC56D (50541)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_163(Vehicle veParam0) // Position - 0xC61D (50717)
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xC6A4 (50852)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xC6F1 (50929)
{
...
void func_166(var uParam0) // Position - 0xC712 (50962)
{
...
void func_167(var uParam0) // Position - 0xC760 (51040)
{
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() || !STREAMING::IS_NEW_LOAD_SCENE_LOADED())
		if (!func_14(&(uParam0->f_18), Global_262145.f_30230, false))
			return;
	else
		STREAMING::NEW_LOAD_SCENE_STOP();
...
Vector3 func_168(float fParam0, var uParam1, var uParam2) // Position - 0xC81A (51226)
{
	return -BUILTIN::SIN(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::COS(fParam0.f_2) * BUILTIN::COS(fParam0), BUILTIN::SIN(fParam0);
}

BOOL func_169(var uParam0) // Position - 0xC847 (51271)
{
	Player player;
	...
	else
	{
		...
		func_170(uParam0->f_23, &Global_1879406[player /*55*/], false, -1);
	}
...
void func_170(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xC91F (51487)
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_171(Ped pedParam0, int iParam1, int iParam2) // Position - 0xCA88 (51848)
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_172(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xDD5F (56671)
{
	Hash entityModel;
	int num;
...
BOOL func_173(int iParam0, int iParam1) // Position - 0xE585 (58757)
{
	int num;
	int num2;
...
int func_174(int iParam0, int iParam1) // Position - 0xE5C4 (58820)
{
	int num;
	int num2;
...
int func_175() // Position - 0xE60A (58890)
{
	return Global_33282;
}

int func_176(int iParam0) // Position - 0xE615 (58901)
{
	int num;
	int num2;
...
char* func_177(int iParam0) // Position - 0xE9B6 (59830)
{
	switch (iParam0)
	{
		case 0:
...
int func_178(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xEFF3 (61427)
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_179(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x10026 (65574)
{
	Hash entityModel;
	int num;
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(20000) * Global_262145.f_2825), 0);
					break;
			
				case 1:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1400) * Global_262145.f_2826), 2);
					break;
			
				case 2:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(9750) * Global_262145.f_2827), 3);
					break;
			
				case 3:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2150) * Global_262145.f_2828), 0);
					break;
			
				case 4:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2829), 0);
					break;
			
				case 54:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12400) * Global_262145.f_2830), 1);
					break;
			
				case 5:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3500) * Global_262145.f_2831), 0);
					break;
			
				case 6:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4950) * Global_262145.f_2832), 2);
					break;
			
				case 55:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1350) * Global_262145.f_2833), 1);
					break;
			
				case 7:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1450) * Global_262145.f_2834), 0);
					break;
			
				case 8:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2700) * Global_262145.f_2835), 7);
					break;
			
				case 9:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1200) * Global_262145.f_2836), 0);
					break;
			
				case 10:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1500) * Global_262145.f_2837), 0);
					break;
			
				case 11:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2650) * Global_262145.f_2838), 0);
					break;
			
				case 56:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1900) * Global_262145.f_2839), 1);
					break;
			
				case 12:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4950) * Global_262145.f_2840), 2);
					break;
			
				case 57:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2400) * Global_262145.f_2841), 1);
					break;
			
				case 58:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2842), 1);
					break;
			
				case 59:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7400) * Global_262145.f_2843), 1);
					break;
			
				case 60:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2844), 1);
					break;
			
				case 17:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2400) * Global_262145.f_2849), 2);
					break;
			
				case 18:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2850), 2);
					break;
			
				case 19:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3600) * Global_262145.f_2851), 2);
					break;
			
				case 20:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2852), 3);
					break;
			
				case 21:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12500) * Global_262145.f_2853), 3);
					break;
			
				case 22:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2854), 3);
					break;
			
				case 23:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2855), 3);
					break;
			
				case 24:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2856), 3);
					break;
			
				case 25:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3750) * Global_262145.f_2857), 2);
					break;
			
				case 26:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3750) * Global_262145.f_2858), 3);
					break;
			
				case 27:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4800) * Global_262145.f_2859), 3);
					break;
			
				case 28:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3500) * Global_262145.f_2860), 3);
					break;
			
				case 61:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12350) * Global_262145.f_2861), 1);
					break;
			
				case 62:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1900) * Global_262145.f_2862), 1);
					break;
			
				case 63:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4500) * Global_262145.f_2863), 1);
					break;
			
				case 64:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12250) * Global_262145.f_2864), 1);
					break;
			
				case 65:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12300) * Global_262145.f_2865), 1);
					break;
			
				case 29:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2500) * Global_262145.f_2866), 0);
					break;
			
				case 30:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2867), 0);
					break;
			
				case 31:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2868), 0);
					break;
			
				case 66:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2869), 1);
					break;
			
				case 32:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2870), 2);
					break;
			
				case 33:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7300) * Global_262145.f_2871), 3);
					break;
			
				case 34:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7250) * Global_262145.f_2872), 2);
					break;
			
				case 35:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(11900) * Global_262145.f_2873), 0);
					break;
			
				case 36:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2750) * Global_262145.f_2874), 0);
					break;
			
				case 37:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1750) * Global_262145.f_2875), 0);
					break;
			
				case 38:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7300) * Global_262145.f_2876), 3);
					break;
			
				case 39:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(3250) * Global_262145.f_2877), 2);
					break;
			
				case 40:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1000) * Global_262145.f_2878), 0);
					break;
			
				case 67:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2879), 1);
					break;
			
				case 41:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2880), 2);
					break;
			
				case 68:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2881), 1);
					break;
			
				case 42:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5050) * Global_262145.f_2882), 0);
					break;
			
				case 43:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2450) * Global_262145.f_2883), 2);
					break;
			
				case 44:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(4950) * Global_262145.f_2884), 0);
					break;
			
				case 45:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5100) * Global_262145.f_2885), 0);
					break;
			
				case 46:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(12250) * Global_262145.f_2886), 0);
					break;
			
				case 47:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(1150) * Global_262145.f_2887), 3);
					break;
			
				case 48:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2888), 3);
					break;
			
				case 49:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7600) * Global_262145.f_2889), 3);
					break;
			
				case 50:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2600) * Global_262145.f_2890), 2);
					break;
			
				case 51:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2500) * Global_262145.f_2891), 3);
					break;
			
				case 52:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7450) * Global_262145.f_2892), 3);
					break;
			
				case 53:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(7500) * Global_262145.f_2893), 0);
					break;
			
				case 69:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2894), 1);
					break;
			
				case 70:
					func_187(sParam0, iParam1, pedParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(2500) * Global_262145.f_2895), 2);
					break;
			}
			...
			if (entityModel == joaat("MP_M_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_187(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_187(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_187(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
					...
					case 13:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_A", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2845), 0);
						break;
				
					case 14:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_187(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2848), 0);
						break;
				
					case 71:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_E", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				
					case 72:
						func_187(sParam0, iParam1, pedParam3, "TAT_FMM_CLB" /*Crew Emblem Back*/, "multiplayer_overlays", "000_F", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			else if (entityModel == joaat("MP_F_Freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_187(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2896), 0);
						break;
				
					case 88:
						func_187(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2897), 0);
						break;
				
					case 89:
						func_187(sParam0, iParam1, pedParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(100) * Global_262145.f_2898), 0);
						break;
					...
					case 14:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_100" /*Crew Emblem Small*/, "multiplayer_overlays", "000_B", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(5000) * Global_262145.f_2846), 0);
						break;
				
					case 15:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_C", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2847), 2);
						break;
				
					case 16:
						func_187(sParam0, iParam1, pedParam3, "TAT_FM_101" /*Crew Emblem Large*/, "multiplayer_overlays", "000_D", "crewLogo", iParam2, BUILTIN::ROUND(BUILTIN::TO_FLOAT(10000) * Global_262145.f_2848), 0);
						break;
				}
			}
			break;
...
void func_180(char* sParam0, int iParam1, int iParam2, int iParam3) // Position - 0x12F92 (77714)
{
	int decorationIndex;
	int numTattooShopDlcItems;
	Hash outComponent;
...
BOOL func_181() // Position - 0x13024 (77860)
{
...
int func_182() // Position - 0x1304B (77899)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_183() // Position - 0x13101 (78081)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x1323A (78394)
{
	int profileSetting;
...
int func_185() // Position - 0x132F2 (78578)
{
	return 1;
}

int func_186() // Position - 0x132FB (78587)
{
	return 1;
}

void func_187(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x13304 (78596)
{
	var unk;
...
BOOL func_188(Ped pedParam0, int iParam1) // Position - 0x135B9 (79289)
{
...
Hash func_189(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13879 (79993)
{
	var outProp;
	int componentId;
	int num;
	...
	else
	{
		...
		if (hParam0 == Global_79677.f_26[iParam2] && iParam1 == Global_79677[iParam2] && Global_79677.f_13[iParam2] != 0)
			return Global_79677.f_13[iParam2];
	
		num2 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_191(iParam2));
...
int func_190(Hash hParam0, int iParam1) // Position - 0x13993 (80275)
{
	switch (hParam0)
	{
...
ePedComponentType func_191(int iParam0) // Position - 0x13D3A (81210)
{
	switch (iParam0)
	{
		case 0:
...
int func_192(Hash hParam0) // Position - 0x13DEA (81386)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_193(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13E4B (81483)
{
	int i;
	int j;
...
int func_194(Ped pedParam0, int iParam1) // Position - 0x13EEC (81644)
{
...
int func_195(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13F4C (81740)
{
	ePedComponentType componentId;
...
int func_196(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13FA3 (81827)
{
	int pedPropIndex;
...
int func_197(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x13FEA (81898)
{
	Hash entityModel;
...
int func_198(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x140E8 (82152)
{
	Hash entityModel;
...
int func_199(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14226 (82470)
{
	var outfit;
	int i;
	int num;
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_191(iParam2));
...
int func_200(Hash hParam0) // Position - 0x142E1 (82657)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_201(ePedComponentType epctParam0) // Position - 0x14340 (82752)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_202(Ped pedParam0, int iParam1, int iParam2) // Position - 0x143C6 (82886)
{
	Hash entityModel;
	int num;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79527[1 /*14*/] = { func_218(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
			...
			if (unk[num2] != -99)
			{
				if (!func_202(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_202(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79527[2 /*14*/] = { func_218(entityModel, 14, j, -1) };
								
									if (Global_79527[2 /*14*/].f_12 == i)
									{
										if (func_202(pedParam0, 14, j))
										{
											if (!func_206(entityModel, iParam2, 14, j, &unk, &Global_79527[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79527[2 /*14*/] = { func_218(entityModel, num2, num, -1) };
					
						if (!func_206(entityModel, iParam2, num2, num, &unk, &Global_79527[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
		...
		{
			if (func_88(1759, Global_79524) != unk[10])
			{
				Global_2883588 = hash;
				Global_2883589 = hash2;
				return false;
	...
	{
		if (PED::GET_PED_PROP_INDEX(pedParam0, Global_79527[1 /*14*/].f_12, 1) == Global_79527[1 /*14*/].f_3 && PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, Global_79527[1 /*14*/].f_12) == Global_79527[1 /*14*/].f_4 || Global_79527[1 /*14*/].f_3 == -1)
			return true;
	
		if (Global_79527[1 /*14*/].f_12 == PV_COMP_HEAD && IS_BIT_SET(Global_79527[1 /*14*/].f_6, 6) && EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HELMET"), 1) && EXTRAMETADATA::GET_SHOP_PED_APPAREL_VARIANT_PROP_COUNT(Global_2883588) > 0)
		{
			...
			for (m = 0; m < shopPedApparelVariantPropCount; m = m + 1)
			{
				...
				if (nameHash != 0 && nameHash != joaat("0"))
				{
					...
					if (outProp.f_3 == PED::GET_PED_PROP_INDEX(pedParam0, Global_79527[1 /*14*/].f_12, 1) && outProp.f_4 == PED::GET_PED_PROP_TEXTURE_INDEX(pedParam0, Global_79527[1 /*14*/].f_12))
						return true;
				}
			}
		}
	...
	{
		if (Global_79527[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_191(iParam1)) && Global_79527[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_191(iParam1)))
			return true;
...
BOOL func_203(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x14821 (84001)
{
	Hash componentHash;
...
BOOL func_204(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0x148CA (84170)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_205(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14972 (84338)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x149C5 (84421)
{
	var unk;
	int i;
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x14FC9 (85961)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_208(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15246 (86598)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1566B (87659)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_210(Hash hParam0, int iParam1, int iParam2) // Position - 0x1595E (88414)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_211(Hash hParam0, int iParam1) // Position - 0x159F7 (88567)
{
	int i;
	var unk;
...
void func_212(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16326 (90918)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_213(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x16450 (91216)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_214(Hash hParam0, int iParam1) // Position - 0x16498 (91288)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_217(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[0], Global_114344.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_217(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[1], Global_114344.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_217(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[2], Global_114344.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x182E1 (99041)
{
	int num;
	Hash outfit;
...
int func_216(int iParam0) // Position - 0x184CB (99531)
{
	switch (iParam0)
	{
		case 0:
...
void func_217(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1857B (99707)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_218(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x185EC (99820)
{
	func_264();
...
void func_219(int iParam0, int iParam1, Hash hParam2) // Position - 0x1862D (99885)
{
	switch (iParam0)
	{
		case 2:
...
void func_220(int iParam0) // Position - 0x18739 (100153)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_221(&Global_79527[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_221(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x188F4 (100596)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_88(func_224(iParam1, iParam0->f_2), Global_79524);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_88(func_223(iParam1, iParam0->f_2), Global_79524);
...
BOOL func_222(int iParam0, int iParam1, var uParam2) // Position - 0x18C96 (101526)
{
	*uParam2 = 979;
...
int func_223(int iParam0, int iParam1) // Position - 0x1909B (102555)
{
	switch (iParam1)
	{
		case 0:
...
int func_224(int iParam0, int iParam1) // Position - 0x19496 (103574)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x19891 (104593)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_226(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A734 (108340)
{
	int num;
	int num2;
	int num3;
...
BOOL func_227(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A772 (108402)
{
...
BOOL func_228(int iParam0) // Position - 0x1D3D4 (119764)
{
	return Global_44375 == iParam0;
}

int func_229(int iParam0) // Position - 0x1D3E2 (119778)
{
	switch (iParam0)
	{
		case -1:
...
void func_230(int iParam0, Hash hParam1) // Position - 0x1D4B6 (119990)
{
	int num;
...
void func_231(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D4D6 (120022)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_221(&Global_79527[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_221(&Global_79527[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_221(&Global_79527[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79725)
		{
			...
			func_221(&Global_79527[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_191(iParam0));
...
void func_232(int iParam0, Hash hParam1) // Position - 0x1D75D (120669)
{
	BOOL flag;
	int num;
	var unk;
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1D860 (120928)
{
	BOOL flag;
	int num;
	var unk;
...
void func_234(int iParam0, Hash hParam1) // Position - 0x1DB3F (121663)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 == 1)
	{
		...
		if (num7 >= 0 && num7 < 121)
		{
			...
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_2039[num7] * Global_298977.f_20);
		}
	}
	else if (num6 == 2)
	{
		...
		if (num8 >= 0 && num8 < 24)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_2160[num8] * Global_298977.f_21);
	}
	else if (num6 == 3)
	{
		num9 = iParam0 - 155;
		...
		if (num9 >= 0 && num9 < 128)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_2185[num9] * Global_298977.f_44);
	}
	else if (num6 == 4)
	{
		num10 = iParam0 - 319;
		...
		if (num10 >= 0 && num10 < 10)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_2314[num10] * Global_298977.f_22);
	}
	...
	if (iParam0 >= 327)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			if (EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HAT"), 1))
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_20);
			else if (EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("GLASSES"), 1))
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_44);
			else if (EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("WATCH"), 1))
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_22);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}

	return;
}

void func_235(int iParam0, Hash hParam1) // Position - 0x20916 (133398)
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x20A1B (133659)
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			...
			if (Global_79527[0 /*14*/].f_7 > 0)
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_46);
		
			return;
	}

	value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_298977.f_46);
...
void func_237(int iParam0, Hash hParam1) // Position - 0x211F7 (135671)
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			...
			if (Global_79527[0 /*14*/].f_7 > 0)
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_23);
	...
	if (num6 >= 0 && num6 < 26)
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_2012[num6] * Global_298977.f_23);

	func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	return;
}

void func_238(int iParam0, Hash hParam1) // Position - 0x214DC (136412)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 >= 0 && num6 < 256)
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_1755[num6] * Global_298977.f_19);
	...
	if (iParam0 >= 256)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_19);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
...
void func_239(int iParam0, Hash hParam1) // Position - 0x22B03 (142083)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 >= 0 && num6 < 256)
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_1241[num6] * Global_298977.f_17);
	...
	if (iParam0 >= 256)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_17);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
...
void func_240(int iParam0, Hash hParam1) // Position - 0x24163 (147811)
{
	BOOL flag;
	int num;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x242BE (148158)
{
	BOOL flag;
	int num;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x2453E (148798)
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			...
			if (Global_79527[0 /*14*/].f_7 > 0)
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_18);
	...
	value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_298977.f_18);
	func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	return;
}

BOOL func_243(int iParam0, int iParam1) // Position - 0x258E0 (153824)
{
	int num;
	int num2;
...
int func_244(int iParam0, int iParam1) // Position - 0x2590F (153871)
{
	int num;
...
int func_245(int iParam0) // Position - 0x25927 (153895)
{
	int num;
	int num2;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x25CA2 (154786)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (iParam0 == 4)
	{
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "REW_RS" /*Rockstar V Neck*/, 16);
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(1250) * Global_262145.f_2898 * Global_298977.f_18);
		}
		else
		{
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(40) * Global_262145.f_1498[4] * Global_298977.f_18);
		}
	}
	else if (iParam0 == 7)
	{
		TEXT_LABEL_ASSIGN_STRING(&unk, "REW_LSB" /*Los Santos Belle V Neck*/, 16);
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(450) * Global_262145.f_2897 * Global_298977.f_18);
	}
	else if (iParam0 == 9)
	{
		if (func_243(87, -1))
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "REW_REDSK" /*Red Skull V Neck*/, 16);
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(500) * Global_262145.f_2896 * Global_298977.f_18);
		}
		else
		{
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(40) * Global_262145.f_1498[9] * Global_298977.f_18);
		}
	}
	else
	{
		...
		if (num6 >= 0 && num6 < 256)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_1498[num6] * Global_298977.f_18);
	}
...
void func_247(int iParam0, Hash hParam1) // Position - 0x27407 (160775)
{
	BOOL flag;
	int value;
	var unk;
...
void func_248(int iParam0, int iParam1, Hash hParam2) // Position - 0x282D9 (164569)
{
	switch (iParam0)
	{
		case 2:
...
void func_249(int iParam0) // Position - 0x283E5 (164837)
{
	BOOL flag;
	int num;
	var unk;
...
void func_250(int iParam0, Hash hParam1) // Position - 0x285AF (165295)
{
	int num;
...
void func_251(int iParam0, Hash hParam1) // Position - 0x285CF (165327)
{
	BOOL flag;
	int num;
	var unk;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x286D2 (165586)
{
	BOOL flag;
	int num;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x28983 (166275)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 == 1)
	{
		...
		if (num7 >= 0 && num7 < 121)
		{
			...
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_950[num7] * Global_298977.f_12);
		}
	}
	else if (num6 == 2)
	{
		...
		if (num8 >= 0 && num8 < 24)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_1071[num8] * Global_298977.f_13);
	}
	else if (num6 == 3)
	{
		num9 = iParam0 - 155;
		...
		if (num9 >= 0 && num9 < 128)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_1096[num9] * Global_298977.f_14);
	}
	else if (num6 == 4)
	{
		num10 = iParam0 - 319;
		...
		if (num10 >= 0 && num10 < 15)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_1225[num10] * Global_298977.f_15);
	}
	...
	if (iParam0 >= 327)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			if (EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("HAT"), 1))
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_12);
			else if (EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("GLASSES"), 1))
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_14);
			else if (EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Global_2883588, joaat("WATCH"), 1))
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_15);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
...
void func_254(int iParam0, Hash hParam1) // Position - 0x2B742 (177986)
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2B863 (178275)
{
	BOOL flag;
	int value;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			...
			if (Global_79527[0 /*14*/].f_7 > 0)
				Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_45);
		
			return;
	}

	value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_298977.f_45);
...
void func_256(int iParam0, Hash hParam1) // Position - 0x2C15C (180572)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 >= 0 && num6 < 26)
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_923[num6] * Global_298977.f_16);

	func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	return;
}

void func_257(int iParam0, Hash hParam1) // Position - 0x2C413 (181267)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 >= 0 && num6 < 256)
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_666[num6] * Global_298977.f_11);
	...
	if (iParam0 >= 256)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_11);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2DA50 (186960)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (num6 >= 0 && num6 < 256)
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_171[num6] * Global_298977.f_9);
	...
	if (iParam0 >= 256)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_9);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2F083 (192643)
{
	BOOL flag;
	int num;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2F1DA (192986)
{
	BOOL flag;
	int num;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2F4F6 (193782)
{
	BOOL flag;
	int value;
	var unk;
	...
	value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_298977.f_10);
	...
	if (iParam0 >= 241)
	{
		...
		if (Global_79527[0 /*14*/].f_7 > 0)
			Global_79527[0 /*14*/].f_7 = BUILTIN::ROUND(BUILTIN::TO_FLOAT(Global_79527[0 /*14*/].f_7) * Global_298977.f_10);
	}
	else
	{
		func_221(&Global_79527[0 /*14*/], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
...
void func_262(int iParam0, Hash hParam1) // Position - 0x319E7 (203239)
{
	BOOL flag;
	int value;
	var unk;
	...
	if (iParam0 == 23)
	{
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "REW_RS" /*Rockstar V Neck*/, 16);
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(1250) * Global_262145.f_2898 * Global_298977.f_10);
		}
		else
		{
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(45) * Global_262145.f_428[23] * Global_298977.f_10);
		}
	}
	else if (iParam0 == 17)
	{
		TEXT_LABEL_ASSIGN_STRING(&unk, "REW_LSB" /*Los Santos Belle V Neck*/, 16);
		value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(450) * Global_262145.f_2897 * Global_298977.f_10);
	}
	else if (iParam0 == 28)
	{
		if (func_243(87, -1))
		{
			TEXT_LABEL_ASSIGN_STRING(&unk, "REW_REDSK" /*Red Skull V Neck*/, 16);
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(500) * Global_262145.f_2896 * Global_298977.f_10);
		}
		else
		{
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(55) * Global_262145.f_428[28] * Global_298977.f_10);
		}
	}
	else
	{
		...
		if (num6 >= 0 && num6 < 237)
			value = BUILTIN::ROUND(BUILTIN::TO_FLOAT(value) * Global_262145.f_428[num6] * Global_298977.f_10);
	}
...
void func_263(int iParam0, Hash hParam1) // Position - 0x32F72 (208754)
{
	BOOL flag;
	int value;
	var unk;
...
void func_264() // Position - 0x33E2C (212524)
{
...
BOOL func_265(Ped pedParam0) // Position - 0x33EA5 (212645)
{
	int num;

	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
	{
		num = Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_97.f_28;
...
int func_266(int iParam0) // Position - 0x33F21 (212769)
{
	if (func_267(true))
...
BOOL func_267(BOOL bParam0) // Position - 0x33F58 (212824)
{
...
BOOL func_268(int iParam0) // Position - 0x33F8C (212876)
{
	return iParam0 == 87;
}

BOOL func_269() // Position - 0x33F99 (212889)
{
	return func_270(*Global_4718592.f_131616);
}

int func_270(int iParam0) // Position - 0x33FAF (212911)
{
	int i;
...
BOOL func_271(BOOL bParam0) // Position - 0x33FE9 (212969)
{
	if (bParam0)
		return IS_BIT_SET(*Global_4718592.f_183571, 12) && func_272();

	return IS_BIT_SET(*Global_4718592.f_183571, 12);
}

BOOL func_272() // Position - 0x34020 (213024)
{
...
BOOL func_273(Ped pedParam0, BOOL bParam1) // Position - 0x3404E (213070)
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_114(PLAYER::PLAYER_ID(), true) && Global_1888737[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
int func_274(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x34888 (215176)
{
	Hash componentHash;
...
int func_275(int iParam0, Hash hParam1) // Position - 0x350A8 (217256)
{
...
int func_276(Ped pedParam0) // Position - 0x350CA (217290)
{
...
Player func_277() // Position - 0x3512D (217389)
{
	Player player;
...
Player _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x3514B (217419)
{
	return Global_1888737[PLAYER::PLAYER_ID() /*611*/].f_10;
}

BOOL func_279(BOOL bParam0) // Position - 0x35160 (217440)
{
	return func_280(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_280(Player plParam0, BOOL bParam1) // Position - 0x35172 (217458)
{
	if (!func_11(plParam0))
		return false;
	...
	return func_11(Global_1888737[plParam0 /*611*/].f_10);
}

BOOL func_281(Player plParam0) // Position - 0x351AA (217514)
{
	if (func_11(plParam0))
		if (func_11(Global_1888737[plParam0 /*611*/].f_10))
...
Ped func_282() // Position - 0x351DF (217567)
{
	Ped playerPed;
...
BOOL func_283(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35201 (217601)
{
	if (Global_2658016[plParam0 /*467*/].f_235 == 99)
		if (bParam2 && Global_2658016[plParam0 /*467*/].f_238 == 0 || bParam2 == false)
			return false;

	if (bParam1)
		if (Global_2658016[plParam0 /*467*/].f_235 == 13)
			return false;

	return true;
}

int func_284(var uParam0) // Position - 0x35258 (217688)
{
	return *uParam0;
}

void func_285() // Position - 0x35263 (217699)
{
...
void func_286(int iParam0) // Position - 0x352AE (217774)
{
	if (func_46())
		return;
...
void func_287(BOOL bParam0) // Position - 0x352E1 (217825)
{
	if (bParam0)
		func_289();
...
void func_288(int iParam0, int iParam1) // Position - 0x35332 (217906)
{
...
void func_289() // Position - 0x35368 (217960)
{
	Global_2740054.f_4671 = 0;
	return;
}

BOOL func_290() // Position - 0x35378 (217976)
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x3538C (217996)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x35410 (218128)
{
	switch (func_92())
	{
		case 0:
...
Hash func_293() // Position - 0x35443 (218179)
{
...
BOOL func_294() // Position - 0x35467 (218215)
{
	return Global_2684745.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x35476 (218230)
{
...
BOOL func_296() // Position - 0x3548D (218253)
{
	return Global_2696538;
}

BOOL func_297() // Position - 0x35499 (218265)
{
	return Global_2684745.f_695;
}

void func_298() // Position - 0x354A8 (218280)
{
	BUILTIN::WAIT(0);
	return;
}

void func_299(var uParam0) // Position - 0x354B5 (218293)
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_302(&uLocal_120, joaat("nimbus"), "Plane_1");
	func_55(&uLocal_120, 1);
	func_300(&uLocal_120, -2392.8381f, -2427.6187f, 43.1663f, -1.9378f, -0.4041f, -53.486f, "HS4_LSA_LAND_NIMB", 1, 1, uParam0->f_4, 0);
	return;
}

void func_300(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x35509 (218377)
{
...
void func_301(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x35539 (218425)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_302(var uParam0, int iParam1, char* sParam2) // Position - 0x35566 (218470)
{
