...
{
	if (IS_BIT_SET(Global_114904.f_24993, 3))
		return "BB4_loiter";
	else if (IS_BIT_SET(Global_114904.f_24993, 2))
		return "BB3_loiter";
	else if (IS_BIT_SET(Global_114904.f_24993, 1))
		return "BB2_loiter";
	else if (IS_BIT_SET(Global_114904.f_24993, 0))
		return "BB1_loiter";
