...
{
	if (IS_BIT_SET(Global_114963.f_24995, 3))
		return "BB4_loiter";
	else if (IS_BIT_SET(Global_114963.f_24995, 2))
		return "BB3_loiter";
	else if (IS_BIT_SET(Global_114963.f_24995, 1))
		return "BB2_loiter";
	else if (IS_BIT_SET(Global_114963.f_24995, 0))
		return "BB1_loiter";
