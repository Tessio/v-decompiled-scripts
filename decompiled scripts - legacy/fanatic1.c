...
void func_2(eCharacter echParam0, BOOL bParam1) // Position - 0x522 (1314)
{
	...
	Global_114904.f_2370.f_539.f_2332[echParam0] = bParam1;
	return;
}
...
void func_31() // Position - 0xF43 (3907)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_3(character) && !func_35(14) || Global_113852)
			{
				if (Global_114904.f_2370.f_539.f_4321 != character && func_3(Global_114904.f_2370.f_539.f_4321))
...
void func_71(int iParam0, BOOL bParam1) // Position - 0x2B67 (11111)
{
	...
	{
		func_236(&(Global_113991[num /*10*/].f_9));
	}
...
void func_74() // Position - 0x2DCC (11724)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114904.f_10201.f_3853))
		func_76(13, BUILTIN::FLOOR(Global_114904.f_10201.f_3853));
...
BOOL func_99(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x3DB7 (15799)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_152(entityModel, epctParam1, epctParam2, -1) };
	...
	else
	{
		...
		Global_80063[1 /*14*/] = { func_152(entityModel, epctParam1, unk28[epctParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_144(epctParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_144(epctParam1), Global_80063[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_144(epctParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, 0);
	}
...
BOOL func_100(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x3F74 (16244)
{
	...
	{
		if (!func_216(pedParam0, Global_114904.f_2370.f_539[num /*65*/].f_64, Global_114904.f_2370.f_539[num /*65*/].f_63))
		{
...
int func_102(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4051 (16465)
{
	...
	if (iParam5 == 0)
	{
		Global_80063[1 /*14*/] = { func_152(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_80063[1 /*14*/] = { func_152(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_80063[1 /*14*/] = { func_152(entityModel, 14, unk18[j], -1) };
							func_118(pedParam0, Global_80063[1 /*14*/].f_12, Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4);
							func_134(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_144(i), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_144(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_144(i), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, iParam4);
			...
			{
				Global_80063[1 /*14*/] = { func_152(entityModel, i, func_108(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_80063[1 /*14*/] = { func_152(entityModel, 14, unk59[j], -1) };
			func_118(pedParam0, Global_80063[1 /*14*/].f_12, Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4);
			func_134(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_144(iParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_144(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_144(iParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, iParam4);
...
{
	Global_80063[1 /*14*/] = { func_152(hParam0, iParam1, epctParam2, -1) };
...
void func_134(int iParam0) // Position - 0x819A (33178)
{
	if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_80063[1 /*14*/].f_6, 6))
		func_141(iParam0, Global_80063[1 /*14*/].f_5, Global_80063[1 /*14*/].f_2, 2, Global_80063[1 /*14*/].f_1, 1, 0);
...
BOOL func_143(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xBEBA (48826)
{
	...
	{
		if (!func_216(pedParam0, Global_114904.f_2370.f_539[num /*65*/].f_61, Global_114904.f_2370.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (epctParam1)
			{
				...
				case 5:
					func_151(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (epctParam1)
			{
				...
				case 2:
					func_151(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (epctParam1)
			{
				...
				case 4:
					func_151(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_154(int iParam0) // Position - 0xED4C (60748)
{
	...
	func_155(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_139(func_158(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_139(func_157(iParam1, iParam0->f_2), Global_80060);
			...
			{
				num = func_139(num2, Global_80060);
...
void func_161(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x11074 (69748)
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_155(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_155(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_155(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_155(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_216(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x225F9 (140793)
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_216(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_216(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_80063[2 /*14*/] = { func_152(entityModel, 14, k, -1) };
								
									if (Global_80063[2 /*14*/].f_12 == j)
										if (func_216(pedParam0, 14, k))
											if (!func_106(entityModel, epctParam2, 14, k, &unk, &Global_80063[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_152(entityModel, i, type, -1) };
					
						if (!func_106(entityModel, epctParam2, i, type, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_144(epctParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_144(epctParam1)))
	{
		return true;
	}
...
void func_223(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x22E55 (142933)
{
	...
	if (iParam0 != -1)
	{
		...
		func_224(&unk33, unk.f_3, Global_102466, bParam1, bParam2);
	}
...
void func_225(int iParam0, var uParam1) // Position - 0x22ED9 (143065)
{
	switch (iParam0)
	{
		...
		case 5:
			func_226(uParam1, "Barry3A", func_219(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Las zonas en las que puedes encontrar vehículos con un alijo oculto aparecerán indicadas en el mapa. Recoge estos vehículos para Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
			break;
		...
		case 8:
			func_226(uParam1, "Dreyfuss1", func_219(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*Se ha revelado la identidad y el paradero del asesino.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_227(iParam0), 0, 0);
			break;
		...
		case 38:
			func_226(uParam1, "Nigel1A", func_219(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Se han marcado en el mapa las zonas en las que puedes encontrar objetos de famosos. Róbalos para Nigel y para la señora Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_227(iParam0), 1, 1);
			break;
		...
		case 49:
			func_226(uParam1, "Paparazzo3A", func_219(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Las zonas en las que puedes encontrar oportunidades para sacar fotos a famosos se han marcado en el mapa. Localiza y fotografía a estos famosos para Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
			break;
		...
		case 58:
			func_226(uParam1, "Tonya1", func_219(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Puedes encontrarte con extraños y locos por todo San Andreas en ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~.*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
			break;
...
void func_239(int iParam0) // Position - 0x24B54 (150356)
{
	...
	Global_114904.f_18581[iParam0 /*6*/].f_3 = func_240();
	...
	if (offset >= 0 && offset <= 31)
	{
		if (!func_263(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_260(68))
					func_257("DI_HLP_STRY" /*Los personajes de la historia estarán disponibles en el modo director del editor Rockstar a medida que avance la historia de GTA V.*/, 2, 0, 20000, 10000, 7, 0, 208, 0);
			}
		}
	}
...
void START_RUNNING() // Position - 0x2DE6B (188011)
{
	...
	switch (iLocal_155)
	{
		...
		case 1:
			if (!Global_114904.f_18581.f_384)
			{
				if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
					_DISPLAY_HELP_TEXT("FAN_HELP" /*Si corres o montas en bicicleta tu resistencia mejorará.~n~Al aumentar la resistencia podrás esprintar y montar en bicicleta más tiempo.~n~Si esprintas o montas en bicicleta más tiempo del que te permite tu resistencia, tu salud se resentirá.*/, -1);
					Global_114904.f_18581.f_384 = 1;
				}
			}
...
{
	if (!Global_114904.f_18581.f_385)
	{
		if (PLAYER::GET_PLAYER_SPRINT_TIME_REMAINING(PLAYER::PLAYER_ID()) <= 5f)
		{
			if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
				_DISPLAY_HELP_TEXT("AM_H_NOSTAM" /*Te has quedado sin resistencia. Si fuerzas más tu cuerpo, perderás salud.*/, -1);
				Global_114904.f_18581.f_385 = 1;
			}
		}
	}
...
void func_392(ePedComponentType epctParam0, BOOL bParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12, int iParam13, int iParam14, int iParam15) // Position - 0x3018C (197004)
{
	...
	if (num > -1)
	{
		...
		Global_1679103.f_3391.f_172[num] = bParam1;
...
void func_393(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x302E6 (197350)
{
	...
	if (num > -1)
	{
		Global_1679103.f_1 = 1;
		func_390(5, num);
		Global_1679103.f_3749[num] = iParam0;
		...
		Global_1679103.f_3749.f_183[num] = iParam4;
...
void func_394(ePedComponentType epctParam0, BOOL bParam1, const char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24, int iParam25, int iParam26, int iParam27, int iParam28, int iParam29, int iParam30, int iParam31, int iParam32, int iParam33, int iParam34, int iParam35, int iParam36, int iParam37, int iParam38, int iParam39) // Position - 0x303F6 (197622)
{
	...
	if (num > -1)
	{
		...
		Global_1679103.f_1177.f_194[num] = iParam3;
		Global_1679103.f_1177.f_183[num] = iParam4;
	...
	if (Global_80535 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_414(Global_80536, Global_80538, iParam10) };
				y == -0.014f;
...
BOOL func_449(eCharacter echParam0) // Position - 0x3383D (211005)
{
	...
	return Global_114904.f_2370.f_539.f_2332[echParam0];
}
...
int func_477() // Position - 0x343D9 (213977)
{
	...
	num = func_478(&(Global_102429.f_3), false);
	num2 = 0;
...
BOOL func_481() // Position - 0x344AD (214189)
{
	...
	if (Global_102429.f_11 == 5)
		if (func_476(&(Global_102429.f_3)) > -1)
			return true;
