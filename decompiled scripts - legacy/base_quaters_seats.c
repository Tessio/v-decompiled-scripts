...
BOOL func_70() // Position - 0x1802 (6146)
{
	if (Global_1845087 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1845087, true, 0))
			return false;
...
{
	func_74(2, &uLocal_122, 0);
	func_74(3, &uLocal_122, 1);
	func_72(&uLocal_122, 6303);
	return;
}
...
{
	func_82(2, &uLocal_122, 0);
	func_82(3, &uLocal_122, 1);
	return;
}
