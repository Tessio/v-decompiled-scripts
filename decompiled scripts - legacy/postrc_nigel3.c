	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (!func_25())
			{
				...
				if (!IS_BIT_SET(Global_114904.f_18581.f_382, 5))
					MISC::SET_BIT(&(Global_114904.f_18581.f_382), 5);
...
void func_27() // Position - 0xADF (2783)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_28(character) && !func_16(14) || Global_113852)
			{
				if (Global_114904.f_2370.f_539.f_4321 != character && func_28(Global_114904.f_2370.f_539.f_4321))
