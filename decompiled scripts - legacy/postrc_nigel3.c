...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			{
				func_24(101, 1);
				STATS::STAT_SET_BOOL(joaat("SP_KILLED_AL") /* TUNEABLE: SP_KILLED_AL */, true, true);
			
				if (!IS_BIT_SET(Global_114963.f_18583.f_382, 5))
					MISC::SET_BIT(&(Global_114963.f_18583.f_382), 5);
...
void func_1() // Position - 0xF6 (246)
{
	...
	{
		case 0:
			if (MISC::GET_GAME_TIMER() - iLocal_204 > 5000 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_205, PLAYER::PLAYER_PED_ID(), true))
			{
				if (_CONVERSATION_ADD_LINE(&uLocal_39, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(pedLocal_205);
					iLocal_38 = 1;
				}
			}
			else if (MISC::GET_GAME_TIMER() - iLocal_204 > 12000 && BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedLocal_205, true)) <= 900f)
			{
				if (_CONVERSATION_ADD_LINE(&uLocal_39, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
					iLocal_38 = 1;
			}
...
{
	iLocal_204 = MISC::GET_GAME_TIMER();
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_39, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_39, 5, pedLocal_205, "DINAPOLI", 0, 1);
	iLocal_37 = 1;
	return;
}
...
BOOL func_23() // Position - 0xA24 (2596)
{
	...
	if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedLocal_205, true)) >= num * num && !ENTITY::IS_ENTITY_ON_SCREEN(pedLocal_205))
		return false;
...
{
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_205))
		if (!PED::IS_PED_INJURED(pedLocal_205))
			return true;
...
void func_27() // Position - 0xADF (2783)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_28(character) && !func_16(14) || Global_113909)
			{
				if (Global_114963.f_2370.f_539.f_4321 != character && func_28(Global_114963.f_2370.f_539.f_4321))
...
void func_33() // Position - 0xCE7 (3303)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_205))
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_205);
