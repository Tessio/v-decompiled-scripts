...
int func_71(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x6F24 (28452)
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_80063[1 /*14*/] = { func_124(entityModel, iParam1, hParam2, -1) };
...
void func_74(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7811 (30737)
{
	Hash hash;
	int num;
...
BOOL func_75(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x789B (30875)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_76(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7979 (31097)
{
	Global_80063[1 /*14*/] = { func_124(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_80063[1 /*14*/].f_6, 2);
}

BOOL func_77(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x79A1 (31137)
{
	var unk;
	int i;
...
BOOL func_78(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7FA5 (32677)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_80(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x80EB (33003)
{
	Hash i;
	Hash j;
...
int func_82(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x823C (33340)
{
	int num;
...
Hash func_83(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x8543 (34115)
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_84(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x90F6 (37110)
{
	int num;
...
Hash func_85(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x93DA (37850)
{
	int num;
...
Hash func_86(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x96A1 (38561)
{
	Hash i;
	Hash hash;
...
BOOL func_87(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x96D8 (38616)
{
	Hash hash;
...
BOOL func_88(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x9701 (38657)
{
	*uParam2 = -99;
...
int func_89(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x99CB (39371)
{
	int num;
...
Hash func_90(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x9C55 (40021)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_91(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x9DAC (40364)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_92(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, hash, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_92(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x9E46 (40518)
{
	switch (hParam0)
	{
...
Hash func_93(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9F14 (40724)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_96(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0xA436 (42038)
{
	Hash entityModel;
...
struct<10> func_101(Hash hParam0, Hash hParam1) // Position - 0xA810 (43024)
{
	int i;
	var unk;
...
struct<17> func_104(Hash hParam0, Hash hParam1) // Position - 0xB2B1 (45745)
{
	int i;
	var unk;
...
void func_107(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xD394 (54164)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
BOOL func_108(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xD405 (54277)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (hParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, hParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (hParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, hParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (hParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, hParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (hParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_93(hParam0, hParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_109(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xD682 (54914)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_110(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xDAA7 (55975)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_111(Ped pedParam0, ePedComponentType epctParam1) // Position - 0xDD9A (56730)
{
	int pedPropIndex;
...
Hash func_112(Ped pedParam0, int iParam1) // Position - 0xDDE1 (56801)
{
...
struct<14> func_124(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x11C58 (72792)
{
	func_187();
...
BOOL func_188(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x25663 (153187)
{
	Hash entityModel;
	Hash hash;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_188(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_80063[2 /*14*/].f_12 == j)
										if (func_188(pedParam0, 14, k))
											if (!func_77(entityModel, hParam2, 14, k, &unk, &Global_80063[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_124(entityModel, i, hash, -1) };
					
						if (!func_77(entityModel, hParam2, i, hash, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
