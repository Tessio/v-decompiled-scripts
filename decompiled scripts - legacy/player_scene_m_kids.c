...
int func_77(int iParam0, BOOL bParam1) // Position - 0xC2F2 (49906)
{
	Hash statHash;
	int outValue;
...
Hash func_78(int iParam0, BOOL bParam1) // Position - 0xC321 (49953)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_79(bParam1));
}

BOOL func_79(BOOL bParam0) // Position - 0xC336 (49974)
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_80() // Position - 0xC36A (50026)
{
...
BOOL func_83(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xD614 (54804)
{
	BOOL flag;
	int num;
	int num2;
