...
void main() // Position - 0x0 (0)
{
	...
	func_245(3);
	func_234(&(uLocal_44.f_1), func_244(Global_97897[1 /*19*/], Global_97897[2 /*19*/]));
...
void func_62(var uParam0, int iParam1, int iParam2) // Position - 0x2427 (9255)
{
	...
	if (!IS_BIT_SET(Global_97897[iParam1 /*19*/].f_18, iParam2))
	{
		...
		{
			func_24(uParam0, uParam0->f_1.f_276, Global_97897[iParam1 /*19*/].f_7[iParam2 /*2*/], 1);
...
void func_100() // Position - 0x3E21 (15905)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_101(character) && !func_230(14) || Global_113292)
			{
				if (Global_114344.f_2367.f_539.f_4321 != character && func_101(Global_114344.f_2367.f_539.f_4321))
...
void func_108(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4088 (16520)
{
					...
					if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, ecaLocal_35) || PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, ecaLocal_36))
					{
						switch (uParam0->f_464)
						{
							...
							case 4:
								...
								{
									if (Global_114344.f_1.f_12[num2 /*6*/][i] == 0 || func_40(Global_114344.f_1.f_12[num2 /*6*/][i]) != Global_97897[num2 /*19*/].f_1[i])
									{
										flag = false;
...
void func_114(int iParam0, BOOL bParam1) // Position - 0x5901 (22785)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_149() || Global_113391 || Global_33284 || func_148() || func_106(8, -1) || func_147() || func_146() || func_145() || func_144() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_149() || Global_33284 || func_148() || func_106(8, -1) || func_145() || func_147() || func_146() || func_144() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_149() || Global_113391 || Global_33284 || func_148() || func_106(8, -1) || func_145() || func_147() || func_146() || func_144() || Global_114344.f_7692.f_919[character] == 5 || Global_44922 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_149() || Global_113391 || Global_33284 || func_148() || func_106(8, -1) || func_147() || func_146() || func_144() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_149() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_106(8, -1) || func_144() || func_143() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
...
void func_154(int iParam0, BOOL bParam1) // Position - 0x754E (30030)
{
	...
	if (!func_39(10) && IS_BIT_SET(Global_114344.f_24999.f_8[4], 0))
		func_158(9, true);

	if (!func_39(13) && IS_BIT_SET(Global_114344.f_24999.f_8[16], 0))
		func_158(12, true);
...
int func_163(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7C82 (31874)
{
	eCharacter character;
	var unk;
	var unk99;
	...
	{
		character = Global_114344.f_18537[iParam1];
	...
	Global_114344.f_18537[iParam1] = echParam2;
	uParam0->f_2296[iParam1] = func_181();

	if (!func_180(echParam2, &uParam0->f_2300[iParam1 /*3*/], &uParam0->f_2310[iParam1]))
		return 0;

	if (!func_179(uParam0->f_2300[iParam1 /*3*/], 0f, 0f, 0f, false))
	{
		if (!func_179(Global_100332[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_164(int iParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7D9F (32159)
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
	...
	switch (echParam1)
	{
		case CHAR_FRANK_TREV_CONF:
			*uParam2 = { Global_101297[iParam0 /*98*/] };
			...
			{
				if (OBJECT::IS_POINT_IN_ANGLED_AREA(Global_101600[iParam0 /*3*/], -829.7478f, 192.11703f, 76.73248f, -827.13837f, 153.85951f, 59.961723f, 33.25f, false, true))
				{
...
{
	if (Global_101297[iParam0 /*98*/] == PV_COMP_HEAD)
	{
	...
	if (!func_167(Global_101297[iParam0 /*98*/], false, -1))
	{
		func_165(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
BOOL func_168(ePedComponentType epctParam0) // Position - 0xBA66 (47718)
{
	int num;
	var unk;
	var name;
...
BOOL func_171() // Position - 0xBD52 (48466)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_172() // Position - 0xBD68 (48488)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_173() // Position - 0xBD7E (48510)
{
	return false;
}

BOOL func_174() // Position - 0xBD87 (48519)
{
	return true;
}

BOOL func_175() // Position - 0xBD90 (48528)
{
	return true;
}

BOOL func_176() // Position - 0xBD99 (48537)
{
...
BOOL func_178(int iParam0) // Position - 0xBE6A (48746)
{
...
BOOL func_179(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC0EF (49391)
{
	if (bParam6)
...
BOOL func_180(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC136 (49462)
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
var func_181() // Position - 0xCAA5 (51877)
{
	var unk;
...
void func_182(var uParam0, int iParam1) // Position - 0xCAEB (51947)
{
	if (iParam1 <= 0)
		return;
...
void func_183(var uParam0, int iParam1) // Position - 0xCB71 (52081)
{
...
void func_184(var uParam0, int iParam1) // Position - 0xCBA4 (52132)
{
	int num;
	int num2;
...
int func_185(int iParam0, int iParam1) // Position - 0xCBF5 (52213)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_186(int iParam0) // Position - 0xCC97 (52375)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_187(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCCB9 (52409)
{
	if (bParam0)
		return uParam1;
...
int func_188(int iParam0) // Position - 0xCCD0 (52432)
{
	return iParam0 & 15;
}

void func_189(var uParam0, int iParam1) // Position - 0xCCDD (52445)
{
...
void func_190(var uParam0, int iParam1) // Position - 0xCD17 (52503)
{
...
void func_191(var uParam0, int iParam1) // Position - 0xCD52 (52562)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_192(var uParam0, int iParam1) // Position - 0xCD8E (52622)
{
	int i;
	eCharacter character;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_180(Global_114344.f_18537[i], &unk, &num))
			{
...
void func_193(var uParam0) // Position - 0xCF54 (53076)
{
	*uParam0 = -15;
	return;
}

int func_194() // Position - 0xCF62 (53090)
{
	if (func_118(false))
		return 0;
...
void func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCFAD (53165)
{
	if (bParam0)
	{
...
BOOL func_196() // Position - 0xD0FC (53500)
{
	return IS_BIT_SET(Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_36.f_18, 14);
}

BOOL func_197(Player plParam0, int iParam1) // Position - 0xD116 (53526)
{
	BOOL flag;
...
int func_198(int iParam0, BOOL bParam1) // Position - 0xD16F (53615)
{
	int num;
	int num2;
...
int func_199() // Position - 0xD1B0 (53680)
{
	return Global_1574927;
}

BOOL func_200(Player plParam0) // Position - 0xD1BC (53692)
{
	Player player;
...
BOOL func_201(Player plParam0) // Position - 0xD1DE (53726)
{
...
BOOL func_202() // Position - 0xD21D (53789)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_203(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD22B (53803)
{
	int num;
...
void func_204(int iParam0) // Position - 0xD25E (53854)
{
	if (iParam0 == 1)
...
void func_205() // Position - 0xD281 (53889)
{
				...
				switch (iLocal_40)
				{
					case 0:
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_98365.f_9[0]))
						{
							...
							{
								pedLocal_727 = Global_98365.f_9[0];
...
void func_206() // Position - 0xDBA0 (56224)
{
	func_85(1, 0, true);
	func_85(2, 0, true);
	func_214(&uLocal_44);
...
void func_207(var uParam0) // Position - 0xDBC2 (56258)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
...
void func_208(var uParam0) // Position - 0xDC08 (56328)
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC44 (56388)
{
...
int func_210(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xDCDF (56543)
{
	int i;
...
void func_211(var uParam0, int iParam1) // Position - 0xDE16 (56854)
{
	int i;
...
void func_213() // Position - 0xDE87 (56967)
{
	Global_101932 = true;
	return;
}

void func_214(var uParam0) // Position - 0xDE94 (56980)
{
...
BOOL func_215(int iParam0) // Position - 0xDEE3 (57059)
{
	switch (iParam0)
	{
		case 0:
...
int func_216() // Position - 0xDF50 (57168)
{
	return Global_80007;
}

BOOL func_217(var uParam0) // Position - 0xDF5C (57180)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_207(uParam0);
...
void func_218(var uParam0) // Position - 0xDF85 (57221)
{
...
void func_219(var uParam0, float fParam1, float fParam2) // Position - 0xDFEF (57327)
{
	float num;
...
void func_220(var uParam0) // Position - 0xE0C0 (57536)
{
...
void func_221(var uParam0) // Position - 0xE13E (57662)
{
	int i;
...
void func_222(var uParam0) // Position - 0xE198 (57752)
{
	int i;
	Hash modelHash;
	float pitch;
...
Vector3 func_223(var uParam0, var uParam1) // Position - 0xE2CE (58062)
{
	float num;
	float num2;
	float num3;
...
void func_224(var uParam0) // Position - 0xE34C (58188)
{
	int i;
	int num;
	int num2;
...
void func_225(var uParam0) // Position - 0xE429 (58409)
{
	int num;
	int value;
	int i;
...
BOOL func_226(var uParam0) // Position - 0xE569 (58729)
{
...
void func_227(var uParam0) // Position - 0xE604 (58884)
{
	float num;
	float num2;
...
void func_228(var uParam0) // Position - 0xE68D (59021)
{
	int i;
	int num;
	BOOL value;
...
void func_229(var uParam0) // Position - 0xE8CE (59598)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
BOOL func_230(int iParam0) // Position - 0xE8F2 (59634)
{
	return Global_44375 == iParam0;
}

BOOL func_231(eCharacter echParam0) // Position - 0xE900 (59648)
{
	int i;
...
BOOL func_232(int iParam0) // Position - 0xE968 (59752)
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_233(var uParam0, int iParam1) // Position - 0xE995 (59797)
{
	var unk;
	var unk4;
...
void func_234(var uParam0, int iParam1) // Position - 0xEA61 (60001)
{
	func_243(uParam0, 1, "HEIST_JEWELLERY", "BOARD0", "JHFAUD", "CRWAUD", 2, 2, 7, 8, iParam1, 708.99567f, -965.25604f, 31.395329f, 5.5f, 6.25f, 4f);
...
void func_235(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xED07 (60679)
{
	var unk;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED80 (60800)
{
	if (uParam0->f_33 < 20)
	{
...
void func_237(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xEDC4 (60868)
{
	var unk;
...
void func_238(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xEE14 (60948)
{
	if (uParam0->f_117 < 22)
	{
...
void func_239(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0xEE64 (61028)
{
	var unk;
	var unk3;
...
void func_240(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0xEEFE (61182)
{
	var unk;
	var unk5;
	var unk9;
...
void func_241(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0xEFA2 (61346)
{
	uParam0->f_9 = fParam1;
...
void func_243(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF08A (61578)
{
	uParam0->f_1 = iParam1;
...
int func_244(int iParam0, int iParam1) // Position - 0xF0F6 (61686)
{
	if (iParam0 > iParam1)
		return iParam0;
...
int func_245(int iParam0) // Position - 0xF10C (61708)
{
	int num;
	int offset;
...
void func_246() // Position - 0xF163 (61795)
{
