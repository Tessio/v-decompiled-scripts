...
int func_164(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7CB5 (31925)
{
	...
	{
		character = Global_114904.f_18540[iParam1];
	...
	Global_114904.f_18540[iParam1] = echParam2;
	...
	{
		if (!func_180(Global_100868[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_181(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC0EC (49388)
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
int func_199(int iParam0, BOOL bParam1) // Position - 0xD125 (53541)
{
	int num;
	int num2;
