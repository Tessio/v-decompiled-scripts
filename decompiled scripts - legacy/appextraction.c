	...
	while (true)
	{
		...
		if (Global_21649.f_1 != 9)
		{
			switch (Global_21649.f_1)
			{
				...
				case 8:
					if (func_5(FRONTEND_CONTROL, Global_21617, 0))
					{
						func_4();
						Global_21627 = true;
...
void func_7() // Position - 0x1FB (507)
{
	...
	func_9(Global_21630, "DISPLAY_VIEW", 24f, BUILTIN::TO_FLOAT(1), -1082130432, -1082130432, -1082130432);
	return;
}
...
void func_11() // Position - 0x417 (1047)
{
	if (Global_21637)
	{
		func_12(Global_21630, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*LLAMAR*/, 0, 0, 0, 0);
		func_12(Global_21630, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
	}
	else
	{
