#region Local Var
	...
	var uLocal_133 = 0;
	float fLocal_134 = 0f;
	eCharacter echLocal_135 = CHAR_MICHAEL;
	int iLocal_136 = 0;
...
void main() // Position - 0x0 (0)
{
	...
	iLocal_112 = 0;
	func_89(&Global_113609, 0);
	func_87();

	if (func_86(iLocal_111, 1))
		iLocal_117 = 10;
	else
		iLocal_117 = 9;
	...
	if (!func_86(iLocal_111, 8))
		if (!_CAN_ENTER_FREEROAM_STATE(iLocal_117))
			if (func_83(0, iLocal_116))
				func_91(false);
			else
				func_91(true);
	...
	if (func_86(iLocal_111, 8388608))
		func_91(true);

	if (func_86(iLocal_111, 524288) && func_82() && !func_81())
		func_91(true);

	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_86(iLocal_111, 4194304))
	{
		if (iLocal_122 != 263)
		{
			func_80(iLocal_122, true, false);
			iLocal_122 = 263;
		}
	...
	while (true)
	{
		if (!func_86(iLocal_111, 268435456))
		{
			groundZ = 0f;
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_102) && !ENTITY::IS_ENTITY_DEAD(pedLocal_102, false))
		{
			...
			{
				case 0:
					if (_CAN_ENTER_FREEROAM_STATE(iLocal_117) || func_86(iLocal_111, 16) && !func_86(iLocal_111, 524288))
					{
						iLocal_115 = -1;
						func_77();
						func_79(1);
				...
				case 3:
					...
					if (!func_86(iLocal_111, 4))
					{
						func_75();
						func_78(&iLocal_111, 4);
					}
					...
					if (fLocal_127 > fLocal_119 * fLocal_119 && !Global_102520)
					{
						if (iLocal_122 != 263)
						{
							if (func_74(6) && !func_73(iLocal_122))
							{
							}
							else
							{
					...
					{
						uLocal_86 = { uLocal_70 };
						flag3 = !func_86(iLocal_111, 64);
						func_89(&iLocal_111, 128);
					
						if (!func_72(3) && !Global_102520)
						{
							if (func_86(iLocal_111, 2097152))
							{
								if (!func_86(iLocal_111, 1) || !ENTITY::DOES_ENTITY_EXIST(func_71()) && !Global_102520)
								{
									func_79(10);
									break;
								}
						...
						if (!func_61(6) || Global_114010 || func_60())
							flag3 = false;
						...
						if (flag3)
						{
							...
							if (flag3)
							{
								...
								if (func_44(uLocal_103))
								{
									if (iLocal_113 == -1)
									{
										_CONTEXT_ADD_HELP_TEXT(&iLocal_113, 4, sLocal_118, 0, 0, 0, 0);
										func_57(&iLocal_111, 2048);
									}
									else if (!func_86(iLocal_111, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_42(&iLocal_113);
										func_89(&iLocal_111, 2048);
									}
								
									if (func_40(iLocal_113, true))
									{
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&uLocal_86))
					{
						...
						if (num == 1)
						{
							...
							iLocal_69 = BUILTIN::START_NEW_SCRIPT(&uLocal_86, essLocal_114);
							SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&uLocal_86);
							uLocal_70 = { uLocal_86 };
							TEXT_LABEL_ASSIGN_STRING(&uLocal_86, "", 64);
							func_89(&iLocal_111, 4);
							func_25();
							func_57(&iLocal_111, 2);
							func_79(6);
							func_21(&uLocal_124);
				...
				case 6:
					if (!func_86(iLocal_111, 256))
						if (CAM::IS_SCREEN_FADING_OUT() || CAM::IS_SCREEN_FADED_IN())
							PAD::SET_INPUT_EXCLUSIVE(PLAYER_CONTROL, INPUT_CONTEXT);
						else if (CAM::IS_SCREEN_FADED_OUT())
							func_57(&iLocal_111, 256);
				
					if (func_86(Global_113609, 262144))
					{
						func_89(&Global_113609, 262144);
						func_15();
					}
				
					if (func_86(iLocal_111, 2097152))
						if (!func_72(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
							func_79(10);
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
					{
						...
						func_10(&uLocal_124);
						func_89(&iLocal_111, 256);
						func_7();
					
						if (flag)
						{
							func_89(&iLocal_111, 2);
						}
						else if (func_86(iLocal_111, 2))
						{
							if (func_86(Global_113609, 0))
							{
								func_6(&iLocal_115);
								iLocal_115 = -1;
								func_89(&iLocal_111, 2);
						...
						if (func_86(iLocal_111, 16777216))
							func_91(true);
				...
				case 7:
					...
					if (iLocal_122 != 263)
						func_80(iLocal_122, false, false);
					...
					if (iLocal_121 % 150 == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_123 == 2)
							{
								if (iLocal_123 == 2)
								{
									if (_CAN_ENTER_FREEROAM_STATE(iLocal_117) && func_83(0, iLocal_116))
									{
										func_87();
...
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(obLocal_137.f_1);

	if (ENTITY::DOES_ENTITY_EXIST(obLocal_137))
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&obLocal_137);
...
void func_46() // Position - 0x1690 (5776)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_47(character) && !func_74(14) || Global_113909)
			{
				if (Global_114963.f_2370.f_539.f_4321 != character && func_47(Global_114963.f_2370.f_539.f_4321))
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_68() || Global_114010 || Global_33818 || func_67() || func_53(8, -1) || func_66() || func_65() || func_64() || func_55() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_68() || Global_33818 || func_67() || func_53(8, -1) || func_64() || func_66() || func_65() || func_55() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_68() || Global_114010 || Global_33818 || func_67() || func_53(8, -1) || func_64() || func_66() || func_65() || func_55() || Global_114963.f_7697.f_919[character] == 5 || Global_45468 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_68() || Global_114010 || Global_33818 || func_67() || func_53(8, -1) || func_66() || func_65() || func_55() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_68() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_53(8, -1) || func_55() || func_63() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_68() || Global_33818 || func_67() || func_53(8, -1) || func_65() || func_64() || func_55() || Global_114963.f_7697.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_68() || func_65() || Global_114010 || Global_33818 || func_67() || Global_46147 || func_53(8, -1) || func_64() || func_63() || func_55() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_68() || Global_114010 || Global_33818 || func_67() || func_53(8, -1) || func_64() || func_63() || func_66() || func_65() || func_55())
							return false;
						break;
				}
			}
...
void func_75() // Position - 0x22EE (8942)
{
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_137))
	{
		obLocal_137 = OBJECT::CREATE_OBJECT(obLocal_137.f_1, obLocal_137.f_2, true, true, false);
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(obLocal_137, obLocal_137.f_2, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(obLocal_137, obLocal_137.f_5, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(obLocal_137, true);
	}
...
{
	if (!STREAMING::IS_MODEL_VALID(obLocal_137.f_1))
		return false;

	return STREAMING::HAS_MODEL_LOADED(obLocal_137.f_1);
}
...
void func_77() // Position - 0x2357 (9047)
{
	...
	STREAMING::REQUEST_MODEL(obLocal_137.f_1);
	return;
}
...
{
	return func_85(iParam0, Global_44921);
}
...
{
	TEXT_LABEL_ASSIGN_STRING(&uLocal_70, "Yoga", 64);
	sLocal_118 = "PLAY_YOGA" /*Presiona ~INPUT_CONTEXT~ para hacer yoga.*/;
	iLocal_116 = 18;
	fLocal_134 = 2.5f;
	fLocal_119 = 20f;
	essLocal_114 = 64500;
	...
	{
		iLocal_122 = 110;
		obLocal_137.f_2 = { -791.0036f, 186.3552f, 71.8295f };
		obLocal_137.f_5 = { 0f, 0f, -87.1403f };
		obLocal_137.f_1 = joaat("prop_yoga_mat_03");
	}
	else if (iLocal_136 == 1)
	{
		iLocal_122 = 111;
		obLocal_137.f_2 = { 2861.47f, 5945.9f, 357.06f };
		obLocal_137.f_5 = { 0f, -0.5f, 70f };
		obLocal_137.f_1 = joaat("prop_yoga_mat_03");
	}

	echLocal_135 = CHAR_MICHAEL;
	return;
}
...
void func_91(BOOL bParam0) // Position - 0x2888 (10376)
{
	if (bParam0)
		if (iLocal_122 != 263)
			func_80(iLocal_122, 0, false);

	func_42(&iLocal_113);

	if (func_86(iLocal_111, 2))
	{
		func_4();
		func_89(&iLocal_111, 2);
		func_6(&iLocal_115);
