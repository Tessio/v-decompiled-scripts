...
{
	if (iParam0 < 9)
		return IS_BIT_SET(Global_114904.f_18110.f_175[iParam0 /*19*/].f_18, 0);
...
int func_36(int iParam0) // Position - 0x13E8 (5096)
{
	...
	{
		case 0:
			return Global_114904.f_10056.f_90[0];
	
		case 1:
			return Global_114904.f_10056.f_90[1];
	
		case 2:
			return Global_114904.f_10056.f_90[2];
	}
