...
{
	if (iParam0 < 9)
		return IS_BIT_SET(Global_114963.f_18112.f_175[iParam0 /*19*/].f_18, 0);
...
int func_36(int iParam0) // Position - 0x13E8 (5096)
{
	...
	{
		case 0:
			return Global_114963.f_10058.f_90[0];
	
		case 1:
			return Global_114963.f_10058.f_90[1];
	
		case 2:
			return Global_114963.f_10058.f_90[2];
	}
