...
BOOL func_142(int iParam0) // Position - 0xBA04 (47620)
{
	int num;
...
BOOL func_143(int iParam0) // Position - 0xBA28 (47656)
{
	int num;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0xBA46 (47686)
{
