...
void func_23() // Position - 0xA5B (2651)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_27(character) && !func_16(14) || Global_113852)
			{
		...
		if (!PED::IS_PED_INJURED(uParam0->[i]))
		{
			switch (uParam1->[i])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->[i], Global_99733, &uLocal_370, &uLocal_386[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
						uParam1->[i] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99734))
					{
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->[i], Global_99734, &uLocal_370, &uLocal_419[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_370) && ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->[i], &uLocal_370, &uLocal_419[i /*16*/], 2))
					{
						...
						{
							if (num < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99734))
							{
						...
						if (iLocal_112 == 165)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_452[i /*16*/]))
							{
								...
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99734))
								{
...
BOOL func_30(Entity eParam0, float fParam1) // Position - 0x1670 (5744)
{
	...
	for (i = 0; i < 263; i = i + 1)
	{
		if (IS_BIT_SET(Global_34155[i /*23*/].f_11, 0))
		{
			if (Global_34155[i /*23*/].f_16 == 9)
			{
			}
			else
			{
				...
				if (IS_BIT_SET(Global_34155[i /*23*/].f_11, 19))
				{
					num = 3;
...
BOOL func_47() // Position - 0x1E00 (7680)
{
	...
	if (Global_2673271.f_62)
		return true;

	if (Global_99882.f_44 == 1)
		if (Global_99882.f_46 == 0)
			return true;
...
int func_49(int iParam0, Ped pedParam1) // Position - 0x1EF1 (7921)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_50(Global_102150) && pedParam1 != 0)
		{
			Global_102150 = 0;
		}
	}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114904.f_2370.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_68(Global_114904.f_2370.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114904.f_2370.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_68(Global_114904.f_2370.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114904.f_2370.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_68(Global_114904.f_2370.f_539.f_2314[2]), 32);
			return true;
