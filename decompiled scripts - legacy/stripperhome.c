...
eCharacter func_18(BOOL bParam0, BOOL bParam1) // Position - 0x6FD (1789)
{
...
BOOL func_19() // Position - 0x73E (1854)
{
...
void func_52() // Position - 0x111B (4379)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114963.f_10203.f_3853))
		func_56(13, BUILTIN::FLOOR(Global_114963.f_10203.f_3853));

	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_80337)
		{
			if (func_55() == HUD_COLOUR_BLACK == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
eHudColour func_55() // Position - 0x164C (5708)
{
	return Global_33815;
}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x16A8 (5800)
{
	if (bParam2 == -1)
		bParam2 = func_19();
...
void func_68(int iParam0) // Position - 0x1B0A (6922)
{
	...
	{
		case 0:
			func_86("SCLUB_HOME_D" /*~r~~a~ murió.*/, uLocal_93[0]);
		...
		case 1:
			HUD::CLEAR_PRINTS();
			func_69("SCLUB_HOME_A" /*Abandonaste a ~a~.*/, uLocal_93[0], false);
			iLocal_91 = 5;
			break;
		...
		case 4:
			func_86("SCLUB_HOME_D3" /*~r~~a~ se asustó.*/, uLocal_93[0]);
			iLocal_91 = 6;
			break;
...
{
	if (bParam1)
		func_28(&(Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_3), 2);
	else
		func_75(&(Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_3), 2);
...
BOOL func_78(BOOL bParam0) // Position - 0x1D8C (7564)
{
	BOOL flag;
	BOOL flag2;
...
void func_80() // Position - 0x1DD9 (7641)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_82(character) && !func_81(14) || Global_113909)
			{
				if (Global_114963.f_2370.f_539.f_4321 != character && func_82(Global_114963.f_2370.f_539.f_4321))
...
{
	Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/] = iParam1;
	return;
}

int func_91(int iParam0) // Position - 0x201C (8220)
{
	return Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/];
}
...
void func_93(BOOL bParam0) // Position - 0x210B (8459)
{
	switch (uLocal_93[0])
	{
		...
		case 7:
			if (bParam0)
				func_86("SCLUB_HOME_GO" /*Lleva a ~a~ a ~y~casa.~s~*/, uLocal_93[0]);
			else
		...
		case 8:
		case 9:
			_SHOW_SUBTITLE_CLEAR_EXISTING("SCLUB_HOME_GO3" /*Llévala a ~y~casa.*/, 7500, 1);
			break;
	}
	...
	switch (iLocal_92)
	{
		...
		case 13:
			if (!CAM::IS_SCREEN_FADING_OUT() && func_203(&uLocal_272) >= 1f)
			{
				...
				{
					if (uLocal_93[0] == 5)
						func_69("SCLUB_PHON_HELP_ALT" /*El número de ~a~ se añadió a tu teléfono.*/, uLocal_93[0], false);
					else
						func_69("SCLUB_PHON_HELP" /*El número de ~a~ se añadió a tu teléfono.*/, uLocal_93[0], false);
...
{
	return Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2;
}
...
void func_119(int iParam0) // Position - 0x39E2 (14818)
{
	...
	Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2 = Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2 + 1;
	return;
}

void func_120(int iParam0, int iParam1) // Position - 0x3A25 (14885)
{
	Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2 = iParam1;
	return;
}
...
void func_127(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x3C9F (15519)
{
	int num;
...
{
	Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 = iParam1;
	return;
}
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x412D (16685)
{
	...
	return Global_114963.f_243[iParam1 /*53*/].f_2[iParam0 /*5*/].f_4;
}
...
void func_141(float fParam0) // Position - 0x4153 (16723)
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (func_10(&(Global_114963.f_18112.f_175[i /*19*/].f_5)))
			func_142(&(Global_114963.f_18112.f_175[i /*19*/].f_5), fParam0 * 60f);
	}

	for (j = 0; j < 6; j = j + 1)
	{
		if (func_10(&Global_114963.f_18112.f_362[j /*3*/]))
			func_142(&Global_114963.f_18112.f_362[j /*3*/], fParam0 * 60f);
	}
...
{
	if (HUD::IS_MESSAGE_BEING_DISPLAYED() || AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() || Global_23023 != 0)
		return false;
...
void func_218(BOOL bParam0) // Position - 0x698E (27022)
{
	...
	if (iLocal_95 != 9)
	{
		if (num >= 200f / 2f && func_195() && !func_271(iLocal_350, 2) || func_258(uLocal_291[0], false))
		{
			...
			func_255(0);
			func_86("SCLUB_HOME_R" /*Vuelve con ~b~~a~.~s~*/, uLocal_93[0]);
			iLocal_95 = 9;
		}
	}
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_195())
			{
				if (!func_271(iLocal_350, 1))
				{
					...
					func_86("SCLUB_HOME_MEET" /*Reúnete con ~b~~a~~s~ detrás del club.*/, uLocal_93[0]);
					func_255(0);
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(uLocal_291[0], true), 3f, 3f, 3f, false, true, 0) || VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_357, false) && func_243(veLocal_357, uLocal_291[0], true) <= 10f)
			{
				...
				{
					if (!func_72("SCLUB_SMALL_CAR" /*Consigue un vehículo más grande para llevar a ~a~ a casa.*/, &unk))
					{
						func_69("SCLUB_SMALL_CAR" /*Consigue un vehículo más grande para llevar a ~a~ a casa.*/, uLocal_93[0], false);
			...
			else if (func_72("SCLUB_SMALL_CAR" /*Consigue un vehículo más grande para llevar a ~a~ a casa.*/, &unk))
			{
				HUD::CLEAR_HELP(true);
			}
			break;
		...
		case 5:
			...
			else
			{
				...
				if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SCLUB_HOME_WALK" /*Acompáñala a la puerta.*/))
					HUD::CLEAR_HELP(true);
			}
			break;
		...
		case 7:
			...
			{
				unk = { func_73(uLocal_93[0]) };
				func_87("SCLUB_FOLLOW_H" /*Sigue a ~b~~a~~s~ a su casa.*/, &unk, 7500, 1);
				func_88();
				func_255(0);
...
void func_233(int iParam0, int iParam1, BOOL bParam2) // Position - 0x8517 (34071)
{
	...
	{
		if (func_55() == HUD_COLOUR_PURE_WHITE)
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vector) > 100f)
		{
			...
			if (!func_271(iLocal_350, 128))
			{
				if (!func_34(0))
				{
					func_69("SCLUB_HOME_C_H" /*Para cancelar la cita sexual, vuelve a llamar a ~a~.*/, uLocal_93[0], false);
...
{
	if (Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 < 0)
		Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 = 0;

	Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 = Global_114963.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 + 1;
	return;
}
...
void func_281(BOOL bParam0) // Position - 0xA22F (41519)
{
	switch (uLocal_93[0])
	{
		...
		case 7:
			if (bParam0)
				func_86("SCLUB_HOME_MEE4" /*Reúnete con ~b~~a~~s~ en su casa.*/, uLocal_93[0]);
			else
				func_86("SCLUB_HOME_MEET" /*Reúnete con ~b~~a~~s~ detrás del club.*/, uLocal_93[0]);
			break;
	
		case 8:
			func_86("SCLUB_HOME_LIZ" /*Reúnete con ~b~~a~~s~ en la universidad.*/, uLocal_93[0]);
			break;
	
		case 9:
			func_86("SCLUB_HOME_HITCH" /*Reúnete con ~b~~a~~s~ en el embarcadero.*/, uLocal_93[0]);
			break;
	}
...
BOOL func_305(BOOL bParam0) // Position - 0xAFB4 (44980)
{
