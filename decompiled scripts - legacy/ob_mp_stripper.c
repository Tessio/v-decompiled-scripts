...
void main() // Position - 0x0 (0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(eScriptParam_0))
	{
		...
		epctLocal_333 = Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_39;
...
void func_2() // Position - 0xCE5 (3301)
{
	...
	if (type > PV_COMP_INVALID && type != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 36; i = i + 1)
		{
			if (Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_39 == Global_1845298[type /*881*/].f_260[i])
			{
				if (func_9(i) != -1)
				{
...
ePedComponentType _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0xDFB (3579)
{
	ePedComponentType type;
...
{
	return IS_BIT_SET(Global_1677555.f_241.f_136[func_15(9) /*33*/][plParam0], func_14(9));
}
...
BOOL func_19(BOOL bParam0) // Position - 0x10E3 (4323)
{
	BOOL flag;
	BOOL flag2;
...
eCharacter func_28(BOOL bParam0, BOOL bParam1) // Position - 0x138A (5002)
{
...
Player func_54(int iParam0, BOOL bParam1) // Position - 0x1E41 (7745)
{
	Player player;
...
eHudColour func_69() // Position - 0x23A4 (9124)
{
	return Global_33815;
}
