...
void func_1(var uParam0) // Position - 0xB6 (182)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if (func_55(uParam0) || func_51(uParam0) || func_50(uParam0) || !func_49(uParam0) || func_47(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || IS_BIT_SET(Global_1950702.f_4, 2) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						if (MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)
							if (func_41(uParam0->f_9) && !Global_262145.f_26712)
...
BOOL func_9(BOOL bParam0) // Position - 0xB43 (2883)
{
...
BOOL func_10(Ped pedParam0) // Position - 0xC2E (3118)
{
	int weaponHash;
...
BOOL func_11() // Position - 0xC8B (3211)
{
...
BOOL func_12(var uParam0) // Position - 0xCA5 (3237)
{
	return func_33(&(uParam0->f_7), 9);
}

void func_13(var uParam0) // Position - 0xCB7 (3255)
{
	var animDict;
	var animnName;
...
void func_14(var uParam0) // Position - 0xD6A (3434)
{
	var animDict;
...
BOOL func_15() // Position - 0xDD4 (3540)
{
	return IS_BIT_SET(Global_1950702.f_3, 25);
}

BOOL func_16(float fParam0, float fParam1, float fParam2) // Position - 0xDE5 (3557)
{
	float num;
	float num2;
...
void func_17(var uParam0) // Position - 0xE6B (3691)
{
	int weaponHash;
...
void func_18() // Position - 0xEFF (3839)
{
	Global_24430.f_6 = 1;
	return;
}

void func_19(BOOL bParam0) // Position - 0xF0D (3853)
{
	if (bParam0)
		if (func_20())
...
BOOL func_20() // Position - 0xF32 (3890)
{
	return IS_BIT_SET(Global_2685152.f_2, 11);
}

void func_21() // Position - 0xF43 (3907)
{
	MISC::SET_BIT(&Global_9503, 4);
	return;
}

void func_22(int iParam0) // Position - 0xF53 (3923)
{
	if (func_28())
		return;
...
void func_23(int iParam0) // Position - 0xF86 (3974)
{
	if (func_28())
		return;
...
BOOL func_24() // Position - 0x1010 (4112)
{
...
void func_25(BOOL bParam0, BOOL bParam1) // Position - 0x1037 (4151)
{
	if (bParam0)
	{
		if (func_27(0))
...
BOOL func_26() // Position - 0x10AB (4267)
{
	return IS_BIT_SET(Global_1964670, 5);
}

char* func_27(int iParam0) // Position - 0x10B9 (4281)
{
	if (iParam0 == 1)
...
BOOL func_28() // Position - 0x1110 (4368)
{
	return IS_BIT_SET(Global_1964670, 19);
}

void func_29(int iParam0) // Position - 0x111F (4383)
{
...
Vector3 func_30(var uParam0) // Position - 0x113D (4413)
{
	var unk;
...
Vector3 func_31(var uParam0) // Position - 0x1179 (4473)
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_32(int* piParam0, int iParam1) // Position - 0x118D (4493)
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_33(var uParam0, int iParam1) // Position - 0x119D (4509)
{
	return IS_BIT_SET(*uParam0, iParam1);
}

void func_34(var uParam0, char* sParam1) // Position - 0x11AB (4523)
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
...
void func_35(var uParam0, char* sParam1) // Position - 0x14DD (5341)
{
...
void func_36(ePedComponentType epctParam0) // Position - 0x1767 (5991)
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_2359296[func_37() /*5574*/].f_681.f_4248[i /*3*/] == epctParam0)
		{
...
int func_37() // Position - 0x17CA (6090)
{
	int num;
...
void func_38(var uParam0) // Position - 0x17D7 (6103)
{
...
int func_39(var uParam0) // Position - 0x180F (6159)
{
	int randomIntInRange;
...
int func_40(int iParam0) // Position - 0x18A7 (6311)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_41(int iParam0) // Position - 0x18DF (6367)
{
	switch (iParam0)
	{
		case 2:
...
void func_42(var uParam0) // Position - 0x191D (6429)
{
	if (uParam0->f_6 != -1)
	{
		func_43(&(uParam0->f_6));
...
void func_43(var uParam0) // Position - 0x193F (6463)
{
	int num;
...
int func_44(int iParam0) // Position - 0x1996 (6550)
{
	int i;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x19D1 (6609)
{
	int i;
...
ePedComponentType func_46(int iParam0) // Position - 0x1AFC (6908)
{
	if (iParam0 != 4)
		return PV_COMP_HEAD;
...
BOOL func_47(Player plParam0) // Position - 0x1B15 (6933)
{
	return func_48(plParam0) == joaat("WEAPON_MINIGUN");
}

BOOL func_48(Player plParam0) // Position - 0x1B29 (6953)
{
	return Global_1892925[plParam0 /*615*/].f_592;
}

BOOL func_49(var uParam0) // Position - 0x1B3D (6973)
{
	*uParam0(!func_33(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_50(var uParam0) // Position - 0x1B67 (7015)
{
	var sizeAndPeds;
	int i;
...
BOOL func_51(var uParam0) // Position - 0x1BDE (7134)
{
	int i;
...
int func_52(ePedComponentType epctParam0) // Position - 0x1C58 (7256)
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1C79 (7289)
{
	return -1;
}

BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1C82 (7298)
{
...
BOOL func_55(var uParam0) // Position - 0x1CE2 (7394)
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_56(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x1CF3 (7411)
{
...
void func_59(var uParam0, int iParam1) // Position - 0x1DE3 (7651)
{
	uParam0->f_13 = iParam1;
	return;
}

void func_60(int* piParam0, int iParam1) // Position - 0x1DF1 (7665)
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_61(var uParam0) // Position - 0x1E01 (7681)
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_62() // Position - 0x1E54 (7764)
{
	return 0.13f;
}

void func_63(var uParam0) // Position - 0x1E61 (7777)
{
...
void func_64(int* piParam0, int iParam1, char* sParam2) // Position - 0x1EB9 (7865)
{
	int offset;
...
char* func_65() // Position - 0x1EDD (7901)
{
	return Global_77397;
}

BOOL func_66() // Position - 0x1EE9 (7913)
{
...
BOOL func_67() // Position - 0x1F48 (8008)
{
	if (func_68() == 0)
		return true;
...
int func_68() // Position - 0x1F5D (8029)
{
	return Global_1574635.f_18;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x1F6B (8043)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1FEF (8175)
{
	switch (func_72())
	{
		case false:
...
Hash func_71() // Position - 0x2022 (8226)
{
...
BOOL func_72() // Position - 0x2046 (8262)
{
	return Global_33815;
}

BOOL func_73() // Position - 0x2051 (8273)
{
	return Global_2685152.f_726;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x2060 (8288)
{
...
BOOL func_75() // Position - 0x2077 (8311)
{
	return Global_2697072;
}

BOOL func_76() // Position - 0x2083 (8323)
{
	return Global_2685152.f_721;
}

int func_77() // Position - 0x2092 (8338)
{
	return func_78(PLAYER::PLAYER_ID());
}

int func_78(Player plParam0) // Position - 0x20A2 (8354)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658293[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_79(ePedComponentType epctParam0) // Position - 0x20BF (8383)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
		if (func_81(epctParam0) && !func_80(epctParam0))
			return true;

	return false;
}

BOOL func_80(ePedComponentType epctParam0) // Position - 0x20F8 (8440)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_81(ePedComponentType epctParam0) // Position - 0x2129 (8489)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_82(Player plParam0) // Position - 0x215A (8538)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658293[plParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
				return func_83(Global_2658293[plParam0 /*468*/].f_325.f_8) == 15;

	return false;
}

int func_83(ePedComponentType epctParam0) // Position - 0x21A1 (8609)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
void func_84() // Position - 0x26F1 (9969)
{
	func_86(&uLocal_145);
	func_85();
	return;
...
void func_85() // Position - 0x2703 (9987)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_86(var uParam0) // Position - 0x270F (9999)
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x276E (10094)
{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_94(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_91(*Global_4718592.f_197291))
...
BOOL func_88(BOOL bParam0) // Position - 0x2C23 (11299)
{
...
BOOL func_89() // Position - 0x2C4F (11343)
{
	if (func_90())
		return true;
...
BOOL func_90() // Position - 0x2C6A (11370)
{
...
BOOL func_91(int iParam0) // Position - 0x2C95 (11413)
{
	return iParam0 == 17;
}

void func_92() // Position - 0x2CA2 (11426)
{
	var unk;
...
void func_93() // Position - 0x2CEF (11503)
{
...
BOOL func_94(Ped pedParam0) // Position - 0x2D2D (11565)
{
	int scriptTaskStatus;
...
void func_95(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2D5E (11614)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2E2E (11822)
{
	Hash statName;
...
void func_97() // Position - 0x2E4A (11850)
{
	eViewModeContext i;
...
BOOL func_98(Player plParam0) // Position - 0x2EA2 (11938)
{
...
BOOL func_99() // Position - 0x2EE1 (12001)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_100(Player plParam0, int iParam1) // Position - 0x2EEF (12015)
{
	BOOL flag;
...
eCharacter func_101(int iParam0, BOOL bParam1) // Position - 0x2F48 (12104)
{
...
int func_102() // Position - 0x2F89 (12169)
{
	return Global_1574928;
}

BOOL func_103(Player plParam0) // Position - 0x2F95 (12181)
{
	Player player;
...
BOOL func_104() // Position - 0x2FB7 (12215)
{
...
void func_105() // Position - 0x2FE8 (12264)
{
...
void func_106() // Position - 0x3019 (12313)
{
	func_107(0, &uLocal_145, 0, 3);
	func_107(1, &uLocal_145, 1, 3);
	func_107(2, &uLocal_145, 2, 3);
	func_107(3, &uLocal_145, 3, 1);
	func_107(4, &uLocal_145, 4, 1);
	func_107(5, &uLocal_145, 5, 1);
	func_107(6, &uLocal_145, 6, 1);
	func_107(7, &uLocal_145, 7, 1);
	func_107(8, &uLocal_145, 8, 1);
	func_107(9, &uLocal_145, 9, 1);
	func_107(10, &uLocal_145, 10, 1);
	func_107(11, &uLocal_145, 11, 1);
	func_107(12, &uLocal_145, 12, 1);
	func_107(13, &uLocal_145, 13, 1);
	func_107(14, &uLocal_145, 14, 1);
	func_107(15, &uLocal_145, 15, 1);
	func_107(16, &uLocal_145, 16, 1);
	func_107(17, &uLocal_145, 17, 1);
	func_107(18, &uLocal_145, 18, 1);
	func_107(19, &uLocal_145, 19, 1);
	return;
}

void func_107(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x30ED (12525)
{
	var unk;
	float num;

	func_112(iParam0, &unk, &num);
	uParam1->f_16[iParam2 /*14*/].f_13 = iParam3;
	uParam1->f_16[iParam2 /*14*/] = { unk };
	uParam1->f_16[iParam2 /*14*/].f_3 = { 0f, 0f, num };
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_109(func_111(), func_110(iParam3, num)) + unk };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_109(func_108(), func_110(iParam3, num)) + unk };
	uParam1->f_16[iParam2 /*14*/].f_6 = 1.25f;
	return;
}

Vector3 func_108() // Position - 0x317E (12670)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_109(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3191 (12689)
{
	float num;
	float num2;
	float num3;
...
float func_110(int iParam0, float fParam1) // Position - 0x31D5 (12757)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_111() // Position - 0x320E (12814)
{
	return -0.5f, -0.5f, 0f;
}

void func_112(int iParam0, var uParam1, var uParam2) // Position - 0x3221 (12833)
{
	if (func_4())
	{
		switch (iParam0)
...
void func_113() // Position - 0x37E1 (14305)
{
	return;
}

int func_114(int iParam0, int iParam1, BOOL bParam2) // Position - 0x37E9 (14313)
{
	int i;
...
Player func_115() // Position - 0x38FF (14591)
{
	Player player;
