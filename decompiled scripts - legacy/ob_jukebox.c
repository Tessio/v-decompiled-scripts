...
void func_63(int iParam0) // Position - 0x2E85 (11909)
{
	if (iParam0->f_9 != 0)
	{
...
int func_87(int iParam0, BOOL bParam1) // Position - 0x6CDB (27867)
{
	int num;
	int num2;
...
BOOL func_137(int iParam0) // Position - 0x8B88 (35720)
{
	switch (iParam0->f_9)
	{
		case 0:
...
void func_147(int iParam0, Hash hParam1) // Position - 0x9CC7 (40135)
{
