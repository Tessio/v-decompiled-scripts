...
void func_3() // Position - 0x4BE (1214)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_5(character) && !func_4(14) || Global_113852)
			{
				if (Global_114904.f_2370.f_539.f_4321 != character && func_5(Global_114904.f_2370.f_539.f_4321))
...
void func_32(BOOL bParam0, int iParam1) // Position - 0x128A (4746)
{
	...
	if (iParam1 <= func_49(bParam0))
	{
		...
		if (func_40(bParam0, iParam1) != 322)
			func_34(func_40(bParam0, iParam1), uLocal_46, uLocal_46.f_1);
...
void func_35() // Position - 0x1482 (5250)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114904.f_10201.f_3853))
		func_37(13, BUILTIN::FLOOR(Global_114904.f_10201.f_3853));
...
int func_82(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2EFC (12028)
{
	...
	if (iParam5 == 0)
	{
		Global_80063[1 /*14*/] = { func_134(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_80063[1 /*14*/] = { func_134(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_80063[1 /*14*/] = { func_134(entityModel, 14, unk18[j], -1) };
							func_102(pedParam0, Global_80063[1 /*14*/].f_12, Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4);
							func_125(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_92(i), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_92(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_92(i), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, iParam4);
			...
			{
				Global_80063[1 /*14*/] = { func_134(entityModel, i, func_91(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_80063[1 /*14*/] = { func_134(entityModel, 14, unk59[j], -1) };
			func_102(pedParam0, Global_80063[1 /*14*/].f_12, Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4);
			func_125(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_92(iParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_92(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_92(iParam1), Global_80063[1 /*14*/].f_3, Global_80063[1 /*14*/].f_4, iParam4);
...
BOOL func_83(Ped pedParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x370D (14093)
{
	...
	{
		if (!func_198(pedParam0, Global_114904.f_2370.f_539[num /*65*/].f_64, Global_114904.f_2370.f_539[num /*65*/].f_63))
		{
...
{
	Global_80063[1 /*14*/] = { func_134(epctParam0, iParam1, epctParam2, -1) };
...
BOOL func_90(Ped pedParam0, ePedComponentType epctParam1, var uParam2, int iParam3) // Position - 0x4017 (16407)
{
	...
	{
		if (!func_198(pedParam0, Global_114904.f_2370.f_539[num /*65*/].f_61, Global_114904.f_2370.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
			switch (epctParam1)
			{
				...
				case 5:
					func_118(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[0], Global_114904.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (epctParam1)
			{
				...
				case 2:
					func_118(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[1], Global_114904.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (epctParam1)
			{
				...
				case 4:
					func_118(&unk, -99, -99, Global_114904.f_2370.f_539.f_196[2], Global_114904.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_125(int iParam0) // Position - 0x9E6F (40559)
{
	if (IS_BIT_SET(Global_80063[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_80063[1 /*14*/].f_6, 6))
		func_132(iParam0, Global_80063[1 /*14*/].f_5, Global_80063[1 /*14*/].f_2, 2, Global_80063[1 /*14*/].f_1, 1, 0);
...
void func_136(int iParam0) // Position - 0xDD9A (56730)
{
	...
	func_137(&Global_80063[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_130(func_140(iParam1, iParam0->f_2), Global_80060);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_130(func_139(iParam1, iParam0->f_2), Global_80060);
			...
			{
				num = func_130(num2, Global_80060);
...
void func_143(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x100CD (65741)
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_137(&Global_80063[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_137(&Global_80063[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_137(&Global_80063[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80261)
		{
			...
			func_137(&Global_80063[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_198(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x21663 (136803)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_134(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_198(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_198(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_80063[2 /*14*/] = { func_134(entityModel, 14, k, -1) };
								
									if (Global_80063[2 /*14*/].f_12 == j)
										if (func_198(pedParam0, 14, k))
											if (!func_88(entityModel, epctParam2, 14, k, &unk, &Global_80063[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_134(entityModel, i, type, -1) };
					
						if (!func_88(entityModel, epctParam2, i, type, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_80063[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_92(epctParam1)) && Global_80063[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_92(epctParam1)))
	{
		return true;
	}
...
int func_248(BOOL bParam0) // Position - 0x2434A (148298)
{
	if (func_252())
	{
		...
		if (func_41(Global_114893))
			func_249(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Evento aleatorio*/);
	
		if (bParam0 && func_41(Global_114893))
...
{
	switch (func_253(&Global_33835, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
{
	return func_256(iParam0, Global_44869);
}
...
{
	if (Global_114893 == func_50() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114894)
		return true;
...
void func_269(int iParam0, var uParam1) // Position - 0x250D3 (151763)
{
	switch (iParam0)
	{
		...
		case 5:
			func_270(uParam1, "Barry3A", func_272(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Las zonas en las que puedes encontrar vehículos con un alijo oculto aparecerán indicadas en el mapa. Recoge estos vehículos para Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_271(iParam0), 0, 1);
			break;
		...
		case 8:
			func_270(uParam1, "Dreyfuss1", func_272(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*Se ha revelado la identidad y el paradero del asesino.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_271(iParam0), 0, 0);
			break;
		...
		case 38:
			func_270(uParam1, "Nigel1A", func_272(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Se han marcado en el mapa las zonas en las que puedes encontrar objetos de famosos. Róbalos para Nigel y para la señora Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_271(iParam0), 1, 1);
			break;
		...
		case 49:
			func_270(uParam1, "Paparazzo3A", func_272(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Las zonas en las que puedes encontrar oportunidades para sacar fotos a famosos se han marcado en el mapa. Localiza y fotografía a estos famosos para Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_271(iParam0), 0, 1);
			break;
		...
		case 58:
			func_270(uParam1, "Tonya1", func_272(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Puedes encontrarte con extraños y locos por todo San Andreas en ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~.*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_271(iParam0), 0, 1);
			break;
...
void func_281(BOOL bParam0) // Position - 0x26C99 (158873)
{
	if (bParam0 == -1)
		bParam0 = func_50();
...
void func_283(BOOL bParam0) // Position - 0x26D0C (158988)
{
	Global_114893 = bParam0;
	return;
}

BOOL func_284(var uParam0, var uParam1, var uParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26D1A (159002)
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (!func_319(Global_114904.f_25002.f_43[bParam3]))
			return false;
...
BOOL func_308(BOOL bParam0, int iParam1) // Position - 0x278B9 (161977)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_317() || Global_113951 || Global_33778 || func_316() || func_23(8, -1) || func_315() || func_314() || func_313() || func_312() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_317() || Global_33778 || func_316() || func_23(8, -1) || func_313() || func_315() || func_314() || func_312() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_317() || Global_113951 || Global_33778 || func_316() || func_23(8, -1) || func_313() || func_315() || func_314() || func_312() || Global_114904.f_7695.f_919[character] == 5 || Global_45416 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_317() || Global_113951 || Global_33778 || func_316() || func_23(8, -1) || func_315() || func_314() || func_312() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_317() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_23(8, -1) || func_312() || func_311() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_317() || Global_33778 || func_316() || func_23(8, -1) || func_314() || func_313() || func_312() || Global_114904.f_7695.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_317() || func_314() || Global_113951 || Global_33778 || func_316() || Global_46094 || func_23(8, -1) || func_313() || func_311() || func_312() || Global_114904.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_317() || Global_113951 || Global_33778 || func_316() || func_23(8, -1) || func_313() || func_311() || func_315() || func_314() || func_312())
							return false;
						break;
				}
			}
...
ePedComponentType func_316() // Position - 0x2808E (163982)
{
...
BOOL func_320(BOOL bParam0, int iParam1, eCharacter echParam2) // Position - 0x280F0 (164080)
{
	BOOL num;
	eCharacter character;
...
BOOL func_322(BOOL bParam0) // Position - 0x281F8 (164344)
{
	BOOL flag;
	BOOL flag2;
...
void func_328(BOOL bParam0) // Position - 0x28459 (164953)
{
	var name;
	...
	if (func_258())
	{
		...
		func_331(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_330(Global_114893, true), 64);
	
		if (func_49(Global_114893) > 0)
		{
...
char* func_330(BOOL bParam0, BOOL bParam1) // Position - 0x28548 (165192)
{
	switch (bParam0)
	{
		case false:
...
void func_332(BOOL bParam0) // Position - 0x287A3 (165795)
{
	func_333(bParam0, 0, func_338(bParam0));
	return;
}

void func_333(BOOL bParam0, int iParam1, int iParam2) // Position - 0x287B8 (165816)
{
	int unk;
	var unk2;
...
void func_335(BOOL bParam0, var uParam1) // Position - 0x288B8 (166072)
{
...
int func_338(BOOL bParam0) // Position - 0x28A8A (166538)
{
	int num;
...
int func_342() // Position - 0x28C99 (167065)
{
	...
	if (Global_22983 == 4)
	{
		...
		{
			if (HUD::DOES_TEXT_LABEL_EXIST(&Global_21851[currentScriptedConversationLine /*6*/]))
			{
				labelName = { Global_22602 };
