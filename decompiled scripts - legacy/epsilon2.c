...
BOOL func_68(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5CD5 (23765)
{
	Global_80063[1 /*14*/] = { func_115(hParam0, iParam1, hParam2, -1) };
...
BOOL func_70(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x6301 (25345)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_74(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x6596 (26006)
{
	int num;
	...
	if (iParam4 == 0)
	{
		switch (iParam2)
		{
			case 2:
				...
				hash = func_82(hParam1, epctParam3, hash2);
				break;
		
			case 1:
				hash3 = func_104(pedParam0, 2);
				hash = func_82(hParam1, hash3, epctParam3);
				break;
		}
	}
	else if (iParam4 == 2)
	{
		func_74(hParam1, iParam2, epctParam3, &hash);
	}
	else if (iParam4 == 1)
	{
		func_81(hParam1, iParam2, epctParam3, &hash);
	}
	else if (iParam4 == 6)
	{
		if (iParam2 == 4)
			func_80(hParam1, epctParam3, &hash);
	}
	else
	{
		switch (hParam1)
						...
						if (iParam2 == 3)
						{
							...
							else if (epctParam3 >= 176 && epctParam3 <= 191 || epctParam3 >= 227 && epctParam3 <= 242 || epctParam3 >= 243 && epctParam3 <= 258)
							{
								...
								if (hash8 >= 27 && hash8 <= 42 || hash8 >= 43 && hash8 <= 58 || hash8 >= 59 && hash8 <= 74)
									hash = func_77(hParam1, epctParam3, hash9, 0);
								else
									hash = func_77(hParam1, epctParam3, hash9, 1);
							}
...
BOOL func_76(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0x7450 (29776)
{
	int num;
...
Hash func_77(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x7734 (30516)
{
	int num;
...
Hash func_78(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x79FB (31227)
{
	Hash i;
	Hash hash;
...
BOOL func_79(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x7A32 (31282)
{
	Hash hash;
...
BOOL func_80(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x7A5B (31323)
{
	*uParam2 = -99;
...
int func_81(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x7D25 (32037)
{
	int num;
...
Hash func_82(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0x7FAF (32687)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_83(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x8108 (33032)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_84(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, hash, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_84(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x81A2 (33186)
{
	switch (hParam0)
	{
...
Hash func_85(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x8270 (33392)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_88(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x8792 (34706)
{
	Hash entityModel;
...
struct<17> func_96(Hash hParam0, Hash hParam1) // Position - 0x960D (38413)
{
	int i;
	var unk;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					else if (epctParam2 >= 10 && epctParam2 <= 17)
					{
						return true;
					}
...
BOOL func_101(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xB9DD (47581)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
			...
			if (epctParam2 == 9 || epctParam2 == 7 || epctParam2 == 23)
				return true;
		else if (iParam1 == 9)
			if (epctParam2 >= 9 && epctParam2 <= 14)
				return true;
		else if (iParam1 == 14)
			if (epctParam2 == 12 || epctParam2 == 59 || epctParam2 == 60 || epctParam2 == 31 || epctParam2 == 32 || epctParam2 == 33 || epctParam2 == 34 || epctParam2 == 35 || epctParam2 == 36 || epctParam2 == 37 || epctParam2 == 38 || epctParam2 == 39 || epctParam2 == 40 || epctParam2 == 41 || epctParam2 >= 42 && epctParam2 <= 44 || epctParam2 == 54 || epctParam2 == 55)
				return true;
	}
	else if (hParam0 == joaat("Player_One"))
	{
		if (iParam1 == 2)
			...
			if (epctParam2 == 3 || epctParam2 == 5 || epctParam2 == 9)
				return true;
		else if (iParam1 == 9)
			if (epctParam2 >= 5 && epctParam2 <= 10)
				return true;
		else if (iParam1 == 14)
			if (epctParam2 == 82 || epctParam2 == 10 || epctParam2 == 26 || epctParam2 == 27 || epctParam2 == 28 || epctParam2 == 29 || epctParam2 == 30 || epctParam2 == 31 || epctParam2 == 32 || epctParam2 == 33 || epctParam2 == 34 || epctParam2 == 35 || epctParam2 == 36 || epctParam2 >= 37 && epctParam2 <= 39)
				return true;
	}
	else if (hParam0 == joaat("Player_Two"))
	{
		if (iParam1 == 8)
			if (epctParam2 == 14 || epctParam2 == 7)
				return true;
		else if (iParam1 == 9)
			if (epctParam2 == 8 || epctParam2 >= 9 && epctParam2 <= 14 || epctParam2 == 15 || epctParam2 == 16)
				return true;
		else if (iParam1 == 14)
			if (epctParam2 == 88 || epctParam2 == 12 || epctParam2 == 47 || epctParam2 == 48 || epctParam2 == 49 || epctParam2 == 50 || epctParam2 == 51 || epctParam2 == 52 || epctParam2 == 53 || epctParam2 == 54 || epctParam2 == 55 || epctParam2 == 56 || epctParam2 == 57 || epctParam2 >= 58 && epctParam2 <= 60)
				return true;
	}
...
void func_116(int iParam0, Hash hParam1) // Position - 0xFF66 (65382)
{
	switch (iParam0)
	{
		case 0:
...
void func_136(Hash hParam0) // Position - 0x14B40 (84800)
{
	if (hParam0 < 136)
		func_138(hParam0);
	else
...
void func_141(int iParam0, Hash hParam1) // Position - 0x1689D (92317)
{
	switch (iParam0)
	{
		case 0:
...
void func_154(Hash hParam0) // Position - 0x1B7E2 (112610)
{
	if (hParam0 < 107)
		func_157(hParam0);
	else if (hParam0 < 227)
...
void func_160(int iParam0, Hash hParam1) // Position - 0x1E0AD (123053)
{
	switch (iParam0)
	{
		case 0:
...
void func_173(Hash hParam0) // Position - 0x21F45 (139077)
{
	if (hParam0 < 60)
		func_175(hParam0);
	else
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_179(pedParam0, i, unk[i]))
				{
					...
					else
					{
						...
						Global_80063[2 /*14*/] = { func_115(entityModel, i, hash, -1) };
					
						if (!func_69(entityModel, epctParam2, i, hash, &unk, &Global_80063[2 /*14*/]))
							return false;
					}
				}
			}
...
BOOL func_286(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x2C5C2 (181698)
{
	Hash entityModel;
	int i;
	var unk;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80063[1 /*14*/] = { func_115(entityModel, iParam1, hParam2, -1) };
