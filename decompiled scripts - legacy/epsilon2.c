...
BOOL func_33() // Position - 0x46AF (18095)
{
	return Global_33776;
}

BOOL func_34() // Position - 0x46BA (18106)
{
	return Global_33775;
}
...
struct<2> func_226(int iParam0, const char* sParam1, int iParam2) // Position - 0x2687D (157821)
{
	var unk;
	int num;
...
void func_254() // Position - 0x2AE66 (175718)
{
	...
	if (!bLocal_151 && func_259(3) == -1)
	{
		func_258(3, false);
		num = func_257(3, 8, 1);
		func_256(num, 3, 8, "EPS_EMAIL5K" /*Visita nuestro sitio web ~b~<u>www.epsilonprogram.com</u>~s~ y dona 5000 $.*/);
		bLocal_151 = true;
	}
...
void func_276(ePedComponentType epctParam0) // Position - 0x2BCD1 (179409)
{
	int i;
	int j;
...
void func_289(BOOL bParam0, BOOL bParam1) // Position - 0x2C816 (182294)
{
...
void func_299(BOOL bParam0, BOOL bParam1) // Position - 0x2CA4F (182863)
{
	...
	if (offset >= 0 && offset <= 31)
	{
		if (!func_325(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_322(68))
					func_319("DI_HLP_STRY" /*Los personajes de la historia estarán disponibles en el modo director del editor Rockstar a medida que avance la historia de GTA V.*/, 2, 0, 20000, 10000, 7, 0, 208, 0);
			}
		}
	}
