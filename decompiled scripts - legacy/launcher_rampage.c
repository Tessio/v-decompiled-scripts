		...
		if (iLocal_287 != -1)
		{
			if (!func_232())
			{
				*panParam0 = func_231(iLocal_287);
				...
				MISC::SET_BIT(&Global_114344.f_18578[*panParam0 /*6*/], 0);
				MISC::SET_BIT(&Global_114344.f_18578[*panParam0 /*6*/], 2);
				MISC::CLEAR_BIT(&Global_114344.f_18578[*panParam0 /*6*/], 3);
				Global_113431[*panParam0 /*10*/].f_1 = 0;
			
				if (!func_229(false))
					Global_113431[*panParam0 /*10*/].f_3 = 0;
...
{
	while (!Global_113431[*panParam0 /*10*/])
	{
		BUILTIN::WAIT(0);
	}
...
void func_7(int iParam0) // Position - 0x49C (1180)
{
	...
	TEXT_LABEL_COPY(&Global_64521, { func_12(iParam0) }, 4);
	Global_64509 = 0;
	Global_64508 = false;
...
void func_26(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xD89 (3465)
{
	if (Global_101893 != 10 && Global_101893 != 9)
	{
		...
		func_28(&Global_104903, sParam0, 0, "Start", iParam1, pedParam2);
		func_27();
		Global_96046 = 0;
	}
...
void func_61() // Position - 0x41BD (16829)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(character) && !func_62(14) || Global_113292)
			{
				if (Global_114344.f_2367.f_539.f_4321 != character && func_39(Global_114344.f_2367.f_539.f_4321))
...
void func_63(Ped pedParam0, BOOL bParam1) // Position - 0x42C8 (17096)
{
	...
	if (func_39(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_64(pedParam0, &Global_114344.f_2367.f_539.f_298[character /*477*/]);
...
ePedComponentType func_86() // Position - 0x768E (30350)
{
...
BOOL func_89(ePedComponentType epctParam0) // Position - 0x76D2 (30418)
{
...
BOOL func_97(ePedComponentType epctParam0) // Position - 0x858D (34189)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
int func_100() // Position - 0x8875 (34933)
{
	return func_101(PLAYER::PLAYER_ID());
}

int func_101(Player plParam0) // Position - 0x8885 (34949)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658016[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_102(int iParam0) // Position - 0x88A2 (34978)
{
	return func_77(iParam0, 0, false);
}

int func_103(int iParam0) // Position - 0x88B2 (34994)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_104() // Position - 0x8BF5 (35829)
{
	return Global_101945.f_399 > 0;
}

var func_105() // Position - 0x8C06 (35846)
{
	var unk;
...
void func_106(var uParam0, int iParam1) // Position - 0x8C4C (35916)
{
	if (iParam1 <= 0)
		return;
...
void func_107(var uParam0, int iParam1) // Position - 0x8CD2 (36050)
{
...
void func_108(var uParam0, int iParam1) // Position - 0x8D05 (36101)
{
	int num;
	int num2;
...
int func_109(int iParam0, int iParam1) // Position - 0x8D56 (36182)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_110(int iParam0) // Position - 0x8DF8 (36344)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_111(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E1A (36378)
{
	if (bParam0)
		return uParam1;
...
int func_112(int iParam0) // Position - 0x8E31 (36401)
{
	return iParam0 & 15;
}

void func_113(var uParam0, int iParam1) // Position - 0x8E3E (36414)
{
...
void func_114(var uParam0, int iParam1) // Position - 0x8E78 (36472)
{
...
void func_115(var uParam0, int iParam1) // Position - 0x8EB3 (36531)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_116(int iParam0) // Position - 0x8EEF (36591)
{
	int num;
	var textLabel;
...
BOOL func_117() // Position - 0x8F52 (36690)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_118() // Position - 0x8F68 (36712)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_119(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F7E (36734)
{
...
struct<2> func_120(int iParam0) // Position - 0x8FC0 (36800)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x940D (37901)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xA6E5 (42725)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAA2B (43563)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAAD0 (43728)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAB6B (43883)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAB91 (43921)
{
	Global_79999 != 6;
...
void func_128(Ped pedParam0) // Position - 0xABC9 (43977)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAC22 (44066)
{
...
int func_130(Ped pedParam0) // Position - 0xACA5 (44197)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xACD6 (44246)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACEB (44267)
{
	int num;
...
int func_133() // Position - 0xAD6D (44397)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAD9E (44446)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xADB9 (44473)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xAE05 (44549)
{
	int i;
...
BOOL func_137(Vehicle veParam0) // Position - 0xAE4E (44622)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE6E (44654)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xAE8F (44687)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xAEE2 (44770)
{
...
BOOL func_141(int iParam0) // Position - 0xAF5F (44895)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFB2 (44978)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB0A8 (45224)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB113 (45331)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB152 (45394)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB2A1 (45729)
{
	return IS_BIT_SET(Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB2BB (45755)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB314 (45844)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB355 (45909)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB377 (45943)
{
...
BOOL func_151() // Position - 0xB3B6 (46006)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3C4 (46020)
{
	int num;
...
BOOL func_153() // Position - 0xB3F7 (46071)
{
...
void func_154(int iParam0) // Position - 0xB41E (46110)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB441 (46145)
{
...
void func_156() // Position - 0xB47E (46206)
{
	Global_21451 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB48E (46222)
{
...
BOOL func_158() // Position - 0xB4E5 (46309)
{
...
BOOL func_159(Any* panParam0, BOOL bParam1) // Position - 0xB507 (46343)
{
	var unk;
	...
	if (func_201(*panParam0) || func_199(*panParam0) || Global_79990 == true)
		return true;
...
void func_160(Ped pedParam0, var uParam1, int iParam2) // Position - 0xB777 (46967)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_161(int iParam0) // Position - 0xBACF (47823)
{
...
BOOL func_162(var uParam0) // Position - 0xBAEF (47855)
{
...
BOOL func_163(var uParam0) // Position - 0xBB07 (47879)
{
...
void func_164(Any* panParam0) // Position - 0xBB2C (47916)
{
	int i;
	int taskSequenceId;
...
void func_165(Object* pobParam0) // Position - 0xBE30 (48688)
{
...
void func_166(Any* panParam0) // Position - 0xBE5B (48731)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xBEDB (48859)
{
	int i;
	int num;
...
BOOL func_168(Ped pedParam0, Vehicle veParam1) // Position - 0xC09A (49306)
{
...
BOOL func_169(Vehicle veParam0) // Position - 0xC0CA (49354)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_170(Any* panParam0, BOOL bParam1, int iParam2) // Position - 0xC0F4 (49396)
{
	int i;
	int num;
...
BOOL func_171(int iParam0) // Position - 0xC3B0 (50096)
{
...
BOOL func_172(Vehicle veParam0, int iParam1) // Position - 0xC3E4 (50148)
{
	float xSize;
...
BOOL func_173(Vehicle veParam0, int iParam1) // Position - 0xC45A (50266)
{
	return func_174(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_174(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC472 (50290)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_175(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xC533 (50483)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_176(Ped pedParam0, int iParam1) // Position - 0xC65F (50783)
{
...
int func_177() // Position - 0xC724 (50980)
{
	int i;
...
BOOL func_178(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xC76E (51054)
{
	var unk;
...
float func_179(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xC7FF (51199)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_180(float fParam0, var uParam1, var uParam2) // Position - 0xC820 (51232)
{
	float num;
	float num2;
...
void func_181(var uParam0) // Position - 0xC85F (51295)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_182(Vehicle veParam0, Ped pedParam1) // Position - 0xC87A (51322)
{
	int i;
...
BOOL func_183(Vehicle veParam0) // Position - 0xC8B9 (51385)
{
...
BOOL func_184(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC8E1 (51425)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_185(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC9DC (51676)
{
	float entityCoords;
	float num;
...
BOOL func_186(Vehicle veParam0, float fParam1) // Position - 0xCAE8 (51944)
{
	var outProjectile;
	var outCoords;
...
BOOL func_187(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xCB7D (52093)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_188(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xCC0B (52235)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_189(int iParam0) // Position - 0xCC53 (52307)
{
...
void func_190(Vehicle veParam0) // Position - 0xCC9D (52381)
{
	int taskSequenceId;
...
BOOL func_191(int iParam0) // Position - 0xCD3A (52538)
{
	if (iParam0 == -1)
		iParam0 = func_197();
...
BOOL func_192(int iParam0) // Position - 0xCDCF (52687)
{
...
BOOL func_193() // Position - 0xCE0E (52750)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_194() // Position - 0xCE2B (52779)
{
	if (Global_98790 != -1)
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xCE4E (52814)
{
	return func_196(iParam0, Global_44375);
}

BOOL func_196(int iParam0, int iParam1) // Position - 0xCE5F (52831)
{
	if (iParam1 == 15)
		return 1;
...
int func_197() // Position - 0xD040 (53312)
{
	return func_198(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_198(const char* sParam0, int iParam1) // Position - 0xD051 (53329)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_199(int iParam0) // Position - 0xD09A (53402)
{
...
BOOL func_200() // Position - 0xD0CE (53454)
{
...
BOOL func_201(int iParam0) // Position - 0xD10C (53516)
{
	if (func_229(false))
...
void func_202() // Position - 0xD134 (53556)
{
	func_208(0);
	func_207();
	func_203();
...
void func_203() // Position - 0xD149 (53577)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_204(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xD1A1 (53665)
{
...
void func_205(Vehicle veParam0) // Position - 0xD1F8 (53752)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_206(BOOL bParam0, BOOL bParam1) // Position - 0xD224 (53796)
{
...
void func_207() // Position - 0xD375 (54133)
{
...
void func_208(int iParam0) // Position - 0xD3C6 (54214)
{
	if (func_213())
		return;
...
void func_209(int iParam0) // Position - 0xD3F9 (54265)
{
	if (func_213())
		return;
...
void func_210(BOOL bParam0, BOOL bParam1) // Position - 0xD483 (54403)
{
	if (bParam0)
	{
		if (func_212(0))
...
BOOL func_211() // Position - 0xD4F7 (54519)
{
	return IS_BIT_SET(Global_1959772, 5);
}

BOOL func_212(int iParam0) // Position - 0xD505 (54533)
{
	if (iParam0 == 1)
...
BOOL func_213() // Position - 0xD55C (54620)
{
	return IS_BIT_SET(Global_1959772, 19);
}

BOOL func_214(int iParam0) // Position - 0xD56B (54635)
{
...
BOOL func_215(int iParam0) // Position - 0xD5AC (54700)
{
	int num;
	...
	num = func_217(&(Global_113431[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_216(int iParam0) // Position - 0xD5F1 (54769)
{
...
int func_217(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xD623 (54819)
{
	int i;
...
void func_218(int iParam0, int iParam1) // Position - 0xD75A (55130)
{
	int i;
...
BOOL func_219(int iParam0) // Position - 0xD7A9 (55209)
{
	if (Global_44375 == 15)
		return false;
...
BOOL func_220() // Position - 0xD7CB (55243)
{
	if (Global_101893 == 10 || Global_101893 == 9)
		return true;
...
BOOL func_221(int iParam0) // Position - 0xD7EF (55279)
{
	const char* string2;
	...
	if (!Global_114344.f_9089 && !func_229(true))
	{
...
BOOL func_222(int iParam0) // Position - 0xD8A8 (55464)
{
	var unk;
...
BOOL func_223(int iParam0) // Position - 0xD969 (55657)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_224(int iParam0, char* sParam1) // Position - 0xD9EE (55790)
{
...
BOOL func_225(int iParam0) // Position - 0xDAD0 (56016)
{
...
BOOL func_226(int iParam0) // Position - 0xDAFB (56059)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_227(int iParam0) // Position - 0xDB26 (56102)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_228(int iParam0) // Position - 0xDB51 (56145)
{
	if (func_192(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_229(BOOL bParam0) // Position - 0xDB86 (56198)
{
...
char* func_230(int iParam0) // Position - 0xDBAE (56238)
{
	switch (iParam0)
	{
		case 0:
...
int func_231(int iParam0) // Position - 0xDC02 (56322)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_232() // Position - 0xDC49 (56393)
{
	BOOL flag;
...
void func_233(char* sParam0) // Position - 0xDD56 (56662)
{
...
BOOL func_234() // Position - 0xDD6C (56684)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_235(BOOL bParam0) // Position - 0xDD88 (56712)
{
	if (bParam0)
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0xDDB1 (56753)
{
...
BOOL func_237(Ped pedParam0) // Position - 0xDDC8 (56776)
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
int func_238(float fParam0) // Position - 0xDDE6 (56806)
{
	int i;
	Vector3 vector;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		vector = { Global_33661[iLocal_285 + i /*23*/][0 /*3*/] };
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0xDE62 (56930)
{
	func_61();
	return Global_114344.f_2367.f_539.f_4321;
}

void func_240(Any* panParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xDE7B (56955)
{
	int num;
	var unk;
	int i;
...
void func_241(Any* panParam0) // Position - 0xE352 (58194)
{
	char* animDict;
...
BOOL func_242(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE5B5 (58805)
{
...
BOOL func_243(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xE609 (58889)
{
	Global_22586 = 0;
...
void func_244() // Position - 0xE8D7 (59607)
{
	if (!func_245())
		return;
...
BOOL func_245() // Position - 0xE90E (59662)
{
...
BOOL func_246(Player plParam0) // Position - 0xE971 (59761)
{
	return func_247(plParam0, 20);
}

BOOL func_247(Player plParam0, int iParam1) // Position - 0xE981 (59777)
{
	return IS_BIT_SET(Global_1888737[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_248() // Position - 0xE999 (59801)
{
	int i;
...
void func_249() // Position - 0xE9CB (59851)
{
...
BOOL func_250() // Position - 0xEA60 (60000)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xEAF9 (60153)
{
	if (func_62(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_252() // Position - 0xEB9B (60315)
{
	int i;
...
BOOL func_253(int iParam0, int iParam1) // Position - 0xEBF3 (60403)
{
	switch (iParam0)
	{
		case 5:
...
void func_254(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEC2B (60459)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xEC81 (60545)
{
...
float func_256(Entity eParam0, Ped pedParam1, BOOL bParam2) // Position - 0xED1C (60700)
{
	Vector3 entityCoords;
...
BOOL func_257(Any* panParam0) // Position - 0xED7A (60794)
{
	func_202();
...
BOOL func_258(Any* panParam0) // Position - 0xEF6F (61295)
{
	func_202();
...
void func_259() // Position - 0xF0AC (61612)
{
	Global_21451 = 0;
	func_260();
	return;
...
void func_260() // Position - 0xF0BC (61628)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23596 = 0;
...
BOOL func_261(Any* panParam0, int iParam1) // Position - 0xF0DD (61661)
{
...
void func_262() // Position - 0xF8C0 (63680)
{
	func_30(&(Global_104903.f_2890), &Global_104903, 0, 1, 1, 0);
	return;
}

BOOL func_263(Any* panParam0) // Position - 0xF8DB (63707)
{
	float num;
...
void func_264(int iParam0, var uParam1) // Position - 0xF969 (63849)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_265(BOOL bParam0) // Position - 0xF9CD (63949)
{
	Vehicle playersLastVehicle;
...
BOOL func_266(int iParam0) // Position - 0xFA64 (64100)
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_234() || Global_113391 || Global_33284 || func_272() || func_253(8, -1) || func_104() || func_271() || func_270() || func_269() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_234() || Global_33284 || func_272() || func_253(8, -1) || func_270() || func_104() || func_271() || func_269() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_234() || Global_113391 || Global_33284 || func_272() || func_253(8, -1) || func_270() || func_104() || func_271() || func_269() || Global_114344.f_7692.f_919[character] == 5 || Global_44922 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_234() || Global_113391 || Global_33284 || func_272() || func_253(8, -1) || func_104() || func_271() || func_269() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_234() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_253(8, -1) || func_269() || func_268() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_234() || Global_33284 || func_272() || func_253(8, -1) || func_271() || func_270() || func_269() || Global_114344.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_234() || func_271() || Global_113391 || Global_33284 || func_272() || Global_45590 || func_253(8, -1) || func_270() || func_268() || func_269() || Global_114344.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_267() // Position - 0x10182 (65922)
{
	return Global_101932.f_1;
}

BOOL func_268() // Position - 0x10190 (65936)
{
	if (Global_98790 != -1)
...
BOOL func_269() // Position - 0x101B3 (65971)
{
...
BOOL func_270() // Position - 0x101CD (65997)
{
	if (Global_80005)
		return true;
...
BOOL func_271() // Position - 0x101F7 (66039)
{
	return Global_101945.f_400 > 0;
}

BOOL func_272() // Position - 0x10208 (66056)
{
	return Global_1575086;
}

void func_273(Any* panParam0, var uParam1) // Position - 0x10214 (66068)
{
...
void func_274(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0x10409 (66569)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_275(int iParam0, BOOL bParam1) // Position - 0x104FA (66810)
{
	if (iParam0 == -1)
		return;
...
int func_276(int iParam0) // Position - 0x10536 (66870)
{
	if (Global_79740 == iParam0)
		if (Global_79741 == -1)
...
void func_277(var uParam0, int iParam1) // Position - 0x1056F (66927)
{
	BOOL flag;
	int i;
...
float func_278(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1060D (67085)
{
	Vector3 entityCoords;
...
BOOL func_279() // Position - 0x10647 (67143)
{
	return Global_99177;
}

void func_280(var uParam0) // Position - 0x10653 (67155)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_281(uParam0);
...
void func_281(var uParam0) // Position - 0x1066A (67178)
{
	BOOL flag;
	int num;
	int i;
...
void func_282(int iParam0) // Position - 0x10752 (67410)
{
	if (iParam0 == -1)
		iParam0 = func_197();
...
BOOL func_283(int iParam0) // Position - 0x1077A (67450)
{
	return Global_113431[iParam0 /*10*/].f_1;
}

void func_284(Any* panParam0) // Position - 0x1078C (67468)
{
	if (*panParam0 == 52)
	{
...
BOOL func_285(Any* panParam0) // Position - 0x107FE (67582)
{
...
void func_286(Any* panParam0) // Position - 0x10838 (67640)
{
	switch (*panParam0)
	{
		case 52:
...
void func_287(Any* panParam0) // Position - 0x108D9 (67801)
{
	char* animDict;
	Hash model;
	Hash model2;
...
BOOL func_288(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10D74 (68980)
{
...
Hash func_289(Hash hParam0, int iParam1, int iParam2) // Position - 0x10E67 (69223)
{
	int num;
	int num2;
	int num3;
...
BOOL func_290(var uParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x10EA5 (69285)
{
	int num;
	int num2;
	int num3;
...
int func_291(Hash hParam0, int iParam1) // Position - 0x1678C (92044)
{
	int price;
	float num;
	int dlcWeaponIndex;
		...
		switch (hParam0)
		{
			...
			case joaat("WEAPON_BULLPUPSHOTGUN"):
				switch (iParam1)
				{
					case joaat("COMPONENT_AT_AR_AFGRIP"):
						price = 4100;
						price = BUILTIN::FLOOR(BUILTIN::TO_FLOAT(price) * Global_262145.f_15085);
						break;
...
float func_292(Hash hParam0, var uParam1, float fParam2) // Position - 0x1A397 (107415)
{
	float num;
	float num2;
	int num3;
...
int func_293(Hash hParam0) // Position - 0x1A475 (107637)
{
	eCharacter character;
	int num;
	int i;
...
int func_294(int iParam0, eCharacter echParam1) // Position - 0x1A6D1 (108241)
{
	int num;
	int num2;
	int num3;
...
int func_295(int iParam0, eCharacter echParam1) // Position - 0x1A7D5 (108501)
{
	return Global_114344.f_19151[echParam1 /*271*/].f_3[iParam0 /*12*/].f_3;
}

float func_296() // Position - 0x1A7F1 (108529)
{
	return Global_101945.f_2107;
}

void func_297(char* sParam0, var uParam1, var uParam2, var uParam3, var uParam4, ePedComponentType epctParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11, BOOL bParam12, int iParam13) // Position - 0x1A800 (108544)
{
...
BOOL func_298() // Position - 0x1AED9 (110297)
{
	return func_299();
}

BOOL func_299() // Position - 0x1AEE5 (110309)
{
	return Global_1586540[189 /*143*/].f_66 == joaat("thruster");
}

ePedComponentType func_300() // Position - 0x1AEFD (110333)
{
	return 1384502824;
}

ePedComponentType func_301() // Position - 0x1AF0A (110346)
{
	return -1576586413;
}

ePedComponentType func_302() // Position - 0x1AF17 (110359)
{
	return joaat("kosatka");
}

int func_303(Hash hParam0) // Position - 0x1AF24 (110372)
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
int func_304(Hash hParam0) // Position - 0x1AF83 (110467)
{
	return func_305(hParam0);
}

int func_305(Hash hParam0) // Position - 0x1AF91 (110481)
{
	switch (hParam0)
	{
		case joaat("WEAPON_UNARMED"):
...
char* func_306(int iParam0, Hash hParam1) // Position - 0x1B5E1 (112097)
{
	int dlcWeaponIndex;
	int i;
	var unk;
...
char* func_307(var uParam0) // Position - 0x1C050 (114768)
{
	return uParam0;
}

BOOL func_308() // Position - 0x1C05A (114778)
{
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x1C077 (114807)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_310(int iParam0) // Position - 0x1C08E (114830)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		switch (iParam0)
...
BOOL func_311(int iParam0) // Position - 0x1C0F0 (114928)
{
	switch (iParam0)
	{
		case joaat("COMPONENT_PISTOL_MK2_CAMO_IND_01"):
...
BOOL func_312() // Position - 0x1C14F (115023)
{
...
int func_313() // Position - 0x1C176 (115062)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int func_314() // Position - 0x1C22C (115244)
{
	int outValue;
	int outValue2;
	Hash statHash;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x1C365 (115557)
{
	int profileSetting;
...
int func_316(Hash hParam0, var uParam1) // Position - 0x1C41D (115741)
{
	int num;
	int num2;
	var unk;
...
int func_317(int iParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x1C799 (116633)
{
	*uParam2 = 1;
	*uParam3 = 0;
	...
	{
		case joaat("WEAPON_BAT"):
			if (!*Global_262145.f_33308 && func_327(iLocal_104, false) || func_318(iParam0, hParam1, -1))
			{
				*uParam2 = 1;
				*uParam3 = 0;
				return 1;
			...
			if (*Global_262145.f_33308 || !func_327(iLocal_104, false))
			{
				*uParam2 = 0;
				*uParam3 = 1;
				return 1;
...
BOOL func_318(int iParam0, Hash hParam1, int iParam2) // Position - 0x1C893 (116883)
{
	int num;
	int num2;
...
int func_319(int iParam0) // Position - 0x1C8C5 (116933)
{
	return iParam0 % 32;
}

int func_320(int iParam0, Hash hParam1) // Position - 0x1C8D2 (116946)
{
	return func_321(iParam0, hParam1);
}

int func_321(int iParam0, int iParam1) // Position - 0x1C8E2 (116962)
{
	switch (iParam1)
	{
		case joaat("WEAPON_PISTOL"):
...
int func_322(int iParam0, Hash hParam1, int iParam2) // Position - 0x1EF01 (126721)
{
	int num;
...
int func_323(int iParam0, Hash hParam1) // Position - 0x1EF1B (126747)
{
	int num;
	int num2;
...
int func_324() // Position - 0x1F09B (127131)
{
	return Global_33282;
}

int func_325(int iParam0) // Position - 0x1F0A6 (127142)
{
	return iParam0 / 32;
}

BOOL func_326() // Position - 0x1F0B3 (127155)
{
	return Global_1575065;
}

BOOL func_327(int iParam0, BOOL bParam1) // Position - 0x1F0BF (127167)
{
	if (iParam0 == 58)
	{
		if (bParam1)
...
BOOL func_328(int iParam0, int iParam1, int iParam2) // Position - 0x1F0E8 (127208)
{
	int num;
	int num2;
...
int func_329(int iParam0, int iParam1, int iParam2) // Position - 0x1F11A (127258)
{
	int num;
...
int func_330(int iParam0, int iParam1) // Position - 0x1F134 (127284)
{
	int num;
	int num2;
...
BOOL func_331(int iParam0) // Position - 0x1F2B7 (127671)
{
	switch (iParam0)
	{
		case 46:
...
BOOL func_332(Hash hParam0) // Position - 0x1F307 (127751)
{
	switch (hParam0)
	{
		case -1916886713:
...
void func_333(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1F324 (127780)
{
	*uParam0 = iParam1;
	uParam0->f_4 = iParam2;
	uParam0->f_6 = iParam3;
...
BOOL func_334(Hash hParam0) // Position - 0x1F343 (127811)
{
...
BOOL func_335(Hash hParam0) // Position - 0x1F367 (127847)
{
	switch (hParam0)
	{
		case joaat("WEAPON_PISTOL_MK2"):
...
BOOL func_336(Hash hParam0, int iParam1) // Position - 0x1F3C6 (127942)
{
	var unk;
	int num;
...
float func_337(float fParam0) // Position - 0x1F3F3 (127987)
{
	return fParam0 * 57.29578f;
}

int func_338(var uParam0) // Position - 0x1F403 (128003)
{
...
BOOL func_339(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1F423 (128035)
{
...
int func_340(var uParam0) // Position - 0x1F461 (128097)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
		return 0;
...
BOOL func_341(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x1F49C (128156)
{
...
Vector3 func_342(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1F51A (128282)
{
	var groundZ;
...
int func_343() // Position - 0x1F560 (128352)
{
...
void func_344(Any* panParam0) // Position - 0x1F58F (128399)
{
	Hash model;
	char* animDict;
...
void func_345(Any* panParam0) // Position - 0x1F866 (129126)
{
	Hash model;
	char* animDict;
...
int func_346() // Position - 0x1FB66 (129894)
{
	return func_347(1182.1375f, -400.4787f, 66.92414f, 8f);
}

int func_347(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1FB86 (129926)
{
	var unk;
...
void func_348(Any* panParam0) // Position - 0x1FBB9 (129977)
{
	Hash model;
	Hash model2;
	Hash model3;
...
void func_349(var uParam0, BOOL bParam1, int iParam2) // Position - 0x1FE85 (130693)
{
	int namedRendertar;
...
void func_350(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1FF04 (130820)
{
	func_165(pobParam0);
...
BOOL func_351(var uParam0) // Position - 0x1FF2B (130859)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
		return true;
...
void func_352(var uParam0) // Position - 0x1FF42 (130882)
{
	*uParam0 = GRAPHICS::REQUEST_SCALEFORM_MOVIE(func_353());
	return;
}

char* func_353() // Position - 0x1FF55 (130901)
{
	return "CELLPHONE_CUTSCENE";
}

int func_354() // Position - 0x1FF61 (130913)
{
	return func_347(911.5349f, 3642.1108f, 31.647379f, 8f);
}

void func_355(Any* panParam0) // Position - 0x1FF81 (130945)
{
	var pedBoneCoords;
	char* animDict;
	int boneId;
...
BOOL func_356(int iParam0) // Position - 0x204A9 (132265)
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		return true;
...
BOOL func_357(int iParam0) // Position - 0x204D6 (132310)
{
	var unk;
	eCharacter character;
...
BOOL func_358(var uParam0, Any* panParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x20527 (132391)
{
	int i;
...
BOOL func_359(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, Any* panParam5) // Position - 0x2058C (132492)
{
	int num;
	char* str;
...
BOOL func_360(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x20604 (132612)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_361(int iParam0) // Position - 0x2067F (132735)
{
...
void func_362(Any* panParam0, BOOL bParam1) // Position - 0x206AC (132780)
{
	func_284(panParam0);
...
void func_363() // Position - 0x20754 (132948)
{
...
int func_364(var uParam0) // Position - 0x2076E (132974)
{
	if (func_163(uParam0))
	{
...
void func_365(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x207A4 (133028)
{
...
void func_366(var uParam0, BOOL bParam1) // Position - 0x207C4 (133060)
{
	func_367(&(uParam0->f_41), bParam1);
	return;
}

void func_367(var uParam0, BOOL bParam1) // Position - 0x207D6 (133078)
{
	int i;
...
void func_368(Object* pobParam0, BOOL bParam1) // Position - 0x20814 (133140)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_369(var uParam0, BOOL bParam1) // Position - 0x2084F (133199)
{
	func_370(&(uParam0->f_35), bParam1);
	return;
}

void func_370(var uParam0, BOOL bParam1) // Position - 0x20861 (133217)
{
	int i;
...
void func_371(Vehicle* pveParam0) // Position - 0x2089E (133278)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_372(Vehicle* pveParam0) // Position - 0x208D6 (133334)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_373(var uParam0, int iParam1) // Position - 0x20972 (133490)
{
	func_374(&(uParam0->f_28), iParam1);
	return;
}

void func_374(var uParam0, int iParam1) // Position - 0x20984 (133508)
{
	int i;
...
void func_375(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x209C5 (133573)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_376(Ped* ppedParam0) // Position - 0x20A15 (133653)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_377(char* sParam0) // Position - 0x20A56 (133718)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_378(var uParam0) // Position - 0x20A68 (133736)
{
	*uParam0 = -1;
...
void func_379() // Position - 0x20A9B (133787)
{
