	...
	while (num == 1)
	{
		...
		switch (iLocal_248)
		{
			...
			case 9:
				...
				{
					if (bLocal_503)
						Global_114289[iLocal_249] = iLocal_502;
					else
...
void func_47(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21DA (8666)
{
