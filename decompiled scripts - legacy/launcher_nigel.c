...
eCharacter func_148(int iParam0, BOOL bParam1) // Position - 0xB726 (46886)
{
	eCharacter character;
	int num;
...
ePedComponentType func_199() // Position - 0xD8F7 (55543)
{
...
void func_222(BOOL bParam0, BOOL bParam1) // Position - 0xE685 (59013)
{
	if (bParam0 == -1)
		return;
...
int func_223(BOOL bParam0) // Position - 0xE6C1 (59073)
{
	if (Global_80276 == bParam0)
		if (Global_80277 == -1)
