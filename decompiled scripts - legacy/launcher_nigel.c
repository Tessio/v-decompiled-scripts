	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114050[num /*10*/].f_9 != -1)
			{
				...
				func_329(&(Global_114050[num /*10*/].f_9));
			}
		}
...
void func_7(BOOL bParam0) // Position - 0xB10 (2832)
{
	Global_65056 = true;
	Global_65059 = 1;
...
BOOL func_15(Hash hParam0) // Position - 0xCE1 (3297)
{
	var outValue;
...
void func_25(ePedComponentType epctParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1AE1 (6881)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, ePedComponentType epctParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x298C (10636)
{
	Vehicle vehicle;
...
int func_28(var uParam0, ePedComponentType epctParam1, Vehicle veParam2, int iParam3) // Position - 0x2A14 (10772)
{
...
eHudColour func_76() // Position - 0x6BF7 (27639)
{
	return Global_33815;
}
...
int func_98() // Position - 0x8C3A (35898)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8C4A (35914)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658293[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8C67 (35943)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8C77 (35959)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8FE1 (36833)
{
	return Global_102538.f_417 > 0;
}

var func_103() // Position - 0x8FF2 (36850)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x9038 (36920)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x90BE (37054)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x90F1 (37105)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9142 (37186)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x91E4 (37348)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9206 (37382)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x921D (37405)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x922A (37418)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9264 (37476)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x929F (37535)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x92DB (37595)
{
	func_58();
	return Global_114963.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x92F4 (37620)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x9357 (37719)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x936D (37741)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x9383 (37763)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x93C5 (37829)
{
...
struct<2> func_120(int iParam0) // Position - 0x93ED (37869)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x983A (38970)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAB12 (43794)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAE58 (44632)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAEFD (44797)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAF98 (44952)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAFBE (44990)
{
	Global_80592 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAFF6 (45046)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xB04F (45135)
{
...
int func_130(Ped pedParam0) // Position - 0xB0D2 (45266)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB103 (45315)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB118 (45336)
{
	int num;
...
int func_133() // Position - 0xB19A (45466)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB1CB (45515)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB1E6 (45542)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB232 (45618)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB27B (45691)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB29B (45723)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB2BC (45756)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB30F (45839)
{
...
BOOL func_141(int iParam0) // Position - 0xB38C (45964)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB3DF (46047)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB4D5 (46293)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB540 (46400)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB57F (46463)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB6CE (46798)
{
	return IS_BIT_SET(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB6E8 (46824)
{
	BOOL flag;
...
eCharacter func_148(int iParam0, BOOL bParam1) // Position - 0xB741 (46913)
{
	eCharacter character;
	int num;
...
BOOL func_149(Player plParam0) // Position - 0xB782 (46978)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB7A4 (47012)
{
...
BOOL func_151() // Position - 0xB7E3 (47075)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_152() // Position - 0xB7F1 (47089)
{
...
void func_153(int iParam0) // Position - 0xB818 (47128)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB83B (47163)
{
...
void func_155() // Position - 0xB878 (47224)
{
	Global_21889 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB888 (47240)
{
...
BOOL func_157() // Position - 0xB8DF (47327)
{
...
void func_158() // Position - 0xB901 (47361)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB916 (47382)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB96E (47470)
{
...
void func_161(Vehicle veParam0) // Position - 0xB9C5 (47557)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB9F1 (47601)
{
...
void func_163() // Position - 0xBB42 (47938)
{
...
void func_164(int iParam0) // Position - 0xBB93 (48019)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xBBC6 (48070)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xBC50 (48208)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xBCC4 (48324)
{
	return IS_BIT_SET(Global_1964670, 5);
}

BOOL func_168(int iParam0) // Position - 0xBCD2 (48338)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xBD29 (48425)
{
	return IS_BIT_SET(Global_1964670, 19);
}

BOOL func_170(int iParam0) // Position - 0xBD38 (48440)
{
...
BOOL func_171(int iParam0) // Position - 0xBD79 (48505)
{
	int num;
...
void func_172(int iParam0) // Position - 0xBDBE (48574)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBDF0 (48624)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBF27 (48935)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBF76 (49014)
{
	return func_176(iParam0, Global_44921);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBF87 (49031)
{
	if (iParam1 == 15)
		return 1;
...
ePedComponentType func_199() // Position - 0xD964 (55652)
{
...
void func_222(BOOL bParam0, BOOL bParam1) // Position - 0xE6F2 (59122)
{
	if (bParam0 == -1)
		return;
...
int func_223(BOOL bParam0) // Position - 0xE72E (59182)
{
	if (Global_80333 == bParam0)
		if (Global_80334 == -1)
...
BOOL func_229(Any* panParam0, BOOL bParam1) // Position - 0xE938 (59704)
{
	...
	if (func_262(*panParam0) || func_260(*panParam0) || Global_80583 == true)
		return true;
...
struct<5> func_294(int iParam0) // Position - 0x12359 (74585)
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_295(&Global_4718592.f_236570[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_236570[1 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_236570[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_236570[2 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_236570[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_236570[3 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_236570[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_236570[4 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_236570[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
ePedComponentType func_295(ePedComponentType epctParam0) // Position - 0x150F4 (86260)
{
	return epctParam0;
}
