...
void main() // Position - 0x0 (0)
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	iLocal_97 = func_382(CHAR_OMEGA);
	sLocal_164 = "Omega";
	sLocal_165 = "FRANKLIN";
	sLocal_174 = "Flying_Saucer";
	uLocal_177 = { 2328.6006f, 2570.337f, 46.808f };
	uLocal_180 = { 90f, 0f, -45.358f };
	hLocal_183 = joaat("prop_cs_power_cell");
	...
	if (func_284())
	{
		...
		while (!func_275(&uLocal_98))
		{
			BUILTIN::WAIT(0);
		}
	
		func_274(&uLocal_98, false, true);
		Global_80583 = false;
	}
	...
	while (true)
	{
		...
		func_256(uLocal_98.f_9, 0, 0, 0, 0, 0);
...
void func_5() // Position - 0x280 (640)
{
	...
	{
		case 0:
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_189, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_45(&pedLocal_188, &uLocal_98.f_35[0]);
			bLocal_354 = false;
			func_31(&uLocal_98, 1, false, false);
			iLocal_160 = 1;
			break;
		...
		case 1:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_188) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), pedLocal_188, true))
						bLocal_354 = _CONVERSATION_ADD_LINE(&uLocal_189, "SCRAPAU", "SCRAP_DOCK", 7, 0, 0, 0);
				}
			}
			break;
...
void func_20() // Position - 0x9B6 (2486)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_21(character) && !func_25(14) || Global_113909)
			{
	...
	switch (iLocal_160)
	{
		case 0:
			...
			if (func_211(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_98.f_28[0], sLocal_164, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Franklin", 0, 0, 0);
				}
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_170[2]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_170[2], uLocal_166[2], 1, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_170[0]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_170[0], uLocal_166[0], 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_170[1]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_170[1], uLocal_166[1], 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_165, 0, 0, 0);
			
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(pedLocal_175, sLocal_174, 2, joaat("p_cs_saucer_01_s"), 0);
				func_203();
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(uLocal_166[0], 0))
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_170[0], true);
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(uLocal_166[1], 0))
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_170[1], true);
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_165, 0))
			...
			if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_175))
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_174, 0)))
					pedLocal_175 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_174, 0));
			else if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_174, 0))
				ENTITY::FREEZE_ENTITY_POSITION(pedLocal_175, true);
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_176) && STREAMING::HAS_MODEL_LOADED(hLocal_183))
				{
					obLocal_176 = OBJECT::CREATE_OBJECT_NO_OFFSET(hLocal_183, uLocal_177, true, true, false, 0);
					ENTITY::SET_ENTITY_ROTATION(obLocal_176, uLocal_180, 2, false);
				}
			
				func_49(18, 0);
				func_222(23, false);
				Global_34066 = iLocal_355;
				iLocal_160 = 2;
			}
			break;
...
{
	if (IS_BIT_SET(Global_102486.f_20, 17))
		return 0;
...
int func_51(int iParam0, int iParam1) // Position - 0x132A (4906)
{
	...
	if (func_61(&Global_4525223))
	{
		if (func_59(&Global_4525223, iParam0))
			return 0;
	
		if (func_52(&Global_4525223, iParam0))
			return 1;
	}
	else
	{
...
void func_55(var uParam0) // Position - 0x1504 (5380)
{
	...
	func_57(uParam0, Global_4525222 - 0.5f);
	return;
}
...
int func_66(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x181B (6171)
{
	...
	if (iParam5 == 0)
	{
		Global_80120[1 /*14*/] = { func_119(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_80120[1 /*14*/] = { func_119(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_80120[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_80120[1 /*14*/] = { func_119(entityModel, 14, unk18[j], -1) };
							func_86(pedParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
							func_109(14);
			...
			{
				Global_80120[1 /*14*/] = { func_119(entityModel, i, func_75(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_80120[1 /*14*/] = { func_119(entityModel, 14, unk59[j], -1) };
			func_86(pedParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
			func_109(14);
...
BOOL func_67(Ped pedParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x202C (8236)
{
	...
	{
		if (!func_183(pedParam0, Global_114963.f_2370.f_539[num /*65*/].f_64, Global_114963.f_2370.f_539[num /*65*/].f_63))
		{
...
{
	Global_80120[1 /*14*/] = { func_119(epctParam0, iParam1, epctParam2, -1) };
...
BOOL func_74(Ped pedParam0, ePedComponentType epctParam1, var uParam2, int iParam3) // Position - 0x2935 (10549)
{
	...
	{
		if (!func_183(pedParam0, Global_114963.f_2370.f_539[num /*65*/].f_61, Global_114963.f_2370.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
			switch (epctParam1)
			{
				...
				case 5:
					func_102(&unk, -99, -99, Global_114963.f_2370.f_539.f_196[0], Global_114963.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (epctParam1)
			{
				...
				case 2:
					func_102(&unk, -99, -99, Global_114963.f_2370.f_539.f_196[1], Global_114963.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (epctParam1)
			{
				...
				case 4:
					func_102(&unk, -99, -99, Global_114963.f_2370.f_539.f_196[2], Global_114963.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_109(int iParam0) // Position - 0x878F (34703)
{
	if (IS_BIT_SET(Global_80120[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_80120[1 /*14*/].f_6, 6))
		func_117(iParam0, Global_80120[1 /*14*/].f_5, Global_80120[1 /*14*/].f_2, 2, Global_80120[1 /*14*/].f_1, 1, 0);
...
void func_110(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x883B (34875)
{
	BOOL flag;
	int offset;
	int num;
	...
	if (func_116(epctParam0, iParam1, &num, &offset, bParam2, bParam3))
	{
		address = func_115(num, flag);
		MISC::SET_BIT(&address, offset);
		func_111(num, address, flag, true);
	}

	return;
}

void func_111(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8883 (34947)
{
	Hash statName;

	if (iParam0 != 16764)
	{
		statName = func_112(iParam0, bParam2);
...
Hash func_112(int iParam0, BOOL bParam1) // Position - 0x88B1 (34993)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_113(bParam1));
}

BOOL func_113(BOOL bParam0) // Position - 0x88C6 (35014)
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_114() // Position - 0x88FA (35066)
{
	return Global_1574928;
}

int func_115(int iParam0, BOOL bParam1) // Position - 0x8906 (35078)
{
	Hash statHash;
	int outValue;
	...
	if (iParam0 != 16764)
	{
		statHash = func_112(iParam0, bParam1);
...
void func_121(int iParam0) // Position - 0xC5FF (50687)
{
	...
	func_122(&Global_80120[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_115(func_125(iParam1, iParam0->f_2), Global_80117);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_115(func_124(iParam1, iParam0->f_2), Global_80117);
			...
			{
				num = func_115(num2, Global_80117);
...
BOOL func_126(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE7CE (59342)
{
	BOOL flag;
	int num;
	int num2;
	...
	if (func_116(epctParam0, iParam1, &num2, &num, bParam2, bParam3))
	{
		num3 = func_115(num2, flag);
...
void func_128(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE8E0 (59616)
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_122(&Global_80120[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_122(&Global_80120[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_122(&Global_80120[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80318)
		{
			...
			func_122(&Global_80120[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_183(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FB5F (129887)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_80120[1 /*14*/] = { func_119(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_183(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_183(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_80120[2 /*14*/] = { func_119(entityModel, 14, k, -1) };
								
									if (Global_80120[2 /*14*/].f_12 == j)
										if (func_183(pedParam0, 14, k))
											if (!func_72(entityModel, epctParam2, 14, k, &unk, &Global_80120[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80120[2 /*14*/] = { func_119(entityModel, i, type, -1) };
					
						if (!func_72(entityModel, epctParam2, i, type, &unk, &Global_80120[2 /*14*/]))
							return false;
					}
				}
			}
...
eCharacter func_188(BOOL bParam0, BOOL bParam1) // Position - 0x1FFB9 (131001)
{
	eCharacter character;
	BOOL flag;
...
void func_206(int iParam0, var uParam1) // Position - 0x20B17 (133911)
{
	switch (iParam0)
	{
		...
		case 5:
			func_207(uParam1, "Barry3A", func_209(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Las zonas donde puedes encontrar un vehículo con un botín oculto aparecen indicadas en el mapa. Recoge estos vehículos para Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 8:
			func_207(uParam1, "Dreyfuss1", func_209(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*Se reveló la identidad y el paradero del asesino.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_208(iParam0), 0, 0);
			break;
		...
		case 38:
			func_207(uParam1, "Nigel1A", func_209(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Se marcaron en el mapa las zonas en las que puedes encontrar objetos de famosos. Róbalos para Nigel y para la señora Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_208(iParam0), 1, 1);
			break;
		...
		case 49:
			func_207(uParam1, "Paparazzo3A", func_209(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Las zonas en las que puedes encontrar oportunidades para sacar fotos a famosos se marcaron en el mapa. Localiza y fotografía a estos famosos para Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 58:
			func_207(uParam1, "Tonya1", func_209(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Puedes encontrar extraños y locos por todo San Andreas en ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
...
void func_223() // Position - 0x228FF (141567)
{
	...
	if (func_225())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_163 && !func_224(PLAYER::PLAYER_PED_ID(), uLocal_98.f_28[0], 5f, true))
		{
			CAM::SET_GAMEPLAY_ENTITY_HINT(uLocal_98.f_28[0], 0f, 0f, 0f, true, 2000, 2500, 2000, 0);
...
BOOL func_225() // Position - 0x229BC (141756)
{
	...
	else if (PED::IS_PED_INJURED(uLocal_98.f_28[0]) || PED::IS_PED_RAGDOLL(uLocal_98.f_28[0]))
	{
		iLocal_161 = 2;
		func_48(4);
		return false;
	...
	{
		if (func_227(uLocal_98.f_28[0], true, 1116471296, 1126825984, false, false, false, false) || func_226(PLAYER::PLAYER_PED_ID(), uLocal_98.f_28[0], true))
		{
...
BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22C06 (142342)
{
	...
	flag = func_231(&iLocal_54[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_54[num /*4*/].f_3), pedParam0, iParam5);
...
void func_245() // Position - 0x233EF (144367)
{
	...
	if (!bLocal_184)
	{
		...
		{
			inLocal_187 = INTERIOR::GET_INTERIOR_AT_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_98.f_35[0], true));
		
			if (INTERIOR::IS_VALID_INTERIOR(inLocal_187))
			{
				INTERIOR::PIN_INTERIOR_IN_MEMORY(inLocal_187);
				bLocal_184 = true;
			}
		}
	}
	...
	{
		if (INTERIOR::IS_INTERIOR_READY(inLocal_187))
			bLocal_185 = true;
	}
	else if (!bLocal_186)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_98.f_35[0]))
		{
			entityCoords = { ENTITY::GET_ENTITY_COORDS(uLocal_98.f_35[0], true) };
			entityHeading = ENTITY::GET_ENTITY_HEADING(uLocal_98.f_35[0]);
			func_39(&uLocal_98.f_35[0]);
			uLocal_98.f_35[0] = VEHICLE::CREATE_VEHICLE(joaat("dune2"), entityCoords, entityHeading, true, true, false);
			INTERIOR::UNPIN_INTERIOR(inLocal_187);
			bLocal_186 = true;
		}
	}
...
void func_254() // Position - 0x236B7 (145079)
{
	...
	STREAMING::REQUEST_MODEL(hLocal_183);
	...
	if (func_225())
	{
		if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			...
			if (func_217(PLAYER::PLAYER_PED_ID()) && func_217(uLocal_98.f_28[0]))
			{
				hLocal_162 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_98.f_28[0], hLocal_162);
			}
		
			iLocal_163 = MISC::GET_GAME_TIMER() + 3500;
			func_255();
			func_48(1);
		}
	}
...
{
	uLocal_170[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2333.23f, 2574.97f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_l"), true, false, true);
	uLocal_170[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2329.65f, 2576.64f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_r"), true, false, true);
	uLocal_166[0] = "Scrap_Door_L";
	uLocal_166[1] = "Scrap_Door_R";
	uLocal_166[2] = "Scrap_Latch";
	return;
}
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_259(Global_80593, Global_80595, iParam10) };
				y == -0.014f;
...
struct<2> func_259(eCharacter echParam0, const char* sParam1, int iParam2) // Position - 0x23AE4 (146148)
{
	var unk;
	eCharacter character;
...
{
	if (!func_270(0) || Global_80608 || Global_80596 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
ePedComponentType func_269(BOOL bParam0) // Position - 0x23FCA (147402)
{
	if (bParam0)
...
{
	return func_272(iParam0, Global_44921);
}
...
void func_285() // Position - 0x247CB (149451)
{
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		func_34(&uLocal_170[i], false);
	}

	func_34(&pedLocal_175, false);
	func_34(&obLocal_176, false);
	func_38(&pedLocal_188);
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314.546f, 2576.3296f, 44.7f, 2326.4463f, 2579.6082f, 47.6645f, true, true);
	func_31(&uLocal_98, 0, false, false);
...
void func_289(int iParam0, BOOL bParam1) // Position - 0x24918 (149784)
{
	...
	{
		func_330(&(Global_114050[num /*10*/].f_9));
	}
...
void func_292() // Position - 0x24B7D (150397)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114963.f_10203.f_3853))
		func_294(13, BUILTIN::FLOOR(Global_114963.f_10203.f_3853));

	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_80337)
		{
			if (func_293() == HUD_COLOUR_BLACK == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
eHudColour func_293() // Position - 0x2503B (151611)
{
	return Global_33815;
}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25097 (151703)
{
	if (bParam2 == -1)
		bParam2 = func_114();
...
{
	func_306(&Global_108504);
	return;
}

void func_306(ePedComponentType epctParam0) // Position - 0x2526A (152170)
{
	int i;
	int j;

	*epctParam0 = 145;
	func_312(&(epctParam0->f_1));
	epctParam0->f_6 = -1;
	epctParam0->f_7 = -1;
	epctParam0->f_8 = 0f;
	epctParam0->f_2 = 0;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		...
		epctParam0->f_17[j] = 0;
		epctParam0->f_21[j] = 0;
		func_311(&epctParam0->f_25[0 /*295*/][j /*98*/]);
		func_311(&epctParam0->f_25[1 /*295*/][j /*98*/]);
	...
	func_310(&(epctParam0->f_2884));
	func_308(&(epctParam0->f_2890));
	func_307(&(epctParam0->f_2980));
	return;
}
...
BOOL func_316(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x25B57 (154455)
{
	...
	{
		unk28 = { func_99(entityModel, PV_COMP_HEAD) };
		Global_80120[1 /*14*/] = { func_119(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_76(iParam1), Global_80120[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_76(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, 0);
	}
...
void func_321(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25E92 (155282)
{
	...
	if (iParam0 != -1)
	{
		...
		func_322(&unk33, unk.f_3, Global_102523, bParam1, bParam2);
	}
...
void func_324() // Position - 0x25F27 (155431)
{
	...
	{
		func_20();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_325(Global_114963.f_2370.f_539.f_4321));
	}
	else
	{
...
void func_329(BOOL bParam0, BOOL bParam1) // Position - 0x25FE1 (155617)
{
...
void func_333(int iParam0) // Position - 0x26536 (156982)
{
	...
	Global_114963.f_18583[iParam0 /*6*/].f_3 = func_334();
...
{
	if (func_293() == -1 || func_293() == 999 && !(func_346() == HUD_COLOUR_PURE_WHITE))
		return true;

	return false;
}

eHudColour func_346() // Position - 0x274B5 (160949)
{
	return Global_33816;
}
	...
	if (offset >= 0 && offset <= 31)
	{
		if (!func_357(iParam0))
		{
			...
			if (!bParam1)
			{
				...
				if (!func_354(68))
					func_351("DI_HLP_STRY" /*Los personajes de la historia se desbloquearán en el modo Director del editor Rockstar conforme avances con la historia de GTA V.*/, 2, 0, 20000, 10000, 7, 0, 208, 0);
			}
		}
	}
...
int func_364() // Position - 0x2B6E8 (177896)
{
	...
	num = func_365(&(Global_102486.f_3), false);
	num2 = 0;
...
BOOL func_368() // Position - 0x2B7BC (178108)
{
	...
	if (Global_102486.f_11 == 5)
		if (func_363(&(Global_102486.f_3)) > -1)
			return true;
