		...
		if (Global_21649.f_1 != 9)
		{
			switch (Global_21649.f_1)
			{
				...
				case 8:
					...
					if (func_11(FRONTEND_CONTROL, Global_21617, 0))
					{
						func_10();
						Global_21627 = true;
...
void func_12() // Position - 0x541 (1345)
{
	...
	{
		if (func_11(FRONTEND_CONTROL, Global_21618, 0))
		{
			func_15();
			Global_21627 = true;
			_UPDATE_CURRENT_PLAYER_CHARACTER();
			...
			Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_259 = uLocal_35[GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_53)];
...
void func_19() // Position - 0x73B (1851)
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		num = 0;
		num2 = 9;
		Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_84[num2] = 5000;
	
		while (num < 9)
		{
			if (Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_124[num] == 1)
			{
				if (unk[num] == 0)
				{
					if (Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_84[num] < Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_84[num2])
					{
						num2 = num;
						func_20(Global_21630, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(13), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_104[num2]), -1f, -1f, &Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_7[num2 /*4*/], 0, 0, 0, 0);
					}
				}
			}
		...
		if (Global_10324[Global_21649 /*2811*/][iLocal_55 /*281*/].f_124[i] == 1)
	...
	if (Global_21637)
	{
		func_20(Global_21630, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*ENTRAR*/, 0, 0, 0, 0);
		func_20(Global_21630, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*VOLVER*/, 0, 0, 0, 0);
	}
	else
	{
...
void func_21() // Position - 0x9F5 (2549)
{
	...
	if (bLocal_61 == false)
	{
		if (func_11(FRONTEND_CONTROL, Global_21625, 0))
		{
			if (iLocal_52 > 0)
				iLocal_52 = iLocal_52 - 1;
		...
		if (func_11(FRONTEND_CONTROL, Global_21626, 0))
		{
			iLocal_52 = iLocal_52 + 1;
...
{
	func_9(Global_21630, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
{
	func_9(Global_21630, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21638, true);
	func_25();
	return;
}
...
void func_26() // Position - 0xB5E (2910)
{
	...
	while (value < 9)
	{
		num = 0;
		num2 = 9;
		Global_10324[Global_21649 /*2811*/][num2 /*281*/] = 5000;
	
		while (num < 9)
		{
			if (Global_10324[Global_21649 /*2811*/][num /*281*/].f_280 == 1)
			{
				if (unk[num] == 0)
				{
					if (num == 0)
					{
						if (Global_10324[Global_21649 /*2811*/][num /*281*/] < Global_10324[Global_21649 /*2811*/][num2 /*281*/])
						{
							num2 = num;
							func_20(Global_21630, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(2), BUILTIN::TO_FLOAT(value), -1f, -1f, -1f, &(Global_10324[Global_21649 /*2811*/][num2 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
		...
		uLocal_35[value] = num2;
		unk[num2] = 1;
	
		if (Global_10324[Global_21649 /*2811*/][value /*281*/].f_280 == 1)
			iLocal_51 = iLocal_51 + 1;
	...
	func_9(Global_21630, "DISPLAY_VIEW", 13f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_13(Global_21630, "SET_HEADER", "CELL_16" /*Configuración*/, 0, 0, 0, 0);
...
void func_30() // Position - 0xDDB (3547)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_31(character) && !func_35(14) || Global_113909)
			{
				if (Global_114963.f_2370.f_539.f_4321 != character && func_31(Global_114963.f_2370.f_539.f_4321))
