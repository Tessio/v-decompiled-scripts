...
BOOL func_22(int iParam0) // Position - 0xA8A (2698)
{
	...
	bitsInRange = MISC::GET_BITS_IN_RANGE(Global_114963.f_10058.f_133, 0, num - 1);
...
struct<5> func_40(int iParam0) // Position - 0x1875 (6261)
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_41(&Global_4718592.f_236570[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_236570[1 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_236570[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_236570[2 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_236570[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_236570[3 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_236570[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_236570[4 /*160*/].f_16 };
			unk.f_3 = func_41(&Global_4718592.f_236570[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
ePedComponentType func_41(ePedComponentType epctParam0) // Position - 0x460F (17935)
{
	return epctParam0;
}
...
{
	return IS_BIT_SET(Global_114963.f_10058.f_133, iParam0);
}
