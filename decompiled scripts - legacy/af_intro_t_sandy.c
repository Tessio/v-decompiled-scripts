...
int func_6(int iParam0) // Position - 0x576 (1398)
{
	...
	for (i = 0; i < Global_114963.f_7697.f_764; i = i + 1)
	{
	...
	for (i = 0; i < Global_114963.f_7697.f_866; i = i + 1)
	{
...
void func_7(int iParam0) // Position - 0x69D (1693)
{
	...
	{
		for (i = iParam0; i <= Global_114963.f_7697.f_866 - 2; i = i + 1)
		{
...
void func_8(int iParam0) // Position - 0x756 (1878)
{
	...
	{
		for (i = iParam0; i <= Global_114963.f_7697.f_764 - 2; i = i + 1)
		{
...
void func_12(int iParam0) // Position - 0x995 (2453)
{
	...
	for (i = 0; i < Global_114963.f_7697.f_198; i = i + 1)
	{
		if (Global_114963.f_7697.f_137[i /*15*/] == iParam0)
		{
			func_13(Global_114963.f_7697.f_137[i /*15*/].f_6);
...
int func_13(int iParam0) // Position - 0xA51 (2641)
{
	...
	{
		if (func_19(iParam0, Global_21649) == 1)
		{
			func_18(iParam0, Global_21649, 0);
		
			if (func_17(iParam0, Global_21649) == 0)
			{
...
void func_15(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xADC (2780)
{
	...
	if (iParam0 < 162)
		Global_114963.f_28060[iParam0 /*29*/].f_24[echParam1] = iParam2;
...
void func_16(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xB21 (2849)
{
	...
	if (iParam0 < 162)
		Global_114963.f_28060[iParam0 /*29*/].f_12[echParam1] = iParam2;
...
void func_18(int iParam0, eCharacter echParam1, int iParam2) // Position - 0xB90 (2960)
{
	...
	if (iParam0 < 162)
		Global_114963.f_28060[iParam0 /*29*/].f_19[echParam1] = iParam2;
...
void func_20(eCharacter echParam0) // Position - 0xBEB (3051)
{
	...
	if (echParam0 < 0 || echParam0 >= Global_114963.f_7697.f_136)
		return;
...
void func_26() // Position - 0xE52 (3666)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(character) && !func_27(14) || Global_113909)
			{
