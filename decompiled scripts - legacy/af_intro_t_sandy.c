...
void func_7(int iParam0) // Position - 0x69D (1693)
{
	...
	if (iParam0 < 0 || iParam0 >= Global_114904.f_7695.f_866)
		return;

	if (Global_114904.f_7695.f_866 > 1)
	{
		for (i = iParam0; i <= Global_114904.f_7695.f_866 - 2; i = i + 1)
		{
...
void func_8(int iParam0) // Position - 0x756 (1878)
{
	...
	if (iParam0 < 0 || iParam0 >= Global_114904.f_7695.f_764)
		return;

	if (Global_114904.f_7695.f_764 > 1)
	{
		for (i = iParam0; i <= Global_114904.f_7695.f_764 - 2; i = i + 1)
		{
...
void func_12(int iParam0) // Position - 0x995 (2453)
{
	...
	for (i = 0; i < Global_114904.f_7695.f_198; i = i + 1)
	{
		if (Global_114904.f_7695.f_137[i /*15*/] == iParam0)
		{
			func_13(Global_114904.f_7695.f_137[i /*15*/].f_6);
...
int func_13(int iParam0) // Position - 0xA51 (2641)
{
	...
	{
		if (func_19(iParam0, Global_21610) == 1)
		{
			func_18(iParam0, Global_21610, 0);
...
void func_20(eCharacter echParam0) // Position - 0xBEB (3051)
{
	...
	if (echParam0 < 0 || echParam0 >= Global_114904.f_7695.f_136)
		return;

	num = Global_114904.f_7695[echParam0 /*15*/].f_2;

	if (Global_114904.f_7695.f_136 > 1)
	{
	...
	if (Global_114904.f_7695.f_136 > 0)
	{
...
void func_26() // Position - 0xE52 (3666)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(character) && !func_27(14) || Global_113852)
			{
