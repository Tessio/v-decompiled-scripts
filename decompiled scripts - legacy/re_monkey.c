...
void func_5(BOOL bParam0, int iParam1) // Position - 0x22E (558)
{
	if (bParam0 == -1)
		bParam0 = func_29();
	...
	if (iParam1 <= func_28(bParam0))
	{
		...
		if (func_13(bParam0, iParam1) != 322)
			func_7(func_13(bParam0, iParam1), uLocal_61, uLocal_61.f_1);
...
eHudColour func_9() // Position - 0x8E3 (2275)
{
	return Global_33815;
}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x93F (2367)
{
	if (bParam2 == -1)
		bParam2 = func_12();
...
BOOL func_12() // Position - 0x95D (2397)
{
	return Global_1574928;
}

int func_13(BOOL bParam0, int iParam1) // Position - 0x969 (2409)
{
	switch (bParam0)
	{
		case false:
...
BOOL func_14(BOOL bParam0) // Position - 0xCDD (3293)
{
	switch (bParam0)
	{
		case 29:
...
void func_27(BOOL bParam0, int iParam1) // Position - 0x1267 (4711)
{
	MISC::SET_BIT(&Global_114963.f_25004.f_8[bParam0], iParam1);
	return;
}

int func_28(BOOL bParam0) // Position - 0x1282 (4738)
{
	int num;
...
BOOL func_29() // Position - 0x1333 (4915)
{
	var unk;
	int num;
...
void func_40(int iParam0) // Position - 0x1B1B (6939)
{
	...
	for (i = CHAR_MICHAEL; i < Global_114963.f_7697.f_198; i = i + 1)
	{
		if (Global_114963.f_7697.f_137[i /*15*/] == iParam0)
		{
			func_41(Global_114963.f_7697.f_137[i /*15*/].f_6);
...
int func_41(eCharacter echParam0) // Position - 0x1BD7 (7127)
{
	...
	{
		if (func_47(echParam0, Global_21649) == 1)
		{
			func_46(echParam0, Global_21649, 0);
		
			if (func_45(echParam0, Global_21649) == 0)
			{
...
{
	switch (func_63(&Global_33875, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
void func_86(BOOL bParam0) // Position - 0x30EF (12527)
{
	if (bParam0 == -1)
		bParam0 = func_29();
...
void func_88(BOOL bParam0) // Position - 0x3162 (12642)
{
...
BOOL func_95(var uParam0, var uParam1, var uParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x32F3 (13043)
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (func_22(_GET_CURRENT_PLAYER_CHARACTER()))
			if (!func_134(bParam3, iParam4, 145))
				return false;
	
		if (!func_133(Global_114963.f_25004.f_43[bParam3]))
			return false;
		...
		if (func_120(bParam3, iParam4) && !bParam5)
			return false;
		...
		if (bParam3 == 9 && iParam4 == 2 || iParam4 == 5 && !func_120(false, 0))
			return false;
...
BOOL func_120(BOOL bParam0, int iParam1) // Position - 0x3ED4 (16084)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_130() || Global_114010 || Global_33818 || func_129() || func_128(8, -1) || func_127() || func_126() || func_125() || func_124() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_130() || Global_33818 || func_129() || func_128(8, -1) || func_125() || func_127() || func_126() || func_124() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_130() || Global_114010 || Global_33818 || func_129() || func_128(8, -1) || func_125() || func_127() || func_126() || func_124() || Global_114963.f_7697.f_919[character] == 5 || Global_45468 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_130() || Global_114010 || Global_33818 || func_129() || func_128(8, -1) || func_127() || func_126() || func_124() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_130() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_128(8, -1) || func_124() || func_123() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
...
ePedComponentType func_129() // Position - 0x46E2 (18146)
{
...
BOOL func_134(BOOL bParam0, int iParam1, eCharacter echParam2) // Position - 0x47E6 (18406)
{
	BOOL num;
	eCharacter character;
...
BOOL func_136(BOOL bParam0) // Position - 0x48EE (18670)
{
	BOOL flag;
	BOOL flag2;
...
void func_138(int iParam0, var uParam1) // Position - 0x49F7 (18935)
{
	switch (iParam0)
	{
		...
		case 5:
			func_139(uParam1, "Barry3A", func_141(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Las zonas donde puedes encontrar un vehículo con un botín oculto aparecen indicadas en el mapa. Recoge estos vehículos para Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_140(iParam0), 0, 1);
			break;
		...
		case 8:
			func_139(uParam1, "Dreyfuss1", func_141(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*Se reveló la identidad y el paradero del asesino.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_140(iParam0), 0, 0);
			break;
		...
		case 38:
			func_139(uParam1, "Nigel1A", func_141(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Se marcaron en el mapa las zonas en las que puedes encontrar objetos de famosos. Róbalos para Nigel y para la señora Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_140(iParam0), 1, 1);
			break;
		...
		case 49:
			func_139(uParam1, "Paparazzo3A", func_141(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Las zonas en las que puedes encontrar oportunidades para sacar fotos a famosos se marcaron en el mapa. Localiza y fotografía a estos famosos para Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_140(iParam0), 0, 1);
			break;
		...
		case 58:
			func_139(uParam1, "Tonya1", func_141(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Puedes encontrar extraños y locos por todo San Andreas en ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_140(iParam0), 0, 1);
			break;
...
void func_151(int iParam0) // Position - 0x650E (25870)
{
	...
	if (func_162())
	{
		...
		func_154(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_153(Global_114952, true), 64);
...
char* func_153(BOOL bParam0, BOOL bParam1) // Position - 0x65FD (26109)
{
	switch (bParam0)
	{
		case false:
