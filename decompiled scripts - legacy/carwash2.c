...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F8A (36746)
{
	int num;
...
int func_118(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, Hash hParam5, int iParam6, int iParam7) // Position - 0x994B (39243)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_119(int iParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4) // Position - 0x9AF8 (39672)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
Hash func_129(int iParam0) // Position - 0x9F08 (40712)
{
	if (iParam0 == 1)
...
void func_222(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xD7A4 (55204)
{
	Hash hash;
	int num;
...
void func_255(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x13345 (78661)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
int func_364(var uParam0, const char* sParam1, Hash hParam2) // Position - 0x2D01E (184350)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_365(const char* sParam0, Hash hParam1) // Position - 0x2D06A (184426)
{
...
BOOL func_377(Hash hParam0) // Position - 0x2D3EA (185322)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
Hash _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x2D40E (185358)
{
	Hash outValue;
