...
void main() // Position - 0x0 (0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		while (iLocal_57 == 0)
		{
			...
			{
				iLocal_57.f_1 = func_45(iScriptParam_0);
	...
	while (true)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1576970 == false || func_28())
			func_25();
...
void func_46() // Position - 0x8474 (33908)
{
	...
	Global_1576985 = Global_1576985 + 1;
	func_47(0, -1, false);
