...
void func_2() // Position - 0xE3 (227)
{
	...
	if (Global_46114 > gameTimer || Global_46114 == -1)
	{
		...
		{
			num5 = Global_46118 - Global_46117;
			Global_46117 = Global_46117 + (num5 * 0.1f);
		...
		if (!func_8(PLAYER::PLAYER_ID()))
		{
			if (!CAM::IS_GAMEPLAY_CAM_SHAKING())
				CAM::SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", Global_46117 * num2 * num4);
			...
			if (MISC::GET_GAME_TIMER() % 100 == 0)
			{
				...
				else
				{
					...
					CAM::SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE(Global_46117 * num2 * num4);
					CAM::SET_GAMEPLAY_CAM_MOTION_BLUR_SCALING_THIS_UPDATE(Global_46116 * num2 * num4);
					fLocal_45 = num2;
				}
			}
		}
	
		if (Global_46116 * num2 * num4 < 1f)
			CAM::SET_GAMEPLAY_CAM_MAX_MOTION_BLUR_STRENGTH_THIS_UPDATE(Global_46116 * num2 * num4);
		else
			CAM::SET_GAMEPLAY_CAM_MAX_MOTION_BLUR_STRENGTH_THIS_UPDATE(1f);
	
		if (!CAM::IS_CINEMATIC_CAM_SHAKING())
			CAM::SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", Global_46117 * Global_46111 * num2 * num4);
	
		CAM::SET_CINEMATIC_CAM_SHAKE_AMPLITUDE(Global_46117 * Global_46111 * num2 * num4);
	
		if (CAM::DOES_CAM_EXIST(Global_46113))
			if (CAM::IS_CAM_SHAKING(Global_46113))
				CAM::SET_CAM_SHAKE_AMPLITUDE(Global_46113, Global_46117 * num2 * num4);
		...
		if (Global_46120 > 0f)
		{
			...
			else
			{
				...
				num6 = Global_46114 - gameTimer;
			
				if (num6 <= Global_46115 / 2 && Global_46114 != -1)
				{
					flag = false;
					...
					{
						Global_46114 = Global_46114 + 1000;
					}
					else if (flag)
					{
						Global_46114 = Global_46114 + 1000;
					...
					else
					{
						if (GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() != -1)
							GRAPHICS::SET_TRANSITION_OUT_OF_TIMECYCLE_MODIFIER(BUILTIN::TO_FLOAT(Global_46115 / 2) / 1000f);
...
float func_14() // Position - 0x71B (1819)
{
	...
	gameTimer = MISC::GET_GAME_TIMER();
	num = 1f;
	value = Global_46114 - gameTimer;

	if (value <= Global_46115)
		if (Global_46114 != -1)
			num = BUILTIN::TO_FLOAT(value) / BUILTIN::TO_FLOAT(Global_46115);
...
void func_16(int iParam0) // Position - 0x76E (1902)
{
	...
	Global_45933[num /*5*/] = func_17();
	Global_45933[num /*5*/].f_1 = Global_45902[iParam0 /*6*/].f_1;
	Global_45933[num /*5*/].f_2 = 0;
	args = { Global_45902[iParam0 /*6*/] };
...
void func_23() // Position - 0x9C6 (2502)
{
	...
	{
		num = func_29(Global_45933[iLocal_33 /*5*/], 0);
...
void func_28(int iParam0) // Position - 0xABC (2748)
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (iParam0 == Global_46014[i /*6*/].f_1)
			func_21(i);
	}
...
int func_29(int iParam0, int iParam1) // Position - 0xAEE (2798)
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (iParam1 == Global_46014[i /*6*/].f_2)
