...
void main() // Position - 0x0 (0)
{
	...
	{
		if (IS_BIT_SET(Global_1690394, 1))
		{
			func_27();
		}
		else
...
int func_4(Any* panParam0) // Position - 0x399 (921)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (func_5(panParam0, &Global_2652579.f_2452[i /*16*/]))
			return i;
	}
...
int func_9(int iParam0) // Position - 0x4BA (1210)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (!func_7(&Global_1912395[iParam0 /*315*/].f_102.f_21[i /*14*/]))
		{
			num = i;
			break;
		}
...
int func_10() // Position - 0x506 (1286)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (!func_7(&Global_2652579.f_2452[i /*16*/]))
		{
			num = i;
			break;
		}
...
eHudColour func_17() // Position - 0x6BB (1723)
{
	return Global_33775;
}
...
BOOL func_24() // Position - 0x849 (2121)
{
	if (func_25())
		return true;
...
BOOL func_25() // Position - 0x864 (2148)
{
...
void func_26() // Position - 0x88F (2191)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_27() // Position - 0x89B (2203)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}
