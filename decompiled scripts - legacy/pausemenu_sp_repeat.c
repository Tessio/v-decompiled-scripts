...
void func_36() // Position - 0xFB5 (4021)
{
	...
	{
		case 1:
			Global_80588 = func_37(&uLocal_47, 1, 0, 1);
			break;
	
		case 7:
			Global_80588 = func_37(&uLocal_47, 0, 1, 1);
			break;
...
{
	if (Global_114963.f_9094.f_330[24 /*6*/] == true || Global_114963.f_9094.f_330[25 /*6*/] == true || Global_114963.f_9094.f_330[26 /*6*/] == true || Global_114963.f_9094.f_330[27 /*6*/] == true)
		return 1;
...
void func_47(int iParam0) // Position - 0x16A7 (5799)
{
	...
	uLocal_45 = { func_79(iParam0, Global_80587) };
	...
	for (i = 0; i < func_76(iParam0, Global_80587); i = i + 1)
	{
		num5 = func_74(iParam0, Global_80587, i);
		flag = true;
		...
		if (!Global_65288[num5 /*13*/].f_7 && flag)
		{
...
void func_53(int iParam0, var uParam1) // Position - 0x19AA (6570)
{
	...
	if (Global_80587 == 7)
	{
		...
		{
			case 52:
				*uParam1 = Global_114963.f_2359[0 /*2*/];
			...
			case 53:
				*uParam1 = Global_114963.f_2359[1 /*2*/];
			...
			case 54:
				*uParam1 = Global_114963.f_2359[2 /*2*/];
			...
			case 55:
				*uParam1 = Global_114963.f_2359[3 /*2*/];
			...
			case 56:
				*uParam1 = Global_114963.f_2359[4 /*2*/];
...
void func_67() // Position - 0x44C5 (17605)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_68(character) && !func_26(14) || Global_113909)
			{
...
int func_73(int iParam0) // Position - 0x4668 (18024)
{
	...
	num = func_72(Global_65288[iParam0 /*13*/].f_4);
...
void func_84() // Position - 0x55B0 (21936)
{
	...
	for (i = 0; i < Global_80588; i = i + 1)
	{
		num2 = 0;
		num3 = 0;
		num7 = -1;
		num = uLocal_47[i /*2*/];
		uLocal_45 = { func_79(num, Global_80587) };
	
		for (j = 0; j < func_76(num, Global_80587); j = j + 1)
		{
			num4 = func_74(num, Global_80587, j);
		
			if (!Global_65288[num4 /*13*/].f_7)
			{
				if (func_64(num4) == 1)
					num3 = num3 + 1;
