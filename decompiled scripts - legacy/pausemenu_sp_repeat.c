		...
		case 2:
			switch (iScriptParam_0.f_1)
			{
				...
				case 76:
					if (Global_80547 != -1)
					{
						func_1(Global_80547, Global_80530);
						func_28(-1);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
								Global_80532 = { ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) };
...
{
	Global_80527 = echParam0;
	Global_80527.f_1 = iParam1;

	if (iParam1 == 7)
		if (echParam0 >= CHAR_MICHAEL && echParam0 < CHAR_MRS_THORNHILL)
			Global_113991[echParam0 /*10*/].f_3 = 1;

	MISC::SET_BIT(&Global_80529, 0);
	return;
}
...
{
	if (Global_114904.f_18581.f_380 > 0)
		return 1;
...
BOOL func_7() // Position - 0x41F (1055)
{
	...
	else if (Global_114904.f_10023.f_21 > 0)
	{
		return 1;
	}
...
BOOL func_12(int iParam0, int iParam1, BOOL bParam2) // Position - 0x634 (1588)
{
	...
	if (bParam2)
		...
		if (func_18() == HUD_COLOUR_PURE_WHITE)
...
BOOL func_15(BOOL bParam0) // Position - 0x6D8 (1752)
{
	BOOL flag;
	BOOL flag2;
...
BOOL func_16() // Position - 0x70C (1804)
{
...
eHudColour func_18() // Position - 0xAFC (2812)
{
	return Global_33775;
}
	...
	if (func_8() == -1)
	{
		if (func_5(Global_80530))
		{
			...
			if (Global_80531 > 16)
			{
				...
				func_34(func_35(iParam0), Global_80531);
			}
		}
	}
...
void func_36() // Position - 0xFB5 (4021)
{
	...
	{
		case 1:
			Global_80531 = func_37(&uLocal_28, 1, 0, 1);
			break;
	
		case 7:
			Global_80531 = func_37(&uLocal_28, 0, 1, 1);
			break;
...
int func_42(int iParam0, int iParam1) // Position - 0x153B (5435)
{
	...
	{
		case 1:
			return Global_114904.f_9092.f_330[iParam0 /*6*/].f_3;
	
		case 7:
			return Global_114904.f_18581[iParam0 /*6*/].f_3;
...
{
	if (Global_114904.f_9092.f_330[24 /*6*/] == true || Global_114904.f_9092.f_330[25 /*6*/] == true || Global_114904.f_9092.f_330[26 /*6*/] == true || Global_114904.f_9092.f_330[27 /*6*/] == true)
		return 1;
...
void func_47(int iParam0) // Position - 0x16A7 (5799)
{
	...
	uLocal_26 = { func_79(iParam0, Global_80530) };
	...
	for (i = 0; i < func_76(iParam0, Global_80530); i = i + 1)
	{
		num5 = func_74(iParam0, Global_80530, i);
		flag = true;
		...
		if (!Global_65235[num5 /*13*/].f_7 && flag)
		{
...
void func_53(int iParam0, var uParam1) // Position - 0x19AA (6570)
{
	...
	if (Global_80530 == 7)
	{
		...
		{
			case 52:
				*uParam1 = Global_114904.f_2359[0 /*2*/];
			...
			case 53:
				*uParam1 = Global_114904.f_2359[1 /*2*/];
			...
			case 54:
				*uParam1 = Global_114904.f_2359[2 /*2*/];
			...
			case 55:
				*uParam1 = Global_114904.f_2359[3 /*2*/];
			...
			case 56:
				*uParam1 = Global_114904.f_2359[4 /*2*/];
...
BOOL func_54(int iParam0, int iParam1, int iParam2) // Position - 0x1A6A (6762)
{
	...
	if (Global_65235[iParam0 /*13*/].f_7)
		return true;

	num = { Global_65235[iParam0 /*13*/] };
...
{
	if (func_65(iParam0, func_72(Global_65235[iParam0 /*13*/].f_4)))
		return 1;
...
void func_67() // Position - 0x44C5 (17605)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114904.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_68(character) && !func_26(14) || Global_113852)
			{
...
int func_73(int iParam0) // Position - 0x4668 (18024)
{
	...
	num = func_72(Global_65235[iParam0 /*13*/].f_4);
...
void func_83(int iParam0, int iParam1, int iParam2) // Position - 0x5516 (21782)
{
	...
	if (Global_80530 != iParam0 || iParam2 == 1)
		num = 1;

	Global_80530 = iParam0;
	func_4(2);
...
void func_84() // Position - 0x55B0 (21936)
{
	...
	for (i = 0; i < Global_80531; i = i + 1)
	{
		num2 = 0;
		num3 = 0;
		num7 = -1;
		num = uLocal_28[i /*2*/];
		uLocal_26 = { func_79(num, Global_80530) };
	
		for (j = 0; j < func_76(num, Global_80530); j = j + 1)
		{
			num4 = func_74(num, Global_80530, j);
		
			if (!Global_65235[num4 /*13*/].f_7)
			{
				if (func_64(num4) == 1)
					num3 = num3 + 1;
