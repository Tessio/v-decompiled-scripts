...
void func_6(int iParam0) // Position - 0x261 (609)
{
	...
	player = Global_1881981.f_7[iParam0 /*8*/].f_2;

	if (Global_1881981.f_7[iParam0 /*8*/].f_1 == 1 && plLocal_122 == player)
	{
		func_27(player, Global_1881981.f_7[iParam0 /*8*/].f_6);
		func_13(iParam0);
	}
...
void func_27(Player plParam0, var uParam1) // Position - 0xCC9 (3273)
{
	if (Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_27 == _INVALID_PLAYER_INDEX())
	{
		...
		{
			Global_1892653[PLAYER::PLAYER_ID() /*615*/].f_10.f_27 = plParam0;
...
void func_33() // Position - 0xDD0 (3536)
{
	...
	player = Global_1881981.f_7[num /*8*/].f_2;
...
void func_51() // Position - 0x12EA (4842)
{
	...
	flag = false;
	num2 = func_31(iLocal_121, 0);
	plLocal_122 = Global_1881981.f_7[num2 /*8*/].f_2;
	player = Global_1881981.f_7[num2 /*8*/].f_2;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21591, "SET_DATA_SLOT");
	...
	if (Global_1881981.f_7[num2 /*8*/] == 0)
	{
		if (Global_262145.f_15456)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (num3 < 3)
				{
					if (Global_1892653[player /*615*/].f_10.f_12[i] != _INVALID_PLAYER_INDEX())
					{
						if (_NETWORK_IS_PLAYER_VALID(Global_1892653[player /*615*/].f_10.f_12[i], false, true))
						{
							unk16[num3] = Global_1892653[player /*615*/].f_10.f_12[i];
							num3 = num3 + 1;
						}
					}
				}
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x1B9D (7069)
{
	var gamerHandle;
...
BOOL func_68(Player plParam0) // Position - 0x1BB4 (7092)
{
	var gamerHandle;
...
BOOL func_71(Player plParam0, int iParam1) // Position - 0x1CD2 (7378)
{
...
const char* func_73(Player plParam0, BOOL bParam1) // Position - 0x1CF4 (7412)
{
	if (!bParam1)
...
BOOL func_75(Player plParam0, BOOL bParam1) // Position - 0x1D2B (7467)
{
	return func_76(plParam0, bParam1, 1);
}

BOOL func_76(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x1D3C (7484)
{
	Player player;
	...
	if (func_30(player) && Global_1892653[player /*615*/].f_10.f_433 == iParam2)
		return 1;

	return 0;
}

BOOL func_77(Player plParam0, int iParam1) // Position - 0x1D98 (7576)
{
	if (func_30(plParam0))
		if (func_30(Global_1892653[plParam0 /*615*/].f_10))
...
int func_78(Player plParam0) // Position - 0x1DE7 (7655)
{
...
BOOL func_79(Player plParam0) // Position - 0x1E0D (7693)
{
	if (!func_30(plParam0))
		return false;
...
eHudColour func_80(Player plParam0) // Position - 0x1E34 (7732)
{
	int num;
...
int func_83(Player plParam0) // Position - 0x1F2E (7982)
{
	if (func_30(plParam0))
		if (func_84(plParam0, true))
			return Global_2649159.f_818.f_11[func_65(plParam0)];

	return -1;
}

BOOL func_84(Player plParam0, BOOL bParam1) // Position - 0x1F5E (8030)
{
	if (!func_30(plParam0))
		return false;
	...
	return func_30(Global_1892653[plParam0 /*615*/].f_10);
}

BOOL func_85(Player plParam0) // Position - 0x1F96 (8086)
{
	if (func_30(plParam0))
		if (func_30(Global_1892653[plParam0 /*615*/].f_10))
...
struct<16> func_86(Player plParam0) // Position - 0x1FCB (8139)
{
	var unk;
