...
void main() // Position - 0x0 (0)
{
	...
	iLocal_119 = 0;
	func_100();
	func_99(Global_21203, "SET_THEME", BUILTIN::TO_FLOAT(5), -1082130432, -1082130432, -1082130432, -1082130432);
	func_89(false);
...
void func_5() // Position - 0x1FA (506)
{
	...
	if (bLocal_121)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, Global_21191))
			bLocal_121 = false;
...
void func_6(int iParam0) // Position - 0x261 (609)
{
	...
	player = Global_1881764.f_7[iParam0 /*8*/].f_2;

	if (Global_1881764.f_7[iParam0 /*8*/].f_1 == 1 && plLocal_120 == player)
	{
		func_27(player, Global_1881764.f_7[iParam0 /*8*/].f_6);
		func_13(iParam0);
	}
...
void func_13(int iParam0) // Position - 0x44F (1103)
{
	...
	if (iParam0 != -1)
	{
		...
		{
			if (IS_BIT_SET(Global_1881764.f_7[iParam0 /*8*/].f_5, 0))
			{
				func_26();
		...
		{
			Global_1881764.f_7[i /*8*/] = { Global_1881764.f_7[i + 1 /*8*/] };
		}
	
		Global_1881764.f_7[9 /*8*/].f_1 = 0;
		Global_1881764.f_7[9 /*8*/].f_2 = _INVALID_PLAYER_INDEX();
	}
...
{
	return IS_BIT_SET(Global_1881764.f_3, iParam0);
}
...
void func_19() // Position - 0x5AD (1453)
{
	if (!Global_21445 && !IS_BIT_SET(Global_9077, 9))
	{
		if (Global_21222.f_1 == 6)
		{
			...
			func_20(1);
			func_99(Global_21203, "DISPLAY_VIEW", 1f, BUILTIN::TO_FLOAT(Global_21202), -1082130432, -1082130432, -1082130432);
		}
	}
...
{
	if (Global_1888737[PLAYER::PLAYER_ID() /*611*/].f_10.f_26 == _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
		{
			Global_1888737[PLAYER::PLAYER_ID() /*611*/].f_10.f_26 = plParam0;
...
int func_31(int iParam0, int iParam1) // Position - 0xD84 (3460)
{
	...
	{
		if (Global_1881764.f_7[i /*8*/].f_7 == iParam1)
		{
			iParam0 = iParam0 - 1;
...
void func_33() // Position - 0xDD0 (3536)
{
	...
	player = Global_1881764.f_7[num /*8*/].f_2;
	...
	if (func_36(&uLocal_122))
	{
		...
		else if (Global_1881764.f_7[num /*8*/] == 0)
		{
			func_6(num);
		}
		else if (Global_1881764.f_7[num /*8*/] == 1)
		{
			func_34(num);
		}
		else
...
BOOL func_36(var uParam0) // Position - 0xEC6 (3782)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21191))
		return false;
...
BOOL func_41(var uParam0) // Position - 0xFCE (4046)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21192))
		return false;
...
void func_43(var uParam0) // Position - 0x1034 (4148)
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21198) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_SCROLL_BACKWARD))
	{
		func_46();
		uParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}

	if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21199) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CELLPHONE_SCROLL_FORWARD))
	{
		func_44();
		uParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
...
{
	func_99(Global_21203, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
{
	func_99(Global_21203, "SET_INPUT_EVENT", BUILTIN::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_21211, true);
	func_47();
	return;
}
...
void func_49() // Position - 0x11C1 (4545)
{
	...
	if (func_36(&uLocal_122))
	{
		...
		switch (Global_1881764.f_7[num /*8*/].f_1)
		{
			case 0:
				return;
	...
	if (func_40(&uLocal_122))
	{
		...
		switch (Global_1881764.f_7[num2 /*8*/].f_1)
		{
			case 0:
				return;
...
void func_51() // Position - 0x12EA (4842)
{
	...
	func_99(Global_21203, "SET_DATA_SLOT_EMPTY", BUILTIN::TO_FLOAT(26), -1082130432, -1082130432, -1082130432, -1082130432);
	flag = false;
	num2 = func_31(iLocal_119, 0);
	plLocal_120 = Global_1881764.f_7[num2 /*8*/].f_2;
	player = Global_1881764.f_7[num2 /*8*/].f_2;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21203, "SET_DATA_SLOT");
	...
	if (Global_1881764.f_7[num2 /*8*/] == 0)
	{
		if (Global_262145.f_15367)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (num3 < 3)
				{
					if (Global_1888737[player /*611*/].f_10.f_11[i] != _INVALID_PLAYER_INDEX())
					{
						if (_NETWORK_IS_PLAYER_VALID(Global_1888737[player /*611*/].f_10.f_11[i], false, true))
						{
							unk16[num3] = Global_1888737[player /*611*/].f_10.f_11[i];
							num3 = num3 + 1;
						}
					}
				}
		...
		{
			if (Global_1881764.f_88[num2 /*5*/].f_1)
				if (Global_1881764.f_88[num2 /*5*/].f_2)
			...
			else if (Global_1881764.f_88[num2 /*5*/].f_2)
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1881764.f_88[num2 /*5*/]);
			HUD::ADD_TEXT_COMPONENT_INTEGER(func_78(player));
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1881764.f_88[num2 /*5*/].f_3);
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1881764.f_88[num2 /*5*/].f_4);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		}
	}
	else if (Global_1881764.f_7[num2 /*8*/] == 1)
	{
		...
		HUD::SET_COLOUR_OF_NEXT_TEXT_COMPONENT(func_80(Global_1881764.f_7[num2 /*8*/].f_2));
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_63(Global_1881764.f_7[num2 /*8*/].f_2));
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	}

	if (flag)
	{
		num = func_57(Global_1881764.f_7[num2 /*8*/].f_2);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_99(Global_21203, "DISPLAY_VIEW", BUILTIN::TO_FLOAT(26), -1082130432, -1082130432, -1082130432, -1082130432);
	func_55(&uLocal_111);
...
void func_53(int iParam0, int iParam1, const char* sParam2, int iParam3, int* piParam4, int iParam5) // Position - 0x1669 (5737)
{
	if (iParam1 == 1)
	{
		func_21(Global_21203, "SET_SOFT_KEYS", BUILTIN::TO_FLOAT(iParam0), 0f, BUILTIN::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	...
	if (Global_21210)
	{
		func_21(Global_21203, "SET_SOFT_KEYS", BUILTIN::TO_FLOAT(iParam0), 1f, BUILTIN::TO_FLOAT(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
		MISC::SET_BIT(piParam4, iParam3);
		func_54(iParam5, true);
		return;
	}

	func_21(Global_21203, "SET_SOFT_KEYS", BUILTIN::TO_FLOAT(iParam0), 1f, BUILTIN::TO_FLOAT(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
	MISC::SET_BIT(piParam4, iParam3);
	func_54(iParam5, true);
	return;
}
...
BOOL func_76(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x1D3C (7484)
{
	...
	if (func_30(player) && Global_1888737[player /*611*/].f_10.f_431 == iParam2)
		return 1;
...
{
	if (func_30(plParam0))
		if (func_30(Global_1888737[plParam0 /*611*/].f_10))
...
int func_83(Player plParam0) // Position - 0x1F2E (7982)
{
	if (func_30(plParam0))
		if (func_84(plParam0, true))
			return Global_2648929.f_818.f_11[func_65(plParam0)];
...
BOOL func_84(Player plParam0, BOOL bParam1) // Position - 0x1F5E (8030)
{
	...
	return func_30(Global_1888737[plParam0 /*611*/].f_10);
}
...
void func_89(BOOL bParam0) // Position - 0x202E (8238)
{
	...
	func_90();
	func_99(Global_21203, "DISPLAY_VIEW", BUILTIN::TO_FLOAT(25), BUILTIN::TO_FLOAT(value), -1082130432, -1082130432, -1082130432);
...
void func_90() // Position - 0x2118 (8472)
{
	...
	func_99(Global_21203, "SET_DATA_SLOT_EMPTY", BUILTIN::TO_FLOAT(25), -1082130432, -1082130432, -1082130432, -1082130432);

	for (i = 0; i < func_32(); i = i + 1)
	{
		if (Global_1881764.f_7[i /*8*/].f_1 == 1 && Global_1881764.f_7[i /*8*/].f_7 == 0)
		{
			switch (Global_1881764.f_7[i /*8*/])
			{
				case 0:
					if (func_94(i, num))
						num = num + 1;
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x222B (8747)
{
	...
	if (Global_1881764.f_7[iParam0 /*8*/].f_2 == _INVALID_PLAYER_INDEX() || !_NETWORK_IS_PLAYER_VALID(Global_1881764.f_7[iParam0 /*8*/].f_2, false, true))
		return false;

	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21203, "SET_DATA_SLOT");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(25);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	unk = { func_86(Global_1881764.f_7[iParam0 /*8*/].f_2) };
	func_93(&unk);
	...
	num = func_83(Global_1881764.f_7[iParam0 /*8*/].f_2);
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x22E8 (8936)
{
	...
	unk = { func_86(Global_1881764.f_7[iParam0 /*8*/].f_2) };
	func_93(&unk);
	flag = func_79(Global_1881764.f_7[iParam0 /*8*/].f_2);
	value = func_78(Global_1881764.f_7[iParam0 /*8*/].f_2);
...
int func_98() // Position - 0x25B0 (9648)
{
	...
	for (i = 0; i < func_32(); i = i + 1)
	{
		if (Global_1881764.f_7[i /*8*/].f_7 == 1)
			num = num + 1;
	}
