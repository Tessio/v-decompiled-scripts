...
void main() // Position - 0x0 (0)
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_43452[i /*8*/], "", 32);
	}
		...
		else
		{
			...
			switch (iLocal_96)
			{
				...
				case 1:
					...
					if (func_107())
					{
						if (!func_106(9) || Global_113668.f_19 == 4)
						{
							func_83();
...
void func_2() // Position - 0x1E3 (483)
{
	if (func_10())
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_200[0]))
		{
			...
			{
				uLocal_200[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_x17dlc_rep_sign_01a"), 2222.883f, 5612.299f, 55.291f, false, false, true, 0);
				ENTITY::SET_ENTITY_ROTATION(uLocal_200[0], 0.5f, 0f, 15.325f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_200[0], true);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("xm_prop_x17dlc_rep_sign_01a"));
			}
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(uLocal_200[0]))
	{
	...
	if (func_3())
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_200[1]))
		{
			...
			{
				uLocal_200[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_base_cabinet_door_01"), -362.402f, 4829.89f, 142.477f, false, false, true, 0);
				ENTITY::SET_ENTITY_ROTATION(uLocal_200[1], 0f, 0f, 320f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_200[1], true);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("xm_prop_base_cabinet_door_01"));
			}
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(uLocal_200[1]))
	{
...
BOOL func_3() // Position - 0x2FD (765)
{
	...
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		if (func_8(*Global_4718592.f_132931) == 14 || func_8(*Global_4718592.f_132931) == 15)
			return false;
...
BOOL func_4(ePedComponentType epctParam0) // Position - 0x381 (897)
{
...
BOOL func_6(ePedComponentType epctParam0) // Position - 0x3F0 (1008)
{
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x421 (1057)
{
...
int func_8(ePedComponentType epctParam0) // Position - 0x481 (1153)
{
	if (epctParam0 == Global_262145.f_4708[0])
		return 0;
	else if (epctParam0 == Global_262145.f_4708[1])
		return 1;
	else if (epctParam0 == Global_262145.f_4708[2])
		return 2;
	else if (epctParam0 == Global_262145.f_4708[3])
		return 3;
	else if (epctParam0 == Global_262145.f_4708[4])
		return 4;
	else if (epctParam0 == Global_262145.f_4708[5])
		return 5;
	else if (epctParam0 == Global_262145.f_4708[6])
		return 6;
	else if (epctParam0 == Global_262145.f_4708[7])
		return 7;
	else if (epctParam0 == Global_262145.f_4708[8])
		return 8;
	else if (epctParam0 == Global_262145.f_4708[9])
		return 9;
	else if (epctParam0 == Global_262145.f_4708[10])
		return 10;
	else if (epctParam0 == Global_262145.f_4708[11])
		return 11;
	else if (epctParam0 == Global_262145.f_4708[12])
		return 12;
	else if (epctParam0 == Global_262145.f_4708[13])
		return 13;
	else if (epctParam0 == Global_262145.f_4708[14])
		return 14;
	else if (epctParam0 == Global_262145.f_4708[15])
		return 15;

	return -1;
}

BOOL func_9() // Position - 0x5F7 (1527)
{
	return Global_33815;
}
...
BOOL func_11(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x627 (1575)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (bParam1 || _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658293[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
				return func_12(Global_2658293[epctParam0 /*468*/].f_325.f_8) == 33;

	return false;
}

int func_12(ePedComponentType epctParam0) // Position - 0x676 (1654)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
void func_13() // Position - 0xBC6 (3014)
{
	int i;
	var iplName;
	BOOL flag;
	...
	if (!bLocal_195 && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_48())
	{
		if (!Global_1836288)
		{
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_48())
	{
		if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() || func_44())
		{
			if (!Global_1836289)
			{
				...
				if (!IS_BIT_SET(*Global_4718592.f_189721, 14))
		...
		else if (IS_BIT_SET(*Global_4718592.f_189721, 13))
		{
			if (!STREAMING::IS_IPL_ACTIVE("xm_siloentranceclosed_x17"))
				STREAMING::REQUEST_IPL("xm_siloentranceclosed_x17");
		...
		if (IS_BIT_SET(Global_1950702.f_1864, 8))
		{
			STREAMING::REMOVE_IPL("Coroner_Int_on");
			STREAMING::REQUEST_IPL("Coroner_Int_off");
			MISC::CLEAR_BIT(&(Global_1950702.f_1864), 8);
		}
		...
		if (!Global_1836298)
		{
			...
			if (func_42(*Global_4718592.f_132931) == 3)
		...
		if (!Global_1836292)
		{
			if (IS_BIT_SET(Global_1950702.f_5, 18))
			...
			if (IS_BIT_SET(Global_1950702.f_5, 19))
			{
		...
		if (!Global_1836303)
		{
			...
			if (*Global_262145.f_36138 && !STREAMING::IS_IPL_ACTIVE("m24_2_airstrip"))
			...
			if (!Global_1836304)
			{
				...
				if (CUTSCENE::IS_CUTSCENE_ACTIVE() || CUTSCENE::IS_CUTSCENE_PLAYING() || NETWORK::NETWORK_IS_IN_MP_CUTSCENE() && !func_40(PLAYER::PLAYER_ID()) && !func_39(PLAYER::PLAYER_ID()) && !func_38(PLAYER::PLAYER_ID()) && Global_1950702.f_5187 == -1 && Global_1950702.f_5187.f_1 == -1)
					flag = true;
			
				if (Global_2686119.f_3512.f_163 == 2 && Global_2686119.f_3512.f_23 == 0)
					flag2 = 1;
		...
		if (!Global_1836305)
		{
			...
			if (*Global_262145.f_36820 && !NETWORK::NETWORK_IS_ACTIVITY_SESSION())
			{
		...
		if (!Global_1836306)
		{
			...
			if (!func_27())
			{
				...
				if (!func_40(PLAYER::PLAYER_ID()) && !func_11(PLAYER::PLAYER_ID(), true) && !func_26(PLAYER::PLAYER_ID(), 33) && !func_25())
				{
		...
		if (!Global_1836307)
		{
			if (!STREAMING::IS_IPL_ACTIVE("m26_1_mp2026_01_additions_exterior") && !IS_BIT_SET(Global_2686119.f_6526, 23))
			{
				STREAMING::REQUEST_IPL("m26_1_mp2026_01_additions_exterior");
				MISC::CLEAR_BIT(&(Global_2686119.f_6526), 27);
			}
			else if (!IS_BIT_SET(Global_2686119.f_6526, 27))
			{
				func_21(227, true);
				func_21(226, true);
				MISC::SET_BIT(&(Global_2686119.f_6526), 27);
			}
		
			if (!STREAMING::IS_IPL_ACTIVE("m26_1_mp2026_01_additions_exterior_cctv") && !IS_BIT_SET(Global_2686119.f_6526, 24))
				STREAMING::REQUEST_IPL("m26_1_mp2026_01_additions_exterior_cctv");
		
			if (!STREAMING::IS_IPL_ACTIVE("m26_1_mp2026_01_additions_exterior_maintenance") && !IS_BIT_SET(Global_2686119.f_6526, 25))
				STREAMING::REQUEST_IPL("m26_1_mp2026_01_additions_exterior_maintenance");
		
			if (!STREAMING::IS_IPL_ACTIVE("m26_1_mp2026_01_additions_kortz_lowerbarriers_up") && !IS_BIT_SET(Global_2686119.f_6526, 26))
				STREAMING::REQUEST_IPL("m26_1_mp2026_01_additions_kortz_lowerbarriers_up");
		}
	}
	...
	else if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && !func_48())
	{
		func_14();
		bLocal_197 = false;
	}

	if (bLocal_198 && func_48())
	{
		func_14();
		bLocal_198 = false;
	}
	...
	if (bLocal_199)
	{
		if (!Global_1836288 && func_48() && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
		{
...
void func_14() // Position - 0x21E4 (8676)
{
	int i;
...
void func_15(int iParam0, BOOL bParam1) // Position - 0x2206 (8710)
{
	int i;
	...
	if (func_20(iParam0))
	{
		...
		if (!bParam1)
		{
			if (Global_2739529.f_93[iParam0])
			{
				Global_2739529.f_93[iParam0] = false;
				Global_2739529.f_136 = Global_2739529.f_136 + -1;
			}
		
			if (Global_2739529.f_136 <= false)
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_17());
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_16());
				Global_2739529.f_136 = 0;
			}
		}
	}
...
Hash func_16() // Position - 0x2282 (8834)
{
	return joaat("apa_mp_apa_yacht");
}

Hash func_17() // Position - 0x228F (8847)
{
	return joaat("apa_mp_apa_yacht_win");
}

char* func_18(int iParam0, int iParam1) // Position - 0x229C (8860)
{
	return func_19(&Global_4280768[iParam0 /*45*/].f_15[iParam1 /*8*/]);
}

char* func_19(char* sParam0) // Position - 0x22B6 (8886)
{
	return sParam0;
}

BOOL func_20(int iParam0) // Position - 0x22C0 (8896)
{
...
void func_21(int iParam0, BOOL bParam1) // Position - 0x22DE (8926)
{
	Vector3 vector;

	vector = { func_22(iParam0) };
	...
	if (bParam1)
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(vector.f_5, 4, true, true);

	return;
}

struct<7> func_22(int iParam0) // Position - 0x2320 (8992)
{
	var unk;
...
void func_23() // Position - 0x4F9B (20379)
{
...
void func_24() // Position - 0x4FBE (20414)
{
...
BOOL func_25() // Position - 0x4FE1 (20449)
{
	return Global_1950702.f_5247 != PV_COMP_INVALID;
}

BOOL func_26(Player plParam0, int iParam1) // Position - 0x4FF2 (20466)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && Global_2635562.f_2983)
		if (IS_BIT_SET(Global_2658293[plParam0 /*468*/].f_325, 1) && Global_2658293[plParam0 /*468*/].f_325.f_17 != PV_COMP_INVALID)
			return iParam1 == func_12(Global_2658293[plParam0 /*468*/].f_325.f_17);

	return false;
}

BOOL func_27() // Position - 0x504F (20559)
{
	if (*Global_262145.f_37373)
		return false;

	if (func_37(PLAYER::PLAYER_ID()) || NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !_IS_FMMC_ACTIVE() || !func_28() || *Global_262145.f_37372)
		return true;

	return false;
}

BOOL func_28() // Position - 0x50A7 (20647)
{
	if (!func_29())
		return false;
...
BOOL func_29() // Position - 0x50BC (20668)
{
	if (Global_1574613)
		return true;
...
BOOL func_30(int iParam0, int iParam1) // Position - 0x50EC (20716)
{
	Hash statHash;
	int outValue;
...
Hash func_31(int iParam0, int iParam1) // Position - 0x5110 (20752)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_32(iParam1));
}

int func_32(int iParam0) // Position - 0x5125 (20773)
{
	int num;
	int num2;
...
int func_33() // Position - 0x5159 (20825)
{
	return Global_1574928;
}

BOOL func_34() // Position - 0x5165 (20837)
{
	return Global_1575083;
}

BOOL func_35() // Position - 0x5171 (20849)
{
	return Global_1575085;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x517D (20861)
{
	return Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_185 != 0;
}

BOOL func_37(Player plParam0) // Position - 0x5194 (20884)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	return IS_BIT_SET(Global_1882652[plParam0 /*321*/].f_158.f_43.f_1, 11);
}

BOOL func_38(Player plParam0) // Position - 0x51BB (20923)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return Global_2658293[plParam0 /*468*/].f_325.f_20 != PV_COMP_INVALID;

	return false;
}

BOOL func_39(Player plParam0) // Position - 0x51E0 (20960)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_2658293[plParam0 /*468*/].f_325, 5);

	return false;
}

BOOL func_40(Player plParam0) // Position - 0x5203 (20995)
{
...
void func_41() // Position - 0x5234 (21044)
{
...
int func_42(int iParam0) // Position - 0x5250 (21072)
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (iParam0 == func_43(i))
			return i;
	}
...
int func_43(int iParam0) // Position - 0x527C (21116)
{
	if (iParam0 != -1)
...
BOOL func_44() // Position - 0x529B (21147)
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		return func_46();

	return func_45(*Global_4718592.f_132931);
}

BOOL func_45(ePedComponentType epctParam0) // Position - 0x52BF (21183)
{
	int i;
...
BOOL func_46() // Position - 0x52F9 (21241)
{
	return Global_2685152.f_20;
}

void func_47() // Position - 0x5307 (21255)
{
...
BOOL func_48() // Position - 0x53AD (21421)
{
	return Global_2698802;
}

void func_49() // Position - 0x53B9 (21433)
{
	int num;
	Vector3 vector;
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_40249[i] != 0 || Global_40258[i] != 0)
			flag = false;
	}
	...
	if (func_54(num) && !MISC::ARE_STRINGS_EQUAL(&Global_41212, vector.f_3))
	{
		flag2 = false;
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (PLAYER::PLAYER_ID() > -1)
				if (IS_BIT_SET(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140, 8))
					flag2 = true;
...
void func_50(int iParam0, BOOL bParam1) // Position - 0x558F (21903)
{
	char* string2;
	Interior interior;
	...
	string2 = "NULL";
	interior = 0;
	string2 = func_51(iParam0, &interior);
...
char* func_51(int iParam0, var uParam1) // Position - 0x563B (22075)
{
	Vector3 vector;

	vector = { func_58(iParam0) };
	*uParam1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vector, vector.f_3);
	return vector.f_4;
}

void func_52(int iParam0, BOOL bParam1) // Position - 0x5660 (22112)
{
	int offset;

	offset = { func_53(iParam0) };
...
struct<2> func_53(int iParam0) // Position - 0x56A3 (22179)
{
	int num;
...
BOOL func_54(int iParam0) // Position - 0x56D0 (22224)
{
	int num;
...
void func_55(int iParam0, BOOL bParam1) // Position - 0x5701 (22273)
{
	char* string2;
	Interior interior;
	Interior interiorFromPrimaryView;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x57C8 (22472)
{
	int offset;
...
BOOL func_57(int iParam0) // Position - 0x580B (22539)
{
	int num;
...
struct<5> func_58(int iParam0) // Position - 0x583C (22588)
{
	var unk;
	var unk6;
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_60(&Global_4718592.f_236570[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_236570[1 /*160*/].f_16 };
			unk.f_3 = func_60(&Global_4718592.f_236570[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_236570[2 /*160*/].f_16 };
			unk.f_3 = func_60(&Global_4718592.f_236570[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_236570[3 /*160*/].f_16 };
			unk.f_3 = func_60(&Global_4718592.f_236570[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_236570[4 /*160*/].f_16 };
			unk.f_3 = func_60(&Global_4718592.f_236570[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
BOOL func_59(float fParam0, var uParam1, var uParam2) // Position - 0x85D7 (34263)
{
...
var func_60(var uParam0) // Position - 0x8601 (34305)
{
	return uParam0;
}

struct<6> func_61(int iParam0, BOOL bParam1) // Position - 0x860B (34315)
{
	var unk;
...
void func_62() // Position - 0x91C1 (37313)
{
	...
	{
		fLocal_83 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_43615[iLocal_81 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true);
	}
	else
	{
		distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_43615[iLocal_81 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true);
	
		if (distanceBetweenCoords < fLocal_83)
		{
			fLocal_83 = distanceBetweenCoords;
			iLocal_82 = iLocal_81;
		}
	}
	...
	if (!bLocal_85)
	{
		if (Global_43615[iLocal_84 /*31*/].f_24 == 0)
		{
			iLocal_86 = 0;
		...
		else
		{
			...
			if (iLocal_86 >= Global_43615[iLocal_84 /*31*/].f_24)
			{
				iLocal_86 = 0;
				iLocal_84 = iLocal_84 + 1;
...
void func_63(int iParam0) // Position - 0x92BE (37566)
{
	int i;
	Ped ped;
	BOOL flag;
	...
	if (IS_BIT_SET(iLocal_95, iParam0))
		return;

	MISC::SET_BIT(&iLocal_95, iParam0);

	if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 4))
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
				if (!IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 6))
					func_70(iParam0, true);
			else if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 6))
	...
	if (Global_43615[iParam0 /*31*/].f_24 > 0)
	{
		for (i = 0; i < Global_43615[iParam0 /*31*/].f_24; i = i + 1)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(ped))
				func_69(iParam0, ped, true);
		}
	}

	if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 6) || IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 5) || func_67(iParam0))
	{
		func_66(iParam0);
		iLocal_84 = iParam0;
	
		if (Global_43615[iParam0 /*31*/] == -1735618852 || Global_43615[iParam0 /*31*/] == 213039352 || Global_43615[iParam0 /*31*/] == -1247364148 || Global_43615[iParam0 /*31*/] == 935592315 || Global_43615[iParam0 /*31*/] == 179480401 || Global_43615[iParam0 /*31*/] == -804938986 || Global_43615[iParam0 /*31*/] == -599111730 || Global_43615[iParam0 /*31*/] == 1423193534 || Global_43615[iParam0 /*31*/] == -1958174046)
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_43615[iParam0 /*31*/], true);
	
		if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 7))
			func_65(iParam0, true);
	
		if (!IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 1))
			{
				if (Global_43615[iParam0 /*31*/].f_22 > -1f)
				{
					Global_43615[iParam0 /*31*/].f_22 = Global_43615[iParam0 /*31*/].f_22 - (Global_43615[iParam0 /*31*/].f_23 * BUILTIN::TIMESTEP());
				
					if (Global_43615[iParam0 /*31*/].f_22 < -1f)
						Global_43615[iParam0 /*31*/].f_22 = -1f;
				
					MISC::CLEAR_BIT(&(Global_43615[iParam0 /*31*/].f_1), 3);
				}
				else
				{
					MISC::SET_BIT(&(Global_43615[iParam0 /*31*/].f_1), 2);
				}
			}
			else if (Global_43615[iParam0 /*31*/].f_22 < 1f)
			{
				Global_43615[iParam0 /*31*/].f_22 = Global_43615[iParam0 /*31*/].f_22 + (Global_43615[iParam0 /*31*/].f_23 * BUILTIN::TIMESTEP());
			...
			OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_43615[iParam0 /*31*/], Global_43615[iParam0 /*31*/].f_22, false, false);
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_43615[iParam0 /*31*/], 1, false, true);
		}
		else if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 1))
		{
			if (Global_43615[iParam0 /*31*/].f_22 > -1f)
				MISC::CLEAR_BIT(&(Global_43615[iParam0 /*31*/].f_1), 2);
		}
		else if (Global_43615[iParam0 /*31*/].f_22 < 1f)
		{
			MISC::CLEAR_BIT(&(Global_43615[iParam0 /*31*/].f_1), 2);
	...
	else
	{
		...
		if (!IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 3))
		{
			flag = false;
			closestVehicle = VEHICLE::GET_CLOSEST_VEHICLE(Global_43615[iParam0 /*31*/].f_2, 15f, 0, 2175);
		
			if (ENTITY::DOES_ENTITY_EXIST(closestVehicle))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(closestVehicle, false))
				{
					num = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(closestVehicle, true), Global_43615[iParam0 /*31*/].f_2);
				
					if (num < Global_43615[iParam0 /*31*/].f_7)
						flag = true;
				}
			}
			...
			if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 1))
			{
				if (Global_43615[iParam0 /*31*/].f_22 < 0f)
				{
					if (!flag)
					{
						Global_43615[iParam0 /*31*/].f_22 = Global_43615[iParam0 /*31*/].f_22 + (Global_43615[iParam0 /*31*/].f_23 * BUILTIN::TIMESTEP());
						...
						if (Global_43615[iParam0 /*31*/].f_22 > 0f)
							Global_43615[iParam0 /*31*/].f_22 = 0f;
				...
				{
					Global_43615[iParam0 /*31*/].f_22 = 0f;
					MISC::SET_BIT(&(Global_43615[iParam0 /*31*/].f_1), 3);
				}
			}
			else if (Global_43615[iParam0 /*31*/].f_22 > 0f)
			{
				if (!flag)
				{
					Global_43615[iParam0 /*31*/].f_22 = Global_43615[iParam0 /*31*/].f_22 - (Global_43615[iParam0 /*31*/].f_23 * BUILTIN::TIMESTEP());
		...
		{
			if (Global_43615[iParam0 /*31*/] == -1735618852 || Global_43615[iParam0 /*31*/] == 213039352 || Global_43615[iParam0 /*31*/] == -1247364148 || Global_43615[iParam0 /*31*/] == 935592315 || Global_43615[iParam0 /*31*/] == 179480401 || Global_43615[iParam0 /*31*/] == -804938986 || Global_43615[iParam0 /*31*/] == -599111730 || Global_43615[iParam0 /*31*/] == 1423193534 || Global_43615[iParam0 /*31*/] == -1958174046)
				AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_43615[iParam0 /*31*/], false);
...
void func_64(int iParam0) // Position - 0x982E (38958)
{
	int i;
	BOOL flag;
	int num;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (flag)
		{
			uLocal_90[i - 1] = uLocal_90[i];
		}
		else if (uLocal_90[i] == iParam0)
		{
...
void func_65(int iParam0, BOOL bParam1) // Position - 0x987A (39034)
{
	int num;
	BOOL flag;
	Vehicle closestVehicle;
	...
	if (Global_43615[iParam0 /*31*/] == -1298870201)
		num = 23;
	else if (Global_43615[iParam0 /*31*/] == 65926040)
		num = 22;
	else if (Global_43615[iParam0 /*31*/] == 1423193534)
		num = 26;
	else if (Global_43615[iParam0 /*31*/] == -1958174046)
		num = 25;

	if (bParam1)
	{
		if (!IS_BIT_SET(Global_43615[num /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_43615[num /*31*/].f_1, 1))
			{
				if (Global_43615[num /*31*/].f_22 > -1f)
				{
					Global_43615[num /*31*/].f_22 = Global_43615[num /*31*/].f_22 - (Global_43615[num /*31*/].f_23 * BUILTIN::TIMESTEP());
				
					if (Global_43615[num /*31*/].f_22 < -1f)
						Global_43615[num /*31*/].f_22 = -1f;
				
					MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 3);
				}
				else
				{
					MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 2);
				}
			}
			else if (Global_43615[num /*31*/].f_22 < 1f)
			{
				Global_43615[num /*31*/].f_22 = Global_43615[num /*31*/].f_22 + (Global_43615[num /*31*/].f_23 * BUILTIN::TIMESTEP());
			...
			OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_43615[num /*31*/], Global_43615[num /*31*/].f_22, false, false);
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_43615[num /*31*/], 1, false, true);
		}
		else if (IS_BIT_SET(Global_43615[num /*31*/].f_1, 1))
		{
			if (Global_43615[num /*31*/].f_22 > -1f)
				MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 2);
		}
		else if (Global_43615[num /*31*/].f_22 < 1f)
		{
			MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 2);
	...
	else if (!IS_BIT_SET(Global_43615[num /*31*/].f_1, 3))
	{
		flag = false;
		closestVehicle = VEHICLE::GET_CLOSEST_VEHICLE(Global_43615[num /*31*/].f_2, 15f, 0, 2175);
	
		if (ENTITY::DOES_ENTITY_EXIST(closestVehicle))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(closestVehicle, false))
			{
				num2 = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(closestVehicle, true), Global_43615[num /*31*/].f_2);
			
				if (num2 < Global_43615[num /*31*/].f_7)
					flag = true;
			}
		}
		...
		if (IS_BIT_SET(Global_43615[num /*31*/].f_1, 1))
		{
			if (Global_43615[num /*31*/].f_22 < 0f)
			{
				if (!flag)
				{
					Global_43615[num /*31*/].f_22 = Global_43615[num /*31*/].f_22 + (Global_43615[num /*31*/].f_23 * BUILTIN::TIMESTEP());
			...
			{
				Global_43615[num /*31*/].f_22 = 0f;
				MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 3);
			}
		}
		else if (Global_43615[num /*31*/].f_22 > 0f)
		{
			if (!flag)
			{
				Global_43615[num /*31*/].f_22 = Global_43615[num /*31*/].f_22 - (Global_43615[num /*31*/].f_23 * BUILTIN::TIMESTEP());
...
void func_66(int iParam0) // Position - 0x9BC5 (39877)
{
	int i;

	if (iLocal_89 < uLocal_90)
	{
		for (i = 0; i < iLocal_89; i = i + 1)
		{
			if (uLocal_90[i] == iParam0)
				return;
		}
	
		uLocal_90[iLocal_89] = iParam0;
		iLocal_89 = iLocal_89 + 1;
	}
...
BOOL func_67(int iParam0) // Position - 0x9C03 (39939)
{
	int i;
	Ped ped;
	...
	if (Global_43615[iParam0 /*31*/].f_24 > 0)
	{
		for (i = 0; i < Global_43615[iParam0 /*31*/].f_24; i = i + 1)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(ped))
			{
				...
				{
					if (BUILTIN::VDIST2(Global_43615[iParam0 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(ped, true)) < Global_43615[iParam0 /*31*/].f_6)
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ped, Global_43615[iParam0 /*31*/].f_9, Global_43615[iParam0 /*31*/].f_12, Global_43615[iParam0 /*31*/].f_8, false, true, 0))
						{
							iLocal_86 = i;
							return true;
						}
					
						if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 0))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ped, Global_43615[iParam0 /*31*/].f_16, Global_43615[iParam0 /*31*/].f_19, Global_43615[iParam0 /*31*/].f_15, false, true, 0))
							{
								iLocal_86 = i;
								return true;
							}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(ped, false))
						{
							...
							minimum = { func_68() };
							maximum = { func_68() };
							offsetFromEntityInWorldCoords = { func_68() };
							offsetFromEntityInWorldCoords2 = { func_68() };
							...
							if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, Global_43615[iParam0 /*31*/].f_9, Global_43615[iParam0 /*31*/].f_12, Global_43615[iParam0 /*31*/].f_8, false, true))
							{
								iLocal_86 = i;
								return true;
							}
						
							if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords2, Global_43615[iParam0 /*31*/].f_9, Global_43615[iParam0 /*31*/].f_12, Global_43615[iParam0 /*31*/].f_8, false, true))
							{
								iLocal_86 = i;
								return true;
							}
							...
							if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 0))
							{
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, Global_43615[iParam0 /*31*/].f_16, Global_43615[iParam0 /*31*/].f_19, Global_43615[iParam0 /*31*/].f_15, false, true))
								{
									iLocal_86 = i;
									return true;
								}
							
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords2, Global_43615[iParam0 /*31*/].f_16, Global_43615[iParam0 /*31*/].f_19, Global_43615[iParam0 /*31*/].f_15, false, true))
								{
									iLocal_86 = i;
									return true;
								}
							...
							if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(vehiclePedIsIn))
							{
								...
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(trailer, Global_43615[iParam0 /*31*/].f_9, Global_43615[iParam0 /*31*/].f_12, Global_43615[iParam0 /*31*/].f_8, false, true, 0))
									{
										iLocal_86 = i;
										return true;
									}
									...
									if (IS_BIT_SET(Global_43615[iParam0 /*31*/].f_1, 0))
									{
										if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(trailer, Global_43615[iParam0 /*31*/].f_16, Global_43615[iParam0 /*31*/].f_19, Global_43615[iParam0 /*31*/].f_15, false, true, 0))
										{
											iLocal_86 = i;
											return true;
										}
...
Vector3 func_68() // Position - 0x9EB8 (40632)
{
	var unk;
...
void func_69(int iParam0, Ped pedParam1, BOOL bParam2) // Position - 0x9EC4 (40644)
{
	int i;
	BOOL flag;
...
void func_70(int iParam0, BOOL bParam1) // Position - 0x9F80 (40832)
{
	if (bParam1)
		MISC::SET_BIT(&(Global_43615[iParam0 /*31*/].f_1), 6);
	else
		MISC::CLEAR_BIT(&(Global_43615[iParam0 /*31*/].f_1), 6);

	return;
}

void func_71(int iParam0) // Position - 0x9FAC (40876)
{
			...
			switch (iParam0)
			{
				case 13:
					if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
						if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[78 /*34*/].f_6) == 0)
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_43615[13 /*31*/].f_2, true) <= 100f)
								if (!func_82(13, PLAYER::PLAYER_PED_ID()))
									func_81(13, PLAYER::PLAYER_PED_ID());
							else if (func_82(13, PLAYER::PLAYER_PED_ID()))
								func_69(13, PLAYER::PLAYER_PED_ID(), false);
					else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[78 /*34*/].f_6) == 0)
						if (func_82(13, PLAYER::PLAYER_PED_ID()))
							func_69(13, PLAYER::PLAYER_PED_ID(), false);
					break;
				...
				case 17:
				case 16:
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[9 /*34*/].f_6) == 0 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("extreme2")) == 0)
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_43615[17 /*31*/].f_2, true) <= 100f)
						{
							switch (_GET_CURRENT_PLAYER_CHARACTER())
							{
								case CHAR_MICHAEL:
									if (func_74(12, 5))
									{
										if (!func_82(17, PLAYER::PLAYER_PED_ID()))
											func_81(17, PLAYER::PLAYER_PED_ID());
									
										if (!func_82(16, PLAYER::PLAYER_PED_ID()))
											func_81(16, PLAYER::PLAYER_PED_ID());
									}
									else
									{
										if (func_82(17, PLAYER::PLAYER_PED_ID()))
											func_69(17, PLAYER::PLAYER_PED_ID(), false);
									
										if (func_82(16, PLAYER::PLAYER_PED_ID()))
											func_69(16, PLAYER::PLAYER_PED_ID(), false);
									}
									break;
				...
				case 22:
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_43615[22 /*31*/].f_2, true) <= 100f)
					{
						switch (_GET_CURRENT_PLAYER_CHARACTER())
						{
							case CHAR_MICHAEL:
								if (func_74(12, 5))
								{
									if (!func_82(22, PLAYER::PLAYER_PED_ID()))
										func_81(22, PLAYER::PLAYER_PED_ID());
								
									if (!func_82(23, PLAYER::PLAYER_PED_ID()))
										func_81(23, PLAYER::PLAYER_PED_ID());
								}
								else
								{
									if (func_82(22, PLAYER::PLAYER_PED_ID()))
										func_69(22, PLAYER::PLAYER_PED_ID(), false);
								
									if (func_82(23, PLAYER::PLAYER_PED_ID()))
										func_69(23, PLAYER::PLAYER_PED_ID(), false);
								}
								break;
				...
				case 14:
				case 15:
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[27 /*34*/].f_6) == 0)
					{
						if (func_82(14, PLAYER::PLAYER_PED_ID()))
							func_69(14, PLAYER::PLAYER_PED_ID(), false);
					
						if (func_82(15, PLAYER::PLAYER_PED_ID()))
							func_69(15, PLAYER::PLAYER_PED_ID(), false);
					}
					break;
				...
				case 24:
					if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 480.4354f, -1317.9095f, 29.5957f) < 400f)
						if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[8 /*34*/].f_6) == 0 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[10 /*34*/].f_6) == 0)
							if (func_82(24, PLAYER::PLAYER_PED_ID()))
								if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != INTERIOR::GET_INTERIOR_AT_COORDS(480.4354f, -1317.9095f, 29.5957f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 486.86005f, -1316.6035f, 27.719374f, 484.8906f, -1312.6472f, 31.723122f, 4.25f, false, true, 0))
									func_69(24, PLAYER::PLAYER_PED_ID(), false);
								...
								func_81(24, PLAYER::PLAYER_PED_ID());
						else if (!func_82(24, PLAYER::PLAYER_PED_ID()))
							func_81(24, PLAYER::PLAYER_PED_ID());
					break;
			
				case 25:
				case 26:
					if (!func_82(25, PLAYER::PLAYER_PED_ID()))
						func_81(25, PLAYER::PLAYER_PED_ID());
				
					if (!func_82(26, PLAYER::PLAYER_PED_ID()))
						func_81(26, PLAYER::PLAYER_PED_ID());
					break;
			
				case 4:
					if (!func_82(4, PLAYER::PLAYER_PED_ID()))
					{
						switch (_GET_CURRENT_PLAYER_CHARACTER())
						{
							case CHAR_MICHAEL:
								if (BUILTIN::VDIST2(Global_43615[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
									func_81(4, PLAYER::PLAYER_PED_ID());
								break;
						
							case CHAR_FRANKLIN:
								if (func_73(2))
									if (func_73(17))
										if (func_73(19) || func_72(19))
											if (BUILTIN::VDIST2(Global_43615[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
												func_81(4, PLAYER::PLAYER_PED_ID());
									else if (BUILTIN::VDIST2(Global_43615[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
										func_81(4, PLAYER::PLAYER_PED_ID());
								break;
...
BOOL func_72(int iParam0) // Position - 0xA6E1 (42721)
{
	int i;
...
BOOL func_73(int iParam0) // Position - 0xA749 (42825)
{
	if (iParam0 == 94 || iParam0 == -1)
		return false;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0xA775 (42869)
{
	if (iParam0 == -1)
		return false;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xA795 (42901)
{
	func_76();
	return Global_114963.f_2370.f_539.f_4321;
}

void func_76() // Position - 0xA7AE (42926)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_77(character) && !func_106(14) || Global_113909)
			{
				if (Global_114963.f_2370.f_539.f_4321 != character && func_77(Global_114963.f_2370.f_539.f_4321))
...
BOOL func_77(eCharacter echParam0) // Position - 0xA8AB (43179)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xA8B7 (43191)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xA8F4 (43252)
{
...
Hash func_80(eCharacter echParam0) // Position - 0xA919 (43289)
{
	return Global_2349[echParam0 /*29*/];
}

void func_81(int iParam0, Ped pedParam1) // Position - 0xA928 (43304)
{
	int i;
	Ped ped;
	BOOL flag;
...
BOOL func_82(int iParam0, Ped pedParam1) // Position - 0xA9DA (43482)
{
	int i;
...
void func_83() // Position - 0xAA13 (43539)
{
	var unk;
	int i;
	...
	unk = 228;
	unk.f_230 = 8;
	func_105(&Global_41220, &unk);
	func_84(iLocal_79);

	for (i = 0; i < unk.f_229; i = i + 1)
	{
		if (unk[i] != iLocal_79)
			func_84(unk[i]);
	}
...
void func_84(int iParam0) // Position - 0xAA73 (43635)
{
	if (IS_BIT_SET(Global_40278[iParam0 / 32], iParam0 % 32) && Global_40745[iParam0] != 2 && !IS_BIT_SET(Global_40516[iParam0 / 32], iParam0 % 32))
	{
		Global_40287[iParam0] = Global_40287[iParam0] - 1;
	
		if (Global_40287[iParam0] <= 0)
		{
			MISC::CLEAR_BIT(&Global_40278[iParam0 / 32], iParam0 % 32);
			Global_40287[iParam0] = 0;
		}
	}
	else
	{
...
void func_85(int iParam0) // Position - 0xAAF1 (43761)
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
	...
	if (IS_BIT_SET(Global_40278[iParam0 / 32], iParam0 % 32) && Global_40745[iParam0] == 2 && distanceBetweenCoords > 210f)
	{
		MISC::CLEAR_BIT(&Global_40278[iParam0 / 32], iParam0 % 32);
		Global_40287[iParam0] = 0;
	}
	...
	{
		if (IS_BIT_SET(Global_40516[iParam0 / 32], iParam0 % 32))
		{
			if (distanceBetweenCoords < 25f)
			{
				...
				{
					MISC::SET_BIT(&Global_40278[iParam0 / 32], iParam0 % 32);
					Global_40745[iParam0] = 3;
					MISC::SET_BIT(&Global_40269[iParam0 / 32], iParam0 % 32);
				}
			}
		
			MISC::CLEAR_BIT(&Global_40516[iParam0 / 32], iParam0 % 32);
		}
	}

	if (IS_BIT_SET(Global_40278[iParam0 / 32], iParam0 % 32))
	{
		num = Global_40745[iParam0];
	}
	...
	{
		num = Global_114963.f_7268[iParam0];
	}

	if (Global_40974[iParam0] != num)
		flag = true;

	if (IS_BIT_SET(Global_40269[iParam0 / 32], iParam0 % 32))
		if (!IS_BIT_SET(Global_40278[iParam0 / 32], iParam0 % 32) || Global_40287[iParam0] == 0 && Global_40745[iParam0] != 2)
			flag = true;
	...
	if (flag)
	{
		...
		if (flag2)
		{
			MISC::CLEAR_BIT(&Global_40269[iParam0 / 32], iParam0 % 32);
			Global_40974[iParam0] = num;
		}
	}

	if (IS_BIT_SET(Global_40278[iParam0 / 32], iParam0 % 32) && Global_40745[iParam0] != 2)
	{
		MISC::SET_BIT(&Global_40269[iParam0 / 32], iParam0 % 32);
		func_86(iParam0);
	
		if (Global_40287[iParam0] < 2)
			Global_40287[iParam0] = Global_40287[iParam0] + 1;
	}
...
void func_86(int* piParam0) // Position - 0xAFB7 (44983)
{
	if (!IS_BIT_SET(Global_41220.f_230[piParam0 / 32], piParam0 % 23))
	{
		MISC::SET_BIT(&Global_41220.f_230[piParam0 / 32], piParam0 % 23);
		Global_41220[Global_41220.f_229] = piParam0;
...
BOOL func_87() // Position - 0xB002 (45058)
{
	if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		return false;
...
int func_88(int iParam0) // Position - 0xB081 (45185)
{
	eCharacter character;
...
BOOL func_89(int iParam0) // Position - 0xB2A9 (45737)
{
	Hash entityModel;
	...
	if (iParam0 == 40 || iParam0 == 49 || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				entityModel = ENTITY::GET_ENTITY_MODEL(func_90(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), true)));
...
Vehicle func_90(Vehicle veParam0) // Position - 0xB315 (45845)
{
	return veParam0;
}

void func_91(int iParam0, var uParam1) // Position - 0xB31F (45855)
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_92(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[26 /*34*/].f_6) == 0)
			{
				Global_114963.f_7268[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114963.f_7268[iParam0], true, true);
			}
...
BOOL func_92(int iParam0) // Position - 0xBCB7 (48311)
{
	var unk;
	int doorState;
...
int func_93(int iParam0) // Position - 0xBCEB (48363)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_94() // Position - 0xBCFE (48382)
{
	var unk;
...
void func_95(var uParam0, int iParam1) // Position - 0xBD44 (48452)
{
	if (iParam1 <= 0)
		return;
...
void func_96(var uParam0, int iParam1) // Position - 0xBDCA (48586)
{
...
void func_97(var uParam0, int iParam1) // Position - 0xBDFD (48637)
{
	int num;
	int num2;
...
int func_98(int iParam0, int iParam1) // Position - 0xBE4E (48718)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_99(int iParam0) // Position - 0xBEF0 (48880)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_100(BOOL bParam0, var uParam1, var uParam2) // Position - 0xBF12 (48914)
{
	if (bParam0)
		return uParam1;
...
int func_101(int iParam0) // Position - 0xBF29 (48937)
{
	return iParam0 & 15;
}

void func_102(var uParam0, int iParam1) // Position - 0xBF36 (48950)
{
...
void func_103(var uParam0, int iParam1) // Position - 0xBF70 (49008)
{
...
void func_104(var uParam0, int iParam1) // Position - 0xBFAB (49067)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_105(var uParam0, var uParam1) // Position - 0xBFE7 (49127)
{
	*uParam1 = { *uParam0 };
	uParam1->f_229 = uParam0->f_229;
	uParam0->f_229 = 0;
	uParam0->f_230 = { uParam1->f_230 };
	return;
}

BOOL func_106(int iParam0) // Position - 0xC015 (49173)
{
	return Global_44921 == iParam0;
}

BOOL func_107() // Position - 0xC023 (49187)
{
	if (func_9() == -1 || func_9() == 999 && !(func_108() == 0))
		return true;

	return false;
}

int func_108() // Position - 0xC053 (49235)
{
	return Global_33816;
}

void func_109() // Position - 0xC05E (49246)
{
	int i;
	int j;
	int k;
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
	{
		for (i = 0; i < 10; i = i + 1)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_43533[i /*8*/]))
			{
				if (!STREAMING::IS_IPL_ACTIVE(&Global_43533[i /*8*/]))
					STREAMING::REQUEST_IPL(&Global_43533[i /*8*/]);
			
				TEXT_LABEL_ASSIGN_STRING(&Global_43533[i /*8*/], "", 32);
			}
		}
	}
	...
	if (Global_42654)
	{
		for (j = 0; j < 198; j = j + 1)
		{
			func_113(&uLocal_99, j);
			func_112(&uLocal_99, j, Global_41857[j]);
			func_110(&uLocal_99, j, Global_41857[j]);
			Global_42854[j] = false;
		}
	...
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		for (l = 0; l < 10; l = l + 1)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_43452[l /*8*/]))
			{
				if (STREAMING::IS_IPL_ACTIVE(&Global_43452[l /*8*/]))
					STREAMING::REMOVE_IPL(&Global_43452[l /*8*/]);
			
				TEXT_LABEL_ASSIGN_STRING(&Global_43452[l /*8*/], "", 32);
			}
		}
	}
...
void func_110(var uParam0, int iParam1, int iParam2) // Position - 0xC20B (49675)
{
	if (!func_111(uParam0->f_79, 0f, 0f, 0f, false))
	{
		if (iParam2 == 0)
		{
			if (Global_42655[iParam1])
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_43252[iParam1], false);
				Global_42655[iParam1] = false;
			}
		}
		else if (iParam2 == 1 || iParam2 == 2)
		{
			if (!Global_42655[iParam1])
			{
				Global_43252[iParam1] = PED::ADD_SCENARIO_BLOCKING_AREA(uParam0->f_79, uParam0->f_82, false, true, true, true, 1);
				Global_42655[iParam1] = true;
			}
		}
	}
...
BOOL func_111(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC28C (49804)
{
	if (bParam6)
...
void func_112(var uParam0, int iParam1, int iParam2) // Position - 0xC2D3 (49875)
{
	if (!func_111(uParam0->f_58, 0f, 0f, 0f, false) && !func_111(uParam0->f_61, 0f, 0f, 0f, false))
	...
	if (!func_111(uParam0->f_68, 0f, 0f, 0f, false))
	{
		if (uParam0->f_75[iParam2])
		{
			if (!Global_42255[iParam1])
			{
				Global_42056[iParam1] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uParam0->f_68, uParam0->f_71, uParam0->f_74, false, 7);
				Global_42255[iParam1] = true;
			}
		}
		else if (Global_42255[iParam1])
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Global_42056[iParam1]);
			Global_42255[iParam1] = false;
		}
	}

	if (!func_111(uParam0->f_85, 0f, 0f, 0f, false) && !func_111(uParam0->f_88, 0f, 0f, 0f, false))
...
int func_113(var uParam0, int iParam1) // Position - 0xC3F8 (50168)
{
	int i;
...
BOOL func_114(int iParam0) // Position - 0xFAEB (64235)
{
	BOOL flag;
	BOOL num;
	...
	if (Global_41658[iParam0] || !func_107() && !Global_42454[iParam0])
	{
		if (func_118(iParam0, false, 0, false))
		{
			num = 1;
			Global_1925981 = 0;
		}
	...
	if (Global_41857[iParam0] == 1)
	{
		func_113(&uLocal_99, iParam0);
		flag = true;
	
		if (uLocal_99.f_33)
			if (MISC::GET_HASH_KEY(&uLocal_99.f_8[2 /*8*/]) != MISC::GET_HASH_KEY(""))
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), uLocal_99, true) > 250f)
					func_115(iParam0, 2, 0, true, 0);
	}

	if (Global_43053[iParam0])
	{
		if (!flag)
		{
			func_113(&uLocal_99, iParam0);
		...
		func_112(&uLocal_99, iParam0, Global_41857[iParam0]);
		Global_43053[iParam0] = false;
	}

	if (Global_42854[iParam0])
	{
		if (!flag)
		{
			func_113(&uLocal_99, iParam0);
		...
		func_110(&uLocal_99, iParam0, Global_41857[iParam0]);
		Global_42854[iParam0] = false;
	}

	return num;
}

void func_115(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xFBF3 (64499)
{
	if (iParam0 != 198)
	{
		if (Global_80337)
		...
		func_118(iParam0, bParam3, iParam4, false);
...
void func_116(int iParam0, int iParam1) // Position - 0xFC4B (64587)
{
	switch (iParam0)
	{
		case 12:
...
void func_117(int iParam0, BOOL bParam1) // Position - 0xFD34 (64820)
{
	if (bParam1)
...
BOOL func_118(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xFD5D (64861)
{
	BOOL flag;
	int num;
	int num2;
...
void func_119() // Position - 0x1069A (67226)
{
	int i;
	var unk;
	...
	if (Global_40268)
	{
		...
		for (i = 0; i < 27; i = i + 1)
		{
			if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_43615[i /*31*/]))
				OBJECT::REMOVE_DOOR_FROM_SYSTEM(Global_43615[i /*31*/], 0);
		}
	}
...
void func_120() // Position - 0x1070D (67341)
{
	if (!bLocal_98 && IS_BIT_SET(Global_114963.f_9094.f_2[27 /*3*/], 2))
	{
		bLocal_98 = true;
		bLocal_97 = true;
	}

	if (bLocal_97 && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && STREAMING::GET_PLAYER_SWITCH_STATE() == 5)
	{
		...
		if (func_107())
		{
			func_122("prologue_DistantLights");
			func_122("prologue_LODLights");
		}
		else
		{
...
void func_121(BOOL bParam0) // Position - 0x109E1 (68065)
{
	int i;
	int zoneFromNameId;

	if (!(bParam0 == Global_40246))
	{
		i = 0;
	
		for (i = 0; i < 263; i = i + 1)
		{
			MISC::SET_BIT(&(Global_34195[i /*23*/].f_11), 18);
		}
...
void func_122(char* sParam0) // Position - 0x10A45 (68165)
{
	int i;
	Hash hashKey;
	Hash hashKey2;
	...
	else
	{
		...
		for (i = 0; i < 10; i = i + 1)
		{
			hashKey2 = MISC::GET_HASH_KEY(&Global_43452[i /*8*/]);
		...
		if (!flag && num != -1)
			TEXT_LABEL_ASSIGN_STRING(&Global_43452[num /*8*/], sParam0, 32);
	}

	return;
}

void func_123() // Position - 0x10AC2 (68290)
{
	int i;
	int j;
	...
	Global_41220.f_229 = 0;

	for (i = 0; i < 228; i = i + 1)
	{
		MISC::SET_BIT(&Global_40269[i / 32], i % 32);
		Global_40287[i] = 0;
		MISC::CLEAR_BIT(&Global_40278[i / 32], i % 32);
		Global_40745[i] = 0;
		Global_40974[i] = 1;
		MISC::SET_BIT(&Global_40516[i / 32], i % 32);
	}

	for (i = 0; i < 198; i = i + 1)
	{
		Global_41459[i] = false;
	
		if (Global_42255[i])
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Global_42056[i]);
			Global_42255[i] = false;
		}
	
		if (Global_42655[i])
		{
			PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_43252[i], false);
			Global_42655[i] = false;
		}
	
		Global_42454[i] = false;
	}
	...
	for (j = 0; j < 10; j = j + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_43533[j /*8*/], "", 32);
	}
...
void func_124() // Position - 0x10CE0 (68832)
{
...
void func_125() // Position - 0x10DC0 (69056)
{
	OBJECT::CLEAR_EXTENDED_PICKUP_PROBE_AREAS();
	return;
}

void func_126(int iParam0) // Position - 0x10DCC (69068)
{
	int i;
...
void func_127() // Position - 0x10E10 (69136)
{
	int i;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_128())
	{
		func_52(25, true);
		func_52(26, true);
		func_52(27, true);
...
BOOL func_128() // Position - 0x110B0 (69808)
{
	return Global_2685152.f_719;
}

void func_129() // Position - 0x110BF (69823)
{
	func_116(12, Global_114963.f_7268.f_229[12]);
	func_116(65, Global_114963.f_7268.f_229[65]);
	func_116(6, Global_114963.f_7268.f_229[6]);
	func_116(174, Global_114963.f_7268.f_229[174]);
	func_116(37, Global_114963.f_7268.f_229[37]);
	return;
}

void func_130() // Position - 0x11120 (69920)
{
	int i;
	Vector3 vector;
...
void func_131() // Position - 0x11169 (69993)
{
	int i;

	for (i = 0; i < 27; i = i + 1)
	{
		OBJECT::ADD_DOOR_TO_SYSTEM(Global_43615[i /*31*/], Global_43615[i /*31*/].f_5, Global_43615[i /*31*/].f_2, true, true, false, 0);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_43615[i /*31*/], 1, true, false);
		Global_43615[i /*31*/].f_22 = OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(Global_43615[i /*31*/]);
		MISC::CLEAR_BIT(&(Global_43615[i /*31*/].f_1), 2);
		MISC::CLEAR_BIT(&(Global_43615[i /*31*/].f_1), 3);
		MISC::CLEAR_BIT(&(Global_43615[i /*31*/].f_1), 5);
		MISC::CLEAR_BIT(&(Global_43615[i /*31*/].f_1), 6);
	}
...
void func_132() // Position - 0x11204 (70148)
{
	int num;

	num = 4;
	Global_43615[num /*31*/] = -1735618852;
	Global_43615[num /*31*/].f_2 = { -844f, 156f, 66f };
	Global_43615[num /*31*/].f_5 = joaat("prop_lrggate_02_ld");
	Global_43615[num /*31*/].f_6 = 900f;
	Global_43615[num /*31*/].f_7 = 36f;
	Global_43615[num /*31*/].f_8 = 15f;
	Global_43615[num /*31*/].f_9 = { -851.81586f, 170.87428f, 61.302193f };
	Global_43615[num /*31*/].f_12 = { -851.57f, 148.1459f, 71.34533f };
	Global_43615[num /*31*/].f_15 = 15f;
	Global_43615[num /*31*/].f_16 = { -836.65967f, 175.33656f, 65.05977f };
	Global_43615[num /*31*/].f_19 = { -836.6878f, 152.78897f, 73.66382f };
	Global_43615[num /*31*/].f_23 = 0.25f;
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 0);
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 3);
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 4);
	MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 7);
	num = 0;
	Global_43615[num /*31*/] = -303823323;
	Global_43615[num /*31*/].f_2 = { 19f, -2530f, 5f };
	Global_43615[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_43615[num /*31*/].f_6 = 625f;
	Global_43615[num /*31*/].f_7 = 49f;
	Global_43615[num /*31*/].f_8 = 7.75f;
	Global_43615[num /*31*/].f_9 = { 15.188263f, -2531.2031f, 5.05037f };
	Global_43615[num /*31*/].f_12 = { 30.920921f, -2542.128f, 7.5043f };
	Global_43615[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_43615[num /*31*/].f_1), 7);
	num = 1;
	Global_43615[num /*31*/] = -1110491335;
	Global_43615[num /*31*/].f_2 = { 11f, -2542f, 5f };
	Global_43615[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_43615[num /*31*/].f_6 = 625f;
	Global_43615[num /*31*/].f_7 = 49f;
	Global_43615[num /*31*/].f_8 = 7.75f;
	Global_43615[num /*31*/].f_9 = { 13.802609f, -2540.9292f, 5.050376f };
	Global_43615[num /*31*/].f_12 = { -5.521768f, -2527.885f, 7.542066f };
	Global_43615[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global
num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 3);
	MISC::SET_BIT(&(Global_43615[num /*31*/].f_1), 7);
	num = 26;
	Global_43615[num /*31*/] = -1958174046;
	Global_43615[num /*31*/].f_2 = { 460.06f, -2003.11f, 22.14f };
	Global_43615[num /*31*/].f_5 = joaat("prop_facgate_01b");
	Global_43615[num /*31*/].f_6 = 324f;
	Global_43615[num /*31*/].f_7 = 9f;
	Global_43615[num /*31*/].f_8 = 10f;
	Global_43615[num /*31*/].f_9 = { 444.06693f, -1993.7362f, 21.10992f };
...
void func_133() // Position - 0x12AB6 (76470)
{
	int i;
	...
	{
		if (func_107())
			Global_114963.f_7268.f_229[i] = 0;
		else
			Global_44453.f_229[i] = 0;
	...
	if (func_107())
	{
		Global_114963.f_7268.f_229[185] = 1;
		Global_114963.f_7268.f_229[187] = 1;
		Global_114963.f_7268.f_229[186] = 1;
		Global_114963.f_7268.f_229[86] = 1;
		Global_114963.f_7268[106] = 0;
		Global_114963.f_7268[64] = 0;
		Global_114963.f_7268[65] = 0;
		Global_114963.f_7268[66] = 0;
		Global_114963.f_7268[164] = 0;
		Global_114963.f_7268.f_428 = 1;
	}
	else
	{
		Global_44453.f_229[62] = 1;
		Global_44453.f_229[179] = 1;
		Global_44453.f_229[14] = 1;
		Global_44453.f_229[86] = 1;
		Global_44453.f_229[173] = 1;
		Global_44453.f_229[76] = 1;
		Global_44453.f_229[94] = 1;
		Global_44453.f_229[70] = 1;
		Global_44453.f_229[71] = 1;
		Global_44453.f_229[73] = 1;
		Global_44453.f_229[72] = 0;
		Global_44453.f_229[74] = 0;
		Global_44453.f_428 = 1;
	}

	Global_114963.f_7268.f_229[76] = 1;
	Global_114963.f_7268.f_229[94] = 1;
	return;
}

BOOL func_134() // Position - 0x12CA6 (76966)
{
	if (func_107())
		return Global_114963.f_7268.f_428;

	return Global_44453.f_428;
}

void func_135() // Position - 0x12CCB (77003)
{
	Interior interiorAtCoordsWithType;
...
void func_136(BOOL bParam0) // Position - 0x12D37 (77111)
{
	func_137("MPINT_MISC_DOOR", joaat("prop_sc1_12_door"), -58.47f, -1530.51f, 34.54f, bParam0);
	func_137("MPINT_HIGHEND1_DOOR_L", joaat("prop_ss1_mpint_door_l"), -778.36f, 313.54f, 86.14f, bParam0);
	func_137("MPINT_HIGHEND1_DOOR_R", joaat("prop_ss1_mpint_door_r"), -776.2f, 313.54f, 86.14f, bParam0);
	func_137("MPINT_HIGHEND1_DOOR_GARAGE", joaat("prop_ss1_mpint_garage"), -796.08f, 313.78f, 86.68f, bParam0);
	func_137("MPINT_HIGHEND5_DOOR_L", joaat("prop_dt1_20_mp_door_l"), -263.46f, -970.52f, 31.61f, bParam0);
	func_137("MPINT_HIGHEND5_DOOR_R", joaat("prop_dt1_20_mp_door_r"), -260.66f, -969.21f, 31.61f, bParam0);
	func_137("MPINT_HIGHEND5_DOOR_GARAGE", joaat("prop_dt1_20_mp_gar"), -282.55f, -995.16f, 24.67f, bParam0);
	func_137("MPINT_HIGHEND7_DOOR_L", joaat("sm_14_mp_door_l"), -1444.28f, -545.01f, 34.98f, bParam0);
	func_137("MPINT_HIGHEND7_DOOR_R", joaat("sm_14_mp_door_r"), -1442.3f, -543.63f, 34.98f, bParam0);
	func_137("MPINT_HIGHEND7_DOOR_GARAGE", joaat("prop_sm_14_mp_gar"), -1455.81f, -503.98f, 32.29f, bParam0);
	func_137("MPINT_HIGHEND9_DOOR_L", joaat("prop_bh1_09_mp_l"), -914.06f, -453.65f, 39.81f, bParam0);
	func_137("MPINT_HIGHEND9_DOOR_R", joaat("prop_bh1_09_mp_r"), -912.91f, -455.89f, 39.81f, bParam0);
	func_137("MPINT_HIGHEND9_DOOR_GARAGE", joaat("prop_bh1_09_mp_gar"), -820.57f, -436.81f, 37.44f, bParam0);
	func_137("MPINT_HIGHEND12_DOOR_L", joaat("dt1_03_mp_door"), -47.84f, -588.77f, 38.36f, bParam0);
	func_137("MPINT_HIGHEND12_DOOR_GARAGE", joaat("prop_com_gar_door_01"), -33.79f, -621.62f, 36.11f, bParam0);
	func_137("MPINT_HIGHEND14_DOOR_GARAGE", joaat("prop_bh1_08_mp_gar"), -878.02f, -359.46f, 36.27f, bParam0);
	func_137("MPINT_HIGHEND16_DOOR_L", joaat("prop_ss1_mpint_door_l"), -615.8f, 38.37f, 44.04f, bParam0);
	func_137("MPINT_HIGHEND16_DOOR_R", joaat("prop_ss1_mpint_door_r"), -613.64f, 38.37f, 44.04f, bParam0);
	func_137("MPINT_HIGHEND16_DOOR_GARAGE", joaat("prop_ss1_mpint_garage"), -629.91f, 56.57f, 44.72f, bParam0);
	func_137("MPINT_LOWEND1_DOOR", joaat("p_cut_door_01"), -40.19f, -58.21f, 64.21f, bParam0);
	func_137("MPINT_LOWEND2_DOOR", joaat("p_cut_door_03"), -200.29f, 185.6f, 80.66f, bParam0);
	func_137("MPINT_LOWEND3_DOOR_L", joaat("prop_kt1_10_mpdoor_l"), -812.83f, -979.01f, 14.6f, bParam0);
	func_137("MPINT_LOWEND3_DOOR_R", joaat("prop_kt1_10_mpdoor_r"), -811.25f, -981.27f, 14.61f, bParam0);
	func_137("MPINT_LOWEND4_DOOR", joaat("kt1_11_mp_door"), -661.87f, -854.63f, 24.69f, bParam0);
	func_137("MPINT_LOWEND5_DOOR", joaat("prop_sm_10_mp_door"), -1533.58f, -327.59f, 48.09f, bParam0);
	func_137("MPINT_LOWEND6_DOOR_L", joaat("prop_sm1_11_doorr"), -1565.58f, -406.92f, 42.61f, bParam0);
	func_137("MPINT_LOWEND6_DOOR_R", joaat("prop_sm1_11_doorl"), -1564.01f, -405.04f, 42.61f, bParam0);
	func_137("MP_APARTMENT_DOOR_01", joaat("prop_sm1_11_doorr"), -1605.0138f, -431.9617f, 40.6384f, bParam0);
	func_137("MPINT_LOWEND7_DOOR_GARAGE", joaat("prop_sm1_11_garaged"), -1605.26f, -447.18f, 38.58f, bParam0);
	func_137("MPINT_MIDEND1_DOOR_L", joaat("prop_bh1_44_door_01l"), 286.91f, -159.22f, 64.84f, bParam0);
	func_137("MPINT_MIDEND1_DOOR_R", joaat("prop_bh1_44_door_01r"), 285.94f, -161.88f, 64.84f, bParam0);
	func_137("MPINT_MIDEND2_DOOR", joaat("prop_bh1_44_door_01r"), 4.4f, 37.32f, 71.75f, bParam0);
	func_137("MPINT_MIDEND3_DOOR", joaat("prop_bh1_44_door_01r"), 8.74f, 81.31f, 78.65f, bParam0);
	func_137("MPINT_MIDEND4_DOOR_L", joaat("prop_sm1_11_doorl"), -510.42f, 108f, 64.02f, bParam0);
	func_137("MPINT_MIDEND4_DOOR_R", joaat("prop_sm1_11_doorr"), -512.84f, 107.66f, 64.02f, bParam0);
	func_137("MPINT_MIDEND5_DOOR", joaat("prop_ss1_05_mp_door"), -197.23f, 85.16f, 69.9f, bParam0);
	func_137("MPINT_MIDEND6_DOOR_L", joaat("prop_ss1_08_mp_door_l"), -627.34f, 170.87f, 61.29f, bParam0);
	func_137("MPINT_MIDEND6_DOOR_R", joaat("prop_ss1_08_mp_door_r"), -627.34f, 168.53f, 61.29f, bParam0);
	func_137("MPINT_MIDEND7_DOOR_L", joaat("vb_43_door_l_mp"), -969.36f, -1429.98f, 7.97f, bParam0);
	func_137("MPINT_MIDEND7_DOOR_R", joaat("vb_43_door_r_mp"), -968.6f, -1432.04f, 6.77f, bParam0);
	func_137("MPINT_MIDEND8_DOOR_L", joaat("prop_kt1_10_mpdoor_r"), -830.05f, -862.99f, 21.09f, bParam0);
	func_137("MPINT_MIDEND8_DOOR_R", joaat("prop_kt1_10_mpdoor_l"), -832.81f, -862.99f, 21.09f, bParam0);
	func_137("MPINT_MIDEND9_DOOR_L", joaat("prop_kt1_06_door_l"), -763.9f, -755.08f, 28.19f, bParam0);
	func_137("MPINT_MIDEND9_DOOR_R", joaat("prop_kt1_06_door_r"), -763.9f, -752.49f, 28.19f, bParam0);
	return;
}

void func_137(char* sParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5) // Position - 0x13267 (78439)
{
	Hash hashKey;
...
BOOL func_138() // Position - 0x132BB (78523)
{
	return Global_1575058;
}

void func_139() // Position - 0x132C7 (78535)
{
	if (func_107())
	{
		if (!Global_114963.f_7268.f_428 || IS_BIT_SET(iLocal_78, 0) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || Global_40267)
		{
			if (!Global_2698801)
			{
				if (IS_BIT_SET(iLocal_78, 0) || Global_40267)
					bLocal_194 = true;
	...
	else if (!Global_44453.f_428 || IS_BIT_SET(iLocal_78, 1) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_128() && !func_140() || Global_40267)
	{
		if (func_9() == 2)
			if (IS_BIT_SET(iLocal_78, 2))
				iLocal_96 = 0;
		else
			iLocal_96 = 0;
	
		if (IS_BIT_SET(iLocal_78, 1))
			bLocal_194 = true;
	}
...
BOOL func_140() // Position - 0x13380 (78720)
{
	if (func_144() || func_143() || func_128() || func_142() || func_141())
		return true;

	return false;
}

BOOL func_141() // Position - 0x133BC (78780)
{
	return Global_2685152.f_872;
}

BOOL func_142() // Position - 0x133CB (78795)
{
	return Global_2685152.f_721;
}

BOOL func_143() // Position - 0x133DA (78810)
{
	return Global_2685152.f_734;
}

BOOL func_144() // Position - 0x133E9 (78825)
{
	return IS_BIT_SET(Global_2685152, 21);
}

BOOL func_145() // Position - 0x133F8 (78840)
{
