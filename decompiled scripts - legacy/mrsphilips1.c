...
eHudColour func_8() // Position - 0xA0F (2575)
{
	return Global_33775;
}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA6B (2667)
{
	if (bParam2 == -1)
		bParam2 = func_11();
...
BOOL func_11() // Position - 0xA89 (2697)
{
...
void func_22(ePedComponentType epctParam0) // Position - 0xC4A (3146)
{
	int i;
	int j;
...
void func_68(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x59C3 (22979)
{
	BOOL flag;
	int offset;
	int num;
...
void func_69(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5A0B (23051)
{
	Hash statName;
...
Hash func_70(int iParam0, BOOL bParam1) // Position - 0x5A39 (23097)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(bParam1));
}

BOOL func_71(BOOL bParam0) // Position - 0x5A4E (23118)
{
	BOOL flag;
	BOOL flag2;
...
int func_72(int iParam0, BOOL bParam1) // Position - 0x5A82 (23170)
{
	Hash statHash;
	int outValue;
...
BOOL func_92(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE6C2 (59074)
{
	BOOL flag;
	int num;
	int num2;
...
eCharacter func_214(BOOL bParam0, BOOL bParam1) // Position - 0x27461 (160865)
{
	eCharacter character;
	BOOL flag;
...
struct<2> func_241(int iParam0, const char* sParam1, int iParam2) // Position - 0x27F55 (163669)
{
	var unk;
	int num;
...
ePedComponentType func_251(BOOL bParam0) // Position - 0x2843D (164925)
{
	if (bParam0)
