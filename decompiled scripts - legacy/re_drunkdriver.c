...
void main() // Position - 0x0 (0)
{
	...
	if (func_201(uLocal_74, 27, iLocal_362, false, false))
		func_198(-1);
	else
...
void func_41(BOOL bParam0, int iParam1) // Position - 0x145A (5210)
{
	if (bParam0 == -1)
		bParam0 = func_59();
	...
	if (iParam1 <= func_58(bParam0))
	{
		func_57(bParam0, iParam1);
		...
		if (func_49(bParam0, iParam1) != 322)
			func_43(func_49(bParam0, iParam1), uLocal_61, uLocal_61.f_1);
...
void func_44() // Position - 0x1652 (5714)
{
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_80337)
		{
			if (func_45() == HUD_COLOUR_BLACK == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
eHudColour func_45() // Position - 0x1B10 (6928)
{
	return Global_33815;
}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B6C (7020)
{
	if (bParam2 == -1)
		bParam2 = func_48();
...
BOOL func_48() // Position - 0x1B8A (7050)
{
	return Global_1574928;
}

int func_49(BOOL bParam0, int iParam1) // Position - 0x1B96 (7062)
{
	switch (bParam0)
	{
		case false:
...
BOOL func_50(BOOL bParam0) // Position - 0x1F0A (7946)
{
	switch (bParam0)
	{
		case 29:
...
void func_57(BOOL bParam0, int iParam1) // Position - 0x230A (8970)
{
	MISC::SET_BIT(&Global_114963.f_25004.f_8[bParam0], iParam1);
	return;
}

int func_58(BOOL bParam0) // Position - 0x2325 (8997)
{
	int num;
...
BOOL func_59() // Position - 0x23D6 (9174)
{
	var unk;
	int num;
...
void func_77() // Position - 0x29ED (10733)
{
	...
	switch (iLocal_72)
	{
			...
			if (iLocal_71 == 1)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1017.4605f, -1259.8677f, 3.9183f, -1061.8914f, -1424.029f, 24.4253f, 171.75f, false, true, 0) && CAM::IS_SPHERE_VISIBLE(uLocal_169, 1f) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_169, 15f, 15f, 15f, false, true, 0))
				{
					...
					if (!PED::IS_PED_INJURED(uLocal_108[0]))
					{
						...
						{
							uLocal_172[0] = func_170(uLocal_108[0], false, 145);
					...
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), veLocal_111, 1.5f, 1.5f, 5f, false, true, 0) && PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (_CONVERSATION_ADD_LINE(&uLocal_190, "REDR2AU", "REDR2_TRY", 4, 0, 0, 0))
						{
							...
							if (!HUD::DOES_BLIP_EXIST(blLocal_175))
								blLocal_175 = func_153(veLocal_111, false, false);
						...
						if (!func_4())
						{
							...
							else
							{
								if (!PED::IS_PED_INJURED(uLocal_108[0]))
								{
									...
									{
										func_150(uLocal_108[0], &uLocal_82[0]);
									}
								}
				...
				switch (iLocal_81)
				{
						...
						if (BUILTIN::TIMERA() > 1000)
						{
							if (!PED::IS_PED_INJURED(uLocal_108[0]))
							{
								if (func_152())
								{
									...
									{
										fLocal_181 = func_148(PLAYER::PLAYER_PED_ID(), uLocal_108[0], true);
										iLocal_81 = iLocal_81 + 1;
									}
								}
								else if (!bLocal_136)
					...
					case 2:
						...
						if (!PED::IS_PED_INJURED(uLocal_108[0]))
							if (func_152())
								if (!bLocal_135)
									if (func_148(PLAYER::PLAYER_PED_ID(), uLocal_108[0], true) > fLocal_181 + 5f)
						...
						if (func_2())
						{
							...
							if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR && !func_65())
							{
								...
								{
									blLocal_120 = func_145(uLocal_104, false);
						...
						if (!PED::IS_PED_INJURED(uLocal_108[0]))
							if (func_148(PLAYER::PLAYER_PED_ID(), uLocal_108[0], true) > 50f)
								func_67();
						break;
					...
					case 0:
						if (!ENTITY::IS_ENTITY_DEAD(veLocal_111, false))
						{
							if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_111, true))
							{
								...
								if (!HUD::DOES_BLIP_EXIST(uLocal_172[1]))
									uLocal_172[1] = func_170(uLocal_108[1], false, 145);
		...
		case 8:
			...
			if (iLocal_71 == 1)
			{
				if (func_127(true, false, true) && iLocal_141 == -1)
				{
					func_6();
...
BOOL func_88(BOOL bParam0) // Position - 0x5859 (22617)
{
	BOOL flag;
	BOOL flag2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, BOOL bParam1) // Position - 0x5A7C (23164)
{
	if (bParam1 == -1)
		bParam1 = func_48();
...
eCharacter func_118(BOOL bParam0, BOOL bParam1) // Position - 0x6A27 (27175)
{
	eCharacter character;
	BOOL flag;
...
void func_137() // Position - 0x7E52 (32338)
{
	if (func_2() && iLocal_128 < 2)
	{
		...
		func_138(uLocal_177, MISC::GET_GAME_TIMER() - iLocal_176);
	}
	...
	if (iLocal_71 == 1)
	{
		if (!PED::IS_PED_INJURED(uLocal_108[0]))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_108[0], 8f, 8f, 8f, false, true, 0) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(blLocal_119))
					blLocal_119 = func_145(uLocal_98, true);
			}
			else
			{
				if (!HUD::DOES_BLIP_EXIST(uLocal_172[0]))
...
void func_157() // Position - 0x8EC9 (36553)
{
	...
	for (iLocal_80 = 0; iLocal_80 <= iLocal_107 - 1; iLocal_80 = iLocal_80 + 1)
	{
		if (!HUD::DOES_BLIP_EXIST(uLocal_172[iLocal_80]))
		{
			uLocal_172[iLocal_80] = func_170(uLocal_108[iLocal_80], false, 145);
...
int func_160(BOOL bParam0) // Position - 0x8F5D (36701)
{
	if (func_163())
	{
		...
		if (bParam0 && func_50(Global_114952))
...
{
	switch (func_164(&Global_33875, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
void func_178(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9D4F (40271)
{
	...
	{
		if (func_45() == HUD_COLOUR_PURE_WHITE)
		{
...
void func_186(int iParam0, var uParam1) // Position - 0xA663 (42595)
{
	switch (iParam0)
	{
		...
		case 5:
			func_187(uParam1, "Barry3A", func_189(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Las zonas donde puedes encontrar un vehículo con un botín oculto aparecen indicadas en el mapa. Recoge estos vehículos para Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_188(iParam0), 0, 1);
			break;
		...
		case 8:
			func_187(uParam1, "Dreyfuss1", func_189(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*Se reveló la identidad y el paradero del asesino.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_188(iParam0), 0, 0);
			break;
		...
		case 38:
			func_187(uParam1, "Nigel1A", func_189(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Se marcaron en el mapa las zonas en las que puedes encontrar objetos de famosos. Róbalos para Nigel y para la señora Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_188(iParam0), 1, 1);
			break;
		...
		case 49:
			func_187(uParam1, "Paparazzo3A", func_189(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Las zonas en las que puedes encontrar oportunidades para sacar fotos a famosos se marcaron en el mapa. Localiza y fotografía a estos famosos para Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_188(iParam0), 0, 1);
			break;
		...
		case 58:
			func_187(uParam1, "Tonya1", func_189(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Puedes encontrar extraños y locos por todo San Andreas en ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_188(iParam0), 0, 1);
			break;
...
void func_198(BOOL bParam0) // Position - 0xC154 (49492)
{
	if (bParam0 == -1)
		bParam0 = func_59();
...
void func_200(BOOL bParam0) // Position - 0xC1C7 (49607)
{
	Global_114952 = bParam0;
	return;
}

BOOL func_201(var uParam0, var uParam1, var uParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xC1D5 (49621)
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
	...
	if (!flag)
	{
		...
		if (func_25(_GET_CURRENT_PLAYER_CHARACTER()))
			if (!func_238(bParam3, iParam4, 145))
				return false;
	
		if (!func_237(Global_114963.f_25004.f_43[bParam3]))
			return false;
		...
		if (func_226(bParam3, iParam4) && !bParam5)
			return false;
		...
		if (bParam3 == 9 && iParam4 == 2 || iParam4 == 5 && !func_226(false, 0))
			return false;
...
BOOL func_226(BOOL bParam0, int iParam1) // Position - 0xCDB6 (52662)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_235() || Global_114010 || Global_33818 || func_234() || func_31(8, -1) || func_233() || func_232() || func_231() || func_230() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_235() || Global_33818 || func_234() || func_31(8, -1) || func_231() || func_233() || func_232() || func_230() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_235() || Global_114010 || Global_33818 || func_234() || func_31(8, -1) || func_231() || func_233() || func_232() || func_230() || Global_114963.f_7697.f_919[character] == 5 || Global_45468 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_235() || Global_114010 || Global_33818 || func_234() || func_31(8, -1) || func_233() || func_232() || func_230() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_235() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_31(8, -1) || func_230() || func_229() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_235() || Global_33818 || func_234() || func_31(8, -1) || func_232() || func_231() || func_230() || Global_114963.f_7697.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_235() || func_232() || Global_114010 || Global_33818 || func_234() || Global_46147 || func_31(8, -1) || func_231() || func_229() || func_230() || Global_114963.f_7697.f_919[character] == 5)
							return false;
						break;
...
ePedComponentType func_234() // Position - 0xD58A (54666)
{
...
BOOL func_238(BOOL bParam0, int iParam1, eCharacter echParam2) // Position - 0xD5EC (54764)
{
	BOOL num;
	eCharacter character;
...
BOOL func_240(BOOL bParam0) // Position - 0xD6F4 (55028)
{
	BOOL flag;
	BOOL flag2;
...
void func_243() // Position - 0xD848 (55368)
{
	...
	if (bLocal_189)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(veLocal_112, false))
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_112, false) && func_148(PLAYER::PLAYER_PED_ID(), veLocal_112, true) > 50f)
				func_255(veLocal_112, 0, _CHAR_NULL);
...
void func_244(int iParam0) // Position - 0xDADC (56028)
{
	...
	if (func_197())
	{
		...
		func_247(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_246(Global_114952, true), 64);
...
char* func_246(BOOL bParam0, BOOL bParam1) // Position - 0xDBCB (56267)
{
	switch (bParam0)
	{
		case false:
...
void func_256(Vehicle veParam0, eCharacter echParam1) // Position - 0xE2EE (58094)
{
	...
	func_257(veParam0, &(Global_114963.f_32759.f_5510));
	return;
}
...
BOOL func_268() // Position - 0xF1A1 (61857)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_269() // Position - 0xF1B7 (61879)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_270() // Position - 0xF1CD (61901)
{
	return false;
}

BOOL func_271() // Position - 0xF1D6 (61910)
{
	return true;
}

BOOL func_272() // Position - 0xF1DF (61919)
{
	return true;
}

BOOL func_273() // Position - 0xF1E8 (61928)
{
...
BOOL func_274(Vehicle veParam0) // Position - 0xF201 (61953)
{
	Hash entityModel;
...
BOOL func_275(Vehicle veParam0) // Position - 0xF248 (62024)
{
	int i;
...
BOOL func_276(Vehicle veParam0) // Position - 0xF283 (62083)
{
	int i;
...
BOOL func_277(Vehicle veParam0) // Position - 0xF2FF (62207)
{
	int i;
...
eCharacter func_278(Vehicle veParam0) // Position - 0xF3E7 (62439)
{
	int i;
...
BOOL func_279(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xF44A (62538)
{
	int i;
	var garageName;
	int num;
...
BOOL func_280(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xF4B8 (62648)
{
...
void func_281() // Position - 0xF58F (62863)
{
	Global_34054 = false;
	Global_34055 = false;
	Global_34057 = false;
...
void func_282(BOOL bParam0) // Position - 0xF5AB (62891)
{
	int i;
...
Vector3 func_283() // Position - 0xF5CE (62926)
{
	float distanceBetweenCoords;
