...
void main() // Position - 0x0 (0)
{
	...
	func_315(5);
	func_304(&(uLocal_193.f_1), Global_98490[5 /*19*/]);
...
void func_13(const char* sParam0, const char* sParam1) // Position - 0x9E1 (2529)
{
	int i;
	int j;
...
BOOL func_40(int iParam0) // Position - 0x1E2A (7722)
{
...
void func_101() // Position - 0x3E34 (15924)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_102(character) && !func_301(14) || Global_113909)
			{
...
ePedComponentType func_149() // Position - 0x6EEF (28399)
{
...
int func_165(var uParam0, int iParam1, BOOL bParam2) // Position - 0x8168 (33128)
{
	BOOL flag;
	var unk;
	var unk99;
	...
	if (!func_182(bParam2, &uParam0->f_2300[iParam1 /*3*/], &uParam0->f_2310[iParam1]))
		return 0;

	if (!func_181(uParam0->f_2300[iParam1 /*3*/], 0f, 0f, 0f, false))
	{
		if (!func_181(Global_100925[bParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
		
			if (func_166(iParam1, bParam2, &unk, &unk99, &unk102, &unk103, &unk106))
...
BOOL func_166(int iParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x8285 (33413)
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
int func_168(int iParam0, var uParam1, int iParam2) // Position - 0xB953 (47443)
{
	...
	if (!func_169(Global_101890[iParam0 /*98*/], false, -1))
	{
		func_167(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
BOOL func_173() // Position - 0xBF84 (49028)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_174() // Position - 0xBF9A (49050)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_175() // Position - 0xBFB0 (49072)
{
	return false;
}

BOOL func_176() // Position - 0xBFB9 (49081)
{
	return true;
}

BOOL func_177() // Position - 0xBFC2 (49090)
{
	return true;
}

BOOL func_178() // Position - 0xBFCB (49099)
{
...
BOOL func_179() // Position - 0xBFE4 (49124)
{
	int profileSetting;
...
BOOL func_180(int iParam0) // Position - 0xC09F (49311)
{
...
BOOL func_181(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC31F (49951)
{
	if (bParam6)
...
BOOL func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC366 (50022)
{
	switch (bParam0)
	{
		case 11:
...
int func_183() // Position - 0xCCD5 (52437)
{
	var unk;
...
void func_184(var uParam0, int iParam1) // Position - 0xCD1B (52507)
{
	if (iParam1 <= 0)
		return;
...
void func_185(var uParam0, int iParam1) // Position - 0xCDA1 (52641)
{
...
void func_186(var uParam0, int iParam1) // Position - 0xCDD4 (52692)
{
	int num;
	int num2;
...
int func_187(int iParam0, int iParam1) // Position - 0xCE25 (52773)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_188(int iParam0) // Position - 0xCEC7 (52935)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_189(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCEE9 (52969)
{
	if (bParam0)
		return uParam1;
...
int func_190(int iParam0) // Position - 0xCF00 (52992)
{
	return iParam0 & 15;
}

void func_191(var uParam0, int iParam1) // Position - 0xCF0D (53005)
{
...
void func_192(var uParam0, int iParam1) // Position - 0xCF47 (53063)
{
...
void func_193(var uParam0, int iParam1) // Position - 0xCF82 (53122)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_194(var uParam0, int iParam1) // Position - 0xCFBE (53182)
{
	int i;
	BOOL flag;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_182(Global_114963.f_18542[i], &unk, &num))
			{
...
void func_195(var uParam0) // Position - 0xD184 (53636)
{
	*uParam0 = -15;
	return;
}

int func_196() // Position - 0xD192 (53650)
{
	if (func_119(false))
		return 0;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD1DD (53725)
{
...
void func_198(int iParam0) // Position - 0xD278 (53880)
{
	Global_45472 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

int func_199(var uParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xD28A (53898)
{
	Ped ped;
	eCharacter character;
...
void func_200() // Position - 0xD77A (55162)
{
	if (Global_99773)
	{
		func_101();
...
char* func_201(eCharacter echParam0) // Position - 0xD7AC (55212)
{
	echParam0 = echParam0;
	return "";
}

BOOL func_202() // Position - 0xD7BB (55227)
{
	return Global_24428;
}

void func_203(eCharacter echParam0, var uParam1) // Position - 0xD7C6 (55238)
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_204(int iParam0, Ped pedParam1) // Position - 0xD892 (55442)
{
	int i;
	Ped ped;
	BOOL flag;
...
BOOL func_205(int iParam0, Ped pedParam1) // Position - 0xD944 (55620)
{
	int i;
...
void func_206(int iParam0) // Position - 0xD97D (55677)
{
	if (iParam0 == 10)
		return;
...
void func_207(eCharacter echParam0, int iParam1) // Position - 0xDB0D (56077)
{
	int num;
...
void func_208(eCharacter echParam0) // Position - 0xDBFA (56314)
{
...
void func_209(eCharacter echParam0) // Position - 0xDC45 (56389)
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_210() // Position - 0xE10B (57611)
{
...
int func_211(int iParam0) // Position - 0xE18A (57738)
{
	eCharacter character;
...
BOOL func_212(eCharacter echParam0) // Position - 0xE3B2 (58290)
{
	Hash entityModel;
...
Vehicle func_213(Vehicle veParam0) // Position - 0xE41E (58398)
{
	return veParam0;
}

void func_214(int iParam0, var uParam1) // Position - 0xE428 (58408)
{
	int num;
	int num2;
...
BOOL func_215(int iParam0) // Position - 0xEDC0 (60864)
{
	var unk;
	int doorState;
...
int func_216(int iParam0) // Position - 0xEDF4 (60916)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

struct<7> func_217(int iParam0) // Position - 0xEE07 (60935)
{
	var unk;
...
BOOL func_218() // Position - 0x11A80 (72320)
{
...
eHudColour func_219() // Position - 0x11AB0 (72368)
{
	return Global_33816;
}

eHudColour func_220() // Position - 0x11ABB (72379)
{
	return Global_33815;
}

int func_221(Vector3 vParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0x11AC6 (72390)
{
	int i;
	float distanceBetweenCoords;
	float num;
...
BOOL func_222(int iParam0) // Position - 0x11B55 (72533)
{
	return IS_BIT_SET(Global_114963.f_7236[iParam0], 0);
}

void func_223(eCharacter echParam0) // Position - 0x11B6A (72554)
{
	int i;
...
void func_224(eCharacter echParam0, int iParam1) // Position - 0x11B8D (72589)
{
	int outValue;
	float modifier;
	Hash statHash;
...
int func_225(int iParam0, int iParam1) // Position - 0x11C79 (72825)
{
	Hash statHash;
	int outValue;
...
Hash func_226(int iParam0, int iParam1) // Position - 0x11CA8 (72872)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_227(iParam1));
}

int func_227(int iParam0) // Position - 0x11CBD (72893)
{
	int num;
	int num2;
...
int func_228() // Position - 0x11CF1 (72945)
{
	return Global_1574928;
}

void func_229(eCharacter echParam0, int iParam1, var uParam2, var uParam3) // Position - 0x11CFD (72957)
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_230() // Position - 0x11F54 (73556)
{
	var unk;
...
void func_231(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x122FA (74490)
{
	if (iParam2 == -1)
		iParam2 = func_228();
...
void func_232(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x12322 (74530)
{
	eCharacter character;
	ePedComponentType i;
...
BOOL func_233(int iParam0, int iParam1) // Position - 0x124BC (74940)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_234(int iParam0, int iParam1) // Position - 0x124E0 (74976)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_227(iParam1));
}

void func_235(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x124F5 (74997)
{
	eCharacter character;
...
void func_236(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x12A3E (76350)
{
	eCharacter character;
...
BOOL func_237() // Position - 0x12C7F (76927)
{
...
BOOL func_238(int iParam0) // Position - 0x12C9D (76957)
{
	return Global_1574538[iParam0];
}

BOOL func_239() // Position - 0x12CAD (76973)
{
	return func_238(func_228() + 1);
}

void func_240(eCharacter echParam0) // Position - 0x12CBF (76991)
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_241() // Position - 0x12E73 (77427)
{
...
void func_242(Ped pedParam0) // Position - 0x12EF6 (77558)
{
	int i;
	var ammo;
	Hash weaponSlot;
...
Hash func_243(int iParam0) // Position - 0x12FB8 (77752)
{
	int num;
...
void func_244(Ped pedParam0) // Position - 0x1322C (78380)
{
	eCharacter character;
...
int func_245(eCharacter echParam0) // Position - 0x1331A (78618)
{
...
BOOL func_246(int iParam0) // Position - 0x13355 (78677)
{
	if (Global_44921 == 15)
		return false;
...
eCharacter func_247(int iParam0) // Position - 0x13377 (78711)
{
	if (iParam0 == 0)
		return CHAR_MICHAEL;
	else if (iParam0 == 2)
...
void func_248(eCharacter echParam0, var uParam1) // Position - 0x133A5 (78757)
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
void func_249(int iParam0, Ped pedParam1, BOOL bParam2) // Position - 0x1345D (78941)
{
	int i;
	BOOL flag;
...
void func_250(Ped pedParam0, BOOL bParam1) // Position - 0x13519 (79129)
{
	func_262(pedParam0);
...
void func_251(Ped pedParam0) // Position - 0x1354D (79181)
{
	eCharacter character;
...
void func_252(Ped pedParam0) // Position - 0x13594 (79252)
{
	eCharacter character;
...
void func_253(Ped pedParam0) // Position - 0x135D2 (79314)
{
	eCharacter character;
...
void func_254(Ped pedParam0) // Position - 0x1375F (79711)
{
	eCharacter character;
...
void func_255(Ped pedParam0) // Position - 0x1379B (79771)
{
	eCharacter character;
...
void func_256(Ped pedParam0, BOOL bParam1) // Position - 0x137F8 (79864)
{
	eCharacter character;
...
void func_257(Ped pedParam0, var uParam1) // Position - 0x138EB (80107)
{
	int i;
	int j;
	Hash k;
...
BOOL func_258(int iParam0) // Position - 0x13B73 (80755)
{
	switch (iParam0)
	{
...
BOOL func_259(int iParam0) // Position - 0x13C14 (80916)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
Hash func_260(Hash hParam0, int iParam1) // Position - 0x13E0C (81420)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_261(Hash hParam0, Any* panParam1) // Position - 0x14B8E (84878)
{
	int i;
	int numDlcWeapons;
...
void func_262(Ped pedParam0) // Position - 0x14BC9 (84937)
{
	eCharacter character;
	...
	if (func_102(character) && !PED::IS_PED_INJURED(pedParam0))
		Global_114963.f_2370.f_539.f_2296[character] = func_183();

	return;
}

BOOL func_263(var uParam0, int iParam1) // Position - 0x14C03 (84995)
{
	BOOL flag;
	BOOL flag2;
		...
		if (func_245(_GET_CURRENT_PLAYER_CHARACTER()) != iParam1 || flag)
		{
			...
			if (flag || uParam0->f_24[iParam1] != 0 || func_267(iParam1) && func_264(iParam1) && !uParam0->f_18[iParam1])
				if (!uParam0->f_23)
					...
					flag2 = true;
			else if (!(IS_BIT_SET(Global_114963.f_9094.f_2[27 /*3*/], 1) && !Global_4 && !func_119(false)))
				if (uParam0->f_23)
					flag2 = true;
...
int func_264(int iParam0) // Position - 0x14D58 (85336)
{
...
BOOL func_265(eCharacter echParam0) // Position - 0x14DA8 (85416)
{
	if (func_102(echParam0))
		if (Global_114963.f_9094 || Global_4 || func_119(false))
...
eCharacter func_266() // Position - 0x14DF6 (85494)
{
	return Global_114963.f_2370.f_539.f_4323;
}

int func_267(int iParam0) // Position - 0x14E0B (85515)
{
	if (Global_114963.f_9094 || Global_4 || func_119(false))
		if (!Global_80337 || Global_80337 && iParam0 != func_245(func_266()))
...
void func_268(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x14E97 (85655)
{
	if (bParam0)
	{
		PLAYER::SPECIAL_ABILITY_DEACTIVATE_FAST(PLAYER::PLAYER_ID(), 0);
...
BOOL func_269() // Position - 0x14FE6 (85990)
{
	return IS_BIT_SET(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_36.f_18, 14);
}

BOOL func_270(Player plParam0, int iParam1) // Position - 0x15000 (86016)
{
	BOOL flag;
...
eCharacter func_271(int iParam0, BOOL bParam1) // Position - 0x15059 (86105)
{
	eCharacter character;
	int num;
...
BOOL func_272(Player plParam0) // Position - 0x1509A (86170)
{
	Player player;
...
BOOL func_273(Player plParam0) // Position - 0x150BC (86204)
{
...
BOOL func_274() // Position - 0x150FB (86267)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_275(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x15109 (86281)
{
	int num;
...
void func_276(int iParam0) // Position - 0x1513C (86332)
{
	if (iParam0 == 1)
...
void func_277(var uParam0) // Position - 0x1515F (86367)
{
...
BOOL func_278(int iParam0) // Position - 0x151AE (86446)
{
	switch (iParam0)
	{
		case 0:
...
void func_279(var uParam0, float fParam1, float fParam2) // Position - 0x1521B (86555)
{
	float num;
...
void func_280(var uParam0) // Position - 0x152EC (86764)
{
...
void func_281(var uParam0) // Position - 0x15356 (86870)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
...
void func_282(var uParam0) // Position - 0x1539C (86940)
{
	int i;
...
void func_283(var uParam0) // Position - 0x153D8 (87000)
{
...
void func_284(var uParam0) // Position - 0x15456 (87126)
{
	int i;
...
void func_285(var uParam0) // Position - 0x154B0 (87216)
{
	int i;
	Hash modelHash;
	float pitch;
...
Vector3 func_286(var uParam0, var uParam1) // Position - 0x155E6 (87526)
{
	float num;
	float num2;
	float num3;
...
void func_287(var uParam0) // Position - 0x15664 (87652)
{
	int i;
	int num;
	int num2;
...
void func_288(var uParam0) // Position - 0x15741 (87873)
{
	int num;
	int value;
	int i;
...
BOOL func_289(var uParam0) // Position - 0x15881 (88193)
{
...
void func_290(var uParam0) // Position - 0x1591C (88348)
{
	float num;
	float num2;
...
void func_291(var uParam0) // Position - 0x159A5 (88485)
{
	int i;
	int num;
	BOOL value;
...
void func_292(var uParam0) // Position - 0x15BE6 (89062)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_293() // Position - 0x15C0A (89098)
{
				...
				if (func_297("RBHS_MCS_3"))
				{
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_98958.f_9[0]))
						{
							...
							pedLocal_145 = Global_98958.f_9[0];
...
void func_294(var uParam0) // Position - 0x16467 (91239)
{
	BOOL flag;
	int num;
	int i;
...
void func_295(BOOL bParam0, BOOL bParam1) // Position - 0x1654F (91471)
{
	if (bParam0 == -1)
		return;
...
void func_296() // Position - 0x1658B (91531)
{
	func_85(1, 2, true);
	func_85(2, 2, true);
	func_277(&uLocal_193);
...
BOOL func_297(char* sParam0) // Position - 0x165AD (91565)
{
...
void func_298() // Position - 0x165D2 (91602)
{
	Global_102525 = true;
	return;
}

int func_299(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x165DF (91615)
{
	int i;
...
void func_300(var uParam0, int iParam1) // Position - 0x16716 (91926)
{
	int i;
...
BOOL func_301(int iParam0) // Position - 0x16765 (92005)
{
	return Global_44921 == iParam0;
}

BOOL func_302(int iParam0) // Position - 0x16773 (92019)
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_303(var uParam0, int iParam1) // Position - 0x167A0 (92064)
{
	var unk;
	var unk4;
...
void func_304(var uParam0, int iParam1) // Position - 0x1686C (92268)
{
...
void func_305(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x16AFC (92924)
{
	var unk;
...
void func_306(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16B75 (93045)
{
	if (uParam0->f_33 < 20)
	{
...
void func_307(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0x16BB9 (93113)
{
	var unk;
...
void func_308(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x16C09 (93193)
{
	if (uParam0->f_117 < 22)
	{
...
void func_309(var uParam0, int iParam1, char* sParam2) // Position - 0x16C59 (93273)
{
	var unk;
...
void func_310(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0x16C85 (93317)
{
	var unk;
	var unk3;
...
void func_311(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0x16D1F (93471)
{
	var unk;
	var unk5;
	var unk9;
...
void func_312(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x16DC3 (93635)
{
	uParam0->f_9 = fParam1;
...
void func_314(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x16EAB (93867)
{
	uParam0->f_1 = iParam1;
...
int func_315(int iParam0) // Position - 0x16F17 (93975)
{
	int num;
	int offset;
...
void func_316() // Position - 0x16F6E (94062)
{
...
BOOL func_317(var uParam0) // Position - 0x17017 (94231)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_281(uParam0);
