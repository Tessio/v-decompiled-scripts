...
void func_3(int iParam0, BOOL bParam1) // Position - 0x340 (832)
{
	...
	{
		func_174(&(Global_113431[num /*10*/].f_9));
	}
...
void func_7() // Position - 0x5CD (1485)
{
	...
	if (value > 0f && BUILTIN::FLOOR(value) < BUILTIN::FLOOR(Global_114344.f_10198.f_3853))
		func_203(13, BUILTIN::FLOOR(Global_114344.f_10198.f_3853));
...
BOOL func_31(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1562 (5474)
{
	...
	Global_79527[1 /*14*/] = { func_84(entityModel, epctParam1, epctParam2, -1) };
	...
	else
	{
		...
		Global_79527[1 /*14*/] = { func_84(entityModel, epctParam1, unk28[epctParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_76(epctParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_76(epctParam1), Global_79527[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_76(epctParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, 0);
	}
...
BOOL func_32(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x171F (5919)
{
	...
	{
		if (!func_149(pedParam0, Global_114344.f_2367.f_539[num /*65*/].f_64, Global_114344.f_2367.f_539[num /*65*/].f_63))
		{
...
int func_34(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17FB (6139)
{
	...
	if (iParam5 == 0)
	{
		Global_79527[1 /*14*/] = { func_84(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79527[1 /*14*/] = { func_84(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79527[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79527[1 /*14*/] = { func_84(entityModel, 14, unk18[j], -1) };
							func_50(pedParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
							func_66(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_76(i), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_76(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_76(i), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79527[1 /*14*/] = { func_84(entityModel, i, func_40(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79527[1 /*14*/] = { func_84(entityModel, 14, unk59[j], -1) };
			func_50(pedParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
			func_66(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_76(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_76(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_76(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
...
{
	Global_79527[1 /*14*/] = { func_84(hParam0, iParam1, epctParam2, -1) };
...
BOOL func_75(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9649 (38473)
{
	...
	{
		if (!func_149(pedParam0, Global_114344.f_2367.f_539[num /*65*/].f_61, Global_114344.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
ePedComponentType func_76(ePedComponentType epctParam0) // Position - 0x96F4 (38644)
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_77(Hash hParam0, ePedComponentType epctParam1) // Position - 0x97A4 (38820)
{
	int i;
	var unk;
...
struct<17> func_80(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA245 (41541)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (epctParam1)
			{
				...
				case 5:
					func_83(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[0], Global_114344.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (epctParam1)
			{
				...
				case 2:
					func_83(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[1], Global_114344.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (epctParam1)
			{
				...
				case 4:
					func_83(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[2], Global_114344.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_83(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC328 (49960)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_84(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC399 (50073)
{
	func_148();
...
void func_86(int iParam0) // Position - 0xC4DB (50395)
{
	...
	func_87(&Global_79527[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_87(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD70B (55051)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_71(func_90(iParam1, iParam0->f_2), Global_79524);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_71(func_89(iParam1, iParam0->f_2), Global_79524);
...
BOOL func_88(int iParam0, int iParam1, var uParam2) // Position - 0xDAAC (55980)
{
	*uParam2 = 979;
...
int func_89(int iParam0, int iParam1) // Position - 0xDEB1 (57009)
{
	switch (iParam1)
	{
		case 0:
...
int func_90(int iParam0, int iParam1) // Position - 0xE2AC (58028)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_91(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE6A7 (59047)
{
	int num;
	int num2;
	int num3;
...
BOOL func_92(int iParam0) // Position - 0xE6E5 (59109)
{
	return Global_44375 == iParam0;
}

int func_93(int iParam0) // Position - 0xE6F3 (59123)
{
	switch (iParam0)
	{
		case -1:
...
void func_94(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE7C7 (59335)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_87(&Global_79527[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_87(&Global_79527[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_87(&Global_79527[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79725)
		{
			...
			func_87(&Global_79527[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_95(int iParam0) // Position - 0xEA4D (59981)
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0xEB9A (60314)
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0xF0A7 (61607)
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0xF11B (61723)
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0xF18E (61838)
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0xF275 (62069)
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0xF5B7 (62903)
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Position - 0xF7BF (63423)
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0xFAE8 (64232)
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_149(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FA46 (129606)
{
	Hash entityModel;
	ePedComponentType type;
	int i;
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_149(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_149(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79527[2 /*14*/] = { func_84(entityModel, 14, k, -1) };
								
									if (Global_79527[2 /*14*/].f_12 == j)
										if (func_149(pedParam0, 14, k))
											if (!func_38(entityModel, epctParam2, 14, k, &unk, &Global_79527[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79527[2 /*14*/] = { func_84(entityModel, i, type, -1) };
					
						if (!func_38(entityModel, epctParam2, i, type, &unk, &Global_79527[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79527[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_76(epctParam1)) && Global_79527[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_76(epctParam1)))
	{
		return true;
	}
...
void func_156() // Position - 0x1FDB3 (130483)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_153(character) && !func_92(14) || Global_113292)
			{
				if (Global_114344.f_2367.f_539.f_4321 != character && func_153(Global_114344.f_2367.f_539.f_4321))
...
void func_161(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20525 (132389)
{
	...
	if (iParam0 != -1)
	{
		...
		func_162(&unk33, unk.f_3, Global_101930, bParam1, bParam2);
	}
...
int func_204(int iParam0, int iParam1, BOOL bParam2) // Position - 0x26E04 (159236)
{
	...
	for (i = 0; i < Global_54909[num /*203*/].f_3; i = i + 1)
	{
		...
		if (num3 < 3)
			func_205(Global_54909[num /*203*/].f_4[i], Global_54909[num /*203*/].f_1, true, bParam2, false);
	}
...
void func_205(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x27000 (159744)
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_211(Global_45609[num5 /*12*/].f_1) };
	...
	else
	{
		...
		if (Global_54909[num6 /*203*/].f_10[Global_54909[num6 /*203*/].f_9 - 1 /*48*/].f_1)
			...
			unk = { func_211(Global_45609[num8 /*12*/].f_1) };
	}
...
void func_275(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2A1C5 (172485)
{
	...
	if (Global_79999 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_289(Global_80000, Global_80002, iParam10) };
				y == -0.014f;
...
int func_313(Entity eParam0, eCharacter echParam1) // Position - 0x2B4B1 (177329)
{
	int num;
...
int func_337(const char* sParam0) // Position - 0x2BC0F (179215)
{
...
int func_338() // Position - 0x2BC65 (179301)
{
	...
	num = func_339(&(Global_101893.f_3), false);
	num2 = 0;
...
int func_339(const char* sParam0, BOOL bParam1) // Position - 0x2BC89 (179337)
{
	Hash hashKey;
	int num;
