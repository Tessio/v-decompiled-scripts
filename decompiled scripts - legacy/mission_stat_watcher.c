			...
			if (Global_64499 || bLocal_636)
			{
				...
				if (!(bLocal_635 == Global_64500))
				{
					...
					if (Global_64509)
					{
						...
						value = 2;
						func_97(&uLocal_43, "HISHPA", &Global_64521, 0);
					
						if (num == 69 || num == 70)
							func_96(&uLocal_43, 5, "ACTATAKE_AG", "", Global_114344.f_1.f_126[Global_64510 /*23*/], 0, 0, 0);
						else
							func_96(&uLocal_43, 5, "POTATAKE", "", Global_114344.f_1.f_126[Global_64510 /*23*/], 0, 0, 0);
					
						j = 0;
					
						for (j = 0; j < Global_98098[Global_64510 /*38*/].f_37; j = j + 1)
						{
							if (Global_98098[Global_64510 /*38*/].f_31[j] > 0)
								func_96(&uLocal_43, 5, func_95(Global_98098[Global_64510 /*38*/].f_25[j]), "", -1 * Global_98098[Global_64510 /*38*/].f_31[j], 0, 0, 0);
						}
					
						if (Global_114344.f_1.f_126[Global_64510 /*23*/].f_2[0] > 0 || num == 74 || num == 75 || num == 69 || num == 70)
							func_96(&uLocal_43, 5, "ACTATAKE_M", "", Global_114344.f_1.f_126[Global_64510 /*23*/].f_2[0], 0, 0, 0);
					
						if (Global_114344.f_1.f_126[Global_64510 /*23*/].f_2[1] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 5, "ACTATAKE_F", "", Global_114344.f_1.f_126[Global_64510 /*23*/].f_2[1], 0, 0, 0);
					
						if (Global_114344.f_1.f_126[Global_64510 /*23*/].f_2[2] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 5, "ACTATAKE_T", "", Global_114344.f_1.f_126[Global_64510 /*23*/].f_2[2], 0, 0, 0);
					
						if (Global_98088.f_7 > 0)
							func_96(&uLocal_43, 5, "ACTATAKE_L", "", Global_98088.f_7, 0, 0, 0);
					
						num2 = func_93(func_94(Global_64510));
						num3 = 0;
						value2 = 0;
					
						for (j = 0; j < Global_97897[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_114344.f_1.f_12[num2 /*6*/][j]))
								num3 = num3 + Global_114344.f_1.f_126[Global_64510 /*23*/].f_17[j];
							else
								value2 = value2 + Global_114344.f_1.f_126[Global_64510 /*23*/].f_17[j];
						}
					...
					{
						func_97(&uLocal_43, "MISHPA", &Global_64521, 0);
					}
...
void func_19(BOOL bParam0) // Position - 0xEDD (3805)
{
...
float func_27(float fParam0) // Position - 0x234F (9039)
{
	return fParam0 * 0.00078125f;
}

void func_28(const char* sParam0, const char* sParam1, float fParam2, float fParam3, BOOL bParam4, int iParam5) // Position - 0x235F (9055)
{
...
void func_29(const char* sParam0, float fParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x238C (9100)
{
...
int func_30(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x23C9 (9161)
{
	var textureDict;
	var textureName;
	int num;
...
float func_31(int iParam0) // Position - 0x24F5 (9461)
{
	switch (iParam0)
	{
		case 34:
...
void func_32(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x25CF (9679)
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_33(int iParam0, int iParam1) // Position - 0x2657 (9815)
{
	return BUILTIN::TO_FLOAT(iParam0) / BUILTIN::TO_FLOAT(iParam1) > 3.5f;
}

char* func_34(int iParam0, BOOL bParam1) // Position - 0x2672 (9842)
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_35(char* sParam0) // Position - 0x2BA0 (11168)
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x2BAA (11178)
{
	var gamerHandle;
...
char* func_37(int iParam0) // Position - 0x2BC1 (11201)
{
	var txdName;
	var netHandle;
...
void func_38(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0x2C36 (11318)
{
	int r;
	int g;
	int b;
...
void func_39(int iParam0, int iParam1, float fParam2, float fParam3, const char* sParam4, int iParam5) // Position - 0x2EC6 (11974)
{
	eHudColour hudColor;
...
float func_40(float fParam0) // Position - 0x328B (12939)
{
	return fParam0 * 0.025f;
}

float func_41(float fParam0) // Position - 0x329B (12955)
{
	return fParam0 * 0.0009259259f;
}

void func_42(ePedComponentType epctParam0, char* sParam1, int iParam2, int iParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x32AB (12971)
{
	int num;
	int i;
...
void func_43(int iParam0, int iParam1) // Position - 0x3408 (13320)
{
	MISC::SET_BIT(&Global_1675403.f_7064[iParam0], iParam1);
	return;
}

BOOL func_44(int iParam0, int iParam1) // Position - 0x3421 (13345)
{
	return IS_BIT_SET(Global_1675403.f_7064[iParam0], iParam1);
}

float func_45(const char* sParam0, const char* sParam1) // Position - 0x3437 (13367)
{
...
float func_46(const char* sParam0) // Position - 0x3452 (13394)
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true) / 2f;
}

void func_47() // Position - 0x3467 (13415)
{
...
void func_48(const char* sParam0) // Position - 0x348F (13455)
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

float func_49() // Position - 0x349D (13469)
{
	float num;
...
float func_50(float fParam0) // Position - 0x34B1 (13489)
{
	return fParam0 * 0.0013888889f;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x34C1 (13505)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x34FE (13566)
{
...
Hash func_53(eCharacter echParam0) // Position - 0x3523 (13603)
{
	return Global_2241[echParam0 /*29*/];
}

BOOL func_54(eCharacter echParam0) // Position - 0x3532 (13618)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_55(int iParam0) // Position - 0x353E (13630)
{
	if (func_57())
		return;
...
BOOL func_56(int iParam0) // Position - 0x3571 (13681)
{
	if (iParam0 == 1)
...
BOOL func_57() // Position - 0x35C8 (13768)
{
	return IS_BIT_SET(Global_1959772, 19);
}

void func_58(int iParam0) // Position - 0x35D7 (13783)
{
	if (func_57())
		return;
...
BOOL func_59() // Position - 0x3661 (13921)
{
...
void func_60(BOOL bParam0, BOOL bParam1) // Position - 0x3688 (13960)
{
	if (bParam0)
	{
		if (func_56(0))
...
BOOL func_61() // Position - 0x36FC (14076)
{
	return IS_BIT_SET(Global_1959772, 5);
}

BOOL func_62() // Position - 0x370A (14090)
{
	int i;
	...
	{
		if (Global_76602[i /*9*/] > 0)
			if (Global_64731[Global_76602[i /*9*/] /*13*/].f_7 == false)
				return 1;
	}
...
void func_63(BOOL bParam0) // Position - 0x374E (14158)
{
	char* audioName;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x37C1 (14273)
{
	func_65();
	return Global_114344.f_2367.f_539.f_4321;
}

void func_65() // Position - 0x37DA (14298)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_54(character) && !func_66(14) || Global_113292)
			{
...
BOOL func_66(int iParam0) // Position - 0x38D7 (14551)
{
	return Global_44375 == iParam0;
}

int func_67(var uParam0, BOOL bParam1, int iParam2) // Position - 0x38E5 (14565)
{
...
void func_68(var uParam0) // Position - 0x3A84 (14980)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_69(var uParam0) // Position - 0x3B48 (15176)
{
	float screenWidthOfDisplayText;
	int num;
	int num2;
...
void func_70(var uParam0) // Position - 0x3C50 (15440)
{
	uParam0->f_547 = 1f;
	uParam0->f_546 = 0;
	uParam0->f_572 = 0f;
...
void func_71() // Position - 0x3CCF (15567)
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < Global_76601; i = i + 1)
	{
		num3 = Global_76602[i /*9*/];
		flag = !Global_64731[num3 /*13*/].f_7;
		flag2 = Global_64731[num3 /*13*/].f_8;
		unk = Global_64731[num3 /*13*/].f_12;
		unk2 = Global_64731[num3 /*13*/].f_9;
		flag3 = false;
		flag3 = false;
	
		if (func_76(num3, Global_76602[i /*9*/].f_1))
			flag3 = true;
	...
	if (NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		if (Global_76751 == false)
		{
			...
			Global_114344.f_9089.f_330[num6 /*6*/].f_4 = Global_76747;
		}
		else
		{
...
void func_72(int iParam0) // Position - 0x420B (16907)
{
	int num;
...
void func_73(int iParam0) // Position - 0x421B (16923)
{
	int num;
	var gamerHandle;
	var clanDesc;
...
int func_74(int iParam0) // Position - 0xB932 (47410)
{
	int i;
	int num;
	...
	switch (iParam0)
	{
		...
		case 676:
			for (i = 0; i < 5; i = i + 1)
			{
				if (Global_114344.f_1.f_126[Global_64510 /*23*/].f_11[i] == 1)
					num = num + Global_114344.f_1.f_126[Global_64510 /*23*/].f_17[i];
			}
	...
	for (i = 0; i < Global_76601; i = i + 1)
	{
		if (Global_76602[i /*9*/] == iParam0)
			return Global_76602[i /*9*/].f_1;
	}

	return 0;
}

int func_75(int iParam0) // Position - 0xB9CC (47564)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_76(int iParam0, int iParam1) // Position - 0xBA21 (47649)
{
	if (iParam1 < 0)
		return false;
	...
	if (iParam0 == 881 || iParam0 == 889 || iParam0 == 897 && Global_114344.f_24908[4 /*4*/] == _GET_CURRENT_PLAYER_CHARACTER())
...
void func_77(var uParam0) // Position - 0xBAEB (47851)
{
	int i;
	int value;
	BOOL flag;
...
void func_78(float fParam0, BOOL bParam1) // Position - 0xBC5E (48222)
{
	float num;
	int num2;
	int num3;
	...
	if (Global_76751)
	{
		...
		if (num < 100f)
			if (fParam0 >= 100f)
				Global_114344.f_10020.f_22 = Global_114344.f_10020.f_22 + 1;
...
void func_79(int iParam0, float fParam1, BOOL bParam2) // Position - 0xBD0F (48399)
{
	if (bParam2)
...
float func_80(int iParam0) // Position - 0xBD4A (48458)
{
	return Global_114344.f_9089.f_330[iParam0 /*6*/].f_5;
}

void func_81(int iParam0, float fParam1, BOOL bParam2) // Position - 0xBD62 (48482)
{
	if (bParam2)
...
float func_82(int iParam0) // Position - 0xBD97 (48535)
{
	return Global_114344.f_18578[iParam0 /*6*/].f_5;
}

float func_83(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xBDAC (48556)
{
	float value;
	int num;
	int num2;
...
int func_84(int iParam0) // Position - 0xBE8E (48782)
{
	int num;
...
void func_85(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xBECA (48842)
{
...
int func_86(float fParam0) // Position - 0xBF0F (48911)
{
	if (fParam0 == 0f)
		return 0;
...
float func_87(int iParam0, int iParam1, BOOL bParam2) // Position - 0xBF44 (48964)
{
	float num;
	float value;
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBFA3 (49059)
{
	float num;
	float num2;
	int num3;
	...
	num3 = { Global_64731[Global_76602[iParam1 /*9*/] /*13*/] };
	...
	if (num3 == 14)
		Global_76602[iParam1 /*9*/].f_1 = BUILTIN::FLOOR(Global_76602[iParam1 /*9*/].f_2);
	...
	if (!(num3.f_2 == 0))
	{
		num2 = BUILTIN::TO_FLOAT(BUILTIN::FLOOR((BUILTIN::TO_FLOAT(Global_76602[iParam1 /*9*/].f_1) / BUILTIN::TO_FLOAT(num3.f_2)) * 100f));
	...
	if (Global_76602[iParam1 /*9*/].f_3 == 0 || flag)
		if (num3.f_3)
			if (num4 > Global_76602[iParam1 /*9*/].f_1 || num4 < 0 || num4 == -1)
				func_90(Global_76602[iParam1 /*9*/].f_1, Global_76602[iParam1 /*9*/]);
		else if (Global_76602[iParam1 /*9*/].f_1 > num4 || num4 < 0 || num4 == -1)
			func_90(Global_76602[iParam1 /*9*/].f_1, Global_76602[iParam1 /*9*/]);

	num5 = Global_76602[iParam1 /*9*/].f_1;
	...
	str = func_89(Global_76602[iParam1 /*9*/]);
	...
	if (Global_76602[iParam1 /*9*/].f_3 != 0)
	{
		...
		func_96(uParam0, 8, str, str2, Global_76602[iParam1 /*9*/].f_1, 0, 3, 0);
	}
	else
	{
		iLocal_630 = 0;
		...
		{
			case 1:
				func_96(uParam0, 10, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 2:
				func_96(uParam0, 11, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 3:
				func_96(uParam0, 0, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
			...
			case 5:
				func_96(uParam0, 13, str, "", BUILTIN::CEIL((BUILTIN::TO_FLOAT(Global_76602[iParam1 /*9*/].f_1) / BUILTIN::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 8:
				num7 = Global_76602[iParam1 /*9*/].f_1;
			...
			case 9:
				func_96(uParam0, 13, str, "", BUILTIN::ROUND(Global_76602[iParam1 /*9*/].f_2), 0, num6, 0);
				break;
		
			case 10:
			case 15:
			case 16:
				func_96(uParam0, 1, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 11:
				func_96(uParam0, 13, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 14:
				func_96(uParam0, 14, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 12:
			case 13:
				func_96(uParam0, 5, str, "", Global_76602[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
...
char* func_89(int iParam0) // Position - 0xC4A6 (50342)
{
	switch (iParam0)
	{
		case 0:
...
void func_90(int iParam0, int iParam1) // Position - 0xD657 (54871)
{
	Hash statName;
	int value;

	statName = Global_64731[iParam1 /*13*/].f_4;
	...
	if (func_101(false) && Global_64498)
	{
...
int func_91(Hash hParam0) // Position - 0xD6B0 (54960)
{
	int outValue;
...
BOOL func_92(int iParam0) // Position - 0xD6D9 (55001)
{
	return IS_BIT_SET(Global_114344.f_1.f_118, iParam0);
}

int func_93(int iParam0) // Position - 0xD6EC (55020)
{
...
int func_94(int iParam0) // Position - 0xD719 (55065)
{
	int num;
...
char* func_95(int iParam0) // Position - 0xD76A (55146)
{
	switch (iParam0)
	{
		case 1:
...
void func_96(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xD7D8 (55256)
{
	int num;
...
void func_97(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD84B (55371)
{
...
void func_98(int iParam0) // Position - 0xD86E (55406)
{
	int num;
	int num2;
	int i;
	...
	num2 = Global_114344.f_1.f_126[iParam0 /*23*/].f_1;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		Global_114344.f_1.f_126[iParam0 /*23*/].f_17[i] = 0;
	}

	i = 0;
	num3 = 0;

	for (i = 0; i < Global_98098[iParam0 /*38*/].f_37; i = i + 1)
	{
		if (Global_98098[iParam0 /*38*/].f_31[i] > 0)
		{
			num3 = num3 + Global_98098[iParam0 /*38*/].f_31[i];
			Global_114344.f_1.f_126[iParam0 /*23*/].f_1 = Global_114344.f_1.f_126[iParam0 /*23*/].f_1 - Global_98098[iParam0 /*38*/].f_31[i];
		}
	}
	...
	if (iParam0 == 2)
	{
		num4 = BUILTIN::FLOOR(BUILTIN::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_1) * 0.78f);
		func_100(iParam0, 3, num4);
		Global_114344.f_1.f_126[iParam0 /*23*/].f_1 = Global_114344.f_1.f_126[iParam0 /*23*/].f_1 - num4;
		num2 = num2 - num4;
	}

	for (i = 0; i < 5; i = i + 1)
	{
		num5 = Global_114344.f_1.f_12[num /*6*/][i];
	
		switch (Global_114344.f_1.f_126[iParam0 /*23*/].f_11[i])
		{
			case 1:
			case 2:
			case 0:
				Global_114344.f_1.f_126[iParam0 /*23*/].f_17[i] = BUILTIN::CEIL(BUILTIN::TO_FLOAT(Global_97743[num5 /*5*/].f_1) * 0.01f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		
			case 3:
				Global_114344.f_1.f_126[iParam0 /*23*/].f_17[i] = BUILTIN::CEIL(BUILTIN::TO_FLOAT(Global_97743[num5 /*5*/].f_1) * 0.015f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		}
	}
	...
	{
		num2 = num2 - Global_114344.f_1.f_126[iParam0 /*23*/].f_17[i];
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			Global_114344.f_1.f_126[0 /*23*/].f_2[1] = BUILTIN::CEIL(0.12f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_114344.f_1.f_126[0 /*23*/].f_2[1];
			Global_98088.f_7 = BUILTIN::CEIL(0.14f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_98088.f_7;
			Global_98088.f_6 = 14f;
			Global_114344.f_1.f_126[0 /*23*/].f_2[0] = num2;
			break;
		...
		case 2:
			...
			Global_98088.f_7 = BUILTIN::CEIL(0.12f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_98088.f_7;
			Global_98088.f_6 = 12f;
			Global_114344.f_1.f_126[2 /*23*/].f_2[0] = num2 / 3;
			Global_114344.f_1.f_126[2 /*23*/].f_2[1] = num2 / 3;
			Global_114344.f_1.f_126[2 /*23*/].f_2[2] = num2 / 3;
			Global_98088.f_6 = 0f;
			break;
		...
		case 3:
			...
			num2 = num2 - Global_98088.f_7;
			Global_98088.f_6 = 12f;
			Global_114344.f_1.f_126[3 /*23*/].f_2[1] = num2;
			break;
		...
		case 4:
			...
			num2 = num2 - Global_98088.f_7;
			Global_98088.f_6 = 12f;
			Global_114344.f_1.f_126[4 /*23*/].f_2[0] = num2 / 3;
			Global_114344.f_1.f_126[4 /*23*/].f_2[1] = num2 / 3;
			Global_114344.f_1.f_126[4 /*23*/].f_2[2] = num2 / 3;
			Global_98088.f_6 = 0f;
			break;
	}

	value = Global_114344.f_1.f_126[iParam0 /*23*/].f_1;

	if (Global_114344.f_1.f_126[iParam0 /*23*/].f_6[0] != -1f)
		Global_114344.f_1.f_126[iParam0 /*23*/].f_6[0] = (BUILTIN::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_2[0]) / BUILTIN::TO_FLOAT(value)) * 100f;

	if (Global_114344.f_1.f_126[iParam0 /*23*/].f_6[1] != -1f)
		Global_114344.f_1.f_126[iParam0 /*23*/].f_6[1] = (BUILTIN::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_2[1]) / BUILTIN::TO_FLOAT(value)) * 100f;

	if (Global_114344.f_1.f_126[iParam0 /*23*/].f_6[2] != -1f)
		Global_114344.f_1.f_126[iParam0 /*23*/].f_6[2] = (BUILTIN::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_2[2]) / BUILTIN::TO_FLOAT(value)) * 100f;

	if (Global_98088.f_6 != -1f)
		Global_98088.f_6 = (BUILTIN::TO_FLOAT(Global_98088.f_7) / BUILTIN::TO_FLOAT(value)) * 100f;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		num6 = num6 + Global_114344.f_1.f_126[iParam0 /*23*/].f_2[j];
	}

	switch (iParam0)
	{
		case 0:
			func_99(810, Global_114344.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 1:
			...
			{
				case 3:
					func_99(610, Global_114344.f_1.f_126[iParam0 /*23*/].f_1, true);
					func_99(611, num6, true);
					break;
			
				case 4:
					func_99(622, Global_114344.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 2:
			func_99(734, Global_114344.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 4:
			...
			{
				case 8:
					func_99(664, Global_114344.f_1.f_126[iParam0 /*23*/].f_1, true);
					func_99(671, num6, true);
					break;
			
				case 9:
					func_99(674, Global_114344.f_1.f_126[iParam0 /*23*/].f_1, true);
...
void func_99(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE16F (57711)
{
	int i;
...
void func_100(int iParam0, int iParam1, int iParam2) // Position - 0xE219 (57881)
{
	int num;
	BOOL flag;
	int num2;
	...
	num2 = Global_98098[iParam0 /*38*/].f_37;
	i = 0;

	for (i = 0; i < num2; i = i + 1)
	{
		if (Global_98098[iParam0 /*38*/].f_25[i] == iParam1)
		{
			Global_98098[iParam0 /*38*/].f_25[i] = iParam1;
			Global_98098[iParam0 /*38*/].f_31[i] = num;
			return;
		}
	}
	...
	Global_98098[iParam0 /*38*/].f_31[Global_98098[iParam0 /*38*/].f_37] = num;
	Global_98098[iParam0 /*38*/].f_37 = Global_98098[iParam0 /*38*/].f_37 + 1;
	return;
}

BOOL func_101(BOOL bParam0) // Position - 0xE3D1 (58321)
{
...
void func_102() // Position - 0xE3F9 (58361)
{
	int i;
	int num;
	...
	{
		if (Global_76602[i /*9*/].f_1 == 0)
			if (Global_76602[i /*9*/].f_2 != 0f)
				Global_76602[i /*9*/].f_1 = BUILTIN::FLOOR(Global_76602[i /*9*/].f_2);
	
		num = Global_76602[i /*9*/];
	
		if (num > 0)
		{
			if (Global_64731[num /*13*/] == 9)
				Global_76602[i /*9*/].f_1 = BUILTIN::ROUND(fLocal_632);
		
			if (Global_64731[num /*13*/] == 15)
				Global_76602[i /*9*/].f_1 = iLocal_633;
		}
	}
...
void func_103() // Position - 0xE4A0 (58528)
{
	int value;
	int value2;
	float num;
	...
	value = 0;
	value2 = 0;
	value = func_7(joaat("SP0_SHOTS")) - Global_64529;
	value2 = func_7(joaat("SP0_HITS")) - Global_64528;
	value = value + (func_7(joaat("SP1_SHOTS")) - Global_64531);
	value2 = value2 + (func_7(joaat("SP1_HITS")) - Global_64530);
	value = value + (func_7(joaat("SP2_SHOTS")) - Global_64533);
	value2 = value2 + (func_7(joaat("SP2_HITS")) - Global_64532);
	BUILTIN::WAIT(0);
	num = 100f;
...
void func_104(var uParam0) // Position - 0xE576 (58742)
{
	func_70(uParam0);
	uParam0->f_574 = 0;
	uParam0->f_31 = 0;
...
BOOL func_105() // Position - 0xE5A0 (58784)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_106() // Position - 0xE5BC (58812)
{
	int i;
	...
	for (i = 0; i < Global_76601; i = i + 1)
	{
		Global_76602[i /*9*/].f_3 = 4;
	}

	return;
}

void func_107() // Position - 0xE5FB (58875)
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (flag)
		iLocal_624 = BUILTIN::ROUND(MISC::GET_FRAME_TIME() * 1000f);
	...
	for (i = 0; i < Global_76601; i = i + 1)
	{
		if (Global_76602[i /*9*/] >= 0)
		{
			num = Global_64731[Global_76602[i /*9*/] /*13*/];
		
			switch (num)
			{
				case 6:
					if (Global_76602[i /*9*/].f_6 != 0)
					{
						if (Global_76602[i /*9*/].f_7 == 1)
						{
							Global_76602[i /*9*/].f_8 = 0;
							Global_76602[i /*9*/].f_1 = 0;
							Global_76602[i /*9*/].f_7 = 0;
						}
						else if (ENTITY::DOES_ENTITY_EXIST(Global_76602[i /*9*/].f_6))
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_76602[i /*9*/].f_6, false))
							{
								iLocal_628 = Global_76602[i /*9*/].f_8;
								iLocal_627 = ENTITY::GET_ENTITY_HEALTH(Global_76602[i /*9*/].f_6);
								iLocal_629 = iLocal_628 - iLocal_627;
							
								if (iLocal_629 > 0)
								{
									Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 + iLocal_629;
								
									if (Global_76602[i /*9*/].f_1 < 0)
										Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 * -1;
								}
							
								Global_76602[i /*9*/].f_8 = iLocal_627;
							}
						}
						else
						{
							Global_76602[i /*9*/].f_6 = 0;
						}
					}
					break;
			
				case 1:
					Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 4:
					if (Global_64514)
						if (Global_64516 == -1 || Global_76602[i /*9*/] == Global_64516)
							if (Global_76602[i /*9*/] == 339 || Global_76602[i /*9*/] == 179 || Global_76602[i /*9*/] == 342 || Global_76602[i /*9*/] == 234)
								Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 + BUILTIN::ROUND(MISC::GET_FRAME_TIME() * 1000f);
							else
								Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_64518 == -1 || Global_64518 == Global_76602[i /*9*/])
						{
							if (!(Global_64517 == 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(Global_64517))
								{
									if (!ENTITY::IS_ENTITY_DEAD(Global_64517, false))
									{
										...
										{
											entitySpeed = ENTITY::GET_ENTITY_SPEED(Global_64517);
										
											if (entitySpeed > Global_76602[i /*9*/].f_2)
												Global_76602[i /*9*/].f_2 = entitySpeed;
										}
									}
								}
							}
...
void func_108() // Position - 0xE9D6 (59862)
{
	int i;
	int j;
	int num;
	...
	if (Global_64535 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Global_64536[i /*2*/]))
				{
					Global_64536[i /*2*/] = 0;
			...
			case EVENT_ENTITY_DESTROYED:
				...
				if (ENTITY::DOES_ENTITY_EXIST(eventData))
				{
					...
					if (Global_64665 > 0)
					{
						...
						for (j = 0; j < Global_64665; j = j + 1)
						{
							if (Global_64666[j /*2*/] == entityModel)
								num2 = num2 + Global_64666[j /*2*/].f_1;
						}
					}
						...
						if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath) && PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()) == ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedSourceOfDeath) || flag2)
						{
							if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath))
							{
								...
								if (Global_64535 > 0)
								{
									...
									if (num3 != -1)
									{
										PED::GET_PED_LAST_DAMAGE_BONE(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Global_64536[num3 /*2*/]), &iLocal_631);
								...
								if (Global_76797 > 0)
								{
									...
									for (j = 0; j < Global_76797; j = j + 1)
									{
										if (Global_76788[j /*2*/] == pedCauseOfDeath)
											func_99(Global_76788[j /*2*/].f_1, 1, false);
									}
								}
							}
							...
							if (Global_76787 > 0)
							{
								...
								while (!flag)
								{
									if (Global_76754[j /*2*/] != 0)
									{
										if (ENTITY::DOES_ENTITY_EXIST(Global_76754[j /*2*/]))
										{
											if (ENTITY::IS_ENTITY_DEAD(Global_76754[j /*2*/], false))
											{
												if (Global_76754[j /*2*/] == eventData)
												{
													func_99(Global_76754[j /*2*/].f_1, 1, false);
													Global_76754[j /*2*/] = 0;
												}
											}
										}
...
void func_109(int iParam0) // Position - 0xEDDF (60895)
{
	int i;
	int num;
...
void func_110() // Position - 0xEE2C (60972)
{
	int i;
	int num;
...
void func_111() // Position - 0xEE78 (61048)
{
	BOOL flag;
	int i;
	int num;
...
int func_112(Ped pedParam0) // Position - 0xEED6 (61142)
{
	int i;
...
void func_113() // Position - 0xEF11 (61201)
{
	int replayStatCount;
	int value;
	int num;
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 33)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 33)
			{
				...
				if ((replayStatCount - 4) % 3 == 0)
				{
					...
					Global_76751 = flag2;
					Global_76752 = replayStatAtIndex3;
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 13)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 37)
			{
				...
				if (replayStatCount2 == 3)
				{
					...
					Global_114344.f_2356[replayStatAtIndex5 /*2*/] = replayStatAtIndex6;
					Global_114344.f_2356[replayStatAtIndex5 /*2*/].f_1 = replayStatAtIndex7;
					func_114();
				}
			}
		}
...
int func_114() // Position - 0xF071 (61553)
{
	if (func_101(false))
		return 0;
...
void func_115() // Position - 0xF0BC (61628)
{
	Global_80005 = false;
	Global_80006 = false;
	Global_64506 = false;
