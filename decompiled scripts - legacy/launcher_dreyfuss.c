...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB5F8 (46584)
{
	int num;
	int num2;
...
BOOL func_192() // Position - 0xC9DC (51676)
{
...
void func_205(int iParam0, BOOL bParam1) // Position - 0xD65A (54874)
{
	if (iParam0 == -1)
		return;
...
int func_206(int iParam0) // Position - 0xD696 (54934)
{
	if (Global_80276 == iParam0)
		if (Global_80277 == -1)
...
int func_259() // Position - 0x10013 (65555)
{
	return Global_33776;
}
