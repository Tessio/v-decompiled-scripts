...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (func_71(PLAYER::PLAYER_ID()))
			if (func_70())
				func_67(&uLocal_139, -271.6364f, 289.377f, 103.994f, BLIP_ELEVATOR, "MSG_BLP_EL" /*Ascensor*/, 0.8f, false, false);
			else
				func_66(&uLocal_139);
			...
			if (func_56(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9 /*14*/]) && func_55(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				...
				else if (uParam0->f_6 == -1)
				{
					if (MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)
						if (func_44(uParam0->f_9) && !Global_262145.f_26711)
...
BOOL func_15(BOOL bParam0) // Position - 0xC30 (3120)
{
...
BOOL func_16(Ped pedParam0) // Position - 0xD1B (3355)
{
	int weaponHash;
...
BOOL func_17() // Position - 0xD78 (3448)
{
...
BOOL func_18(var uParam0) // Position - 0xD92 (3474)
{
	return func_23(&(uParam0->f_7), 9);
}

void func_19(var uParam0) // Position - 0xDA4 (3492)
{
	var animDict;
	var animnName;
...
void func_20(var uParam0) // Position - 0xE57 (3671)
{
	var animDict;
...
BOOL func_21() // Position - 0xEC1 (3777)
{
	return IS_BIT_SET(Global_1950198.f_3, 25);
}

void func_22(int* piParam0, int iParam1) // Position - 0xED2 (3794)
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_23(var uParam0, int iParam1) // Position - 0xEE2 (3810)
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_24(float fParam0, float fParam1, float fParam2) // Position - 0xEF0 (3824)
{
	float num;
	float num2;
...
void func_25(var uParam0) // Position - 0xF76 (3958)
{
	int weaponHash;
...
void func_26() // Position - 0x100A (4106)
{
	Global_24390.f_6 = 1;
	return;
}

void func_27(BOOL bParam0) // Position - 0x1018 (4120)
{
	if (bParam0)
		if (func_28())
...
void func_29() // Position - 0x104E (4174)
{
...
void func_31(int iParam0) // Position - 0x1091 (4241)
{
	if (func_36())
		return;
...
BOOL func_32() // Position - 0x111B (4379)
{
...
void func_33(BOOL bParam0, BOOL bParam1) // Position - 0x1142 (4418)
{
	if (bParam0)
	{
		if (func_35(0))
...
BOOL func_34() // Position - 0x11B6 (4534)
{
	return IS_BIT_SET(Global_1964145, 5);
}

ePedComponentType func_35(int iParam0) // Position - 0x11C4 (4548)
{
	if (iParam0 == 1)
...
BOOL func_36() // Position - 0x121B (4635)
{
	return IS_BIT_SET(Global_1964145, 19);
}

Vector3 func_37(var uParam0) // Position - 0x122A (4650)
{
	var unk;
...
Vector3 func_38(var uParam0) // Position - 0x1266 (4710)
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_39(var uParam0, char* sParam1) // Position - 0x127A (4730)
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_10())
...
void func_40(var uParam0, char* sParam1) // Position - 0x15AF (5551)
{
...
void func_41(var uParam0) // Position - 0x1839 (6201)
{
...
int func_42(var uParam0) // Position - 0x1871 (6257)
{
	int randomIntInRange;
...
int func_43(int iParam0) // Position - 0x1909 (6409)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_44(int iParam0) // Position - 0x1937 (6455)
{
	switch (iParam0)
	{
		case 2:
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x1975 (6517)
{
	int i;
...
BOOL func_46(Player plParam0) // Position - 0x1AA0 (6816)
{
	return func_47(plParam0) == joaat("WEAPON_MINIGUN");
}

BOOL func_47(Player plParam0) // Position - 0x1AB4 (6836)
{
	return Global_1892653[plParam0 /*615*/].f_592;
}

BOOL func_48(var uParam0) // Position - 0x1AC8 (6856)
{
	*uParam0(!func_23(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_49(var uParam0) // Position - 0x1AF2 (6898)
{
	var sizeAndPeds;
	int i;
...
int func_51(ePedComponentType epctParam0) // Position - 0x1BE3 (7139)
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1C04 (7172)
{
	return -1;
}

ePedComponentType _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1C0D (7181)
{
...
BOOL func_54(var uParam0) // Position - 0x1C6D (7277)
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_55(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x1C7E (7294)
{
...
BOOL func_58(int iParam0) // Position - 0x1D71 (7537)
{
	switch (iParam0)
	{
		case 1:
...
void func_59(int* piParam0, int iParam1) // Position - 0x1DD7 (7639)
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_60(var uParam0) // Position - 0x1DE7 (7655)
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_61() // Position - 0x1E3A (7738)
{
	return 0.13f;
}

void func_62(var uParam0) // Position - 0x1E47 (7751)
{
...
void func_63(int* piParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1E9F (7839)
{
	int offset;
...
ePedComponentType func_64() // Position - 0x1EC3 (7875)
{
	return Global_77342;
}

BOOL func_65() // Position - 0x1ECF (7887)
{
...
void func_66(Blip* pblParam0) // Position - 0x1EE6 (7910)
{
...
void func_67(var uParam0, float fParam1, float fParam2, float fParam3, eBlipSprite ebsParam4, char* sParam5, float fParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1F06 (7942)
{
...
Blip func_68(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1F69 (8041)
{
	Blip blip;
...
var func_69(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1F95 (8085)
{
	if (bParam0)
		return uParam1;
...
BOOL func_70() // Position - 0x1FAC (8108)
{
	return IS_BIT_SET(Global_1950198.f_11, 17);
}

BOOL func_71(Player plParam0) // Position - 0x1FBD (8125)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return Global_1845250[plParam0 /*880*/].f_260.f_524 != 0;
...
BOOL func_72() // Position - 0x1FE3 (8163)
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), Global_1950198.f_1322[161 /*3*/], true) >= 150f)
		return true;
...
BOOL func_73() // Position - 0x2053 (8275)
{
	if (func_74() == 0)
		return true;
...
int func_74() // Position - 0x2068 (8296)
{
	return Global_1574634.f_18;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x2076 (8310)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x20FA (8442)
{
	switch (func_78())
	{
...
Hash func_77() // Position - 0x212D (8493)
{
...
eHudColour func_78() // Position - 0x2151 (8529)
{
	return Global_33775;
}

BOOL func_79() // Position - 0x215C (8540)
{
	return Global_2685150.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x216B (8555)
{
...
BOOL func_81() // Position - 0x2182 (8578)
{
	return Global_2696964;
}

BOOL func_82() // Position - 0x218E (8590)
{
	return Global_2685150.f_695;
}

Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x219D (8605)
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

BOOL func_84(ePedComponentType epctParam0) // Position - 0x21B0 (8624)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_85(Player plParam0) // Position - 0x2216 (8726)
{
...
void func_86() // Position - 0x2247 (8775)
{
	func_88(&uLocal_140);
	func_66(&uLocal_139);
	func_87();
...
void func_87() // Position - 0x225F (8799)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_88(var uParam0) // Position - 0x226B (8811)
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x22CA (8906)
{
...
BOOL func_90(BOOL bParam0) // Position - 0x277F (10111)
{
...
BOOL func_91() // Position - 0x27AB (10155)
{
	if (func_92())
		return true;
...
BOOL func_92() // Position - 0x27C6 (10182)
{
...
BOOL func_93(int iParam0) // Position - 0x27F1 (10225)
{
	return iParam0 == 17;
}

void func_94() // Position - 0x27FE (10238)
{
	var unk;
...
void func_95() // Position - 0x284B (10315)
{
...
BOOL func_96(Ped pedParam0) // Position - 0x2889 (10377)
{
	int scriptTaskStatus;
...
void func_97(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x28BA (10426)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x298A (10634)
{
	Hash statName;
...
void func_99() // Position - 0x29A6 (10662)
{
	eViewModeContext i;
...
BOOL func_100(Player plParam0) // Position - 0x29FE (10750)
{
...
BOOL func_101() // Position - 0x2A3D (10813)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_102(Player plParam0, int iParam1) // Position - 0x2A4B (10827)
{
	BOOL flag;
...
eCharacter func_103(BOOL bParam0, BOOL bParam1) // Position - 0x2AA4 (10916)
{
...
BOOL func_104() // Position - 0x2AE5 (10981)
{
	return Global_1574927;
}

BOOL func_105(Player plParam0) // Position - 0x2AF1 (10993)
{
	Player player;
...
BOOL func_106() // Position - 0x2B13 (11027)
{
...
void func_107() // Position - 0x2B44 (11076)
{
...
void func_108() // Position - 0x2B72 (11122)
{
	func_109(0, &uLocal_140, 0, 2);
	func_109(1, &uLocal_140, 1, 1);
	func_109(2, &uLocal_140, 2, 2);
	func_109(3, &uLocal_140, 3, 1);
	func_109(4, &uLocal_140, 4, 2);
	func_109(5, &uLocal_140, 5, 1);
	func_109(6, &uLocal_140, 6, 2);
	func_109(7, &uLocal_140, 7, 1);
	return;
}

void func_109(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2BC2 (11202)
{
	var unk;
	float num;
	...
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_111(func_112(), num) + unk };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_111(func_110(), num) + unk };
	uParam1->f_16[iParam2 /*14*/].f_6 = fLocal_122;
	return;
}

Vector3 func_110() // Position - 0x2C44 (11332)
{
	return 0.4f, -0.5f, 2f;
}

Vector3 func_111(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2C57 (11351)
{
	float num;
	float num2;
	float num3;
...
Vector3 func_112() // Position - 0x2C9B (11419)
{
	return -0.4f, -0.5f, 0f;
}

void func_113(int iParam0, var uParam1, var uParam2) // Position - 0x2CAE (11438)
{
	switch (iParam0)
	{
		case 0:
...
void func_114() // Position - 0x2DD5 (11733)
{
	return;
}

int func_115(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2DDD (11741)
{
	int i;
