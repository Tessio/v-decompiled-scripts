...
int func_12(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x9AF (2479)
{
	...
	if (iParam5 == 0)
	{
		Global_79527[1 /*14*/] = { func_65(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79527[1 /*14*/] = { func_65(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79527[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79527[1 /*14*/] = { func_65(entityModel, 14, unk18[j], -1) };
							func_32(pedParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
							func_55(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_22(i), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_22(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_22(i), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79527[1 /*14*/] = { func_65(entityModel, i, func_21(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79527[1 /*14*/] = { func_65(entityModel, 14, unk59[j], -1) };
			func_32(pedParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
			func_55(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_22(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_22(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_22(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
...
BOOL func_13(Ped pedParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x11C0 (4544)
{
	...
	{
		if (!func_130(pedParam0, Global_114344.f_2367.f_539[num /*65*/].f_64, Global_114344.f_2367.f_539[num /*65*/].f_63))
		{
...
{
	Global_79527[1 /*14*/] = { func_65(epctParam0, iParam1, epctParam2, -1) };
...
BOOL func_20(Ped pedParam0, ePedComponentType epctParam1, var uParam2, int iParam3) // Position - 0x1AC9 (6857)
{
	...
	{
		if (!func_130(pedParam0, Global_114344.f_2367.f_539[num /*65*/].f_61, Global_114344.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
Hash func_34(ePedComponentType epctParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x399D (14749)
{
	...
	else
	{
		...
		num2 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_22(iParam2));
...
int func_39(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x410A (16650)
{
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_22(iParam2));
	...
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
			switch (epctParam1)
			{
				...
				case 5:
					func_48(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[0], Global_114344.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (epctParam1)
			{
				...
				case 2:
					func_48(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[1], Global_114344.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (epctParam1)
			{
				...
				case 4:
					func_48(&unk, -99, -99, Global_114344.f_2367.f_539.f_196[2], Global_114344.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
BOOL func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xA736 (42806)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_64(int iParam0) // Position - 0xB5D9 (46553)
{
	if (!IS_BIT_SET(Global_79527[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_65(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xB621 (46625)
{
	func_129();
...
void func_66(int iParam0, int iParam1) // Position - 0xB673 (46707)
{
	switch (iParam0)
	{
		case 0:
...
void func_67(int iParam0) // Position - 0xB763 (46947)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_68(&Global_79527[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_68(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xC995 (51605)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_61(func_71(iParam1, iParam0->f_2), Global_79524);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_61(func_70(iParam1, iParam0->f_2), Global_79524);
...
BOOL func_69(int iParam0, int iParam1, var uParam2) // Position - 0xCD36 (52534)
{
	*uParam2 = 979;
...
int func_70(int iParam0, int iParam1) // Position - 0xD13B (53563)
{
	switch (iParam1)
	{
		case 0:
...
int func_71(int iParam0, int iParam1) // Position - 0xD536 (54582)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_72(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD931 (55601)
{
	int num;
	int num2;
	int num3;
...
BOOL func_73(int iParam0) // Position - 0xD96F (55663)
{
	return Global_44375 == iParam0;
}

int func_74(int iParam0) // Position - 0xD97D (55677)
{
	switch (iParam0)
	{
		case -1:
...
void func_75(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xDA51 (55889)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_68(&Global_79527[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_68(&Global_79527[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		EXTRAMETADATA::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_68(&Global_79527[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79725)
		{
			...
			func_68(&Global_79527[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_22(iParam0));
...
void func_76(int iParam0) // Position - 0xDCD7 (56535)
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0xDE24 (56868)
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0xE331 (58161)
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Position - 0xE3A5 (58277)
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Position - 0xE418 (58392)
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Position - 0xE4FF (58623)
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Position - 0xE841 (59457)
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Position - 0xEA49 (59977)
{
	BOOL flag;
	int num;
	var unk;
...
void func_84(int iParam0) // Position - 0xEC69 (60521)
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Position - 0xED72 (60786)
{
	BOOL flag;
	int num;
	var unk;
...
void func_86(int iParam0) // Position - 0xF704 (63236)
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0x1025D (66141)
{
	if (iParam0 < 136)
		func_89(iParam0);
	else
...
void func_88(int iParam0) // Position - 0x10292 (66194)
{
	BOOL flag;
	int num;
	var unk;
...
void func_89(int iParam0) // Position - 0x10E96 (69270)
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0) // Position - 0x11D96 (73110)
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0) // Position - 0x11EC3 (73411)
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0, int iParam1) // Position - 0x11FBA (73658)
{
	switch (iParam0)
	{
		case 0:
...
void func_93(int iParam0) // Position - 0x120AA (73898)
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0x13577 (79223)
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Position - 0x136BE (79550)
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0x13BC8 (80840)
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0x14234 (82484)
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0x142A7 (82599)
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0x14377 (82807)
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x14872 (84082)
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x14A03 (84483)
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Position - 0x151F2 (86514)
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0x152FB (86779)
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0x1621E (90654)
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x16ECB (93899)
{
	if (iParam0 < 107)
		func_108(iParam0);
	else if (iParam0 < 227)
...
void func_106(int iParam0) // Position - 0x16F11 (93969)
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Position - 0x179B5 (96693)
{
	BOOL flag;
	int num;
	var unk;
...
void func_108(int iParam0) // Position - 0x187A4 (100260)
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x193E3 (103395)
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x1965B (104027)
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0, int iParam1) // Position - 0x19797 (104343)
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0) // Position - 0x19887 (104583)
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Position - 0x1A5E5 (108005)
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x1A754 (108372)
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x1ACC5 (109765)
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x1B1ED (111085)
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x1B260 (111200)
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x1B330 (111408)
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x1B7E0 (112608)
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x1BA3B (113211)
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Position - 0x1BCFB (113915)
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x1BEB6 (114358)
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_130(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1EDF0 (126448)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79527[1 /*14*/] = { func_65(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_130(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_130(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79527[2 /*14*/] = { func_65(entityModel, 14, k, -1) };
								
									if (Global_79527[2 /*14*/].f_12 == j)
										if (func_130(pedParam0, 14, k))
											if (!func_18(entityModel, epctParam2, 14, k, &unk, &Global_79527[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79527[2 /*14*/] = { func_65(entityModel, i, type, -1) };
					
						if (!func_18(entityModel, epctParam2, i, type, &unk, &Global_79527[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79527[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_22(epctParam1)) && Global_79527[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_22(epctParam1)))
	{
		return true;
	}
...
void func_132() // Position - 0x1F062 (127074)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_133(character) && !func_73(14) || Global_113292)
			{
				if (Global_114344.f_2367.f_539.f_4321 != character && func_133(Global_114344.f_2367.f_539.f_4321))
...
void func_175() // Position - 0x1FFA1 (130977)
{
	...
	if (func_176(197, &offset))
		if (!IS_BIT_SET(Global_114344.f_18537.f_23, offset))
			MISC::SET_BIT(&(Global_114344.f_18537.f_23), offset);
