...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB73C (46908)
{
	int num;
	int num2;
...
BOOL func_203() // Position - 0xDB6B (56171)
{
...
void func_223(int iParam0, BOOL bParam1) // Position - 0xE4FB (58619)
{
	if (iParam0 == -1)
		return;
...
int func_224(int iParam0) // Position - 0xE537 (58679)
{
	if (Global_80276 == iParam0)
		if (Global_80277 == -1)
