...
void func_5() // Position - 0x57D (1405)
{
	...
	switch (Global_21610.f_1)
	{
		case 6:
			...
			if (Global_21598)
			{
				func_21(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
				func_21(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_21843 == true)
					if (Global_21598)
						func_21(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_21(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_21598)
					func_21(Global_21591, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
		...
		case 10:
			...
			{
				func_21(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
		...
		case 9:
			if (Global_21609 == 1)
			{
				...
				{
					func_21(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_8778 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_21(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_2339[Global_8778 /*29*/].f_3), &(Global_2339[Global_8778 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2339[Global_8778 /*29*/].f_3), 0);
				}
			...
			else if (Global_22983 == 4 || Global_22983 == 3)
			{
				...
				else
				{
					...
					if (func_8(Global_8778, Global_21610) == 0)
					{
						...
						func_21(Global_21591, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8778 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_72(Global_21591, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_6() // Position - 0xB69 (2921)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_21591))
	{
		...
		{
			if (Global_21598)
				func_21(Global_21591, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
			...
			if (Global_23030)
				...
				func_21(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_21(Global_21591, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
...
void func_31(int iParam0, int iParam1) // Position - 0x2162 (8546)
{
	...
	num2 = Global_49438[iParam0 /*46*/].f_32[num];

	if (!(iParam1 < Global_46113[num2 /*12*/].f_4))
		return;

	num3 = Global_46113[num2 /*12*/].f_5[iParam1 /*4*/].f_1;
	flag = false;

	if (Global_49438[iParam0 /*46*/].f_31 < Global_49438[iParam0 /*46*/].f_30 - 1)
	{
		num4 = Global_49438[iParam0 /*46*/].f_8[Global_49438[iParam0 /*46*/].f_31];
	...
	if (!flag)
	{
		if (num3 > -1)
		{
			...
			num5 = Global_49438[iParam0 /*46*/].f_2;
			i = 0;
			num6 = Global_46113[num3 /*12*/].f_2;
	...
	if (Global_46113[num2 /*12*/].f_5[iParam1 /*4*/].f_3 > -1)
		func_32(Global_46113[num2 /*12*/].f_5[iParam1 /*4*/].f_3, false);

	if (Global_46113[num2 /*12*/].f_5[iParam1 /*4*/].f_2)
	{
		Global_49438[iParam0 /*46*/].f_1 = 1;
	}
	else if (num3 > -1)
	{
		Global_49438[iParam0 /*46*/].f_45 = Global_46113[num3 /*12*/].f_10;
		Global_49438[iParam0 /*46*/].f_43 = Global_46113[num3 /*12*/].f_11;
	}
	else
	{
...
void func_34(int iParam0, BOOL bParam1) // Position - 0x238E (9102)
{
	...
	func_35(Global_46113[num2 /*12*/].f_3, iParam0, false, false, bParam1);
	...
	for (i = 0; i < num3; i = i + 1)
	{
		if (Global_49438[iParam0 /*46*/].f_3[i] != Global_46113[num2 /*12*/].f_2 && Global_49438[iParam0 /*46*/].f_3[i] != Global_46113[num2 /*12*/].f_3)
			func_35(Global_49438[iParam0 /*46*/].f_3[i], iParam0, false, false, bParam1);
	}
...
void func_35(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x252A (9514)
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_40(Global_46113[num5 /*12*/].f_1) };
	...
	else
	{
		...
		if (Global_55413[num6 /*203*/].f_10[Global_55413[num6 /*203*/].f_9 - 1 /*48*/].f_1)
			...
			unk = { func_40(Global_46113[num8 /*12*/].f_1) };
	}
...
void func_48(int iParam0, eCharacter echParam1, int iParam2) // Position - 0x34B3 (13491)
{
	...
	if (!Global_55051[num /*120*/].f_86[num2])
	{
		...
		{
			num7 = Global_46113[num5 /*12*/].f_5[j /*4*/].f_1;
			unk = { func_40(Global_46113[num7 /*12*/].f_1) };
			unk17 = { func_40(Global_46113[num7 /*12*/].f_1) };
			...
			func_9(&unk17);
			func_9(func_50(Global_46113[num7 /*12*/].f_2));
			func_49(num7, Global_46113[num7 /*12*/].f_2);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
	}
...
void func_75(eCharacter echParam0) // Position - 0x558A (21898)
{
	...
	for (j = 0; j < num2; j = j + 1)
	{
		...
		{
			unk120 = Global_55051[num /*120*/].f_18[num3];
			num5 = -1;
			k = 0;
		
			for (k = 0; k < 7; k = k + 1)
			{
				if (Global_55413[k /*203*/].f_1 == unk120)
					num5 = k;
			}
		...
		{
			num6 = num4;
			num4.f_1[num6] = Global_55051[num /*120*/].f_1[num3];
			num4.f_18[num6] = Global_55051[num /*120*/].f_18[num3];
			num4.f_35[num6] = Global_55051[num /*120*/].f_35[num3];
			num4.f_52[num6] = Global_55051[num /*120*/].f_52[num3];
			num4.f_69[num6] = Global_55051[num /*120*/].f_69[num3];
			num4.f_86[num6] = Global_55051[num /*120*/].f_86[num3];
			num4 = num4 + 1;
		}
