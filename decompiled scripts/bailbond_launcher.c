...
void func_28(int iParam0) // Position - 0x1E62 Hash - 0x6514B1B3 ^0x794D213E
{
	...
	switch (iParam0)
	{
		case 1:
		case 2:
			MISC::SET_BIT(&(Global_114135.f_24990), func_73(uLocal_41.f_4));
		
			if (iParam0 == 1)
			{
				func_72(0);
				num = 8;
				MISC::SET_BIT(&(Global_114135.f_24990), func_71(uLocal_41.f_4));
			}
			else
			{
				func_72(true);
				num = 4;
				MISC::CLEAR_BIT(&(Global_114135.f_24990), func_71(uLocal_41.f_4));
				func_210(2, 95, 10000, false, false);
			
				if (Global_95840 == false)
					func_57(30, 1);
			}
...
void func_77(const char* sParam0, int iParam1, Ped pedParam2) // Position - 0x3192 Hash - 0xB566D143 ^0xDB451503
{
	if (Global_101688 != 10 && Global_101688 != 9)
	{
		...
		func_79(&Global_104696, sParam0, 0, "Start", iParam1, pedParam2);
		func_78();
		Global_95841 = 0;
	}
...
int func_102(int iParam0, int iParam1) // Position - 0x5CB6 Hash - 0x744E461C ^0x5051D2B7
{
	Hash statHash;
	int outValue;
...
void func_112(Ped pedParam0, BOOL bParam1) // Position - 0x6613 Hash - 0xC106EC1D ^0x74ED6306
{
	...
	if (func_90(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_113(pedParam0, &Global_114135.f_2367.f_539.f_298[character /*477*/]);
...
Hash func_116(Hash hParam0, int iParam1) // Position - 0x6C27 Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_117(Hash hParam0, Any* panParam1) // Position - 0x79A8 Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_118(int iParam0) // Position - 0x79E3 Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_119(Ped pedParam0) // Position - 0x7C57 Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_120(var uParam0, int iParam1) // Position - 0x7C93 Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_121(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x81E3 Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_122(int iParam0, var uParam1, var uParam2) // Position - 0x8227 Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_123(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x89A6 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_124(var uParam0) // Position - 0x89ED Hash - 0xDB33C708 ^0xF5B91AC7
{
...
BOOL func_125(int iParam0) // Position - 0x8A48 Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_126(iParam0, 0, true);
}

BOOL func_126(int iParam0, int iParam1, BOOL bParam2) // Position - 0x8A58 Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_127(int iParam0) // Position - 0x8AB8 Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_128() // Position - 0x8E6F Hash - 0x21D64237 ^0x21D64237
{
	return Global_33087;
}

BOOL func_129(int iParam0) // Position - 0x8E7A Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_126(iParam0, 5, true);
}

int func_130(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x8E8A Hash - 0x999E57A3 ^0x999E57A3
{
	int i;
...
Vector3 func_131(int iParam0, BOOL bParam1) // Position - 0x8F2C Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_132() // Position - 0x96A6 Hash - 0x6E37375C ^0x6E37375C
{
...
int func_133() // Position - 0x99A1 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652568.f_2706;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x99B0 Hash - 0x16E871AD ^0x10C54C39
{
...
int func_135() // Position - 0x99DA Hash - 0xEAE183ED ^0x84867848
{
	return Global_2657991[PLAYER::PLAYER_ID() /*467*/].f_324.f_8;
}

Vector3 func_136(float fParam0, float fParam1, float fParam2) // Position - 0x99F2 Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_137(), 0f, fParam0);
}

Vector3 func_137() // Position - 0x9A07 Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_138(Player plParam0) // Position - 0x9A1E Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_139(int iParam0, int iParam1) // Position - 0x9A76 Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_140(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x9B20 Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_141(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x9BB5 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_142(int iParam0) // Position - 0x9BF9 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_143(int iParam0) // Position - 0x9D7D Hash - 0x2623C81B ^0x2623C81B
{
	return func_144(iParam0);
}

struct<6> func_144(int iParam0) // Position - 0x9D8B Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
BOOL func_145(int iParam0, var uParam1) // Position - 0xA852 Hash - 0x31632D18 ^0xF002B35A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_146(Player plParam0) // Position - 0xA8D4 Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0xA92C Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

Vector3 func_148(int iParam0) // Position - 0xA935 Hash - 0xCBED323 ^0xCBED323
{
	switch (iParam0)
	{
		case 1:
...
int func_149() // Position - 0xABBC Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_150(PLAYER::PLAYER_ID());
}

int func_150(Player plParam0) // Position - 0xABCC Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657991[plParam0 /*467*/].f_324.f_3, 28, 31);
}

BOOL func_151(int iParam0) // Position - 0xABE9 Hash - 0xA85A6891 ^0xA85A6891
{
	return func_126(iParam0, 0, false);
}

int func_152(int iParam0) // Position - 0xABF9 Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_153() // Position - 0xAF3C Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101740.f_399 > 0;
}

BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xAF4D Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101688 == 10 || Global_101688 == 9)
		return true;
...
void func_155(var uParam0) // Position - 0xAF71 Hash - 0x13A821A8 ^0x62366C6
{
	var scriptName;
...
struct<6> func_156(int iParam0) // Position - 0xAFB7 Hash - 0x91B2FA56 ^0xDF732C64
{
	var unk;
...
BOOL func_157(var uParam0) // Position - 0xB011 Hash - 0x22A11E05 ^0x22A11E05
{
	int num;
...
int func_158(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB030 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_159(var uParam0, int iParam1) // Position - 0xB167 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB1B6 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_161(iParam0, Global_44181);
}

BOOL func_161(int iParam0, int iParam1) // Position - 0xB1C7 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_162(int iParam0) // Position - 0xB3A8 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_163(BOOL bParam0) // Position - 0xB3CA Hash - 0xAA584072 ^0x4899099B
{
...
BOOL func_164() // Position - 0xB4A2 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79800)
		return true;
...
BOOL func_165() // Position - 0xB4CC Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_166() // Position - 0xB4E6 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_167(int iParam0) // Position - 0xB502 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_166() || Global_113182 || Global_33090 || func_172() || func_171(8, -1) || func_153() || func_170() || func_164() || func_165() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_166() || Global_33090 || func_172() || func_171(8, -1) || func_164() || func_153() || func_170() || func_165() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_166() || Global_113182 || Global_33090 || func_172() || func_171(8, -1) || func_164() || func_153() || func_170() || func_165() || Global_114135.f_7692.f_919[character] == 5 || Global_44728 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_166() || Global_113182 || Global_33090 || func_172() || func_171(8, -1) || func_153() || func_170() || func_165() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_166() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_171(8, -1) || func_165() || func_169() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_166() || func_170() || Global_113182 || Global_33090 || func_172() || Global_45392 || func_171(8, -1) || func_164() || func_169() || func_165() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
BOOL func_168() // Position - 0xBC1F Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101727.f_1;
}

BOOL func_169() // Position - 0xBC2D Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98585 != -1)
...
BOOL func_170() // Position - 0xBC50 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101740.f_400 > 0;
}

BOOL func_171(int iParam0, int iParam1) // Position - 0xBC61 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_172() // Position - 0xBC99 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575084;
}

void func_173(int iParam0) // Position - 0xBCA5 Hash - 0x83F21A1F ^0xD10033A0
{
...
void func_174(int iParam0) // Position - 0xBD1A Hash - 0x12249850 ^0x46987D7A
{
	int offset;
	int i;
...
int func_175(char* sParam0) // Position - 0xBD5C Hash - 0x3411B367 ^0xD0D08AE8
{
...
BOOL func_176(char* sParam0) // Position - 0xBD83 Hash - 0x486E76BF ^0xD39F7AD6
{
	int i;
...
void func_177(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xBDBE Hash - 0xFA14711 ^0xFA14711
{
	func_178(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_178(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xBDDE Hash - 0x2DEFD20B ^0x2F7188BE
{
	int i;
...
void func_179() // Position - 0xBFB0 Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
BOOL func_180(int iParam0) // Position - 0xC0C9 Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_181(var uParam0, var uParam1) // Position - 0xC109 Hash - 0x81E313DD ^0xA19E0255
{
	if (!uParam0->f_7)
	{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xC19A Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_183(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xC1E8 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22426 = 0;
...
void func_184() // Position - 0xC4B6 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_185())
		return;
...
BOOL func_185() // Position - 0xC4ED Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_186(Player plParam0) // Position - 0xC550 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_187(plParam0, 20);
}

BOOL func_187(Player plParam0, int iParam1) // Position - 0xC560 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1887549[plParam0 /*611*/].f_10.f_4, iParam1);
}

void func_188() // Position - 0xC578 Hash - 0xE1F0C158 ^0xB5D2F635
{
	int i;
...
void func_189() // Position - 0xC5A8 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_190() // Position - 0xC63D Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_191() // Position - 0xC664 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC6FD Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_70(14))
	{
...
void func_193() // Position - 0xC79F Hash - 0x719867DD ^0xB196B20A
{
	int i;
...
void func_194() // Position - 0xC7F5 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_195(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC84C Hash - 0xC6B752B2 ^0xC6B752B2
{
...
char* func_196(int iParam0) // Position - 0xC8A2 Hash - 0xB2E27DFB ^0x5EA4816A
{
	switch (iParam0)
	{
		case 0:
...
char* func_197(int iParam0) // Position - 0xC8E7 Hash - 0xB2E27DFB ^0xBACBBF14
{
	switch (iParam0)
	{
		case 0:
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC92C Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xC9C7 Hash - 0x152DA0B2 ^0x220E93E9
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0xC9E9 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_111();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_201(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xCA02 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
...
void func_202(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xCB84 Hash - 0x733BFBA2 ^0x733BFBA2
{
...
void func_203(var uParam0, int iParam1) // Position - 0xCBBC Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_204(var uParam0, int iParam1) // Position - 0xCC42 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_205(var uParam0, int iParam1) // Position - 0xCC93 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_206(var uParam0, int iParam1) // Position - 0xCCC6 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_207(var uParam0, int iParam1) // Position - 0xCD00 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_208(var uParam0, int iParam1) // Position - 0xCD3B Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
int func_209() // Position - 0xCD77 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_210(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xCDBD Hash - 0xD1775FEC ^0xD1775FEC
{
	int outValue;
	Hash statHash;
...
int func_211(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xCE8F Hash - 0x66394909 ^0x7ECE9AC7
{
	float num;
	int num2;
	int num3;
...
void func_212(BOOL bParam0) // Position - 0xD48E Hash - 0xB232D28E ^0x40CAA0C6
{
	int i;
	int j;
...
void func_213(int iParam0) // Position - 0xD710 Hash - 0xD2EB197 ^0x9FF73396
{
	int value;
...
void func_214(int iParam0) // Position - 0xD76A Hash - 0x3705FAD4 ^0x3705FAD4
{
	BOOL flag;
	var txdName;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD8E2 Hash - 0xA17D549C ^0x216D7E51
{
	switch (iParam0)
	{
		case 0:
...
int func_216() // Position - 0xD9E3 Hash - 0xF9396AAC ^0xF9396AAC
{
	int num;
...
void func_217(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xD9F0 Hash - 0x99A9B13C ^0x893CB3D1
{
	Hash statName;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xDA1E Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_105();
...
void func_219(int iParam0) // Position - 0xDA3C Hash - 0x35B495B7 ^0x35B495B7
{
	func_225(93, iParam0);
	func_225(29, iParam0);
	func_225(30, iParam0);
...
BOOL func_220(int iParam0) // Position - 0xDA5C Hash - 0xA882C352 ^0xA882C352
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xDBFC Hash - 0x6099A833 ^0x46750A9D
{
	if (iParam1 == -1)
		iParam1 = func_105();
...
int func_222(BOOL bParam0) // Position - 0xDC18 Hash - 0xDC114C70 ^0xC626A2DE
{
	var outValue;
	int value;
	int outValue2;
...
BOOL func_223(int iParam0, int iParam1) // Position - 0xDCCF Hash - 0x77E0C72A ^0x80DA2A54
{
...
void func_224(Hash hParam0, int iParam1) // Position - 0xDD20 Hash - 0x1F80E88A ^0x1E13AAF3
{
	int outValue;
...
void func_225(int iParam0, int iParam1) // Position - 0xDD43 Hash - 0xE9A65642 ^0xF9847A54
{
	int outValue;
...
void func_226() // Position - 0xDDA0 Hash - 0xFD5B61DC ^0x7C6336B1
{
	int outValue;
...
int func_227(int iParam0) // Position - 0xDE15 Hash - 0x12DEE71A ^0xB4CACA6A
{
	return Global_2201[iParam0 /*29*/].f_17;
}

BOOL func_228(int iParam0, BOOL bParam1) // Position - 0xDE26 Hash - 0xD1E42460 ^0xD1E42460
{
	int num;
	char* str;
	char* str2;
...
char* func_229(int iParam0) // Position - 0xDE70 Hash - 0xB2E27DFB ^0x705FA7F6
{
	switch (iParam0)
	{
		case 0:
...
char* func_230(int iParam0, BOOL bParam1) // Position - 0xDEB5 Hash - 0x1201C76A ^0x3598D6C0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_231(int iParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4) // Position - 0xDF42 Hash - 0xAFE3E57C ^0x6C5665D3
{
	int num;
	int num2;
	int num3;
...
Hash func_232(eCharacter echParam0) // Position - 0xE52E Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_90(echParam0))
...
BOOL func_233(Ped pedParam0, int iParam1, int iParam2) // Position - 0xE554 Hash - 0x5D21B072 ^0xEA5269F1
{
	Vector3 vector;
	int num;
...
float func_234(int* piParam0) // Position - 0xE5BA Hash - 0x4CA081DF ^0xE7D9DC6
{
...
float func_235(BOOL bParam0) // Position - 0xE5F6 Hash - 0xB0FB4432 ^0x9D798691
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_236(int* piParam0) // Position - 0xE64E Hash - 0x58F53CD ^0x58F53CD
{
	return IS_BIT_SET(*piParam0, 2);
}

BOOL func_237(int* piParam0) // Position - 0xE65B Hash - 0xA8A91C80 ^0xA8A91C80
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_238(int iParam0, int iParam1) // Position - 0xE668 Hash - 0x9B3F919B ^0x9B3F919B
{
	int num;
...
int func_239(eCharacter echParam0) // Position - 0xE7F2 Hash - 0xFC9AD598 ^0xFC9AD598
{
...
int func_240(eCharacter echParam0) // Position - 0xE84A Hash - 0x12DEE71A ^0x2B1BDBFF
{
	return Global_2201[echParam0 /*29*/].f_11;
}

eCharacter func_241() // Position - 0xE85B Hash - 0x13981B57 ^0x13981B57
{
...
int func_242(float fParam0, BOOL bParam1) // Position - 0xE87D Hash - 0x3E8E68B1 ^0x9A61112B
{
	var unk;
	int num;
	int num2;
...
void func_243(int iParam0, var uParam1) // Position - 0xE923 Hash - 0xCF1528B4 ^0x255A0B48
{
	switch (iParam0)
	{
		case 0:
...
int func_245(int iParam0) // Position - 0xFB29 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_246(int iParam0) // Position - 0xFE6F Hash - 0x49BA4072 ^0xF75D840
{
	var unk;
	var unk3;
...
struct<2> func_247(int iParam0) // Position - 0xFEA5 Hash - 0x5008E56D ^0x5008E56D
{
	var unk;
...
int func_248() // Position - 0x1043E Hash - 0x35BC7314 ^0x35BC7314
{
	func_111();
...
BOOL func_249(Ped pedParam0) // Position - 0x10484 Hash - 0xD8C74549 ^0xD8C74549
{
	if (pedParam0 == 0)
		return false;
...
int func_250(Ped pedParam0) // Position - 0x104A5 Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
BOOL func_251() // Position - 0x104EE Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_252() // Position - 0x10503 Hash - 0xF29B9B49 ^0x5D093C2F
{
...
BOOL func_253() // Position - 0x1051C Hash - 0x4CC0D5B ^0xB091969D
{
	Vector3 vector;
	float num;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x105B1 Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

BOOL func_255() // Position - 0x105C4 Hash - 0xB23DBE04 ^0x2D338795
{
	Vector3 vector;
...
void func_256() // Position - 0x10612 Hash - 0x65C0F959 ^0x42A57E07
{
	char* componentType;
...
void func_257() // Position - 0x10736 Hash - 0xDB647C20 ^0xDB647C20
{
	iLocal_223 = 0;
	bLocal_219 = false;
	bLocal_220 = false;
...
BOOL func_258() // Position - 0x1074A Hash - 0x6BBF97B8 ^0x354A2FB7
{
	if (!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		return false;
...
void func_259() // Position - 0x10799 Hash - 0x5C5AD372 ^0x180EE063
{
	if (Global_114135.f_24990.f_1 == 0)
	{
...
void func_260(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x1089D Hash - 0xDA27A8A3 ^0xD3778307
{
	int num;
...
void func_261() // Position - 0x10A1B Hash - 0x5D7776D4 ^0x6C15C6CD
{
	var txdName;
	var subject;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x10A94 Hash - 0x5D6A4A13 ^0x32291975
{
	return Global_2201[character /*29*/].f_3;
}

int func_263(eCharacter echParam0, int iParam1) // Position - 0x10AA7 Hash - 0x97DCD8A1 ^0xF8178EDD
{
...
int func_264(eCharacter echParam0, int iParam1) // Position - 0x10AD1 Hash - 0x97DCD8A1 ^0x5A8D70D2
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_265(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x10AFB Hash - 0xAB9B6CC ^0x1B5EEB55
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_266(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x10B40 Hash - 0xAB9B6CC ^0x80AE0F15
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_267() // Position - 0x10B85 Hash - 0xBBA1EB34 ^0x642EB874
{
...
void func_268(var uParam0, int iParam1) // Position - 0x10BBE Hash - 0xD18CB130 ^0xA0F4C6FD
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x10BDB Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_270(int iParam0) // Position - 0x10BEE Hash - 0xFCBFD2CC ^0x1DBFD43E
{
	int num;
	int offset;
