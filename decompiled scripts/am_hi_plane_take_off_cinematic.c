...
BOOL func_142(int iParam0) // Position - 0xB2AD Hash - 0x16FCD261 ^0xBB7E202A
{
	int num;
...
BOOL func_143(int iParam0) // Position - 0xB2D1 Hash - 0xE40D6326 ^0xE40D6326
{
	int num;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0xB2EF Hash - 0x7CD5054C ^0x870BEA81
{
...
void func_299() // Position - 0x34F5A Hash - 0x27B9B639 ^0x96FE06D6
{
...
void func_300(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x34FF2 Hash - 0x607C6130 ^0x706A73DE
{
...
void func_301(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x35022 Hash - 0x6C5FBB5E ^0xD460273B
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_302(var uParam0, int iParam1, char* sParam2) // Position - 0x3504F Hash - 0x56FFD57E ^0x2EC6E3FD
{
