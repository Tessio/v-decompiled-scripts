...
BOOL func_55(int iParam0) // Position - 0x2F56 Hash - 0x59486232 ^0x6624066D
{
...
int func_57(int iParam0) // Position - 0x2F96 Hash - 0xDF8A8B50 ^0xC07F9971
{
	if (Global_120[iParam0 /*10*/].f_8 != 184)
	{
		func_58(iParam0, 0);
