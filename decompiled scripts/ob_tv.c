...
BOOL func_6() // Position - 0x85E Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 14);
}

BOOL func_7(Player plParam0, int iParam1) // Position - 0x878 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
...
eCharacter func_8(int iParam0, BOOL bParam1) // Position - 0x8D1 Hash - 0x1DCD393E ^0x1DCD393E
{
...
int func_9() // Position - 0x912 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574926;
}

BOOL func_10(Player plParam0) // Position - 0x91E Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_11(Player plParam0) // Position - 0x940 Hash - 0x68897CDD ^0x41D261A7
{
...
BOOL func_12() // Position - 0x97F Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_13(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x98D Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_14() // Position - 0x9C0 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_15(int iParam0) // Position - 0x9E7 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
BOOL func_16() // Position - 0xA0A Hash - 0xC0D9F7E2 ^0x2B0C5F8C
{
	if (!func_65(iLocal_41))
	{
...
void func_17() // Position - 0xB16 Hash - 0xC3C4A43C ^0x4FF216CB
{
	if (bLocal_83 == false)
	{
...
void func_18(int iParam0) // Position - 0xBD0 Hash - 0x7E11E9C ^0x544BF257
{
	if (func_23())
		return;
...
void func_19(int iParam0) // Position - 0xC03 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_23())
		return;
...
void func_20(BOOL bParam0, BOOL bParam1) // Position - 0xC8D Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_22(0))
...
BOOL func_21() // Position - 0xD01 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_22(int iParam0) // Position - 0xD0F Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_23() // Position - 0xD66 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1957675, 19);
}

void func_24(BOOL bParam0, BOOL bParam1) // Position - 0xD75 Hash - 0xDC2C4999 ^0x9684608E
{
	int num;
	int num2;
	float tvVolume;
...
BOOL func_25(BOOL bParam0) // Position - 0xEBC Hash - 0x25EF1702 ^0x3A4EC47C
{
	int num;
	int num2;
...
void func_26() // Position - 0xF08 Hash - 0xF551C7D2 ^0x593599C
{
	float fov;
...
BOOL func_27(int iParam0, BOOL bParam1) // Position - 0xFDF Hash - 0xE8E8EFB4 ^0x98461D05
{
	int num;
...
int func_28(int iParam0) // Position - 0x1097 Hash - 0x7F0E29AD ^0x84091235
{
	int i;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x10D2 Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
void func_30() // Position - 0x11FD Hash - 0xB8D9DAEC ^0x35919E14
{
	if (MISC::IS_PC_VERSION())
	{
		if (iLocal_85 == 0)
...
BOOL func_31(int iParam0, int iParam1) // Position - 0x121D Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
float func_32(var uParam0) // Position - 0x1255 Hash - 0x4CA081DF ^0xE7D9DC6
{
	if (func_35(uParam0))
		if (func_34(uParam0))
			return uParam0->f_2;
...
float func_33(BOOL bParam0) // Position - 0x1291 Hash - 0xB0FB4432 ^0x9D798691
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_34(var uParam0) // Position - 0x12E9 Hash - 0x58F53CD ^0x58F53CD
{
	return IS_BIT_SET(*uParam0, 2);
}

BOOL func_35(var uParam0) // Position - 0x12F6 Hash - 0xA8A91C80 ^0xA8A91C80
{
	return IS_BIT_SET(*uParam0, 1);
}

void func_36() // Position - 0x1303 Hash - 0x18A58530 ^0xDB3CE2EE
{
	float xScale;
...
void func_37(var uParam0) // Position - 0x1344 Hash - 0xACC09CB ^0xBF2D75A5
{
	float aspectRatio;
	float num;
	float num2;
...
void func_38() // Position - 0x1381 Hash - 0x788155EC ^0xFC0A0CDE
{
	Global_33148[iLocal_41 /*11*/].f_7 = 0;
	Global_33148[iLocal_41 /*11*/] = GRAPHICS::GET_TV_CHANNEL();
	fLocal_28 = GRAPHICS::GET_TV_VOLUME();
...
BOOL func_39(int iParam0) // Position - 0x1401 Hash - 0x3955DF3F ^0xCBEBA13E
{
	var unk;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x1476 Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_41(int iParam0, int iParam1) // Position - 0x1489 Hash - 0xE9A65642 ^0xF9847A54
{
	int outValue;
...
char* func_42(int iParam0) // Position - 0x14E6 Hash - 0x95E62A7F ^0x6A61834B
{
	char* str;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x15C5 Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x15D8 Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
BOOL func_45() // Position - 0x162F Hash - 0x4661537F ^0x24508B34
{
...
void func_46(int iParam0, int iParam1, int iParam2) // Position - 0x175E Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_47() // Position - 0x1844 Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_48() // Position - 0x1D02 Hash - 0x9482CBBF ^0x8B17A994
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1D4D Hash - 0x15889021 ^0xE7262364
{
...
int func_50() // Position - 0x1D75 Hash - 0x21D64237 ^0x21D64237
{
	return Global_33087;
}

BOOL func_51(int iParam0, int iParam1) // Position - 0x1D80 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1DD1 Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
void func_53() // Position - 0x1DEF Hash - 0x3D3204BF ^0x7DF7781D
{
	SYSTEM::WAIT(0);
...
void func_54() // Position - 0x1E1B Hash - 0x60A20886 ^0xDBC2CEAA
{
	Hash entityModel;
...
void func_55() // Position - 0x1ED9 Hash - 0x2EC4B74F ^0x71674BDB
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_35))
...
void func_56(int* piParam0) // Position - 0x1F58 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_57(piParam0, 0f);
	return;
}

void func_57(int* piParam0, float fParam1) // Position - 0x1F67 Hash - 0xED66BE55 ^0x9F6586C1
{
...
void func_58() // Position - 0x1F92 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

BOOL func_59(int iParam0) // Position - 0x1F9A Hash - 0x35F9F9C ^0x35F9F9C
{
...
void func_60() // Position - 0x1FC6 Hash - 0x923794AC ^0x747921F2
{
...
void func_61() // Position - 0x22B5 Hash - 0xBF767C65 ^0x6174B12C
{
...
void func_62() // Position - 0x22E7 Hash - 0x44202625 ^0xA8E37EAC
{
...
void func_63() // Position - 0x231D Hash - 0x216C970 ^0x12BB31B4
{
	if (iLocal_41 == -1)
		return;
...
BOOL func_64(int iParam0) // Position - 0x23D8 Hash - 0x937D8816 ^0x937D8816
{
	return Global_44181 == iParam0;
}

BOOL func_65(int iParam0) // Position - 0x23E6 Hash - 0x96F4EAF ^0x6589D7D8
{
	if (iParam0 != -1)
...
BOOL func_66() // Position - 0x2405 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_67() // Position - 0x2422 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98585 != -1)
...
void func_68() // Position - 0x2445 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_69() // Position - 0x244D Hash - 0x7F45B52E ^0x4942577D
{
	if (iLocal_41 == -1)
		SCRIPT::TERMINATE_THIS_THREAD();
...
void func_70() // Position - 0x2514 Hash - 0xC4BD9799 ^0x658A83CA
{
	func_53();
