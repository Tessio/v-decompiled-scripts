...
BOOL func_1() // Position - 0x5B4 Hash - 0x57459B9C ^0x9A36D842
{
...
void func_2() // Position - 0x5E6 Hash - 0x9A142650 ^0xE9E53C81
{
	Global_23831.f_6 = 1;
	return;
}

BOOL func_3() // Position - 0x5F4 Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
void func_4() // Position - 0x749 Hash - 0x9EE84918 ^0x78A3A193
{
	if (CAM::IS_SCREEN_FADED_OUT())
...
BOOL func_5() // Position - 0x75F Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_6() // Position - 0x95C Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_7() // Position - 0xAAE Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_8() // Position - 0xD37 Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_9() // Position - 0xEE1 Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_10() // Position - 0x109A Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_11() // Position - 0x126E Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_12() // Position - 0x13B7 Hash - 0x9A3CFD90 ^0xBF2480BA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_13() // Position - 0x165F Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_14() // Position - 0x17A2 Hash - 0x3E91DD9 ^0x722ABEAF
{
	var unk;
...
BOOL func_15() // Position - 0x1B43 Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_16() // Position - 0x1DAF Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_17() // Position - 0x1F66 Hash - 0xE2DF8C0F ^0x34B7AFEB
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_18() // Position - 0x22CE Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_19() // Position - 0x248E Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_20() // Position - 0x264D Hash - 0x9A3CFD90 ^0xBF2480BA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_21() // Position - 0x2827 Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_22() // Position - 0x2A0D Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_23() // Position - 0x2C95 Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_24() // Position - 0x2E11 Hash - 0x21AB13AA ^0x8C04EF84
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_25() // Position - 0x2FA3 Hash - 0x2CC0A299 ^0x2C03DA77
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_26() // Position - 0x3109 Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_27() // Position - 0x32BA Hash - 0xFEB52FAC ^0x5AF60283
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_28() // Position - 0x340D Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_29() // Position - 0x35B9 Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_30() // Position - 0x376B Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_31() // Position - 0x38F5 Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_32() // Position - 0x3ABB Hash - 0xE8296746 ^0x1CDA61CA
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_33() // Position - 0x3CBC Hash - 0xB797285B ^0x141F3A1
{
	switch (iLocal_29)
	{
		case 0:
...
BOOL func_34() // Position - 0x3E6D Hash - 0x21AB13AA ^0x8C04EF84
{
	switch (iLocal_29)
	{
		case 0:
...
void func_35() // Position - 0x3FFE Hash - 0xFDE2574 ^0xFB8DF502
{
	CAM::DO_SCREEN_FADE_OUT(5000);
	iLocal_29 = 0;
	return;
...
void func_39() // Position - 0x4299 Hash - 0x770EF3D1 ^0x44A3AE88
{
	MISC::SET_CREDITS_ACTIVE(false);
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x42AA Hash - 0x56032C5B ^0x18DFBA48
{
	int num;
	int num2;
	int num3;
...
int func_41() // Position - 0x437A Hash - 0x39D9D518 ^0xBC98C03C
{
	int i;
...
BOOL func_42(int iParam0) // Position - 0x43AC Hash - 0xE5CDC45F ^0xE5CDC45F
{
	switch (iParam0)
	{
		case 71:
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x43EA Hash - 0x15889021 ^0xE7262364
{
...
void func_44(int iParam0, BOOL bParam1) // Position - 0x4412 Hash - 0x91747301 ^0x6F31F55
{
...
void func_45(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x445C Hash - 0xA5484192 ^0xF1C0EC85
{
...
void func_46(BOOL bParam0) // Position - 0x44C3 Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_53();
...
void func_47(int iParam0) // Position - 0x4526 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_51())
		return;
...
BOOL func_48() // Position - 0x45B0 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_49(BOOL bParam0, BOOL bParam1) // Position - 0x45D7 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_52(0))
...
BOOL func_50() // Position - 0x464B Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_51() // Position - 0x4659 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1957675, 19);
}

BOOL func_52(int iParam0) // Position - 0x4668 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_53() // Position - 0x46BF Hash - 0xF8FE2348 ^0xA77911B2
{
...
void func_54(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x46E8 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_55() // Position - 0x4837 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 14);
}

BOOL func_56(Player plParam0, int iParam1) // Position - 0x4851 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
...
int func_57(int iParam0, BOOL bParam1) // Position - 0x48AA Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_58() // Position - 0x48EB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574926;
}

BOOL func_59(Player plParam0) // Position - 0x48F7 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_60(Player plParam0) // Position - 0x4919 Hash - 0x68897CDD ^0x41D261A7
{
...
BOOL func_61() // Position - 0x4958 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_62(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4966 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
void func_63(int iParam0) // Position - 0x4999 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
