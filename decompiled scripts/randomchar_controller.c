					...
					else if (func_23(iLocal_94))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (HUD::DOES_BLIP_EXIST(Global_33467[num /*23*/].f_19))
								{
									HUD::SET_BLIP_FLASHES(Global_33467[num /*23*/].f_19, true);
									HUD::SET_BLIP_FLASH_TIMER(Global_33467[num /*23*/].f_19, 10000);
...
void func_57(eCharacter echParam0) // Position - 0x2FDA Hash - 0xEC7DB104 ^0xEC7DB104
{
	...
	if (echParam0 < CHAR_MICHAEL || echParam0 >= Global_114135.f_7692.f_866)
		return;

	if (Global_114135.f_7692.f_866 > CHAR_FRANKLIN)
	{
	...
	if (Global_114135.f_7692.f_866 > CHAR_MICHAEL)
	{
...
void func_58(eCharacter echParam0) // Position - 0x3093 Hash - 0xEC7DB104 ^0xEC7DB104
{
	...
	if (echParam0 < CHAR_MICHAEL || echParam0 >= Global_114135.f_7692.f_764)
		return;

	if (Global_114135.f_7692.f_764 > CHAR_FRANKLIN)
	{
	...
	if (Global_114135.f_7692.f_764 > CHAR_MICHAEL)
	{
...
int func_62(eCharacter echParam0) // Position - 0x3382 Hash - 0xF5506146 ^0xF7A54567
{
	eCharacter character;

	if (Global_120[echParam0 /*10*/].f_8 != 184)
	{
		if (func_68(echParam0, Global_21066) == 1)
		{
			func_67(echParam0, Global_21066, 0);
		
			if (func_66(echParam0, Global_21066) == 0)
			{
...
void func_63(eCharacter echParam0, eCharacter echParam1) // Position - 0x33D8 Hash - 0xA1B5646 ^0x1B8F934B
{
	eCharacter character;
...
void func_76() // Position - 0x3997 Hash - 0x921FBCBE ^0x921FBCBE
{
	...
	if (!func_82(num) || num == 52)
	{
		if (!IS_BIT_SET(Global_114135.f_18578.f_390[iLocal_50], iLocal_49))
		{
			...
			if (num == 58)
				MISC::SET_BIT(&Global_114135.f_18578.f_390[iLocal_50], iLocal_49);
...
void func_83(int iParam0) // Position - 0x3D0C Hash - 0x99117B13 ^0xFF0C48F0
{
		...
		if (IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_114135.f_18578[iParam0 /*6*/], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					...
					{
						func_122(Global_114135.f_18578[iParam0 /*6*/].f_2, &unk34, &unk35, &unk36, &num, &num2, &num3);
	...
	if (Global_113222[iParam0 /*10*/].f_7 != num5)
	{
		if (func_105(&(Global_113222[iParam0 /*10*/].f_8)))
		{
			...
			{
				num6 = uLocal_72[Global_113222[iParam0 /*10*/].f_8];
			...
			Global_113222[iParam0 /*10*/].f_7 = num5;
		}
	}
...
void func_98(int iParam0, int iParam1) // Position - 0x4CEE Hash - 0xDF6BC64B ^0x4CE741A1
{
	...
	MISC::SET_BITS_IN_RANGE(&(Global_33467[num /*23*/].f_11), 21, 26, iParam1);
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E Hash - 0xC7C0A3F4 ^0x5A19DEEB
{
	...
	if (bParam1)
		MISC::SET_BIT(&(Global_33467[num /*23*/].f_11), 28);
	else
		MISC::CLEAR_BIT(&(Global_33467[num /*23*/].f_11), 28);
...
BOOL func_110() // Position - 0x565F Hash - 0x70B4A54B ^0xF137E5FF
{
...
int func_111(int iParam0) // Position - 0x56DE Hash - 0x46546439 ^0x46546439
{
	eCharacter character;
...
BOOL func_112(eCharacter echParam0) // Position - 0x5906 Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
...
Vehicle func_113(Vehicle veParam0) // Position - 0x5972 Hash - 0xC9D82232 ^0xC9D82232
{
	return veParam0;
}

void func_114(int iParam0, var uParam1) // Position - 0x597C Hash - 0x45AE8BFD ^0xA0700457
{
	int num;
	int num2;
...
BOOL func_115(int iParam0) // Position - 0x6314 Hash - 0xDEE87AD1 ^0x5F1ACD39
{
	var unk;
	int doorState;
...
struct<7> func_116(int iParam0) // Position - 0x6348 Hash - 0xA6A81C3E ^0x591CC9FB
{
	var unk;
