...
int func_41(eCharacter echParam0) // Position - 0x1BD7 Hash - 0xF5506146 ^0xF7A54567
{
	eCharacter character;
...
void func_42(eCharacter echParam0, eCharacter echParam1) // Position - 0x1C2D Hash - 0xA1B5646 ^0x1B8F934B
{
	eCharacter character;
