...
BOOL func_1(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x2A1 Hash - 0x8996399F ^0x2E8DDA26
{
	int i;
...
int func_2(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9E3 Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_3(Vehicle veParam0) // Position - 0xA3A Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_4(BOOL bParam0, BOOL bParam1) // Position - 0xA66 Hash - 0xC86614C6 ^0xCD39041A
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0xBB7 Hash - 0x4E1330D6 ^0x886EF094
{
...
BOOL func_6(BOOL bParam0) // Position - 0xC3C Hash - 0xBC517E8E ^0xBC517E8E
{
	if (bParam0)
		if (func_7())
			return true;
...
BOOL func_7() // Position - 0xC62 Hash - 0x10D488D5 ^0x92DBA025
{
	if (Global_113077)
		return true;
...
void func_8() // Position - 0xC94 Hash - 0x9A142650 ^0xE9E53C81
{
	Global_23831.f_6 = 1;
	return;
}

BOOL func_9(var uParam0) // Position - 0xCA2 Hash - 0xF5F2B273 ^0xF18782D6
{
	var entityRotation;
	Ped vehiclePedIsIn;
	Ped ped;
...
float func_10(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xD4B Hash - 0x9ECDD667 ^0x170D4E4C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_11() // Position - 0xD62 Hash - 0xBAE5BE54 ^0x8C6F0E0A
{
	Vehicle vehiclePedIsIn;
...
int func_12(var uParam0, const char* sParam1, int iParam2) // Position - 0xD9C Hash - 0x8355FF75 ^0x5A8F0C8E
{
...
void func_13(const char* sParam0, int iParam1) // Position - 0xDE8 Hash - 0xAFD19873 ^0xBBBE5748
{
...
BOOL func_14(var uParam0) // Position - 0xE04 Hash - 0x3512D277 ^0xF9635378
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0xE5E Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_16(const char* sParam0, int iParam1) // Position - 0xE71 Hash - 0xCB708C57 ^0xEA56376
{
...
BOOL func_17(var uParam0) // Position - 0xE8A Hash - 0x4C14E206 ^0x9590158A
{
	var unk;
...
struct<8> func_18(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xF2E Hash - 0xA273CE48 ^0xA273CE48
{
	var unk;
	var unk9;
...
Vector3 func_19(float fParam0, var uParam1, var uParam2) // Position - 0xF90 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
BOOL func_20(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFCF Hash - 0x9A4C1B16 ^0x6EACDAB9
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

int func_21(var uParam0, const char* sParam1) // Position - 0xFED Hash - 0xAB97D92D ^0x632C2B75
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_22(const char* sParam0) // Position - 0x1036 Hash - 0x99A98712 ^0xE46BE9F0
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
	return;
...
void func_23(var uParam0) // Position - 0x104C Hash - 0x46411C7A ^0x1AD808B0
{
	if (func_14(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_24() // Position - 0x1079 Hash - 0xC58A5FA9 ^0x73B964DD
{
	Vehicle vehiclePedIsIn;
...
BOOL func_25(Vehicle veParam0, int iParam1) // Position - 0x10CD Hash - 0xA2B23595 ^0x26123F56
{
	int num;
...
BOOL func_26(Vehicle veParam0) // Position - 0x1169 Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x1193 Hash - 0x3D210083 ^0xF7E7C389
{
...
BOOL func_28(Vehicle veParam0) // Position - 0x11B4 Hash - 0x2E9AC124 ^0x5164B34A
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
int func_29() // Position - 0x11F7 Hash - 0x177E4C87 ^0x8B4FC090
{
...
int func_30(int iParam0) // Position - 0x1245 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_61482[iParam0];
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1254 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_32();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_32() // Position - 0x126D Hash - 0xD1F2D853 ^0xF9F5FD4D
{
...
BOOL func_33(eCharacter echParam0) // Position - 0x136A Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1376 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x13B3 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_36(eCharacter echParam0) // Position - 0x13D8 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2201[echParam0 /*29*/];
}

int func_37(Player plParam0) // Position - 0x13E7 Hash - 0xB3F5DAA8 ^0xB3F5DAA8
{
	int num;
...
int func_38(Player plParam0) // Position - 0x13F9 Hash - 0x7998C8F7 ^0x712BCC49
{
	if (plParam0 > -1)
...
BOOL func_39(Player plParam0) // Position - 0x143C Hash - 0x392A396A ^0x1DEEBA83
{
	if (!func_40(plParam0))
		return false;
...
BOOL func_40(Player plParam0) // Position - 0x145B Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
void func_41(var uParam0, int iParam1) // Position - 0x147D Hash - 0x948772F0 ^0xC07820E1
{
...
BOOL func_42(var uParam0) // Position - 0x1491 Hash - 0x94D713D7 ^0x5446E692
{
	func_68(PLAYER::PLAYER_PED_ID());
...
BOOL func_43() // Position - 0x154A Hash - 0x44A439DC ^0x3D5209CD
{
	return MISC::GET_GAME_TIMER() <= Global_23970.f_6481 + 100;
}

BOOL func_44(BOOL bParam0) // Position - 0x155F Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_45(int iParam0) // Position - 0x1588 Hash - 0x12B1B55 ^0xF5FCD842
{
	if (iParam0 == 0)
		if (func_65())
			return false;
...
BOOL func_46(Player plParam0) // Position - 0x15EE Hash - 0x85F8BECA ^0x85F8BECA
{
	if (func_49(plParam0))
		return true;
...
BOOL func_47(Player plParam0) // Position - 0x1611 Hash - 0xE40D6326 ^0xE40D6326
{
	Player player;
...
BOOL func_48(Player plParam0, int iParam1) // Position - 0x162F Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1887549[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_49(Player plParam0) // Position - 0x1647 Hash - 0x295F4323 ^0xC9EF0000
{
	Player player;
...
BOOL func_50(int iParam0) // Position - 0x166A Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_51(var uParam0) // Position - 0x16C1 Hash - 0x46261827 ^0x6A7ACEE5
{
	if (uParam0->f_11 == 1)
...
void func_52(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x16F6 Hash - 0x608B27C3 ^0x72A9B272
{
	int i;
	float num;
	float num2;
...
void func_53(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x17AB Hash - 0xAFA32A88 ^0xC11A84EF
{
	func_54(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x17D1 Hash - 0x343DF434 ^0x343DF434
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_55(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x19E1 Hash - 0xFED631D9 ^0x4FB6D3D3
{
...
void func_56(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A1A Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_57(int iParam0, int iParam1) // Position - 0x1A72 Hash - 0x45677974 ^0x367715F6
{
	switch (iParam0)
	{
		case 12:
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x1B4E Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_59(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1B77 Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_60() // Position - 0x24DC Hash - 0x6134FBB2 ^0x82030B41
{
...
int func_61() // Position - 0x250C Hash - 0x21D64237 ^0x21D64237
{
	return Global_33088;
}

int func_62() // Position - 0x2517 Hash - 0x21D64237 ^0x21D64237
{
	return Global_33087;
}

int func_63(var uParam0, int iParam1) // Position - 0x2522 Hash - 0x5A2CB71 ^0x1D338919
{
	int i;
