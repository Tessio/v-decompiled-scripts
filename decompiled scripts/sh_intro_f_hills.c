...
{
	Global_79172[1 /*14*/] = { func_65(hParam0, iParam1, epctParam2, -1) };
...
struct<14> func_65(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xB543 Hash - 0x7D5AC326 ^0xB460D68E
{
	func_129();
