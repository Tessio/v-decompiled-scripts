...
void func_1() // Position - 0x59 Hash - 0x49D1B324 ^0x49D1B324
{
	switch (iLocal_19)
	{
		case 0:
...
void func_2() // Position - 0x8F Hash - 0x5D0A1D8B ^0x4125967D
{
	var src;

	func_11(&(iLocal_19.f_4));
	func_10(&(iLocal_19.f_704), "GENERIC_INSTRUCTIONAL_BUTTONS");
	...
	if (func_9(5))
	{
		...
		Global_1919353 = iLocal_19.f_2;
	}
	else
	{
		Global_1919353 = PV_COMP_INVALID;
	}

	func_3(&hLocal_843);
	src = -1;
	src.f_1 = -1;
	MISC::COPY_SCRIPT_STRUCT(&Global_1919350, &src, 3);
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_3(Any* panParam0) // Position - 0x10E Hash - 0x3E10B81E ^0x810D4E68
{
	MISC::COPY_SCRIPT_STRUCT(&Global_1919343, panParam0, 5);
	func_4(0);
	return;
}

void func_4(int iParam0) // Position - 0x126 Hash - 0x79384820 ^0x23884BD1
{
	MISC::SET_BIT(&(Global_1919343.f_4), iParam0);
	return;
}

void func_5(BOOL bParam0, BOOL bParam1) // Position - 0x13A Hash - 0x2C083C0F ^0xBAA507B8
{
	int i;
	int j;
	float aspectRatio;
...
void func_6(BOOL bParam0, int iParam1) // Position - 0x624 Hash - 0x8F233D4 ^0xB55528D0
{
	int num;
	...
	if (bParam0)
	{
		func_7(&Global_23970.f_6263[num /*10*/]);
...
void func_7(int iParam0) // Position - 0x6E7 Hash - 0x294B53C7 ^0x1978B7FB
{
	if (iParam0->f_9 != 0)
	{
...
BOOL func_8(var uParam0, BOOL bParam1, int iParam2) // Position - 0x713 Hash - 0x5D26C738 ^0x7D8419D1
{
	var unk;
	Hash hashKey;
	int i;
...
BOOL func_9(int iParam0) // Position - 0x7B0 Hash - 0x7E8D1BF7 ^0xB5F1A152
{
	return IS_BIT_SET(iLocal_19.f_1, iParam0);
}

void func_10(var uParam0, char* sParam1) // Position - 0x7BF Hash - 0x49B08D86 ^0xA09BF1C8
{
...
void func_11(var uParam0) // Position - 0x7D3 Hash - 0x8F527192 ^0x77A12AC6
{
	int i;
...
void func_12() // Position - 0x8BD Hash - 0x5C453C65 ^0x5C453C65
{
	func_16();
	func_14();
	func_13();
...
void func_13() // Position - 0x8DB Hash - 0xFEC7C9F6 ^0xFEC7C9F6
{
	Global_1919356 = false;
	return;
}

void func_14() // Position - 0x8E8 Hash - 0x4EA54FBC ^0x26D74352
{
	if (func_9(0))
		func_15(2);
	...
	if (IS_BIT_SET(Global_1919350.f_2, 0))
		func_15(2);

	return;
}

void func_15(int iParam0) // Position - 0x91A Hash - 0x28DF00E8 ^0x28DF00E8
{
	iLocal_19 = iParam0;
	return;
}

void func_16() // Position - 0x926 Hash - 0xFC245520 ^0x59BC60A5
{
	func_110();

	if (!func_108(0, -1, false))
		return;
...
void func_17() // Position - 0x977 Hash - 0x5263CC93 ^0x5263CC93
{
	if (!func_20())
		return;
...
void func_18() // Position - 0x998 Hash - 0xFEC7C9F6 ^0xFEC7C9F6
{
	Global_1919355 = false;
	return;
}

void func_19(int iParam0) // Position - 0x9A5 Hash - 0x9B9BA48B ^0x88F66A7C
{
	MISC::SET_BIT(&(iLocal_19.f_1), iParam0);
	return;
}

BOOL func_20() // Position - 0x9B7 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1919355;
}

void func_21() // Position - 0x9C3 Hash - 0x29DAA064 ^0xD99A039B
{
	var unk;
	...
	{
		func_33(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_ACCEPT, true), "FMMC_SEL_ACCE", &(iLocal_19.f_4), 0);
		func_33(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_CANCEL, true), "FMMC_SEL_CANC", &(iLocal_19.f_4), 0);
		func_33(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_UP, true), "FMMC_SEL_UP", &(iLocal_19.f_4), 0);
		func_33(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_DOWN, true), "FMMC_SEL_DOWN", &(iLocal_19.f_4), 0);
	}
	...
	if (!func_31(&(iLocal_19.f_704), "GENERIC_INSTRUCTIONAL_BUTTONS") || !IS_BIT_SET(iLocal_19.f_1, 3) || GRAPHICS::IS_SCALEFORM_MOVIE_DELETING(iLocal_19.f_704))
	{
	...
	{
		func_30(1);
		func_22(&(iLocal_19.f_704), &unk, &(iLocal_19.f_4), func_29(&(iLocal_19.f_4)));
	}

	return;
}

void func_22(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xAE7 Hash - 0x3DF0A81 ^0x71C99E24
{
	int i;
			...
			for (i = 0; i < uParam2->f_693; i = i + 1)
			{
				if (IS_BIT_SET(uParam2->f_689, i))
				{
					...
					if (!IS_BIT_SET(uParam2->f_690, i))
					{
						...
						func_26(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action, true));
					
						if (action2 < 365)
							func_26(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action2, true));
					}
					else
					{
						control2 = uParam2->f_1[i /*57*/].f_54;
						controlGroup = uParam2->f_1[i /*57*/].f_55;
						func_26(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(control2, controlGroup, true));
					}
				...
				else
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_DATA_SLOT");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(i);
					func_26(&uParam2->f_1[i /*57*/]);
				
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam2->f_1[i /*57*/].f_16)))
						func_26(&(uParam2->f_1[i /*57*/].f_16));
...
void func_23() // Position - 0xE78 Hash - 0xBA92F148 ^0xFCB5C23
{
...
void func_24(int iParam0, var uParam1) // Position - 0xE96 Hash - 0x24DC2FE ^0xB024DAA
{
...
void func_25(char* sParam0) // Position - 0xEC4 Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_26(char* sParam0) // Position - 0xED6 Hash - 0x690E6520 ^0x509C71F3
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

void func_27(int iParam0) // Position - 0xEE4 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_1577950 = iParam0;
	return;
}

void func_28(var uParam0) // Position - 0xEF2 Hash - 0x617D6E16 ^0x617D6E16
{
	Global_1981195 = 0;
	uParam0->f_692 = 0;
	return;
...
BOOL func_29(var uParam0) // Position - 0xF05 Hash - 0xA02AD92D ^0xA02AD92D
{
	return Global_1981195 || uParam0->f_692;
}

void func_30(int iParam0) // Position - 0xF1C Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1675211.f_1163 = iParam0;
	return;
}

BOOL func_31(var uParam0, char* sParam1) // Position - 0xF2D Hash - 0xDD2F1BBF ^0xD9D8D4C5
{
...
struct<9> func_32() // Position - 0xF4B Hash - 0xB2D33A0B ^0xC243FD27
{
	float num;
...
void func_33(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0xF8F Hash - 0x1C6DE86C ^0x8D13F6FB
{
	int num;
...
void func_34() // Position - 0xFDF Hash - 0xB603B456 ^0xECCB3EF1
{
	var r;
	var g;
	var b;
	...
	for (i = PV_COMP_HEAD; i <= iLocal_19.f_3 - 1; i = i + 1)
	{
		...
		else
		{
			...
			{
				func_83(i, &hLocal_724.f_2.f_6[i /*4*/], 0, flag, 0, false, 0);
			
				if (IS_BIT_SET(hLocal_724.f_2.f_104[i], 4) || flag && IS_BIT_SET(hLocal_724.f_2.f_104[i], 7))
					if (IS_BIT_SET(hLocal_724.f_2.f_104[i], 5) && !func_81(i) || !IS_BIT_SET(hLocal_724.f_2.f_104[i], 5) && func_81(i))
						func_80(i, 5, false);
					else
						func_80(i, 7, false);
				else
				...
				if (i == Global_23970.f_6342)
					func_79(&hLocal_724.f_2.f_55[i /*4*/], 0, 0);
			}
		}
	}
	...
	{
		func_77();
		func_42(true, -1, true, false, false, -1082130432, false, false, -1);
	}

	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL) && func_39(false, false))
	{
		PAD::DISABLE_CONTROL_ACTION(CAMERA_CONTROL, INPUT_LOOK_LR, true);
		PAD::DISABLE_CONTROL_ACTION(CAMERA_CONTROL, INPUT_LOOK_UD, true);
		func_35(false, false, false, true);
...
void func_35(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11BE Hash - 0x6E7ED0C2 ^0x4BE3E0E
{
	float x;
	float y;
	float x2;
	...
	if (num4 >= x && num4 <= x2 && num5 >= y && num5 <= y2)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num10 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_36(num, num2 + ((float)num10 * 0.034722f), Global_23969, 0.034722f - 0.0015f, 255, 255, 255, num7);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_36(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x146A Hash - 0x4539121 ^0xE88E6ABA
{
	GRAPHICS::DRAW_RECT(fParam0 + (iParam2 * 0.5f), fParam1 + (fParam3 * 0.5f), iParam2, fParam3, iParam4, iParam5, iParam6, iParam7, false);
	return;
}

void func_37(BOOL bParam0) // Position - 0x1499 Hash - 0xD298BF7C ^0x3A4A9D9E
{
	float num;
	float num2;
	float num3;
	...
	if (Global_4542450 == -2)
		func_36(num, num2, Global_23969, num3, 255, 255, 255, num4);
	else if (Global_4542450 == -3)
		func_36(num, num2 + num3, Global_23969, num3, 255, 255, 255, num4);

	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
	return;
}

void func_38() // Position - 0x1522 Hash - 0xFDAF4DEA ^0xCA07F087
{
...
BOOL func_39(BOOL bParam0, BOOL bParam1) // Position - 0x156A Hash - 0x64BEBD7A ^0xE226A347
{
	if (Global_2672939.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_41(8, -1) && func_40() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79800 || Global_23970.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101740.f_1490)
		return false;

	return true;
}

eTransitionState func_40() // Position - 0x1607 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575012;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x1613 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_42(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x164B Hash - 0x5CD4D9BF ^0xD9788B4F
{
	int num;
	int r;
	int g;
	...
	if (Global_23970)
		if (func_75(29, true, true, &width, &height, bParam7))
			num29 = height / width;
		else
			Global_23970 = false;
	...
	num31 = 1f;
	func_73(bParam7, &unk3, &unk4, &num31);

	if (bParam3)
	{
		if (Global_23970.f_5821 <= PV_COMP_BERD)
		{
			func_83(Global_23970.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (i == 1 && Global_23970.f_6331)
		{
			...
			else
			{
				if (Global_23970)
				{
					TEXT_LABEL_ASSIGN_STRING(&textureDict, func_72(29), 64);
					TEXT_LABEL_ASSIGN_STRING(&textureName, func_69(29, true), 64);
				
					if (MISC::GET_HASH_KEY(&Global_23970.f_7680[29 /*16*/]) == joaat("CREW_LOGO"))
					{
						func_36(Global_23967, Global_23968, iParam5, height3, 0, 0, 0, 255);
				...
				func_36(Global_23967, Global_23968 + height3, iParam5, 0.034722f, r, g, b, a);
				...
				{
					func_68();
					func_66((Global_23967 + iParam5) - 0.00390625f - func_67("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6339, Global_23970.f_6340), Global_23968 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6339, Global_23970.f_6340);
				}
				else if (Global_23970.f_6334 > Global_23970.f_5828)
				{
					...
					{
						func_68();
						func_66((Global_23967 + iParam5) - 0.00390625f - func_67("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6337, Global_23970.f_6336), Global_23968 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6337, Global_23970.f_6336);
					}
				}
			}
			...
			if (Global_23970.f_6334 > Global_23970.f_5828)
			{
				...
				func_36(Global_23967, num28 + 0f, iParam5, 0.034722f, r, g, b, a);
			...
			if (MISC::GET_HASH_KEY(&(Global_23970.f_5241)) != 0 && Global_23970.f_5323 != -1)
			{
				...
				{
					func_75(Global_23970.f_5325, true, true, &width, &height, bParam7);
				...
				func_36(Global_23967, num28 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_75(Global_23970.f_5325, true, true, &width, &height, bParam7);
					func_64(Global_23970.f_5325, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_5325), func_69(Global_23970.f_5325, true), Global_23967 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542374.f_21)) != 0 && Global_4542374.f_65 != -1)
			{
				...
				{
					func_75(Global_4542374.f_67, true, true, &width, &height, bParam7);
					x = (Global_23967 + width + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_75(Global_4542374.f_67, true, true, &width, &height, bParam7);
					func_64(Global_4542374.f_67, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_72(Global_4542374.f_67), func_69(Global_4542374.f_67, true), Global_23967 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
			...
			func_57(unk3, iParam1, iParam8, false, false, false, bParam4, 1, false);
			GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
			GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
		}
						...
						switch (Global_23970.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_23970.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23970.f_79[num16 /*6*/]) != 0)
										{
											...
											func_55(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, num35, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_75(Global_23970.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													num25 = num25 + width;
									...
									if (flag6)
									{
										if (func_75(26, true, false, &width, &height, bParam7))
										{
											if (Global_23970.f_5686[k] == 2)
												x = x - (width * 2f);
											...
											if (func_75(26, true, true, &width, &height, bParam7))
											{
												func_64(26, true, &red, &green, &blue, &alpha);
											
												if (i == 1)
													GRAPHICS::DRAW_SPRITE(func_72(26), func_69(26, true), num24 + x + num26, (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
											}
										}
									
										if (func_75(27, true, false, &width, &height, bParam7))
										{
											x = x + width;
											num26 = width * 0.5f;
										
											if (func_75(27, true, true, &width, &height, bParam7))
											{
												func_64(27, true, &red, &green, &blue, &alpha);
											
												if (i == 1)
													GRAPHICS::DRAW_SPRITE(func_72(27), func_69(27, true), num24 + x + num26 + screenWidthOfDisplayText + num25, (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
									...
									if (MISC::GET_HASH_KEY(&Global_23970.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_55(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23970.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_75(Global_23970.f_4984[num14 + num20], flag, false, &width, &height, bParam7))
												{
													x = x + (width * 0.5f);
												
													if (func_75(Global_23970.f_4984[num14 + num20], flag, true, &width, &height, bParam7))
													{
														func_64(Global_23970.f_4984[num14 + num20], flag, &red, &green, &blue, &alpha);
													
														if (i == 1)
															if (Global_23970.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_4984[num14 + num20]), func_69(Global_23970.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_4984[num14 + num20]), func_69(Global_23970.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_55(false, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_23970.f_4984[num14 + l] != 2 && Global_23970.f_4984[num14 + l] != 54 && Global_23970.f_4984[num14 + l] != 64)
											{
												if (func_75(Global_23970.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_75(Global_23970.f_4984[num14 + l], flag, true, &width, &height, bParam7))
														{
															func_64(Global_23970.f_4984[num14 + l], flag, &red, &green, &blue, &alpha);
														
															if (Global_23970.f_4984[num14 + l] == 30)
																GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_4984[num14 + l]), func_69(Global_23970.f_4984[num14 + l], flag), Global_23967 + (width * 0.5f), (y + 0.00277776f + (height * 0.5f)) - (0.00078125f * 11f), width, height, 0f, red, green, blue, alpha, false, 0);
															else if (Global_23970.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_4984[num14 + l]), func_69(Global_23970.f_4984[num14 + l], flag), ((num24 + x + screenWidthOfDisplayText) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_4984[num14 + l]), func_69(Global_23970.f_4984[num14 + l], flag), (num24 + x + screenWidthOfDisplayText) - (0.00078125f * 12f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23970.f_6332)
									{
										func_55(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_55(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
										func_52(num24 + x, y, "NUMBER" /*~1~*/, Global_23970.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									if (flag6)
									{
										if (func_75(26, true, false, &width, &height, false))
										{
											if (Global_23970.f_5686[k] == 2)
												x = x - (width * 2f);
									...
									func_55(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
									func_51(num24 + x, y, "NUMBER" /*~1~*/, Global_23970.f_4726[num13], Global_23970.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_75(Global_23970.f_4984[num14], flag, false, &width, &height, bParam7))
									{
										if (!Global_23970.f_6332)
										{
											num25 = width;
										...
										if (i == 1)
										{
											if (func_75(Global_23970.f_4984[num14], flag, true, &width, &height, bParam7))
											{
												func_64(Global_23970.f_4984[num14], flag, &red, &green, &blue, &alpha);
												GRAPHICS::DRAW_SPRITE(func_72(Global_23970.f_4984[num14]), func_69(Global_23970.f_4984[num14], flag), num24 + x + (width * 0.5f), (y - 0.00277776f) + (height2 * 0.5f), width * func_50(Global_23970.f_4984[num14]), height * func_50(Global_23970.f_4984[num14]), 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
								}
...
void func_43(int iParam0) // Position - 0x47F2 Hash - 0x7E11E9C ^0x544BF257
{
	if (func_49())
		return;
...
void func_44(int iParam0) // Position - 0x4825 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_49())
		return;
...
BOOL func_45() // Position - 0x48AF Hash - 0xD140D54A ^0xE638D98F
{
...
void func_46(BOOL bParam0, BOOL bParam1) // Position - 0x48D6 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_48(0))
...
BOOL func_47() // Position - 0x494A Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_48(int iParam0) // Position - 0x4958 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_49() // Position - 0x49AF Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1957675, 19);
}

float func_50(int iParam0) // Position - 0x49BE Hash - 0x61246D49 ^0x61246D49
{
	switch (iParam0)
	{
		case 35:
...
void func_51(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4) // Position - 0x4A2D Hash - 0x69E27AC3 ^0x1F999E63
{
...
void func_52(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x4A4C Hash - 0x51E04EF ^0x8FDB7829
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x4A6A Hash - 0x11DC3931 ^0x820FC5
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

void func_54(BOOL bParam0) // Position - 0x4A7B Hash - 0xE7D01AEE ^0x5FC67C22
{
	int r;
	int g;
	int b;
...
void func_55(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4AC1 Hash - 0x4F37228D ^0x4F37228D
{
	int r;
	int g;
	int b;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_56(Global_23970.f_6614[iParam4], &r, &g, &b);
...
void func_56(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4C6F Hash - 0xBC32E287 ^0xBC32E287
{
	switch (iParam0)
	{
		case 0:
...
void func_57(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x4EF9 Hash - 0x27A51DEF ^0xFA033CDB
{
	int num;
	int i;
	int j;
	...
	if (bParam3 && !func_39(bParam4, bParam8))
		return;
...
BOOL func_58(Player plParam0, int iParam1) // Position - 0x53F7 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
...
int func_59(int iParam0, BOOL bParam1) // Position - 0x5450 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_60() // Position - 0x5491 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574926;
}

BOOL func_61(Player plParam0) // Position - 0x549D Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_62() // Position - 0x54BF Hash - 0x8034D5B3 ^0x6404C51
{
	var position;
...
BOOL func_63() // Position - 0x552D Hash - 0x3CA1BB47 ^0x894044A3
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
void func_64(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x5547 Hash - 0x16389FD1 ^0x58250497
{
...
void func_65(float fParam0) // Position - 0x5668 Hash - 0x4A65499D ^0x9B8EE2A2
{
	int r;
	int g;
	int b;
...
void func_66(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x56C7 Hash - 0xB49C9E3A ^0xA43F5A6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(epctParam3);
...
float func_67(char* sParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x56EA Hash - 0x4268C4EF ^0xB6E60544
{
...
void func_68() // Position - 0x572C Hash - 0x16EFE904 ^0xB607D3A2
{
	int r;
	int g;
	int b;
...
char* func_69(int iParam0, BOOL bParam1) // Position - 0x57B6 Hash - 0x9230D0AE ^0x4BB30F5A
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_70(char* sParam0) // Position - 0x5CDE Hash - 0xC9D82232 ^0xC9D82232
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x5CE8 Hash - 0x3F3CEB62 ^0x60A9D262
{
	var gamerHandle;
...
char* func_72(int iParam0) // Position - 0x5CFF Hash - 0x60CD2ECC ^0xC4EB38
{
	var txdName;
	var netHandle;
...
void func_73(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x5D72 Hash - 0xEE4D06D2 ^0x33CDA0F9
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x5DFA Hash - 0xB42F2FDC ^0x10EEA826
{
	return SYSTEM::TO_FLOAT(iParam0) / SYSTEM::TO_FLOAT(iParam1) > 3.5f;
}

BOOL func_75(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x5E15 Hash - 0x8B713771 ^0xD678E8A5
{
	var textureDict;
	var textureName;
	int num;
	...
	TEXT_LABEL_ASSIGN_STRING(&textureDict, func_72(iParam0), 64);
	TEXT_LABEL_ASSIGN_STRING(&textureName, func_69(iParam0, bParam1), 64);
...
float func_76(int iParam0) // Position - 0x5F41 Hash - 0xE12CB3F5 ^0xE12CB3F5
{
	switch (iParam0)
	{
		case 33:
...
void func_77() // Position - 0x6015 Hash - 0xEB0D43DD ^0xEB0D43DD
{
	Global_1919356 = true;
	return;
}

BOOL func_78() // Position - 0x6022 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1919356;
}

void func_79(char* sParam0, int iParam1, int iParam2) // Position - 0x602E Hash - 0xB7E76F1D ^0x4CADBC86
{
	int i;
...
void func_80(ePedComponentType epctParam0, int iParam1, BOOL bParam2) // Position - 0x6093 Hash - 0x7E99DBFF ^0x86F70EFB
{
	int num;
	float num2;
	float num3;
	...
	if (iParam1 != 0)
	{
		func_75(iParam1, true, false, &num2, &num3, false);
	
		if (Global_23970.f_5678[Global_23970.f_5822])
		{
			func_75(26, true, false, &num4, &unk, false);
			num2 = num2 + (num4 * 2f);
		}
		...
		if (bParam2)
			if (num3 > Global_23970.f_6348[epctParam0])
				Global_23970.f_6348[epctParam0] = num3;
	}
...
BOOL func_81(ePedComponentType epctParam0) // Position - 0x620E Hash - 0x6243BAE3 ^0x1F9DB52B
{
	return func_82(&(hLocal_843.f_2), epctParam0);
}

BOOL func_82(var uParam0, ePedComponentType epctParam1) // Position - 0x6221 Hash - 0x347E2523 ^0x347E2523
{
	return IS_BIT_SET(uParam0->[epctParam1 / 32], epctParam1 & 31);
}

void func_83(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6238 Hash - 0x266829EB ^0xA645288
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_86(Global_23970.f_5821, true);
	else
		func_86(Global_23970.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_85(&Global_23970.f_79[Global_23970.f_5823 /*6*/]);
	
		if (Global_23970.f_5678[Global_23970.f_5822])
		{
			func_75(26, true, false, &num3, &unk, false);
			num2 = num2 + (num3 * 2f);
		}
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_84(&Global_23970.f_79[Global_23970.f_5823 /*6*/]);
...
float func_84(char* sParam0) // Position - 0x6454 Hash - 0xA8635191 ^0x72265D8A
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
}

float func_85(char* sParam0) // Position - 0x6470 Hash - 0xCD3C1AB8 ^0xFAB77820
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
	...
	func_55(false, true, false, false, 0, false, false);
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

void func_86(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x64AD Hash - 0x88A2313D ^0xBBA11C08
{
	int num;
...
BOOL func_87(ePedComponentType epctParam0) // Position - 0x64F9 Hash - 0xE4E8264C ^0x251C2EB6
{
	if (IS_BIT_SET(hLocal_724.f_2.f_104[epctParam0], 7))
		if (!IS_BIT_SET(hLocal_724.f_2.f_104[epctParam0], 2))
			return true;

	return func_88(&(hLocal_724.f_2), epctParam0);
}

BOOL func_88(var uParam0, ePedComponentType epctParam1) // Position - 0x6531 Hash - 0x5F5EE690 ^0xEF93D27E
{
	return !IS_BIT_SET(uParam0->f_104[epctParam1], 1);
}

void func_89(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6544 Hash - 0x9D52C17B ^0x9D52C17B
{
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x6583 Hash - 0x9D52C17B ^0x9D52C17B
{
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x65C2 Hash - 0x9D52C17B ^0x9D52C17B
{
...
void func_92(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x666C Hash - 0xE8F8E4B9 ^0xE8F8E4B9
{
...
void func_93(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x669C Hash - 0xE8F8E4B9 ^0xE8F8E4B9
{
...
void func_94(char* sParam0) // Position - 0x66CC Hash - 0xD03AE33A ^0xD6DE91B4
{
	int i;
...
void func_95(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6717 Hash - 0xE8F8E4B9 ^0xE8F8E4B9
{
...
void func_96() // Position - 0x6747 Hash - 0x16C2B596 ^0x311D7B3B
{
	ePedComponentType type;

	type = Global_23970.f_6342;

	if (type <= PV_COMP_INVALID || type >= PV_COMP_MAX)
		return;

	if (func_9(2) && func_88(&(hLocal_724.f_2), type))
	{
		if (func_81(type))
			func_101(type);
		else
...
void func_97() // Position - 0x67CA Hash - 0x1DAA2713 ^0x1DAA2713
{
	func_98(2);
	return;
}

void func_98(int iParam0) // Position - 0x67D7 Hash - 0x9B9BA48B ^0xC9A3A392
{
	MISC::CLEAR_BIT(&(iLocal_19.f_1), iParam0);
	return;
}

void func_99(ePedComponentType epctParam0) // Position - 0x67E9 Hash - 0xF50BFED ^0x3ED5BD15
{
	func_100(&(hLocal_843.f_2), epctParam0);
	return;
}

void func_100(var uParam0, ePedComponentType epctParam1) // Position - 0x67FC Hash - 0x9747A09E ^0xF9D92DC8
{
	MISC::SET_BIT(&uParam0->[epctParam1 / 32], epctParam1 & 31);
	return;
}

void func_101(ePedComponentType epctParam0) // Position - 0x6816 Hash - 0xF50BFED ^0x3ED5BD15
{
	func_102(&(hLocal_843.f_2), epctParam0);
	return;
}

void func_102(var uParam0, ePedComponentType epctParam1) // Position - 0x6829 Hash - 0x9747A09E ^0xE1C56B02
{
	MISC::CLEAR_BIT(&uParam0->[epctParam1 / 32], epctParam1 & 31);
	return;
}

void func_103() // Position - 0x6843 Hash - 0x2C3EFAF8 ^0xFD36342E
{
	int num;
	int num2;
	...
	if (num != 0)
	{
		...
		while (!func_87(iLocal_19.f_2) || num2 == 0)
		{
			func_105(num);
			num2 = num2 + 1;
	...
	{
		if (Global_4542450 > PV_COMP_INVALID && Global_4542450 < iLocal_19.f_3)
		{
...
void func_104(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6AF7 Hash - 0xC6887A59 ^0xC6887A59
{
	ePedComponentType i;
	int num;
...
void func_105(int iParam0) // Position - 0x6C47 Hash - 0xEC843F96 ^0xC38C98B9
{
...
void func_106() // Position - 0x6C93 Hash - 0xC406F895 ^0x32036BF1
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(hLocal_724) == 0 || hLocal_724 != Global_1919350)
		func_19(4);

	return;
}

void func_107(int iParam0) // Position - 0x6CBA Hash - 0x79384820 ^0xAD47ED22
{
	MISC::CLEAR_BIT(&(Global_1919343.f_4), iParam0);
	return;
}

BOOL func_108(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x6CCE Hash - 0xF7C7CB5C ^0x1F94FA7F
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag2 = func_109(&Global_23970.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_109(int iParam0) // Position - 0x6DD6 Hash - 0x55978EE6 ^0xF39227AE
{
	switch (iParam0->f_9)
	{
		case 0:
...
void func_110() // Position - 0x6E78 Hash - 0x289CBE6 ^0x9046A008
{
	Global_1919350.f_1 = hLocal_724.f_1;
	Global_1919350 = hLocal_724;
	return;
}

void func_111() // Position - 0x6E92 Hash - 0x8CC0337A ^0xDD828C9A
{
	int i;
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&hLocal_724.f_2.f_6[i /*4*/]))
		{
			...
			if (func_87(i) && iLocal_19.f_2 == -1 && Global_1919353 == PV_COMP_INVALID)
			{
				func_104(i, false, 1);
				iLocal_19.f_2 = i;
			}
	...
	if (Global_1919353 != PV_COMP_INVALID && func_87(Global_1919353))
	{
		iLocal_19.f_2 = Global_1919353;
		Global_1919353 = PV_COMP_INVALID;
		func_104(iLocal_19.f_2, false, 1);
	}
...
void func_112() // Position - 0x6F46 Hash - 0xFC7C025 ^0x869F55A9
{
	Global_1919348 = -1;
	Global_1919348.f_1 = -1;
	Global_1919354 = false;
	return;
}

void func_113() // Position - 0x6F5F Hash - 0xC3CBB14E ^0xF2C83E13
{
	var src;
	...
	src.f_1 = -1;
	src.f_2 = 1;
	MISC::COPY_SCRIPT_STRUCT(&Global_1919343, &src, 5);
	return;
}
