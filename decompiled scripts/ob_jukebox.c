...
int func_80(int iParam0, BOOL bParam1) // Position - 0x6E42 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
void func_137(int iParam0, Hash hParam1) // Position - 0x9D5E Hash - 0x8B1B3DA8 ^0x8B1B3DA8
{
