...
void func_1(eCharacter echParam0, int iParam1) // Position - 0x321 Hash - 0xE14B34D3 ^0xA77BDFA7
{
...
void func_2(int iParam0, int iParam1) // Position - 0x362 Hash - 0x5CE52334 ^0x5CE52334
{
	if (func_8() == -1)
	{
		if (func_5(iParam0))
...
void func_3(BOOL bParam0) // Position - 0x396 Hash - 0x95150F14 ^0x95150F14
{
	func_29(1, bParam0);
	func_29(2, bParam0);
	return;
...
BOOL func_4(int iParam0) // Position - 0x3AC Hash - 0x65C46DC6 ^0x54782F0D
{
...
BOOL func_5(int iParam0) // Position - 0x3D1 Hash - 0xF8D2E76B ^0xF8D2E76B
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_6() // Position - 0x404 Hash - 0x47CAA55F ^0x47CAA55F
{
...
BOOL func_7() // Position - 0x41F Hash - 0x5F650835 ^0x3265B087
{
	if (Global_2883694)
	{
...
int func_8() // Position - 0x477 Hash - 0x51B3FB45 ^0x8D02FA9F
{
	if (func_27())
	{
		if (func_26(14))
...
BOOL func_9() // Position - 0x5D9 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_10() // Position - 0x5F3 Hash - 0xAA829472 ^0xAA829472
{
	int i;
...
BOOL func_11(int iParam0) // Position - 0x623 Hash - 0x541882A7 ^0x541882A7
{
	return func_12(iParam0, 20, true);
}

BOOL func_12(int iParam0, int iParam1, BOOL bParam2) // Position - 0x634 Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_13(int iParam0, int iParam1) // Position - 0x694 Hash - 0x744E461C ^0x5051D2B7
{
	Hash statHash;
	int outValue;
...
Hash func_14(int iParam0, int iParam1) // Position - 0x6C3 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_15(iParam1));
}

int func_15(int iParam0) // Position - 0x6D8 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_16() // Position - 0x70C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574926;
}

int func_17(int iParam0) // Position - 0x718 Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_18() // Position - 0xACF Hash - 0x21D64237 ^0x21D64237
{
	return Global_33087;
}

BOOL func_19() // Position - 0xADA Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101740.f_399 > 0;
}

BOOL func_20() // Position - 0xAEB Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101740.f_400 > 0;
}

BOOL func_21() // Position - 0xAFC Hash - 0xB8714F4F ^0xB8714F4F
{
	return IS_BIT_SET(Global_79788, 9);
}

BOOL func_22() // Position - 0xB0B Hash - 0x4C17DBA0 ^0x4C17DBA0
{
	return IS_BIT_SET(Global_79788, 8);
}

BOOL func_23() // Position - 0xB1A Hash - 0xE69FEBE1 ^0x5D872482
{
...
BOOL func_24(int iParam0, int iParam1) // Position - 0xC8F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC9E Hash - 0x15889021 ^0xE7262364
{
...
BOOL func_26(int iParam0) // Position - 0xCC6 Hash - 0x937D8816 ^0x937D8816
{
	return Global_44181 == iParam0;
}

BOOL func_27() // Position - 0xCD4 Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_44181 == 15)
		return false;
...
void func_28(int iParam0) // Position - 0xCE9 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_79806 = iParam0;
	return;
}

void func_29(int iParam0, BOOL bParam1) // Position - 0xCF7 Hash - 0xD7D6DF48 ^0xC6E60A2
{
	if (bParam1 == true)
		func_30(false, 1);
...
void func_30(BOOL bParam0, int iParam1) // Position - 0xD26 Hash - 0x6C084EF7 ^0x879D6199
{
	char* str;
	char* str2;
	int value;
...
void func_31(char* sParam0) // Position - 0xEA7 Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_32(int iParam0) // Position - 0xEB9 Hash - 0xAC7AAE54 ^0xFDDAF2C8
{
	if (iParam0 == 1)
...
void func_33(int iParam0, int iParam1) // Position - 0xEE1 Hash - 0xC86B77F ^0xC86B77F
{
	if (func_8() == -1)
	{
...
void func_34(int iParam0, int iParam1) // Position - 0xF2F Hash - 0x5CD9BE9D ^0xB7071DCF
{
...
int func_35(int iParam0) // Position - 0xF5A Hash - 0x8D13EF68 ^0x8D13EF68
{
	int i;
...
void func_36() // Position - 0xF88 Hash - 0xF1339A17 ^0xF1339A17
{
	switch (Global_79789)
	{
		case 1:
...
int func_37(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFC8 Hash - 0xF73D8560 ^0xF73D8560
{
	int num;
...
void func_38(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1020 Hash - 0x174CAF97 ^0x174CAF97
{
	int num;
	int i;
	int num2;
...
int func_39(int iParam0, int iParam1, int iParam2) // Position - 0x110E Hash - 0x1AFC76D3 ^0x1AFC76D3
{
	int i;
	int num;
	int num2;
...
BOOL func_40(int iParam0, int iParam1) // Position - 0x118A Hash - 0xAC8757AF ^0x27E68E2B
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_41(int iParam0) // Position - 0x11C8 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
int func_42(int iParam0, int iParam1) // Position - 0x150E Hash - 0xFC16A83C ^0x19341493
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_43(int iParam0, int iParam1) // Position - 0x1556 Hash - 0x9F56C2F2 ^0x9F56C2F2
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_44() // Position - 0x15AF Hash - 0x63C8E514 ^0x63C8E514
{
...
BOOL func_45(int iParam0) // Position - 0x1611 Hash - 0xC2488648 ^0xC2488648
{
	int num;
...
int func_46(int iParam0) // Position - 0x164B Hash - 0x3BB0694C ^0x3BB0694C
{
	switch (iParam0)
	{
		case 1:
...
void func_47(int iParam0) // Position - 0x167A Hash - 0xF8744AE ^0xA03DA521
{
	int i;
	int num;
	int num2;
...
void func_48(int iParam0) // Position - 0x17BE Hash - 0x9A867C6D ^0xD5CEA9A9
{
...
float func_49(int iParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x17DB Hash - 0xCFE37593 ^0xCFE37593
{
	float value;
	int num;
...
int func_50(int iParam0) // Position - 0x18AD Hash - 0xE158C251 ^0xE158C251
{
	int num;
...
int func_51(float fParam0) // Position - 0x18E9 Hash - 0x9F5139BD ^0x9F5139BD
{
	if (fParam0 == 0f)
		return 0;
...
float func_52(int iParam0, int iParam1, BOOL bParam2) // Position - 0x191E Hash - 0xB606A20F ^0xE2337BDE
{
	float num;
	float value;
...
void func_53(int iParam0, var uParam1) // Position - 0x197D Hash - 0x86D7525E ^0x86D7525E
{
	int num;
...
BOOL func_54(int iParam0, int iParam1, int iParam2) // Position - 0x1A3D Hash - 0x28F05F4B ^0x1E072287
{
	int num;
	int num2;
	int num3;
...
void func_55(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1CA3 Hash - 0xBBCDC2A1 ^0x31F27922
{
	if (iParam5 != 0)
	{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x1D13 Hash - 0xA17D549C ^0x9F8053F4
{
	switch (iParam0)
	{
		case 0:
...
void func_57(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2EEE Hash - 0x8D5F774 ^0x8A19087C
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x2F5E Hash - 0x9F14AA70 ^0x261AB642
{
	int value;
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x2FE3 Hash - 0x5C01F316 ^0xA6F08800
{
	float value;
...
void func_60(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x306C Hash - 0xD008E474 ^0x5EB598A
{
	if (iParam4 != 0)
	{
...
void func_61(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x30D1 Hash - 0xD57ECD74 ^0x15C64044
{
	int value;
	int value2;
...
void func_62(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3170 Hash - 0x506839C9 ^0x8B1DD37B
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x31E0 Hash - 0xA17D549C ^0x30377D00
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0) // Position - 0x4392 Hash - 0x400E5F53 ^0x1AB12576
{
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x43B5 Hash - 0x92B07CD ^0x4DDE5ABA
{
	if (iParam1 < 0)
		return false;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x447F Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_67();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_67() // Position - 0x4498 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
...
BOOL func_68(eCharacter echParam0) // Position - 0x4595 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x45A1 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x45DE Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_71(eCharacter echParam0) // Position - 0x4603 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2201[echParam0 /*29*/];
}

int func_72(Hash hParam0) // Position - 0x4612 Hash - 0x671EC69 ^0xFAAE3E43
{
	int outValue;
...
int func_73(int iParam0) // Position - 0x463B Hash - 0x7ADD5368 ^0x6779994A
{
	int num;
...
int func_74(int iParam0, int iParam1, int iParam2) // Position - 0x4660 Hash - 0x18D4F097 ^0xCC21744D
{
	switch (iParam1)
	{
		case 1:
...
int func_75(int iParam0, int iParam1) // Position - 0x46A3 Hash - 0x7748E784 ^0xEC455128
{
	switch (iParam0)
	{
		case 2:
...
int func_76(int iParam0, int iParam1) // Position - 0x4D87 Hash - 0x2CB0FBEB ^0x4E4F4989
{
	switch (iParam1)
	{
		case 1:
...
int func_77(int iParam0) // Position - 0x4DC2 Hash - 0x6DC67296 ^0x6DC67296
{
	switch (iParam0)
	{
		case 2:
...
void func_78(int iParam0) // Position - 0x4F73 Hash - 0xF30DB114 ^0x9801939E
{
...
struct<2> func_79(int iParam0, int iParam1) // Position - 0x4F98 Hash - 0xF1E9A0EA ^0x96C883C0
{
	var unk;
...
struct<2> func_80(int iParam0) // Position - 0x502E Hash - 0x323E6781 ^0x99014D2D
{
	var unk;
	var unk3;
...
struct<2> func_81(int iParam0) // Position - 0x5066 Hash - 0x975AC8C9 ^0xAEB9808C
{
	var unk;
...
void func_82() // Position - 0x54B3 Hash - 0x84904DD8 ^0x435B6582
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_COLUMN_SCROLL");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
...
void func_83(int iParam0, int iParam1, int iParam2) // Position - 0x54E9 Hash - 0x8840AE89 ^0x8840AE89
{
	int num;
...
void func_84() // Position - 0x5583 Hash - 0xD7742884 ^0xD7742884
{
	int i;
	int num;
	int num2;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, char* sParam5, int iParam6) // Position - 0x56A1 Hash - 0x1C958777 ^0x5816BE53
{
...
void func_86() // Position - 0x56F8 Hash - 0x5C4DA0D5 ^0xFE13A6C8
{
