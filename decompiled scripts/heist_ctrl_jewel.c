...
int func_163(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7C82 Hash - 0x33F90E8 ^0xA5954A2B
{
	...
	{
		if (!func_179(Global_100127[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_168(ePedComponentType epctParam0) // Position - 0xBA66 Hash - 0xC7E3100C ^0xE3158D63
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xBB32 Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_170(ePedComponentType epctParam0, int iParam1) // Position - 0xBB49 Hash - 0xD1D0764E ^0x49FF13DF
{
	int cloudTimeAsInt;
	int num;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xBD52 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xBD68 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_173() // Position - 0xBD7E Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_174() // Position - 0xBD87 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_175() // Position - 0xBD90 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_176() // Position - 0xBD99 Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xBDB2 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
BOOL func_178(int iParam0) // Position - 0xBE6A Hash - 0x2E27F421 ^0x11F57E1B
{
...
BOOL func_179(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC0EF Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_180(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC136 Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
var func_181() // Position - 0xCAA5 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_182(var uParam0, int iParam1) // Position - 0xCAEB Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_183(var uParam0, int iParam1) // Position - 0xCB71 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_184(var uParam0, int iParam1) // Position - 0xCBA4 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_185(int iParam0, int iParam1) // Position - 0xCBF5 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_186(int iParam0) // Position - 0xCC97 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_187(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCCB9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_188(int iParam0) // Position - 0xCCD0 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_189(var uParam0, int iParam1) // Position - 0xCCDD Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_190(var uParam0, int iParam1) // Position - 0xCD17 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_191(var uParam0, int iParam1) // Position - 0xCD52 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_192(var uParam0, int iParam1) // Position - 0xCD8E Hash - 0x604FE9F ^0x604FE9F
{
	int i;
	eCharacter character;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_180(Global_114135.f_18537[i], &unk, &num))
			{
...
void func_193(var uParam0) // Position - 0xCF54 Hash - 0xEE73B491 ^0xBDB3BDC2
{
	*uParam0 = -15;
	return;
}

int func_194() // Position - 0xCF62 Hash - 0x9482CBBF ^0x8B17A994
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
		return 0;
...
void func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCFAD Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_196() // Position - 0xD0FC Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_36.f_18, 14);
}

BOOL func_197(Player plParam0, int iParam1) // Position - 0xD116 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
...
int func_198(int iParam0, BOOL bParam1) // Position - 0xD16F Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_199() // Position - 0xD1B0 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574926;
}

BOOL func_200(Player plParam0) // Position - 0xD1BC Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_201(Player plParam0) // Position - 0xD1DE Hash - 0x68897CDD ^0x41D261A7
{
...
BOOL func_202() // Position - 0xD21D Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_203(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD22B Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
void func_204(int iParam0) // Position - 0xD25E Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void func_205() // Position - 0xD281 Hash - 0x90ED0800 ^0xB82EC02C
{
				...
				switch (iLocal_40)
				{
					case 0:
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_98160.f_9[0]))
						{
							...
							{
								pedLocal_727 = Global_98160.f_9[0];
...
void func_206() // Position - 0xDBA0 Hash - 0x782692F7 ^0x782692F7
{
	func_85(1, 0, true);
	func_85(2, 0, true);
	func_214(&uLocal_44);
...
void func_207(var uParam0) // Position - 0xDBC2 Hash - 0xAB2CC7E2 ^0x834C7DF2
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
...
void func_208(var uParam0) // Position - 0xDC08 Hash - 0x35CBA45F ^0x100E32FB
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC44 Hash - 0x6C235EE0 ^0x9E57F206
{
...
int func_210(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xDCDF Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_211(var uParam0, int iParam1) // Position - 0xDE16 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL func_212(int iParam0) // Position - 0xDE65 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_44181 == 15)
		return false;
...
void func_213() // Position - 0xDE87 Hash - 0xEB0D43DD ^0xEB0D43DD
{
	Global_101727 = true;
	return;
}

void func_214(var uParam0) // Position - 0xDE94 Hash - 0x45115720 ^0x45115720
{
...
BOOL func_215(int iParam0) // Position - 0xDEE3 Hash - 0xF9ACC98C ^0xF9ACC98C
{
	switch (iParam0)
	{
		case 0:
...
int func_216() // Position - 0xDF50 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_79802;
}

BOOL func_217(var uParam0) // Position - 0xDF5C Hash - 0xE4FDB1 ^0xE4FDB1
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_207(uParam0);
...
void func_218(var uParam0) // Position - 0xDF85 Hash - 0xF97E1DC0 ^0xAF76B06D
{
...
void func_219(var uParam0, float fParam1, float fParam2) // Position - 0xDFEF Hash - 0xB6424A22 ^0xC19A843D
{
	float num;
...
void func_220(var uParam0) // Position - 0xE0C0 Hash - 0xA34BD2B5 ^0x1436EE99
{
...
void func_221(var uParam0) // Position - 0xE13E Hash - 0x3B6A64C3 ^0xA256CD38
{
	int i;
...
void func_222(var uParam0) // Position - 0xE198 Hash - 0x37D1DA65 ^0xADC3926C
{
	int i;
	Hash modelHash;
	float pitch;
...
Vector3 func_223(var uParam0, var uParam1) // Position - 0xE2CE Hash - 0xF4C75BC ^0x4CA2BC55
{
	float num;
	float num2;
	float num3;
...
void func_224(var uParam0) // Position - 0xE34C Hash - 0x3C2FC897 ^0xB574E179
{
	int i;
	int num;
	int num2;
...
void func_225(var uParam0) // Position - 0xE429 Hash - 0xF9F5988E ^0x59CE3919
{
	int num;
	int value;
	int i;
...
BOOL func_226(var uParam0) // Position - 0xE569 Hash - 0xDC2D04B2 ^0x494C3305
{
...
void func_227(var uParam0) // Position - 0xE604 Hash - 0x150E35B4 ^0x65C61BF4
{
	float num;
	float num2;
...
void func_228(var uParam0) // Position - 0xE68D Hash - 0x8171B096 ^0xB90E271D
{
	int i;
	int num;
	BOOL value;
...
void func_229(var uParam0) // Position - 0xE8CE Hash - 0x5606F816 ^0xFBC804CC
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
BOOL func_230(int iParam0) // Position - 0xE8F2 Hash - 0x937D8816 ^0x937D8816
{
	return Global_44181 == iParam0;
}

BOOL func_231(eCharacter echParam0) // Position - 0xE900 Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
BOOL func_232(int iParam0) // Position - 0xE968 Hash - 0xB6246282 ^0x2350A449
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_233(var uParam0, int iParam1) // Position - 0xE995 Hash - 0x51C42492 ^0x7C99995B
{
	var unk;
	var unk4;
...
void func_234(var uParam0, int iParam1) // Position - 0xEA61 Hash - 0xA9000AD6 ^0x130F069A
{
...
void func_235(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xED07 Hash - 0x4F0D0B53 ^0x4F0D0B53
{
	var unk;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED80 Hash - 0x114653F8 ^0xF0B5381D
{
	if (uParam0->f_33 < 20)
	{
...
void func_237(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xEDC4 Hash - 0x23A9DD2C ^0xAC5599F3
{
	var unk;
...
void func_238(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xEE14 Hash - 0x3F642A6B ^0xA090274F
{
	if (uParam0->f_117 < 22)
	{
...
void func_239(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0xEE64 Hash - 0xEFACA8ED ^0x48FBA927
{
	var unk;
	var unk3;
...
void func_240(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0xEEFE Hash - 0x634170F2 ^0x634170F2
{
	var unk;
	var unk5;
	var unk9;
...
void func_241(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0xEFA2 Hash - 0xFA29E56E ^0xB9CB6FDB
{
	uParam0->f_9 = fParam1;
...
void func_243(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF08A Hash - 0x43625A4D ^0x75081F43
{
	uParam0->f_1 = iParam1;
...
int func_244(int iParam0, int iParam1) // Position - 0xF0F6 Hash - 0xD4B46002 ^0xD4B46002
{
	if (iParam0 > iParam1)
		return iParam0;
...
int func_245(int iParam0) // Position - 0xF10C Hash - 0xFCBFD2CC ^0x1DBFD43E
{
	int num;
	int offset;
...
void func_246() // Position - 0xF163 Hash - 0x5FA4B436 ^0xD86A2245
{
