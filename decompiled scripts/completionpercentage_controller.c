...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	while (true)
	{
		...
		if (iLocal_411 == 1)
		{
			if (!bLocal_408)
			{
				if (!bLocal_409)
				{
					...
					DATAFILE::DATADICT_SET_FLOAT(panLocal_412, "tot_pc", Global_114135.f_10198.f_3853);
		...
		if (MISC::GET_NUM_SUCCESSFUL_STUNT_JUMPS() > Global_114135.f_10053)
		{
			...
			func_4(_GET_CURRENT_PLAYER_CHARACTER(), 4, (MISC::GET_NUM_SUCCESSFUL_STUNT_JUMPS() - Global_114135.f_10053) * 2);
...
void func_4(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xAE0 Hash - 0xF0BE1C2C ^0x36DE7AA4
{
	int num;
	int num2;
...
void func_5(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xBCE Hash - 0x99A9B13C ^0x893CB3D1
{
	Hash statName;
...
int func_8(int iParam0, int iParam1) // Position - 0xC45 Hash - 0x744E461C ^0x5051D2B7
{
	Hash statHash;
	int outValue;
...
BOOL func_57(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7A62 Hash - 0x1B8A3878 ^0x6E172C5F
{
...
int func_58(int iParam0) // Position - 0xA687 Hash - 0xE4C61EBD ^0xE4C61EBD
{
	switch (iParam0)
	{
		case -1:
...
void func_59(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xA75B Hash - 0xE3509264 ^0xCA79B364
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_52(&Global_79322[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_52(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_52(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_60(int iParam0) // Position - 0xA9E1 Hash - 0x7678FA6 ^0xDF22BB96
{
	BOOL flag;
	int num;
	var unk;
...
void func_61(int iParam0) // Position - 0xAB2E Hash - 0x7D56211F ^0x8C1F4FF8
{
	BOOL flag;
	int num;
	var unk;
...
void func_62(int iParam0) // Position - 0xB03B Hash - 0x82F32603 ^0x8B6EE357
{
	BOOL flag;
	int num;
	var unk;
...
void func_63(int iParam0) // Position - 0xB0AF Hash - 0xC026927F ^0x16C121D4
{
	BOOL flag;
	int num;
	var unk;
...
void func_64(int iParam0) // Position - 0xB122 Hash - 0xC290E725 ^0x13187614
{
	BOOL flag;
	int num;
	var unk;
...
void func_65(int iParam0) // Position - 0xB209 Hash - 0x5D57C554 ^0x4E1BFB22
{
	BOOL flag;
	int num;
	var unk;
...
void func_66(int iParam0) // Position - 0xB54B Hash - 0x70022766 ^0xF9A202F7
{
	BOOL flag;
	int num;
	var unk;
...
void func_67(int iParam0) // Position - 0xB753 Hash - 0xDDFE7744 ^0xC857FFD9
{
	BOOL flag;
	int num;
	var unk;
...
void func_68(int iParam0) // Position - 0xB973 Hash - 0x98A96DA2 ^0xA02464B9
{
	BOOL flag;
	int num;
	var unk;
...
void func_69(int iParam0) // Position - 0xBA7C Hash - 0xEF2456FB ^0xB71AC469
{
	BOOL flag;
	int num;
	var unk;
...
void func_70(int iParam0) // Position - 0xC40F Hash - 0xD968CB7E ^0x7D506A05
{
	BOOL flag;
	int num;
	var unk;
...
void func_71(int iParam0) // Position - 0xCF67 Hash - 0x2732DFB2 ^0x9C99461
{
	if (iParam0 < 136)
		func_73(iParam0);
	else
...
void func_72(int iParam0) // Position - 0xCF9C Hash - 0x7B542CFB ^0x81C3F2B8
{
	BOOL flag;
	int num;
	var unk;
...
void func_73(int iParam0) // Position - 0xDBA0 Hash - 0x7B542CFB ^0x179EF33D
{
	BOOL flag;
	int num;
	var unk;
...
void func_74(int iParam0) // Position - 0xEAA0 Hash - 0xC2F9B35A ^0x8A2BB819
{
	BOOL flag;
	int num;
	var unk;
...
void func_75(int iParam0) // Position - 0xEBCD Hash - 0xABA42D5F ^0x805E0CE
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0, int iParam1) // Position - 0xECC4 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0) // Position - 0xEDB4 Hash - 0xAB7FAD27 ^0x4033A68
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0x10283 Hash - 0x21FEBBEB ^0xABDE362E
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Position - 0x103CA Hash - 0x4B9467AD ^0x7FED314F
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Position - 0x108D4 Hash - 0x92B0C2C ^0xBD2E5B63
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Position - 0x10F3D Hash - 0xC79E233C ^0x332E0AFB
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Position - 0x10FB0 Hash - 0xCB73BC76 ^0xD694B5F1
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Position - 0x11080 Hash - 0xF0CA871C ^0x99FF9F4D
{
	BOOL flag;
	int num;
	var unk;
...
void func_84(int iParam0) // Position - 0x1157B Hash - 0xA3FBA090 ^0x8B907DBF
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Position - 0x1170C Hash - 0x37BE0534 ^0xEE645D7
{
	BOOL flag;
	int num;
	var unk;
...
void func_86(int iParam0) // Position - 0x11EFB Hash - 0xBE3A939E ^0x944DE966
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0x12004 Hash - 0xE2721790 ^0x80A5ABA0
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0) // Position - 0x12F27 Hash - 0xBC068BE9 ^0xA901172E
{
	BOOL flag;
	int num;
	var unk;
...
void func_89(int iParam0) // Position - 0x13BD4 Hash - 0x905863CF ^0x4D59FCB8
{
	if (iParam0 < 107)
		func_92(iParam0);
	else if (iParam0 < 227)
...
void func_90(int iParam0) // Position - 0x13C1A Hash - 0x6B1EB2DB ^0x4E87812A
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0) // Position - 0x146C0 Hash - 0x6B1EB2DB ^0x4D8BAED0
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0) // Position - 0x154AE Hash - 0x6B1EB2DB ^0x954F572D
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Position - 0x160ED Hash - 0xD1DB443F ^0xB59D496E
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0x16365 Hash - 0x1F0C7E6B ^0x926371A3
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0, int iParam1) // Position - 0x164A1 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_96(int iParam0) // Position - 0x16591 Hash - 0xAA85C48C ^0x8769F802
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0x172EF Hash - 0xB0F22A0E ^0xB08F085D
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0x1745E Hash - 0x7AE9DF25 ^0x21A26F6E
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0x179CF Hash - 0x91A280E6 ^0x46C6D990
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x17EF7 Hash - 0x56246CCB ^0x22007F6F
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x17F6A Hash - 0xBC3ED9F1 ^0xCC7F833D
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Position - 0x1803C Hash - 0xC124F6A5 ^0x52291B4A
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0x184EC Hash - 0x2CA76A28 ^0xA7FBB52D
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0x18747 Hash - 0x331B0270 ^0xD44AE32E
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x18A07 Hash - 0xC5B6C2BE ^0x6B19E7B0
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x18BC2 Hash - 0xE4934E8C ^0x13014C3E
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Position - 0x19708 Hash - 0xC75B5564 ^0x18A9F34B
{
	BOOL flag;
	int num;
	var unk;
...
void func_108(int iParam0) // Position - 0x1A33A Hash - 0xA5A40372 ^0xCEFC4EDB
{
	if (iParam0 < 60)
		func_110(iParam0);
	else
...
void func_109(int iParam0) // Position - 0x1A36F Hash - 0x5453623C ^0x4836E67A
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x1B102 Hash - 0x8425A109 ^0xD484AC2C
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x1B784 Hash - 0x646F46FD ^0xA930372B
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Position - 0x1B86A Hash - 0x59B15048 ^0xF7DCE709
{
	BOOL flag;
	int num;
	var unk;
...
void func_113() // Position - 0x1B961 Hash - 0xE5F61993 ^0xEFD41040
{
...
void func_114(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1B9D9 Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79539)
...
void func_115(int iParam0, int iParam1) // Position - 0x1BA31 Hash - 0xF488CE34 ^0x5E93512B
{
	switch (iParam0)
	{
		case 12:
...
void func_116(int iParam0, BOOL bParam1) // Position - 0x1BB1A Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_117(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1BB43 Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_118() // Position - 0x1C4AC Hash - 0x6134FBB2 ^0x82030B41
{
...
int func_119() // Position - 0x1C4DC Hash - 0x21D64237 ^0x21D64237
{
	return Global_33088;
}

int func_120() // Position - 0x1C4E7 Hash - 0x21D64237 ^0x21D64237
{
	return Global_33087;
}

int func_121(var uParam0, int iParam1) // Position - 0x1C4F2 Hash - 0x5A2CB71 ^0x9B6B0D15
{
	int i;
...
void func_122(int iParam0, BOOL bParam1) // Position - 0x1FD30 Hash - 0xD6D1968B ^0x2D6E7FD1
{
...
void func_123(int iParam0) // Position - 0x1FD75 Hash - 0x2A3ED2F3 ^0xD4039C56
{
	char* str;
...
void func_124(char* sParam0) // Position - 0x1FDE4 Hash - 0xBB8D320E ^0x453C0B56
{
...
BOOL func_125() // Position - 0x1FE18 Hash - 0x1C9B9817 ^0x5956764E
{
	if (func_126())
		return false;
...
BOOL func_126() // Position - 0x1FE38 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2696929;
}

Vector3 func_127(int iParam0) // Position - 0x1FE44 Hash - 0x5E05F6B ^0xD4BB2260
{
	int num;
	var unk;
	int num2;
...
void func_128(int iParam0, var uParam1) // Position - 0x1FEFF Hash - 0x45E5CB0A ^0x45E5CB0A
{
	switch (iParam0)
	{
		case 0:
