...
int func_40(Player plParam0) // Position - 0x1326 Hash - 0x7998C8F7 ^0x712BCC49
{
	if (plParam0 > -1)
...
BOOL func_47(int iParam0) // Position - 0x14B5 Hash - 0x12B1B55 ^0xF5FCD842
{
	if (iParam0 == 0)
		if (func_53())
			return false;

	if (HUD::IS_PAUSE_MENU_ACTIVE() || PLAYER::IS_SYSTEM_UI_BEING_DISPLAYED() || func_45() || Global_64302 || func_46(false) || func_52(0) || func_48(PLAYER::PLAYER_ID()))
		return false;

	return true;
}

BOOL func_48(Player plParam0) // Position - 0x151B Hash - 0x85F8BECA ^0x85F8BECA
{
	if (func_51(plParam0))
		return true;
...
BOOL func_49(Player plParam0) // Position - 0x153E Hash - 0xE40D6326 ^0xE40D6326
{
	Player player;
...
BOOL func_50(Player plParam0, int iParam1) // Position - 0x155C Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1887549[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_51(Player plParam0) // Position - 0x1574 Hash - 0x295F4323 ^0xC9EF0000
{
	Player player;
...
BOOL func_52(int iParam0) // Position - 0x1597 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_53() // Position - 0x15EE Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_44181 == 15)
		return false;
...
void func_54(var uParam0) // Position - 0x1603 Hash - 0x46261827 ^0x6A7ACEE5
{
	if (uParam0->f_11 == 1)
...
void func_55(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1638 Hash - 0x608B27C3 ^0x72A9B272
{
	int i;
	float num;
	float num2;
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x16ED Hash - 0xAFA32A88 ^0xC11A84EF
{
	func_57(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_57(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1713 Hash - 0x343DF434 ^0x343DF434
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_58(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1923 Hash - 0xFED631D9 ^0x4FB6D3D3
{
...
void func_59(int iParam0) // Position - 0x195C Hash - 0xDD698506 ^0x4B63A6F7
{
	int shapeTestResult;
	Entity entityHit;
	var endCoords;
...
void func_60(BOOL bParam0) // Position - 0x1A4D Hash - 0x2B3AC4E8 ^0x2B3AC4E8
{
	bParam0;
	return;
}

int func_61(Vehicle veParam0) // Position - 0x1A5A Hash - 0xEFED5857 ^0x3579E800
{
...
int func_62(Vehicle veParam0) // Position - 0x1AC5 Hash - 0x1D957720 ^0x672B6AEA
{
	var minimum;
	float maximum;
...
BOOL func_63(Vehicle veParam0) // Position - 0x1C56 Hash - 0x8C8F8A76 ^0xF9EA37DB
{
	Hash entityModel;
...
BOOL func_64(Hash hParam0) // Position - 0x1EB5 Hash - 0xA46FAD49 ^0x1BDB939C
{
...
BOOL func_65(Vehicle veParam0, BOOL bParam1) // Position - 0x20F6 Hash - 0xF79DA43C ^0xBC9AF55C
{
	if (Global_79539)
...
float func_66(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2144 Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_67() // Position - 0x217E Hash - 0xB7F2D95C ^0xB7F2D95C
{
...
void func_68(var uParam0, int iParam1) // Position - 0x220D Hash - 0xAACEB5E5 ^0xB34749EE
{
...
BOOL IS_XBOX_PLATFORM() // Position - 0x22A1 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x22B7 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_71(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x22CD Hash - 0x3810CC5D ^0x842A4B4D
{
...
float func_72(float fParam0, float fParam1, float fParam2) // Position - 0x22F6 Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_73(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x231D Hash - 0x372A5F05 ^0x40F3047B
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_74(int iParam0) // Position - 0x2392 Hash - 0x95581D1A ^0x95581D1A
{
	int num;
...
BOOL func_75(Vehicle veParam0) // Position - 0x23AA Hash - 0x251F0A94 ^0x6A446318
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_76() // Position - 0x23C8 Hash - 0xC7243898 ^0x2B2E904B
{
	func_77(&iLocal_38);
	func_25(&uLocal_87);
	SCRIPT::TERMINATE_THIS_THREAD();
...
void func_77(var uParam0) // Position - 0x23E0 Hash - 0xFA5E4776 ^0xFA5E4776
{
	int i;
...
void func_78(var uParam0) // Position - 0x2409 Hash - 0x4918B04C ^0x4918B04C
{
	*uParam0 = 0;
	return;
}
