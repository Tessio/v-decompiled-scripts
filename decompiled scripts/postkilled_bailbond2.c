...
BOOL func_1() // Position - 0x213 Hash - 0xEF787812 ^0xF152B7F5
{
	int i;
...
void func_2(Vehicle* pveParam0) // Position - 0x26C Hash - 0xC50F9886 ^0x638B6124
{
...
BOOL func_3(Vehicle veParam0) // Position - 0x2A4 Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x2CE Hash - 0x3D210083 ^0xF7E7C389
{
...
int func_5(Ped pedParam0, var uParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, int iParam6, const char* sParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2EF Hash - 0x1E0371E4 ^0x2179AF37
{
	BOOL flag;
...
void func_6(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x4DF Hash - 0x34362197 ^0xC592197
{
...
void func_7(Blip* pblParam0, BOOL bParam1) // Position - 0x52F Hash - 0x1F5B428 ^0xDA53EE22
{
	BOOL flag;
	var unk;
...
BOOL func_8(Vehicle veParam0) // Position - 0x5A9 Hash - 0x7E48B415 ^0x126328AB
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
...
BOOL func_9() // Position - 0x5C9 Hash - 0x639D8C60 ^0xB2FFB54F
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x619 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_11();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_11() // Position - 0x632 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
...
BOOL func_12(int iParam0) // Position - 0x72F Hash - 0x937D8816 ^0x937D8816
{
	return Global_44181 == iParam0;
}

BOOL func_13(eCharacter echParam0) // Position - 0x73D Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x749 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x786 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_16(eCharacter echParam0) // Position - 0x7AB Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2201[echParam0 /*29*/];
}

BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x7BA Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_18(iParam0, Global_44181);
}

BOOL func_18(int iParam0, int iParam1) // Position - 0x7CB Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
void func_19() // Position - 0x9AC Hash - 0x99174D1 ^0x898BFD0A
{
	int i;
...
void func_20() // Position - 0xA79 Hash - 0x193151C4 ^0x2EC15F0C
{
	int i;
