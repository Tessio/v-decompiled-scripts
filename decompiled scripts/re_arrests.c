...
void func_22(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2901 Hash - 0x99A9B13C ^0x893CB3D1
{
	Hash statName;
...
int func_29(int iParam0, int iParam1) // Position - 0x2B62 Hash - 0x744E461C ^0x5051D2B7
{
	Hash statHash;
	int outValue;
