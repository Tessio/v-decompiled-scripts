...
void func_5() // Position - 0x1D2B0 Hash - 0x414B00C ^0xA7B03D26
{
...
void func_6() // Position - 0x1D32F Hash - 0xCE5FB49E ^0x214A59D5
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1D3BF Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_10())
	{
		case 0:
