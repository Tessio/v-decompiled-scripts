...
void func_1() // Position - 0x87C Hash - 0xE91F8842 ^0xCC7D2285
{
...
void func_2() // Position - 0x8C0 Hash - 0x6C7B3549 ^0xB550E3D6
{
...
void func_3() // Position - 0x8DE Hash - 0xF931BA9E ^0x98F3220
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_4() // Position - 0x921 Hash - 0x52BC72F1 ^0xE1E31EDA
{
...
void func_5() // Position - 0x975 Hash - 0x7935B5EE ^0x451C9445
{
	Global_23465 = -1;
...
BOOL func_6(int* piParam0, int iParam1) // Position - 0x9ED Hash - 0xDDB0D9A1 ^0xDDB0D9A1
{
	return IS_BIT_SET(*piParam0, iParam1);
}

BOOL func_7() // Position - 0x9FB Hash - 0x48B70C9A ^0x1E42E2F1
{
	return IS_BIT_SET(*Global_4718592.f_180429, 12);
}

void func_8() // Position - 0xA10 Hash - 0xE2C819B9 ^0x169A7C06
{
...
void func_9() // Position - 0xA4A Hash - 0x86C672DA ^0x6EB97CBF
{
...
void func_10() // Position - 0xAFE Hash - 0xA35D6DF0 ^0xC18F86C4
{
...
void func_11() // Position - 0xB23 Hash - 0x274A547D ^0xD4AF096A
{
...
void func_12() // Position - 0xB64 Hash - 0x2DD1C56C ^0xBC8C2F08
{
...
void func_13() // Position - 0xB77 Hash - 0x1407BE4C ^0x4BEE425D
{
	if (SYSTEM::TIMERB() > 0)
		Global_23460 = 2;
...
void func_14() // Position - 0xB8B Hash - 0x402D5728 ^0xA39E1841
{
	GRAPHICS::DRAW_LOW_QUALITY_PHOTO_TO_PHONE(false, false);
	GRAPHICS::FREE_MEMORY_FOR_HIGH_QUALITY_PHOTO();
	GRAPHICS::FREE_MEMORY_FOR_LOW_QUALITY_PHOTO();
...
void func_15() // Position - 0xBB5 Hash - 0x55406231 ^0xA9466FB7
{
	if (Global_23461)
	{
		Global_23460 = 1;
...
BOOL func_16() // Position - 0xBD5 Hash - 0xAAE8E826 ^0x4088B365
{
...
void func_17() // Position - 0xD8E Hash - 0x4A4D76E2 ^0xF1564291
{
	int alpha;
...
BOOL func_18() // Position - 0xFDD Hash - 0x9E06F5B4 ^0xC825B580
{
...
BOOL func_19() // Position - 0xFFA Hash - 0xC2D19317 ^0xC2D19317
{
...
BOOL func_20(eControlType ectParam0, eControlAction ecaParam1) // Position - 0x1012 Hash - 0x7DBFDB98 ^0xABF8476
{
...
BOOL func_21(Ped pedParam0) // Position - 0x1058 Hash - 0x6E21113D ^0x5A7BE662
{
	int weaponHash;
...
BOOL func_22(eControlType ectParam0, eControlAction ecaParam1, int iParam2) // Position - 0x10B5 Hash - 0xBB00BE4E ^0xA27687FD
{
...
void func_23() // Position - 0x1127 Hash - 0x7D5EA9E8 ^0xD50E1B9E
{
...
void func_24() // Position - 0x13B0 Hash - 0xC0EDC8FD ^0xA0778517
{
	var unk;
...
void func_25() // Position - 0x19C9 Hash - 0xA15C39F1 ^0x1E604597
{
...
void func_26() // Position - 0x1B57 Hash - 0x6293DE88 ^0x9C5DDF81
{
	if (Global_79539)
	{
...
int func_27(eCharacter echParam0, eCharacter echParam1) // Position - 0x1B88 Hash - 0x97DCD8A1 ^0xF8178EDD
{
...
void func_28(char* sParam0) // Position - 0x1BB2 Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_29() // Position - 0x1BC4 Hash - 0x8961A3BB ^0x93F6EC7D
{
...
void func_30(BOOL bParam0) // Position - 0x1E3B Hash - 0x71EE90A5 ^0x9B43779A
{
	int i;
...
void func_31(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4) // Position - 0x1EF3 Hash - 0x112FD624 ^0x43678DBA
{
...
void func_32(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1F63 Hash - 0xC22558F4 ^0xA170BFDC
{
...
void func_33() // Position - 0x2019 Hash - 0xA8B082D2 ^0xA8B082D2
{
	int i;
...
void func_34() // Position - 0x203C Hash - 0x1394B1B7 ^0x55CFE506
{
	int i;
...
BOOL func_35() // Position - 0x20CC Hash - 0x2EE4DDA7 ^0x2EE4DDA7
{
	if (func_36())
		return true;
...
BOOL func_36() // Position - 0x20E0 Hash - 0x1728AAB1 ^0xAC3CBB95
{
	return func_37() && !NETWORK::NETWORK_IS_ACTIVITY_SESSION();
}

BOOL func_37() // Position - 0x20F6 Hash - 0x6A44CE01 ^0x553A3758
{
	return _STAT_GET_PACKED_BOOL(9539, -1);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x2106 Hash - 0x6099A833 ^0x46750A9D
{
	if (iParam1 == -1)
		iParam1 = func_39();
...
int func_39() // Position - 0x2122 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574926;
}

void func_40(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x212E Hash - 0x39E054FF ^0x41D02682
{
...
void func_41(int iParam0) // Position - 0x21E1 Hash - 0x237C6068 ^0x694D87FA
{
	int i;
	int num;
	int value;
...
BOOL func_42(int iParam0) // Position - 0x2768 Hash - 0x937D8816 ^0x937D8816
{
	return Global_44181 == iParam0;
}

void func_43(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2776 Hash - 0x5F496D0E ^0x86F8205
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
void func_44(BOOL bParam0) // Position - 0x27D9 Hash - 0xF1ACDC57 ^0xE983EA0A
{
	if (bParam0)
...
void func_45() // Position - 0x27FB Hash - 0x5A8987FE ^0x3ABD2F1B
{
...
BOOL func_46() // Position - 0x2890 Hash - 0x8908160D ^0xED00B78B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x28FB Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_42(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x299D Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_49();
	return Global_114135.f_2367.f_539.f_4321;
}

void func_49() // Position - 0x29B6 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
...
BOOL func_50(eCharacter echParam0) // Position - 0x2AB3 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2ABF Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2AFC Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_53(eCharacter echParam0) // Position - 0x2B21 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2201[echParam0 /*29*/];
}

BOOL func_54() // Position - 0x2B30 Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_55() // Position - 0x2B57 Hash - 0x6064D4DF ^0xB7C7932C
{
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x2B90 Hash - 0x767F75CD ^0xDF5C0DEB
{
	char* str;
...
int func_57(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2C7B Hash - 0x90553990 ^0x41296483
{
	int num;
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x2CDD Hash - 0x154EA353 ^0xBFA672B0
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x2D3B Hash - 0x6F79B86B ^0x7B76DD66
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
void func_60() // Position - 0x2D80 Hash - 0xCCDB0B42 ^0x901FA31A
{
	var string1;
	int num;
	var sender;
...
void func_61() // Position - 0x33FA Hash - 0x83496B34 ^0x98CFBDBF
{
	var txdName;
	var subject;
	const char* filenameForAudioConversation;
...
void func_62() // Position - 0x3477 Hash - 0x81315440 ^0x4F291094
{
...
void func_63() // Position - 0x3510 Hash - 0x2FBFF507 ^0x74666D8
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_64(int iParam0) // Position - 0x355C Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
		if (Global_21066.f_1 > 3)
...
void func_65() // Position - 0x35B3 Hash - 0x90D1AD46 ^0x7815AD8E
{
	var string1;
	int num;
	int num2;
...
int func_66(int iParam0, int iParam1) // Position - 0x3C7F Hash - 0x8F00BBCC ^0x8F00BBCC
{
	if (iParam0 < iParam1)
		return iParam0;
...
void func_67() // Position - 0x3CA4 Hash - 0xDA4BDA68 ^0xE203273C
{
...
void func_68() // Position - 0x3CDC Hash - 0xBBA214FF ^0xFDF26E72
{
...
void func_69() // Position - 0x3D55 Hash - 0x3BC9A979 ^0x63C7223
{
	int num;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x3FC1 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_71(iParam0, Global_44181);
}

BOOL func_71(int iParam0, int iParam1) // Position - 0x3FD2 Hash - 0x3C08E89D ^0x3C08E89D
{
	if (iParam1 == 15)
		return 1;
...
BOOL _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x41C4 Hash - 0x2EDA5ECE ^0x16D5CF7
{
	int num;
	char* str;
	int num2;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x4253 Hash - 0x5D6A4A13 ^0x32291975
{
	return Global_2201[character /*29*/].f_3;
}

int func_74(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x4266 Hash - 0x56140E21 ^0x6722A9E7
{
	int num;
	int num2;
...
void func_75(eCharacter echParam0, char* sParam1, BOOL bParam2, int iParam3) // Position - 0x474B Hash - 0x8EDEEA2A ^0x9CE88A61
{
	eCharacter character;
...
BOOL func_76() // Position - 0x47E6 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_77(Player plParam0) // Position - 0x4849 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_78(plParam0, 20);
}

BOOL func_78(Player plParam0, int iParam1) // Position - 0x4859 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1887549[plParam0 /*611*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x4871 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

int func_80(Player plParam0) // Position - 0x487A Hash - 0xD56839EF ^0xE2816EA0
{
	return Global_1845221[plParam0 /*889*/].f_206.f_6;
}

BOOL func_81() // Position - 0x488F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575084;
}

void func_82(int iParam0) // Position - 0x489B Hash - 0x82B5D42C ^0xE58ED58A
{
	var unk;
	var unk2;
...
void func_83(int iParam0) // Position - 0x48BA Hash - 0x3B4AC1F3 ^0x87B359AA
{
	int clockSeconds;
	int clockMinutes;
	int clockHours;
...
void func_84() // Position - 0x494C Hash - 0xC4D8B21 ^0xF60D6219
{
	int num;
	int num2;
	int num3;
...
BOOL func_85(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x4A17 Hash - 0x87F973EB ^0x688F177D
{
	int num;
	int num2;
	int num3;
...
int func_86() // Position - 0x4B02 Hash - 0xC20166C6 ^0x2C188830
{
	int num;
	int num2;
	int i;
...
void func_87() // Position - 0x4C6A Hash - 0xC0F0F0E9 ^0x3E493474
{
...
void func_88(int iParam0, char* sParam1) // Position - 0x4E1F Hash - 0x224F1443 ^0x78F3B6C9
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	return;
...
void func_89() // Position - 0x4E34 Hash - 0xBA2973FF ^0xB320093D
{
...
void func_90() // Position - 0x4E6B Hash - 0xBB5888CE ^0x70F45AFC
{
...
void func_91() // Position - 0x4EA2 Hash - 0xDDD0594E ^0x38706EE5
{
...
BOOL func_92() // Position - 0x4EF4 Hash - 0xA4B50453 ^0xAB3B9EF5
{
...
BOOL func_93(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x513D Hash - 0x687B7981 ^0x511E81EC
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
void func_94(char* sParam0) // Position - 0x52A0 Hash - 0x68B96D20 ^0xE2CC02C7
{
...
void func_95(int iParam0) // Position - 0x52C0 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_98())
		return;
...
void func_96(BOOL bParam0, BOOL bParam1) // Position - 0x534A Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_64(0))
...
BOOL func_97() // Position - 0x53BE Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1957675, 5);
}

BOOL func_98() // Position - 0x53CC Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1957675, 19);
}

void func_99() // Position - 0x53DB Hash - 0x781E5162 ^0xC1253735
{
	float i;
...
void func_100(int iParam0) // Position - 0x545A Hash - 0x6DAB7E3A ^0xECA26711
{
	float i;
	char* str;
...
char* func_101(int iParam0, int iParam1) // Position - 0x54BC Hash - 0x18D0DD45 ^0x33D86C3E
{
	iParam1 = iParam1;
...
int func_102(int iParam0, BOOL bParam1, int iParam2) // Position - 0x55AD Hash - 0xCC61AD0E ^0x90B80B76
{
	int num;
...
BOOL func_103(BOOL bParam0) // Position - 0x58E9 Hash - 0x1416D65F ^0x240B9382
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		return false;
...
BOOL func_104() // Position - 0x59F9 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_105() // Position - 0x5A15 Hash - 0x21D64237 ^0x21D64237
{
	return Global_61489;
}

int func_106(int iParam0) // Position - 0x5A20 Hash - 0xF7024573 ^0xB514535D
{
	Vector3 vector;
...
void func_107(int iParam0) // Position - 0x5E48 Hash - 0x63314BA2 ^0x63314BA2
{
	int i;
...
Vector3 func_108(int iParam0) // Position - 0x5FD4 Hash - 0x19C525E7 ^0x19C525E7
{
	if (!func_109(iParam0))
		return 0f, 0f, 0f;
...
BOOL func_109(int iParam0) // Position - 0x61BE Hash - 0x4533289C ^0x4533289C
{
	if (iParam0 >= 19)
		return false;
	else if (iParam0 <= -1)
...
var func_110(int iParam0, Interior inParam1) // Position - 0x61DF Hash - 0x724FFEBB ^0x3397F292
{
	Vector3 vector;
...
struct<5> func_111(int iParam0) // Position - 0x6204 Hash - 0xAA1C3943 ^0x28B20F42
{
	var unk;
	var unk6;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x8E66 Hash - 0x16E871AD ^0x10C54C39
{
...
char* func_113(char* sParam0) // Position - 0x8E90 Hash - 0xC9D82232 ^0xC9D82232
{
	return sParam0;
}

struct<6> func_114(int iParam0, BOOL bParam1) // Position - 0x8E9A Hash - 0x293B24C9 ^0x49F602D8
{
	var unk;
...
BOOL func_115(int iParam0) // Position - 0x9A50 Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
BOOL func_116(int iParam0) // Position - 0x9AB8 Hash - 0x35F9F9C ^0x35F9F9C
{
	if (iParam0 == 94 || iParam0 == -1)
		return false;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x9AE4 Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

BOOL func_118() // Position - 0x9AF7 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_119() // Position - 0x9B11 Hash - 0x44A439DC ^0x3D5209CD
{
	return MISC::GET_GAME_TIMER() <= Global_23970.f_6481 + 100;
}

BOOL func_120() // Position - 0x9B26 Hash - 0xB8714F4F ^0xB8714F4F
{
	return IS_BIT_SET(Global_79788, 9);
}

BOOL func_121() // Position - 0x9B35 Hash - 0x4C17DBA0 ^0x4C17DBA0
{
	return IS_BIT_SET(Global_79788, 8);
}

BOOL func_122() // Position - 0x9B44 Hash - 0xA0C414F9 ^0xC74DF638
{
...
BOOL func_123() // Position - 0x9CD9 Hash - 0xAA829472 ^0xAA829472
{
	int i;
...
BOOL func_124(int iParam0) // Position - 0x9D09 Hash - 0x541882A7 ^0x541882A7
{
	return func_125(iParam0, 20, true);
}

BOOL func_125(int iParam0, int iParam1, BOOL bParam2) // Position - 0x9D1A Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_126(int iParam0) // Position - 0x9D7A Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_127() // Position - 0xA131 Hash - 0x21D64237 ^0x21D64237
{
	return Global_33087;
}

BOOL func_128() // Position - 0xA13C Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101740.f_400 > 0;
}

BOOL func_129() // Position - 0xA14D Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101740.f_399 > 0;
}

BOOL func_130(int iParam0, int iParam1) // Position - 0xA15E Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xA16D Hash - 0x15889021 ^0xE7262364
{
...
BOOL func_132() // Position - 0xA195 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101727.f_1;
}

BOOL func_133() // Position - 0xA1A3 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_79807;
}

BOOL func_134() // Position - 0xA1AF Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79800)
		return true;
...
BOOL func_135() // Position - 0xA1D9 Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_44181 == 15)
		return false;
...
BOOL func_136(eCharacter echParam0) // Position - 0xA1EE Hash - 0x66989FAD ^0x89C951EC
{
...
int func_137(int iParam0, int iParam1) // Position - 0xA252 Hash - 0x744E461C ^0x5051D2B7
{
	Hash statHash;
	int outValue;
...
Hash func_138(int iParam0, int iParam1) // Position - 0xA281 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_139(iParam1));
}

int func_139(int iParam0) // Position - 0xA296 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
void func_140() // Position - 0xA2CA Hash - 0x27D4231F ^0xABE764C
{
	if (Global_79539 == false)
	{
...
void func_141() // Position - 0xA358 Hash - 0x35153265 ^0x666D8ACE
{
	int i;
	int num;
	int num2;
...
BOOL func_142() // Position - 0xA922 Hash - 0x4F6FCCAE ^0x4F6FCCAE
{
	if (Global_79539)
...
int func_143(int iParam0, eCharacter echParam1) // Position - 0xA949 Hash - 0x97DCD8A1 ^0xFBF2A354
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_144() // Position - 0xA973 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}
