...
BOOL func_18(Player plParam0, int iParam1) // Position - 0xE59 Hash - 0x825301DE ^0x456639F5
{
	int num;
...
BOOL func_23(Player plParam0) // Position - 0x1019 Hash - 0xE598F4B8 ^0xB1409510
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
