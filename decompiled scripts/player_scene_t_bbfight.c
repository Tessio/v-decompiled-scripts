		...
		if (!PED::IS_PED_INJURED(uParam0->[i]))
		{
			switch (uParam1->[i])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->[i], Global_98992, &uLocal_370, &uLocal_386[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
						uParam1->[i] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98993))
					{
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->[i], Global_98993, &uLocal_370, &uLocal_419[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_370) && ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->[i], &uLocal_370, &uLocal_419[i /*16*/], 2))
					{
						...
						{
							if (num < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98993))
							{
...
int func_48(int iParam0, Ped pedParam1) // Position - 0x1EB8 Hash - 0xD1960A5B ^0x3A103378
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_49(Global_101409) && pedParam1 != 0)
		{
			Global_101409 = 0;
		}
	}
