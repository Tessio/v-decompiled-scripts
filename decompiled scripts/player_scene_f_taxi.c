...
BOOL func_4() // Position - 0x1B6 Hash - 0xA0DE5513 ^0x9AD56213
{
	...
	if (!func_3(&unk))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98993))
		{
			...
			if (!func_5(Global_101409, veLocal_73, 2))
				if (synchronizedScenePhase >= 0.9f)
					PED::SET_PED_INTO_VEHICLE(Global_101409, veLocal_73, 2);
...
int func_8(int iParam0, Ped pedParam1) // Position - 0x36D Hash - 0xD1960A5B ^0x3A103378
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_9(Global_101409) && pedParam1 != 0)
		{
			Global_101409 = 0;
		}
	}
...
void func_22() // Position - 0x6A5 Hash - 0x4E5C8B7C ^0x1553D247
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_101409) || !ENTITY::DOES_ENTITY_EXIST(veLocal_73) || !STREAMING::HAS_MODEL_LOADED(hLocal_72) && num < 400)
	{
...
BOOL func_33(ePedComponentType epctParam0) // Position - 0x7E1C Hash - 0xC7E3100C ^0xAC7BE42
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x7EE8 Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
...
BOOL func_35(ePedComponentType epctParam0, int iParam1) // Position - 0x7EFF Hash - 0xD1D0764E ^0x49FF13DF
{
	int cloudTimeAsInt;
	int num;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8109 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x811F Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_38() // Position - 0x8135 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_39() // Position - 0x813E Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_40() // Position - 0x8147 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_41() // Position - 0x8150 Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x8169 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
BOOL func_43(int iParam0) // Position - 0x8221 Hash - 0x2E27F421 ^0x11F57E1B
{
...
int func_44(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x84A1 Hash - 0x36DCAE2A ^0x59910E2E
{
	int num;
...
BOOL func_45(var uParam0) // Position - 0x869C Hash - 0xF5357FFC ^0xF5357FFC
{
	eCharacter character;
	Vector3 entityCoords;
	float num;
...
BOOL func_46(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8754 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_47(int iParam0, var uParam1, char* sParam2) // Position - 0x879B Hash - 0x20E57CE ^0xD035C1C1
{
	var unk;
	int num;
	var unk4;
...
BOOL func_48(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xAD9D Hash - 0x416CB035 ^0x416CB035
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0xCCEC Hash - 0x6E373505 ^0x528400E3
{
...
BOOL func_50(int iParam0, var uParam1, var uParam2) // Position - 0xCD0A Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (iParam0)
	{
		case 11:
...
char* func_51(Hash hParam0) // Position - 0xD679 Hash - 0xE6862179 ^0x86FEB13A
{
	switch (hParam0)
	{
...
void func_52() // Position - 0xD70C Hash - 0x40867CF7 ^0x46D4DBDA
{
